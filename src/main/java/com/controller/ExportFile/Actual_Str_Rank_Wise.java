...
public class Actual_Str_Rank_Wise extends AbstractPdfView {
	...
	public Actual_Str_Rank_Wise(String Type,List<String> TH,String Heading,String username,String foot){
		this.Type = Type;
		this.TH = TH;
		...
		for(int i=0;i< aList.size();i++) {
			...
			for(int j = 0;j<l.size();j++) {
				if(TH.get(0).equals("SR NO")) {
					relativeWidths[0] = (float) 0.30;
				}if(TH.get(1).equals("PARENT ARM")) {
					relativeWidths[1] = (float) 0.40;
				}if(TH.get(2).equals("ARM DESC")) {
					relativeWidths[2] = (float) 1.20;
				}if(TH.get(3).equals("FM")) {
					relativeWidths[3] = (float) 0.40;
				}if(TH.get(4).equals("GEN")) {
					relativeWidths[4] = (float) 0.40;
				}if(TH.get(5).equals("LT")) {
					relativeWidths[5] = (float) 0.40;
				}if(TH.get(6).equals("MAJGEN")) {
					relativeWidths[6] = (float) 0.40;
				}if(TH.get(7).equals("BRIG")) {
					relativeWidths[7] = (float) 0.40;
				}if(TH.get(8).equals("COL")) {
					relativeWidths[8] = (float) 0.40;
				}if(TH.get(9).equals("COLTS")) {
					relativeWidths[9] = (float) 0.40;
				}if(TH.get(10).equals("LTCOL")) {
					relativeWidths[10] = (float) 0.40;
				}if(TH.get(11).equals("MAJ")) {
					relativeWidths[11] = (float) 0.40;
				}if(TH.get(12).equals("CAPT")) {
					relativeWidths[12] = (float) 0.40;
				}if(TH.get(13).equals("LT")) {
					relativeWidths[13] = (float) 0.40;
				}if(TH.get(14).equals("TOTAL")) {
					relativeWidths[14] = (float) 0.40;
				}if(TH.get(15).equals("PERCENTAGE")) {
