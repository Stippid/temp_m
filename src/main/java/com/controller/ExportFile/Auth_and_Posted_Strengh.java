...
public class Auth_and_Posted_Strengh extends AbstractPdfView {
	...
	public Auth_and_Posted_Strengh(String Heading,List<String> TH,String foot,String username,
			ArrayList<ArrayList<String>>list,String cont_comd,String cont_corps,String cont_div,String cont_bde,String unit_name,String sus_no){
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		Chunk underline5 = new Chunk("AUTH AND POSTED STRENGTH", fontTableHeadingMainHead);
