...
public class CommandGenderReport extends AbstractPdfView {
	...
	public CommandGenderReport(String Type,List<String> TH,String Heading,String username,String foot){
		this.Type = Type;
		this.TH = TH;
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		for(int i=0;i< aList.size();i++) {
			...
			for(int j = 0;j<l.size();j++) {
				...
				}if(TH.get(1).equals("LEVEL C")) {
					relativeWidths[1] = (float) 3.00;
				}if(TH.get(2).equals("MALE")) {
					relativeWidths[2] = (float) 0.50;
				}if(TH.get(3).equals("FEMALE")) {
					relativeWidths[3] = (float) 0.50;
				}if(TH.get(4).equals("OTHER")) {
					relativeWidths[4] = (float) 0.50;
				}if(TH.get(5).equals("TOTAL")) {
					relativeWidths[5] = (float) 0.50;
				}
