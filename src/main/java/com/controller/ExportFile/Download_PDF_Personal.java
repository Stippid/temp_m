...
public class Download_PDF_Personal extends AbstractPdfView {
	...
	public Download_PDF_Personal(List<String> TH,String foot,String username,String batchId,String unit_name){

		this.TH = TH;this.foot=foot;this.username = username;this.batchId = batchId; this.unit_name = unit_name;
	}
	@Override
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk underline2 = new Chunk("NOMINAL ROLL OF OFFRS IN R/ O "+unit_name+" DESIROUS TO PLACE DEMAND FOR PURCHASE OF LAPTOP & SIMILAR DEVICES AS PER DDG IT POLICY B/03568/GEN/DDGIT (PROJ) DT 29 NOV 24 ", fontTableHeadingMainHead);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		table1.setWidths(new int[]{1,2,2,2,2,2,2,2,2,2,2,3});
		Paragraph p;
		...
		p = new Paragraph("Detls of Presiding Offr",fontTableHeading);
		remarkscell1.addElement(p);

		p = new Paragraph("Sig: _______________________",fontTableHeading);
		remarkscell1.addElement(p);

		remarkscell1.addElement(new Phrase("\n"));

		p = new Paragraph("Pers No: _______________________",fontTableHeading);
		remarkscell1.addElement(p);

		remarkscell1.addElement(new Phrase("\n"));

		p = new Paragraph("Name: _______________________",fontTableHeading);
		remarkscell1.addElement(p);
		...
		p = new Paragraph("Dt:",fontTableHeading);
		remarkscell1.addElement(p);

		remarkscell1.addElement(new Phrase("\n"));

		p = new Paragraph("Place: C/o __ APO",fontTableHeading);
		remarkscell1.addElement(p);

		remarkscell1.setHorizontalAlignment(Element.ALIGN_LEFT);
		...
		Paragraph p2 = new Paragraph("Detls of Member 1",fontTableHeading);
		remarkscell2.addElement(p2);

		p2 = new Paragraph("Sig: _______________________",fontTableHeading);
		remarkscell2.addElement(p2);

		remarkscell2.addElement(new Phrase("\n"));

		p2 = new Paragraph("Pers No: _______________________",fontTableHeading);
		remarkscell2.addElement(p2);

		remarkscell2.addElement(new Phrase("\n"));

		p2 = new Paragraph("Name: _______________________",fontTableHeading);
		remarkscell2.addElement(p2);

		remarkscell2.setHorizontalAlignment(Element.ALIGN_CENTER);
		...
		Paragraph p3 = new Paragraph("Detls of Member 2",fontTableHeading);
		remarkscell3.addElement(p3);

		p3 = new Paragraph("Sig: _______________________",fontTableHeading);
		remarkscell3.addElement(p3);

		remarkscell3.addElement(new Phrase("\n"));

		p3 = new Paragraph("Pers No: _______________________",fontTableHeading);
		remarkscell3.addElement(p3);

		remarkscell3.addElement(new Phrase("\n"));

		p3 = new Paragraph("Name: _______________________",fontTableHeading);
		remarkscell3.addElement(p3);
		...
		//		p = new Paragraph("",fontTableValue);
