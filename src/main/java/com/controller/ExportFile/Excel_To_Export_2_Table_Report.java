...
public class Excel_To_Export_2_Table_Report extends AbstractExcelView {
	...
	public Excel_To_Export_2_Table_Report(String Type,List<String> TH,List<String> TH1,String Heading,String username,
			ArrayList<ArrayList<String>>smlist,ArrayList<ArrayList<String>>fmnlist){
		this.Type = Type;
