...
public class Excel_To_Export_4_Table_Report extends AbstractExcelView{
	...
	public Excel_To_Export_4_Table_Report(String Type,List<String> TH,List<String> TH1,List<String> TH2,List<String> TH3,
		...
		this.smlist=smlist;this.relist=relist;this.agelist=agelist;this.stlist=stlist;this.authlist=authlist;this.list_held=list_held;
