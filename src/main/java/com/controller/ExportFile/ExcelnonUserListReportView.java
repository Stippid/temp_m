...
public class ExcelnonUserListReportView extends AbstractExcelView  {
	String Type = "";
	List<String> TH;
	String Heading = "";
	String username = "";
	
	public ExcelnonUserListReportView(String Type,List<String> TH,String Heading,String username){
		this.Type = Type;
		this.TH = TH;
