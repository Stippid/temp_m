...
import com.controller.psg.Enrollment_Reports.Pers_Foreign_Language_Controller;
...
public class Held_Offrs_Download_report extends AbstractPdfView {
	
	
	List<String> TH;
	String Heading = "";
	String username = "";String foot="";int total_column;
	...
	public Held_Offrs_Download_report(String Heading,List<String> TH,String foot,String username,
			ArrayList<ArrayList<String>>list,int total_column){
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Font fontTableHeadingMainHead = FontFactory.getFont("Arial", BaseFont.IDENTITY_H, false, 13, 1);
		...
		Chunk underline2 = new Chunk(Heading, fontTableHeadingMainHead);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		Chunk underline5 = new Chunk(Heading, fontTableHeadingMainHead);
		underline5.setUnderline(0.1f, -2f);
		
		PdfPTable table3 = new PdfPTable(total_column);
