...
import com.controller.ExportFile.PDF_Civilian_Services_SC_ST_Wise.ImageBackgroundEvent;
...
public class PDF_Adhoc_Report extends AbstractPdfView{
	String Type = "";
	List<String> TH;
	String Heading = "";
	String username = "";
	...
	public PDF_Adhoc_Report(List<String> TH,String Heading,String username,List<ArrayList<String>>list,int total,int column_total){
		this.TH = TH;
		this.Heading = Heading;
		this.username = username;
		this.list=list;
		this.total = total;
		this.column_total = column_total;
	}
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk underline = new Chunk("Dynamic Report", fontTableHeading1);
		underline.setUnderline(0.1f, -2f);
		Chunk underline2 = new Chunk("", fontTableHeadingMainHead);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		Font fontTableHeading = FontFactory.getFont("Arial", BaseFont.IDENTITY_H, false, 12, 1);
		Font fontTableHeadingMainHead = FontFactory.getFont("Arial", BaseFont.IDENTITY_H, false, 14, 1);
		...
		PdfPTable table3 = new PdfPTable(column_total);
		table3.setWidthPercentage(100);
		table3.getDefaultCell().setHorizontalAlignment(Element.ALIGN_CENTER);
		for(int h=0;h<TH.size();h++) {
			p = new Paragraph(TH.get(h).toUpperCase(),fontTableHeading);
