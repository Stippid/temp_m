...
public class PDF_Adhoc_mnh_qry extends AbstractPdfView {
	...
	public PDF_Adhoc_mnh_qry(List<String> TH,String Heading,String username,List<ArrayList<String>>list,int total,int column_total){
		this.TH = TH;
