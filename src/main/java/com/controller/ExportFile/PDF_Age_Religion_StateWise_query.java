...
public class PDF_Age_Religion_StateWise_query extends AbstractPdfView{
	
	List<String> TH;List<String> TH1;List<String> TH2;List<String> TH3;
	String Heading = "";
	String username = "";String foot="";
	ArrayList<ArrayList<String>>pdfprint;ArrayList<ArrayList<String>>pdfprint_Religion;ArrayList<ArrayList<String>>pdfprint_Age;ArrayList<ArrayList<String>>pdfprint_State;
	...
	public PDF_Age_Religion_StateWise_query(String Heading,List<String> TH,List<String> TH1,List<String> TH2,List<String> TH3,String foot,String username,
			ArrayList<ArrayList<String>>pdfprint,ArrayList<ArrayList<String>>pdfprint_Religion,
			ArrayList<ArrayList<String>>pdfprint_Age,ArrayList<ArrayList<String>>pdfprint_State,String cont_comd,String cont_corps,
		...
		this.pdfprint_Religion=pdfprint_Religion;
		this.pdfprint_Age=pdfprint_Age;
		this.pdfprint_State=pdfprint_State;
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk underline2 = new Chunk("NUMBERS OF PERS AGE/RELIGION/STATE WISE", fontTableHeadingMainHead);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		Chunk underline5 = new Chunk("SUMMARY", fontTableHeadingMainHead);
		...
		for(int i=0;i< pdfprint.size();i++) {
			List<String> l = pdfprint.get(i);
			for(int j = 0;j<l.size();j++) {
				p = new Paragraph(l.get(j),fontTableHeadingNonBoldData);
				table3.addCell(p);
			}
		}
		Chunk underline6 = new Chunk("NUMBERS OF PERS AGE/RELIGION/STATE WISE", fontTableHeadingMainHead);
		...
		for(int i=0;i< pdfprint_Religion.size();i++) {
			List<String> l = pdfprint_Religion.get(i);
			for(int j = 0;j<l.size();j++) {
				p = new Paragraph(l.get(j),fontTableHeadingNonBoldData);
				table4.addCell(p);
			}
		}		
		Chunk underline8 = new Chunk("NUMBERS OF PERS AGE/RELIGION/STATE WISE", fontTableHeadingMainHead);
		...
		for(int h=0;h<TH2.size();h++) {
			p = new Paragraph(TH2.get(h),fontTableHeadingNonBoldData);
			p.setAlignment(Element.ALIGN_CENTER);
			table5.addCell(p);
		}
		...
		for(int i=0;i< pdfprint_Age.size();i++) {
			List<String> l = pdfprint_Age.get(i);
			for(int j = 0;j<l.size();j++) {
				p = new Paragraph(l.get(j),fontTableHeadingNonBoldData);
				table5.addCell(p);
			}
		...
		Chunk underline9 = new Chunk("NUMBERS OF PERS AGE/RELIGION/STATE WISE", fontTableHeadingMainHead);
		...
		for(int h=0;h<TH3.size();h++) {
			p = new Paragraph(TH3.get(h),fontTableHeadingNonBoldData);
			p.setAlignment(Element.ALIGN_CENTER);
			table6.addCell(p);
		}
		...
		for(int i=0;i< pdfprint_State.size();i++) {
			List<String> l = pdfprint_State.get(i);
			for(int j = 0;j<l.size();j++) {
				p = new Paragraph(l.get(j),fontTableHeadingNonBoldData);
				table6.addCell(p);
			}
		...
		table.addCell(new Paragraph(underline8));
		table.addCell(new Phrase("\n"));
		table.addCell(table5);
		table.addCell(new Paragraph(underline9));
		table.addCell(new Phrase("\n"));
