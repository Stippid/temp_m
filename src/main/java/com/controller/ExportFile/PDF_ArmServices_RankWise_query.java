...
public class PDF_ArmServices_RankWise_query extends AbstractPdfView{
	...
	public PDF_ArmServices_RankWise_query(String Heading,List<String> TH,String foot,String username){
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk underline2 = new Chunk("HELD STR OF OFFRS BY  ARM/SERVICES AND RANK WISE", fontTableHeadingMainHead);
		...
		Chunk underline4 = new Chunk("REPORT NO MISO/OFFRS/04", fontTableHeadingSubMainHead);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		table3.setHeaderRows(1); // table first row will be repeated in all pages
		 int s_fm = 0; int s_cds = 0; int s_gen =0; int s_ltgen = 0; int s_majgen = 0; int s_brig = 0; int s_col = 0;
	     int s_colts = 0; int s_ltcol = 0; int s_maj = 0; int s_capt =0; int s_lt = 0; int s_total = 0;
	     
		for(int i=0;i< aList.size();i++) {
			List<String> l = aList.get(i);
			
			s_fm += Integer.parseInt(l.get(3)); s_cds += Integer.parseInt(l.get(4)); s_gen += Integer.parseInt(l.get(5)); 
			s_ltgen += Integer.parseInt(l.get(6)); s_majgen += Integer.parseInt(l.get(7));s_brig += Integer.parseInt(l.get(8)); 
			s_col += Integer.parseInt(l.get(9)); s_colts += Integer.parseInt(l.get(10)); s_ltcol += Integer.parseInt(l.get(11)); 
			s_maj += Integer.parseInt(l.get(12)); s_capt += Integer.parseInt(l.get(13)); s_lt += Integer.parseInt(l.get(14)); 
		...
		sh1.setColspan(3);
		table3.addCell(sh1);
		table3.addCell(String.valueOf(s_fm));
		
		table3.addCell(String.valueOf(s_cds));
		table3.addCell(String.valueOf(s_gen));
		table3.addCell(String.valueOf(s_ltgen));
		table3.addCell(String.valueOf(s_majgen));
		
		table3.addCell(String.valueOf(s_brig));
		table3.addCell(String.valueOf(s_col));
		table3.addCell(String.valueOf(s_colts));
		table3.addCell(String.valueOf(s_ltcol));
		
		table3.addCell(String.valueOf(s_maj));
		table3.addCell(String.valueOf(s_capt));
		table3.addCell(String.valueOf(s_lt));
