...
public class PDF_Cause_of_Wastage extends AbstractPdfView{
		...
		public PDF_Cause_of_Wastage(String Heading,String foot,String username){
		...
		protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
			...
			Chunk underline3 = new Chunk("REPORT NO MISO/OFFRS/56", fontTableHeadingMainHead);
