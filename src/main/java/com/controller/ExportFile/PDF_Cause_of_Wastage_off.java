...
public class PDF_Cause_of_Wastage_off extends AbstractPdfView{
	...
	public PDF_Cause_of_Wastage_off(String Heading,List<String> TH,String foot,String username){
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		for(int i=0;i< aList.size();i++) {
			...
			s_auth += Integer.parseInt(l.get(1)); 
