...
public class PDF_Certify_BCPC extends AbstractPdfView{
	...
	public PDF_Certify_BCPC(String Heading,ArrayList<ArrayList<String>> list2,String foot,String username){
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		PdfPCell pi5 = new PdfPCell(new Paragraph("1.Personal Details .", fontTableHeading));
		pi5.setColspan(2);
		...
		pl = new Paragraph("      (i) Present Unit:", fontTableValue);
		...
		pl = new Paragraph("      (xiv)  Location Hospital name :", fontTableValue);
