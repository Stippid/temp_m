...
public class PDF_Civilian_Arm_Service_NonRegular_Wise extends AbstractPdfView{
	List<String> TH;
	String Heading = "";
	...
	public PDF_Civilian_Arm_Service_NonRegular_Wise(String Heading,List<String> TH,String foot,String username){
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk underline4 = new Chunk("NON REGULAR ESTABLISHMENT ", fontTableHeadingMainHead);
...
//          }
			...
			for(int onion=0;onion<TH.size()-4;onion++) {
				if(onion==2) {
