...
import com.controller.ExportFile.PDF_User_ParentArms_query.ImageBackgroundEvent;
...
public class PDF_Command_Wise_STR extends AbstractPdfView {
	List<String> TH;
	String Heading = "";
	...
	public PDF_Command_Wise_STR(String Heading,List<String> TH,String foot,String username,
			ArrayList<ArrayList<String>>smlist){
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk underline2 = new Chunk("COMMAND WISE STR AS ON: "+ date1, fontTableHeadingMainHead);
