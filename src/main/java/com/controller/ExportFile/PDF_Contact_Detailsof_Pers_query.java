...
public class PDF_Contact_Detailsof_Pers_query extends AbstractPdfView{
	
	List<String> TH;List<String> TH1;
	String Heading = "";
	String username = "";String foot="";
	ArrayList<ArrayList<String>>pdfprint;ArrayList<ArrayList<String>>pdfprint_pers;
	...
	public PDF_Contact_Detailsof_Pers_query(String Heading,List<String> TH,List<String> TH1,String foot,String username,
			ArrayList<ArrayList<String>>pdfprint,ArrayList<ArrayList<String>>pdfprint_pers,String cont_comd,String cont_corps,String cont_div,String cont_bde,
		...
		this.pdfprint_pers=pdfprint_pers;
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk underline2 = new Chunk("CONTACT DETAILS OF PERSON", fontTableHeadingMainHead);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		Chunk underline6 = new Chunk("CONTACT DETAILS OF PERSON", fontTableHeadingMainHead);
		...
		for(int i=0;i< pdfprint_pers.size();i++) {
			List<String> l = pdfprint_pers.get(i);
			for(int j = 0;j<l.size();j++) {
				p = new Paragraph(l.get(j),fontTableHeadingNonBoldData);
				table4.addCell(p);
			}
