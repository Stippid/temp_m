...
public class PDF_Held_Str_Civ extends AbstractPdfView{
	...
	public PDF_Held_Str_Civ(String Heading,List<String> TH,String foot,String username,
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk underline2 = new Chunk("Held Str Return Civilians ", fontTableHeadingMainHead);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		/*Chunk underline5 = new Chunk("Monthly Str Return civ ", fontTableHeadingMainHead);
