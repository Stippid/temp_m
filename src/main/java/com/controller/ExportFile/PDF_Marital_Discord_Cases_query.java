...
public class PDF_Marital_Discord_Cases_query extends AbstractPdfView{
	
	
	List<String> TH;List<String> TH1;
	String Heading = "";
	String username = "";String foot="";
	ArrayList<ArrayList<String>>fmnlist;ArrayList<ArrayList<String>>sylist;
	String cont_comd = "";String cont_corps = "";String cont_div= "";String cont_bde= "";String unit_name= "";String sus_no= "";
	String country_birth= "";String state_birth= "";String dt_from= "";String dt_to= "";
	...
	public PDF_Marital_Discord_Cases_query(String Heading,List<String> TH,List<String> TH1,String foot,String username,
			ArrayList<ArrayList<String>>fmnlist,ArrayList<ArrayList<String>>sylist,String cont_comd,String cont_corps,String cont_div,String cont_bde,
		...
		this.fmnlist=fmnlist;this.sylist=sylist;
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk underline2 = new Chunk("MARITAL DISCORD CASES", fontTableHeadingMainHead);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		table2.addCell(new Paragraph("Country"));
		table2.addCell(new Paragraph(country_birth));
		table2.addCell(new Paragraph(glue));
		table2.addCell(new Paragraph("State"));
		table2.addCell(new Paragraph(state_birth));
		
		table2.addCell(new Paragraph("Date (From)"));
		table2.addCell(new Phrase(dt_from));
		table2.addCell(new Paragraph(glue));
		table2.addCell(new Paragraph("Date (To)"));
		table2.addCell(new Paragraph(dt_to));
		
		Chunk underline5 = new Chunk("MARITAL DISCORD CASES", fontTableHeadingMainHead);
		...
		Chunk underline6 = new Chunk("SUMMARY", fontTableHeadingMainHead);
