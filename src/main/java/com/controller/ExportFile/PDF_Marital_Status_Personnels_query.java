...
import com.controller.ExportFile.PDF_battleCasualty.ImageBackgroundEvent;
...
public class PDF_Marital_Status_Personnels_query extends AbstractPdfView {
	
	
	List<String> TH;List<String> TH1;
	String Heading = "";
	String username = "";String foot="";
	ArrayList<ArrayList<String>>batterychildlist;ArrayList<ArrayList<String>>tyrechildlist;
	String cont_comd = "";String cont_corps = "";String cont_div= "";String cont_bde= "";String unit_name= "";String sus_no= "";
	String marital_status= "";String dt_from= "";String dt_to= "";
	...
	public PDF_Marital_Status_Personnels_query(String Heading,List<String> TH,List<String> TH1,String foot,String username,
			ArrayList<ArrayList<String>>batterychildlist,ArrayList<ArrayList<String>>tyrechildlist,String cont_comd,String cont_corps,String cont_div,String cont_bde,
		...
		this.batterychildlist=batterychildlist;this.tyrechildlist=tyrechildlist;
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk underline2 = new Chunk("MARITAL STATUS OF PERSONNELS OF UNITS/EST", fontTableHeadingMainHead);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		table2.addCell(new Paragraph("Age (From)"));
		table2.addCell(new Phrase(dt_from));
		table2.addCell(new Paragraph(glue));
		table2.addCell(new Paragraph("Age (To)"));
		table2.addCell(new Paragraph(dt_to));
		
		table2.addCell(new Paragraph("Marital Status"));
		table2.addCell(new Paragraph(marital_status));
		table2.addCell(new Paragraph(glue));
		...
		for(int i=0;i< batterychildlist.size();i++) {
			List<String> l = batterychildlist.get(i);
			for(int j = 0;j<l.size();j++) {
				p = new Paragraph(l.get(j),fontTableHeadingNonBoldData);
				table3.addCell(p);
			}
		}
		Chunk underline6 = new Chunk("MARITAL STATUS OF PERSONNELS OF UNITS/EST", fontTableHeadingMainHead);
