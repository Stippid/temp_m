...
public class PDF_NOKDetails_ContactNo_query extends AbstractPdfView{
	
	
	List<String> TH;List<String> TH1;
	String Heading = "";
	String username = "";String foot="";
	ArrayList<ArrayList<String>>fmnlist;ArrayList<ArrayList<String>>perlist;
	...
	public PDF_NOKDetails_ContactNo_query(String Heading,List<String> TH,List<String> TH1,String foot,String username,
			ArrayList<ArrayList<String>>fmnlist,ArrayList<ArrayList<String>>perlist,String cont_comd,String cont_corps,String cont_div,String cont_bde,
			String unit_name,String sus_no){
		
		this.TH = TH;this.TH1 = TH1;
		this.Heading = Heading;
		this.username = username;this.foot=foot;
		this.fmnlist=fmnlist;this.perlist=perlist;
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk underline2 = new Chunk("DETAILS OF NOK AND CONTACT NO", fontTableHeadingMainHead);
