...
public class PDF_blood_group_query extends AbstractPdfView {
	...
	String cont_comd = "";String cont_corps = "";String cont_div= "";String cont_bde= "";String unit_name= "";String sus_no= "";String blood_group= "";
	...
	public PDF_blood_group_query(String Heading,List<String> TH,List<String> TH1,String foot,String username,
			ArrayList<ArrayList<String>>batterychildlist,ArrayList<ArrayList<String>>tyrechildlist,String cont_comd,String cont_corps,String cont_div,String cont_bde,String unit_name,String sus_no,String blood_group){
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk underline2 = new Chunk("DETAIL OF BLOOD GPS OF PERS", fontTableHeadingMainHead);
		...
		table3.setWidthPercentage(120);  ////120
		p2.add(table3);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		table2.addCell(new Paragraph("Blood Group"));
		table2.addCell(new Paragraph(blood_group));
		table2.addCell(new Paragraph(glue));
		table2.addCell(new Paragraph(""));
		table2.addCell(new Paragraph(""));
		
		Chunk underline5 = new Chunk("DETAILS OF BLOOD GPs OF PERS OF FMNs/ESTs", fontTableHeadingMainHead);
		...
		Chunk underline6 = new Chunk("DETAIL OF BLOOD GPS OF PERS", fontTableHeadingMainHead);
