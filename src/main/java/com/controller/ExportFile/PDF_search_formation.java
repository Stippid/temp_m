...
public class PDF_search_formation extends AbstractPdfView {
	...
	public PDF_search_formation(List<String> TH,String Heading,String username,List<ArrayList<String>>list,int total,
