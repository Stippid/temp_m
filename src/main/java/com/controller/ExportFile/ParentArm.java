...
public class ParentArm extends AbstractPdfView {
	...
	ArrayList<ArrayList<String>> li3;
	String SubHeading="";String SubHeading1="";String SubHeading2="";
	public static final String ENCRYPTED_PDF = "C:\\Users\\BISAG\\Desktop\\Beehive Screen\\beehive_reset_pwd_form.pdf";
	public ParentArm(String Type,List<String> TH,String Heading,String username,ArrayList<ArrayList<String>> list2,ArrayList<ArrayList<String>> list3,String SubHeading,String SubHeading1,String SubHeading2,String foot){
		this.Type = Type;
		this.TH = TH;
		this.Heading = Heading;this.foot=foot;
		this.username = username;
		this.li2=list2;
		this.li3=list3;
		this.SubHeading=SubHeading;this.SubHeading1=SubHeading1;this.SubHeading2=SubHeading2;
	}
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		int colunmSize = 3; // get Colunm Size
		...
		Phrase p1 = new Phrase(SubHeading);
		//table.addCell(p1);
		...
		for(int i=0;i< aList.size();i++) {
			...
			for(int j = 0;j<l.size();j++) {
				if(TH.get(0).equals("Ser No")) {
					relativeWidths[0] = (float) 0.40;
				}if(TH.get(1).equals("Arm Description")) {
					relativeWidths[1] = (float) 2.00;
				}if(TH.get(2).equals("Strength")) {
		...
		PdfPTable table2 = new PdfPTable(colunmSize);
		table2.setWidthPercentage(100);
		Phrase p2 = new Phrase(SubHeading1);
		...
		for(int i=0;i< li2.size();i++) {
			...
			for(int j = 0;j<l.size();j++) {
				if(TH.get(0).equals("Ser No")) {
					...
					table2.addCell(l.get(j));
			}
		}
		
		PdfPTable table3 = new PdfPTable(colunmSize);
		table3.setWidthPercentage(100);
		Phrase p3 = new Phrase(SubHeading2);
