...
public class Report_3008_mns_Pdf extends AbstractPdfView {
...
//	ArrayList<ArrayList<String>> list_ReEmp;
	...
	public Report_3008_mns_Pdf(List<String> TH,List<String> TH4,List<String> TH5,String foot,String username,
			ArrayList<ArrayList<String>> list_super,
//			ArrayList<ArrayList<String>> list_ReEmp,
			ArrayList<ArrayList<String>> list_Des,
			ArrayList<ArrayList<String>> list_auth,
		...
		this.list_super = list_super;
//		this.list_ReEmp = list_ReEmp;
		this.list_Des = list_Des;this.list_auth = list_auth;this.list_held = list_held;this.list_Main = list_Main;
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk underline2 = new Chunk("IAFF - 3008: STR RETURN MNS OFFRS ", fontTableHeadingMainHead);
...
//		p1.setUnderline(0.1f, -2f);
		...
		table1.setWidths(new int[]{1,2,2,2,2,2,2,2,2,2,2,2,2,2,2});
		Paragraph p;
...
//		Phrase p2 = new Phrase("SUPERNUMERARY STR", fontTableHeading);
		...
		table2.setWidths(new int[]{1,2,2,2,2,2,2,2,2,2,2,2,2,2,2});
...
//		Phrase p4 = new Phrase("DESERTER", fontTableHeading);
		...
		table4.setWidths(new int[]{1,2,2,2,2,2,2,2,2,2,2,2,2,2,2});
...
//			tableRemarks.getDefaultCell().setHorizontalAlignment(Element.ALIGN_LEFT);
			...
			p = new Paragraph(" Nursing Offr TOS since submission of last report : ",fontTableHeading);
			...
			remarkscell1 = new PdfPCell();
			remarkscell1.setBorder(Rectangle.NO_BORDER);
			p = new Paragraph("Nursing Offr SOS since submission of last report : ",fontTableHeading);
			p.setAlignment(Element.ALIGN_TOP);
			remarkscell1.addElement(p);
			...
			remarkscell1 = new PdfPCell();
			remarkscell1.setBorder(Rectangle.NO_BORDER);
			p = new Paragraph(" Nursing Offrs under order of posting out : ",fontTableHeading);
			p.setAlignment(Element.ALIGN_TOP);
			remarkscell1.addElement(p);
			...
			remarkscell1 = new PdfPCell();
			remarkscell1.setBorder(Rectangle.NO_BORDER);
			p = new Paragraph(" Nursing Offrs under order of posting in : ",fontTableHeading);
			p.setAlignment(Element.ALIGN_TOP);
			remarkscell1.addElement(p);
			...
			remarkscell1 = new PdfPCell();
			remarkscell1.setBorder(Rectangle.NO_BORDER);
			p = new Paragraph(" Nursing Offrs under order of Retirement / Release/SSC Release : ",fontTableHeading);
			p.setAlignment(Element.ALIGN_TOP);
			remarkscell1.addElement(p);
...
//			String watermark = "";
			...
			graphics.drawString(watermark + watermark, 0, 12);
			try {
