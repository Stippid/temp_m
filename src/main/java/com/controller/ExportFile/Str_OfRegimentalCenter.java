...
public class Str_OfRegimentalCenter extends AbstractPdfView {
	...
	public Str_OfRegimentalCenter(String Type,List<String> TH,String Heading,String username,String foot){
		this.Type = Type;
		this.TH = TH;
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		for(int i=0;i< aList.size();i++) {
			...
			for(int j = 0;j<l.size();j++) {
				...
				}if(TH.get(1).equals("UNIT SUS NO")) {
					relativeWidths[1] = (float) 0.80;
				}if(TH.get(2).equals("UNIT NAME")) {
					relativeWidths[2] = (float) 2.50;
