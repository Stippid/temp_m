...
public class Voucher_PDF_Controller extends AbstractPdfView {
	...
	public Voucher_PDF_Controller(String foot,String username, String baNoV, String unit_name){

		this.foot=foot;this.username = username;this.baNoV = baNoV;this.unit_name = unit_name;
	}
	@Override
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk underline2 = new Chunk("DETAILS FOR "+unit_name+" | DT: " + formattedDate, fontTableHeadingMainHead);
		...
		document.setPageSize(PageSize.A4); // Set to portrait A4
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		///////// Remarks ///////////
		PdfPTable tableRemarks = new PdfPTable(2); // Changed to 2 columns
		tableRemarks.setWidthPercentage(100);
		float[] widths = {50f, 50f}; // Setting relative widths for the columns.
		tableRemarks.setWidths(widths);
		tableRemarks.getDefaultCell().setBorder(Rectangle.NO_BORDER);


		PdfPCell remarkscell1 = new PdfPCell();
		remarkscell1.setBorder(Rectangle.NO_BORDER);
		remarkscell1.setHorizontalAlignment(Element.ALIGN_LEFT);
		Paragraph p1 = new Paragraph();
		p1.add(new Chunk("IV No: ", fontTableHeading));
		p1.add(new Chunk("\n"));
		p1.add(new Chunk("Handing Over Unit: ", fontTableHeading));
		p1.add(new Chunk("\n"));
		p1.add(new Chunk("Date: ", fontTableHeading));
		p1.add(new Chunk("\n"));

		// Insert the Auth line here
		p1.add(new Chunk("Auth: SD4 relief pgme as per letter no _________ dt _________ ", fontTableHeading));
		p1.add(new Chunk("\n"));

		p1.add(new Chunk("BA No.: ", fontTableHeading));
		p1.add(new Chunk("\n"));
		p1.add(new Chunk("Engine No.: ", fontTableHeading));

		remarkscell1.addElement(p1);


		PdfPCell remarkscell2 = new PdfPCell();
		remarkscell2.setBorder(Rectangle.NO_BORDER);
		remarkscell2.setHorizontalAlignment(Element.ALIGN_LEFT);
		Paragraph p2 = new Paragraph();
		p2.add(new Chunk("RV No: ", fontTableHeading));
		p2.add(new Chunk("\n"));
		p2.add(new Chunk("Taking Over Unit: ", fontTableHeading));
		p2.add(new Chunk("\n"));
		p2.add(new Chunk("Date: ", fontTableHeading));
		p2.add(new Chunk("\n"));
		p2.add(new Chunk("Veh Nomenclature: ", fontTableHeading));
		p2.add(new Chunk("\n"));
		p2.add(new Chunk("Chassis No.: ", fontTableHeading));
		...
		table11.setTableEvent(new ImageBackgroundEvent(request,baNoV));
	...
	class ImageBackgroundEvent implements PdfPTableEvent {
		...
		public void tableLayout(PdfPTable table, float[][] widths, float[] heights, int headerRows, int rowStart,
			...
			String batchWatermark = "BA No. = " + batchId;
