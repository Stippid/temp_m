...
public class Excel_To_Export_Download_Search_Report_jco_Table_Report extends AbstractExcelView {
	...
	public Excel_To_Export_Download_Search_Report_jco_Table_Report(String Type,List<String> TH,String username,
			ArrayList<ArrayList<String>>smlist){
		this.Type = Type;
		this.TH = TH;
