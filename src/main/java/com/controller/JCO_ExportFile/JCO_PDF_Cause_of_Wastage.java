...
import com.controller.JCO_ExportFile.PDF_Age_Service_Wise_Jco.ImageBackgroundEvent;
...
public class JCO_PDF_Cause_of_Wastage extends AbstractPdfView{
		...
		public JCO_PDF_Cause_of_Wastage(String Heading,String foot,String username){
		...
		protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
			...
			Chunk underline2 = new Chunk("CAUSE OF WASTAGE", fontTableHeadingMainHead);
			underline2.setUnderline(0.1f, -2f);
			Chunk underline3 = new Chunk("REPORT NO MISO/JCO/56", fontTableHeadingMainHead);
		...
		protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
			...
			tablecenter.getDefaultCell().setHorizontalAlignment(Element.ALIGN_CENTER);
			tablecenter.getDefaultCell().setVerticalAlignment(Element.ALIGN_MIDDLE);
			
			pl= new Paragraph("Cause of Wastage",fontTableHeading);
			tablecenter.addCell(pl);
			plv= new Paragraph("No of Offers",fontTableHeading);
			tablecenter.addCell(plv);
			pl= new Paragraph("Died",fontTableValue);
			tablecenter.addCell(pl);
			plv= new Paragraph(aList.get(0).get(0),fontTableValue);
			tablecenter.addCell(plv);
			pl= new Paragraph("Medical Invalidment",fontTableValue);
			tablecenter.addCell(pl);
			plv= new Paragraph(aList.get(0).get(1),fontTableValue);
			tablecenter.addCell(plv);
			pl= new Paragraph("Premature Retirement",fontTableValue);
			tablecenter.addCell(pl);
			plv= new Paragraph(aList.get(0).get(2),fontTableValue);
			tablecenter.addCell(plv);
			pl= new Paragraph("Relinquished Commission/Release SSC",fontTableValue);
			tablecenter.addCell(pl);
			plv= new Paragraph(aList.get(0).get(3),fontTableValue);
			tablecenter.addCell(plv);
			pl= new Paragraph("Retired",fontTableValue);
			tablecenter.addCell(pl);
			plv= new Paragraph(aList.get(0).get(4),fontTableValue);
			tablecenter.addCell(plv);
			pl= new Paragraph("Total",fontTableHeading);
			tablecenter.addCell(pl);
			plv= new Paragraph(aList.get(0).get(5),fontTableHeading);
			tablecenter.addCell(plv);
			
			table.addCell(tablecenter);
