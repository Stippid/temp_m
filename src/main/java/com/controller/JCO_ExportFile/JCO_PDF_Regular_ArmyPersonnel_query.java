...
public class JCO_PDF_Regular_ArmyPersonnel_query extends AbstractPdfView{
	...
	public JCO_PDF_Regular_ArmyPersonnel_query(String Heading,List<String> TH,List<String> TH1,String foot,String username,
			ArrayList<ArrayList<String>>smlist,ArrayList<ArrayList<String>>fmnlist){
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk underline2 = new Chunk("STR OF REGULAR ARMY PERSONNEL JCO", fontTableHeadingMainHead);
		underline2.setUnderline(0.1f, -2f);
		Chunk underline3 = new Chunk("INF REGTs", fontTableHeadingMainHead);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		Chunk underline6 = new Chunk("INFANTRY", fontTableHeadingMainHead);
		...
		for(int i=0;i< fmnlist.size();i++) {
			...
			g_auth1 += Integer.parseInt(l.get(2));
			g_total1 += Integer.parseInt(l.get(3));
			for(int j = 0;j<l.size();j++) {
				p = new Paragraph(l.get(j),fontTableHeadingNonBoldData);
				table4.addCell(p);
			}
		...
		table4.addCell("");
		table4.addCell("GRAND TOTAL");
		table4.addCell(String.valueOf(g_auth1));
		table4.addCell(String.valueOf(g_total1));
