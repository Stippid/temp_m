...
public class PDF_Age_Service_Wise_Jco extends AbstractPdfView {
	String Heading = "";
	...
	public PDF_Age_Service_Wise_Jco(String Heading,String foot,String username,
			ArrayList<ArrayList<String>>sevicelist){
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk underline2 = new Chunk("HELD STR OF JCO/OR AGE WISE", fontTableHeadingMainHead);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		plv= new Paragraph("NO OF JCO/OR",fontTableHeading);
