...
public class PDF_ArmServices_RankWise_query_JCO extends AbstractPdfView{
	...
	public PDF_ArmServices_RankWise_query_JCO(String Heading,List<String> TH,String foot,String username){
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk underline2 = new Chunk("HELD STR OF JCO/OR BY  ARM/SERVICES AND RANK WISE", fontTableHeadingMainHead);
		...
		Chunk underline4 = new Chunk("REPORT NO MISO/JCO/OR/04", fontTableHeadingSubMainHead);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		int s_warrant_officer = 0; int s_sub_maj = 0; int s_sub =0; 
		int s_nb_sub = 0; int s_hav = 0; int s_nk = 0; int s_sep = 0;
		int s_rects = 0; int s_total = 0;
		
		for(int i=0;i< aList.size();i++) {
			List<String> l = aList.get(i);
			s_warrant_officer += Integer.parseInt(l.get(3));
			s_sub_maj += Integer.parseInt(l.get(4));
			s_sub += Integer.parseInt(l.get(5));
			s_nb_sub += Integer.parseInt(l.get(6));
			s_hav += Integer.parseInt(l.get(7));
			s_nk += Integer.parseInt(l.get(8));
			s_sep += Integer.parseInt(l.get(9));
			s_rects += Integer.parseInt(l.get(10));
			s_total += Integer.parseInt(l.get(11));
		...
		sh1.setColspan(3);
		table3.addCell(sh1);	
		table3.addCell(String.valueOf(s_warrant_officer));  
		table3.addCell(String.valueOf(s_sub_maj)); 
		table3.addCell(String.valueOf(s_sub)); 		
		table3.addCell(String.valueOf(s_nb_sub)); 
		table3.addCell(String.valueOf(s_hav)); 
		table3.addCell(String.valueOf(s_nk)); 		
		table3.addCell(String.valueOf(s_sep)); 
		table3.addCell(String.valueOf(s_rects)); 
