...
public class PDF_Arms_ServiceWise_query_JCO extends AbstractPdfView{
	...
	public PDF_Arms_ServiceWise_query_JCO(String Heading,List<String> TH,String foot,String username){
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk underline2 = new Chunk("HELD STR OF JCO/OR ARM/ SERVICE WISE", fontTableHeadingMainHead);
		underline2.setUnderline(0.1f, -2f);
		Chunk underline3 = new Chunk("Report No. MISO/JCO/OR/55 Report Generated On:" + date1, fontTableHeadingMainHead);
