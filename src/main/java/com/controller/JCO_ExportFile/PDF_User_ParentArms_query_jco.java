...
public class PDF_User_ParentArms_query_jco extends AbstractPdfView {
	...
	public PDF_User_ParentArms_query_jco(String Heading,List<String> TH,List<String> TH1,String foot,String username,
			ArrayList<ArrayList<String>>smlist,ArrayList<ArrayList<String>>fmnlist){
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk underline2 = new Chunk("HELD STR OF JCO/OR BY USER ARMS/ FMN AND PARENT ARM/SERVICES.", fontTableHeadingMainHead);
		...
		Chunk underline4 = new Chunk("REPORT NO MISO/JCO/OR/03", fontTableHeadingSubMainHead);
