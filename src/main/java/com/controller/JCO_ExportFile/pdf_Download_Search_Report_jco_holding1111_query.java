...
public class pdf_Download_Search_Report_jco_holding1111_query extends AbstractPdfView {
	
	
	List<String> TH;
	String Heading = "";
	String username = "";String foot="";
	ArrayList<ArrayList<String>>batterychildlist;
	...
	public pdf_Download_Search_Report_jco_holding1111_query(String Heading,List<String> TH,String foot,String username,
			ArrayList<ArrayList<String>>batterychildlist,String cont_comd,String cont_corps,String cont_div,String cont_bde,String unit_name,String sus_no){
		
		this.TH = TH;
		this.Heading = Heading;
		this.username = username;this.foot=foot;
		this.batterychildlist=batterychildlist;
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk underline2 = new Chunk("Held Str Return JCOs/OR ", fontTableHeadingMainHead);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		Chunk underline5 = new Chunk("Held Str Return JCOs/OR ", fontTableHeadingMainHead);
