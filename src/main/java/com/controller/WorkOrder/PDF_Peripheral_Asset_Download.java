...
//		p.add(underline3);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		Paragraph M35= new Paragraph("(a)    The computer/computer peripherals forword vide this work order are issued by IHQ(OS-11 "
				+ " and or is eligible for PreAudit and upgradation at "+list1.get(0).get(0)+" Fd Wksp coy as per policiy issued vide"
				+ "ADG system B&C letter No B/031015/ AFG sys (T&P) dt 24 Sep 1999. \n\n",fontTableHeading);
		document.add(M35);
		
		Paragraph M36= new Paragraph("(b)   Date introduce in service of the eqpt is as mentioned above  onward & the eqpl is neither under "
				+ "warrenty nor on AMC.\n\n",fontTableHeading);
		document.add(M36);
		
		Paragraph M37= new Paragraph("(c)  There is no clarified date in the computer systems "+list1.get(0).get(0)+" Fd Wksp Coy does not lake any"
				+ " resposibillity whatsever the sequrity and the loss of data during repair.\n\n",fontTableHeading);
		document.add(M37);
		
		Paragraph M38= new Paragraph("(d)  The eqpt was repaired in presence of unit rep no ___________________ Rank ___________________"
