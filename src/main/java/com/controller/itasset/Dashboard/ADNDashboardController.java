...
public class ADNDashboardController {
	@Autowired
	...
	@RequestMapping(value = "/admin/ADNDashboard", method = RequestMethod.GET)
	public ModelAndView ADNDashboard(ModelMap Mmap, HttpSession session,
		...
		Mmap.put("msg", msg);
		Mmap.put("getComputingADNData",dashboardDao.getComputingADNData(formation_code,susno));
		
	
		return new ModelAndView("ADNDashboardTiles");
	}
}
