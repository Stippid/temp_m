...
public class PDF_All_India_Holding extends AbstractPdfView {
	...
	public PDF_All_India_Holding(List<String> TH,String Heading,String username,List<ArrayList<String>>list,int total,
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk underline2 = new Chunk("ALL INDIA HOLDING REPORT", fontTableHeadingMainHead);
