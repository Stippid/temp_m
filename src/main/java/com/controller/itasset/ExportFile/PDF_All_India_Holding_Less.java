...
public class PDF_All_India_Holding_Less extends AbstractPdfView {
	String Type = "";
	List<String> TH;
	String Heading = "";
	String username = "";
	...
	public PDF_All_India_Holding_Less(List<String> TH,String Heading,String username,List<ArrayList<String>>list,int total,
