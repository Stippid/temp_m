...
public class PDF_Asset_All_India_Holding  extends AbstractPdfView {
	String Type = "";
	List<String> TH;
	String Heading = "";
	String username = "";
	...
	String asset_type = "";String a_type = "";String b_head= "";String b_code= "";String line_dte= "";
	...
	public PDF_Asset_All_India_Holding(List<String> TH,String Heading,String username,List<ArrayList<String>>list,int total,
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk underline2 = new Chunk("LINE DIRECTED REPORT", fontTableHeadingMainHead);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		table2.addCell(new Paragraph("Asset Category"));
		table2.addCell(new Paragraph(asset_type));
		table2.addCell(new Paragraph(glue));
		table2.addCell(new Paragraph("Assets Type"));
		table2.addCell(new Paragraph(a_type));
		
		table2.addCell(new Paragraph("Budget Head"));
		table2.addCell(new Paragraph(b_head));
		table2.addCell(new Paragraph(glue));
		table2.addCell(new Paragraph("Budget Code"));
		table2.addCell(new Paragraph(b_code));
		
		
		if(line_dte != "" && line_dte !="0") {
			table2.addCell(new Paragraph("Line Dte"));
			table2.addCell(new Paragraph(line_dte));
			table2.addCell(new Paragraph(glue));
		...
		PdfPTable table3 = new PdfPTable(TH.size()-1);
