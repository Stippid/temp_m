...
public class PDF_AuditReport extends AbstractPdfView {
	String Type = "";
	List<String> TH;
	String Heading = "";
	String username = "";
	...
	public PDF_AuditReport(List<String> TH,String username,String Heading,List<ArrayList<String>>list,int total){
		this.TH = TH;
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk underline2 = new Chunk("AUDIT REPORT:"+username, fontTableHeadingMainHead);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		PdfPTable table4 = new PdfPTable(16);
