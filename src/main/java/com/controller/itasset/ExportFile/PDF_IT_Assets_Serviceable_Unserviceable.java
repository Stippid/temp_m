...
public class PDF_IT_Assets_Serviceable_Unserviceable extends AbstractPdfView{
	...
	public PDF_IT_Assets_Serviceable_Unserviceable(String Heading,List<String> TH,String foot,String username,
			ArrayList<ArrayList<String>>list,String cont_comd,String cont_corps,String cont_div,String cont_bde,
			String unit_name,String sus_no,String assets_type){
	...
	protected void buildPdfMetadata(Map<String, Object> model, Document document, HttpServletRequest request) {
		...
		Chunk underline2 = new Chunk("AUTH AND POSTED STRENGTH", fontTableHeadingMainHead);
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
		...
		table2.addCell(new Paragraph("Peripheral Type"));
		table2.addCell(new Paragraph(assets_type));
		table2.addCell(new Paragraph(glue));
		table2.addCell(new Paragraph(""));
		table2.addCell(new Paragraph(""));
		
		Chunk underline5 = new Chunk("IT ASSET SERVICEABLE UNSERVICEABLE", fontTableHeadingMainHead);
		...
		int s_ser = 0; int s_unser = 0;
		for(int i=0;i< list.size();i++) {
			List<String> l = list.get(i);
			s_ser += Integer.parseInt(l.get(8)); s_unser += Integer.parseInt(l.get(9));
		...
		sh.setColspan(5);
		table3.addCell(sh);
		table3.addCell(String.valueOf(s_ser));
		table3.addCell(String.valueOf(s_unser));
