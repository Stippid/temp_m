...
public class ArrivalDeparctureController {
	...
	@RequestMapping(value = "/Arrival_Departure_Report", method = RequestMethod.GET)
	public ModelAndView Arrival_Departure_Report(ModelMap Mmap,HttpSession session,@RequestParam(value = "msg", required = false) String msg,HttpServletRequest request) {
		String  roleid = session.getAttribute("roleid").toString();
		Boolean val = roledao.ScreenRedirect("Arrival_Departure_Report", roleid);	
		if(val == false) {
		...
		Mmap.put("msg", msg);
		return new ModelAndView("Arrival_Departure_ReportTiles", "Arrival_Departure_ReportCMD", new Miso_Orbat_Unt_Dtl());
	}

	@RequestMapping(value = "/Arrival_Departure_ReportAction",method = RequestMethod.POST)
	public ModelAndView addItemEntryarrivalForm(@ModelAttribute("Arrival_Departure_ReportCMD") Miso_Orbat_Unt_Dtl ud,
		...
		if(letter_no.equals(""))
		{
			...
			return new ModelAndView("redirect:Arrival_Departure_Report");
		}
	...
	@RequestMapping(value = "/check_sus_hierarchy",method=RequestMethod.POST)
	public @ResponseBody List<String> check_sus_hierarchy(HttpSession session,
			HttpServletRequest request,
			 @RequestParam   String  unit_sus_no) {				
		
		
		return allMethodsDAO.check_sus_hierarchy(unit_sus_no);
