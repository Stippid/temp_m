...
import com.controller.ExportFile.PDF_Civilian_Orgnisation_Unit_Wise;
import com.controller.orbat.AllMethodsControllerOrbat;
import com.controller.psg.Master.Psg_CommonController;
import com.dao.login.RoleBaseMenuDAO;
import com.dao.psg.Civilian_Report.Organisation_Unit_wise_Dao;
import com.models.Tbl_CodesForm;

@Controller
@RequestMapping(value = { "admin", "/", "user" })
public class Organisation_Unit_wise_Controller {
...
//	Blood_Group_Controller bloodGP = new Blood_Group_Controller();
	...
	@Autowired private Organisation_Unit_wise_Dao OrgUnit ;
	
	
	@RequestMapping(value = "/admin/Oraganisation_Unit_Wise_Url", method = RequestMethod.GET)
	public ModelAndView Oraganisation_Unit_Wise_Url(ModelMap Mmap, HttpSession sessionA,
			@RequestParam(value = "msg", required = false) String msg, HttpServletRequest request) {
		
		String roleid = sessionA.getAttribute("roleid").toString();
		Boolean val = roledao.ScreenRedirect("Oraganisation_Unit_Wise_Url", roleid);
		if (val == false) {
		...
		Mmap.put("msg", msg);
		return new ModelAndView("Organisation_Unit_Wise_Tiles");
	}
	

	@RequestMapping(value = "/getOraganisation_Unit_Wise_ReportDataList", method = RequestMethod.POST)
	 public @ResponseBody List<Map<String, Object>> getOraganisation_Unit_Wise_ReportDataList(int startPage,String pageLength,String Search,
			 String orderColunm,String orderType, String cont_comd,String cont_corps,String cont_div,String cont_bde,String unit_name,
			 String sus_no,String parent_arm, String cadre,HttpSession sessionUserId)throws InvalidKeyException, NoSuchAlgorithmException,
	 NoSuchPaddingException,InvalidKeySpecException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException{
		 ...
		 return OrgUnit.getOraganisation_Unit_Wise_ReportDataListDetails(startPage,pageLength,Search,orderColunm,orderType,cont_comd,cont_corps,cont_div,
				 cont_bde,unit_name,sus_no,parent_arm,cadre,sessionUserId);
	}
	 
	 @RequestMapping(value = "/getOraganisation_Unit_Wise_TotalCount", method = RequestMethod.POST)
	 public @ResponseBody long getOraganisation_Unit_Wise_TotalCount(HttpSession sessionUserId,String Search,String cont_comd,String cont_corps,
			 String cont_div,String cont_bde,String unit_name,String sus_no,String parent_arm, String cadre){
	 	return OrgUnit.getOraganisation_Unit_Wise_TotalCountDtl(Search,cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no,parent_arm,cadre);
	 }
	 @RequestMapping(value = "/Download_Oraganisation_Unit_Wise",method = RequestMethod.POST)
		public ModelAndView Download_Oraganisation_Unit_Wise(@ModelAttribute("cont_comd_dn") String cont_comd,
				@ModelAttribute("cont_corps_dn") String cont_corps,@ModelAttribute("cont_div_dn") String cont_div,
				@ModelAttribute("cont_bde_dn") String cont_bde,@ModelAttribute("cont_comd_tx") String cont_comd_tx,
				@ModelAttribute("cont_corps_tx") String cont_corps_tx,@ModelAttribute("cont_div_tx") String cont_div_tx,
				@ModelAttribute("cont_bde_tx") String cont_bde_tx,@ModelAttribute("unit_name_dn") String unit_name,
				@ModelAttribute("sus_no_dn") String sus_no,@ModelAttribute("parent_arm1") String parent_arm,@ModelAttribute("cadre1") String cadre,
				@RequestParam(value = "msg", required = false) String msg,
				ModelMap Mmap, Authentication authentication,HttpServletRequest request,
				HttpSession sessionEdit) {	
		
			ArrayList<ArrayList<String>> pdfprint = OrgUnit.pdf_Oraganisation_Unit_Wise_ReportDataList(cont_comd,
					cont_corps,cont_div,cont_bde,unit_name,sus_no,parent_arm,cadre);
			...
			TH.add("GROUP - C");
			TH.add("REMARKS");
			TH.add("HELD STR OF CIVILIANS ");
			TH.add("GAZETTED");
			TH.add("NON GAZETTED");
			TH.add("NON INDUSTRIAL");
			TH.add("INDUSTRIAL");
		
			return new ModelAndView(new PDF_Civilian_Orgnisation_Unit_Wise(Heading,TH,foot,username),"userList",pdfprint);
		}
	 
	 @RequestMapping(value = "/Excel_Oraganisation_Unit_Wise", method = RequestMethod.POST)
		public ModelAndView Excel_Oraganisation_Unit_Wise(HttpServletRequest request,ModelMap model,HttpSession session,String typeReport1,
		 ...
		 ArrayList<ArrayList<String>> Excel = OrgUnit.pdf_Oraganisation_Unit_Wise_ReportDataList(cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no,parent_arm,cadre);
