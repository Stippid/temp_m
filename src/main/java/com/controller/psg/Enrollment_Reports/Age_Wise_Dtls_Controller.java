...
import com.dao.psg.Enrollment_Reports.Pers_Foreign_LanguageDAO;
...
public class Age_Wise_Dtls_Controller {
	
	@Autowired
	Age_Wise_DtlsDAO ForAge;
	@Autowired
...
//	Pers_Common_Controller pers_com = new Pers_Common_Controller();
	...
	@RequestMapping(value = "/admin/Age_wise_dtls")
	public ModelAndView Age_wise_dtls(ModelMap Mmap, HttpSession session, HttpServletRequest request,
			@RequestParam(value = "msg", required = false) String msg) {
		
		Mmap.put("msg", msg);
	    
		String roleid = session.getAttribute("roleid").toString();
		Boolean val = roledao.ScreenRedirect("Age_wise_dtls", roleid);
		if (val == false) {
  	...
  	/*String  roleid = sessionA.getAttribute("roleid").toString();
		...
		Mmap.put("msg", msg);
				...
				return new ModelAndView("age_wise_dtls_tiles");
	}
	...
	@RequestMapping(value = "/age_wise_dtls_tablecount", method = RequestMethod.POST)
	public @ResponseBody long age_wise_dtls_tablecount(String Search,String orderColunm,String orderType,HttpSession sessionUserId,String cont_comd,String cont_corps,String cont_div,String cont_bde,
			String unit_name,String unit_sus_no/*,String user_role_id*/,String from_date, String to_date, String typeID, String posn_date, String servingID) throws SQLException {
		 String roleType = sessionUserId.getAttribute("roleType").toString();
		
		return ForAge.getage_wise_dtls_tablecount(Search, orderColunm, orderType, sessionUserId, cont_comd, cont_corps, cont_div, cont_bde, unit_name, unit_sus_no/*, user_role_id*/, from_date, to_date, typeID, posn_date, servingID);
	}
	
	
	@RequestMapping(value = "/age_wise_dtls_table", method = RequestMethod.POST)
	public @ResponseBody List<Map<String, Object>> age_wise_dtls_table(int startPage,String Search,int pageLength,String orderColunm,String orderType,HttpSession sessionUserId
		...
		return ForAge.getage_wise_dtls_table(startPage, pageLength, Search, orderColunm, orderType,sessionUserId, cont_comd, cont_corps, cont_div, cont_bde, 
				unit_name, unit_sus_no, /*user_role_id,*/from_date, to_date, typeID, posn_date, servingID);
	}
	
	
	
	
	@RequestMapping(value = "/age_wise_dtls_tablecountsum", method = RequestMethod.POST)
	public @ResponseBody long age_wise_dtls_tablecountsum(String Search,String orderColunm,String orderType,HttpSession sessionUserId
			,String msg,String cont_comd,String cont_corps,String cont_div,String cont_bde,
			String unit_name,String unit_sus_no, String from_date, String to_date, String typeID, String posn_date, String servingID) throws SQLException {
		 String roleType = sessionUserId.getAttribute("roleType").toString();
		
		return ForAge.getage_wise_dtls_tablecountsum(Search, orderColunm, orderType, sessionUserId, cont_comd, cont_corps, cont_div, cont_bde,
				 unit_name, unit_sus_no, from_date, to_date, typeID, posn_date, servingID);
	}


	@RequestMapping(value = "/age_wise_dtls_tablesum", method = RequestMethod.POST)
	public @ResponseBody List<Map<String, Object>> age_wise_dtls_tablesum(int startPage,String Search,int pageLength,String orderColunm,String orderType,HttpSession sessionUserId
			,String cont_comd,String cont_corps,String cont_div,String cont_bde,
			String unit_name,String unit_sus_no/*String user_role_id,*/, String from_date, String to_date, String typeID, String posn_date, String servingID) throws SQLException {
		 String roleType = sessionUserId.getAttribute("roleType").toString();
			String roleAccess = sessionUserId.getAttribute("roleAccess").toString();
		...
		return ForAge.getage_wise_dtls_tablesum(startPage, pageLength,Search,orderColunm, orderType,sessionUserId, cont_comd, cont_corps, cont_div, cont_bde,
				 unit_name, unit_sus_no, from_date, to_date, typeID, posn_date, servingID);
	}
