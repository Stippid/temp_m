...
import com.dao.psg.Enrollment_Reports.Details_of_Border_Area_Pers_Dao;
//import com.dao.psg.Enrollment_Report.Pers_Foreign_LanguageDAO;
//import com.dao.psg.Enrollment_Report.Pers_Foreign_LanguageDAO;
...
public class Details_of_Border_Area_Pers_Controller {
	...
	@Autowired
	Details_of_Border_Area_Pers_Dao BorderDao;
//	Pers_Common_Controller pers_com = new Pers_Common_Controller();
	...
	@RequestMapping(value = "/admin/Details_of_Border_Area_Pers_Url")
	public ModelAndView Details_of_Border_Area_Pers_Url(ModelMap Mmap, HttpSession session,
			@RequestParam(value = "msg", required = false) String msg, HttpServletRequest request) {
		
		String roleid = session.getAttribute("roleid").toString();
		Boolean val = roledao.ScreenRedirect("Details_of_Border_Area_Pers_Url", roleid);
		if (val == false) {
   	...
   	/*String  roleid = sessionA.getAttribute("roleid").toString();
		...
		//Mmap.put("getUserarm_codeList", ab.getUserarm_codeList());
				...
				return new ModelAndView("Details_of_Border_Area_Pers_Tiles");
	}
...
@RequestMapping(value = "/Details_of_Border_Area_Pers_Count", method = RequestMethod.POST)
public @ResponseBody long Details_of_Border_Area_Pers_Count(String Search,String orderColunm,String orderType,HttpSession sessionUserId
	...
	return BorderDao.Details_of_Border_Area_Pers_Count(Search,orderColunm, orderType, sessionUserId, cont_comd, cont_corps, cont_div, cont_bde,
			 unit_name, unit_sus_no,  state_id, district_id,off_cat);
}


@RequestMapping(value = "/Details_of_Border_Area_PersList", method = RequestMethod.POST)
public @ResponseBody List<Map<String, Object>> Details_of_Border_Area_PersList(int startPage,String Search,int pageLength,String orderColunm,String orderType,HttpSession sessionUserId
	...
	return BorderDao.Details_of_Border_Area_PersList(startPage, pageLength,Search,orderColunm, orderType,sessionUserId, cont_comd, cont_corps, cont_div, cont_bde,
			 unit_name, unit_sus_no,  state_id, district_id,off_cat);
}

@RequestMapping(value = "/Details_of_Border_Area_Pers_Summary_Count", method = RequestMethod.POST)
public @ResponseBody long Details_of_Border_Area_Pers_Summary_Count(String Search,String orderColunm,String orderType,HttpSession sessionUserId
		,String msg,String cont_comd,String cont_corps,String cont_div,String cont_bde,
		String unit_name,String unit_sus_no,String state_id,String district_id,String off_cat) throws SQLException {
	 String roleType = sessionUserId.getAttribute("roleType").toString();
	
	return BorderDao.Details_of_Border_Area_Pers_Summary_Count(Search,orderColunm, orderType, sessionUserId, cont_comd, cont_corps, cont_div, cont_bde,
			 unit_name, unit_sus_no, state_id, district_id,off_cat);
}


@RequestMapping(value = "/Details_of_Border_Area_Pers_Summary_List", method = RequestMethod.POST)
public @ResponseBody List<Map<String, Object>> Details_of_Border_Area_Pers_Summary_List(int startPage,String Search,int pageLength,String orderColunm,String orderType,HttpSession sessionUserId
		,String cont_comd,String cont_corps,String cont_div,String cont_bde,
		String unit_name,String unit_sus_no,String state_id,String district_id,String off_cat) throws SQLException {
	 String roleType = sessionUserId.getAttribute("roleType").toString();
		String roleAccess = sessionUserId.getAttribute("roleAccess").toString();
	...
	return BorderDao.Details_of_Border_Area_Pers_Summary_List(startPage, pageLength,Search,orderColunm, orderType,sessionUserId, cont_comd, cont_corps, cont_div, cont_bde,
			 unit_name, unit_sus_no, state_id, district_id,off_cat);
}
