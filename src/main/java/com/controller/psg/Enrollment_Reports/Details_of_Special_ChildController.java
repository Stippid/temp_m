...
import com.dao.psg.Enrollment_Reports.Details_of_Special_ChildDAO;
...
public class Details_of_Special_ChildController {
	...
	@Autowired
	Details_of_Special_ChildDAO ForMar;
	AllMethodsControllerOrbat m = new AllMethodsControllerOrbat();
	Psg_CommonController mcommon = new Psg_CommonController();
	psg_jco_CommonController jcom = new psg_jco_CommonController();

	@RequestMapping(value = "/admin/Details_of_Special_child")
	public ModelAndView Details_of_Special_child(ModelMap Mmap, HttpSession session, HttpServletRequest request,
			@RequestParam(value = "msg", required = false) String msg) throws ParseException {
		
//		Mmap.put("msg", msg);
	    
		String roleid = session.getAttribute("roleid").toString();
		Boolean val = roledao.ScreenRedirect("Details_of_Special_child", roleid);
		if (val == false) {
	...
	Mmap.put("msg", msg);
		...
		return new ModelAndView("Details_of_Special_Child_tiles");
	...
	@RequestMapping(value = "/special_child_tablecount", method = RequestMethod.POST)
	public @ResponseBody long special_child_tablecount(String Search,String orderColunm,String orderType,HttpSession sessionUserId,String cont_comd,String cont_corps,String cont_div,String cont_bde,
			String unit_name,String unit_sus_no/*,String user_role_id*/,String from_date, String to_date, String posn_date, String typeID, String rankID, String rankjcoID) throws SQLException {
		 String roleType = sessionUserId.getAttribute("roleType").toString();
		
		return ForMar.getspecial_child_tablecount(Search, orderColunm, orderType, sessionUserId, cont_comd, cont_corps, cont_div, cont_bde, unit_name, unit_sus_no
				/*, user_role_id*/, from_date, to_date, posn_date, typeID, rankID, rankjcoID);
	}
	
	
	@RequestMapping(value = "/special_child_table", method = RequestMethod.POST)
	public @ResponseBody List<Map<String, Object>> special_child_table(int startPage,String Search,int pageLength,String orderColunm,String orderType,HttpSession sessionUserId
			,String cont_comd,String cont_corps,String cont_div,String cont_bde, String unit_name,String unit_sus_no,
			/*String user_role_id,*/String from_date, String to_date, String posn_date, String typeID, String rankID, String rankjcoID) throws SQLException {
		 String roleType = sessionUserId.getAttribute("roleType").toString();
		...
		return ForMar.getspecial_child_table(startPage, pageLength, Search, orderColunm, orderType,sessionUserId, cont_comd, cont_corps, cont_div, cont_bde, 
				unit_name, unit_sus_no, /*user_role_id,*/from_date, to_date, posn_date, typeID, rankID, rankjcoID);
	}
	
	
	
	
	@RequestMapping(value = "/special_child_tablecountsum", method = RequestMethod.POST)
	public @ResponseBody long special_child_tablecountsum(String Search,String orderColunm,String orderType,HttpSession sessionUserId
			,String msg,String cont_comd,String cont_corps,String cont_div,String cont_bde, String unit_name,String unit_sus_no, 
			String from_date, String to_date, String posn_date, String typeID, String rankID, String rankjcoID) throws SQLException {
		 String roleType = sessionUserId.getAttribute("roleType").toString();
		
		return ForMar.getspecial_child_tablecountsum(Search, orderColunm, orderType, sessionUserId, cont_comd, cont_corps, cont_div, cont_bde,
				 unit_name, unit_sus_no, from_date, to_date, posn_date, typeID, rankID, rankjcoID);
	}


	@RequestMapping(value = "/special_child_tablesum", method = RequestMethod.POST)
	public @ResponseBody List<Map<String, Object>> special_child_tablesum(int startPage,String Search,int pageLength,String orderColunm,String orderType,HttpSession sessionUserId
			,String cont_comd,String cont_corps,String cont_div,String cont_bde, String unit_name,String unit_sus_no
			/*String user_role_id,*/, String from_date, String to_date, String posn_date, String typeID, String rankID, String rankjcoID) throws SQLException {
		 String roleType = sessionUserId.getAttribute("roleType").toString();
			String roleAccess = sessionUserId.getAttribute("roleAccess").toString();
		...
		return ForMar.getspecial_child_tablesum(startPage, pageLength,Search,orderColunm, orderType,sessionUserId, cont_comd, cont_corps, cont_div, cont_bde,
				 unit_name, unit_sus_no, from_date, to_date, posn_date, typeID, rankID, rankjcoID);
	}
	@RequestMapping(value = "/special_child_jco_tablecountsum", method = RequestMethod.POST)
	public @ResponseBody long special_child_jco_tablecountsum(String Search,String orderColunm,String orderType,HttpSession sessionUserId
			,String msg,String cont_comd,String cont_corps,String cont_div,String cont_bde, String unit_name,String unit_sus_no, 
			String from_date, String to_date, String posn_date, String typeID, String rankID, String rankjcoID) throws SQLException {
		 String roleType = sessionUserId.getAttribute("roleType").toString();
		
		return ForMar.getspecial_child_jco_tablecountsum(Search, orderColunm, orderType, sessionUserId, cont_comd, cont_corps, cont_div, cont_bde,
				 unit_name, unit_sus_no, from_date, to_date, posn_date, typeID, rankID, rankjcoID);
	}


	@RequestMapping(value = "/special_child_jco_tablesum", method = RequestMethod.POST)
	public @ResponseBody List<Map<String, Object>> special_child_jco_tablesum(int startPage,String Search,int pageLength,String orderColunm,String orderType,HttpSession sessionUserId
			,String cont_comd,String cont_corps,String cont_div,String cont_bde, String unit_name,String unit_sus_no
			/*String user_role_id,*/, String from_date, String to_date, String posn_date, String typeID, String rankID, String rankjcoID) throws SQLException {
		 String roleType = sessionUserId.getAttribute("roleType").toString();
			String roleAccess = sessionUserId.getAttribute("roleAccess").toString();
		...
		return ForMar.getspecial_child_jco_tablesum(startPage, pageLength,Search,orderColunm, orderType,sessionUserId, cont_comd, cont_corps, cont_div, cont_bde,
				 unit_name, unit_sus_no, from_date, to_date, posn_date, typeID, rankID, rankjcoID);
	}
}