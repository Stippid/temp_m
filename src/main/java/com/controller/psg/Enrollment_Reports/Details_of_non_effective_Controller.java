...
import com.dao.psg.Enrollment_Reports.Details_of_non_effectiveDAO;
...
public class Details_of_non_effective_Controller {
	
	@Autowired
	Details_of_non_effectiveDAO noneff;
	@Autowired
	...
	@RequestMapping(value = "/admin/Details_of_non_effective")
	public ModelAndView Pers_service(ModelMap Mmap, HttpSession session,
			@RequestParam(value = "msg", required = false) String msg, HttpServletRequest request) {
		Mmap.put("msg", msg);
	     
		String roleid = session.getAttribute("roleid").toString();
		Boolean val = roledao.ScreenRedirect("Details_of_non_effective", roleid);
		if (val == false) {
   	...
   	/*String  roleid = sessionA.getAttribute("roleid").toString();
		...
		return new ModelAndView("Details_of_non_effective_tiles");
	...
	@RequestMapping(value = "/search_non_effective_tablecount", method = RequestMethod.POST)
	public @ResponseBody long search_non_effective_tablecount(String Search,String orderColunm,String orderType,HttpSession sessionUserId
			,String msg,String cont_comd,String cont_corps,String cont_div,String cont_bde,
			String unit_name,String unit_sus_no, String typeID, String cause_of_non_effective,String from_date, String to_date) throws SQLException {
		 String roleType = sessionUserId.getAttribute("roleType").toString();
		
		return noneff.getsearch_non_effective_tablecount(Search,orderColunm, orderType, sessionUserId, cont_comd, cont_corps, cont_div, cont_bde,
				 unit_name, unit_sus_no,typeID, cause_of_non_effective, from_date,  to_date);
	}
	
	@RequestMapping(value = "/search_non_effective_table", method = RequestMethod.POST)
	public @ResponseBody List<Map<String, Object>> search_non_effective_table(int startPage,String Search,int pageLength,String orderColunm,String orderType,HttpSession sessionUserId
		...
		return noneff.getsearch_non_effective_table(startPage, pageLength,Search,orderColunm, orderType,sessionUserId,cont_comd, cont_corps, cont_div, cont_bde,
				 unit_name, unit_sus_no, typeID, cause_of_non_effective, from_date,  to_date);
	}
	
	
	@RequestMapping(value = "/search_non_effective_summery_tablecount", method = RequestMethod.POST)
	public @ResponseBody long search_non_effective_summery_tablecount(String Search,String orderColunm,String orderType,HttpSession sessionUserId
			,String msg,String cont_comd,String cont_corps,String cont_div,String cont_bde,	String unit_name,String unit_sus_no,String typeID, 
			String cause_of_non_effective,String from_date, String to_date) throws SQLException {
		 String roleType = sessionUserId.getAttribute("roleType").toString();
		
		return noneff.getsearch_non_effective_summery_tablecount(Search,orderColunm, orderType, sessionUserId, cont_comd, cont_corps, cont_div, cont_bde,
				 unit_name, unit_sus_no, typeID, cause_of_non_effective, from_date,  to_date);
	}
	
	@RequestMapping(value = "/search_non_effective_summery_table", method = RequestMethod.POST)
	public @ResponseBody List<Map<String, Object>> search_non_effective_summery_table(int startPage,String Search,int pageLength,String orderColunm,String orderType,HttpSession sessionUserId
			,String cont_comd,String cont_corps,String cont_div,String cont_bde,
			String unit_name,String unit_sus_no,String typeID, String cause_of_non_effective,String from_date, String to_date) {
		 String roleType = sessionUserId.getAttribute("roleType").toString();
			String roleAccess = sessionUserId.getAttribute("roleAccess").toString();
		...
		return noneff.getsearch_non_effective_summery_table(startPage, pageLength,Search,orderColunm, orderType,sessionUserId,cont_comd, cont_corps, cont_div, cont_bde,
				 unit_name, unit_sus_no,  typeID, cause_of_non_effective, from_date, to_date);
	}
