...
import com.dao.psg.Enrollment_Reports.Details_of_pan_uid_aadhaar_of_pers_from_hq_Dao;
...
public class Details_of_pan_uid_aadhaar_of_pers_from_hq_Controller {
	...
	@Autowired
	Details_of_pan_uid_aadhaar_of_pers_from_hq_Dao PrDao;
//	Pers_Common_Controller pers_com = new Pers_Common_Controller();
	AllMethodsControllerOrbat m = new AllMethodsControllerOrbat();
	Psg_CommonController mcommon = new Psg_CommonController();
	Psg_CommonController p_comm = new Psg_CommonController();
	
	@RequestMapping(value = "/admin/Details_of_pan_uid_aadhaar_of_pers_from_hq_Url")
	public ModelAndView Details_of_pan_uid_aadhaar_of_pers_from_hq_Url(ModelMap Mmap, HttpSession session,
			@RequestParam(value = "msg", required = false) String msg, HttpServletRequest request) {
		
		String roleid = session.getAttribute("roleid").toString();
		Boolean val = roledao.ScreenRedirect("Details_of_pan_uid_aadhaar_of_pers_from_hq_Url", roleid);
		if (val == false) {
   	...
   	/*String  roleid = sessionA.getAttribute("roleid").toString();
		...
		//Mmap.put("getUserarm_codeList", ab.getUserarm_codeList());
				...
				return new ModelAndView("Details_of_pan_uid_aadhaar_of_pers_from_hq_Tiles");
	}
...
@RequestMapping(value = "/Details_of_pan_uid_aadhaar_of_pers_from_hq_Count", method = RequestMethod.POST)
public @ResponseBody long Details_of_pan_uid_aadhaar_of_pers_from_hq_Count(String Search,String orderColunm,String orderType,HttpSession sessionUserId
		,String msg,String cont_comd,String cont_corps,String cont_div,String cont_bde,
		String unit_name,String unit_sus_no,String state_id,String district_id,String off_cat) throws SQLException {
	 String roleType = sessionUserId.getAttribute("roleType").toString();
	
	return PrDao.Details_of_pan_uid_aadhaar_of_pers_from_hq_Count(Search,orderColunm, orderType, sessionUserId, cont_comd, cont_corps, cont_div, cont_bde,
			 unit_name, unit_sus_no,  state_id, district_id,off_cat);
}


@RequestMapping(value = "/Details_of_pan_uid_aadhaar_of_pers_from_hqList", method = RequestMethod.POST)
public @ResponseBody List<Map<String, Object>> Details_of_pan_uid_aadhaar_of_pers_from_hqList(int startPage,String Search,int pageLength,String orderColunm,String orderType,HttpSession sessionUserId
	...
	return PrDao.Details_of_pan_uid_aadhaar_of_pers_from_hqList(startPage, pageLength,Search,orderColunm, orderType,sessionUserId, cont_comd, cont_corps, cont_div, cont_bde,
			 unit_name, unit_sus_no,  state_id, district_id,off_cat);
}

@RequestMapping(value = "/Details_of_pan_uid_aadhaar_of_pers_from_hq_Summary_Count", method = RequestMethod.POST)
public @ResponseBody long Details_of_pan_uid_aadhaar_of_pers_from_hq_Summary_Count(String Search,String orderColunm,String orderType,HttpSession sessionUserId
		,String msg,String cont_comd,String cont_corps,String cont_div,String cont_bde,
		String unit_name,String unit_sus_no,String state_id,String district_id,String off_cat) throws SQLException {
	 String roleType = sessionUserId.getAttribute("roleType").toString();
	
	return PrDao.Details_of_pan_uid_aadhaar_of_pers_from_hq_Summary_Count(Search,orderColunm, orderType, sessionUserId, cont_comd, cont_corps, cont_div, cont_bde,
			 unit_name, unit_sus_no, state_id, district_id,off_cat);
}


@RequestMapping(value = "/Details_of_pan_uid_aadhaar_of_pers_from_hq_Summary_List", method = RequestMethod.POST)
public @ResponseBody List<Map<String, Object>> Details_of_pan_uid_aadhaar_of_pers_from_hq_Summary_List(int startPage,String Search,int pageLength,String orderColunm,String orderType,HttpSession sessionUserId
		,String cont_comd,String cont_corps,String cont_div,String cont_bde,
		String unit_name,String unit_sus_no,String state_id,String district_id,String off_cat) throws SQLException {
	 String roleType = sessionUserId.getAttribute("roleType").toString();
		String roleAccess = sessionUserId.getAttribute("roleAccess").toString();
	...
	return PrDao.Details_of_pan_uid_aadhaar_of_pers_from_hq_Summary_List(startPage, pageLength,Search,orderColunm, orderType,sessionUserId, cont_comd, cont_corps, cont_div, cont_bde,
			 unit_name, unit_sus_no, state_id, district_id,off_cat);
}
