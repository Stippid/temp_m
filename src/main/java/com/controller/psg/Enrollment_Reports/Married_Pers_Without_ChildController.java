...
import com.dao.psg.Enrollment_Reports.Married_Pers_Without_ChildDAO;
import com.dao.psg.Enrollment_Reports.Pers_Visited_Foreign_CountryDAO;
...
public class Married_Pers_Without_ChildController {
	...
	@Autowired
	Married_Pers_Without_ChildDAO ForMar;
	AllMethodsControllerOrbat m = new AllMethodsControllerOrbat();
	Psg_CommonController mcommon = new Psg_CommonController();
	psg_jco_CommonController jcom = new psg_jco_CommonController();

	@RequestMapping(value = "/admin/Married_pers_without_child")
	public ModelAndView Married_pers_without_child(ModelMap Mmap, HttpSession session, HttpServletRequest request,
			@RequestParam(value = "msg", required = false) String msg) throws ParseException {
		
//		Mmap.put("msg", msg);
		String roleid = session.getAttribute("roleid").toString();
		Boolean val = roledao.ScreenRedirect("Married_pers_without_child", roleid);
		if (val == false) {
	...
	Mmap.put("msg", msg);
		...
		return new ModelAndView("Married_pers_without_child_tiles");
	...
	@RequestMapping(value = "/married_pers_without_child_tablecount", method = RequestMethod.POST)
	public @ResponseBody long married_pers_without_child_tablecount(String Search,String orderColunm,String orderType,HttpSession sessionUserId,String cont_comd,String cont_corps,String cont_div,String cont_bde,
		...
		return ForMar.getmarried_pers_without_child_tablecount(Search, orderColunm, orderType, sessionUserId, cont_comd, cont_corps, cont_div, cont_bde, unit_name, unit_sus_no
				/*, user_role_id*/, posn_date, typeID, rankID, rankjcoID);
	}
	
	
	@RequestMapping(value = "/married_pers_without_child_table", method = RequestMethod.POST)
	public @ResponseBody List<Map<String, Object>> married_pers_without_child_table(int startPage,String Search,int pageLength,String orderColunm,String orderType,HttpSession sessionUserId
			,String cont_comd,String cont_corps,String cont_div,String cont_bde, String unit_name,String unit_sus_no,
			/*String user_role_id,*/ String posn_date, String typeID, String rankID, String rankjcoID) throws SQLException {
		 String roleType = sessionUserId.getAttribute("roleType").toString();
		...
		return ForMar.getmarried_pers_without_child_table(startPage, pageLength, Search, orderColunm, orderType,sessionUserId, cont_comd, cont_corps, cont_div, cont_bde, 
				unit_name, unit_sus_no, /*user_role_id,*/ posn_date, typeID, rankID, rankjcoID);
	}
	
	
	
	
	@RequestMapping(value = "/married_pers_without_child_tablecountsum", method = RequestMethod.POST)
	public @ResponseBody long married_pers_without_child_tablecountsum(String Search,String orderColunm,String orderType,HttpSession sessionUserId
		...
		return ForMar.getmarried_pers_without_child_tablecountsum(Search, orderColunm, orderType, sessionUserId, cont_comd, cont_corps, cont_div, cont_bde,
				 unit_name, unit_sus_no, posn_date, typeID, rankID, rankjcoID);
	}


	@RequestMapping(value = "/married_pers_without_child_tablesum", method = RequestMethod.POST)
	public @ResponseBody List<Map<String, Object>> married_pers_without_child_tablesum(int startPage,String Search,int pageLength,String orderColunm,String orderType,HttpSession sessionUserId
			,String cont_comd,String cont_corps,String cont_div,String cont_bde, String unit_name,String unit_sus_no
			/*String user_role_id,*/, String posn_date, String typeID, String rankID, String rankjcoID) throws SQLException {
		 String roleType = sessionUserId.getAttribute("roleType").toString();
			String roleAccess = sessionUserId.getAttribute("roleAccess").toString();
		...
		return ForMar.getmarried_pers_without_child_tablesum(startPage, pageLength,Search,orderColunm, orderType,sessionUserId, cont_comd, cont_corps, cont_div, cont_bde,
				 unit_name, unit_sus_no,  posn_date, typeID, rankID, rankjcoID);
	}
