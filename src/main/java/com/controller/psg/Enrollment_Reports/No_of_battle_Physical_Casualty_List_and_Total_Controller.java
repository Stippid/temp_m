...
import com.dao.psg.Enrollment_Reports.No_of_battle_Physical_Casualty_List_and_Total_Dao;
...
public class No_of_battle_Physical_Casualty_List_and_Total_Controller {
	...
	@Autowired
	No_of_battle_Physical_Casualty_List_and_Total_Dao BattleDao;
	AllMethodsControllerOrbat m = new AllMethodsControllerOrbat();
	Psg_CommonController mcommon = new Psg_CommonController();
	Psg_CommonController p_comm = new Psg_CommonController();
	
	@RequestMapping(value = "/admin/No_of_battle_Physical_Casualty_List_and_Total_Url")
	public ModelAndView No_of_battle_Physical_Casualty_List_and_Total_Url(ModelMap Mmap, HttpSession session,
			@RequestParam(value = "msg", required = false) String msg, HttpServletRequest request) {
		
		String roleid = session.getAttribute("roleid").toString();
		Boolean val = roledao.ScreenRedirect("No_of_battle_Physical_Casualty_List_and_Total_Url", roleid);
		if (val == false) {
   	...
   	/*String  roleid = sessionA.getAttribute("roleid").toString();
		...
		return new ModelAndView("No_of_battle_Physical_Casualty_List_and_Total_Tiles");
	}
...
@RequestMapping(value = "/No_of_battle_Physical_Casualty_List_and_Total_Count", method = RequestMethod.POST)
public @ResponseBody long No_of_battle_Physical_Casualty_List_and_Total_Count(String Search,String orderColunm,String orderType,HttpSession sessionUserId
		,String msg,String cont_comd,String cont_corps,String cont_div,String cont_bde,
		String unit_name,String unit_sus_no,String off_cat,String from_date,String to_date) throws SQLException {
	 String roleType = sessionUserId.getAttribute("roleType").toString();
	
	return BattleDao.No_of_battle_Physical_Casualty_List_and_Total_Count(Search,orderColunm, orderType, sessionUserId, cont_comd, cont_corps, cont_div, cont_bde,
			 unit_name, unit_sus_no,off_cat, from_date, to_date);
}


@RequestMapping(value = "/No_of_battle_Physical_Casualty_List_and_TotalList", method = RequestMethod.POST)
public @ResponseBody List<Map<String, Object>> No_of_battle_Physical_Casualty_List_and_TotalList(int startPage,String Search,int pageLength,String orderColunm,String orderType,HttpSession sessionUserId
	...
	return BattleDao.No_of_battle_Physical_Casualty_List_and_TotalList(startPage, pageLength,Search,orderColunm, orderType,sessionUserId, cont_comd, cont_corps, cont_div, cont_bde,
			 unit_name, unit_sus_no,  off_cat, from_date, to_date);
}

@RequestMapping(value = "/No_of_battle_Physical_Casualty_List_and_Total_Summary_Count", method = RequestMethod.POST)
public @ResponseBody long No_of_battle_Physical_Casualty_List_and_Total_Summary_Count(String Search,String orderColunm,String orderType,HttpSession sessionUserId
		,String msg,String cont_comd,String cont_corps,String cont_div,String cont_bde,
		String unit_name,String unit_sus_no,String off_cat,String from_date,String to_date) throws SQLException {
	 String roleType = sessionUserId.getAttribute("roleType").toString();
	
	return BattleDao.No_of_battle_Physical_Casualty_List_and_Total_Summary_Count(Search,orderColunm, orderType, sessionUserId, cont_comd, cont_corps, cont_div, cont_bde,
			 unit_name, unit_sus_no,off_cat, from_date, to_date);
}


@RequestMapping(value = "/No_of_battle_Physical_Casualty_List_and_Total_Summary_List", method = RequestMethod.POST)
public @ResponseBody List<Map<String, Object>> No_of_battle_Physical_Casualty_List_and_Total_Summary_List(int startPage,String Search,int pageLength,String orderColunm,String orderType,HttpSession sessionUserId
		,String cont_comd,String cont_corps,String cont_div,String cont_bde,
		String unit_name,String unit_sus_no,String off_cat,String from_date,String to_date) throws SQLException {
	 String roleType = sessionUserId.getAttribute("roleType").toString();
		String roleAccess = sessionUserId.getAttribute("roleAccess").toString();
	...
	return BattleDao.No_of_battle_Physical_Casualty_List_and_Total_Summary_List(startPage, pageLength,Search,orderColunm, orderType,sessionUserId, cont_comd, cont_corps, cont_div, cont_bde,
			 unit_name, unit_sus_no,off_cat, from_date, to_date);
}
