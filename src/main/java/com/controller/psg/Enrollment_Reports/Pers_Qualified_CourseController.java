...
import com.dao.psg.Enrollment_Reports.Pers_Qual_Dao;
...
public class Pers_Qualified_CourseController {
	
	@Autowired
	Pers_Qual_Dao adminDash;
	@Autowired
	private RoleBaseMenuDAO roledao;
	AllMethodsControllerOrbat m = new AllMethodsControllerOrbat();
	Psg_CommonController mcommon = new Psg_CommonController();
	@RequestMapping(value = "/admin/Pers_qualified_course")
	public ModelAndView Pers_qualified_course(ModelMap Mmap, HttpSession session,
			@RequestParam(value = "msg", required = false) String msg, HttpServletRequest request) {
		
		String roleid = session.getAttribute("roleid").toString();
		Boolean val = roledao.ScreenRedirect("Pers_qualified_course", roleid);
		if (val == false) {
		...
		if (request.getHeader("Referer") == null) {
		  ...
		  Mmap.put("msg", msg);
			 ...
			 */
		return new ModelAndView("pers_qualified_course_tiles");
	...
	@RequestMapping(value = "/search_qualification_tablecount", method = RequestMethod.POST)
	public @ResponseBody long search_qualification_tablecount(String Search,String orderColunm,String orderType,HttpSession sessionUserId
			,String msg,String cont_comd,String cont_corps,String cont_div,String cont_bde,
			String unit_name,String unit_sus_no, String typeID, String army_course_name1, 
			String army_course_div_grade1, String posn_date) throws SQLException {
		 String roleType = sessionUserId.getAttribute("roleType").toString();
		
		return adminDash.getsearch_qualification_tablecount(Search,orderColunm, orderType, sessionUserId, cont_comd, cont_corps, cont_div, cont_bde,
				 unit_name, unit_sus_no, typeID, army_course_name1, army_course_div_grade1,  posn_date);
	}
	
	@RequestMapping(value = "/search_qualification_table", method = RequestMethod.POST)
	public @ResponseBody List<Map<String, Object>> search_qualification_table(int startPage,String Search,int pageLength,String orderColunm,String orderType,HttpSession sessionUserId
		...
		return adminDash.getsearch_qualification_table(startPage, pageLength,Search,orderColunm, orderType,sessionUserId,cont_comd, cont_corps, cont_div, cont_bde,
				 unit_name, unit_sus_no, typeID, army_course_name1, army_course_div_grade1,  posn_date);
	}
	
	
	@RequestMapping(value = "/search_qualification_course_tablecount", method = RequestMethod.POST)
	public @ResponseBody long search_qualification_course_tablecount(String Search,String orderColunm,String orderType,HttpSession sessionUserId
			,String msg,String cont_comd,String cont_corps,String cont_div,String cont_bde,
			String unit_name,String unit_sus_no, String typeID, String army_course_name1, String army_course_div_grade1, String posn_date) throws SQLException {
		 String roleType = sessionUserId.getAttribute("roleType").toString();
		
		return adminDash.getsearch_qualification_course_tablecount(Search,orderColunm, orderType, sessionUserId, cont_comd, cont_corps, cont_div, cont_bde,
				 unit_name, unit_sus_no, typeID, army_course_name1, army_course_div_grade1,  posn_date);
	}
	
	@RequestMapping(value = "/search_qualification_course_table", method = RequestMethod.POST)
	public @ResponseBody List<Map<String, Object>> search_qualification_course_table(int startPage,String Search,int pageLength,String orderColunm,String orderType,HttpSession sessionUserId
			,String cont_comd,String cont_corps,String cont_div,String cont_bde,
			String unit_name,String unit_sus_no, String typeID, String army_course_name1, String army_course_div_grade1, String posn_date) {
		 String roleType = sessionUserId.getAttribute("roleType").toString();
			String roleAccess = sessionUserId.getAttribute("roleAccess").toString();
		...
		return adminDash.getsearch_qualification_course_table(startPage, pageLength,Search,orderColunm, orderType,sessionUserId,cont_comd, cont_corps, cont_div, cont_bde,
				 unit_name, unit_sus_no, typeID, army_course_name1, army_course_div_grade1,  posn_date);
	}
