...
import com.dao.psg.Enrollment_Reports.Pers_Service_Dao;
...
public class Pers_ServiceController {
	
	@Autowired
	Pers_Service_Dao serviceDash;
	@Autowired
	...
	@RequestMapping(value = "/admin/Pers_service")
	public ModelAndView Pers_service(ModelMap Mmap, HttpSession session,
			@RequestParam(value = "msg", required = false) String msg, HttpServletRequest request) {
		Mmap.put("msg", msg);
	     
		String roleid = session.getAttribute("roleid").toString();
		Boolean val = roledao.ScreenRedirect("Pers_service", roleid);
		if (val == false) {
   	...
   	/*String  roleid = sessionA.getAttribute("roleid").toString();
		...
		return new ModelAndView("Pers_service_tiles");
	...
	@RequestMapping(value = "/search_service_tablecount", method = RequestMethod.POST)
	public @ResponseBody long search_qualification_tablecount(String Search,String orderColunm,String orderType,HttpSession sessionUserId
			...
			String unit_name,String unit_sus_no, String rankID,String rankJcoID,String serving, String typeID, String posn_date) throws SQLException {
		 String roleType = sessionUserId.getAttribute("roleType").toString();
		
		return serviceDash.getsearch_service_tablecount(Search,orderColunm, orderType, sessionUserId, cont_comd, cont_corps, cont_div, cont_bde,
				 unit_name, unit_sus_no, rankID, rankJcoID, serving, typeID,posn_date);
	}
	
	@RequestMapping(value = "/search_service_table", method = RequestMethod.POST)
	public @ResponseBody List<Map<String, Object>> search_qualification_table(int startPage,String Search,int pageLength,String orderColunm,String orderType,HttpSession sessionUserId
		...
		return serviceDash.getsearch_service_table(startPage, pageLength,Search,orderColunm, orderType,sessionUserId,cont_comd, cont_corps, cont_div, cont_bde,
				 unit_name, unit_sus_no, rankID, rankJcoID, serving, typeID,posn_date);
	}
	
	
	@RequestMapping(value = "/search_service_summery_tablecount", method = RequestMethod.POST)
	public @ResponseBody long search_qualification_course_tablecount(String Search,String orderColunm,String orderType,HttpSession sessionUserId
			,String msg,String cont_comd,String cont_corps,String cont_div,String cont_bde,String unit_name,String unit_sus_no, String rankID, 
			String rankJcoID,String serving, String typeID, String posn_date) throws SQLException {
		 String roleType = sessionUserId.getAttribute("roleType").toString();
		
		return serviceDash.getsearch_service_summery_tablecount(Search,orderColunm, orderType, sessionUserId, cont_comd, cont_corps, cont_div, cont_bde,
				 unit_name, unit_sus_no, rankID, 
				 rankJcoID, serving, typeID,posn_date);
	}
	
	@RequestMapping(value = "/search_service_summery_table", method = RequestMethod.POST)
	public @ResponseBody List<Map<String, Object>> search_qualification_course_table(int startPage,String Search,int pageLength,String orderColunm,String orderType,HttpSession sessionUserId
		...
		return serviceDash.getsearch_service_summery_table(startPage, pageLength,Search,orderColunm, orderType,sessionUserId,cont_comd, cont_corps, cont_div, cont_bde,
				 unit_name, unit_sus_no, rankID,  rankJcoID, serving, typeID,posn_date);
	}
