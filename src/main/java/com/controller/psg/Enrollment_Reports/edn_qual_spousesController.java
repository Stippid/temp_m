...
import com.dao.psg.Enrollment_Reports.Edn_Qual_Spouses_Dao;
...
public class edn_qual_spousesController {
	
	@Autowired
	Edn_Qual_Spouses_Dao spouses;
	@Autowired
	private RoleBaseMenuDAO roledao;
	AllMethodsControllerOrbat m = new AllMethodsControllerOrbat();
	Psg_CommonController mcommon = new Psg_CommonController();

	@RequestMapping(value = "/admin/edn_qual_spouses")
	public ModelAndView Pers_qualified_course(ModelMap Mmap, HttpSession session,
			@RequestParam(value = "msg", required = false) String msg, HttpServletRequest request) {
		
		String roleid = session.getAttribute("roleid").toString();
		Boolean val = roledao.ScreenRedirect("edn_qual_spouses", roleid);
		if (val == false) {
		...
		if (request.getHeader("Referer") == null) {
		  ...
		  Mmap.put("msg", msg);
			...
			Mmap.put("msg", msg);
			Mmap.put("getExaminatonPassed", getExaminatonPassed());
			Mmap.put("date", date1);	
			Mmap.put("msg", msg);
		
			
				return new ModelAndView("edn_qual_spouses_tiles");
	}
	...
	public List<String> getExaminatonPassed() {
	...
	@RequestMapping(value = "/search_qualification_spouses_tablecount", method = RequestMethod.POST)
	public @ResponseBody long search_qualification_spouses_tablecount(String Search,String orderColunm,String orderType,HttpSession sessionUserId
			,String msg,String cont_comd,String cont_corps,String cont_div,String cont_bde,
			String unit_name,String unit_sus_no, String typeID, String examination) throws SQLException {
		 String roleType = sessionUserId.getAttribute("roleType").toString();
		
		return spouses.getsearch_qualification_spouses_tablecount( Search, orderColunm, orderType, sessionUserId, cont_comd, cont_corps, cont_div, cont_bde,
				 unit_name, unit_sus_no,  typeID,examination);
	}
	
	@RequestMapping(value = "/search_qualification_spouses_table", method = RequestMethod.POST)
	public @ResponseBody List<Map<String, Object>> search_qualification_spouses_table(int startPage,String Search,int pageLength,String orderColunm,String orderType,HttpSession sessionUserId
		...
		return spouses.getsearch_qualification_spouses_table( startPage,  pageLength,  Search,
				 orderColunm,  orderType,  sessionUserId,  cont_comd,  cont_corps,
				 cont_div,  cont_bde,  unit_name,  unit_sus_no,  typeID,  examination);
	}
	
	
	@RequestMapping(value = "/search_qualification_spouses_summary_tablecount", method = RequestMethod.POST)
	public @ResponseBody long search_qualification_spouses_summary_tablecount(String Search,String orderColunm,String orderType,HttpSession sessionUserId
			,String msg,String cont_comd,String cont_corps,String cont_div,String cont_bde,
			String unit_name,String unit_sus_no, String typeID, String examination) throws SQLException {
		 String roleType = sessionUserId.getAttribute("roleType").toString();
		
		return spouses.getsearch_qualification_spouses_summary_tablecount( Search, orderColunm, orderType, sessionUserId, cont_comd, cont_corps, cont_div, cont_bde,
				 unit_name, unit_sus_no,  typeID, examination );
	}
	
	@RequestMapping(value = "/search_qualification_spouses_summary_table", method = RequestMethod.POST)
	public @ResponseBody List<Map<String, Object>> search_qualification_spouses_summary_table(int startPage,String Search,int pageLength,String orderColunm,String orderType,HttpSession sessionUserId
			,String cont_comd,String cont_corps,String cont_div,String cont_bde,
			String unit_name,String unit_sus_no, String typeID, String examination) {
		 String roleType = sessionUserId.getAttribute("roleType").toString();
			String roleAccess = sessionUserId.getAttribute("roleAccess").toString();
		...
		return spouses.getsearch_qualification_spouses_summary_table( startPage,  pageLength,  Search,
				 orderColunm,  orderType,  sessionUserId,  cont_comd,  cont_corps, cont_div,  cont_bde,  unit_name,  unit_sus_no,  typeID, examination);
	}
