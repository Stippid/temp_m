...
import com.dao.psg.JCO_Popup.Religion_Popup_JCO_DAO;

@Controller
@RequestMapping(value = {"admin","/","user"})
public class PopUp_ChangeInReligion_JCO_Controller {
	@Autowired
	Religion_Popup_JCO_DAO religionDao;
	...
	private RoleBaseMenuDAO roledao;
	 ...
	 public ModelAndView Change_in_ReligionUrl(ModelMap Mmap, HttpSession session,
			 ...
			 @RequestParam(value = "religion_jco_id", required = false) String religion_jco_id) {
		 ...
		 Boolean val = roledao.ScreenRedirect("update_jco_data_url", session.getAttribute("roleid").toString());
			...
			Mmap.put("list", religionDao.Religion_PopUp_JCO(Integer.parseInt(religion_jco_id)));
			 Mmap.put("msg", msg);
			 return new ModelAndView("Religion_Popup_JCOTiles");
	 }
}
