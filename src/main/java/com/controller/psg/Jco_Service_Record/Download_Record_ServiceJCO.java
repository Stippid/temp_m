package com.controller.psg.Jco_Service_Record;
		...
		public class Download_Record_ServiceJCO extends AbstractPdfView {
			...
			public Download_Record_ServiceJCO(String Type,String Heading,String username,String foot,

					

					List<String> TH,List<String> TH1,List<String> TH2,List<String> TH3,List<String> TH4,List<String> TH5,List<String> TH6,List<String> TH7,

					List<String> TH8,List<String> TH9,List<String> TH10,List<String> TH11,List<String> TH12,List<String> TH13,List<String> TH14,List<String> TH15,

					List<Map<String, Object>> listSH,List<Map<String, Object>> listFM,

					List<Map<String, Object>> listS,List<Map<String, Object>> listCHILD,List<Map<String, Object>> listAM,List<Map<String, Object>> listTENU,

					List<Map<String, Object>> listRegim,List<Map<String, Object>> listFIS,List<Map<String, Object>> listARM,List<Map<String, Object>> listPE,

					List<Map<String, Object>> listAQ,List<Map<String, Object>> listPTQ,	List<Map<String, Object>> listIL,List<Map<String, Object>> listFL,

					List<Map<String, Object>> listF,List<Map<String, Object>> listB,List<Map<String, Object>> listFS,List<Map<String, Object>> listBA,

					List<Map<String, Object>> listORM,List<Map<String, Object>> listPDO,List<Map<String, Object>> listPM,

					List<Map<String, Object>> listPS,List<Map<String, Object>> listNOK,List<Map<String, Object>> listNA

					,List<Map<String, Object>> listTENU_T,List<Map<String, Object>> listAR,String peace_month,List<Map<String, Object>> listRD,String serving_status){

				

				this.Type = Type;this.Heading = Heading;this.username = username;

				

				this.TH = TH;this.TH1 = TH1;this.TH2 = TH2;this.TH3 = TH3;this.TH4 = TH4;	this.TH5 = TH5;this.TH6 = TH6;this.TH7 = TH7;this.TH8 = TH8;this.TH9 = TH9;

				this.TH10 = TH10;this.TH11 = TH11;this.TH12 = TH12;this.TH13 = TH13;this.TH14 = TH14;this.TH15 = TH15;

				this.listSH=listSH;this.listFM=listFM;this.listS=listS;this.listCHILD=listCHILD;this.listAM=listAM;

				this.listTENU=listTENU;this.listRegim=listRegim;this.listFIS=listFIS;this.listARM=listARM;this.listPE=listPE;this.listAQ=listAQ;this.listPTQ=listPTQ;

				this.listIL=listIL;this.listFL=listFL;this.listF=listF;this.listB=listB;this.listFS=listFS;this.listBA=listBA;this.listORM=listORM;

				this.listPDO=listPDO;this.listPM=listPM;this.listPS=listPS;this.listNOK=listNOK;this.listNA=listNA;this.listAR=listAR;

				this.peace_month=peace_month;this.foot=foot;
			...
			protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter arg2,
				...
				///Chunk glue = new Chunk(new VerticalPositionMark());
				 ...
				 PdfPTable tablesleft = new PdfPTable(5);
					...
					try {
						//26-01-1994
//						String fullPath = aList.get(0).get("identity_image").toString();
//						File downloadFile = new File(fullPath);
//					Image idimage = Image.getInstance(downloadFile.toString());		
					...
					cellimage.setVerticalAlignment(Rectangle.LEFT);
						...
						String no_imagestr =  request.getRealPath("/")+"admin"+File.separator+"js"+File.separator+"img"+File.separator+"No_Image.jpg";
					...
					PdfPCell wfg= new PdfPCell(new Paragraph("PERSONAL DETAILS",fontTableheader));
					...
					pl= new Paragraph("Army No:",fontTableHeading);

					tableleft.addCell(pl);

					plv= new Paragraph(aList.get(0).get("army_no").toString(),fontTableValue);
					...
					pl= new Paragraph("Medical Category  :",fontTableHeading);

					tableleft.addCell(pl);

					if(listSH.size() > 0) {
					plv= new Paragraph(listSH.get(0).get("shape").toString(),fontTableValue);
					}else {
					...
					pl= new Paragraph("Medical Cope  :",fontTableHeading);

					tableleft.addCell(pl);
					if(listSH.size() > 0) {

					plv= new Paragraph(listSH.get(0).get("cope").toString(),fontTableValue);
					}else {
						plv= new Paragraph("",fontTableValue);
					...
					pl= new Paragraph("I-Card No:",fontTableHeading);
					...
					pr= new Paragraph("Name :",fontTableHeading);

					tableright.addCell(pr);

					prv= new Paragraph(aList.get(0).get("full_name").toString(),fontTableValue);
					...
					prv= new Paragraph(aList.get(0).get("date_of_tos").toString(),fontTableValue);
					...
					pr= new Paragraph("Aadhar No:",fontTableHeading);

					tableright.addCell(pr);

					prv= new Paragraph(aList.get(0).get("aadhar_no").toString(),fontTableValue);
					...
					prv= new Paragraph(aList.get(0).get("centimeter").toString(),fontTableValue);
				...
				/*	if(listSH.size() > 0) {
					...
					if(listFM.size() > 0) {
						...
						plv= new Paragraph(listFM.get(0).get("father_name").toString(),fontTableValue);
						...
						pr= new Paragraph("Father's Date of Birth:",fontTableHeading);

						tablerightFM.addCell(pr);

						prv= new Paragraph(listFM.get(0).get("father_dob").toString(),fontTableValue);
			  ...
			  if(listS.size() > 0) { for (Map<String, Object> featureService : listS) { for

			  (Map.Entry<String, Object> entry : featureService.entrySet()) { 
			  ...
			  } }else { p = new Paragraph("No Data available"); PdfPCell c1 = new

			  PdfPCell(p); c1.setColspan(10);

			  c1.setHorizontalAlignment(Element.ALIGN_CENTER); table2.addCell(c1); }
			 ...
			 * if(listTENU_T.size() > 0) { Paragraph p1 = new

			 * Paragraph(listTENU_T.get(0).get("Total_tenure").toString(),fontTableValue);

			 * PdfPCell c0 = new PdfPCell(p1); c0.setColspan(1);

			 * c0.setHorizontalAlignment(Element.ALIGN_CENTER); table5.addCell(c0); }
			 ...
			 */
				...
				if (listFIS.size() > 0) {
					    ...
					    pl= new Paragraph("Peace:",fontTableHeading);

						tableleftFIS.addCell(pl);

						plv= new Paragraph(peace_month+" months",fontTableValue);
						...
						pr= new Paragraph("Field:",fontTableHeading);

						tablerightFIS.addCell(pr);

			    		prv= new Paragraph(listFIS.get(0).get("field").toString()+" months",fontTableValue);
...
//
//							prv= new Paragraph(listORM.get(0).get("ori_state").toString(),fontTableValue);
//
						...
						if (listPM.size() > 0) {
									...
									header1= new Paragraph("PERMANENT  ADDRESS",fontTableHeader1);
									 ...
									 table111.addCell(new Phrase("\n"));
										...
										plv= new Paragraph(listPM.get(0).get("pm_country").toString(),fontTableValue);
										...
										prv= new Paragraph(listPM.get(0).get("pm_state").toString(),fontTableValue);
						...
						if (listPS.size() > 0) {
							...
							header1= new Paragraph("PRESENT ADDRESS",fontTableHeader1);
							 ...
							 table111.addCell(new Phrase("\n"));
								...
								plv= new Paragraph(listPS.get(0).get("ps_country").toString(),fontTableValue);
								...
								prv= new Paragraph(listPS.get(0).get("ps_state").toString(),fontTableValue);
...
//								fontTableValue); tablerightPS.addCell(prv);
					...
					if(listNOK.size() > 0) {		
								...
								header1= new Paragraph("NOK DEAILS",fontTableHeader1);
								...
								pl= new Paragraph("Name of NOK:",fontTableHeading);

								tableleftNOK.addCell(pl);

								plv= new Paragraph(listNOK.get(0).get("nok_name").toString(),fontTableValue);
								...
								pr= new Paragraph("Nok Relation:",fontTableHeading);

								tablerightNOK.addCell(pr);

								prv= new Paragraph(listNOK.get(0).get("relation_name").toString(),fontTableValue);
						...
						if (listNA.size() > 0) {
							 ...
							 table111.addCell(new Phrase("\n"));
								...
								plv= new Paragraph(listNA.get(0).get("nok_country").toString(),fontTableValue);
								...
								prv= new Paragraph(listNA.get(0).get("nok_state").toString(),fontTableValue);
			...
			if (listRD.size() > 0) {
				...
				if (listAR.size() > 0) {
					 ...
					 table111.addCell(new Phrase("\n"));
						...
						plv= new Paragraph(listAR.get(0).get("ar_country").toString(),fontTableValue);
						...
						prv= new Paragraph(listAR.get(0).get("ar_state").toString(),fontTableValue);
				...
				header1= new Paragraph("RETIREMENT DETAILS",fontTableHeader1);
				 ...
				 table111.addCell(new Phrase("\n"));
					...
					pl= new Paragraph("Cause of Retirement:",fontTableHeading);
					...
					prv= new Paragraph(listRD.get(0).get("causes_name").toString(),fontTableValue);
					...
					pl= new Paragraph("Cause of Release From Re-Call:",fontTableHeading);
					...
					pr= new Paragraph("Date of Retirement:",fontTableHeading);
					...
					prv= new Paragraph(listRD.get(0).get("date_of_non_effective").toString(),fontTableValue);
					...
					pr= new Paragraph("Date of Release of Re-Call:",fontTableHeading);
			...
			class ImageBackgroundEvent implements PdfPTableEvent {
				...
				public void tableLayout(PdfPTable table, float[][] widths, float[] heights, int headerRows, int rowStart,PdfContentByte[] canvases) {
					...
					try {
				        ...
				        ColumnText.showTextAligned(cb, PdfContentByte.ALIGN_RIGHT, p, cb.getPdfDocument( ).right( ) - width, cb.getPdfDocument( ).top( ) + 9, 0);
