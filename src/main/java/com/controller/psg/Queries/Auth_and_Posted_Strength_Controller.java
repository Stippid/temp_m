...
import com.controller.ExportFile.Auth_and_Posted_Strengh;
...
import com.dao.psg.Queries.Auth_and_Posted_StrengthDAO;
import com.models.Tbl_CodesForm;

@Controller
@RequestMapping(value = { "admin", "/", "user" })
public class Auth_and_Posted_Strength_Controller {
	...
	@Autowired
	private Auth_and_Posted_StrengthDAO authpostDAO;
	@Autowired
	private RoleBaseMenuDAO roledao;
	@RequestMapping(value = "/admin/Auth_and_Posted_Strength", method = RequestMethod.GET)
	public ModelAndView Auth_and_Posted_Strength(ModelMap Mmap, HttpSession sessionA,
		...
		return new ModelAndView("Auth_and_Posted_Strength_Tiles");
	}
	
	 @RequestMapping(value = "/getAuth_and_Posted_StrengthReportDataList", method = RequestMethod.POST)
	 public @ResponseBody List<Map<String, Object>> getAuth_and_Posted_StrengthReportDataList(int startPage,String pageLength,String Search,String orderColunm,String orderType,
		 ...
		 return authpostDAO.getAuth_and_Posted_StrengthReportDataListDetails(startPage,pageLength,Search,orderColunm,orderType,cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no,sessionUserId);
	}
	 
	 @RequestMapping(value = "/getAuth_and_Posted_StrengthTotalCount", method = RequestMethod.POST)
	 public @ResponseBody long getAuth_and_Posted_StrengthTotalCount(HttpSession sessionUserId,String Search,String cont_comd,String cont_corps,String cont_div,String cont_bde,String unit_name,String sus_no){
	 	return authpostDAO.getAuth_and_Posted_StrengthTotalCountDtl(Search,cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no);
	 }
	 
	 @RequestMapping(value = "/Download_Auth_Posted_query",method = RequestMethod.POST)
		public ModelAndView Download_Auth_Posted_query(
		 ...
		 String roleid = sessionEdit.getAttribute("roleid").toString();
			...
			ArrayList<ArrayList<String>> pdfprint = authpostDAO.pdf_getAuth_and_Posted_StrenghReportDataList(cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no);
...
//				TH.add("SUS No");
			...
			return new ModelAndView(new Auth_and_Posted_Strengh(Heading,TH,foot,username,pdfprint,cont_comd_tx,cont_corps_tx,cont_div_tx,cont_bde_tx,unit_name,sus_no),"userList",pdfprint);
		}
	 
	 @RequestMapping(value = "/Excel_Auth_Posted_query", method = RequestMethod.POST)
		public ModelAndView Excel_Auth_Posted_query(HttpServletRequest request,ModelMap model,HttpSession session,String typeReport1,
				...
				@ModelAttribute("unit_name_ex") String unit_name,@ModelAttribute("sus_no_ex") String sus_no,@RequestParam(value = "msg", required = false) String msg) {
		 ...
		 ArrayList<ArrayList<String>> Excel = authpostDAO.pdf_getAuth_and_Posted_StrenghReportDataList(cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no);
