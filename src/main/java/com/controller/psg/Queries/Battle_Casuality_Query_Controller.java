...
import com.dao.psg.Queries.Battle_Casuality_Query_DAO;
import com.models.Tbl_CodesForm;

@Controller
@RequestMapping(value = { "admin", "/", "user" })
public class Battle_Casuality_Query_Controller {
	...
	@Autowired
	Battle_Casuality_Query_DAO BCD;
	@Autowired
	private RoleBaseMenuDAO roledao;
	
	@RequestMapping(value = "/admin/Battle_Casuality_QueryUrl", method = RequestMethod.GET)
	public ModelAndView Battle_Casuality_QueryUrl(ModelMap Mmap, HttpSession sessionA,
			@RequestParam(value = "msg", required = false) String msg, HttpServletRequest request) {
			String roleid = sessionA.getAttribute("roleid").toString();
			Boolean val = roledao.ScreenRedirect("Battle_Casuality_QueryUrl", roleid);
			if (val == false) {
		...
		return new ModelAndView("Battle_Casuality_QueryTile");
	}
	
	
	@RequestMapping(value = "/getBattle_Casuality_Officer_ReportDataList", method = RequestMethod.POST)
	 public @ResponseBody List<Map<String, Object>> getBattle_Casuality_Officer_ReportDataList(int startPage,String pageLength,String Search,String orderColunm,String orderType,
		 ...
		 return BCD.getBattle_Casuality_Officer_ReportDataList_Details(startPage,pageLength,Search,orderColunm,orderType,
				 cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no,sessionUserId);
	}
	 
	 @RequestMapping(value = "/getBattle_Casuality_Officer_TotalCount", method = RequestMethod.POST)
	 public @ResponseBody long getBattle_Casuality_Officer_TotalCount(HttpSession sessionUserId,String Search,String cont_comd,String cont_corps,
			 String cont_div,String cont_bde,String unit_name,String sus_no){
	 	return BCD.getBattle_Casuality_Officer_TotalCountDtl(Search,cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no);
	 }
	 
	 
	
	 @RequestMapping(value = "/getBattle_Casuality_JCO_ReportDataList", method = RequestMethod.POST)
	 public @ResponseBody List<Map<String, Object>> getBattle_Casuality_JCO_ReportDataList(int startPage,String pageLength,String Search,String orderColunm,String orderType,
			 String cont_comd,String cont_corps,String cont_div,String cont_bde,String unit_name,String sus_no,HttpSession sessionUserId) 
			 throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeySpecException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException{
		 ...
		 return BCD.getBattle_Casuality_JCO_ReportDataList_Details(startPage,pageLength,Search,orderColunm,orderType,cont_comd,
				 cont_corps,cont_div,cont_bde,unit_name,sus_no,sessionUserId);
	}
	 
	 @RequestMapping(value = "/getBattle_Casuality_JCO_TotalCount", method = RequestMethod.POST)
	 public @ResponseBody long getBattle_Casuality_JCO_TotalCount(HttpSession sessionUserId,String Search,String cont_comd,String cont_corps,
			 String cont_div,String cont_bde, String unit_name,String sus_no){
	 	return BCD.getBattle_Casuality_JCO_TotalCountDtl(Search,cont_comd,cont_corps,cont_div,
	 			cont_bde,unit_name,sus_no);
	 }
	 
	 
	/* @RequestMapping(value = "/Download_Battle_Casuality_query",method = RequestMethod.POST)
		public ModelAndView Download_Battle_Casuality_query(
			...
			ArrayList<ArrayList<String>> pdfprint = BCD.PDF_GetBattle_Casuality_Officer_ReportDataList(cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no);
			ArrayList<ArrayList<String>> pdfprint_pers = BCD.PDF_GetBattle_Casuality_JCO_ReportDataList(cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no);
