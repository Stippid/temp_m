...
import com.controller.ExportFile.PDF_Contact_Detailsof_Pers_query;
import com.controller.orbat.AllMethodsControllerOrbat;
import com.controller.psg.Master.Psg_CommonController;
import com.dao.login.RoleBaseMenuDAO;
import com.dao.psg.Queries.Contact_Detailsof_PersDAO;
import com.models.Tbl_CodesForm;

@Controller
@RequestMapping(value = { "admin", "/", "user" })
public class Contact_details_Pers_Controller {
	...
	@Autowired
	Contact_Detailsof_PersDAO con;
	@Autowired
	private RoleBaseMenuDAO roledao;
	
	@RequestMapping(value = "/admin/Contact_Details_PersUrl", method = RequestMethod.GET)
	public ModelAndView Contact_Details_PersUrl(ModelMap Mmap, HttpSession sessionA,
			@RequestParam(value = "msg", required = false) String msg, HttpServletRequest request) {
		String roleid = sessionA.getAttribute("roleid").toString();
		Boolean val = roledao.ScreenRedirect("Contact_Details_PersUrl", roleid);
		if (val == false) {
		...
		return new ModelAndView("Contact_Details_Pers_Tiles");
	}
	
	
	@RequestMapping(value = "/getContact_DetailsofPers_ReportDataList", method = RequestMethod.POST)
	 public @ResponseBody List<Map<String, Object>> getContact_DetailsofPers_ReportDataList(int startPage,String pageLength,String Search,String orderColunm,String orderType,
		 ...
		 return con.getContact_Detailsof_Pers_ReportDataListDetails(startPage,pageLength,Search,orderColunm,orderType,
				 cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no,sessionUserId);
	}
	 
	 @RequestMapping(value = "/getContact_DetailsofPers_TotalCount", method = RequestMethod.POST)
	 public @ResponseBody long getContact_DetailsofPers_TotalCount(HttpSession sessionUserId,String Search,String cont_comd,String cont_corps,
			 String cont_div,String cont_bde,String unit_name,String sus_no){
	 	return con.getContact_Detailsof_Pers_TotalCountDtl(Search,cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no);
	 }
	 
	 
	
	 @RequestMapping(value = "/getSummaryOf_Total_Number_ReportDataList_pers", method = RequestMethod.POST)
	 public @ResponseBody List<Map<String, Object>> getSummaryOf_Total_Number_ReportDataList_pers(int startPage,String pageLength,String Search,String orderColunm,String orderType,
			 String cont_comd,String cont_corps,String cont_div,String cont_bde,String unit_name,String sus_no,HttpSession sessionUserId) 
			 throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeySpecException, InvalidAlgorithmParameterException, IllegalBlockSizeException, BadPaddingException{
		 ...
		 return con.getSummaryof_Total_Number_ReportDataListDetails_pers(startPage,pageLength,Search,orderColunm,orderType,cont_comd,
				 cont_corps,cont_div,cont_bde,unit_name,sus_no,sessionUserId);
	}
	 
	 @RequestMapping(value = "/getSummaryOf_Total_Number_TotalCount_pers", method = RequestMethod.POST)
	 public @ResponseBody long getSummaryOf_Total_Number_TotalCount_pers(HttpSession sessionUserId,String Search,String cont_comd,String cont_corps,
			 String cont_div,String cont_bde, String unit_name,String sus_no){
	 	return con.getSummaryof_Total_Number_TotalCountDtl_pers(Search,cont_comd,cont_corps,cont_div,
	 			cont_bde,unit_name,sus_no);
	 }
	 
	 
	 @RequestMapping(value = "/Download_Contact_Detailsof_Pers_query",method = RequestMethod.POST)
		public ModelAndView Download_Contact_Detailsof_Pers_query(
		 ...
		 String roleid = sessionEdit.getAttribute("roleid").toString();
			...
			ArrayList<ArrayList<String>> pdfprint = con.pdf_getContact_Detailsof_Pers_ReportDataList(cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no);
			ArrayList<ArrayList<String>> pdfprint_pers = con.pdf_getSummaryof_Total_Number_ReportDataList_pers(cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no);
...
//				TH1.add("SUS No");
			...
			return new ModelAndView(new PDF_Contact_Detailsof_Pers_query(Heading,TH,TH1,foot,username,pdfprint,pdfprint_pers,cont_comd_tx,cont_corps_tx,
					cont_div_tx,cont_bde_tx,unit_name,sus_no),"userList",pdfprint);
		}

	 @RequestMapping(value = "/Excel_Contact_Detailsof_Pers_query", method = RequestMethod.POST)
		public ModelAndView Excel_Contact_Detailsof_Pers_query(HttpServletRequest request,ModelMap model,HttpSession session,String typeReport1,
		 ...
		 ArrayList<ArrayList<String>> Excel = con.pdf_getContact_Detailsof_Pers_ReportDataList(cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no);
		 ArrayList<ArrayList<String>> Excel1 = con.pdf_getSummaryof_Total_Number_ReportDataList_pers(cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no);
