...
import com.controller.ExportFile.PDF_NOKDetails_ContactNo_query;
import com.controller.orbat.AllMethodsControllerOrbat;
import com.controller.psg.Master.Psg_CommonController;
import com.dao.login.RoleBaseMenuDAO;
import com.dao.psg.Queries.NOK_Details_ContactNo_DAO;
import com.models.Tbl_CodesForm;

@Controller
@RequestMapping(value = { "admin", "/", "user" })
public class DetailsofNOK_ContactNO_Controller {
	
	@Autowired
	NOK_Details_ContactNo_DAO nok;
	...
	@RequestMapping(value = "/admin/NOK_ContactNO_Url", method = RequestMethod.GET)
	public ModelAndView NOK_ContactNO_Url(ModelMap Mmap, HttpSession sessionA,
			@RequestParam(value = "msg", required = false) String msg, HttpServletRequest request) {
		
		String roleid = sessionA.getAttribute("roleid").toString();
		Boolean val = roledao.ScreenRedirect("NOK_ContactNO_Url", roleid);
		if (val == false) {
		...
		Mmap.put("msg", msg);
		return new ModelAndView("NOK_ContactNO_Url_Tiles");
	}
	
	

	@RequestMapping(value = "/getNOK_Details_ContactNo_ReportDataList", method = RequestMethod.POST)
	 public @ResponseBody List<Map<String, Object>> getNOK_Details_ContactNo_ReportDataList(int startPage,String pageLength,String Search,String orderColunm,String orderType,
		 ...
		 return nok.getNOK_Details_ContactNo_ReportDataListDetails(startPage,pageLength,Search,orderColunm,orderType,cont_comd,cont_corps,cont_div,
				 cont_bde,unit_name,sus_no,sessionUserId);
	}
	 
	 @RequestMapping(value = "/getNOK_Details_ContactNo_TotalCount", method = RequestMethod.POST)
	 public @ResponseBody long getNOK_Details_ContactNo_TotalCount(HttpSession sessionUserId,String Search,String cont_comd,String cont_corps,
			 String cont_div,String cont_bde,String unit_name,String sus_no){
	 	return nok.getNOK_Details_ContactNo_TotalCountDtl(Search,cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no);
	 }
	 
	 
	
	 @RequestMapping(value = "/getNOK_Details_ContactNo_ReportDataList_pers", method = RequestMethod.POST)
	 public @ResponseBody List<Map<String, Object>> getNOK_Details_ContactNo_ReportDataList_pers(int startPage,String pageLength,String Search,String orderColunm,String orderType,
		 ...
		 return nok.getNOK_Details_ContactNo_ReportDataListDetails_pers(startPage,pageLength,Search,orderColunm,orderType,cont_comd,cont_corps,cont_div,
				 cont_bde,unit_name,sus_no,sessionUserId);
	}
	 
	 @RequestMapping(value = "/getNOK_Details_ContactNo_TotalCount_pers", method = RequestMethod.POST)
	 public @ResponseBody long getNOK_Details_ContactNo_TotalCount_pers(HttpSession sessionUserId,String Search,String cont_comd,String cont_corps,String cont_div,String cont_bde,
			 String unit_name,String sus_no){
	 	return nok.getNOK_Details_ContactNo_TotalCountDtl_pers(Search,cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no);
	 }
	 
	 

	 
	 @RequestMapping(value = "/Download_NOK_Details_ContactNo_query",method = RequestMethod.POST)
		public ModelAndView Download_NOK_Details_ContactNo_query(
			...
			ArrayList<ArrayList<String>> pdfprint = nok.pdf_getNOK_Details_ContactNo_ReportDataList(cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no);
			ArrayList<ArrayList<String>> pdfprint_pers = nok.pdf_getNOK_Details_ContactNo_ReportDataList_pers(cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no);
...
//				TH.add("SUS No");
				...
				TH.add("JCOs");
				TH.add("ORs");
				TH.add("NOK details entered in DATA");
				TH.add("NOK details not entered in DATA");
...
//				TH1.add("SUS No");
			...
			return new ModelAndView(new PDF_NOKDetails_ContactNo_query(Heading,TH,TH1,foot,username,pdfprint,pdfprint_pers,cont_comd_tx,cont_corps_tx,
					cont_div_tx,cont_bde_tx,unit_name, sus_no),"userList",pdfprint);
		}

	 @RequestMapping(value = "/Excel_NOK_Details_ContactNo_query", method = RequestMethod.POST)
		public ModelAndView Excel_NOK_Details_ContactNo_query(HttpServletRequest request,ModelMap model,HttpSession session,String typeReport1,
		 ...
		 ArrayList<ArrayList<String>> Excel = nok.pdf_getNOK_Details_ContactNo_ReportDataList(cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no);
		 ArrayList<ArrayList<String>> Excel1 = nok.pdf_getNOK_Details_ContactNo_ReportDataList_pers(cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no);
