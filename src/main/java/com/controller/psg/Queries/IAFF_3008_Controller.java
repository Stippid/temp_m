...
public class IAFF_3008_Controller {
	...
	@Autowired
	private IAFF_3008_REPORT_DAO IDAO;
	...
	@RequestMapping(value = "/admin/IAFF_3008_Query", method = RequestMethod.GET)
	public ModelAndView IAFF_3008_Query_mns(ModelMap Mmap, HttpSession sessionA,
			@RequestParam(value = "msg", required = false) String msg, HttpServletRequest request) {
		String roleid = sessionA.getAttribute("roleid").toString();
		Boolean val = roledao.ScreenRedirect("IAFF_3008_Query", roleid);
		if (val == false) {
		...
		return new ModelAndView("IAFF_3008_Query_Tiles");
	}
	
	////-----------TABLE REPORT
// this method not use due to flow change
	@RequestMapping(value = "/admin/GetI3008_Serving_old", method = RequestMethod.POST)
	public ModelAndView GetI3008_Serving_old(ModelMap Mmap, HttpSession session,HttpSession sessionUserId,
    ...
    String rank_des = "";
	    ...
	    ArrayList<ArrayList<String>> list_super = IDAO.iaff3008_Report_SuperNum(month,year,cmd_sus,corp_sus,div_sus,bde_sus,unit_sus_no,rank_des);		
		Mmap.put("list2", list_super);
		...
		Mmap.put("list4", list_ReEmp);
		
		ArrayList<ArrayList<String>> list_Des = IDAO.iaff3008_Report_Deserter(month,year,cmd_sus,corp_sus,div_sus,bde_sus,unit_sus_no,rank_des);		
		Mmap.put("list6", list_Des);
...
//		 Mmap.put("size4", list_auth_held.size());
		...
		ArrayList<ArrayList<String>> list_auth =	IDAO.iaff_Report_3008_Auth(month,year,cmd_sus,corp_sus,div_sus,bde_sus,unit_sus_no,rank_des);
		 Mmap.put("list5", list_auth);	
		 Mmap.put("size5", list_auth.size());
		 
		 ArrayList<ArrayList<String>> list_held =	IDAO.iaff_Report_3008_Held(month,year,cmd_sus,corp_sus,div_sus,bde_sus,unit_sus_no,rank_des);
...
//				Mmap.put("sur",Math.abs(sur));	
	...
	@RequestMapping(value = "/admin/GetI3008_Serving", method = RequestMethod.POST)
	public ModelAndView GetI3008_Serving_mns(ModelMap Mmap, HttpSession session, HttpSession sessionUserId,
		...
		ArrayList<ArrayList<String>> list_serving = IDAO.get3008Report_list(month, year, hd_cmd_sus, hd_corp_sus,
	...
	//---------------CRITERIA
	 @RequestMapping(value = "/getIAFF_3008_Serving_ReportDataList", method = RequestMethod.POST)
	 public @ResponseBody List<Map<String, Object>> getIAFF_3008_Serving_ReportDataList(int startPage,String pageLength,String Search,String orderColunm,String orderType,
			 String cont_comd,String cont_corps,String cont_div,String cont_bde,String unit_name,String sus_no,String month,String year,HttpSession sessionUserId) 
		 ...
		 return IAFFDAO.getIAFF_3008_Serving_Report_ListDetails(startPage,pageLength,Search,orderColunm,orderType,cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no,month,year,sessionUserId);
	}
	 
	 @RequestMapping(value = "/getIAFF_3008_Serving_TotalCount", method = RequestMethod.POST)
	 public @ResponseBody long getIAFF_3008_Serving_TotalCount(HttpSession sessionUserId,String Search,String cont_comd,String cont_corps,String cont_div,String cont_bde,String unit_name,String sus_no,String month,String year){
	 	return IAFFDAO.getIAFF_3008_Serving_TotalCountDtl(Search,cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no,month,year);
	 }
	
	 //----------------SUPER NUMERARY
	 @RequestMapping(value = "/getIAFF_3008_Supernumerary_ReportDataList", method = RequestMethod.POST)
	 public @ResponseBody List<Map<String, Object>> getIAFF_3008_Supernumerary_ReportDataList(int startPage,String pageLength,String Search,String orderColunm,String orderType,
			 String cont_comd,String cont_corps,String cont_div,String cont_bde,String unit_name,String sus_no,String month,String year,HttpSession sessionUserId) 
					 throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeySpecException, InvalidAlgorithmParameterException, 
					 IllegalBlockSizeException, BadPaddingException{
		 ...
		 return IAFFDAO.getIAFF_3008_Supernumerary_ReportDataListDetails(startPage,pageLength,Search,orderColunm,orderType,cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no,month,year,sessionUserId);
	}
	 
	 @RequestMapping(value = "/getIAFF_3008_Supernumerary_TotalCount", method = RequestMethod.POST)
	 public @ResponseBody long getIAFF_3008_Supernumerary_TotalCount(HttpSession sessionUserId,String Search,String cont_comd,String cont_corps,String cont_div,String cont_bde,String unit_name,String sus_no,String month,String year){
	 	return IAFFDAO.getIAFF_3008_Supernumerary_TotalCountDtl(Search,cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no,month,year);
	 }
	 
//----RE EMPLOYEEMENT
	 
	 @RequestMapping(value = "/getIAFF_3008_Re_Employeement_ReportDataList", method = RequestMethod.POST)
	 public @ResponseBody List<Map<String, Object>> getIAFF_3008_Re_Employeement_ReportDataList(int startPage,String pageLength,String Search,String orderColunm,String orderType,
			 String cont_comd,String cont_corps,String cont_div,String cont_bde,String unit_name,String sus_no,String month,String year,HttpSession sessionUserId) 
					 throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeySpecException, InvalidAlgorithmParameterException, 
					 IllegalBlockSizeException, BadPaddingException{
		 ...
		 return IAFFDAO.getIAFF_3008_Re_Employeement_ReportDataListDetails(startPage,pageLength,Search,orderColunm,orderType,cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no,month,year,sessionUserId);
	}
	 
	 @RequestMapping(value = "/getIAFF_3008_Re_Employeement_TotalCount", method = RequestMethod.POST)
	 public @ResponseBody long getIAFF_3008_Re_Employeement_TotalCount(HttpSession sessionUserId,String Search,String cont_comd,String cont_corps,String cont_div,String cont_bde,String unit_name,String sus_no,String month,String year){
	 	return IAFFDAO.getIAFF_3008_Re_Employeement_TotalCountDtl(Search,cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no,month,year);
	 }
	 ...
	 @RequestMapping(value = "/getIAFF_3008_Deserter_ReportDataList", method = RequestMethod.POST)
	 public @ResponseBody List<Map<String, Object>> getIAFF_3008_Deserter_ReportDataList(int startPage,String pageLength,String Search,String orderColunm,String orderType,
			 String cont_comd,String cont_corps,String cont_div,String cont_bde,String unit_name,String sus_no,String month,String year,HttpSession sessionUserId) 
					 throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeySpecException, InvalidAlgorithmParameterException, 
					 IllegalBlockSizeException, BadPaddingException{
		 ...
		 return IAFFDAO.getIAFF_3008_Deserter_ReportDataListDetails(startPage,pageLength,Search,orderColunm,orderType,cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no,month,year,sessionUserId);
	}
	 
	 @RequestMapping(value = "/getIAFF_3008_Deserter_TotalCount", method = RequestMethod.POST)
	 public @ResponseBody long getIAFF_3008_Deserter_TotalCount(HttpSession sessionUserId,String Search,String cont_comd,String cont_corps,String cont_div,String cont_bde,String unit_name,String sus_no,String month,String year){
	 	return IAFFDAO.getIAFF_3008_Deserter_TotalCountDtl(Search,cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no,month,year);
	 }
	 ...
	 @RequestMapping(value = "/Download_IAFF3008_query",method = RequestMethod.POST)
		public ModelAndView Download_IAFF3008_query(@ModelAttribute("cont_comd_tx") String cont_comd_tx,
		 ...
		 String roleid = sessionEdit.getAttribute("roleid").toString();
		    ...
		    if(!hd_cmd_sus.equals("0") && !hd_cmd_sus.equals("") && !hd_cmd_sus.equals("null") && !hd_cmd_sus.equals(null)){
		  		 for_code = hd_cmd_sus ;
					List<String> comd= getFormationListSus_no("Command",for_code);
					if(comd.size() > 0)
					 cmd_sus = comd.get(0);
		  	   }
		  	  if(!hd_corp_sus.equals("0") && !hd_corp_sus.equals("") && !hd_corp_sus.equals("null") && !hd_corp_sus.equals(null)){
		  		 for_code = hd_corp_sus ;
					List<String> cor= getFormationListSus_no("Corps",for_code);	
					if(cor.size() > 0)
					 corp_sus = cor.get(0);
		  	   }
		  	  if(!hd_div_sus.equals("0") && !hd_div_sus.equals("") && !hd_div_sus.equals("null") && !hd_div_sus.equals(null)){
		  		for_code = hd_div_sus ;
				    List<String> div= getFormationListSus_no("Division",for_code);
				    if(div.size() > 0)
				     div_sus = div.get(0);
		  	  }
		  	  if(!hd_bde_sus.equals("0") && !hd_bde_sus.equals("") && !hd_bde_sus.equals("null") && !hd_bde_sus.equals(null)){
		  		for_code = hd_bde_sus ;
				    List<String> bde= getFormationListSus_no("Brigade",for_code);
				    if(bde.size() > 0)
				     bde_sus = bde.get(0);
			...
			ArrayList<ArrayList<String>> list_Main = IDAO.iaff3008_Report_MainDetails(month,year,cmd_sus,corp_sus,div_sus,bde_sus,unit_sus_no);
...
//			 Mmap.put("size4", list_auth.size());
			...
			ArrayList<ArrayList<String>> list_auth =	IDAO.iaff_Report_3008_Auth(month,year,cmd_sus,corp_sus,div_sus,bde_sus,unit_sus_no,rank_des);
			 ...
			 String hd_remarks1 = "";
				...
				ArrayList<ArrayList<String>> getremarks = IDAO.getRemarks3008(month, year, unit_sus_no);
...
//				TH4.add("Total Auth");
			...
			return new ModelAndView(new Report_3008_Pdf(TH,TH4,TH5,foot,username,list_super,list_ReEmp,list_Des,list_auth,list_Main,
					cont_comd_tx,cont_corps_tx,cont_div_tx,cont_bde_tx,sum_auth,sum_held,defi,sur,hd_remarks1,hd_remarks2,hd_remarks3,hd_remarks4,hd_remarks5,hd_remarks6,hd_remarks7,
					TH6,list_held),"userList",list_serving);
		}
	 
	 @RequestMapping(value = "/Excel_IAFF_3008_query", method = RequestMethod.POST)
		public ModelAndView Excel_IAFF_3008_query(HttpServletRequest request,ModelMap model,HttpSession session,String typeReport1,
				@ModelAttribute("cont_comd_txt") String cont_comd_tx,
				@ModelAttribute("cont_corps_txt") String cont_corps_tx,
				@ModelAttribute("cont_div_txt") String cont_div_tx,
		 ...
		 String roleid = session.getAttribute("roleid").toString();
			...
			ArrayList<ArrayList<String>> Excel = IDAO.iaff3008_Report_Serving(month,year,cmd_sus,corp_sus,div_sus,bde_sus,unit_sus_no,rank_des);		
			   
		    ArrayList<ArrayList<String>> Excel1 = IDAO.iaff3008_Report_SuperNum(month,year,cmd_sus,corp_sus,div_sus,bde_sus,unit_sus_no,rank_des);		
			...
			ArrayList<ArrayList<String>> Excel3 = IDAO.iaff3008_Report_Deserter(month,year,cmd_sus,corp_sus,div_sus,bde_sus,unit_sus_no,rank_des);
...
//			 ArrayList<ArrayList<String>> Excel4 =	IDAO.iaff_Report_3008_Auth_Held(month,year,cmd_sus,corp_sus,div_sus,bde_sus,unit_sus_no,rank_des);
			// bisag v2 290822 (split auth and held)
						ArrayList<ArrayList<String>> Excel4 =	IDAO.iaff_Report_3008_Auth(month,year,cmd_sus,corp_sus,div_sus,bde_sus,unit_sus_no,rank_des);
...
//			TH4.add("Total Held");
			...
			return new ModelAndView(new Excel_To_Export_4_Table_Report("L", TH,TH1,TH2,TH3,TH4,TH5,Heading, username,Excel,Excel1,Excel2,Excel3,Excel4,sum_auth,sum_held,defi,sur,TH6,list_held), "userList", Excel );
		}
