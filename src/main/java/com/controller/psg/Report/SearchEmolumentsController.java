...
public class SearchEmolumentsController {
	...
	@Autowired
	search_Emoluments_wise_dataDao cd;
	...
	@RequestMapping(value = "/admin/SearchEmolumentsFormationOfficer_url", method = RequestMethod.GET)
	public ModelAndView SearchEmolumentsFormationOfficer_url(ModelMap Mmap, HttpSession sessionA,
			@RequestParam(value = "msg", required = false) String msg, HttpServletRequest request,
			HttpSession sessionUserId)throws SQLException {
		
			String roleid = sessionUserId.getAttribute("roleid").toString();
			Boolean val = roledao.ScreenRedirect("SearchEmolumentsFormationOfficer_url", roleid);
			if (val == false) {
		...
		return new ModelAndView("Search_Emoluments_officer_tile");
	
	}

	 @RequestMapping(value = "/admin/SearchEmolumentsbattle", method = RequestMethod.POST)
		public ModelAndView SearchEmolumentsbattle(ModelMap Mmap,HttpSession session,HttpServletRequest request,
	 ...
	 //////////////////////////////////	
		@RequestMapping(value = "/getEmoluments", method = RequestMethod.POST)
		public @ResponseBody List<Map<String, Object>> getEmoluments(int startPage,int pageLength,String Search,String orderColunm,String orderType,String personnel_no,String rank,HttpSession sessionUserId,
			...
			return cd.getallEmoluments(startPage, pageLength, Search, orderColunm, orderType, personnel_no,rank,
					 sessionUserId,cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no,dt_of_casuality,scase);
		}
	 
		@RequestMapping(value = "/getEmolumentsCount", method = RequestMethod.POST)
		public @ResponseBody long getEmolumentsCount(String Search,String orderColunm,String orderType,String personnel_no,String rank,String b_code,HttpSession sessionUserId,
				String cont_comd,String cont_corps,
				String cont_div,String cont_bde,String unit_name,String sus_no,String dt_of_casuality,String scase) throws SQLException {
			
		
			return cd.getEmolumentsCount(Search, orderColunm, orderType,personnel_no,rank,
					 sessionUserId,cont_comd,cont_corps,cont_div,cont_bde,unit_name,sus_no,dt_of_casuality,scase);
		}
	 /////////////////////
