...
public class Posting_Out_MnsController {
	...
	@RequestMapping(value = "/admin/Posting_OutMnsUrl", method = RequestMethod.GET)
	public ModelAndView Posting_OutMnsUrl(ModelMap Mmap, HttpSession sessionA,
			@RequestParam(value = "msg", required = false) String msg, HttpServletRequest request,
			HttpSession sessionUserId) {
		Boolean val = roledao.ScreenRedirect("Posting_OutMnsUrl", sessionUserId.getAttribute("roleid").toString());
		if (val == false) {
		...
		return new ModelAndView("Posting_OutMnsTiles", "post_outCMD", new TB_POSTING_IN_OUT());
	}
	
	  @RequestMapping(value = "/getpersonnel_noListApprovedcommMns", method = RequestMethod.POST)
	    public @ResponseBody List<String> getpersonnel_noListApprovedcommMns(String personel_no, HttpSession sessionUserId,HttpServletRequest request) {
	    ...
	    try{
	            ...
	            if(roleSusNo!=null && !roleSusNo.equals("")) {
	                q = sessionHQL.createQuery(
	                    ...
	                    "where substring(p.personnel_no, 1, 2) IN ('NR', 'NS') " +
		...
		@RequestMapping(value = "/admin/Search_Posting_OutMnsUrl")//, method = RequestMethod.GET
		public ModelAndView Search_Posting_OutMnsUrl(ModelMap Mmap, HttpSession sessionA,
			...
			Boolean val = roledao.ScreenRedirect("Search_Posting_OutMnsUrl", roleid);
			if (val == false) {
				return new ModelAndView("AccessTiles");
			}
			if (request.getHeader("Referer") == null) {
			...
			if (m.getActiveUnitNameFromSusNo_Without_Enc(roleSusNo, sessionA).size() > 0) {
			 ...
			 Mmap.put("list", pod.search_postoutMns(roleSusNo, "", "", "", "", "", roleType,"0",roleSusNo));
		     Mmap.put("list1", pod.search_postinMns(roleSusNo, "", "", "", "", "", roleType,"0",roleSusNo));
			Mmap.put("getServiceCategoryList", p_comm.getServiceCategoryList());
			Mmap.put("getPostINOutstatusList", commst.getPostINOutstatusList());
			Mmap.put("getTypeofRankList", commst.getTypeofRankList());
			return new ModelAndView("Search_Posting_Out_Mns_Tiles", "search_post_outCMD", new TB_POSTING_IN_OUT());
		}
	
		
		@RequestMapping(value = "/Search_Posting_In_Mns", method = RequestMethod.POST)
		public @ResponseBody ArrayList<ArrayList<String>> Search_Posting_In_Mns(ModelMap Mmap, HttpSession sessionA,
			...
			ArrayList<String> list_error = new ArrayList<String>();
			 ...
			 Mmap.put("getRoleNameList_dash", das.getRoleNameList_dash());
			 if (cat.equals("1"))
					list = pod.search_postinMns(to_sus_no, personnel_no, rank, from_sus_no,cr_by,cr_date,roleType,status,roleSusNo);
		...
		/*---------------------------Search postout -----------------------------------------------------*/
		@RequestMapping(value = "/Search_Posting_Out_Mns", method = RequestMethod.POST)
		public @ResponseBody ArrayList<ArrayList<String>> Search_Posting_Out_Mns(ModelMap Mmap, HttpSession sessionA,
				HttpServletRequest request,
				HttpSession sessionUserId, @RequestParam(value = "msg", required = false) String msg,
				@RequestParam(value = "personnel_no", required = false) String personnel_no,
				@RequestParam(value = "rank", required = false) String rank,
			...
			ArrayList<String> list_error = new ArrayList<String>();
			 ...
			 Mmap.put("getRoleNameList_dash", das.getRoleNameList_dash());
				if (cat.equals("1"))
			 list = pod.search_postoutMns(from_sus_no, personnel_no, rank, to_sus_no,cr_by,cr_date, roleType,status,roleSusNo);
			else if (cat.equals("2"))
				list = pod.search_jcopostout(from_sus_no, personnel_no, rank, to_sus_no, roleType,status);
			return list;
		}
		...
		@RequestMapping(value = "/Edit_Post_In_MnsUrl", method = RequestMethod.POST)
		public ModelAndView Edit_Post_In_MnsUrl(@ModelAttribute("inupdateid") String updateid, ModelMap model,
			...
			return new ModelAndView("Edit_Posting_In_MnsTiles");
		}
		
		/*---------------------------Edit postout Page open-----------------------------------------------------*/
		@RequestMapping(value = "/Edit_Post_Out_MnsUrl", method = RequestMethod.POST)
		public ModelAndView Edit_Post_Out_MnsUrl(@ModelAttribute("updateid") String updateid, ModelMap model,
				@RequestParam(value = "msg", required = false) String msg, Authentication authentication,
			...
			return new ModelAndView("Edit_Posting_Out_MnsTiles");
		}
		
		
		@RequestMapping(value = "/Reject_PostINMns", method = RequestMethod.POST)
		public  ModelAndView Reject_PostINMns(@ModelAttribute("idinr") int id, BindingResult result,
				HttpServletRequest request,
			...
			return new ModelAndView("Search_Posting_Out_Mns_Tiles");
		}
		
		@RequestMapping(value = "/Reject_PostOUTMns", method = RequestMethod.POST)
		public  ModelAndView Reject_PostOUTMns(@ModelAttribute("idoutr") int id, BindingResult result,
				HttpServletRequest request,
				HttpSession sessionA, ModelMap model,
				@RequestParam(value = "msg", required = false) String msg,
		...
		/*---------------------------//Approve postin  ----------------------------------------------------*/
		@RequestMapping(value = "/Approve_PostINMns", method = RequestMethod.POST)
		public  ModelAndView Approve_PostINMns(@ModelAttribute("id4") int id, BindingResult result,
				HttpServletRequest request,
				HttpSession sessionA, ModelMap model,
				@RequestParam(value = "msg", required = false) String msg,
			...
			if (app > 0) {
				...
				if(roleSusNo.equals(""))
				{
					 List<UserLogin> userlist = getPostIN_outuseridlistMns(tosus_no);
	                 String user_id = "";
	                 ...
	                 String description = ""+per_no+", "+rkin+", "+namein+" has been posted in from " +from_unit +" on " +date_tos ;
					    ...
					    List<UserLogin> userlistout = getPostIN_outuseridlistMns(from_sus);
		                 String user_idout = "";
				...
				List<UserLogin> userlist = getPostIN_outuseridlistMns(reciver_sus_no);
			...
			return new ModelAndView("redirect:Search_Posting_OutMnsUrl");
		}
		
		/*---------------------------//Approve postout  ----------------------------------------------------*/
		@RequestMapping(value = "/Approve_PostOUTMns", method = RequestMethod.POST)
		public  ModelAndView Approve_PostOUTMns(@ModelAttribute("id3") int id, BindingResult result,
				HttpServletRequest request,
				HttpSession sessionA, ModelMap model,
				@RequestParam(value = "msg", required = false) String msg,
			...
			if (app > 0) {
				...
				if(roleSusNo.equals(""))
				{
	                 ...
	                 String description = ""+per_no+", "+rkin+", "+namein+" has been posted in from " +from_unit +" on " +tos_date ;
					    ...
					    List<UserLogin> userlistout = getPostIN_outuseridlistMns(fromsus_no);
		                 String user_idout = "";
		              		for (int i = 0; i < userlistout.size(); i++) {
		              			if(i==0) {
		              				user_idout += 	userlistout.get(i).getUserId();
		...
		@RequestMapping(value = "/CancelRejectHistory_PostINOUTMns", method = RequestMethod.POST)
		public  ModelAndView CancelRejectHistory_PostINOUTMns(@ModelAttribute("idcrh") int id, BindingResult result,
				HttpServletRequest request,
				HttpSession sessionA, ModelMap model,
				@RequestParam(value = "msg", required = false) String msg,
		...
		@RequestMapping(value = "/ApproveCancelHistory_PostINOUTMns", method = RequestMethod.POST)
		public  ModelAndView ApproveCancelHistory_PostINOUTMns(@ModelAttribute("idach") int id, BindingResult result,
				HttpServletRequest request,
				HttpSession sessionA, ModelMap model,
				@RequestParam(value = "msg", required = false) String msg,
		 ...
		 public List<UserLogin> getPostIN_outuseridlistMns(String to_sus_no) {
			...
			/*---------------------------Edit PostOut Action----------------------------------------------------*/
			@RequestMapping(value = "/admin/Edit_posting_out_MnsAction", method = RequestMethod.POST)
			public ModelAndView Edit_posting_out_MnsAction( @RequestParam(value = "msg", required = false) String msg,HttpServletRequest request, ModelMap model, HttpSession session)
			...
			/*---------------------------Edit PostIn Action----------------------------------------------------*/
			@RequestMapping(value = "/admin/Edit_posting_in_MnsAction", method = RequestMethod.POST)
