...
public class E_Holding_Controller {



	@RequestMapping(value = "/admin/E_holding_url")
	public ModelAndView E_holding_url(ModelMap model, HttpSession session, HttpServletRequest request,
			@RequestParam(value = "msg", required = false) String msg) {
//		String roleid = session.getAttribute("roleid").toString();
//		Boolean val = roledao.ScreenRedirect("E_holding_url", roleid);
//		if (val == false) {
...
//		model.put("msg", msg);
		...
		model.put("date", date1);
				...
				return new ModelAndView("e_holdingTiles");
	}
}