...
public class Export_B_Veh_Excel extends AbstractExcelView{
	...
	public Export_B_Veh_Excel(String Type,List<String> TH,String username,
			ArrayList<List<String>>smlist){
		this.Type = Type;
		this.TH = TH;
	...
	protected void buildExcelDocument(Map<String, Object> model, HSSFWorkbook workbook, HttpServletRequest arg2,
		...
		String file_name = datetimestamp.currentDateWithTimeStampString();
		 ...
		 @SuppressWarnings("unchecked")
		  ...
		  Sheet sheet = workbook.createSheet("B Vehicle MVCR");
		  ...
		  /*List<Integer> lockedColumns = Arrays.asList(0,2,3,5);*/
		  List<Integer> lockedColumns = Arrays.asList(0,2,4,5,6,8,10,12,14,16);
