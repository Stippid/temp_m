...
public class computing_assets_DAOImpl implements computing_assets_DAO{
	...
	public List<Map<String, Object>> Search_Computing_Assets(int startPage,int pageLength,String Search,String orderColunm,String orderType,String status,String assets_type,String model_number,String machine_number,String ram_capi,String hdd_capi,String operating_system,String from_date,String to_date,String s_state,String unit_sus_no, String unit_name, HttpSession session)
	{
		...
		String SearchValue = GenerateQueryWhereClause_SQL4(Search,assets_type,model_number,machine_number,ram_capi,hdd_capi,operating_system,from_date,to_date,status,s_state,unit_sus_no,  unit_name,session);
		...
		try{
			...
			stmt = setQueryWhereClause_SQL4(stmt,Search,assets_type,model_number,machine_number,ram_capi,hdd_capi,operating_system,from_date,to_date,status,s_state,unit_sus_no,  unit_name,session);
	...
	public long getAppComputingassetCountList1(String Search,String orderColunm,String orderType,String status,String assets_type,String model_number,
		...
		String SearchValue = GenerateQueryWhereClause_SQL4(Search,assets_type,model_number,machine_number,ram_capi,hdd_capi,operating_system,from_date,to_date,status,s_state, unit_sus_no,  unit_name,sessionUserId);
		int total = 0;
		String q = null;
		Connection conn = null;
		try {
			...
			q ="select \r\n" +
					" count(app.*)\r\n" +
					" from  ( select am.id,ma.assets_name,am.s_state,am.model_number,am.machine_number,am.mac_address,am.ip_address,pm.processor_type,rm.ram,hm.hdd,om.os,ofm.office,fm.os_firmware,dem.dply_env from tb_asset_main am \r\n" +
					"					left join  tb_mstr_assets ma on  ma.id=am.asset_type and ma.category=1 \r\n" +
					"					left join  tb_mstr_processor_type pm on  pm.id=am.processor_type \r\n" +
					"					left join  tb_mstr_ram rm on  rm.id=am.ram_capi \r\n" +
					"					left join  tb_mstr_hdd hm on  hm.id=am.hdd_capi \r\n" +
					...
					//						"					inner join  tb_mstr_make mm on  mm.id=am.make_name\r\n"+
					"					left join  tb_mstr_dply_env dem on  dem.id=am.dply_envt  "
					+ "inner join tb_miso_orbat_unt_dtl orb on orb.sus_no = am.sus_no and status_sus_no='Active' where am.id!=0  "  + SearchValue +" ) app " ;

			PreparedStatement stmt = conn.prepareStatement(q);

			stmt = setQueryWhereClause_SQL4(stmt,Search,assets_type,model_number,machine_number,ram_capi,hdd_capi,operating_system,from_date,to_date,status,s_state,unit_sus_no,  unit_name,sessionUserId);
	...
	/* public String GenerateQueryWhereClause_SQL4(String Search,String assets_type,String model_number,String machine_number,String ram_capi,String hdd_capi,String operating_system,String from_date,String to_date, String status,String s_state) {
			String SearchValue ="";
		...
		public PreparedStatement setQueryWhereClause_SQL4(PreparedStatement stmt,String Search,String assets_type,String model_number,String machine_number,String ram_capi,String hdd_capi,String operating_system,String from_date,String to_date, String status,String s_state) {
	...
	//BISAG
	public String GenerateQueryWhereClause_SQL4(String Search,String assets_type,String model_number,String machine_number,String ram_capi,String hdd_capi,String operating_system,String from_date,String to_date, String status,String s_state,String unit_sus_no, String unit_name,HttpSession sessionUserId) {
		String SearchValue ="";
	...
	public PreparedStatement setQueryWhereClause_SQL4(PreparedStatement stmt,String Search,String assets_type,String model_number,String machine_number,String ram_capi,String hdd_capi,String operating_system,String from_date,String to_date, String status,String s_state,String unit_sus_no, String unit_name,HttpSession sessionUserId) {
	...
	public String approve_AssetsData(String a,String user_sus,String status,String username) {
		...
		try {
			...
			for (int i = 0; i < id_list.length; i++) {
				...
				String hql = "update Assets_Main set modified_by=:modified_by ,status=:status,modified_date=:modified_date where id=:id";
				...
				String hqlUpdate = "update Assets_Child set status=:status,modified_by=:modified_by,modified_dt=:modified_date  where p_id=:id ";
			...
			String model_number,String machine_number,String ram_capi,String hdd_capi,String operating_system,String unit_sus_no,String from_date,String to_date,HttpSession sessionUserId) throws SQLException
	{
		...
		String SearchValue = GenerateQueryWhereClause_SQL(Search,assets_type,model_number,machine_number,ram_capi,hdd_capi,operating_system,unit_sus_no,from_date,to_date,status,sessionUserId);
		...
		try{
			...
			if(status.equals("0")) {
				qry="select distinct am.id,ma.assets_name,am.model_number,am.machine_number,am.mac_address,am.ip_address,pm.processor_type,rm.ram,hm.hdd,om.os,ofm.office,fm.os_firmware,dem.dply_env,\r\n" +
						...
						+ "and ch_am.status = (case when (select count(*) from tb_assets_child ch where ch.p_id=am.id)=1 then 1 else 0 end) "
						+ SearchValue
						+
				...
				System.out.println("app query:  648----- "+stmt);

				stmt = setQueryWhereClause_SQL(stmt,Search,assets_type,model_number,machine_number,ram_capi,hdd_capi,operating_system,unit_sus_no,from_date,to_date,status,sessionUserId);
				...
				qry="select distinct am.id,ma.assets_name,am.model_number,am.machine_number,am.mac_address,am.ip_address,pm.processor_type,rm.ram,hm.hdd,om.os,ofm.office,fm.os_firmware,dem.dply_env,\r\n" +
						...
						" td3.codevalue   as unsv,ch_am.id as ch_id " +
				...
				stmt=conn.prepareStatement(qry);
				System.err.println("search 680: --> "+ stmt);
				stmt = setQueryWhereClause_SQL(stmt,Search,assets_type,model_number,machine_number,ram_capi,hdd_capi,operating_system,unit_sus_no,from_date,to_date,status,sessionUserId);
	...
	public String GenerateQueryWhereClause_SQL(String Search,String assets_type,String model_number,String machine_number,String ram_capi,String hdd_capi,String operating_system,String unit_sus_no,String from_date,String to_date, String status,HttpSession sessionUserId) {
		String SearchValue ="";
	...
	public PreparedStatement setQueryWhereClause_SQL(PreparedStatement stmt,String Search,String assets_type,String model_number,String machine_number,String ram_capi,String hdd_capi,String operating_system,String unit_sus_no,String from_date,String to_date, String status,HttpSession sessionUserId) {
	...
	public ArrayList<ArrayList<String>> Search_DataTableList(HttpSession session){
		...
		try {
			...
			ResultSet rs = stmt.executeQuery();
			System.err.println("search 1316: --> "+ stmt);
	...
	public ArrayList<ArrayList<String>> Search_DataTableList1(HttpSession session){
		...
		try {
			...
			stmt.setString(1, roleSusNo);
			ResultSet rs = stmt.executeQuery();
			System.err.println("search 1430: --> "+ stmt);
	...
	public List<Map<String, Object>> getAuditUploadData(int startPage, int pageLength, String search,
		...
		try{
			...
			SearchValue = "where a.sus_no like ? ";

			if(!search.equals("")) {
				SearchValue +=" and (upper(o.unit_name) like ? OR UPPER(TO_CHAR(a.audit_date, 'YYYY-MM-DD')) LIKE ? ) ";
			}

			q="select distinct a.id, o.unit_name, ltrim(TO_CHAR(a.audit_date,'DD-MON-YYYY'),'0') as last_cyber_audit_date from tb_audit_upload a\r\n"
					+ "inner join tb_miso_orbat_unt_dtl o on o.sus_no = a.sus_no \r\n" + SearchValue
					//+ "left join tb_assest_officer_computing_child m on m.sus_no = a.sus_no\r\n" + SearchValue
					+" ORDER BY "+ orderColunm +" "+orderType +" limit " +pageL+" OFFSET "+startPage ;
			stmt=conn.prepareStatement(q);
	...
	public long getAuditUploadCount(String search,String orderColunm,String orderType,HttpSession sessionUserId) {
		...
		try {
			...
			q="select count(app.*) from(select distinct a.id, o.unit_name, ltrim(TO_CHAR(a.audit_date,'DD-MON-YYYY'),'0') as last_cyber_audit_date from tb_audit_upload a\r\n"
					+ "inner join tb_miso_orbat_unt_dtl o on o.sus_no = a.sus_no \r\n" +SearchValue +" ) app" ;
					//+ "left join tb_assest_officer_computing_child m on m.sus_no = a.sus_no \r\n " +SearchValue +" ) app" ;
			PreparedStatement stmt = conn.prepareStatement(q);
	...
	public List<Map<String, Object>> getDeletedAssetsData(int startPage,int pageLength,String Search,String orderColunm,String orderType,String assets_type,String model_number,String machine_number,
		...
		try{
			...
			ResultSet rs = stmt.executeQuery();
			System.err.println("search ca 66  del  : --> "+ stmt);
			ResultSetMetaData metaData = rs.getMetaData();
			int columnCount = metaData.getColumnCount();
