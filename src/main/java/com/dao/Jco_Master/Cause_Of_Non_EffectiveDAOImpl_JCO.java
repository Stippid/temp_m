...
public class Cause_Of_Non_EffectiveDAOImpl_JCO implements Cause_Of_Non_EffectiveDAO_JCO{
	...
	public ArrayList<ArrayList<String>> search_Cause_Of_Non_Effe(String causes_name,String type_of_officer,String status)
	{
		...
		try{	  
			...
			q="select  c.id,UPPER(c.causes_name) AS causes_name,t.label AS type_of_officer,\r\n" + 
					"		c.status  \r\n" + 
					"from tb_psg_mstr_cause_of_non_effective_jco c\r\n" + 
	 ...
	 public TB_PSG_MSTR_CAUSE_OF_NON_EFFECTIVE_JCO getCauNonEffeByid(int id) {
			Session sessionHQL = HibernateUtil.getSessionFactory().openSession();
		 	...
		 	TB_PSG_MSTR_CAUSE_OF_NON_EFFECTIVE_JCO updateid = (TB_PSG_MSTR_CAUSE_OF_NON_EFFECTIVE_JCO) sessionHQL.get(TB_PSG_MSTR_CAUSE_OF_NON_EFFECTIVE_JCO.class, id);
