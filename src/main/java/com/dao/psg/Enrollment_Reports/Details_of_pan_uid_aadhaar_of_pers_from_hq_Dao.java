...
public interface Details_of_pan_uid_aadhaar_of_pers_from_hq_Dao {

	long Details_of_pan_uid_aadhaar_of_pers_from_hq_Count(String search, String orderColunm, String orderType,
	...
	List<Map<String, Object>> Details_of_pan_uid_aadhaar_of_pers_from_hqList(int startPage, int pageLength, String search,
	...
	long Details_of_pan_uid_aadhaar_of_pers_from_hq_Summary_Count(String search, String orderColunm, String orderType,
			HttpSession sessionUserId, String cont_comd, String cont_corps, String cont_div, String cont_bde,
			String unit_name, String unit_sus_no,String state_id,String district_id,String off_cat);

	List<Map<String, Object>> Details_of_pan_uid_aadhaar_of_pers_from_hq_Summary_List(int startPage, int pageLength, String search,
			String orderColunm, String orderType, HttpSession sessionUserId, String cont_comd, String cont_corps,
