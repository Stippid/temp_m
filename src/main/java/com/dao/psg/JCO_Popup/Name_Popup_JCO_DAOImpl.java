...
public class Name_Popup_JCO_DAOImpl implements Name_Popup_JCO_DAO{
	...
	public ArrayList<ArrayList<String>> Name_PopUp_JCO(int jco_id)
	{
		ArrayList<ArrayList<String>> alist = new ArrayList<ArrayList<String>>();
			...
			try{	  
				...
				q="SELECT distinct id,authority,TO_CHAR(date_of_authority ,'DD-MON-YYYY') as date_of_authority ,\r\n" + 
						"first_name,middle_name,last_name, status, created_by,first_name,middle_name,last_name, \r\n" + 
					...
					while (rs.next()) {
						...
						list.add(rs.getString("middle_name"));//4
