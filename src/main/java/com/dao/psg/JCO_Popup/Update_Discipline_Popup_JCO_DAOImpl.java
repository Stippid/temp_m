...
public class Update_Discipline_Popup_JCO_DAOImpl implements Update_Discipline_Popup_JCO_DAO{
	...
	public ArrayList<ArrayList<String>> UpdateDiscipline_jco_id_PopUp_JCO(int discipline_jco_id)
	{
		ArrayList<ArrayList<String>> alist = new ArrayList<ArrayList<String>>();
			...
			try{	  
				...
				q="SELECT d.id, \r\n" + 
						...
						"					inner join tb_psg_census_jco_or_p pc on pc.id=d.jco_id and pc.status in ('1','5') \r\n" + 
						"					WHERE   jco_id =? and d.status in (1,2)  order by id desc\r\n" + "";
						
	
					stmt=conn.prepareStatement(q);
					stmt.setInt(1,discipline_jco_id);
