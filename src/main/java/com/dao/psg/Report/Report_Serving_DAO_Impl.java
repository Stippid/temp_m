...
public class Report_Serving_DAO_Impl implements Report_Serving_DAO{
...
public ArrayList<ArrayList<String>> Search_Report_Version(String month, String year ,HttpSession session,String status ,String unit_sus_no){
	...
	try{	  
		...
		q="select distinct m.sus_no,ms.unit_name,TO_CHAR( TO_DATE (m.month::text, 'MM'), 'Month') AS month_name,"
				+ "m.month,m.year,m.version from tb_psg_iaff_3008_main m \r\n" +
...
public Boolean Delete_Report_3008(String username,String roleSusNo,String month, String year,String version) throws SQLException 
{
	...
	Connection conn = dataSource.getConnection();	
	  try {
		  ...
		  List<TB_PSG_IAFF_3008_MAIN> version0 = Get_3008_VersionData(month,year,roleSusNo);
...
{
	return  "update tb_psg_iaff_3008_main set status='3', modified_by= ?, modified_date= now()::timestamp \r\n" + 
	  " where id=? and sus_no=? and month=? and year=? " ;
}
public String Delete_Report_3008_Main()
{
	return  "update tb_psg_iaff_3008_main_details set status='3', modified_by= ?, modified_date= now()::timestamp \r\n" + 
	  " where sus_no=? and month=? and year=? and version=?" ;
}

public String Delete_Report_3008_Serving()
{
	return  "update tb_psg_iaff_3008_serving set status='3' \r\n" + 
	  " where sus_no=? and month=? and year=? and version=?" ;
}

public String Delete_Report_3008_SuperNumarary()
{
	return  "update tb_psg_iaff_3008_supernumerary set status='3' \r\n" + 
	  " where sus_no=? and month=? and year=? and version=?" ;
}

public String Delete_Report_3008_Re_Employment()
{
	return  "update tb_psg_iaff_3008_re_employeement set status='3' \r\n" + 
	  " where sus_no=? and month=? and year=? and version=?" ;
}

public String Delete_Report_3008_Deserter()
{
	return  "update tb_psg_iaff_3008_deserter set status='3' \r\n" + 
	  " where sus_no=? and month=? and year=? and version=?" ;
}
...
{
	return  "update tb_psg_iaff_3008_auth set status='3' \r\n" + 
	  " where sus_no=? and month=? and year=? and version=?" ;
}
////--------------------For Approval
...
public ArrayList<ArrayList<String>> Search_Report_Serving_Approval(String month, String year , HttpSession session,String version,String unit_sus_no)
{
		...
		try{	  
			...
			/*q="select distinct sr.personal_no as personnel_no,\r\n" + 
				"ltrim(TO_CHAR(sr.date_of_tos ,'DD-MON-YYYY'),'0') as dt_of_tos,\r\n" + 
				"ltrim(TO_CHAR(sr.date_of_birth ,'DD-MON-YYYY'),'0') as date_of_birth,\r\n" + 
				"ltrim(TO_CHAR(sr.date_of_commission ,'DD-MON-YYYY'),'0') as date_of_commission ,\r\n" + 
				"ltrim(TO_CHAR(sr.date_of_seniority ,'DD-MON-YYYY'),'0') as date_of_seniority,\r\n" + 
				"ltrim(TO_CHAR(sr.date_of_appointment ,'DD-MON-YYYY'),'0') as date_of_appointment,\r\n" + 
				"sr.parent_arm,sr.regiment,sr.cda_acc_no,sr.rank,sr.appointment as appt,sr.name,sr.med_cat\r\n" + 
				"						from tb_psg_iaff_3008_main m \r\n" + 
				"inner join tb_psg_iaff_3008_serving  sr on sr.month = m.month and \r\n" + 
				"sr.year= m.year and sr.version = m.version and sr.sus_no = m.sus_no "+
				" where m.sus_no = ? and m.status='0' and m.year = ? and m.month = ? and m.version = ? ";*/
...
public ArrayList<ArrayList<String>> Search_Report_3008_Super_Approval(String month, String year , HttpSession session ,String version,String unit_sus_no)
{
		...
		try{	  
			...
			"						from tb_psg_iaff_3008_main m \r\n" + 
			"inner join tb_psg_iaff_3008_supernumerary sp on sp.month = m.month and \r\n" + 
...
public ArrayList<ArrayList<String>> Search_Report_3008_ReEmployed_Approval(String month, String year , HttpSession session ,String version,String unit_sus_no)
{
		...
		try{	  
			...
			"						from tb_psg_iaff_3008_main m \r\n" + 
			"inner join tb_psg_iaff_3008_re_employeement re on re.month = m.month and \r\n" + 
...
public ArrayList<ArrayList<String>> Search_Report_3008_Deserter_Approval(String month, String year , HttpSession session ,String version,String unit_sus_no)
{
		...
		try{	  
			...
			"						from tb_psg_iaff_3008_main m \r\n" + 
			"inner join tb_psg_iaff_3008_deserter ds on ds.month = m.month and \r\n" + 
...
{
	return  "update tb_psg_iaff_3008_main set status='1', modified_by= ?, modified_date= now()::timestamp \r\n" + 
	  " where id=? and sus_no=? and month=? and year=? " ;
}
public String Approve_Report_3008_Main()
{
	return  "update tb_psg_iaff_3008_main_details set status='1', modified_by= ?, modified_date= now()::timestamp \r\n" + 
	  " where sus_no=? and month=? and year=? and version=?" ;
}

public String Approve_Report_3008_Serving()
{
	return  "update tb_psg_iaff_3008_serving set status='1' , approved_by = ? , approved_date = now()::timestamp  \r\n" + 
	  " where sus_no=? and month=? and year=? and version=?" ;
}

public String Approve_Report_3008_SuperNumarary()
{
	return  "update tb_psg_iaff_3008_supernumerary set status='1', approved_by = ? , approved_date = now()::timestamp \r\n" + 
	  " where sus_no=? and month=? and year=? and version=?" ;
}

public String Approve_Report_3008_Re_Employment()
{
	return  "update tb_psg_iaff_3008_re_employeement set status='1' , approved_by = ? , approved_date = now()::timestamp \r\n" + 
	  " where sus_no=? and month=? and year=? and version=?" ;
}

public String Approve_Report_3008_Deserter()
{
	return  "update tb_psg_iaff_3008_deserter set status='1', approved_by = ? , approved_date = now()::timestamp \r\n" + 
	  " where sus_no=? and month=? and year=? and version=?" ;
}
...
{
	return  "update tb_psg_iaff_3008_auth set status='1', approved_by = ? , approved_date = now()::timestamp \r\n" + 
	  " where sus_no=? and month=? and year=? and version=?" ;
}
...
private Report_3008DAO report_3008DAO;
	...
	public Boolean Insert_Report_3008(String username,String roleSusNo,String FDate ,String month, String year ,
			String userId,String present_return_no,String present_return_dt,String observation,String LDate) throws SQLException 
	{
		PreparedStatement pstmt = null;
		Connection conn = dataSource.getConnection();	
//		  try {
...
//						}
			  ...
			  List<TB_PSG_IAFF_3008_MAIN> version = Get_3008_VersionData(month,year,roleSusNo);
				if (version.size() == 0) {
					...
					pstmt.setString(19, observation);
				...
				pstmt.setString(11,FDate);
				pstmt.setString(12,FDate);
				pstmt.setString(13,FDate);
				pstmt.setString(14,FDate);
				pstmt.setString(15,LDate);
				pstmt.setString(16, roleSusNo);
				pstmt.setString(17,FDate);
				pstmt.setString(18,FDate);
				...
				pstmt = conn.prepareStatement(Insert_Report_3008_Re_Employeement());
				pstmt.setString(1,userId);
				pstmt.setString(2,month);
				pstmt.setString(3,year);
				...
				pstmt = conn.prepareStatement(Insert_Report_3008_auth());
				pstmt.setString(1,userId);
...
/////////////////////For Insert ---------------
	...
	public  List<TB_PSG_IAFF_3008_MAIN> Get_3008_VersionData(String month, String year ,String roleSusNo) {
		...
		String hqlUpdate = " from TB_PSG_IAFF_3008_MAIN where month=:month and year=:year and sus_no=:roleSusNo ";
		...
		List<TB_PSG_IAFF_3008_MAIN> list = (List<TB_PSG_IAFF_3008_MAIN>) query.list();
		tx.commit();
		sessionHQL.close();
		return list;
	}
	...
	{ 
		return  "INSERT INTO tb_psg_iaff_3008_main \r\n" + 
	...
	{
		return  "update tb_psg_iaff_3008_main set month= ?, year= ?, version= ?,status='0',\r\n" + 
	...
	public String Insert_Report_3008_Main_Details()
	{
		...
		return  "INSERT INTO tb_psg_iaff_3008_main_details\r\n" + 
		"(sus_no,month,year,version,cmd_sus,corp_sus,div_sus,bde_sus,auth,held,present_return_no,present_return_dt,we_pe_no,"
		+ "cmd_unit,corp_unit,div_unit,bde_unit,created_by,created_date,remarks,remarksforoffrstos,remarksforoffrssos,remarksforoffrspostout,remarksforoffrspostin"
		+ ",remarksforoffrsunderretire,remarksdistr) "+
	    "VALUES (?,?,?,?,?,?,?,?,?,?,?,CAST(? as Date),?,?,?,?,?,?,now()::timestamp,?,?,?,?,?,?,?) ";
		
	}
	public String Insert_Report_3008_Serving()
	{
	return  "INSERT INTO tb_psg_iaff_3008_serving \r\n" + 
			...
			+ "CASE \r\n"
			+ "    WHEN app_main.date_of_appointment >= op.dt_of_tos \r\n"
			+ "    THEN app_main.date_of_appointment\r\n"
			+ "    ELSE NULL::timestamp\r\n"
			...
			"(select version from tb_psg_iaff_3008_main where \r\n" + 
			...
			"to_date(to_char(ds.dt_desertion,'Mon YYYY'),'Mon YYYY') <= to_date(?,'YYYY/MM/DD')\r\n" + 
			"AND (ds.dt_recovered is null OR to_date(to_char(ds.dt_recovered,'Mon YYYY'),'Mon YYYY') >= to_date(?,'YYYY/MM/DD'))) \r\n" + 
			" AND LEFT(c.personnel_no, 2) NOT IN ('NR', 'NS')" +
	...
	public String Insert_Report_3008_SuperNumarary() {
		...
		return "INSERT INTO tb_psg_iaff_3008_supernumerary \r\n" + 
				"(personal_no,sus_no,unit_name,parent_arm,regiment,cda_acc_no,rank,appointment,\r\n" + 
				"	date_of_tos, tenure_date, date_of_birth, date_of_seniority, date_of_commission,date_of_appointment," +
				"  created_date,created_by,month,year,version,name,med_cat)\r\n" + 
				"select DISTINCT c.personnel_no ,op.to_sus_no,\r\n" + 
	...
	return "INSERT INTO tb_psg_iaff_3008_re_employeement \r\n" + 
		"(personal_no,sus_no,unit_name,parent_arm,regiment,cda_acc_no,rank,appointment,\r\n" + 
		"	date_of_tos, tenure_date, date_of_birth, date_of_seniority, date_of_commission,date_of_appointment," +
		"  created_date,created_by,month,year,version,name,med_cat)\r\n" + 
		"select DISTINCT c.personnel_no ,op.to_sus_no,\r\n" + 
	...
	public String Insert_Report_3008_Deserter()
	{
		...
		return "INSERT INTO tb_psg_iaff_3008_deserter \r\n" + 
			"(personal_no,sus_no,unit_name,parent_arm,regiment,cda_acc_no,rank,appointment,\r\n" + 
			"	date_of_tos, tenure_date, date_of_birth, date_of_seniority, date_of_commission,date_of_appointment," +
			"  created_date,created_by,month,year,version,name,med_cat)\r\n" + 
			"select DISTINCT c.personnel_no ,op.to_sus_no,\r\n" + 
...
//	{
//
//		return "INSERT INTO tb_psg_iaff_3008_auth \r\n" + 
...
//			"COALESCE(total_held,'0') as total_held," + 
			...
			"COALESCE(description,'0') as rank ," + 
			 "(select username from  logininformation U where U.userid= cast(? as integer)) as user_id, ? as month, ? as year , " + 
			" (select version from tb_psg_iaff_3008_main where  \r\n" + 
			" sus_no = ? and month = ? and year = ? ) as version,auth.sus_no as sus_no from \r\n" + 
			"(select\r\n" + 
			"COALESCE(sum(n.base_auth),'0') as base_auth ,\r\n" + 
			"COALESCE(sum(n.mod_auth),'0') as mod_auth,\r\n" + 
			"COALESCE(sum(n.foot_auth),'0') as foot_auth,\r\n" + 
			"COALESCE(sum(base_auth + mod_auth + foot_auth),'0') as total_auth,\r\n" + 
			"r.id as rank_id, n.sus_no ,r.description \r\n" + 
			"from sus_pers_stdauth n\r\n" + 
			"inner join cue_tb_psg_rank_app_master r on r.code  = n.rank_code and upper(r.level_in_hierarchy) = upper('Rank')\r\n" + 
			"where r.parent_code = '0' and  n.sus_no = ? group by rank_id,n.sus_no) auth\r\n" + 
			"" ;
    }
	...
	public String Insert_Report_3008_held()
	{
		...
		return "INSERT INTO tb_psg_iaff_3008_Held \r\n" + 
				"(base_auth,mod_auth,foot_auth,total_auth,total_held,rank,user_id,month,year,version,sus_no\r\n" + 
				" )" + 
	...
	public ArrayList<String> getSusNoListForIAFF3008( )
	{
			...
			try{	  
				...
				q="select sus_no from tb_miso_orbat_unt_dtl ms "
						...
						+ "\r\n"
						+ "select sus_no from tb_psg_iaff_3008_main where month=to_char( date_trunc('month'::text, CURRENT_DATE::timestamp with time zone) ,'MM') and"
