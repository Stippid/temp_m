...
public class Type_Of_Stock_CDAOImpl implements Type_Of_Stock_CDAO{
    ...
    public  ArrayList<List<String>> getSearchStockC(String sus_no, String mct, String type_of_stock, String roleType) {
        ArrayList<List<String>> alist = new ArrayList<List<String>>();
		 ...
		 conn = dataSource.getConnection();			 
			 ...
			 * "inner join TB_TMS_BANUM_DIRCTRY b on  b.ba_no=d.ba_no and cast(b.mct as character varying) = ? where d.sus_no=? and d.type_of_stock=? and d.ba_no not in (select ba_no from tb_tms_emar_drr_dir_dtl where sus_no=? and  type_of_stock in ('3','4','5'))\r\n"
			...
			// query shivani 17-16-2023
			  q="select distinct b.ba_no as ba_no,b.engine_no as engine ,b.chasis_no as chasis,d.type_of_stock as type_of_stock,d.id as id ,ch.remarks\r\n"
			  		+ "from tb_tms_emar_drr_dir_dtl d \r\n"
			  		+ "inner join TB_TMS_BANUM_DIRCTRY b on  b.ba_no=d.em_no and cast(b.mct as character varying) = ? \r\n"
			  		+ "inner join tb_tms_banum_req_child ch on ch.ba_no = b.ba_no\r\n"
			  		+ "where d.sus_no= ? and d.type_of_stock= ? \r\n"
			  		+ "and d.em_no not in (select em_no from tb_tms_emar_drr_dir_dtl where sus_no= ? and  type_of_stock in ('3','4','5'))\r\n";
