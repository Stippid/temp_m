...
public class Type_of_stockDAOImpl implements Type_of_stockDAO{
    ...
    public  ArrayList<List<String>> getSearchStock(String sus_no, String mct, String type_of_stock, String roleType) {
        ArrayList<List<String>> alist = new ArrayList<List<String>>();
		 ...
		 conn = dataSource.getConnection();			 
			 ...
			 * + "from TB_TMS_DRR_DIR_DTL d \r\n" +
			 * "inner join TB_TMS_BANUM_DIRCTRY b on  b.ba_no=d.ba_no and cast(b.mct as character varying) = ? where d.sus_no=? and d.type_of_stock=? and d.ba_no not in (select ba_no from TB_TMS_DRR_DIR_DTL where sus_no=? and  type_of_stock in ('3','4','5'))\r\n"
			...
			// query shivani 17-16-2023
			  q="select distinct b.ba_no as ba_no,b.engine_no as engine ,b.chasis_no as chasis,d.type_of_stock as type_of_stock,d.id as id ,ch.remarks\r\n"
			  		...
			  		+ "and d.ba_no not in (select ba_no from TB_TMS_DRR_DIR_DTL where sus_no= ? and  type_of_stock in ('3','4','5'))\r\n";
