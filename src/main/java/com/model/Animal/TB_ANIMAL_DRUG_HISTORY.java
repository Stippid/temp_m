...
@Entity
@Table(name = "tb_animal_drug_history", uniqueConstraints = {@UniqueConstraint(columnNames = "id") })
public class TB_ANIMAL_DRUG_HISTORY {
	...
	public String getUsed_drug() {
		return used_drug;
	}
	public void setUsed_drug(String used_drug) {
		this.used_drug = used_drug;
	}
