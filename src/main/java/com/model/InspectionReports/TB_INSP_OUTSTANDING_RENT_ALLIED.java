...
@Entity
@Table(name = "tb_insp_outstanding_rent_allied", uniqueConstraints = {@UniqueConstraint(columnNames = "id") })
public class TB_INSP_OUTSTANDING_RENT_ALLIED {

	private int id;
	
	private String year;
	private String amount_outstanding;
	private String on_acc;
	...
	public String getOn_acc() {
		return on_acc;
	}

	public void setOn_acc(String on_acc) {
		this.on_acc = on_acc;
	}
