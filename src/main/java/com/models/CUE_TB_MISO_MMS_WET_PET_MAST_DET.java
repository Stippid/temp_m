...
@Entity
@Table(name = "cue_tb_miso_mms_wet_pet_mast_det", uniqueConstraints = {
@UniqueConstraint(columnNames = "id"),})
public class CUE_TB_MISO_MMS_WET_PET_MAST_DET {
	...
	private String uploaded_wetpet;
	...
	public String getUploaded_wetpet() {
		return uploaded_wetpet;
	}
	public void setUploaded_wetpet(String uploaded_wetpet) {
		this.uploaded_wetpet = uploaded_wetpet;
	}
