...
@Entity
@Table(name = "cue_tb_miso_provision_transport_footnotes", uniqueConstraints = {@UniqueConstraint(columnNames = "id")})
public class CUE_TB_MISO_PROVISION_TRANSPORT_FOOTNOTES {
