...
@Entity
@Table(name = "cue_tb_miso_wepeconditions", uniqueConstraints = {@UniqueConstraint(columnNames = "id")})
public class CUE_TB_MISO_WEPECONDITIONS 
{	
	private int id;	
	private String ammend_status;
	private String approved_rejected_by;	
	private Integer auto_no_wet;
	private String code;
	...
	private String letter_date_copy;
...
/*	@NotNull*/
	...
	public Integer getAuto_no_wet() {
		return auto_no_wet;
	}
	public void setAuto_no_wet(Integer auto_no_wet) {
	...
	public String getLetter_date_copy() {
		return letter_date_copy;
	}
	public void setLetter_date_copy(String letter_date_copy) {
		this.letter_date_copy = letter_date_copy;
	}
