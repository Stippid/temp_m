...
@Entity
@Table(name = "tb_psg_emolument_parent_offcr", uniqueConstraints = {@UniqueConstraint(columnNames = "id") })

public class TB_PSG_EMOLUMENT_PARENT_OFFCR {
