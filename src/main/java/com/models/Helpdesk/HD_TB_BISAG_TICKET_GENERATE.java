...
public class HD_TB_BISAG_TICKET_GENERATE {
	 ...
	 private String sd_vetting;
	 private String sd_reply;
	 
	 @DateTimeFormat (pattern = "yyyy-MM-dd")
		private Date sd_reply_dt ;
	 public Date getSd_reply_dt() {
		return sd_reply_dt;
	}
	public void setSd_reply_dt(Date sd_reply_dt) {
		this.sd_reply_dt = sd_reply_dt;
	}
	...
	public String getSd_vetting() {
		return sd_vetting;
	}
	public void setSd_vetting(String sd_vetting) {
		this.sd_vetting = sd_vetting;
	}
	public String getSd_reply() {
		return sd_reply;
	}
	public void setSd_reply(String sd_reply) {
		this.sd_reply = sd_reply;
	}
}
