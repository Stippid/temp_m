...
@Entity
@Table(name = "tb_tms_emar_drr_dir_dtl", uniqueConstraints = {@UniqueConstraint(columnNames = "id")})

public class TB_TMS_EMAR_DRR_DIR_DTL {
	private int id;
	...
	public void setIssue_agnst_rio(String issue_agnst_rio) {
		this.issue_agnst_rio = issue_agnst_rio;
	}
	...
	public BigInteger getKms_run() {
		return kms_run;
	}
	public void setKms_run(BigInteger kms_run) {
