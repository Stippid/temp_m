...
@Entity
@Table(name = "tb_tms_fmcr_history_table" , uniqueConstraints = {@UniqueConstraint(columnNames = "id")})
public class TB_TMS_FMCR_HISTORY_TABLE {
	  ...
	  private int engine_kms_run;
	  private int engine_hrs_run;
...
//	  private String oh2_detl;
	  ...
	  private Date gms_demand_dt;
	  private String low_tempered_bal;


	private Date save_date;
	  private int engine_hrs_current = 0;
	  private int engine_hr_total = 0;
	  private int engine_failure_at = 0;
	    private int air_compressor_total_hrs = 0;
	    private int air_compressor_failure_at = 0;
	    private int sgb_total_km = 0;
	    private int igb_total_km = 0;
	    private int sprocket_assy_total_km = 0;
	    private int pump_drive_motor_hr = 0;
	    private int starter_genr_total_hr = 0;
	    private int turbo_charger_defect_at = 0;
	    private int fire_fight_sys_cyl_auth = 0;
	    private int fire_fight_sys_cyl_held = 0;
	    private int fire_fight_sys_cyl_empty = 0;
	    private int cbrn_filter_qty = 0;
	    private int no_of_msls_fired = 0;
	    private int no_of_msls_failed = 0;
	    private int relay_kr_hr = 0;
	    private int lrf_hr = 0;
	    private int gyro_direc_indi_hr = 0;
	    private int dist_box_hr = 0;
	    private int dist_box_failure_at = 0;
	    private int sgb_failure_at = 0;
	    private int igb_failure_at = 0;
	    private int track_assy_failure_at = 0;
	    private int sprocket_assy_failure_at = 0;
	    private int pump_drive_motor_failure_at = 0;
	    private int starter_genr_failure_at = 0;
	    private int relay_kr_failure_at = 0;
	    private int lrf_failure_at = 0;
	    private int gyro_direc_failure_at = 0;
	    private int mrs_qty = 0;
	    private int main_gun_article_efc = 0;
	    private int bogie_wheels_held_onrd = 0;
	    private int bogie_wheels_held_offrd = 0;
	    private int track_pads_held_onrd = 0;
	    private int track_pads_held_offrd = 0;
	...
	@Column(name = "ba_no" , nullable = false)
	...
	public int getEngine_kms_run() {
		return engine_kms_run;
	}
	public void setEngine_kms_run(int engine_kms_run) {
		this.engine_kms_run = engine_kms_run;
	}
	
	@Column(name = "engine_hrs_run")
	public int getEngine_hrs_run() {
		return engine_hrs_run;
	}
	public void setEngine_hrs_run(int engine_hrs_run) {
...
//	}
	...
	public int getFmcr_id() {
		return fmcr_id;
	}
	public void setFmcr_id(int fmcr_id) {
		this.fmcr_id = fmcr_id;
	}
	...
	public String getCntry_of_orgn() {
		return cntry_of_orgn;
	}
	public void setCntry_of_orgn(String cntry_of_orgn) {
		this.cntry_of_orgn = cntry_of_orgn;
	}
...
public Date getGms_demand_dt() {
	return gms_demand_dt;
}
public void setGms_demand_dt(Date gms_demand_dt) {
	this.gms_demand_dt = gms_demand_dt;
}
...
@Column(name = "engine_hrs_current", columnDefinition = "INT DEFAULT 0")
public int getEngine_hrs_current() {
    return engine_hrs_current;
}

@Column(name = "engine_hr_total", columnDefinition = "INT DEFAULT 0")
...
@Column(name = "air_compressor_total_hrs", columnDefinition = "INT DEFAULT 0")
public int getAir_compressor_total_hrs() {
    return air_compressor_total_hrs;
}

@Column(name = "air_compressor_failure_at", columnDefinition = "INT DEFAULT 0")
public int getAir_compressor_failure_at() {
    return air_compressor_failure_at;
}

@Column(name = "sgb_total_km", columnDefinition = "INT DEFAULT 0")
public int getSgb_total_km() {
    return sgb_total_km;
}

@Column(name = "igb_total_km", columnDefinition = "INT DEFAULT 0")
public int getIgb_total_km() {
    return igb_total_km;
}

@Column(name = "sprocket_assy_total_km", columnDefinition = "INT DEFAULT 0")
public int getSprocket_assy_total_km() {
    return sprocket_assy_total_km;
}

@Column(name = "pump_drive_motor_hr", columnDefinition = "INT DEFAULT 0")
public int getPump_drive_motor_hr() {
    return pump_drive_motor_hr;
}

@Column(name = "starter_genr_total_hr", columnDefinition = "INT DEFAULT 0")
public int getStarter_genr_total_hr() {
    return starter_genr_total_hr;
}

@Column(name = "turbo_charger_defect_at", columnDefinition = "INT DEFAULT 0")
public int getTurbo_charger_defect_at() {
    return turbo_charger_defect_at;
}

@Column(name = "fire_fight_sys_cyl_auth", columnDefinition = "INT DEFAULT 0")
public int getFire_fight_sys_cyl_auth() {
    return fire_fight_sys_cyl_auth;
}

@Column(name = "fire_fight_sys_cyl_held", columnDefinition = "INT DEFAULT 0")
public int getFire_fight_sys_cyl_held() {
    return fire_fight_sys_cyl_held;
}

@Column(name = "fire_fight_sys_cyl_empty", columnDefinition = "INT DEFAULT 0")
public int getFire_fight_sys_cyl_empty() {
    return fire_fight_sys_cyl_empty;
}

@Column(name = "cbrn_filter_qty", columnDefinition = "INT DEFAULT 0")
public int getCbrn_filter_qty() {
    return cbrn_filter_qty;
}

@Column(name = "no_of_msls_fired", columnDefinition = "INT DEFAULT 0")
public int getNo_of_msls_fired() {
    return no_of_msls_fired;
}

@Column(name = "no_of_msls_failed", columnDefinition = "INT DEFAULT 0")
public int getNo_of_msls_failed() {
    return no_of_msls_failed;
}

@Column(name = "relay_kr_hr", columnDefinition = "INT DEFAULT 0")
public int getRelay_kr_hr() {
    return relay_kr_hr;
}

@Column(name = "lrf_hr", columnDefinition = "INT DEFAULT 0")
public int getLrf_hr() {
    return lrf_hr;
}

@Column(name = "gyro_direc_indi_hr", columnDefinition = "INT DEFAULT 0")
public int getGyro_direc_indi_hr() {
    return gyro_direc_indi_hr;
}

@Column(name = "dist_box_hr", columnDefinition = "INT DEFAULT 0")
public int getDist_box_hr() {
    return dist_box_hr;
}

@Column(name = "dist_box_failure_at", columnDefinition = "INT DEFAULT 0")
public int getDist_box_failure_at() {
    return dist_box_failure_at;
}

@Column(name = "sgb_failure_at", columnDefinition = "INT DEFAULT 0")
public int getSgb_failure_at() {
    return sgb_failure_at;
}

@Column(name = "igb_failure_at", columnDefinition = "INT DEFAULT 0")
public int getIgb_failure_at() {
    return igb_failure_at;
}

@Column(name = "track_assy_failure_at", columnDefinition = "INT DEFAULT 0")
public int getTrack_assy_failure_at() {
    return track_assy_failure_at;
}

@Column(name = "sprocket_assy_failure_at", columnDefinition = "INT DEFAULT 0")
public int getSprocket_assy_failure_at() {
    return sprocket_assy_failure_at;
}

@Column(name = "pump_drive_motor_failure_at", columnDefinition = "INT DEFAULT 0")
public int getPump_drive_motor_failure_at() {
    return pump_drive_motor_failure_at;
}

@Column(name = "starter_genr_failure_at", columnDefinition = "INT DEFAULT 0")
public int getStarter_genr_failure_at() {
    return starter_genr_failure_at;
}

@Column(name = "relay_kr_failure_at", columnDefinition = "INT DEFAULT 0")
public int getRelay_kr_failure_at() {
    return relay_kr_failure_at;
}

@Column(name = "lrf_failure_at", columnDefinition = "INT DEFAULT 0")
public int getLrf_failure_at() {
    return lrf_failure_at;
}

@Column(name = "gyro_direc_failure_at", columnDefinition = "INT DEFAULT 0")
public int getGyro_direc_failure_at() {
    return gyro_direc_failure_at;
}

@Column(name = "mrs_qty", columnDefinition = "INT DEFAULT 0")
public int getMrs_qty() {
    return mrs_qty;
}

@Column(name = "main_gun_article_efc", columnDefinition = "INT DEFAULT 0")
public int getMain_gun_article_efc() {
    return main_gun_article_efc;
}

@Column(name = "bogie_wheels_held_onrd", columnDefinition = "INT DEFAULT 0")
public int getBogie_wheels_held_onrd() {
    return bogie_wheels_held_onrd;
}

@Column(name = "bogie_wheels_held_offrd", columnDefinition = "INT DEFAULT 0")
public int getBogie_wheels_held_offrd() {
    return bogie_wheels_held_offrd;
}

@Column(name = "track_pads_held_onrd", columnDefinition = "INT DEFAULT 0")
public int getTrack_pads_held_onrd() {
    return track_pads_held_onrd;
}

@Column(name = "track_pads_held_offrd", columnDefinition = "INT DEFAULT 0")
