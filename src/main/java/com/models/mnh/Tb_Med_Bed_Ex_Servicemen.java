...
@Entity
@Table(name = "tb_med_bed_ex_servicemen", uniqueConstraints = {
@UniqueConstraint(columnNames = "id")})
public class Tb_Med_Bed_Ex_Servicemen {
    ...
    private int need_exms_adm;
    private int need_exms_bed_days;
    private int no_of_fmly_ref_adm;
	...
	public int getNeed_exms_adm() {
		return need_exms_adm;
	}
	public void setNeed_exms_adm(int need_exms_adm) {
		this.need_exms_adm = need_exms_adm;
	}
	public int getNeed_exms_bed_days() {
		return need_exms_bed_days;
	}
	public void setNeed_exms_bed_days(int need_exms_bed_days) {
		this.need_exms_bed_days = need_exms_bed_days;
	}
	public int getNo_of_fmly_ref_adm() {
		return no_of_fmly_ref_adm;
	}
	public void setNo_of_fmly_ref_adm(int no_of_fmly_ref_adm) {
		this.no_of_fmly_ref_adm = no_of_fmly_ref_adm;
	}
	@Column(length = 250)
