...
@Entity
@Table(name = "tb_psg_civilian_spouse_qualification_reg", uniqueConstraints = {@UniqueConstraint(columnNames = "id") })
public class TB_CIVILIAN_SPOUSE_QUALIFICATION_REG {
	private int id;
	private int type;
