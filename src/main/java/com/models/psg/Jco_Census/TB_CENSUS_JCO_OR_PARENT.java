...
@Entity
@Table(name = "tb_psg_census_jco_or_p", uniqueConstraints = {@UniqueConstraint(columnNames = "id") })

public class TB_CENSUS_JCO_OR_PARENT {
	...
	private int district_of_birth=0;
	private int state_of_birth=0;
	private int country_of_birth=0;
...
//	@DateTimeFormat(pattern = "dd/MM/yyyy")
	...
	private int update_jco_cancel_status;
	...
	public String getRank_intake() {
		return rank_intake;
	}
	public void setRank_intake(String rank_intake) {
		this.rank_intake = rank_intake;
	}
	...
	public int getUpdate_jco_cancel_status() {
		return update_jco_cancel_status;
	}
	public void setUpdate_jco_cancel_status(int update_jco_cancel_status) {
		this.update_jco_cancel_status = update_jco_cancel_status;
	}
