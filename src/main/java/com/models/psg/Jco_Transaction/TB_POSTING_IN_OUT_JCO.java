...
@Entity
@Table(name = "tb_psg_posting_in_out_jco", uniqueConstraints = {@UniqueConstraint(columnNames = "id") })

public class TB_POSTING_IN_OUT_JCO {
	private int id;
	private int jco_id; 
	private int rank; 
	...
	public void setApp_name(int app_name) {
