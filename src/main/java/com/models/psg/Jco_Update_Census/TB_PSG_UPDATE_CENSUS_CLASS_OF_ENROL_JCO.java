...
@Entity
@Table(name = "tb_psg_update_census_class_of_enrol_jco", uniqueConstraints = {@UniqueConstraint(columnNames = "id") }) 

public class TB_PSG_UPDATE_CENSUS_CLASS_OF_ENROL_JCO {
