...
@Entity
@Table(name = "tb_psg_update_census_mother_tongue_jco", uniqueConstraints = {@UniqueConstraint(columnNames = "id") })

public class TB_PSG_UPDATE_CENSUS_MOTHER_TOUNGE_JCO {
	...
	public void setMother_tounge(int mother_tounge) {
