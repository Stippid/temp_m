...
@Entity
@Table(name = "tb_psg_mstr_height", uniqueConstraints = {
@UniqueConstraint(columnNames = "height_id"),})
public class TB_Height {
	  ...
	  private String created_by;
		...
		@Column(name = "height_id", unique = true, nullable = false)
