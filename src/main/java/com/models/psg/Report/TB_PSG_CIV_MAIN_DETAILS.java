...
@Entity
@Table(name = "tb_psg_held_str_civ_main_details", uniqueConstraints = {@UniqueConstraint(columnNames = "id") })
public class TB_PSG_CIV_MAIN_DETAILS {
	...
	private String civilian_status;
