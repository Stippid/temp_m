...
@Entity
@Table(name = "tb_psg_iaff_3008_main_details", uniqueConstraints = {@UniqueConstraint(columnNames = "id") })
public class TB_PSG_IAFF_3008_MAIN_DETAILS {
	...
	private String remarksforoffrstos;
	private String remarksforoffrssos;
	private String remarksforoffrspostout;
	private String remarksforoffrspostin;
	private String remarksforoffrsunderretire;
	...
	public String getRemarksforoffrstos() {
		return remarksforoffrstos;
	}
	public void setRemarksforoffrstos(String remarksforoffrstos) {
		this.remarksforoffrstos = remarksforoffrstos;
	}
	public String getRemarksforoffrssos() {
		return remarksforoffrssos;
	}
	public void setRemarksforoffrssos(String remarksforoffrssos) {
		this.remarksforoffrssos = remarksforoffrssos;
	}
	public String getRemarksforoffrspostout() {
		return remarksforoffrspostout;
	}
	public void setRemarksforoffrspostout(String remarksforoffrspostout) {
		this.remarksforoffrspostout = remarksforoffrspostout;
	}
	public String getRemarksforoffrspostin() {
		return remarksforoffrspostin;
	}
	public void setRemarksforoffrspostin(String remarksforoffrspostin) {
		this.remarksforoffrspostin = remarksforoffrspostin;
	}
	public String getRemarksforoffrsunderretire() {
		return remarksforoffrsunderretire;
	}
	public void setRemarksforoffrsunderretire(String remarksforoffrsunderretire) {
		this.remarksforoffrsunderretire = remarksforoffrsunderretire;
	}
