...
@Entity
@Table(name = "tb_psg_trans_proposed_comm_letter_history", uniqueConstraints = {@UniqueConstraint(columnNames = "id") })
public class TB_TRANS_PROPOSED_COMM_LETTER_HISTORY {

	private BigInteger id;
	private BigInteger comm_his_id;
...
//	}
	...
	public BigInteger getComm_his_id() {
		return comm_his_id;
	}
	public void setComm_his_id(BigInteger comm_his_id) {
		this.comm_his_id = comm_his_id;
	}
