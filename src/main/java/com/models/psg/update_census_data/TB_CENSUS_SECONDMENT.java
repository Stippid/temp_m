...
@Entity
@Table(name = "tb_psg_census_secondment", uniqueConstraints = {@UniqueConstraint(columnNames = "id") })
public class TB_CENSUS_SECONDMENT {
	...
	private int seconded_to;
	private Date secondment_effect;
	...
	public int getSeconded_to() {
		return seconded_to;
	}
	public void setSeconded_to(int seconded_to) {
	...
	public Date getSecondment_effect() {
		return secondment_effect;
	}
	public void setSecondment_effect(Date secondment_effect) {
		this.secondment_effect = secondment_effect;
	}
