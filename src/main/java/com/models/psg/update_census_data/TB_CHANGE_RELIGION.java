...
import java.util.Date;
	...
	import org.springframework.format.annotation.DateTimeFormat;
		...
		@Entity
		@Table(name = "tb_psg_change_religion", uniqueConstraints = {@UniqueConstraint(columnNames = "id") })
		public class TB_CHANGE_RELIGION {
			...
			private Date change_in_rel_date;
			...
			public Date getChange_in_rel_date() {
				return change_in_rel_date;
			}
			public void setChange_in_rel_date(Date change_in_rel_date) {
				this.change_in_rel_date = change_in_rel_date;
			}
