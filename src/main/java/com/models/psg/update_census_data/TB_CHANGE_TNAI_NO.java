...
import com.controller.psg.update_3008.Change_In_date_of_sen_3008;

 
	@Entity
	@Table(name = "tb_psg_change_tnai_no", uniqueConstraints = {@UniqueConstraint(columnNames = "id") })
	public class TB_CHANGE_TNAI_NO {
