...
@Entity
@Table(name = "tb_psg_change_of_seniority", uniqueConstraints = { @UniqueConstraint(columnNames = "id"), })
public class TB_PSG_CHANGE_OF_SENIORITY {
	...
	private Date applicablity_date;
	...
	public Date getApplicablity_date() {
		return applicablity_date;
	}
	public void setApplicablity_date(Date applicablity_date) {
		this.applicablity_date = applicablity_date;
	}
