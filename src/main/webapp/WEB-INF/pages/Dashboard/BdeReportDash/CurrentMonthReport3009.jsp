		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header" align="center">
					<strong style="text-decoration: underline;">3009</strong>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="watermarked" data-watermark="" id="divwatermark"
			...
			<div class="datatablediv" id="reportDiv">
				<div class="">
					<div class="watermarked" data-watermark="" id="divwatermark">
						<span id="ip"></span>
						<table id="3009CurrentMonthReport"
	...
	<div class="col-md-12">
		<div align="center" class="print_btn">
			...
			font-weight: bold; color: white; background-color: purple;" value="Export to Excel"
				onclick="exportToExcel('3009CurrentMonthReport', '3009 Current Month Report')">
		</div>
	</div>
 ...
 <input type="hidden" name="type_of_report" id="type_of_report"  value="0">
	...
	<script>
		...
		$(document).ready(function() {
			...
			colAdj("3009CurrentMonthReport");

		});

		mockjax1('3009CurrentMonthReport');
		table = dataTable('3009CurrentMonthReport');
		...
		function data(tableName) {
			...
			if (tableName == "3009CurrentMonthReport") {			

				$.post("get3009CurrentMonthlistCount?" + key + "=" + value, {
					Search : Search}, function(j) {

					FilteredRecords = j;
				});
				$.post("get3009CurrentMonthlist?" + key + "=" + value, {
		...
		function exportToExcel(tableId, fileName) {
			...
			XLSX.utils.book_append_sheet(wb, ws, "3009 Current Month Report");
	...
	function downloaddata(){
		document.getElementById('type_of_report').value="CurrentMonthReport3009";
