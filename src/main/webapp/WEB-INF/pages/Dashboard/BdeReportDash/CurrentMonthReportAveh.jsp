		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header" align="center">
					<strong style="text-decoration: underline;">A VEH</strong>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="watermarked" data-watermark="" id="divwatermark"
			...
			<div class="datatablediv" id="reportDiv">
				<div class="">
					<div class="watermarked" data-watermark="" id="divwatermark">
						<span id="ip"></span>
						<table id="AvehCurrentMonthReport"
	...
	<div class="col-md-12">
		<div align="center" class="print_btn">
			...
			font-weight: bold; color: white; background-color: purple;" value="Export to Excel"
				onclick="exportToExcel('AvehCurrentMonthReport', 'A VEH Current Month Report')">
		</div>
	</div>
 ...
 <input type="hidden" name="type_of_report" id="type_of_report"  value="0">
	...
	<script>
		...
		$(document).ready(function() {
			...
			colAdj("AvehCurrentMonthReport");

		});

		mockjax1('AvehCurrentMonthReport');
		table = dataTable('AvehCurrentMonthReport');
		...
		function data(tableName) {
			...
			if (tableName == "AvehCurrentMonthReport") {			

				$.post("getAvehcurrentMonthCount?" + key + "=" + value, {
					Search : Search}, function(j) {

					FilteredRecords = j;
				});
				$.post("getAvehcurrentMonthList?" + key + "=" + value, {
		...
		function exportToExcel(tableId, fileName) {
			...
			XLSX.utils.book_append_sheet(wb, ws, "A VEH Current Month Report");
			XLSX.writeFile(wb, fileName + ".xlsx");
		}

	
	function downloaddata(){
		document.getElementById('type_of_report').value="AvehCurrentMonthReport";
