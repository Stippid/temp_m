		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header" align="center">
					<strong style="text-decoration: underline;">C VEH</strong>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="watermarked" data-watermark="" id="divwatermark"
			...
			<div class="datatablediv" id="reportDiv">
				<div class="">
					<div class="watermarked" data-watermark="" id="divwatermark">
						<span id="ip"></span>
						<table id="CvehCurrentMonthReport"
	...
	<div class="col-md-12">
		<div align="center" class="print_btn">
			...
			font-weight: bold; color: white; background-color: purple;" value="Export to Excel"
				onclick="exportToExcel('CvehCurrentMonthReport', 'C VEH Current Month Report')">
		</div>
	</div>
 ...
 <input type="hidden" name="type_of_report" id="type_of_report"  value="0">
	...
	<script>
		...
		$(document).ready(function() {
			...
			colAdj("CvehCurrentMonthReport");

		});

		mockjax1('CvehCurrentMonthReport');
		table = dataTable('CvehCurrentMonthReport');
		...
		function data(tableName) {
			...
			if (tableName == "CvehCurrentMonthReport") {			

				$.post("getCvehcurrentMonthCount?" + key + "=" + value, {
					Search : Search}, function(j) {

					FilteredRecords = j;
				});
				$.post("getCvehcurrentMonthList?" + key + "=" + value, {
		...
		function exportToExcel(tableId, fileName) {
			...
			XLSX.utils.book_append_sheet(wb, ws, "C VEH Current Month Report");
			XLSX.writeFile(wb, fileName + ".xlsx");
		}

	
	function downloaddata(){
		document.getElementById('type_of_report').value="CvehCurrentMonthReport";
