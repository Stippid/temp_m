		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header" align="center">
					<strong style="text-decoration: underline;">IT Assets(holding as on date)</strong>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="watermarked" data-watermark="" id="divwatermark"
			...
			<div class="datatablediv" id="reportDiv">
				<div class="">
					<div class="watermarked" data-watermark="" id="divwatermark">
						<span id="ip"></span>
						<table id="IT_Assets_holding_as_on_date"
	...
	<div class="col-md-12">
		<div align="center" class="print_btn">
			...
			font-weight: bold; color: white; background-color: purple;" value="Export to Excel"
				onclick="exportToExcel('IT_Assets_holding_as_on_date', 'IT Assets(holding as on date)')">
		</div>
	</div>
 ...
 <input type="hidden" name="type_of_report" id="type_of_report"  value="0">
	...
	<script>
		...
		$(document).ready(function() {
			...
			colAdj("IT_Assets_holding_as_on_date");

		});

		mockjax1('IT_Assets_holding_as_on_date');
		table = dataTable('IT_Assets_holding_as_on_date');
		...
		function data(tableName) {
			...
			if (tableName == "IT_Assets_holding_as_on_date") {			

				$.post("IT_Assets_holding_as_on_dateCount?" + key + "=" + value, {
					Search : Search}, function(j) {

					FilteredRecords = j;
				});
				$.post("IT_Assets_holding_as_on_dateList?" + key + "=" + value, {
					...
					for (var i = 0; i < j.length; i++) {
						var sr = i + 1;
						jsondata.push([ sr, j[i].unit_name, j[i].computing, j[i].peripheral]);
		...
		function exportToExcel(tableId, fileName) {
			...
			XLSX.utils.book_append_sheet(wb, ws, "IT Assets(holding as on date)");
	...
	function downloaddata(){
		document.getElementById('type_of_report').value="IT_Assets_holding_as_on_date";
