		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header" align="center">
					<strong style="text-decoration: underline;"> PERIPHERAL </strong>
				</div>
				<div class="mt-1">
	...
	<script>
		...
		function data(tableName) {
			...
			if (tableName == "IT_Assets") {
				...
				$.post("peripheralReportDatacount?" + key + "=" + value, {
					Search : Search
				}, function(j) {
					FilteredRecords = j;
				});
				$.post("peripheralReportData?" + key + "=" + value, {
					...
					for (var i = 0; i < j.length; i++) {
						var sr = i + 1;
						jsondata.push([ sr, j[i].unit_name, j[i].assets_name,j[i].type_of_hw,j[i].count2
								 ]);
