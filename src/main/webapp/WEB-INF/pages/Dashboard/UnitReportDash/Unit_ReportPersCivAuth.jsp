...
<div class="animated fadeIn">
						...
						<table id="persCivAuth"
							...
							<thead>
								...
								<tr>
									...
									<th colspan="2" style="text-align: center;">Non Gazetted</th>
								</tr>
								<tr>
	...
	<div class="col-md-12">
		...
		<input type="button" class="btn btn-purple" style="padding: 5px 10px; font-size: 14px; 
			...
			onclick="exportToExcel('persCivAuth', 'Pers Auth(Civs)')">
...
<form:form action="${dwonloadUrl}" method="post" id="downloadForm" name="downloadForm" modelAttribute="type_of_report">
 <input type="hidden" name="type_of_report" id="type_of_report"  value="0">
	...
	<script>
		...
		mockjax1('persCivAuth');
		table = dataTable('persCivAuth');
		...
		function data(tableName) {
			...
			if (tableName == "persCivAuth") {

				$.post("getUnitReportPersCivAuthcount?" + key + "=" + value, {
					Search : Search
				...
				$.post("getUnitReportPersCivAuth?" + key + "=" + value, {
		...
		function printDiv(divName) {
			...
			row += '<div class="col-6 col-sm-6 col-md-6"><h3>Pers Auth(Civ) </h3> </div> ';
		...
		function exportToExcel(tableId, fileName) {
			...
			XLSX.utils.book_append_sheet(wb, ws, "Pers Auth(Civs)");
			XLSX.writeFile(wb, fileName + ".xlsx");
		}
		
		function downloaddata(){
            document.getElementById('type_of_report').value="civ_auth";
