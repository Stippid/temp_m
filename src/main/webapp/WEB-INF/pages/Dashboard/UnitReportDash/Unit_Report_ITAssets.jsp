...
<div class="animated fadeIn">
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header" align="center">
					<strong style="text-decoration: underline;"> IT Assets</strong>
					<label class="form-control-label alert info" style="font-weight: bold; font-size: 11.5px; color: red; " >
					    (Only Serviceable Assets) 
				...
				<div class="mt-1">
					...
					<!-- <div class="card-footer">
						<div align="center" class="search_btn"></div>
					</div> -->
				</div>
			</div>
		</div>
	...
	<!-- <div class="col-md-12 instruction " >
			<div class="card">
				<div class="card-body" >
				    <label class="form-control-label alert info" style="font-weight: bold; font-size: 11.5px; color: red; float:right;" >
					    Only Serviceable Data Shown on Dashboard and Data-List.
						...
						<table id="IT_Assets"
							...
							<thead style="font-size: 15px; text-align: center;">
								<tr>
									<th>Ser No</th>
									<th>Unit Name</th>
									<th>Asswts Types(Coumputing/Peripheral)</th>
									<th>Asset Name</th>
									<th>Machine No/ Ser No</th>
									<th>OS</th>
									<th>Office Software</th>
									<th>Yr of Procurement/ Vintage</th>
									<th>Processer Type</th>
									<th>Dply enmvt</th>
	...
	<div class="col-md-12">
		<div align="center" class="print_btn">
			...
			<input type="button" class="btn btn-purple" style="padding: 5px 10px; font-size: 14px; font-weight: bold; color: white; background-color: purple;" value="Export to Excel" onclick="exportToExcel('IT_Assets', 'IT Asset')">
 ...
 <input type="hidden" name="type_of_report" id="type_of_report"  value="0">
	...
	<script>
		...
		function data(tableName) {
			...
			if (tableName == "IT_Assets") {

				$.post("getUnitReportIT_Assetscount?" + key + "=" + value, {
					Search : Search,
					sus_no : sus_no
				...
				$.post("getUnitReportIT_Assets?" + key + "=" + value, {
					...
					for (var i = 0; i < j.length; i++) {
						...
						jsondata.push([ sr, j[i].unit_name, j[i].assets_type, j[i].assets_name,
								j[i].machine_number, j[i].os, j[i].office,
								j[i].year_of_proc, j[i].processor_type,
								j[i].dply_env ]);
		...
		function printDiv(divName) {
			...
			row += '<div class="col-6 col-sm-6 col-md-6"><h3>IT Asset</h3> </div> ';
		...
		function downloaddata(){
            document.getElementById('type_of_report').value="itasset_held";
