					...
					<div class="col-md-12 ">
							...
							<table style="width: 100%;" class="table no-margin table-striped  table-hover  table-bordered report_print" >
								<thead style="color: white; text-align: center;">
									<tr>
										<th colspan="7" align="center"><h4>DEFAULTER LIST</h4></th>
									</tr>
									<tr>
						...
						<div class="col-md-12 ">
							...
							<table style="width: 100%;" class="table no-margin table-striped  table-hover  table-bordered report_print" >
								<thead  style="color: white; width:100%;text-align: center;">
									<tr>
									
									 <th colspan="40" align="center"><h4>BED STATE</h4></th>
									
										<!-- <th colspan="11"  style="font-size: 14px;color: white; margin-top: 5px; text-align: center;">BED STATE</th> -->
									</tr>
							
									<tr>
									 <th style="writing-mode: vertical-lr;-ms-writing-mode: tb-rl; transform: rotate(180deg);" rowspan="12"  >
                                              Sr.No
                                     </th>
                                      <th style="writing-mode: vertical-lr;-ms-writing-mode: tb-rl; transform: rotate(180deg);" rowspan="12" >
                                            Name Of MH
                                      ...
                                      <th style="writing-mode: vertical-lr;-ms-writing-mode: tb-rl; transform: rotate(180deg);" rowspan="12"  >
										...
										<th  colspan="8">ARMY</th>
										<th colspan="8">AIRFORCE</th>
										<th colspan="8">NAVY</th>
										<th colspan="8">OTHERS</th>
										
									 <th style="writing-mode: vertical-lr;-ms-writing-mode: tb-rl; transform: rotate(180deg);" rowspan="8" >
                                             Authorized Bed
                                     </th>
                                      <th style="writing-mode: vertical-lr;-ms-writing-mode: tb-rl; transform: rotate(180deg);" rowspan="12"  >
                                           Bed Laid Out
                                      ...
                                      <th style="writing-mode: vertical-lr;-ms-writing-mode: tb-rl; transform: rotate(180deg);" rowspan="12"  >
                                          Bed Occ(%) As per Laid out BEDS
                                     </th>
                                     <th style="writing-mode: vertical-lr;-ms-writing-mode: tb-rl; transform: rotate(180deg);" rowspan="12" >
                                          Bed Occ(%) As per Auth Beds
                                     </th>
									</tr>
									<tr>
									 <th  colspan="4">Serving</th>
									 <th colspan="4">Ex-Serving</th>
									  ...
									  <td style="writing-mode: vertical-lr;-ms-writing-mode: tb-rl; transform: rotate(180deg);" rowspan="2" >Officer</td>
									  <td style="writing-mode: vertical-lr;-ms-writing-mode: tb-rl; transform: rotate(180deg);" rowspan="2" >Officer-Family</td>
									  <td style="writing-mode: vertical-lr;-ms-writing-mode: tb-rl; transform: rotate(180deg);" rowspan="2" >JCO/OR</td>
									  <td style="writing-mode: vertical-lr;-ms-writing-mode: tb-rl; transform: rotate(180deg);" rowspan="2" >JCO/OR Family</td>
							...
							<table style="width: 100%;" class="table no-margin table-striped  table-hover  table-bordered report_print">
								<thead style="color: white; text-align: center;">
									<tr>
										<th colspan="6" align="center"><h4>DAILY DISEASE SURVEILLANCE DETAILS</h4></th>
									</tr>
									<tr>
										<th >SER</th>
										<th >MH</th>
...
$(document).ready(function () {
	...
	$.post("getTargetSUSFromUNITNAME?"+key+"="+value, {target_unit_name:'${unit_name_h}'}).done(function(j) {				
	...
	$.post("getTargetSUSFromUNITNAME?"+key+"="+value, {target_unit_name:'${vip_h}'}).done(function(j) {				
		 var length = j.length-1;
        //var enc = j[length].substring(0,16);
       // jQuery("#sus_no").val(dec(enc,j[0]));
	}).fail(function(xhr, textStatus, errorThrown) {
	});
	$.post("getTargetSUSFromUNITNAME?"+key+"="+value, {target_unit_name:'${adm_amc_h}'}).done(function(j) {				
		 var length = j.length-1;
        //var enc = j[length].substring(0,16);
       // jQuery("#sus_no").val(dec(enc,j[0]));
	}).fail(function(xhr, textStatus, errorThrown) {
	});
	$.post("getTargetSUSFromUNITNAME?"+key+"="+value, {target_unit_name:'${bed_state_h}'}).done(function(j) {				
		 var length = j.length-1;
        //var enc = j[length].substring(0,16);
       // jQuery("#sus_no").val(dec(enc,j[0]));
	}).fail(function(xhr, textStatus, errorThrown) {
	});
	$.post("getTargetSUSFromUNITNAME?"+key+"="+value, {target_unit_name:'${unusual_h}'}).done(function(j) {				
		 var length = j.length-1;
        //var enc = j[length].substring(0,16);
       // jQuery("#sus_no").val(dec(enc,j[0]));
	}).fail(function(xhr, textStatus, errorThrown) {
