	...
	<div class="container" id="printableArea">
			<div class="row">
	    		<div class="card">
		            ...
		            <div class="col-md-12" id="docTypeReport" >
		           	 	<div id="divShow" style="display: block;">
						</div> 
						 <div class="watermarked" data-watermark="" id="divwatermark" style="display: block;">
					<span id="ip"></span>
         				<datatables:table id="applicanttbl" url="getDocTypeDetaisReportWPF" serverSide="true" pipelining="true" pipeSize="3"	row="latlon" rowIdBase="applicant_id" rowIdPrefix="latlon_" displayLength="10" lengthMenu="10,20,100,500,50000"  jqueryUI="true"  
	    					bDestroy="true" filterable="true" sortable="true" width="100%" processing="true" border="1" autoWidth="true" pageable="true" paginationType="full_numbers" stateSave="false" deferRender="true"  scrollCollapse="true" >  
							    ...
							    <datatables:column title="Doc Type" property="wet_pet" searchable="true" data-halign="left" data-valign="left" />
							    <datatables:column title="WE/PE/FE/GSL No." property="wet_pet_no" searchable="true" data-halign="left" data-valign="left" />
							    <datatables:column title="Table Title" property="unit_type" searchable="true" data-halign="left" data-valign="left"/>
							    <datatables:column title="Sponsor Dire" property="sponsor_dire" searchable="true" data-halign="left" data-valign="left" />
<%-- 							    <datatables:column title="Type" property="type" searchable="true" data-halign="left" data-valign="left" /> --%>
		...
		<div class="col-md-12">
			<div align="center" class="print_btn">
				<input type="button" value="Print" onclick="return printDiv('docTypeReport')" style="color:white; padding: 5px 10px 5px 10px; font-size: 14px; font-weight: bold;">
