...
<script src="js/miso/commonJS/commonmethod.js" type="text/javascript"></script>
	...
	<div class="mt-1">
		<div class="col-md-12" >
			<div class="card">		
			<div class="card-header" align="center"> <strong style="text-decoration: underline;"> Comd Wise Auth of Wpn & Eqpt</strong> 
	    			</div>
					<div class="card-body">
...
<!--                						<input type="hidden" id="prf_group_code" name="prf_group_code" maxlength="8" class="form-control"  > -->
							...
							<div class="row form-group">
								<div class="col col-md-3">
									<label class=" form-control-label">Nomenclature of Wpn & Eqpt:</label>
								</div>
								<div class="col-12 col-md-8">
					...
					<div id="nomenClature" class="checkboxes ${not empty selectedBdesList}"
			...
			<a href="DocTypeReportWetPetFet?type=wpn" class="btn btn-success btn-sm" >Clear</a>  
...
function data(tableName) {
	...
	findselecteNC();
	var nomenClature = $("#CheckValNC").val();
	...
	if (tableName == "getSearch") {
	    ...
	    $.post("getDocTypeDetaisReportWpncount?" + key + "=" + value,{
	    	Search:Search,
		...
		$.post("getDocTypeDetaisReportWpn?" + key + "=" + value, {
			...
			for (var i = 0; i < j.length; i++) {
				...
				jsondata.push([j[i].cmd_name, j[i].ff, j[i].nff, j[i].totalue]);
...
if (count==1){
$.post("getitemtypedash?"+key+"="+value,{selected:selected}, function(j) {
	  if (j != "") {
            var length = j.length;
            var options = '';
...
var checkboxes = document.getElementById("nomenClature");
$("#nomenClature").toggle();
