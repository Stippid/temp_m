...
<dandelion:asset jsExcludes="jquery"/>
  ...
  <head>
	<title>Rank Category Wise UE</title>
...
<script src="js/miso/commonJS/commonmethod.js" type="text/javascript"></script>
	...
	<div class="mt-1">
		<div class="col-md-12" >
			<div class="card">		
				<div class="card-header" align="center"> <strong style="text-decoration: underline;"> Rank Category Wise UE</strong> 
	    			</div>		
...
// 	$("#toDate").val('${toDate}');
// select_rank_cat();
	mockjax1('rankCatTable');
	table = dataTable11('rankCatTable');
...
// 	var toDate = $("#toDate").val();  
	...
	if (tableName == "rankCatTable") {
	
		$.post("Rank_cat_wise_dtl_tablecount?" + key + "=" + value,{
			Search:Search,
			cat_id: cat_id,
			cont_comd : cont_comd,
		...
		$.post("Rank_cat_wise_dtl_table?" + key + "=" + value, {	
			startPage : startPage,
			...
			for (var i = 0; i < j.length; i++) {
				...
				jsondata.push([sr, j[i].total_ue,j[i].unit_name,j[i].sus_no ,j[i].cmd_name,j[i].coprs_name,j[i].div_name
					,j[i].bde_name ,j[i].arm_desc,j[i].label,j[i].description]);
