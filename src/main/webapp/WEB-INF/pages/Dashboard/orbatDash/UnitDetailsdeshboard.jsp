...
<script src="js/miso/commonJS/commonmethod.js" type="text/javascript"></script>
	...
	<div class="mt-1">
		<div class="col-md-12" >
			<div class="card">		
				<div class="card-header" align="center"> <strong style="text-decoration: underline;"> UNIT DETAILS</strong> 
	    			</div>		
							...
							<div class="row form-group">
								<div class="col col-md-3">
                					...
                					<input type="hidden" id="location_code" name="location"  class="form-control" >
                  					<input type="text" id="location" name="location_name" maxlength="5" class="form-control" >
                					</div>
              					</div>  
              					</div>
             				</div>
...
// 	var toDate = $("#toDate").val();  
	...
	if (tableName == "applicanttbl") {
		...
		$.post("get_Active_Unit_DocTypeDetais_Report_tablecount?" + key + "=" + value,{
			Search:Search,
			cat_id: cat_id,
			cont_comd : cont_comd,
...
// 			rank : rank
		...
		$.post("get_Active_Unit_DocTypeDetais_Report?" + key + "=" + value, {	
			startPage : startPage,
...
// 			rank : rank
			...
			for (var i = 0; i < j.length; i++) {
				...
				jsondata.push([sr, j[i].sus_no,j[i].unit_name,j[i].cmd_name ,j[i].coprs_name
					, j[i].div_name,j[i].bde_name,j[i].location ,j[i].nrs, j[i].arm_desc,j[i].ct_part_i_ii,j[i].type_of_force]);
