  ...
  <head>
	...
	<body style="height: 400px">
		<div class="container" id="printableArea">
				<div class="card">
	    			<div class="card-header" align="center"> <strong style="text-decoration: underline;">VCR DETAILS</strong></div> 
		            <div class="col-md-12" id="printableArea" >
		           		<div id="divShow" style="display: block;"></div> 
						<div class="watermarked" data-watermark="" id="divwatermark" style="display: block;">
						<span id="ip"></span>
         				 
  						<datatables:table id="applicanttbl" url="getAMvcrDetaisrpt" serverSide="true" pipelining="true" pipeSize="3"	row="latlon" rowIdBase="applicant_id" rowIdPrefix="latlon_"  displayLength="10" lengthMenu="10,20,100,500,5000" jqueryUI="true" 
...
{	
    ...
    var formattedtoday1 =date.getDate()  + '-' + (date.getMonth() + 1)  + '-' + date.getFullYear() ;		
 	...
 	$("div#divShow").empty();
	$("div#divShow").show();
 	printDivOptimize(divName,'VCR DETAILS',"","","");
 	//document.location.reload();
	$("div#divShow").hide();
}
