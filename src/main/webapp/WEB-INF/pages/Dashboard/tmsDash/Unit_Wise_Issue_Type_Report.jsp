			...
			<div class="row">
	    		<div class="card">
					...
					<span id="ip"></span>
  						...
  						<datatables:table id="applicanttbl" url="getloanStoreReportRpt" serverSide="true" pipelining="true" pipeSize="3"	row="latlon" rowIdBase="applicant_id" rowIdPrefix="latlon_"  displayLength="10" lengthMenu="10,20,100,500,5000" jqueryUI="true" 
	    					bDestroy="true" filterable="false" sortable="true" processing="true" border="1"  autoWidth="true" pageable="true" paginationType="full_numbers" stateSave="false" deferRender="true"  scrollX="100%" scrollY="100%" scrollCollapse="true" >  
							    ...
							    <datatables:column title="DIV" property="div" searchable="true" data-halign="left" data-valign="left" />
							    <datatables:column title="BDE" property="bde" searchable="true" data-halign="left" data-valign="left" />
							    <datatables:column title="SUS NAME" property="unit_name" searchable="true" data-halign="left" data-valign="left" />
							    <datatables:column title="LOAN STORE" property="loan" searchable="true" data-halign="left" data-valign="left" />
						</datatables:table>    
                        <br/>
                        </div>
		        	</div>
