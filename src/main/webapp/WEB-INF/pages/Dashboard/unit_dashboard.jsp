   	...
   	<h2 class="notifi_head">${unit_name} DASHBOARD   </h2>
								...
								<table>
									...
									<tbody>
										...
										<tr>
											<td>C</td>
											<td>
												<button class="btn btn-modify btn-round" id="countcauth" onclick="openvehicleAuth(this)">
													0</button>
											</td>
											<td>
			...
			<div class="tbl_scroll">
				<table
					...
					<thead>
						<tr>
							<th width="10%" rowspan="2" style="text-align: center; vertical-align: middle;">Unit Name</th>
							<th width="10%" rowspan="2" style="text-align: center; vertical-align: middle;">Unit Sus</th>
							<th colspan="7" style="text-align: center;">Last Update</th>
						</tr>
						<tr>
							<th width="10%" style="text-align: center;">IAFF 3008</th>
							<th width="10%" style="text-align: center;">IAFF 3009</th>
							<th width="10%" style="text-align: center;">Wpn & Eqpt (MCR)</th>
							<th width="10%" style="text-align: center;">A Veh (FMCR)</th>
							<th width="10%" style="text-align: center;">B Veh (MVCR)</th>
							<th width="10%" style="text-align: center;">C Veh (EMAR)</th>
							<th width="10%" style="text-align: center;">IT Asset</th>
						</tr>
					</thead>
					<tbody>
						<c:choose>
							<c:when test="${not empty lastupdateList}">
								<c:forEach var="row" items="${lastupdateList}">
									<tr>
										<td style="text-align: center;"><c:out
												value="${row.unit_name}" /></td>
										<td style="text-align: center;"><c:out
												value="${row.sus_no}" /></td>
										<td style="text-align: center;"><c:out
												value="${row.date_3008}" /></td>
										<td style="text-align: center;"><c:out
												value="${row.date_3009}" /></td>
										<td style="text-align: center;"><c:out
												value="${row.mcr_date}" /></td>
										<td style="text-align: center;"><c:out
												value="${row.aveh_date}" /></td>
										<td style="text-align: center;"><c:out
												value="${row.bveh_date}" /></td>
										<td style="text-align: center;"><c:out
												value="${row.cveh_date}" /></td>
										<td style="text-align: center;"><c:out
												value="${row.it_asset_date}" /></td>
									</tr>
								</c:forEach>
							</c:when>
							<c:otherwise>
								<tr>
									<td colspan="9" style="text-align: center;">Data is not
										available</td>
								</tr>
							</c:otherwise>
						</c:choose>
		...
		<div class="row">
			<div class="col-md-12 p-0">	
			  	...
			  	<h3 class="notifi_head">NOTIFICATION</h3>
			...
			<div class="container-fluid mt-10px padding-x-0">
		<div class="row">		
		<div id="notifications2" class="notifications2"   style="height:300px;">		
	
			<div class="col-md-12">
			<div class="col-md-4">
			<h4 class="notifi_psg">PERS</h4>
			<div class="" >
			<div id="appnoti2" class="marquee_psg">
			</div>
			</div>
			</div>
			<div class="col-md-4">
			<h4 class="notifi_tms">VEHS</h4>
				<div class="" >
			<div id="appnoti3" class="marquee_tms" >
			</div>
			</div>
			</div>
			<div class="col-md-4">
			<h4 class="notifi_cue">SD Aspects</h4> 
			<div class="">
			<div id="appnoti4"  class="marquee_cue">
			</div>
			</div>
			</div>
</div>
