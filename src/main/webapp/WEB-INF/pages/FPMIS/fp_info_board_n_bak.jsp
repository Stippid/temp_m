...
<script type="text/javascript">
	...
	function chgeffect() {
		$("#nrTableShowDtl").html("<tr><td colspan='9' style='font-size:1.5em;'><center>Press 'Get Data' Button ...");
...
<body class="mmsbg" onload="setMenu();">
	<form:form name="fp_info_board_n" id="fp_info_board_n" method='POST'>
		...
		<div class="" align="center" style="width:99vw; margin:0px;padding:0px;border:0px;overflow: auto;">
			<div class="card">
				<div class="card-header mms-card-header ncard-body-bg"
					style="min-height: 50px; padding-top: 10px;"><h5><span>FIN PERFORMANCE INDICATOR FOR CDRs</span></h5>
				</div>
									...
									<div class="row" style="background-color: azure;width: calc(79vw - 8px);display:inherit;margin-left: 5px;">
										<div class="" style="align-self:center;padding:10px;height: 40px;width: calc(98vw - 8px)!important;display:inline-flex;">
			    	                       ...
			    	                       <%-- <div class="col-md-3" style="text-align: left;float: left;">	    	                       
											...
											<div class="col-md-3" style="font-size:1.1vw;float:right;width:25%!important" id="nrTableDataDivDtlTitleee">&nbsp;&nbsp;Show&nbsp;&nbsp;								
											...
											<div class="col-md-8">
													Budget Holders&nbsp;:&nbsp;
													<select id="DtlBH" style="width:80%;" title="Select Budget Holder to Get Data" onchange="chgeffect();">
														<option value="ALL_ALL_ALL">
															All Budget Holders
														</option>
														<c:forEach var="item" items="${n_hq}" varStatus="num">
								   								<c:if test="${item[3] =='1'}">
								   									<option value="${item[3]}_${item[0]}_${item[1]}">_${item[2]}</option>
								   								</c:if>
								   								<c:if test="${item[3] =='2'}">
								   									<option value="${item[3]}_${item[0]}_${item[1]}">__${item[2]}</option>
								   								</c:if> 					   								 
								   								<c:if test="${item[3] =='3'}">
								   									<option value="${item[3]}_${item[0]}_${item[1]}">___${item[2]}</option>
								   								</c:if> 					   								 
								   								<c:if test="${item[3] =='4'}">
									   								<option value="${item[3]}_${item[0]}_${item[1]}">___${item[2]}</option>
								   								</c:if>								   												   								
										 	...
										 	<div class="col-md-1">
										 		<input id="refdata" type="button" class="btn btn-success btn-sm nGlow" value="Get Data" style="bbackground-color: purple;" data-toggle="tooltip" title="Get Data" onclick="showdetl();">
										 	</div>
										</div>
									</div>
									<div class="row">
										...
										<table style="width:100%;border-collapse: separate;table-layout: fixed;">
							               	<thead style="text-align: center;line-height:25px;font-size: 1vw;border-spacing: 0 0PX!important;" id="th_nrTableShowDtl">  
							    				<tr>							    					
								      				...
								      				<th>Budget Holder</th>
								      				<th>Allocation</th>
													<th class="">Expenditure</th>
													<th class="">Fwd to CDA</th>
													<th class="">Booked by CDA</th>
													<th class="">%Age</th>													
									  			</tr>
							    		  	</thead>
			...
			<div class="card-footer" align="left" style="padding:0px!important;">
				<div class="row" style="font-size:0.8em">
					<div class="col-md-2">	
						<input type="text" id="bhld_slvl" name="nBase_slvl_src" placeholder="Search in Head..." class="form-control-sm"  style="text-transform: uppercase;"
					...
					<div class="col-md-4">
							<span><b>Fund Holders within List&nbsp;:&nbsp;</b></span>
							<select id="DtlFilterBH" onchangeaa="setdtlFilter();" class="form-control" style="font-size:0.8em" title="Select Budget Holder">
								<option value="ALL_ALL_ALL">
									All Fund Holders
								</option>
								<c:forEach var="item" items="${n_hq}" varStatus="num">
				 	...
				 	<div class="col-md-6">
				 		<div class="col-md-12">
					 		 <span><b></b></span>
		               		 <input type="radio" id="fp_rptorder_1" name="fp_rptorder" value="1" checked>&nbsp;Fund Holder Wise Total
...
function perHQmarker(a) {
	...
	if (a=='1') {
		$("[class *=':"+bv+"P']").removeClass(" npoorRow");
		$("[class *=':"+bv+"P']").removeClass(" ngoodRow");
		$("[class *=':"+bv+"P']").removeClass(" nExlntRow");
		$("[class *=':"+bv1+"P']").removeClass(" npoorRow");
		$("[class *=':"+bv1+"P']").removeClass(" ngoodRow");
		$("[class *=':"+bv1+"P']").removeClass(" nExlntRow");
		$("#lg1").text("Excellent");
		$("#lg2").text("Good");
		$("#lg3").text("Poor");
		if ((perval-1)>0) {
