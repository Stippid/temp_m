...
function getFormation() {
	...
	if (hq_type1.indexOf("Brdsafas") < 0) {
		...
		if (hq_type =='5' && roleSusNo !='A000001') {
...
function getSusIncr() {
	...
	var hq_type1 = $("#hq_type :selected").text();
	a2=$("#fmn_sus_no1").val();
	//console.log("a2-",sus_no,a2,hq_type,hq_type1);
	if (hq_type1.indexOf("Br") > 0 || hq_type=='5') {
...
<script>
      $(document).ready(function() {      
    	  ...
    	  $("#form_code_control").change(function(e){
    		  console.log(e);
    		  var fmn_sus_no1 = $(this).find(":selected").attr("name")
    		  $('#fmn_sus_no1').val(fmn_sus_no1);
    	  })
