<%@taglib uri="http://www.springframework.org/tags/form" prefix="form"%>
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
                            ...
                            <div class="row form-group mb">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="part1" data-bs-toggle="tab" data-bs-target="#part1_div" type="button" role="tab" aria-controls="home" aria-selected="true">Part I</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="part2"   type="button" role="tab" onclick="radioch(2)" aria-controls="profile" aria-selected="false">Part II</button>
                                    </li>
        ...
        <!-- 			<div class="ins_main"> -->
        <!-- 				<div class="ins_item clr1" id="establishment_item" onclick="openModal('#OpPreparedness')">Op Preparedness</div> -->
        <!-- 			</div> -->
        <!-- 		</div> -->

        <div class="modal fade" id="Establishment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <form:form id="EstablishmentForm" name="EstablishmentForm" action="EstablishmentFormAction" method="post" commandName="EstablishmentFormCmd">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <button type="button" class="btn btn-sm " id="next" onclick="openModal('#EQUIPMENT')">
                        ...
                        <div class="modal-body">
                            <div class="col-md-12" id="getSearch_Letter" style="display: block;">
                                <div class="watermarked" data-watermark="" id="divwatermark">
                                    ...
                                    <table id="getAuthHeldTable" class="table no-margin table-striped  table-hover  table-bordered ">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody style="font-size: 12px;" id="establishment_tbody">
                                            ...
                                            <tr>
                                                <td id="regular_title" colspan="5"><strong>(a) Regular</strong></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="regular_officers_medical" id="regular_officers_medical" class="form-control form-control-sm" value="">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="regular_jcos_medical" id="regular_jcos_medical" class="form-control form-control-sm" value="">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td id="warrant_label" class="sub-row">(iii) Armament Art/
                                                    <br>Warrant Officers
                                                </td>
                                                ...
                                                <td>
                                                    <input type="text" name="regular_warrant_medical" id="regular_warrant_medical" class="form-control form-control-sm" value="">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="regular_or_medical" id="regular_or_medical" class="form-control form-control-sm" value="">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="regular_civilians_medical" id="regular_civilians_medical" class="form-control form-control-sm" value="">
                                                </td>

                                            </tr>
                                            <tr>
                                                <td id="attached_title" colspan="5"><strong>(b) Attached</strong></td>
                                            </tr>
                                            <tr>
                                                <td id="attached_officers_label" class="sub-row">(i) Officers</td>
                                                <td id="attached_officers_auth">
                                                    <input type="text" name="authoffi" id="authoffi" class="form-control form-control-sm numeric-input" value="">
                                                </td>
                                                <td id="attached_officers_posted">
                                                    <input type="text" name="postoffi" id="postoffi" class="form-control form-control-sm numeric-input" value="">
                                                </td>
                                                <td id="attached_officers_surplus">
                                                    <input type="text" name="surdefioffi" id="surdefioffi" class="form-control form-control-sm numeric-input" value="" readonly="readonly">
                                                </td>
                                                <td id="attached_officers_medical">
                                                    <input type="text" name="medcat_offi" id="medcat_offi" class="form-control form-control-sm" value="">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td id="attached_jcos_label" class="sub-row">(ii) JCOs</td>
                                                <td id="attached_jcos_auth">
                                                    <input type="text" name="authjco" id="authjco" class="form-control form-control-sm numeric-input" value="">
                                                </td>
                                                <td id="attached_jcos_posted">
                                                    <input type="text" name="postjco" id="postjco" class="form-control form-control-sm numeric-input" value="">
                                                </td>
                                                <td id="attached_jcos_surplus">
                                                    <input type="text" name="surdefijco" id="surdefijco" class="form-control form-control-sm numeric-input" value="" readonly="readonly">
                                                </td>
                                                <td id="attached_jcos_medical">
                                                    <input type="text" name="medcat_jco" id="medcat_jco" class="form-control form-control-sm" value="">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td id="attached_warrant_label" class="sub-row">(iii) Armament Art/
                                                    <br>Warrant Officers
                                                </td>
                                                <td id="attached_warrant_auth">
                                                    <input type="text" name="authwarrant" id="authwarrant" class="form-control form-control-sm numeric-input" value="">
                                                </td>
                                                <td id="attached_warrant_posted">
                                                    <input type="text" name="postwarrant" id="postwarrant" class="form-control form-control-sm numeric-input" value="">
                                                </td>
                                                <td id="attached_warrant_surplus">
                                                    <input type="text" name="surdewarrant" id="surdewarrant" class="form-control form-control-sm numeric-input" value="" readonly="readonly">
                                                </td>
                                                <td id="attached_warrant_medical">
                                                    <input type="text" name="medcat_warrant" id="medcat_warrant" class="form-control form-control-sm" value="">
                                                </td>

                                            </tr>
                                            <tr>
                                                <td id="attached_or_label" class="sub-row">(iv) OR</td>
                                                <td id="attached_or_auth">
                                                    <input type="text" name="author" id="author" class="form-control form-control-sm numeric-input" value="">
                                                </td>
                                                <td id="attached_or_posted">
                                                    <input type="text" name="postor" id="postor" class="form-control form-control-sm numeric-input" value="">
                                                </td>
                                                <td id="attached_or_surplus">
                                                    <input type="text" name="surdefior" id="surdefior" class="form-control form-control-sm numeric-input" value="" readonly="readonly">
                                                </td>
                                                <td id="attached_or_medical">
                                                    <input type="text" name="medcat_or" id="medcat_or" class="form-control form-control-sm" value="">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td id="attached_civilians_label" class="sub-row">(v) Civilians</td>
                                                <td id="attached_civilians_auth">
                                                    <input type="text" name="authciv" id="authciv" class="form-control form-control-sm numeric-input" value="">
                                                </td>
                                                <td id="attached_civilians_posted">
                                                    <input type="text" name="postciv" id="postciv" class="form-control form-control-sm numeric-input" value="">
                                                </td>
                                                <td id="attached_civilians_surplus">
                                                    <input type="text" name="surdeciv" id="surdeciv" class="form-control form-control-sm numeric-input" value="" readonly="readonly">
                                                </td>
                                                <td id="attached_civilians_medical">
                                                    <input type="text" name="medcat_civ" id="medcat_civ" class="form-control form-control-sm" value="">
                                                </td>
                        ...
                        <div class="modal-footer">
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="user_remarks1" name="user_remarks1" rows="3"></textarea>
                                </div>
                            ...
                            <div class="col-6 text-right">
                                ...
                                <c:if test="${report.establishment_item != 1}">
                                    <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="establishment_item">Submit for Approval</button>
                                </c:if>
                                <c:if test="${report.establishment_item == 1}">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button class="btn btn-sm" onclick="openModal('#Establishment')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>

                        <h5 class="modal-title" id="exampleModalLabel">EQUIPMENT</h5>
                        <!-- Next Button -->
                        <button class="btn btn-sm " id="next" onclick="openModal('#Animals')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                    ...
                    <form:form id="EqupmentForm" name="EqupmentForm" action="EqupmentFormAction" method="post" commandName="EqupmentFormCmd">
                        <div class="modal-body">
                            <div class="col-md-12" id="getSearch_Letter" style="display: block;">
                                    ...
                                    <table id="getAuthHeldTable" class="table no-margin table-striped  table-hover  table-bordered ">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th colspan="5" style="text-align: center;" id="appt">Mission Reliability in % / Classification</th>
                                                <th colspan="3" style="text-align: center;" id="appt">Serviceability</th>
                                                <th rowspan="2" style="text-align: center;" id="appt">Detailed Remark
                                                </th>
                                            </tr>
                                            <tr>
                                                ...
                                                <th style="text-align: center;">Armament/Quarter of Life / Category
                                                </th>
                            ...
                            <div class="col-md-12" id="getSearch_Letter" style="display: block;">
                                <div class="watermarked" data-watermark="" id="divwatermark">
                                    ...
                                    <table id="getAuthHeldTable" class="table no-margin table-striped  table-hover  table-bordered ">
                                        ...
                                        <thead>
                                            <tr>
                                                <th rowspan="2" style="text-align: center;" class="width_7" id="appt">Sr No Number
                                                </th>
                                                <th rowspan="2" style="text-align: center;" id="name">Type of Duty ie Administration, Training and Formation Detailment etc
                                                </th>
                                                <th colspan="2" style="text-align: center;" id="appt">Total Mileage During the Year</th>
                                                <th rowspan="2" style="text-align: center;" id="appt">Detailed Remarks
                                                </th>
                                                <th rowspan="3" style="text-align: center;" id="appt">Action</th>
                                            </tr>
                                            <tr>
                                                <th style="text-align: center;">Authorised</th>
                                        ...
                                        <tbody style="font-size: 12px;" id="equipment_tbody">
                                            <tr id="firstRow">
                                                <c:if test="${report.equipment_item != 1}">
                                                    <td></td>
                                                    <td>
                                                        <input type="text" name="type_of_duty">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="equp_authorize" class="numeric-input">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="equp_cove" class="numeric-input">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="equp_remark">
                                                    </td>
                                                    <td>
                                                        <button type="button" class="fa fa-plus btn btn-success btn-sm add-to-recommended" data-context="equipmentTble"></button>
                                                    </td>
                                                </c:if>
                                            </tr>
                        ...
                        <div class="modal-footer">
                            ...
                            <div class="col-6 text-right">
                                <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
                                <c:if test="${report.equipment_item != 1}">
                                    <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="equipment_item">Submit for Approval</button>
                                </c:if>
                                <c:if test="${report.equipment_item == 1}">
                                    <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                                </c:if>
        ...
        <div class="modal fade" id="Animals" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">

                        <button class="btn btn-sm" onclick="openModal('#EQUIPMENT')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>
                        <h5 class="modal-title" id="exampleModalLabel">Animals</h5>
                        <button class="btn btn-sm " id="next" onclick="openModal('#Deficiencies_of_Equipment2')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                        </button>
                    ...
                    <form:form id="animalForm" name="animalForm" action="animalFormAction" method="post" commandName="animalFormCmd">
                        <div class="modal-body">
                            <div class="col-md-12" id="getSearch_Letter" style="display: block;">
                                <div class="watermarked" data-watermark="" id="divwatermark">
                                    <span id="ip"></span>
                        ...
                        <div class="modal-footer">
                            ...
                            <div class="col-6 text-right">
                                ...
                                <c:if test="${report.animals_item != 1}">
                                    <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="animals_item">Submit for Approval</button>
                                </c:if>
                                <c:if test="${report.animals_item == 1}">
                                    <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                                </c:if>
        ...
        <div class="modal fade" id="Deficiencies_of_Equipment2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">

                        <button class="btn btn-sm" onclick="openModal('#Animals')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>
					...
					Efficiency.</h5>
                        <button class="btn btn-sm " id="next" onclick="openModal('#Deficiencies_of_Equipment')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                        </button>
                        ...
                        <div class="col-md-12" id="getSearch_Letter" style="display: block;">
                            <div class="watermarked" data-watermark="" id="divwatermark">
                                ...
                                <table id="getAuthHeldTable" class="table no-margin table-striped  table-hover  table-bordered ">
                                    <thead>
                                        <tr>
                                            <th rowspan="2" style="text-align: center;" id="personnel" class="width_7">Sr No Number
                                            </th>
                                            <th rowspan="2" style="text-align: center;" id="rankT">
                                                Nomenclature</th>
                                            ...
                                            <th colspan="3" style="text-align: center;" id="base_auth">
                                                Quantity</th>
                                            <th colspan="2" style="text-align: center;">(Not to be included in Holding)</th>
                                            ...
                                            <th rowspan="2" style="text-align: center;" id="base_auth">
                                                Remarks</th>
                                            <th rowspan="3" style="text-align: center;" id="base_auth">
                                                Action</th>
                                    ...
                                    <tbody style="font-size: 12px;" id="Defi_main_tbody">
                                        <tr id="firstRow">
                                            <c:if test="${report.deficiencies_of_equipment2_item != 1}">
                                                <td></td>
                                                <td>
                                                    <input type="text" name="nomentclature">
                                                </td>
                                                <td>
                                                    <input type="text" name="au_id">
                                                </td>
                                                <td>
                                                    <input type="text" name="qunt_auth" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="qunt_held" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="qunt_defi" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="due_in" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="due_out" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="remark">
                                                </td>
                                                <td>
                                                    <button type="button" class="fa fa-plus btn btn-success btn-sm add-to-recommended" data-context="defOfEqupMaintenance"></button>
                                                </td>
                                            </c:if>
                                        </tr>
                    ...
                    <div class="modal-footer">
                        ...
                        <div class="col-6 text-right">
                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
                            <c:if test="${report.deficiencies_of_equipment2_item != 1}">
                                <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="deficiencies_of_equipment2_item">Submit for Approval</button>
                            </c:if>
                            <c:if test="${report.deficiencies_of_equipment2_item == 1}">
                                <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                            </c:if>
        ...
        <div class="modal fade" id="Deficiencies_of_Equipment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">

                        <button class="btn btn-sm" onclick="openModal('#Deficiencies_of_Equipment2')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>
                        <h5 class="modal-title" id="exampleModalLabel">Details of
					Equipment Rendered Off Road for a prolonged period (more than Six
					Months).</h5>
                        <button class="btn btn-sm " id="next" onclick="openModal('#State_of_Sector_Stores')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                        </button>
                        ...
                        <div class="col-md-12" id="getSearch_Letter" style="display: block;">
                            <div class="watermarked" data-watermark="" id="divwatermark">
                                ...
                                <table id="getAuthHeldTable" class="table no-margin table-striped table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            <th rowspan="2" style="text-align: center; vertical-align: middle; " class="width_7" id="personnel">Sr No</th>
                                            <th rowspan="2" style="text-align: center; vertical-align: middle;" id="rankT">Nomenclature</th>
                                            <th rowspan="2" style="text-align: center; vertical-align: middle;" id="base_auth">A/U</th>
                                            <th colspan="3" style="text-align: center;" id="base_auth">Qty</th>
                                            <th rowspan="2" style="text-align: center; vertical-align: middle;" id="off_road">Off Road with Reason</th>
                                            <th rowspan="2" style="text-align: center; vertical-align: middle;" id="action_taken">Action Taken by the Unit</th>
                    ...
                    <div class="modal-footer">
                        ...
                        <div class="col-6 text-right">
                            ...
                            <c:if test="${report.deficiencies_of_equipment_item != 1}">
                                <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="deficiencies_of_equipment_item">Submit for Approval</button>
                            </c:if>
                            <c:if test="${report.deficiencies_of_equipment_item == 1}">
                                <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                            </c:if>
        ...
        <div class="modal fade" id="State_of_Sector_Stores" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">

                        <button class="btn btn-sm" onclick="openModal('#Deficiencies_of_Equipment')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>
					...
					ACSFP Fund and Other Funds.</h5>
                        <button class="btn btn-sm " id="next" onclick="openModal('#WT_RESULTS')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                        </button>
                        <!-- 				<button type="button" class="close btn-close" data-dismiss="modal" -->
                        <!-- 					aria-label="Close"> -->
                                ...
                                <table id="getAuthHeldTable" class="table no-margin table-striped table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th rowspan="2" style="text-align: center; vertical-align: middle;" id="serviceable">Serviceable / Unserviceable</th>
                                            <th rowspan="2" style="text-align: center; vertical-align: middle;" id="off_road">Reasons for Equipment being Off Rd</th>
                                            <th rowspan="2" style="text-align: center; vertical-align: middle;" id="remarks">Remarks</th>
                                        </tr>
                                        <tr>
                                            <th style="text-align: center;">Authorised</th>
                    ...
                    <div class="modal-footer">
                        ...
                        <div class="col-6 text-right">
                            ...
                            <c:if test="${report.state_of_sector_stores_item != 1}">
                                <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="state_of_sector_stores_item">Submit for Approval</button>
                            </c:if>
                            <c:if test="${report.state_of_sector_stores_item == 1}">
                                <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                            </c:if>
        ...
        <div class="modal fade" id="WT_RESULTS" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">

                        <button class="btn btn-sm" onclick="openModal('#State_of_Sector_Stores')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>
                        <h5 class="modal-title" id="exampleModalLabel">WT RESULTS</h5>
                        <button class="btn btn-sm " id="next" onclick="openModal('#Education_Standards')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                        </button>
                        <!-- 				<button type="button" class="close btn-close" data-dismiss="modal" -->
                        <!-- 					aria-label="Close"> -->
                        ...
                        <div class="col-md-12" id="getSearch_Letter" style="display: block;">
                            <div class="watermarked" data-watermark="" id="divwatermark">
                                ...
                                <table id="getAuthHeldTable" class="table no-margin table-striped table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            <th rowspan="1" style="text-align: center; height: 50px; vertical-align: middle;" class="width_7" id="serial_number">Sr No</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="weapons">Category of Firers</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="category_firers">Weapons</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="total_number">Total Number</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="marksmen">Marksmen</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="first_class">First Class</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="standard_shot">Standard Shot</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="failed">Failed</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="exempted">Numbers Exempted</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="yet_to_fire">Numbers yet to Fire</th>
                                        </tr>
                                        <tr>
                                            <th style="text-align: center;">(a)</th>
                                            <th style="text-align: center;">(b)</th>
                                    ...
                                    <tbody style="font-size: 12px; padding: 10px; text-align:center;" id="wt_result_other_tbody">
                                        <tr id="row1">
                                            <td>4</td>
                                            <td>
                                                <input type="text" id="category_1" name="category_1" value="Permanent Staff" readonly>
                                            </td>
                                            <td>
                                                <input type="text" id="weapon_1" name="weapon_1" value="">
                                            </td>
                                            <td>
                                                <input type="text" id="total_1" name="total_1" value="">
                                            </td>
                                            <td>
                                                <input type="text" id="marksmen_1" name="marksmen_1" value="">
                                            </td>
                                            <td>
                                                <input type="text" id="first_class_1" name="first_class_1" value="">
                                            </td>
                                            <td>
                                                <input type="text" id="standard_1" name="standard_1" value="">
                                            </td>
                                            <td>
                                                <input type="text" id="failed_1" name="failed_1" value="">
                                            </td>
                                            <td>
                                                <input type="text" id="exempted_1" name="exempted_1" value="">
                                            </td>
                                            <td>
                                                <input type="text" id="yet_to_fire_1" name="yet_to_fire_1" value="">
                                            </td>
                                        ...
                                        <tr id="row2">
                                            <td>5</td>
                                            <td>
                                                <input type="text" id="category_2" name="category_2" value="Recruits" readonly>
                                            </td>
                                            <td>
                                                <input type="text" id="weapon_2" name="weapon_2" value="">
                                            </td>
                                            <td>
                                                <input type="text" id="total_2" name="total_2" value="">
                                            </td>
                                            <td>
                                                <input type="text" id="marksmen_2" name="marksmen_2" value="">
                                            </td>
                                            <td>
                                                <input type="text" id="first_class_2" name="first_class_2" value="">
                                            </td>
                                            <td>
                                                <input type="text" id="standard_2" name="standard_2" value="">
                                            </td>
                                            <td>
                                                <input type="text" id="failed_2" name="failed_2" value="">
                                            </td>
                                            <td>
                                                <input type="text" id="exempted_2" name="exempted_2" value="">
                                            </td>
                                            <td>
                                                <input type="text" id="yet_to_fire_2" name="yet_to_fire_2" value="">
                                            </td>
                                        ...
                                        <tr id="row3">
                                            <td>6</td>
                                            <td>
                                                <input type="text" id="category_3" name="category_3" value="Trained Soldiers" readonly>
                                            </td>
                                            <td>
                                                <input type="text" id="weapon_3" name="weapon_3" value="">
                                            </td>
                                            <td>
                                                <input type="text" id="total_3" name="total_3" value="">
                                            </td>
                                            <td>
                                                <input type="text" id="marksmen_3" name="marksmen_3" value="">
                                            </td>
                                            <td>
                                                <input type="text" id="first_class_3" name="first_class_3" value="">
                                            </td>
                                            <td>
                                                <input type="text" id="standard_3" name="standard_3" value="">
                                            </td>
                                            <td>
                                                <input type="text" id="failed_3" name="failed_3" value="">
                                            </td>
                                            <td>
                                                <input type="text" id="exempted_3" name="exempted_3" value="">
                                            </td>
                                            <td>
                                                <input type="text" id="yet_to_fire_3" name="yet_to_fire_3" value="">
                                            </td>
                    ...
                    <div class="modal-footer">
                        ...
                        <div class="col-6 text-right">
                            ...
                            <c:if test="${report.wt_results_item != 1}">
                                <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="wt_results_item">Submit for Approval</button>
                            </c:if>
                            <c:if test="${report.wt_results_item == 1}">
                                <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                            </c:if>
        ...
        <div class="modal fade" id="Education_Standards" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <form:form id="EducationStandardsForm" name="EducationStandardsForm" action="EducationStandardsAction" method="post" commandName="EducationStandardsCmd">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">

                            <button class="btn btn-sm" id="previous" type="button" onclick="openModal('#WT_RESULTS')">
                                <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                            </button>
                            <h5 class="modal-title" id="exampleModalLabel">Education
					Standards</h5>
                            <button type="button" class="btn btn-sm " id="next" onclick="openModal('#Category')">
                                Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                            </button>
                            <!-- 				<button type="button" class="close btn-close" data-dismiss="modal" -->
                            <!-- 					aria-label="Close"> -->
                            ...
                            <div class="col-md-12" id="getSearch_Letter" style="display: block;">
                                <div class="watermarked" data-watermark="" id="divwatermark">
                                    ...
                                    <table id="getAuthHeldTable" class="table no-margin table-striped table-hover table-bordered">
                                        <thead>
                                            <tr>
                                                <th rowspan="2" style="text-align: center; vertical-align: middle;" class="width_7" id="serial_number">Sr No</th>
                                                <th rowspan="2" style="text-align: center; vertical-align: middle;" id="category">Category</th>
                                                <th rowspan="2" style="text-align: center; vertical-align: middle;" id="affected">Affected</th>
                                                <th rowspan="2" style="text-align: center; vertical-align: middle;" id="qualified">Qualified</th>
                                                <th rowspan="2" style="text-align: center; vertical-align: middle;" id="not_qualified">Not Qualified</th>
                                                <th colspan="3" style="text-align: center;" id="distribution">Distribution of Not Qualified due to</th>
                                            </tr>
                                            <tr>
                                                <th style="text-align: center;" id="map_reading">Map Reading
                                                </th>
                                                <th style="text-align: center;" id="education">Education</th>
                                                <th style="text-align: center;" id="promotion_cadre">Promotion Cadre / JLPT (For JCOs only)</th>
                                            </tr>
                                            <tr>
                                                <th style="text-align: center;">(a)</th>
                                                <th style="text-align: center;">(b)</th>
                                        ...
                                        <tbody style="font-size: 12px;" id="Education_Standards_tbody">
                                            <tr>
                                                ...
                                                <td>JCO (JLPT)</td>
                                                <td>
                                                    <input type="text" name="jco_affected" class="form-control form-control-sm numeric-input" data-column="affected" value="">
                                                </td>
                                                <td>
                                                    <input type="text" name="jco_qualified" class="form-control form-control-sm numeric-input" data-column="qualified">
                                                </td>
                                                <td>
                                                    <input type="text" name="jco_not_qualified" class="form-control form-control-sm numeric-input" data-column="not_qualified">
                                                </td>
                                                <td>
                                                    <input type="text" name="jco_map" class="form-control form-control-sm numeric-input" data-column="map">
                                                </td>
                                                <td>
                                                    <input type="text" name="jco_education" class="form-control form-control-sm numeric-input" data-column="education">
                                                </td>
                                                <td>
                                                    <input type="text" name="jco_promotion" class="form-control form-control-sm numeric-input" data-column="promotion">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                <td>NCO</td>
                                                <td>
                                                    <input type="text" name="nco_affected" class="form-control form-control-sm numeric-input" data-column="affected">
                                                </td>
                                                <td>
                                                    <input type="text" name="nco_qualified" class="form-control form-control-sm numeric-input" data-column="qualified">
                                                </td>
                                                <td>
                                                    <input type="text" name="nco_not_qualified" class="form-control form-control-sm numeric-input" data-column="not_qualified">
                                                </td>
                                                <td>
                                                    <input type="text" name="nco_map" class="form-control form-control-sm numeric-input" data-column="map">
                                                </td>
                                                <td>
                                                    <input type="text" name="nco_education" class="form-control form-control-sm numeric-input" data-column="education">
                                                </td>
                                                <td>
                                                    <input type="text" name="nco_promotion" class="form-control form-control-sm numeric-input" data-column="promotion">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                <td>OR</td>
                                                <td>
                                                    <input type="text" name="or_affected" class="form-control form-control-sm numeric-input" data-column="affected">
                                                </td>
                                                <td>
                                                    <input type="text" name="or_qualified" class="form-control form-control-sm numeric-input" data-column="qualified">
                                                </td>
                                                <td>
                                                    <input type="text" name="or_not_qualified" class="form-control form-control-sm numeric-input" data-column="not_qualified">
                                                </td>
                                                <td>
                                                    <input type="text" name="or_map" class="form-control form-control-sm numeric-input" data-column="map">
                                                </td>
                                                <td>
                                                    <input type="text" name="or_education" class="form-control form-control-sm numeric-input" data-column="education">
                                                </td>
                                                <td>
                                                    <input type="text" name="or_promotion" class="form-control form-control-sm numeric-input" data-column="promotion">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                    ...
                                    <input type="hidden" name="total_affected" id="total_affected" value="0.00" />
                                    <input type="hidden" name="total_qualified" id="total_qualified" value="0.00" />
                                    <input type="hidden" name="total_not_qualified" id="total_not_qualified" value="0.00" />
                                    <input type="hidden" name="total_map" id="total_map" value="0.00" />
                                    <input type="hidden" name="total_education" id="total_education" value="0.00" />
                                    <input type="hidden" name="total_promotion" id="total_promotion" value="0.00" />
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <label for="remarks"><strong>Remarks: </strong></label>
                                    <textarea class="form-control" id="user_remarks15" name="user_remarks15" rows="3"></textarea>
                                </div>
                            ...
                            <div class="col-6 text-right">
                                ...
                                <c:if test="${report.education_standards_item != 1}">
                                    <input type="submit" class="btn btn-primary btn-sm" value="Submit for Approval" data-context="education_standards_item">
                                </c:if>
                                <c:if test="${report.education_standards_item == 1}">
                                    <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                                </c:if>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button class="btn btn-sm" onclick="openModal('#Education_Standards')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>
					...
					Establishments.</h5>
                        ...
                        <button class="btn btn-sm" id="next" onclick="openModal('#Up_Gradation')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                        </button>
                        <button type="button" class="close btn-close" onclick="closeModal()">
                            <span aria-hidden="true">×</span>
                        ...
                        <div class="col-md-12" id="getSearch_Letter" style="display: block;">
                            <div class="watermarked" data-watermark="" id="divwatermark">
                                ...
                                <table id="getAuthHeldTable" class="table no-margin table-striped table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            <th rowspan="3" style="text-align: center; vertical-align: middle;" id="course_name">Name of Course</th>
                                            <th colspan="8" style="text-align: center;" id="trained_during">Number of Personnel trained during</th>
                                            <th rowspan="2" colspan="4" style="text-align: center; vertical-align: middle;" id="total_available">Total Available</th>

                                            <th rowspan="4" style="text-align: center; vertical-align: middle;" id="course_name">Action</th>
                                        </tr>
                                        <tr>
                                            <th colspan="4" style="text-align: center;">Period of Report
                                            </th>
                                            <th colspan="4" style="text-align: center;">Preceding Two Years
                                            </th>
                                    ...
                                    <tbody style="font-size: 12px;" id="Category_tbody">
                                        <tr id="firstRow">
                                            <c:if test="${report.category_item != 1}">
                                                ...
                                                <td>
                                                    <input type="text" name="officersTrained" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="jcosTrained" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="ncosTrained" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="orTrained" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="officersAvailable" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="jcosAvailable" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="ncosAvailable" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="orAvailable" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="totalOfficers" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="totalJcos" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="totalNcos" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="totalOr" class="numeric-input">
                                                </td>
                                                <td>
                                                    <button type="button" class="fa fa-plus btn btn-success btn-sm add-to-recommended" data-context="personalTrainedCourses"></button>
                                                </td>
                                            </c:if>
                                        </tr>
                                    </tbody>
                    ...
                    <div class="modal-footer">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="remarks"><strong>Remarks: </strong></label>
                                <textarea class="form-control" id="user_remarks16" name="user_remarks16" rows="3"></textarea>
                            </div>
                        ...
                        <div class="col-6 text-right">
                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
                            <c:if test="${report.category_item != 1}">
                                <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="category_item">Submit for Approval</button>
                            </c:if>
                            <c:if test="${report.category_item == 1}">
                                <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                            </c:if>
        ...
        <div class="modal fade" id="Up_Gradation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <%-- 	<form:form id="UpGradationReposrForm" name="UpGradationReposrForm" action="UpGradationReposrAction" method="post" commandName="UpGradationReposrCmd"> --%>
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button class="btn btn-sm" onclick="openModal('#Category')" id="previous">
                                <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                            </button>
                            <h5 class="modal-title" id="exampleModalLabel">Up-Gradation
					Carried Out During the Period of the Report</h5>
                            <button class="btn btn-sm" id="next" onclick="openModal('#regi_language_exam')">
                                Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                            </button>
                            <button type="button" class="close btn-close" onclick="closeModal()">
                                <span aria-hidden="true">&times;</span>
                            ...
                            <div class="col-md-12" id="getSearch_Letter" style="display: block;">
                                <div class="watermarked" data-watermark="" id="divwatermark">
                                    ...
                                    <table id="getAuthHeldTable" class="table no-margin table-striped table-hover table-bordered">
                                        <thead>
                                            <tr>
                                                <th rowspan="4" style="text-align: center; vertical-align: middle;" id="trade">Trade</th>
                                                <th colspan="4" style="text-align: center;" id="total_affected">Total Affected for Up-Gradation
                                                </th>
                                                <th colspan="4" style="text-align: center;" id="upgraded">Upgraded During the Period of Report
                                                </th>
                                                <th colspan="4" style="text-align: center;" id="total_available">Total Available at the End of the Period of Report
                                                </th>
                                        ...
                                        <tbody style="font-size: 12px;" id="Up_Gradation_tbody_a">
                                            <tr id="firstRow">
                                                <c:if test="${report.up_gradation_item != 1}">
                                                    <td>
                                                        <input type="text" name="trade" class="form-control form-control-sm" data-column="affected_up_gradation">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="affected_up_gradation_class_iv" class="form-control form-control-sm numeric-input" data-column="affected_up_gradation">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="affected_up_gradation_class_iii" class="form-control form-control-sm numeric-input" data-column="affected_up_gradation">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="affected_up_gradation_class_ii" class="form-control form-control-sm numeric-input" data-column="affected_up_gradation">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="affected_up_gradation_class_i" class="form-control form-control-sm numeric-input" data-column="affected_up_gradation">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="during_up_gradation_class_iv" class="form-control form-control-sm numeric-input" data-column="upgraded_during_report">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="during_up_gradation_class_iii" class="form-control form-control-sm numeric-input" data-column="upgraded_during_report">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="during_up_gradation_class_ii" class="form-control form-control-sm numeric-input" data-column="upgraded_during_report">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="during_up_gradation_class_i" class="form-control form-control-sm numeric-input" data-column="upgraded_during_report">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="total_available_class_iv" class="form-control form-control-sm numeric-input" data-column="total_available_period_report">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="total_available_class_iii" class="form-control form-control-sm numeric-input" data-column="total_available_period_report">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="total_available_class_ii" class="form-control form-control-sm numeric-input" data-column="total_available_period_report">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="total_available_class_i" class="form-control form-control-sm numeric-input" data-column="total_available_period_report">
                                                    </td>
                                                    <td>
                                                        <button type="button" class="fa fa-plus btn btn-success btn-sm add-to-recommended" data-context="upGradation"></button>
                                                    </td>
                                                </c:if>
                                            </tr>
                                        </tbody>
                        ...
                        <div class="modal-footer">
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <label for="remarks"><strong>Remarks: </strong></label>
                                    <textarea class="form-control" id="user_remarks17" name="user_remarks17" rows="3"></textarea>
                                </div>
                            ...
                            <div class="col-6 text-right">
                                <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
                                <c:if test="${report.up_gradation_item != 1}">
                                    <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="up_gradation_item">Submit for Approval</button>
                                </c:if>
                                <c:if test="${report.up_gradation_item == 1}">
                                    <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                                </c:if>
        ...
        <div class="modal fade" id="regi_language_exam" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">

            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button class="btn btn-sm" onclick="openModal('#Up_Gradation')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>

                        <h5 class="modal-title" id="exampleModalLabel">Regimental Language Examinations (for Units where such an Examination is applicable).</h5>

                        <button class="btn btn-sm" id="next" onclick="openModal('#BPET_Result')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                        </button>
                    </div>
                    <form:form id="regLanguageExamForm" name="regLanguageExamForm" action="regLanguageExamFormAction" method="post" commandName="regLanguageExamFormCmd">
                            ...
                            <div class="col-md-12" id="getSearch_Letter" style="display: block;">
                                <div class="watermarked" data-watermark="" id="divwatermark">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-1">
                                            <input type="number" id="officersQualified" name="officersQualified" class="form-control form-control-sm" placeholder="Enter count">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-1">
                                            <input type="number" id="numbersExempted" name="numbersExempted" class="form-control form-control-sm" placeholder="Enter count">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-1">
                                            <input type="number" id="qualifiedDuringPeriod" name="qualifiedDuringPeriod" class="form-control form-control-sm" placeholder="Enter count">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-1">
                                            <input type="number" id="notYetQualified" name="notYetQualified" class="form-control form-control-sm" placeholder="Enter count">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <div class="col-6 text-right">
                                ...
                                <c:if test="${report.regi_language_exam_item != 1}">
                                    <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="regi_language_exam_item">Submit for Approval</button>
                                </c:if>
                                <c:if test="${report.regi_language_exam_item == 1}">
                                    <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                                </c:if>
        ...
        <div class="modal fade" id="BPET_Result" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="btn btn-sm" onclick="openModal('#regi_language_exam')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>
                        <h5 class="modal-title" id="exampleModalLabel">BPET Result</h5>
                        <button type="button" class="btn btn-sm" id="next" onclick="openModal('#PPT_Result')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                        </button>
                        <button type="button" class="close btn-close" onclick="closeModal()">
                            <span aria-hidden="true">&times;</span>
                    ...
                    <div class="modal-body">
                        <div class="col-md-12" id="getSearch_Letter" style="display: block;">
                            <div class="watermarked" data-watermark="" id="divwatermark">
                                <span id="ip"></span>
                                <table id="getBPETTable" class="table no-margin table-striped table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            <th rowspan="2" style="text-align: center; vertical-align: middle;" class="width_7" id="serial_number">Sr No</th>
                                            <th rowspan="2" style="text-align: center; vertical-align: middle;" id="personnel">Personnel</th>
                                            <th rowspan="2" style="text-align: center; vertical-align: middle;" id="total_number">Total Number</th>
                                            <th colspan="5" style="text-align: center;" id="grading">Grading</th>
                                            <th rowspan="2" style="text-align: center; vertical-align: middle;" id="yet_to_be_tested">Number Yet to be Tested</th>
                                            <th rowspan="2" style="text-align: center; vertical-align: middle;" id="remarks">Remarks / Reasons for Not Yet Tested</th>
                                        </tr>
                                        <tr>
                    ...
                    <div class="modal-footer">
                        ...
                        <div class="col-6 text-right">
                            ...
                            <c:if test="${report.bpet_result_item != 1}">
                                <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="bpet_result_item">Submit for Approval</button>
                            </c:if>
                            <c:if test="${report.bpet_result_item == 1}">
                                <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                            </c:if>
        ...
        <div class="modal fade" id="PPT_Result" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <form:form id="PptResultForm" name="PptResultForm" action="PptResultAction" method="post" commandName="PptResultCmd">


                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="btn btn-sm" onclick="openModal('#BPET_Result')" id="previous">
                                <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                            </button>
                            <h5 class="modal-title" id="exampleModalLabel">PPT Result</h5>
                            <button type="button" class="btn btn-sm" id="next" onclick="openModal('#Promotion_Exam_Officers')">
                                Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                            </button>
                            <button type="button" class="close btn-close" onclick="closeModal()">
                                <span aria-hidden="true">&times;</span>
                        ...
                        <div class="modal-body">
                            <div class="col-md-12" id="getSearch_Letter" style="display: block;">
                                <div class="watermarked" data-watermark="" id="divwatermark">
                                    <span id="ip"></span>
                                    <table id="getWTResultsTable" class="table no-margin table-striped table-hover table-bordered">
                                        <thead>
                                            <tr>
                                                <th rowspan="2" style="text-align: center; vertical-align: middle;" class="width_7" id="serial_number">Sr No</th>
                                                <th rowspan="2" style="text-align: center; vertical-align: middle;" id="personnel">Personnel</th>
                                        ...
                                        <tbody style="font-size: 12px;" id="PPT_Result_tbody_a">
                                            <tr>
                                                <td>1</td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="personnel_0" value="Officers" readonly>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="total_no_0">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="excellent_0">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="good_0">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="satisfactory_0">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="poor_0">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="fail_0">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="number_yet_to_tested_0">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="remarks_0">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>2</td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="personnel_1" value="JCOs" readonly>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="total_no_1">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="excellent_1">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="good_1">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="satisfactory_1">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="poor_1">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="fail_1">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="number_yet_to_tested_1">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="remarks_1">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>3</td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="personnel_2" value="OR" readonly>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="total_no_2">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="excellent_2">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="good_2">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="satisfactory_2">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="poor_2">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="fail_2">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="number_yet_to_tested_2">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="remarks_2">
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="modal-footer">
                            ...
                            <div class="col-6 text-right">
                                ...
                                <c:if test="${report.ppt_result_item != 1}">
                                    <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="ppt_result_item">Submit for Approval</button>
                                </c:if>
                                <c:if test="${report.ppt_result_item == 1}">
                                    <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                                </c:if>
        ...
        <div class="modal fade" id="Promotion_Exam_Officers" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button class="btn btn-sm" onclick="openModal('#PPT_Result')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>
                        <h5 class="modal-title" id="exampleModalLabel">Promotion Exam
					Officers</h5>
                        <button class="btn btn-sm" id="next" onclick="openModal('#Financial_Grants')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                        </button>
                        <button type="button" class="close btn-close" onclick="closeModal()">
                            <span aria-hidden="true">&times;</span>
                        ...
                        <div class="col-md-12" id="getSearch_Letter" style="display: block;">
                            <div class="watermarked" data-watermark="" id="divwatermark">
                                ...
                                <table id="getAuthHeldTable" class="table no-margin table-striped table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            <th rowspan="1" style="text-align: center; height: 50px; vertical-align: middle;" class="width_7" id="serial_number">Sr No
                                            </th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="exam_type">Type of Exam
                                            </th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="number_appeared">Number Appeared
                                            </th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="number_successful">Number Successful
                                            </th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="number_yet_to_appear">Number Yet to Appear
                                            </th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle; width: 31.5%" id="remarks">Remarks (to include action taken in respect of officers declared unsuccessful for those within two years of the maximum prescribed limit)
                                            </th>
                                        </tr>
                                        <tr>
                                            <th style="text-align: center;">(a)</th>
                    ...
                    <div class="modal-footer">
                        ...
                        <div class="col-6 text-right">
                            ...
                            <c:if test="${report.promotion_exam_officers_item != 1}">
                                <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="promotion_exam_officers_item">Submit for Approval</button>
                            </c:if>
                            <c:if test="${report.promotion_exam_officers_item == 1}">
                                <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                            </c:if>
        ...
        <div class="modal fade" id="Financial_Grants" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="btn btn-sm" onclick="openModal('#Promotion_Exam_Officers')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>
                        <h5 class="modal-title" id="exampleModalLabel">Financial Grants</h5>
                        <button type="button" class="btn btn-sm" id="next" onclick="openModal('#Regt_funds')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                        </button>
                        <button type="button" class="close btn-close" onclick="closeModal()">
                            <span aria-hidden="true">&times;</span>
                    ...
                    <div class="modal-body">
                        <div class="col-md-12" id="getSearch_Letter" style="display: block;">
                            <div class="watermarked" data-watermark="" id="divwatermark">
                                <span id="ip"></span>
                                <table id="financialGrants" class="table no-margin table-striped table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            <th rowspan="1" style="text-align: center; height: 50px; vertical-align: middle;" class="width_7" id="serial_number">Sr No</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="fund_type">Type of Fund / Grants</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="amount_authorised">Amount Authorised</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="amount_allotted">Amount Allotted with Date</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="reasons_over_under">Reasons for Over / Under Allotment
                                            </th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="amount_expended">Amount Expended</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="amount_unutilised">Amount Unutilised</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="reasons_non_utilisation">Reasons for Non Utilisation</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="detailed_remarks">Detailed Remarks</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="fg_action">Action</th>
                                        </tr>
                                        <tr>
                                            <th style="text-align: center;">(a)</th>
                                            <th style="text-align: center;">(b)</th>
                                    ...
                                    <tbody style="font-size: 12px;" id="FG_tbody">
                                        <tr id="firstRow">
                                            <c:if test="${report.financial_grants_item != 1}">
                                                <td name="srno"></td>
                                                <td>
                                                    <input type="text" name="typeOfFund">
                                                </td>
                                                <td>
                                                    <input type="text" name="amtAuth" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="amtAlloted" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="reasonOverUnder">
                                                </td>
                                                <td>
                                                    <input type="text" name="amtExpended" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="amtUnutilised" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="reasonNonUtil">
                                                </td>
                                                <td>
                                                    <input type="text" name="detailedRemarks">
                                                </td>
                                                <td>
                                                    <button type="button" class="fa fa-plus btn btn-success btn-sm add-to-recommended" data-context="financialGrants"></button>
                                                </td>
                                            </c:if>
                                        </tr>
                                    </tbody>
                    ...
                    <div class="modal-footer">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="remarks"><strong>Remarks: </strong></label>
                                <textarea class="form-control" id="user_remarks18" name="user_remarks18" rows="3"></textarea>
                            </div>
                        ...
                        <div class="col-6 text-right">
                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
                            <c:if test="${report.financial_grants_item != 1}">
                                <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="financial_grants_item">Submit for Approval</button>
                            </c:if>
                            <c:if test="${report.financial_grants_item == 1}">
                                <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                            </c:if>
        ...
        <div class="modal fade" id="Regt_funds" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="btn btn-sm" onclick="openModal('#Financial_Grants')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>
                        <h5 class="modal-title" id="exampleModalLabel">Regt Funds incl Offrs Mess</h5>
                        <button type="button" class="btn btn-sm" id="next" onclick="openModal('#Training_Ammunition')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                        </button>
                        <button type="button" class="close btn-close" onclick="closeModal()">
                            <span aria-hidden="true">&times;</span>
                                ...
                                <table id="financialGrants" class="table no-margin table-striped table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th rowspan="3" style="text-align: center; vertical-align: middle;" id="regt_action">Action</th>
                                        </tr>
                                        <tr>
                                    ...
                                    <tbody style="font-size: 12px;" id="Regt_funds_tbody">
                                        <tr id="firstRow">
                                            <c:if test="${report.regt_funds_item != 1}">
                                                <td name="srno"></td>
                                                <td>
                                                    <input type="text" name="nameOfAcct">
                                                </td>
                                                <td>
                                                    <input type="text" name="assetI">
                                                </td>
                                                <td>
                                                    <input type="text" name="liabilityI">
                                                </td>
                                                <td>
                                                    <input type="text" name="assetII">
                                                </td>
                                                <td>
                                                    <input type="text" name="liabilityII">
                                                </td>
                                                <td>
                                                    <input type="text" name="assetIII">
                                                </td>
                                                <td>
                                                    <input type="text" name="liabilityIII">
                                                </td>
                                                <td>
                                                    <input type="text" name="incrDecrAcct">
                                                </td>
                                                <td>
                                                    <button type="button" class="fa fa-plus btn btn-success btn-sm add-to-recommended" data-context="regtFunds"></button>
                                                </td>
                                            </c:if>
                                        </tr>
                                    </tbody>
                    ...
                    <div class="modal-footer">
                        ...
                        <div class="col-6 text-right">
                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
                            <c:if test="${report.regt_funds_item != 1}">
                                <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="regt_funds_item">Submit for Approval</button>
                            </c:if>
                            <c:if test="${report.regt_funds_item == 1}">
                                <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                            </c:if>
        ...
        <div class="modal fade" id="Availability_of_Ranges" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">


            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button class="btn btn-sm" onclick="openModal('#Training_Ammunition')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>
                        <h5 class="modal-title" id="exampleModalLabel">Availability of
					Ranges</h5>
                        <button class="btn btn-sm" id="next" onclick="openModal('#Outstanding_Audit_Objections_Observations')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                        </button>
                        <button type="button" class="close btn-close" onclick="closeModal()">
                            <span aria-hidden="true">×</span>
                            ...
                            <div class="watermarked" data-watermark="" id="divwatermark">
                                ...
                                <table id="getAuthHeldTable" class="table no-margin table-striped table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            <th rowspan="1" style="text-align: center; height: 50px; vertical-align: middle;" class="width_7" id="serial_number">Sr No</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="number_of_ranges">Number of Ranges Available</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="when_used">When Used</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="difficulties_experienced">Difficulties Experienced, if any</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="action_classi">Action</th>
                                        </tr>
                                        <tr>
                                            <th style="text-align: center;">(a)</th>
                                            <th style="text-align: center;">(b)</th>
                                    ...
                                    <tbody style="font-size: 12px;" id="classfication_tbody">
                                        <tr id="firstRow">
                                            <c:if test="${report.availability_of_ranges_item != 1}">
                                                <td name="srno"></td>
                                                <td>
                                                    <input type="text" name="numberOfRanges">
                                                </td>
                                                <td>
                                                    <input type="date" name="whenUsed" max="${today}">
                                                </td>
                                                <td>
                                                    <input type="text" name="difficultiesExperienced">
                                                </td>
                                                <td>
                                                    <button type="button" class="fa fa-plus btn btn-success btn-sm add-to-recommended" data-context="classSave"></button>
                                                </td>
                                            </c:if>
                                        </tr>
                                    </tbody>
                            ...
                            <div class="watermarked" data-watermark="" id="divwatermark">
                                ...
                                <table id="getAuthHeldTable" class="table no-margin table-striped table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            <th rowspan="1" style="text-align: center; height: 50px; vertical-align: middle;" class="width_7" id="serial_number">Sr No</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="ranges_available">Ranges Available</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="level_utilised">Level at which Range Utilised</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="when_used">When Used</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="difficulties_experienced">Difficulties Experienced, if any</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="action_fer">Action</th>
                                        </tr>
                                        <tr>
                                            <th style="text-align: center;">(a)</th>
                                            <th style="text-align: center;">(b)</th>
                                    ...
                                    <tbody style="font-size: 12px;" id="ffrs_tbody">
                                        <tr id="firstRow">
                                            <c:if test="${report.availability_of_ranges_item != 1}">
                                                <td name="srno"></td>
                                                <td>
                                                    <input type="text" name="rangeAvailable">
                                                </td>
                                                <td>
                                                    <input type="text" name="rangeUtilized">
                                                </td>
                                                <td>
                                                    <input type="date" name="whenUsedFfrs" max="${today}">
                                                </td>
                                                <td>
                                                    <input type="text" name="difficultiesFfrs">
                                                </td>
                                                <td>
                                                    <button type="button" class="fa fa-plus btn btn-success btn-sm add-to-recommended" data-context="ffrsSave"></button>
                                                </td>
                                            </c:if>
                                        </tr>
                                    </tbody>
                    ...
                    <div class="modal-footer">
                        ...
                        <div class="col-6 text-right">
                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
                            <c:if test="${report.availability_of_ranges_item != 1}">
                                <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="availability_of_ranges_item">Submit for Approval</button>
                            </c:if>
                            <c:if test="${report.availability_of_ranges_item == 1}">
                                <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                            </c:if>
        ...
        <div class="modal fade" id="Training_Ammunition" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button class="btn btn-sm" onclick="openModal('#Regt_funds')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>
                        <h5 class="modal-title" id="exampleModalLabel">Training
					Ammunition</h5>
                        <button class="btn btn-sm" id="next" onclick="openModal('#Availability_of_Ranges')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                        </button>
                        <button type="button" class="close btn-close" onclick="closeModal()">
                            <span aria-hidden="true">&times;</span>
                            ...
                            <div class="watermarked" data-watermark="" id="divwatermark">
                                ...
                                <table id="getAuthHeldTable" class="table no-margin table-striped table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            <th rowspan="1" style="text-align: center; height: 50px; vertical-align: middle;" class="width_7" id="serial_number">Sr No</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="ammunition_type">Type of Ammunition</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="au">A/U</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="quantity_authorised">Quantity Authorised for Full Training Year</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="received">Received Including Carried Forward</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="expended">Expended</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="balance">Balance</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="reasons_non_expenditure">Reasons for Non-Expenditure</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="fg_action">Action</th>
                                        </tr>
                                        <tr>
                                            <th style="text-align: center;">(a)</th>
                                    ...
                                    <tbody style="font-size: 12px;" id="trainingAmmunition_tbody">
                                        <tr id="firstRow">
                                            <c:if test="${report.training_ammunition_item != 1}">
                                                <td name="srno"></td>
                                                <td>
                                                    <input type="text" name="typeOfAmmunation">
                                                </td>
                                                <td>
                                                    <input type="text" name="tmAuth">
                                                </td>
                                                <td>
                                                    <input type="text" name="tm_qunt_year" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="received_inc_carry_forward">
                                                </td>
                                                <td>
                                                    <input type="text" name="tmExpended">
                                                </td>
                                                <td>
                                                    <input type="text" name="tmBlance" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="tmreason">
                                                </td>
                                                <td>
                                                    <button type="button" class="fa fa-plus btn btn-success btn-sm add-to-recommended" data-context="trainingAmmunitionTble"></button>
                                                </td>
                                            </c:if>
                                        </tr>
                                    </tbody>
                    ...
                    <div class="modal-footer">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="remarks"><strong>Remarks: </strong></label>
                                <textarea class="form-control" id="user_remarks21" name="user_remarks21" rows="3"></textarea>
                            </div>
                        ...
                        <div class="col-6 text-right">
                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
                            <c:if test="${report.training_ammunition_item != 1}">
                                <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="training_ammunition_item">Submit for Approval</button>
                            </c:if>
                            <c:if test="${report.training_ammunition_item == 1}">
                                <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                            </c:if>
        ...
        <div class="modal fade" id="Outstanding_Audit_Objections_Observations" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <form:form id="Outstanding_Audit_Objections_Observations_form" name="Outstanding_Audit_Objections_Observations_form" action="Outstanding_Audit_Objections_Observations_form_action" method="post" commandName="aduit_formCmd">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button class="btn btn-sm" type="button" onclick="openModal('#Availability_of_Ranges')" id="previous">
                                <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                            </button>
                            <h5 class="modal-title" id="exampleModalLabel">Outstanding
					Audit Objections/ Observations</h5>
                            <button class="btn btn-sm" id="next" type="button" onclick="openModal('#Courses')">
                                Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                            </button>
                            <button type="button" class="close btn-close" onclick="closeModal()">
                                <span aria-hidden="true">&times;</span>
                            ...
                            <div class="col-md-12" id="getSearch_Letter" style="display: block;">
                                <div class="watermarked" data-watermark="" id="divwatermark">
                                    ...
                                    <table id="getAuthHeldTable" class="table no-margin table-striped table-hover table-bordered">
                                        <thead>
                                            <tr>
                                                <th rowspan="2" style="text-align: center; height: 50px; vertical-align: middle;" class="width_7" id="serial_number">Sr No</th>
                                                <th rowspan="2" style="text-align: center; vertical-align: middle;" id="period">Period</th>
                                                <th colspan="2" style="text-align: center; vertical-align: middle;" id="numbers_outstanding">Numbers Outstanding</th>
                                                <th rowspan="2" style="text-align: center; vertical-align: middle;" id="detailed_remarks">Detailed Remarks</th>
                                            </tr>
                                        ...
                                        <tbody style="font-size: 12px;" id="audit_tbody">
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="broughtPreviousObj" id="broughtPreviousObj" class="form-control form-control-sm numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="broughtPreviousObserv" id="broughtPreviousObserv" class="form-control form-control-sm numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="broughtPreviousRemark" id="broughtPreviousRemark" class="form-control form-control-sm ">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>2.</td>
                                                ...
                                                <td>
                                                    <input type="text" name="raisedReportObj" id="raisedReportObj" class="form-control form-control-sm numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="raisedReportObserv" id="raisedReportObserv" class="form-control form-control-sm numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="raisedReportRemark" id="raisedReportRemark" class="form-control form-control-sm ">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>3.</td>
                                                ...
                                                <td>
                                                    <input type="text" name="settledDuringObj" id="settledDuringObj" class="form-control form-control-sm numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="settledDuringObserv" id="settledDuringObserv" class="form-control form-control-sm numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="settledDuringRemark" id="settledDuringRemark" class="form-control form-control-sm ">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>4.</td>
                                                ...
                                                <td>
                                                    <input type="text" name="remainingObj" id="remainingObj" class="form-control form-control-sm numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="remainingObserv" id="remainingObserv" class="form-control form-control-sm numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="remainingRemark" id="remainingRemark" class="form-control form-control-sm ">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>5.</td>
                                                <td><strong><u>Details of Objections / Observations</u></strong>:

                                                    <li>(a) Three years and above old</li>
                                                    <li>(b) One year and above old (attach details for both as appropriate, including reasons for delay and action taken so far)</li>
                                                </td>
                                                <td>
                                                    <input type="text" name="difficultiesObj3" id="difficultiesObj3" class="form-control form-control-sm numeric-input">
                                                    <input type="text" name="difficultiesObj1" id="difficultiesObj1" class="form-control form-control-sm numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="difficultiesObserv3" id="difficultiesObserv3" class="form-control form-control-sm numeric-input">
                                                    <input type="text" name="difficultiesObserv1" id="difficultiesObserv1" class="form-control form-control-sm numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="difficultiesRemark3" id="difficultiesRemark3" class="form-control form-control-sm numeric-input">
                                                    <input type="text" name="difficultiesRemark1" id="difficultiesRemark1" class="form-control form-control-sm numeric-input">
                                                </td>
                                            </tr>
                        ...
                        <div class="modal-footer">
                            ...
                            <div class="col-6 text-right">
                                ...
                                <c:if test="${report.outstanding_audit_objections_observations_item != 1}">
                                    <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="outstanding_audit_objections_observations_item">Submit for Approval</button>
                                </c:if>
                                <c:if test="${report.outstanding_audit_objections_observations_item == 1}">
                                    <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                                </c:if>
        ...
        <div class="modal fade" id="Courses" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button class="btn btn-sm" type="button" onclick="openModal('#Outstanding_Audit_Objections_Observations')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>
                        <h5 class="modal-title" id="exampleModalLabel">Details of
					Courses (Category 'A' and Category 'B' Establishments only)</h5>
                        ...
                        <button type="button" type="button" class="close btn-close" onclick="closeModal()">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div class="col-md-12" id="getSearch_Letter" style="display: block;">
                            <div class="watermarked" data-watermark="" id="divwatermark">
                                <span id="ip"></span>
                                <table id="courseTable" class="table no-margin table-striped table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            <th rowspan="1" style="text-align: center; height: 50px; vertical-align: middle;" id="serial_number">Serial Number</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="course_name">Name of the Course</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="number_of_course">Number of Course</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="period_from">Period From</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="period_to">Period To</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="total_allotted">Total Allotted</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="attended">Attended</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="rtu">RTU</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="detailed_remarks">Detailed Remarks</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="">Action</th>
                                        </tr>
                                        <tr>
                                            <th style="text-align: center;">(a)</th>
                                            <th style="text-align: center;">(b)</th>
                                    ...
                                    <tbody style="font-size: 12px;" id="Course_Undertaken_tbody">
                                        <tr id="firstRow">
                                            <c:if test="${report.courses_item != 1}">
                                                ...
                                                <td>
                                                    <input type="text" name="courseNameUndertaken">
                                                </td>
                                                <td>
                                                    <input type="text" name="numberOfCourse" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="date" name="periodFrom" id="periodFrom" style="width: 90%;display: inline;">
                                                </td>
                                                <td>
                                                    <input type="date" name="periodTo" id="periodTo" style="width: 90%;display: inline;">
                                                </td>
                                                <td>
                                                    <input type="text" name="totalAllotted" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="attended" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="rtu" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="detailedRemarks">
                                                </td>
                                                <td>
                                                    <button type="button" class="fa fa-plus btn btn-success btn-sm add-to-recommended" data-context="coursesUndertaken"></button>
                                                </td>
                                            </c:if>
                                        </tr>
                                    </tbody>
                                ...
                                <table id="getAuthHeldTable" class="table no-margin table-striped table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            <th rowspan="1" style="text-align: center; height: 50px; vertical-align: middle;" id="serial_number">Serial Number</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="course_name">Name of the Course</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="total">Total</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="grading">Grading</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="da">D/A/B/C/E/</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="failed">Failed</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="rtu">RTU</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="detailed_remarks">Detailed Remarks</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="">Action</th>
                                    ...
                                    <tbody style="font-size: 12px;" id="Other_Courses_tbody">
                                        <tr id="firstRow">
                                            <c:if test="${report.courses_item != 1}">
                                                <td name="serialNumberOther"></td>
                                                <td>
                                                    <input type="text" name="courseNameOther">
                                                </td>
                                                <td>
                                                    <input type="text" name="totalOther" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="gradingOther">
                                                </td>
                                                <td>
                                                    <input type="text" name="daOther">
                                                </td>
                                                <td>
                                                    <input type="text" name="failedOther" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="rtuOther" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="detailedRemarksOther">
                                                </td>
                                                <td>
                                                    <button type="button" class="fa fa-plus btn btn-success btn-sm add-to-recommended" data-context="otherCourses"></button>
                                                </td>
                                            </c:if>
                                        </tr>
                                    </tbody>
                    ...
                    <div class="modal-footer">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="remarks"><strong>Remarks: </strong></label>
                                <textarea class="form-control" id="user_remarks22" name="user_remarks22" rows="3"></textarea>
                            </div>
                        ...
                        <div class="col-6 text-right">
                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
                            <c:if test="${report.courses_item != 1}">
                                <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="courses_item">Submit for Approval</button>
                            </c:if>
                            <c:if test="${report.courses_item == 1}">
                                <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                            </c:if>
        ...
        <div class="modal fade" id="Summary" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <form:form id="Summary_form" name="Summary_form" action="Summary_form_action" method="post" commandName="Summary_formCmd">

                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button class="btn btn-sm" type="button" onclick="openModal('#Courses')" id="previous">
                                <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                            </button>
                            <h5 class="modal-title" id="exampleModalLabel">Summary of
                        Technical Inspection</h5>
                            <button type="button" class="btn btn-sm" id="next" onclick="openModal('#Outstanding')">
                                Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                            </button>
                            <button type="button" class="close btn-close" onclick="closeModal()">
                                <span aria-hidden="true">×</span>
                                    ...
                                    <table id="getAuthHeldTable" class="table no-margin table-striped table-hover table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th rowspan="1" style="text-align: center; vertical-align: middle;" id="inspection_type">Type of Technical Inspection
                                                </th>
                                                <th rowspan="1" style="text-align: center; vertical-align: middle;" id="date_held">Date Held
                                                </th>
                                                <th rowspan="1" style="text-align: center; vertical-align: middle;" id="by_whom">By Whom
                                                </th>
                                                <th rowspan="1" style="text-align: center; vertical-align: middle;" id="result">Result
                                                </th>
                                                <th rowspan="1" style="text-align: center; vertical-align: middle;" id="detailed_remarks">Detailed Remarks
                                                </th>
                                                <th rowspan="2" style="text-align: center; vertical-align: middle;" id="action">Action
                                                </th>
                                            </tr>
                                            <tr>
                                                <th style="text-align: center;">(a)</th>
                                        ...
                                        <tbody style="font-size: 12px;" id="summary_tech_insp_tbody">
                                            <tr>
                                                <td>1</td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="inspection_type_1" value="CEME" readonly>
                                                </td>
                                                <td>
                                                    <input type="date" name="date_held_1" id="date_held_1" class="form-control" style="width: 90%;display: inline;" max="${today}">
                                                </td>
                                                <td>
                                                    <input type="text" name="by_whom_1" id="by_whom_1" class="form-control form-control-sm">
                                                </td>
                                                <td>
                                                    <input type="text" name="result_1" id="result_1" class="form-control form-control-sm">
                                                </td>
                                                <td>
                                                    <input type="text" name="detailed_remarks_1" id="detailed_remarks_1" class="form-control form-control-sm">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>2</td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="inspection_type_2" value="PARS" readonly>
                                                </td>
                                                <td>
                                                    <input type="date" name="date_held_2" id="date_held_2" class="form-control" style="width: 90%;display: inline;" max="${today}">
                                                </td>
                                                <td>
                                                    <input type="text" name="by_whom_2" id="by_whom_2" class="form-control form-control-sm">
                                                </td>
                                                <td>
                                                    <input type="text" name="result_2" id="result_2" class="form-control form-control-sm">
                                                </td>
                                                <td>
                                                    <input type="text" name="detailed_remarks_2" id="detailed_remarks_2" class="form-control form-control-sm">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>3</td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="inspection_type_3" value="EMAE (SA)" readonly>
                                                </td>
                                                <td>
                                                    <input type="date" name="date_held_3" id="date_held_3" class="form-control" style="width: 90%;display: inline;" max="${today}">
                                                </td>
                                                <td>
                                                    <input type="text" name="by_whom_3" id="by_whom_3" class="form-control form-control-sm">
                                                </td>
                                                <td>
                                                    <input type="text" name="result_3" id="result_3" class="form-control form-control-sm">
                                                </td>
                                                <td>
                                                    <input type="text" name="detailed_remarks_3" id="detailed_remarks_3" class="form-control form-control-sm">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>4</td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="inspection_type_4" value="Cyber Security Audit" readonly>
                                                </td>
                                                <td>
                                                    <input type="date" name="date_held_4" id="date_held_4" class="form-control" style="width: 90%;display: inline;" max="${today}">
                                                </td>
                                                <td>
                                                    <input type="text" name="by_whom_4" id="by_whom_4" class="form-control form-control-sm">
                                                </td>
                                                <td>
                                                    <input type="text" name="result_4" id="result_4" class="form-control form-control-sm">
                                                </td>
                                                <td>
                                                    <input type="text" name="detailed_remarks_4" id="detailed_remarks_4" class="form-control form-control-sm">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>5</td>
                                                <td>
                                                    <input type="text" class="form-control form-control-sm" id="inspection_type_5" value="Training Validation" readonly>
                                                </td>
                                                <td>
                                                    <input type="date" name="date_held_5" id="date_held_5" class="form-control" style="width: 90%;display: inline;" max="${today}">
                                                </td>
                                                <td>
                                                    <input type="text" name="by_whom_5" id="by_whom_5" class="form-control form-control-sm">
                                                </td>
                                                <td>
                                                    <input type="text" name="result_5" id="result_5" class="form-control form-control-sm">
                                                </td>
                                                <td>
                                                    <input type="text" name="detailed_remarks_5" id="detailed_remarks_5" class="form-control form-control-sm">
                                                </td>
                                            </tr>
                                        ...
                                        <tbody style="font-size: 12px;" id="summary_tbody">
                                            <tr id="firstRow">
                                                <c:if test="${report.summarybtn != 1}">
                                                    <td></td>
                                                    <td>
                                                        <input type="text" name="Otherinsp" id="Otherinsp" class="form-control form-control-sm" placeholder="Any other inspection">
                                                    </td>
                                                    <td>
                                                        <input type="date" name="otherinspDate" id="otherinspDate" class="form-control" style="width: 90%;display: inline;" max="${today}">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="byWhomOther" id="byWhomOther" class="form-control form-control-sm ">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="resultOther" id="resultOther" class="form-control form-control-sm ">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="remarkOther" id="remarkOther" class="form-control form-control-sm ">
                                                    </td>
                                                    <td>
                                                        <button type="button" class="fa fa-plus btn btn-success btn-sm add-to-recommended" data-context="summaryTble"></button>
                                                    </td>
                                                </c:if>
                        ...
                        <div class="modal-footer">
                            ...
                            <div class="col-6 text-right">
                                <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close
                                </button>
                                <c:if test="${report.summarybtn != 1}">
                                    <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="summarybtn">Submit for Approval
                                    </button>
                                </c:if>
                                <c:if test="${report.summarybtn == 1}">
                                    <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
        ...
        <div class="modal fade" id="Outstanding" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <form:form id="Outstanding_rent_allied_Form" name="Outstanding_rent_allied_Form" action="OutstandingRentAlliedAction" method="post" commandName="OutstandingRentAlliedCmd">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button class="btn btn-sm" type="button" onclick="openModal('#Summary')" id="previous">
                                <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                            </button>
                            <h5 class="modal-title" id="exampleModalLabel">Details of
					Outstanding Rent/Allied Charges</h5>
                            <button class="btn btn-sm" id="next" type="button" onclick="openModal('#MT_Accidents')">
                                Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                            </button>
                            <button type="button" class="close btn-close" onclick="closeModal()">
                                <span aria-hidden="true">&times;</span>
                                ...
                                <div class="watermarked" data-watermark="" id="divwatermark">
                                    ...
                                    <table id="getAuthHeldTable" class="table no-margin table-striped table-hover table-bordered">
                                        <thead>
                                            <tr>
                                                <th rowspan="1" style="text-align: center; height: 50px; vertical-align: middle;" class="width_7" id="serial_number">Sr No</th>
                                                <th rowspan="1" style="text-align: center; vertical-align: middle;" id="year">Year</th>
                                                <th rowspan="1" style="text-align: center; vertical-align: middle;" id="amount_outstanding">Amount Outstanding</th>
                                                <th rowspan="1" style="text-align: center; vertical-align: middle;" id="on_what_account">On What Account</th>
                                                <th rowspan="1" style="text-align: center; vertical-align: middle;" id="detailed_remarks">Detailed Remarks</th>
                                        ...
                                        <tbody style="font-size: 12px;" id="Outstanding_tbody">
                                            <tr id="firstRow">
                                                <c:if test="${report.outstanding_item != 1}">
                                                    <td name="srno"></td>
                                                    <td>
                                                        <input type="text" name="year" class="numeric-input">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="amount_outstanding" class="numeric-input">
                                                    </td>
                                                    <td>
                                                        <input type="text" name="on_acc" class="numeric-input">
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <button type="button" class="fa fa-plus btn btn-success btn-sm add-to-recommended" data-context="OutstandingTble"></button>
                                                    </td>
                                                </c:if>
                                            </tr>
                                        </tbody>
                        ...
                        <div class="modal-footer">
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    <label for="remarks"><strong>Remarks: </strong></label>
                                    <textarea class="form-control" id="user_remarks23" name="user_remarks23" rows="3"></textarea>
                                </div>
                            ...
                            <div class="col-6 text-right">
                                <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
                                <c:if test="${report.outstanding_item != 1}">
                                    <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="outstanding_item">Submit for Approval</button>
                                </c:if>
                                <c:if test="${report.outstanding_item == 1}">
                                    <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                                </c:if>
        ...
        <div class="modal fade" id="MT_Accidents" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button class="btn btn-sm" onclick="openModal('#Outstanding')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>
                        <h5 class="modal-title" id="exampleModalLabel">Details of
					Outstanding Loss Statements Including MT Accidents</h5>
                        <button class="btn btn-sm" id="next" onclick="openModal('#Details_of_Suicides')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                        </button>
                        <button type="button" class="close btn-close" onclick="closeModal()">
                            <span aria-hidden="true">&times;</span>
                                ...
                                <table id="getAuthHeldTable" class="table no-margin table-striped table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            <th rowspan="1" style="text-align: center; height: 50px; vertical-align: middle;" class="width_7" id="serial_number">Sr No</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="year">Year</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="nature_of_loss">Nature of Loss</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="value">Value</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="detailed_remarks">Detailed Remarks</th>
                                            <th rowspan="2" style="text-align: center; vertical-align: middle;">Action</th>
                                        </tr>
                                        <tr>
                                    ...
                                    <tbody style="font-size: 12px;" id="OutstandingMT_tbody">
                                        <tr id="firstRow">
                                            <c:if test="${report.mt_accidents_item != 1}">
                                                ...
                                                <td>
                                                    <input type="text" name="nature_of_loss" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="value" class="numeric-input">
                                                </td>
                                                <td>
                                                    <input type="text" name="remarks">
                                                </td>
                                                ...
                                                <td>
                                                    <button type="button" class="fa fa-plus btn btn-success btn-sm add-to-recommended" data-context="OutstandingMTTble"></button>
                                                </td>
                                            </c:if>
                                        </tr>
                                    </tbody>
                    ...
                    <div class="modal-footer">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="remarks"><strong>Remarks: </strong></label>
                                <textarea class="form-control" id="user_remarks24" name="user_remarks24" rows="3"></textarea>
                            </div>
                        ...
                        <div class="col-6 text-right">
                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
                            <c:if test="${report.mt_accidents_item != 1}">
                                <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="mt_accidents_item">Submit for Approval</button>
                            </c:if>
                            <c:if test="${report.mt_accidents_item == 1}">
                                <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                            </c:if>
        ...
        <div class="modal fade" id="Details_of_Suicides" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button class="btn btn-sm" onclick="openModal('#MT_Accidents')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>
                        <h5 class="modal-title" id="exampleModalLabel">Details of
					Suicides/ Fratricides/ Untoward Incidents of any other Nature</h5>
                        <button class="btn btn-sm" id="next" onclick="openModal('#Security_Lapses')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                        </button>
                        <button type="button" class="close btn-close" onclick="closeModal()">
                            <span aria-hidden="true">&times;</span>
                            ...
                            <div class="watermarked" data-watermark="" id="divwatermark">
                                ...
                                <table id="getAuthHeldTable" class="table no-margin table-striped table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            <th rowspan="1" style="text-align: center; height: 50px; vertical-align: middle;" class="width_7" id="serial_number">Sr No</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="date">Date</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="nature_of_incident">Nature of Incident</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="fatal_non_fatal">Fatal / Non-Fatal Casualty</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="detailed_remarks">Detailed Remarks</th>
                                            <th rowspan="2" style="text-align: center; vertical-align: middle;">Action</th>
                                        </tr>
                                        <tr>
                                    ...
                                    <tbody style="font-size: 12px;" id="fatalIncidents_tbody">
                                        <tr id="firstRow">
                                            <c:if test="${report.details_of_suicides_item != 1}">
                                                ...
                                                <td>
                                                    <input type="text" name="nature_of_insident">
                                                </td>
                                                <td>
                                                    <input type="text" name="casualty">
                                                </td>
                                                <td>
                                                    <input type="text" name="remarks">
                                                </td>
                                                ...
                                                <td>
                                                    <button type="button" class="fa fa-plus btn btn-success btn-sm add-to-recommended" data-context="fatalIncidentsTble"></button>
                                                </td>
                                            </c:if>
                                        </tr>
                                    </tbody>
                    ...
                    <div class="modal-footer">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="remarks"><strong>Remarks: </strong></label>
                                <textarea class="form-control" id="user_remarks25" name="user_remarks25" rows="3"></textarea>
                            </div>
                        ...
                        <div class="col-6 text-right">
                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
                            <c:if test="${report.details_of_suicides_item != 1}">
                                <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="details_of_suicides_item">Submit for Approval</button>
                            </c:if>
                            <c:if test="${report.details_of_suicides_item == 1}">
                                <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                            </c:if>
        ...
        <div class="modal fade" id="Security_Lapses" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button class="btn btn-sm" onclick="openModal('#Details_of_Suicides')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>
                        <h5 class="modal-title" id="exampleModalLabel">Security Lapses
					Observed in the Unit Functioning</h5>
                        <button class="btn btn-sm" id="next" onclick="openModal('#Details_of_Attachments')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                        </button>
                        <button type="button" class="close btn-close" onclick="closeModal()">
                            <span aria-hidden="true">&times;</span>
                                ...
                                <table id="getAuthHeldTable" class="table no-margin table-striped table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            <th rowspan="1" style="text-align: center; height: 50px; vertical-align: middle;" class="width_7" id="serial_number">Sr No</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="date">Date</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="nature_of_security_lapse">Nature of Security Lapse</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="resulted_in">Resulted in</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="detailed_remarks">Detailed Remarks</th>
                                            <th rowspan="2" style="text-align: center; vertical-align: middle;">Action</th>
                                        </tr>
                                        <tr>
                                    ...
                                    <tbody style="font-size: 12px;" id="securityLapses_tbody">
                                        <tr id="firstRow">
                                            <c:if test="${report.security_lapses_item != 1}">
                                                ...
                                                <td>
                                                    <input type="text" name="nature_of_security_lapse">
                                                </td>
                                                <td>
                                                    <input type="text" name="resulted_in">
                                                </td>
                                                <td>
                                                    <input type="text" name="remarks">
                                                </td>
                                                ...
                                                <td>
                                                    <button type="button" class="fa fa-plus btn btn-success btn-sm add-to-recommended" data-context="securityLapsesTble"></button>
                                                </td>
                                            </c:if>
                                        </tr>
                                    </tbody>
                    ...
                    <div class="modal-footer">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="remarks"><strong>Remarks: </strong></label>
                                <textarea class="form-control" id="user_remarks26" name="user_remarks26" rows="3"></textarea>
                            </div>
                        ...
                        <div class="col-6 text-right">
                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
                            <c:if test="${report.security_lapses_item != 1}">
                                <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="security_lapses_item">Submit for Approval</button>
                            </c:if>
                            <c:if test="${report.security_lapses_item == 1}">
                                <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                            </c:if>
        ...
        <div class="modal fade" id="Details_of_Attachments" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button class="btn btn-sm" onclick="openModal('#Security_Lapses')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>
                        <h5 class="modal-title" id="exampleModalLabel">Details of
					Attachments Outside the Unit</h5>
                        <button class="btn btn-sm" id="next" onclick="openModal('#Details_of_Officers')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                        </button>
                            ...
                            <div class="watermarked" data-watermark="" id="divwatermark">
                                ...
                                <table id="getAuthHeldTable" class="table no-margin table-striped table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            <th rowspan="1" style="text-align: center; height: 50px; vertical-align: middle;" class="width_7" id="serial_number">Sr No</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="location">Location</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="number_of_personnel">Number of Personnel Attached</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="duration">Duration</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="detailed_remarks">Detailed Remarks</th>
                                            <th rowspan="2" style="text-align: center; vertical-align: middle;">Action</th>
                                        </tr>
                                        <tr>
                                    ...
                                    <tbody style="font-size: 12px;" id="outsideAttachments_tbody">
                                        <tr id="firstRow">
                                            <c:if test="${report.details_of_attachments_item != 1}">
                                                ...
                                                <td>
                                                    <input type="text" name="number_of_personnel_attached" class="numeric-input">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <button type="button" class="fa fa-plus btn btn-success btn-sm add-to-recommended" data-context="outsideAttachmentsTble"></button>
                                                </td>
                                            </c:if>
                                        </tr>
                                    </tbody>
                    ...
                    <div class="modal-footer">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="remarks"><strong>Remarks: </strong></label>
                                <textarea class="form-control" id="user_remarks27" name="user_remarks27" rows="3"></textarea>
                            </div>
                        ...
                        <div class="col-6 text-right">
                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
                            <c:if test="${report.details_of_attachments_item != 1}">
                                <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="details_of_attachments_item">Submit for Approval</button>
                            </c:if>
                            <c:if test="${report.details_of_attachments_item == 1}">
                                <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                            </c:if>
        ...
        <div class="modal fade" id="Details_of_Officers" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">

                        <button class="btn btn-sm" onclick="openModal('#Details_of_Attachments')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>
                        <h5 class="modal-title" id="exampleModalLabel">Details of
					Officers Who Have Proceeded on TD in the last 12 months</h5>
                        <button class="btn btn-sm" id="next" onclick="openModal('#Social_Media_violation')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                        </button>
                            ...
                            <div class="watermarked" data-watermark="" id="divwatermark">
                                ...
                                <table id="getAuthHeldTable" class="table no-margin table-striped table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            <th rowspan="1" style="text-align: center; height: 50px; vertical-align: middle;" class="width_7" id="serial_number">Sr No</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="rank_name">Rank & Name</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="nature_of_duty">Nature of Duty</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="ordered_by">Ordered By</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="detailed_remarks">Detailed Remarks</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="">Action</th>
                                        </tr>
                                        <tr>
                                    ...
                                    <tbody style="font-size: 12px;" id="TD_Officers_tbody">
                                        <tr id="firstRow">
                                            <c:if test="${report.details_of_officers_item != 1}">
                                                <td name="serialNumberTD"></td>
                                                <td>
                                                    <input type="text" name="rankAndName">
                                                </td>
                                                <td>
                                                    <input type="text" name="natureOfDuty">
                                                </td>
                                                <td>
                                                    <input type="text" name="orderedBy">
                                                </td>
                                                <td>
                                                    <input type="text" name="detailedRemarksTD">
                                                </td>
                                                <td>
                                                    <button type="button" class="fa fa-plus btn btn-success btn-sm add-to-recommended" data-context="tdOfficers"></button>
                                                </td>
                                            </c:if>
                                        </tr>
                                    </tbody>
                    ...
                    <div class="modal-footer">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="remarks"><strong>Remarks: </strong></label>
                                <textarea class="form-control" id="user_remarks28" name="user_remarks28" rows="3"></textarea>
                            </div>
                        ...
                        <div class="col-6 text-right">
                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
                            <c:if test="${report.details_of_officers_item != 1}">
                                <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="details_of_officers_item">Submit for Approval</button>
                            </c:if>
                            <c:if test="${report.details_of_officers_item == 1}">
                                <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                            </c:if>
        ...
        <div class="modal fade" id="Social_Media_violation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">

                        <button class="btn btn-sm" onclick="openModal('#Details_of_Officers')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>
                        <h5 class="modal-title" id="exampleModalLabel">Security Lapses
					(Social Media violation) Observed in the Unit</h5>
                        <button class="btn btn-sm" id="next" onclick="openModal('#web_messenger_Apps')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                        </button>
                            ...
                            <div class="watermarked" data-watermark="" id="divwatermark">
                                ...
                                <table id="getAuthHeldTable" class="table no-margin table-striped table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            <th rowspan="1" style="text-align: center; height: 50px; vertical-align: middle;" class="width_7" id="serial_number">Sr No</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="date_of_violation_reported_hq">Date of Violation Reported Initially Higher HQ</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="date_of_violation_reported_unit">Date of Violation Reported Initially by Unit/Formation to Higher HQ, if any</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="number_rank_name">Number, Rank and Name</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="current_status">Current Status of Progress of the Case
                                            </th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="loss_of_information">Loss of Information, if any</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="remarks">Remarks</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="">Action</th>
                                        </tr>
                                        <tr>
                                            <th style="text-align: center;">(a)</th>
                                    ...
                                    <tbody style="font-size: 12px;" id="Social_Media_Lapses_tbody">
                                        <tr id="firstRow">
                                            <c:if test="${report.social_media_violation_item != 1}">
                                                <td name="SMLserialNumber"></td>
                                                <td>
                                                    <input type="date" name="SMLdateViolationReportedHQ">
                                                </td>
                                                <td>
                                                    <input type="date" name="SMLdateViolationReportedUnit">
                                                </td>
                                                <td>
                                                    <input type="text" name="SMLnumberRankName">
                                                </td>
                                                <td>
                                                    <input type="text" name="SMLcurrentStatus">
                                                </td>
                                                <td>
                                                    <input type="text" name="SMLlossOfInformation">
                                                </td>
                                                <td>
                                                    <input type="text" name="SMLremarks">
                                                </td>
                                                <td>
                                                    <button type="button" class="fa fa-plus btn btn-success btn-sm add-to-recommended" data-context="socialMediaLapses"></button>
                                                </td>
                                            </c:if>
                                        </tr>
                                    </tbody>
                    ...
                    <div class="modal-footer">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="remarks"><strong>Remarks: </strong></label>
                                <textarea class="form-control" id="user_remarks29" name="user_remarks29" rows="3"></textarea>
                            </div>
                        ...
                        <div class="col-6 text-right">
                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
                            <c:if test="${report.social_media_violation_item != 1}">
                                <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="social_media_violation_item">Submit for Approval</button>
                            </c:if>
                            <c:if test="${report.social_media_violation_item == 1}">
                                <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                            </c:if>
        ...
        <div class="modal fade" id="web_messenger_Apps" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">

                        <button class="btn btn-sm" onclick="openModal('#Social_Media_violation')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>
                        <h5 class="modal-title" id="exampleModalLabel">Security Lapses
					(PIO Calls/ comn with PIO on web messenger Apps) observed in the
					unit</h5>
                        <button class="btn btn-sm" id="next" onclick="openModal('#Espionage')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                        </button>
                            ...
                            <div class="watermarked" data-watermark="" id="divwatermark">
                                ...
                                <table id="getAuthHeldTable" class="table no-margin table-striped table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            <th rowspan="1" style="text-align: center; height: 50px; vertical-align: middle;" class="width_7" id="serial_number">Sr No</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="date_of_violation_reported_hq">Date of Violation Reported from Higher HQ</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="date_of_violation_reported_unit">Date of Violation Reported Initially by Unit/Formation to Higher HQ, if any</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="number_rank_name">Number, Rank and Name</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="current_status">Current Status of Progress of Case</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="loss_of_information">Loss of Information, if any</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="remarks">Remarks</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="">Action</th>
                                        </tr>
                                    ...
                                    <tbody style="font-size: 12px;" id="PIO_Calls_Lapses_tbody">
                                        <tr id="firstRow">
                                            <c:if test="${report.web_messenger_apps_item != 1}">
                                                <td name="PCLserialNumber"></td>
                                                <td>
                                                    <input type="date" name="PCLdateViolationReportedHQ">
                                                </td>
                                                <td>
                                                    <input type="date" name="PCLdateViolationReportedUnit">
                                                </td>
                                                <td>
                                                    <input type="text" name="PCLnumberRankName">
                                                </td>
                                                <td>
                                                    <input type="text" name="PCLcurrentStatus">
                                                </td>
                                                <td>
                                                    <input type="text" name="PCLlossOfInformation">
                                                </td>
                                                <td>
                                                    <input type="text" name="PCLremarks">
                                                </td>
                                                <td>
                                                    <button type="button" class="fa fa-plus btn btn-success btn-sm add-to-recommended" data-context="pioCallsLapses"></button>
                                                </td>
                                            </c:if>
                                        </tr>
                                    </tbody>
                    ...
                    <div class="modal-footer">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="remarks"><strong>Remarks: </strong></label>
                                <textarea class="form-control" id="user_remarks30" name="user_remarks30" rows="3"></textarea>
                            </div>
                        ...
                        <div class="col-6 text-right">
                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
                            <c:if test="${report.web_messenger_apps_item != 1}">
                                <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="web_messenger_apps_item">Submit for Approval</button>
                            </c:if>
                            <c:if test="${report.web_messenger_apps_item == 1}">
                                <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                            </c:if>
        ...
        <div class="modal fade" id="Espionage" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">

                        <button class="btn btn-sm" onclick="openModal('#web_messenger_Apps')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>
                        <h5 class="modal-title" id="exampleModalLabel">Security Lapses
					(Espionage)</h5>
                        <button class="btn btn-sm" id="next" onclick="openModal('#Compromise_of_Cell_Phone')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                        </button>
                                    ...
                                    <tbody style="font-size: 12px;" id="Espionage_Lapses_tbody">
                                        <tr id="firstRow">
                                            <c:if test="${report.espionage_item != 1}">
                                                <td name="ELserialNumber"></td>
                                                <td>
                                                    <input type="date" name="ELdateViolationReportedHQ">
                                                </td>
                                                <td>
                                                    <input type="date" name="ELdateViolationReportedUnit">
                                                </td>
                                                <td>
                                                    <input type="text" name="ELnumberRankName">
                                                </td>
                                                <td>
                                                    <input type="text" name="ELcurrentStatus">
                                                </td>
                                                <td>
                                                    <input type="text" name="ELlossOfInformation">
                                                </td>
                                                <td>
                                                    <input type="text" name="ELremarks">
                                                </td>
                                                <td>
                                                    <button type="button" class="fa fa-plus btn btn-success btn-sm add-to-recommended" data-context="espionageLapses"></button>
                                                </td>
                                            </c:if>
                                        </tr>
                                    </tbody>
                    ...
                    <div class="modal-footer">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="remarks"><strong>Remarks: </strong></label>
                                <textarea class="form-control" id="user_remarks31" name="user_remarks31" rows="3"></textarea>
                            </div>
                        ...
                        <div class="col-6 text-right">
                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
                            <c:if test="${report.espionage_item != 1}">
                                <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="espionage_item">Submit for Approval</button>
                            </c:if>
                            <c:if test="${report.espionage_item == 1}">
                                <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                            </c:if>
        ...
        <div class="modal fade" id="Compromise_of_Cell_Phone" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button class="btn btn-sm" onclick="openModal('#Espionage')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>
                        <h5 class="modal-title" id="exampleModalLabel">Security Lapses
					(Compromise of Cell Phone / other Digital Artefacts by Inimical
					Agency/ Malwares) Observed in Unit</h5>
                        <button class="btn btn-sm" id="next" onclick="openModal('#Untraceable')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                        </button>
                        ...
                        <div class="col-md-12" id="getSearch_Letter" style="display: block;">
                            <div class="watermarked" data-watermark="" id="divwatermark">
                                ...
                                <table id="getAuthHeldTable" class="table no-margin table-striped table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            <th rowspan="1" style="text-align: center; height: 50px; vertical-align: middle;" id="serial_number">Sr No</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="date_of_violation_reported_hq">Date of Violation Reported from Higher HQ</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="date_of_violation_reported_unit">Date of Violation Reported Initially by Unit/Formation to Higher HQ, if any</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="number_rank_name">Number, Rank and Name</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="current_status">Current Status of Progress of Case</th>
                                    ...
                                    <tbody style="font-size: 12px;" id="Cell_Phone_Compromise_Lapses_tbody">
                                        <tr id="firstRow">
                                            <c:if test="${report.compromise_of_cell_phone_item != 1}">
                                                <td name="CPCLserialNumber"></td>
                                                <td>
                                                    <input type="date" name="CPCLdateViolationReportedHQ">
                                                </td>
                                                <td>
                                                    <input type="date" name="CPCLdateViolationReportedUnit">
                                                </td>
                                                <td>
                                                    <input type="text" name="CPCLnumberRankName">
                                                </td>
                                                <td>
                                                    <input type="text" name="CPCLcurrentStatus">
                                                </td>
                                                <td>
                                                    <input type="text" name="CPCLlossOfInformation">
                                                </td>
                                                <td>
                                                    <input type="text" name="CPCLremarks">
                                                </td>
                                                <td>
                                                    <button type="button" class="fa fa-plus btn btn-success btn-sm add-to-recommended" data-context="cellPhoneCompromiseLapses"></button>
                                                </td>
                                            </c:if>
                                        </tr>
                                    </tbody>
                    ...
                    <div class="modal-footer">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="remarks"><strong>Remarks: </strong></label>
                                <textarea class="form-control" id="user_remarks32" name="user_remarks32" rows="3"></textarea>
                            </div>
                        ...
                        <div class="col-6 text-right">
                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
                            <c:if test="${report.compromise_of_cell_phone_item != 1}">
                                <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="compromise_of_cell_phone_item">Submit for Approval</button>
                            </c:if>
                            <c:if test="${report.compromise_of_cell_phone_item == 1}">
                                <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                            </c:if>
        ...
        <div class="modal fade" id="Untraceable" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button class="btn btn-sm" onclick="openModal('#Compromise_of_Cell_Phone')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>
					...
					Check</h5>
                        ...
                        <button class="btn btn-sm" id="next" type="button" onclick="openModal('#Loss_of_CD')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                        </button>
                            ...
                            <div class="watermarked" data-watermark="" id="divwatermark">
                                ...
                                <table id="getAuthHeldTable" class="table no-margin table-striped table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            <th rowspan="1" style="text-align: center; height: 50px; vertical-align: middle;" id="serial_number">Sr No</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="untraceable_document">Untraceable Document (Subject with File Number and Date)</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="classification">Classification</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="originator">Originator of Document</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="custodian">Custodian of Documents</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="current_status">Current Status of the Case</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="remarks">Remarks</th>
                                            <th rowspan="2" style="text-align: center; vertical-align: middle;">Action</th>
                                        </tr>
                                        <tr>
                                    ...
                                    <tbody style="font-size: 12px;" id="Untraceable_tbody">
                                        <tr id="firstRow">
                                            <c:if test="${report.untraceable_item != 1}">
                                                <td name="srno"></td>
                                                <td>
                                                    <input type="text" name="untraceable_document" class="form-control form-control-sm">
                                                </td>
                                                <td>
                                                    <input type="text" name="classification">
                                                </td>
                                                <td>
                                                    <input type="text" name="originator_doc">
                                                </td>
                                                <td>
                                                    <input type="text" name="custodian_doc">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <button type="button" class="fa fa-plus btn btn-success btn-sm add-to-recommended" data-context="UntraceableTble"></button>
                                                </td>
                                            </c:if>
                                        </tr>
                                    </tbody>
                    ...
                    <div class="modal-footer">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="remarks"><strong>Remarks: </strong></label>
                                <textarea class="form-control" id="user_remarks33" name="user_remarks33" rows="3"></textarea>
                            </div>
                        ...
                        <div class="col-6 text-right">
                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
                            <c:if test="${report.untraceable_item != 1}">
                                <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="untraceable_item">Submit for Approval</button>
                            </c:if>
                            <c:if test="${report.untraceable_item == 1}">
                                <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                            </c:if>
        ...
        <div class="modal fade" id="Loss_of_CD" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button class="btn btn-sm" onclick="openModal('#Untraceable')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>
                        <h5 class="modal-title" id="exampleModalLabel">Security Lapses
					(Loss of CD/DVD)</h5>
                        <button class="btn btn-sm" id="next" onclick="openModal('#Loss_of_Identity')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                        </button>
                        <button type="button" class="close btn-close" onclick="closeModal()">
                            <span aria-hidden="true">&times;</span>
                            ...
                            <div class="watermarked" data-watermark="" id="divwatermark">
                                ...
                                <table id="getAuthHeldTable" class="table no-margin table-striped table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            <th rowspan="1" style="text-align: center; height: 50px; vertical-align: middle;" id="serial_number">Sr No</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="untraceable_cd_dvd">Untraceable CD/DVD (Subject with CD/DVD Number and Date)</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="classification">Classification</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="originator">Originator of CD/DVD</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="custodian">Custodian of CD/DVD</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="current_status">Current Status of the Case</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="remarks">Remarks</th>
                                            <th rowspan="2" style="text-align: center; vertical-align: middle;">Action</th>
                                        </tr>
                                    ...
                                    <tbody style="font-size: 12px;" id="lossCdDvd_tbody">
                                        <tr id="firstRow">
                                            <c:if test="${report.loss_of_cd_item != 1}">
                                                <td name="srno"></td>
                                                <td>
                                                    <input type="text" name="untraceble_cd_dvd">
                                                </td>
                                                <td>
                                                    <input type="text" name="classification">
                                                </td>
                                                <td>
                                                    <input type="text" name="originator_cd">
                                                </td>
                                                <td>
                                                    <input type="text" name="custodian_cd">
                                                </td>
                                                <td>
                                                    <input type="text" name="current_status">
                                                </td>
                                                ...
                                                <td>
                                                    <button type="button" class="fa fa-plus btn btn-success btn-sm add-to-recommended" data-context="lossCdDvdTble"></button>
                                                </td>
                                            </c:if>
                                        </tr>
                                    </tbody>
                    ...
                    <div class="modal-footer">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="remarks"><strong>Remarks: </strong></label>
                                <textarea class="form-control" id="user_remarks34" name="user_remarks34" rows="3"></textarea>
                            </div>
                        ...
                        <div class="col-6 text-right">
                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
                            <c:if test="${report.loss_of_cd_item != 1}">
                                <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="loss_of_cd_item">Submit for Approval</button>
                            </c:if>
                            <c:if test="${report.loss_of_cd_item == 1}">
                                <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                            </c:if>
        ...
        <div class="modal fade" id="Loss_of_Identity" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button class="btn btn-sm" onclick="openModal('#Loss_of_CD')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>
                            ...
                            <div class="watermarked" data-watermark="" id="divwatermark">
                                ...
                                <table id="getAuthHeldTable" class="table no-margin table-striped table-hover table-bordered">
                                    <thead>
                                        <tr>
                                            <th rowspan="1" style="text-align: center; height: 50px; vertical-align: middle;" id="serial_number">Sr No</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="untraceable_document_token">Untraceable Document/Token (Subject with I Card/Token Number and Date)</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="classification">Classification</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="originator">Originator of Document/ECR Token</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="custodian">Custodian of Document/ECR Token</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="current_status">Current Status of the Case</th>
                                            <th rowspan="1" style="text-align: center; vertical-align: middle;" id="remarks">Remarks</th>
                                            <th rowspan="2" style="text-align: center; vertical-align: middle;">Action</th>
                                        </tr>
                                    ...
                                    <tbody style="font-size: 12px;" id="lostIdEcr_tbody">
                                        <tr id="firstRow">
                                            <c:if test="${report.loss_of_identity_item != 1}">
                                                <td name="srno"></td>
                                                <td>
                                                    <input type="text" name="untraceable_document_token">
                                                </td>
                                                <td>
                                                    <input type="text" name="classification">
                                                </td>
                                                <td>
                                                    <input type="text" name="originator_doc_ecr">
                                                </td>
                                                <td>
                                                    <input type="text" name="custodian_doc_ecr">
                                                </td>
                                                <td>
                                                    <input type="text" name="current_status">
                                                </td>
                                                ...
                                                <td>
                                                    <button type="button" class="fa fa-plus btn btn-success btn-sm add-to-recommended" data-context="lostIdEcrTble"></button>
                                                </td>
                                            </c:if>
                    ...
                    <div class="modal-footer">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                <label for="remarks"><strong>Remarks: </strong></label>
                                <textarea class="form-control" id="user_remarks35" name="user_remarks35" rows="3"></textarea>
                            </div>
                        ...
                        <div class="col-6 text-right">
                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
                            <c:if test="${report.loss_of_identity_item != 1}">
                                <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="loss_of_identity_item">Submit for Approval</button>
                            </c:if>
                            <c:if test="${report.loss_of_identity_item == 1}">
                                <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
                            </c:if>
        ...
        <div class="modal fade" id="summary_of_report_last_five_year" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">

            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button class="btn btn-sm" onclick="openModal('#land')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>
                    ...
                    INSPECTION REPORT EXTRACTS</h5>
                        ...
                        <button class="btn btn-sm" id="next" onclick="openModal('#recruit_training_b_appendix')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                        </button>
                                ...
                                <div class="watermarked" data-watermark="" id="divwatermark">
                                        ...
                                        <div class="col-md-6">
                                            <div class="row form-group">
                                                <div class="col col-md-5">
                                                    <label for="text-input" class=" form-control-label"><strong style="color: red;">*</strong> Upload Annexure:</label>
                                                </div>
                                                <div class="col-12 col-md-3">
                                                    <input type="file" id="uploadAnnexure" maxlength="250" name="uploadAnnexure" class="form-control" title="Annexure Upload ">

                                                </div>
                                                <c:if test="${report.summary_of_report_last_five_year_item != 1}">
                                                    <div class="col-12 col-md-4">
                                                        <input type="submit" class="btn btn-primary btn-sm" value="Upload" id="btnSubmit">
                                                    </div>
                                                </c:if>
                                            </div>

                                            <div class="col col-md-5">
                                                <label for="text-input" class=" form-control-label">Download Document</label>
                                            </div>
                                            <iframe id="genrFormateIframe" src="<c:url value='/admin/getPdfForInspReport' />" style="display: none;"></iframe>

                                            <button type="button" class="btn btn-primary btn-sm" id="printFormate">
                                                <i class="fa fa-download" id="icon_download"></i> Download PDF
                                            </button>
                                        </div>
                                    ...
                                    <div class="modal-footer">
                                        <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                <label for="remarks"><strong>Remarks: </strong></label>
                                                <textarea class="form-control" id="user_remarks36" name="user_remarks36" rows="3"></textarea>
                                            </div>
                                        ...
                                        <div class="col-6 text-right">
                                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
                                           <%--  <c:if test="${report.summary_of_report_last_five_year_item != 1}">
                                                <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="summary_of_report_last_five_year_item">
        ...
        <div class="modal fade" id="recruit_training_b_appendix" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">

            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button class="btn btn-sm" onclick="openModal('#summary_of_report_last_five_year')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>

                        <h5 class="modal-title" id="exampleModalLabel">Details of Recruit Training (Category B Establishments only).To be submitted as a separate Appendix</h5>

                        <button class="btn btn-sm" id="next" onclick="openModal('#deffi_exp_resp_to_trainng')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                        </button>
                    ...
                    <form method="POST" enctype="multipart/form-data" id="fileUploadFormcatB">
                        <div class="modal-body">
                            <div class="col-md-12" id="getSearch_Letter" style="display: block;">
                                <div class="watermarked" data-watermark="" id="divwatermark">
                                    <span id="ip"></span>
                                    <div class="col-md-12">
                                        <div class="col-md-6">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-3">
                                                    <input type="file" id="uploadAnnexure1" maxlength="250" name="uploadAnnexure1" class="form-control" title="Annexure Upload ">

                                                </div>
                                                <c:if test="${report.recruit_training_b_appendix_item != 1}">
                                                    <div class="col-12 col-md-4">
                                                        <input type="submit" class="btn btn-primary btn-sm" value="Upload" id="btnSubmitcatB">
                                                    </div>
                                                </c:if>
                                            </div>
                                            ...
                                            <iframe id="genrFormateIframe1" src="<c:url value='/admin/getPdfForInspReport' />" style="display: none;"></iframe>

                                            <button type="button" class="btn btn-primary btn-sm" id="printFormate1">
                                                <i class="fa fa-download" id="icon_download"></i> Download PDF
                                            </button>
                                        </div>
                                    ...
                                    <div class="modal-footer">
                                        <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                <label for="remarks"><strong>Remarks: </strong></label>
                                                <textarea class="form-control" id="user_remarks37" name="user_remarks37" rows="3"></textarea>
                                            </div>
                                        ...
                                        <div class="col-6 text-right">
                                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
                                           <%--  <c:if test="${report.recruit_training_b_appendix_item != 1}">
                                                <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="recruit_training_b_appendix_item">
                                                    Submit for Approval</button>
                                            </c:if> --%>
                                            <c:if test="${report.recruit_training_b_appendix_item == 1}">
                                                <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
        ...
        <div class="modal fade" id="deffi_exp_resp_to_trainng" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">

            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button class="btn btn-sm" onclick="openModal('#recruit_training_b_appendix')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>

                        <h5 class="modal-title" id="exampleModalLabel">Difficulties Experienced with respect to Conduct of Training and Administration

</h5>
                        <button class="btn btn-sm" id="next" onclick="openModal('#emp_of_unit_during_period')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                        </button>
                    ...
                    <form method="POST" enctype="multipart/form-data" id="deffi_exp_resp_to_trainngId">
                        <div class="modal-body">
                            <div class="col-md-12" id="getSearch_Letter" style="display: block;">
                                <div class="watermarked" data-watermark="" id="divwatermark">
                                    <span id="ip"></span>
                                    <div class="col-md-12">
                                        <div class="col-md-6">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-3">
                                                    <input type="file" id="uploadAnnexure2" maxlength="250" name="uploadAnnexure2" class="form-control" title="Annexure Upload ">

                                                </div>
                                                <c:if test="${report.deffi_exp_resp_to_trainng_item != 1}">
                                                    <div class="col-12 col-md-4">
                                                        <input type="submit" class="btn btn-primary btn-sm" value="Upload" id="deffi_exp_resp_to_trainngSubmit">
                                                    </div>
                                                </c:if>
                                            </div>
                                            ...
                                            <iframe id="genrFormateIframe2" src="<c:url value='/admin/getPdfForInspReport' />" style="display: none;"></iframe>

                                            <button type="button" class="btn btn-primary btn-sm" id="printFormate2">
                                                <i class="fa fa-download" id="icon_download"></i> Download PDF
                                            </button>
                                        </div>
                                    ...
                                    <div class="modal-footer">
                                        <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                <label for="remarks"><strong>Remarks: </strong></label>
                                                <textarea class="form-control" id="user_remarks38" name="user_remarks38" rows="3"></textarea>
                                            </div>
                                        ...
                                        <div class="col-6 text-right">
                                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
                                        <%--     <c:if test="${report.deffi_exp_resp_to_trainng_item != 1}">
                                                <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="deffi_exp_resp_to_trainng_item">
                                                    Submit for Approval</button>
                                            </c:if> --%>
                                            <c:if test="${report.deffi_exp_resp_to_trainng_item == 1}">
                                                <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
        ...
        <div class="modal fade" id="emp_of_unit_during_period" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">

            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button class="btn btn-sm" onclick="openModal('#deffi_exp_resp_to_trainng')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>

                        <h5 class="modal-title" id="exampleModalLabel">Employment of Unit during the Period Covered by the Report
                    ...
                    <form method="POST" enctype="multipart/form-data" id="emp_of_unit_during_periodId">
                        <div class="modal-body">
                            <div class="col-md-12" id="getSearch_Letter" style="display: block;">
                                <div class="watermarked" data-watermark="" id="divwatermark">
                                    <span id="ip"></span>
                                    <div class="col-md-12">
                                        <div class="col-md-6">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-3">
                                                    <input type="file" id="uploadAnnexure3" maxlength="250" name="uploadAnnexure3" class="form-control" title="Annexure Upload ">

                                                </div>
                                                <c:if test="${report.emp_of_unit_during_period_item != 1}">
                                                    <div class="col-12 col-md-4">
                                                        <input type="submit" class="btn btn-primary btn-sm" value="Upload" id="emp_of_unit_during_periodSubmit">
                                                    </div>
                                                </c:if>
                                            </div>
                                            ...
                                            <iframe id="genrFormateIframe3" src="<c:url value='/admin/getPdfForInspReport' />" style="display: none;"></iframe>

                                            <button type="button" class="btn btn-primary btn-sm" id="printFormate3">
                                                <i class="fa fa-download" id="icon_download"></i> Download PDF
                                            </button>
                                        </div>
                                    ...
                                    <div class="modal-footer">
                                        <div class="col-6">
                                            ...
                                            <div class="form-group">
                                                <label for="remarks"><strong>Remarks: </strong></label>
                                                <textarea class="form-control" id="user_remarks39" name="user_remarks39" rows="3"></textarea>
                                            </div>
                                        ...
                                        <div class="col-6 text-right">
                                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
                                           <%--  <c:if test="${report.emp_of_unit_during_period_item != 1}">
                                                <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="emp_of_unit_during_period_item">
                                                    Submit for Approval</button>
                                            </c:if> --%>
                                            <c:if test="${report.emp_of_unit_during_period_item == 1}">
                                                <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
        ...
        <div class="modal fade" id="land" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">

            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">

                        <button class="btn btn-sm" onclick="openModal('#Loss_of_Identity')" id="previous">
                            <span aria-hidden="true" class="fa fa-arrow-left"></span> Previous
                        </button>
                        <h5 class="modal-title" id="exampleModalLabel">Land</h5>
                        <button class="btn btn-sm" id="next" onclick="openModal('#summary_of_report_last_five_year')">
                            Next <span aria-hidden="true" class="fa fa-arrow-right"></span>
                        </button>
                        ...
                        <div class="modal-body">
                            <div class="col-md-12" id="getSearch_Letter" style="display: block;">
                                <div class="watermarked" data-watermark="" id="divwatermark">
                                    ...
                                    <div class="form-group row">
                                        <label for="defenceLandParticulars" class="col-md-8 col-form-label">
                                            (a) Particulars of Defence Land (category wise such as A1, A2 etc.) allotted & Survey Number:
                                        </label>
                                        <div class="col-md-1">
                                            <input type="text" id="defenceLandParticulars" name="defenceLandParticulars" class="form-control form-control-sm">
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="landRecordRegisterMaintained" class="col-md-8 col-form-label">
                                            (b) Is a Land Record Register being maintained by the unit:
                                        </label>
                                        <div class="col-md-1">
                                            <input type="text" id="landRecordRegisterMaintained" name="landRecordRegisterMaintained" class="form-control form-control-sm">
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="landDemarcated" class="col-md-8 col-form-label">
                                            (c) Has the land been demarcated:
                                        </label>
                                        <div class="col-md-1">
                                            <input type="text" id="landDemarcated" name="landDemarcated" class="form-control form-control-sm">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-1">
                                            <input type="text" id="landUtilized" name="landUtilized" class="form-control form-control-sm">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-1">
                                            <input type="text" id="vacantLandDetails" name="vacantLandDetails" class="form-control form-control-sm">
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="safetyMeasuresAdequate" class="col-md-8 col-form-label">
                                        ...
                                        <div class="col-md-1">
                                            <input type="text" id="safetyMeasuresAdequate" name="safetyMeasuresAdequate" class="form-control form-control-sm">
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="evictionActionDetails" class="col-md-8 col-form-label">
                                            (g) Action taken to evict encroachment, if any:
                                        </label>
                                        <div class="col-md-1">
                                            <input type="text" id="evictionActionDetails" name="evictionActionDetails" class="form-control form-control-sm">
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="remarksSuggestions" class="col-md-8 col-form-label">
                                            (h) Remarks / Suggestions:
                                        </label>
                                        <div class="col-md-1">
                                            <input type="text" id="remarksSuggestions" name="remarksSuggestions" class="form-control form-control-sm">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <div class="col-6 text-right">
                                ...
                                <c:if test="${report.land_item != 1}">
                                    <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="land_item">
                                        Submit for Approval</button>
                                </c:if>
                                <c:if test="${report.land_item == 1}">
                                    <label class=" form-control-label"><strong style="color: red;">Data Approved </strong> </label>
        ...
        <c:url value="Download_AnualReport_extracts" var="dwonloadUrl" />
        <form:form action="${dwonloadUrl}" method="post" id="downloadForm1" name="downloadForm1" modelAttribute="downloadid">
        ...
        <script type="text/javascript">
                    ...
                    for (let i = 0; i < j.length; i++) {
                        ...
                        if (Array.isArray(row) && row.length >= 5) {  // Changed to >= 16, as you'll need at least 16 elements for binding all the rows
                            var data = '<tr style="font-size: 12px; padding: 10px; text-align:center;">' +
                                ...
                                '<td>' + row[2] + '</td>' +
                                '<td>' + row[3] + ' / ' + row[4] + '</td>' +
                                '<td><input type="text" name="an_condtion" id="an_condtion" class="form-control form-control-sm value="" value="' + (row[5] || '') + '"></td>' +
                                '<td><input type="text" name="an_tretment" id="an_tretment" class="form-control form-control-sm value="" value="' + (row[6] || '') + '"></td>' +
                                '<td><input type="text" name="an_grooming" id="an_grooming" class="form-control form-control-sm value="" value="' + (row[7] || '') + '"></td>' +
                                '<td><input type="text" name="an_feeding" id="an_feeding" class="form-control form-control-sm value="" value="' + (row[8] || '') + '"></td>' +
                                '<td><input type="text" name="an_watering" id="an_watering" class="form-control form-control-sm value="" value="' + (row[9] || '') + '"></td>' +
                                '<td><input type="text" name="an_clipping" id="an_clipping" class="form-control form-control-sm value="" value="' + (row[10] || '') + '"></td>' +
                                '<td><input type="text" name="an_feet" id="an_feet" class="form-control form-control-sm value="" value="' + (row[11] || '') + '"></td>' +
                                '<td><input type="text" name="an_saddlery" id="an_saddlery" class="form-control form-control-sm value="" value="' + (row[12] || '') + '"></td>' +
                                '<td><input type="text" name="an_line_gear" id="an_line_gear" class="form-control form-control-sm value="" value="' + (row[13] || '') + '"></td>' +
                                '<td><input type="text" name="an_accomodation" id="an_accomodation" class="form-control form-control-sm value="" value="' + (row[14] || '') + '"></td>' +
                                '<td><input type="text" name="an_remarks" id="an_remarks" class="form-control form-control-sm value="" value="' + (row[15] || '') + '"></td>' +
                                '</tr>';
            ...
            function set_data5(j) {
            	...
            	function set_data8(j) {
            	    ...
            	    for (var i = 0; i < j.length; i++) {
            	        ...
            	        data = data +
            	            ...
            	            '<td>' + row.defi + '</td>' +
            	            '<td></td>' +
            	            '<td><input type="text" name="reason_offrd" id="reason_offrd" class="form-control form-control-sm" value="' + (row.reason_offrd || '') + '"></td>' +
            	            '<td><input type="text" name="remarks" id="remarks" class="form-control form-control-sm" value="' + (row.remarks || '') + '"></td>' +
            	            '</tr>';
            	    }
            	...
            	function set_data9(j) {
            	    var tbody = document.getElementById('Regt_funds_tbody');
            	    var data = '';
            	    tbody.innerHTML = '';
            	    ...
            	    for (var i = 0; i < j.length; i++) {
            	        ...
            	        data = data +
            	            ...
            	            '<td>' + row.defi + '</td>' + 
            	            '<td></td>' + 
            	            '<td><input type="text" name="reason_offrd" id="reason_offrd" class="form-control form-control-sm value=""></td>' +
            	            '<td><input type="text" name="remarks" id="remarks" class="form-control form-control-sm value=""></td>' + 
            	            '</tr>';
            	    }
            ...
            // 			}
            	...
            	function set_dataEdu(j) {
            	  ...
            	  $("#btnSubmit").click(function(event) {
            		  ...
            		  success : function(data) {
            		  alert(data);
            		  foruploadpdf("summary_of_report_last_five_year_item");
            		  }
            		  });
            		  });
            		  ...
            		  success : function(data) {
            		  alert(data);
            		  foruploadpdf("recruit_training_b_appendix_item");
            		  }
            		  });
            		  });
            		  ...
            		  success : function(data) {
            		  alert(data);
            		  foruploadpdf("deffi_exp_resp_to_trainng_item");
            		  }
            		  });
            		  });
            		  ...
            		  success : function(data) {
            		  alert(data);
            		  foruploadpdf("emp_of_unit_during_period_item");
            		  }
            		  });
            		  });
            	...
            	function set_data_ffrs() {
            	    ...
            	    $.post("ffrs_url?" + key + "=" + value, {}, function(j) {
            	        ...
            	        for (var i = 0; i < j.length; i++) {	
            	            var date = ParseDateColumn(j[i].whenusedffrs);
            	            data += 
            	                '<tr style="font-size: 12px; padding: 10px; text-align:center;">' +
            	                ...
            	                '<td><input type="date" name="whenusedffrs' + (i + 1) + '" id="whenusedffrs' + (i + 1) + '" maxlength="10" onclick="clickclear(this, \'DD/MM/YYYY\')" class="form-control" style="width: 90%; display: inline;" ' +
            	                'onfocus="this.style.color=\'#000000\'" onblur="clickrecall(this,\'DD/MM/YYYY\');" onkeyup="clickclear(this, \'DD/MM/YYYY\')" ' +
            	                'onchange="clickrecall(this,\'DD/MM/YYYY\');" aria-required="true" autocomplete="off" style="color: rgb(0, 0, 0);" max="${today}" value="' + date + '"></td>' +
            	        ...
            	        var newRow = 
            	            ...
            	            '<td><input type="date" name="whenusedffrs' + newIndex + '" id="whenusedffrs' + newIndex + '" maxlength="10" onclick="clickclear(this, \'DD/MM/YYYY\')" class="form-control" style="width: 90%; display: inline;" ' +
            	            'onfocus="this.style.color=\'#000000\'" onblur="clickrecall(this,\'DD/MM/YYYY\');" onkeyup="clickclear(this, \'DD/MM/YYYY\')" ' +
            	            'onchange="clickrecall(this,\'DD/MM/YYYY\');" aria-required="true" autocomplete="off" style="color: rgb(0, 0, 0);" max="${today}"></td>' +
            	...
            	/* updatecode */
            	  ...
            	  $(document).on("click", ".add-to-recommended", function () {
            		    ...
            		    if(buttonContext === "personalTrainedCourses"){
            		    	...
            		    	var periodFrom = $row.find("input[name='periodFrom']").val();
            		    	var periodTo = $row.find("input[name='periodTo']").val();
            		            ...
            		            if (response.success) {
            		                ...
            		                if (data && data.length > 0) {		                   
            		                    ...
            		                    $.each(data, function (index, item) {
            		                        ...
            		                        var deleteButtonHtml = '${report.up_gradation_item}' != 1 ?"<td> <button type='button' class='fa fa-trash btn btn-danger btn-sm delete-from-recommended' data-context='upGradationDelete' data-id='" + item.id + "'></button></td>"
                                          :"";
            		                        var rowHtml = "<tr class='fade-in'>" +
            		                            ...
            		                            "<td>" + item.total_available_class_i + "</td>" + deleteButtonHtml +
            		                            "</tr>";
            		                        ...
            		                        $.each(data, function (index, item) {
            		                        	 ...
            		                        	 var deleteButtonHtml = '${report.category_item}' != 1 ? "<td> <button type='button' class='fa fa-trash btn btn-danger btn-sm delete-from-recommended' data-context='personalTrainedCoursesDelete'  data-id='" + item.id + "'></button></td>"
            		                        			 :"";
            		                        	  ...
            		                        	  var rowHtml = "<tr class='fade-in'>" +
            			                            ...
            			                            "<td>" + item.totalor + "</td>" + deleteButtonHtml +
            			                            "</tr>";
            			                        $firstRow.before(rowHtml);
            			                    });
            		                    }/* end personalTrainedCourses */
            		                        ...
            		                        $.each(data, function (index, item) {
            		                        	 ...
            		                        	 var deleteButtonHtml ='${report.deficiencies_of_equipment2_item}' != 1 ? "<td> <button type='button' class='fa fa-trash btn btn-danger btn-sm delete-from-recommended' data-context='defOfEqupMaintenanceDelete'  data-id='" + item.id + "'></button></td>":"";
            		                    	...
            		                    	$.each(data, function (index, item) {
            		                   		 var deleteButtonHtml ='${report.financial_grants_item}' != 1 ? "<td> <button type='button' class='fa fa-trash btn btn-danger btn-sm delete-from-recommended' data-context='financialGrantsDelete'  data-id='" + item.id + "'></button></td>":"";
            		                   		  var rowHtml = "<tr class='fade-in'>" +
            		                   			"<td>" + (index + 1) + "</td>" +
            		                    	...
            		                    	$.each(data, function (index, item) {
            		                   		 var deleteButtonHtml ='${report.availability_of_ranges_item}' != 1 ? "<td> <button type='button' class='fa fa-trash btn btn-danger btn-sm delete-from-recommended' data-context='classSaveDelete'  data-id='" + item.id + "'></button></td>"
            		                   				 :"";
            		                   		  var rowHtml = "<tr class='fade-in'>" +
            		                   			"<td>" + (index + 1) + "</td>" +
            		                   			"<td>" + item.number_of_ranges + "</td>" +
            		                   			"<td>" + item.when_used + "</td>" +
            		                   			"<td>" + item.difficulties_experienced + "</td>" + deleteButtonHtml +
            		                   			"</tr>";
            		                   		$firstRow.before(rowHtml);
            		                   	});
            		                   }
            		                    	...
            		                    	$.each(data, function (index, item) {
            		                   		 var deleteButtonHtml = '${report.availability_of_ranges_item}' != 1 ? "<td> <button type='button' class='fa fa-trash btn btn-danger btn-sm delete-from-recommended' data-context='ffrsSaveDelete'  data-id='" + item.id + "'></button></td>"
            		                   				 :"";
            		                   		  var rowHtml = "<tr class='fade-in'>" +
            		                   			"<td>" + (index + 1) + "</td>" +
            		                    	...
            		                    	$.each(data, function (index, item) {	           
            			                   		 ...
            			                   		 var deleteButtonHtml = '${report.equipment_item}' != 1 ? "<td> <button type='button' class='fa fa-trash btn btn-danger btn-sm delete-from-recommended' data-context='equipmentTbleDelete'  data-id='" + item.id + "'></button></td>":"";
            			                   		  var rowHtml = "<tr class='fade-in'>" +
            			                   			"<td>" + (index + 1) + "</td>" +
            			                   			"<td>" + item.type_of_duty + "</td>" +
            			                   			"<td>" + item.equp_authorize + "</td>" +
            			                   			"<td>" + item.equp_cove + "</td>" +
            			                   			"<td>" + item.equp_remark + "</td>" + deleteButtonHtml +
            			                   			"</tr>";
            			                   		$firstRow.before(rowHtml);
            			                   	});
            			                   }else if (tblname=="trainingAmmunitionTble" || tblname=="trainingAmmunitionTbleDelete"){
            			                    	$.each(data, function (index, item) {	           
            				                   		 ...
            				                   		 var deleteButtonHtml ='${report.training_ammunition_item}' != 1 ?  "<td> <button type='button' class='fa fa-trash btn btn-danger btn-sm delete-from-recommended' data-context='trainingAmmunitionTbleDelete'  data-id='" + item.id + "'></button></td>"
            				                   				 :"";
            				                   		  var rowHtml = "<tr class='fade-in'>" +
            				                   			"<td>" + (index + 1) + "</td>" +
            				                   			...
            				                   			"<td>" + item.expended + "</td>" +
            				                   			"<td>" + item.balance + "</td>" +				                   			
            				                   			"<td>" + item.reason + "</td>" + deleteButtonHtml +
            				                   			"</tr>";
            				                   		$firstRow.before(rowHtml);
            				                   	});
            				                   } else if (tblname == "summaryTble" || tblname == "summaryTbleDelete") {			                      
            				                        ...
            				                        $.each(data, function (index, item) {
            				                            var deleteButtonHtml = '${report.summarybtn}' != 1 ?  "<td> <button type='button' class='fa fa-trash btn btn-danger btn-sm delete-from-recommended' data-context='summaryTbleDelete'  data-id='" + item.id + "'></button></td>"
            				                            		: "";
            				                            var rowHtml = "<tr class='fade-in'>" +
            				                                "<td>" + (index + 6) + "</td>" +  
            					                    	...
            					                    	$.each(data, function (index, item) {	           
            						                   		 ...
            						                   		 var deleteButtonHtml = '${report.outstanding_item}' != 1 ?  "<td> <button type='button' class='fa fa-trash btn btn-danger btn-sm delete-from-recommended' data-context='OutstandingTbleDelete'  data-id='" + item.id + "'></button></td>"
            						                   				 :"";
            						                   		  var rowHtml = "<tr class='fade-in'>" +
            						                   			"<td>" + (index + 1) + "</td>" +
            					                    	...
            					                    	$.each(data, function (index, item) {	           
            						                   		 ...
            						                   		 var deleteButtonHtml ='${report.mt_accidents_item}' != 1 ?  "<td> <button type='button' class='fa fa-trash btn btn-danger btn-sm delete-from-recommended' data-context='OutstandingMTTbleDelete'  data-id='" + item.id + "'></button></td>"
            						                   				 :"";
            						                   		  var rowHtml = "<tr class='fade-in'>" +
            						                   			"<td>" + (index + 1) + "</td>" +
            						                   			"<td>" + item.outstanding_year + "</td>" +
            					                    	...
            					                    	$.each(data, function (index, item) {	           
            						                   		 ...
            						                   		 var deleteButtonHtml = '${report.details_of_suicides_item}' != 1 ? "<td> <button type='button' class='fa fa-trash btn btn-danger btn-sm delete-from-recommended' data-context='fatalIncidentsTbleDelete'  data-id='" + item.id + "'></button></td>":"";
            						                   		  var rowHtml = "<tr class='fade-in'>" +
            						                   			"<td>" + (index + 1) + "</td>" +
            						                   			"<td>" + item.date + "</td>" +
            						                    	...
            						                    	$.each(data, function (index, item) {	           
            							                   		 ...
            							                   		 var deleteButtonHtml = '${report.security_lapses_item}' != 1 ? "<td> <button type='button' class='fa fa-trash btn btn-danger btn-sm delete-from-recommended' data-context='securityLapsesTbleDelete'  data-id='" + item.id + "'></button></td>":"";
            							                   		  var rowHtml = "<tr class='fade-in'>" +
            							                   			"<td>" + (index + 1) + "</td>" +
            							                   			"<td>" + item.date + "</td>" +
            					                    	...
            					                    	$.each(data, function (index, item) {	           
            						                   		 ...
            						                   		 var deleteButtonHtml ='${report.details_of_attachments_item}' != 1 ?  "<td> <button type='button' class='fa fa-trash btn btn-danger btn-sm delete-from-recommended' data-context='outsideAttachmentsTbleDelete'  data-id='" + item.id + "'></button></td>":"";
            						                   		  var rowHtml = "<tr class='fade-in'>" +
            						                   			"<td>" + (index + 1) + "</td>" +
            						                   			"<td>" + item.location + "</td>" +
            						            		...
            						            		$.each(data, function (index, item) {	           
            						            			 ...
            						            			 var deleteButtonHtml = '${report.courses_item}' != 1 ? "<td> <button type='button' class='fa fa-trash btn btn-danger btn-sm delete-from-recommended' data-context='coursesUndertakenDelete'  data-id='" + item.id + "'></button></td>":"";
            						            			  var rowHtml = "<tr class='fade-in'>" +
            						            				"<td>" + (index + 1) + "</td>" +
            						            				"<td>" + item.course_name + "</td>" +
            						            				...
            						            				"<td>" + item.attended + "</td>" + 
            						            				"<td>" + item.rtu + "</td>" + 
            						            				"<td>" + item.detailed_remarks + "</td>" + deleteButtonHtml +
            						            				"</tr>";
            						            			$firstRow.before(rowHtml);
            						            		});
            						            	}else if (tblname=="otherCourses" || tblname=="otherCoursesDelete"){
            						            		$.each(data, function (index, item) {	           
            						            			 ...
            						            			 var deleteButtonHtml = '${report.courses_item}' != 1 ? "<td> <button type='button' class='fa fa-trash btn btn-danger btn-sm delete-from-recommended' data-context='otherCoursesDelete'  data-id='" + item.id + "'></button></td>":"";
            						            			  var rowHtml = "<tr class='fade-in'>" +
            						            				"<td>" + (index + 1) + "</td>" +
            						            				"<td>" + item.course_name + "</td>" +
            						            				"<td>" + item.total + "</td>" +
            						            		...
            						            		$.each(data, function (index, item) {
            						            			 var deleteButtonHtml ='${report.details_of_officers_item}' != 1 ?  "<td> <button type='button' class='fa fa-trash btn btn-danger btn-sm delete-from-recommended' data-context='tdOfficersDelete'  data-id='" + item.id + "'></button></td>":"";
            						            			  var rowHtml = "<tr class='fade-in'>" +
            						            				"<td>" + (index + 1) + "</td>" +
            						            		...
            						            		$.each(data, function (index, item) {
            						            			 var deleteButtonHtml ='${report.social_media_violation_item}' != 1 ?  "<td> <button type='button' class='fa fa-trash btn btn-danger btn-sm delete-from-recommended' data-context='socialMediaLapsesDelete'  data-id='" + item.id + "'></button></td>":"";
            						            			  var rowHtml = "<tr class='fade-in'>" +
            						            				"<td>" + (index + 1) + "</td>" +
            						            		...
            						            		$.each(data, function (index, item) {
            						            			 var deleteButtonHtml ='${report.web_messenger_apps_item}' != 1 ?  "<td> <button type='button' class='fa fa-trash btn btn-danger btn-sm delete-from-recommended' data-context='pioCallsLapsesDelete'  data-id='" + item.id + "'></button></td>":"";
            						            				var rowHtml = "<tr class='fade-in'>" +
            						            				"<td>" + (index + 1) + "</td>" +
            						            				"<td>" + item.date_violation_initial + "</td>" +
            						            				"<td>" + item.date_violation_fmn + "</td>" +
            						            		...
            						            		$.each(data, function (index, item) {
            						            			 var deleteButtonHtml = '${report.espionage_item}' != 1 ? "<td> <button type='button' class='fa fa-trash btn btn-danger btn-sm delete-from-recommended' data-context='espionageLapsesDelete'  data-id='" + item.id + "'></button></td>":"";
            						            				var rowHtml = "<tr class='fade-in'>" +
            						            				"<td>" + (index + 1) + "</td>" +
            						            				"<td>" + item.date_violation_initial + "</td>" +
            						            				"<td>" + item.date_violation_fmn + "</td>" +
            						            		...
            						            		$.each(data, function (index, item) {
            						            			 var deleteButtonHtml = '${report.compromise_of_cell_phone_item}' != 1 ? "<td> <button type='button' class='fa fa-trash btn btn-danger btn-sm delete-from-recommended' data-context='cellPhoneCompromiseLapsesDelete'  data-id='" + item.id + "'></button></td>":"";
            						            				var rowHtml = "<tr class='fade-in'>" +
            						            				"<td>" + (index + 1) + "</td>" +
            						            				"<td>" + item.date_violation_initial + "</td>" +
            						            				"<td>" + item.date_violation_fmn + "</td>" +
            					                    	...
            					                    	$.each(data, function (index, item) {	           
            						                   		 ...
            						                   		 var deleteButtonHtml = '${report.untraceable_item}' != 1 ? "<td> <button type='button' class='fa fa-trash btn btn-danger btn-sm delete-from-recommended' data-context='UntraceableTbleDelete'  data-id='" + item.id + "'></button></td>":"";
            						                   		  var rowHtml = "<tr class='fade-in'>" +
            						                   			"<td>" + (index + 1) + "</td>" +
            					                    	...
            					                    	$.each(data, function (index, item) {	           
            						                   		 ...
            						                   		 var deleteButtonHtml = '${report.loss_of_cd_item}' != 1 ? "<td> <button type='button' class='fa fa-trash btn btn-danger btn-sm delete-from-recommended' data-context='lossCdDvdTbleDelete'  data-id='" + item.id + "'></button></td>":"";
            						                   		  var rowHtml = "<tr class='fade-in'>" +
            						                   			"<td>" + (index + 1) + "</td>" +
            					                    	...
            					                    	$.each(data, function (index, item) {	           
            						                   		 ...
            						                   		 var deleteButtonHtml = '${report.loss_of_identity_item}' != 1 ? "<td> <button type='button' class='fa fa-trash btn btn-danger btn-sm delete-from-recommended' data-context='lostIdEcrTbleDelete'  data-id='" + item.id + "'></button></td>":"";
            						                   		  var rowHtml = "<tr class='fade-in'>" +
            						                   			"<td>" + (index + 1) + "</td>" +
            					                    	...
            					                    	$.each(data, function (index, item) {
            						                   		 var deleteButtonHtml ='${report.regt_funds_item}' != 1 ?  "<td> <button type='button' class='fa fa-trash btn btn-danger btn-sm delete-from-recommended' data-context='regtFundsDelete'  data-id='" + item.id + "'></button></td>":"";
            						                   		  var rowHtml = "<tr class='fade-in'>" +
            						                   			"<td>" + (index + 1) + "</td>" +
            						                   			...
            						                   			"<td>" + item.incr_decr_acct + "</td>" + deleteButtonHtml +
            						                   			"</tr>";
            						                   		$firstRow.before(rowHtml);
            						                   	});
            						                   }
                ...
                var $button = $(this);
                var buttonContext = $button.data("context");
                console.log("here In Save Method buttonContext---> " + buttonContext);
                ...
                if (buttonContext === "establishment_item") {      
                    $("#EstablishmentForm").serializeArray().forEach(function(item) {
                      ...
                      debugger;
                        ...
                        formData.append("regular_officers_auth", $('#regular_officers_auth').text().trim());
                        formData.append("regular_officers_posted", $('#regular_officers_posted').text().trim());
                        formData.append("regular_officers_medical", $('#regular_officers_medical').val().trim()); 
                        
                        formData.append("regular_jcos_auth", $('#regular_jcos_auth').text().trim());
                        formData.append("regular_jcos_posted", $('#regular_jcos_posted').text().trim());
                        formData.append("regular_jcos_medical", $('#regular_jcos_medical').val().trim());
                 
                 
                        formData.append("regular_or_auth", $('#regular_or_auth').text().trim());
                        formData.append("regular_or_posted", $('#regular_or_posted').text().trim());
                        formData.append("regular_or_medical", $('#regular_or_medical').val().trim());
                        formData.append("regular_civilians_auth", $('#regular_civilians_auth').text().trim());
                        formData.append("regular_civilians_posted", $('#regular_civilians_posted').text().trim());
                        formData.append("regular_civilians_medical", $('#regular_civilians_medical').val().trim());
                        formData.append("regular_warrant_auth", $('#regular_warrant_auth').text().trim());
                        formData.append("regular_warrant_posted", $('#regular_warrant_posted').text().trim());
                        formData.append("regular_warrant_medical", $('#regular_warrant_medical').val().trim());
                    ...
                    console.log("user remarka " + user_remarks)
            ...
            var unit_no="";
            		...
            		function foruploadpdf(buttonContext) { 
            		      var formData = new FormData();

            		      formData.append("buttonContext", buttonContext);

            		      if (buttonContext === "summary_of_report_last_five_year_item") {
        ...
        <Script>
            ...
            // 	if(a==3)
            // 	{
            // 	 document.getElementById('Para3Form').submit();
            // 	}
