					...
					<div class="row form-group mb">
						<ul class="nav nav-tabs" id="myTab" role="tablist">
							<li class="nav-item" role="presentation">
								<button class="nav-link active" id="part3" data-bs-toggle="tab"
									data-bs-target="#part3_div" type="button" role="tab"
									aria-controls="profile" aria-selected="false"><b>Part III
									(B)</b></button>
							</li>
						</ul>
					</div>
				...
				<div class="modal-content">
					...
					<div class="modal-footer">
						<div class="col-6 text-end">
							...
							<c:if test="${report.Overall_Str_and_Challenges_items != 1}">
								<button type="button"class="btn btn-primary btn-sm add-to-submit_approve"
									data-context="overall_str_and_challenges_items">Submit for Approval</button>
							</c:if>
						</div>
					</div>
				</div>
