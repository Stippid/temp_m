    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
        ...
        <div class="container-fluid">
            <div class="card">
                            ...
                            <div class="row form-group mb">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="part4" data-bs-toggle="tab" data-bs-target="#part4_div" type="button" role="tab" aria-controls="profile" aria-selected="false">Part IV
                                        </button>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="modal fade" id="fitness_for_war_or_designated_role_1" tabindex="-1" role="dialog" aria-labelledby="unitFitnessModalLabel" aria-hidden="true">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <label><strong>1. Strengths/Challenges for
												the Unit/Formation HQ/Establishment</strong></label>
                                                <div class="mt-2">
                                                    <label for="strengths_training">(a) Training and operational preparation for the assigned role/task:</label>
                                                    <textarea class="form-control" id="strengths_training" name="strengths_training" rows="4"></textarea>
                                                </div>
                                                <div class="mt-3">
                                                    <label for="challenges_equipment">(b) Equipment profile as necessitated to undertake the assigned role/task:</label>
                                                    <textarea class="form-control" id="challenges_equipment" name="challenges_equipment" rows="4"></textarea>
                                                </div>
                                                <div class="mt-3">
                                                    <label for="admin_welfare">(c) Administration of the unit including troops welfare measures:</label>
                                                    <textarea class="form-control" id="admin_welfare" name="admin_welfare" rows="4"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="modal-footer">
                                <div class="col-6 text-end">
                                    ...
                                    <c:if test="${report.unit_fitness_items != 1}">
                                        <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="unit_fitness_items">Submit for Approval
                                        </button>
                                    </c:if>
                                </div>
                            </div>
                ...
                <div class="modal fade" id="fitness_for_war_or_designated_role_2" tabindex="-1" role="dialog" aria-labelledby="unitFitnessModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                                ...
                                                <div class="mt-2">
                                                    ...
                                                    <div class="form-check">
                                                        <label class="form-check-label" for="fit_for_war_yes">
                                                            <input class="form-check-input" type="radio" name="fit_for_war" id="fit_for_war_yes" value="Yes" required>Yes
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="form-check-label" for="fit_for_war_no">
                                                            <input class="form-check-input" type="radio" name="fit_for_war" id="fit_for_war_no" value="No">No
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="mt-3">
                                                    ...
                                                    <div class="form-check">
                                                        <label class="form-check-label" for="unfit_equipment">
                                                            <input class="form-check-input" type="radio" name="unfit_reason" id="unfit_equipment" value="Lack of Equipment">Lack of Equipment
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="form-check-label" for="unfit_training">
                                                            <input class="form-check-input" type="radio" name="unfit_reason" id="unfit_training" value="Lack of Training">Lack of Training
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="form-check-label" for="unfit_both">
                                                            <input class="form-check-input" type="radio" name="unfit_reason" id="unfit_both" value="Both">Both
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="mt-3">
                                                    <label for="fitness_recommendations">(c) Recommendations to improve fitness for war/designated role:</label>
                                                    <textarea class="form-control" id="fitness_recommendations" name="fitness_recommendations" rows="4"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="modal-footer">
                                <div class="col-6 text-end">
                                    ...
                                    <c:if test="${report.unit_data_items != 1}">
                                        <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="unit_data_items">Submit for Approval
                                        </button>
                                    </c:if>
                                </div>
                            </div>
                ...
                <div class="modal fade" id="fitness_for_war_or_designated_role_3" tabindex="-1" role="dialog" aria-labelledby="unitFitnessModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group mt-4">
                                                <label for="critical_issues"><strong>3.
												Critical Issues:</strong></label>
                                                <textarea class="form-control" id="critical_issues" name="critical_issues" rows="5" placeholder="Issues critical to the performance of the unit (to be filled if required)"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="modal-footer">
                                <div class="col-6 text-end">
                                    ...
                                    <c:if test="${report.critical_issues_items != 1}">
                                        <button type="button" class="btn btn-primary btn-sm add-to-submit_approve" data-context="critical_issues_items">Submit for Approval
                                        </button>
                                    </c:if>
                                </div>
                            </div>
