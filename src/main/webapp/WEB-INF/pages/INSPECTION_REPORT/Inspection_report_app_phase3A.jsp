					...
					<div class="col-md-4 ">
						<div class="row form-group mb">
							<ul class="nav nav-tabs" id="myTab" role="tablist">
									...
									<button class="nav-link " id="part3A" data-bs-toggle="tab"
...
<c:if test="${report.measures_core_values == 0 || report.measures_core_values == 1}">
...
<c:if test="${report.human_resource_developement == 0 || report.human_resource_developement == 1}">
...
<c:if test="${report.additional_information == 0 || report.additional_information == 1}">
...
<c:if test="${report.comments_insp_offr == 0 || report.comments_insp_offr == 1}">
    ...
    <div class="modal-footer">
        ...
        <div class="col-6 text-right">
            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
						<c:if test="${report.individual_training == 0}">
							<button type="button"
								class="btn btn-primary btn-sm add-to-submit_approve"
								onclick="validate_Individual_training();">Approve</button>
						</c:if>
            ...
            <div class="watermarked" data-watermark="" id="divwatermark">
				...
				<div class="modal-footer">
					...
					<div class="col-6 text-right">
						...
						<c:if test="${report.collective_training == 0}">
							<button type="button"
								class="btn btn-primary btn-sm add-to-submit_approve"
								onclick="validate_Collective_training();">Approve</button>
						</c:if>
...
<div class="modal fade" id="management_training" tabindex="-1" role="dialog"
  ...
  <form id="ManagementForm" method="POST">  <!-- Added ID to the form -->
    ...
    <div class="modal-footer">
        ...
        <div class="col-6 text-right">
            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
            <c:if test="${report.management_training == 0}">
							<button type="button"
								class="btn btn-primary btn-sm add-to-submit_approve"
								onclick="validate_management_training();">Approve</button>
						</c:if>
...
<div class="modal fade" id="personnel_management" tabindex="-1" role="dialog"
  ...
  <form id="personnelForm" method="POST">  <!-- Added ID to the form -->
    ...
    <div class="modal-footer">
        ...
        <div class="col-6 text-right">
            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
           <c:if test="${report.personnel_management == 0}">
							<button type="button"
								class="btn btn-primary btn-sm add-to-submit_approve"
								onclick="validate_personnel_management();">Approve</button>
						</c:if>
...
<div class="modal fade" id="interior_economy" tabindex="-1" role="dialog"
  ...
  <form id="interiorForm" method="POST">  <!-- Added ID to the form -->
    ...
    <div class="modal-footer">
        ...
        <div class="col-6 text-right">
            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
          <c:if test="${report.interior_economy == 0}">
							<button type="button"
								class="btn btn-primary btn-sm add-to-submit_approve"
								onclick="validate_interior_economy();">Approve</button>
						</c:if>
...
<div class="modal fade" id="morale_motivation" tabindex="-1" role="dialog"
  ...
  <form id="moralForm" method="POST">  <!-- Added ID to the form -->
    ...
    <div class="modal-footer">
        ...
        <div class="col-6 text-right">
            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
           <c:if test="${report.morale_motivation == 0}">
							<button type="button"
								class="btn btn-primary btn-sm add-to-submit_approve"
								onclick="validate_morale_motivation();">Approve</button>
						</c:if>
...
<div class="modal fade" id="material_management" tabindex="-1" role="dialog"
  ...
  <form id="materialForm" method="POST">  <!-- Added ID to the form -->
    ...
    <div class="modal-footer">
        ...
        <div class="col-6 text-right">
            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
           <c:if test="${report.material_management == 0}">
							<button type="button"
								class="btn btn-primary btn-sm add-to-submit_approve"
								onclick="validate_material_management();">Approve</button>
						</c:if>
...
<div class="modal fade" id="other_miscellaneous_aspects" tabindex="-1" role="dialog"
  ...
  <form id="miscellaneousForm" method="POST">  <!-- Added ID to the form -->
    ...
    <div class="modal-footer">
        ...
        <div class="col-6 text-right">
            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
            <c:if test="${report.other_miscellaneous_aspects == 0}">
							<button type="button"
								class="btn btn-primary btn-sm add-to-submit_approve"
								onclick="validate_other_miscellaneous_aspects();">Approve</button>
						</c:if>
...
<div class="modal fade" id="measures_core_values" tabindex="-1" role="dialog"
  ...
  <form id="measuresForm" method="POST">  <!-- Added ID to the form -->
    ...
    <div class="modal-footer">
        ...
        <div class="col-6 text-right">
            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
           <c:if test="${report.measures_core_values == 0}">
							<button type="button"
								class="btn btn-primary btn-sm add-to-submit_approve"
								onclick="validate_measures_taken();">Approve</button>
						</c:if>
...
<div class="modal fade" id="human_resource_developement" tabindex="-1" role="dialog"
  ...
  <form id="humanForm" method="POST">  <!-- Added ID to the form -->
    ...
    <div class="modal-footer">
        ...
        <div class="col-6 text-right">
            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
            <c:if test="${report.human_resource_developement == 0}">
							<button type="button"
								class="btn btn-primary btn-sm add-to-submit_approve"
								onclick="validate_human_resource();">Approve</button>
						</c:if>
...
<div class="modal fade" id="additional_information" tabindex="-1" role="dialog"
  ...
  <form id="additionalForm" method="POST">  <!-- Added ID to the form -->
    ...
    <div class="modal-footer">
        ...
        <div class="col-6 text-right">
            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
            <c:if test="${report.additional_information == 0}">
							<button type="button"
								class="btn btn-primary btn-sm add-to-submit_approve"
								onclick="validate_additional_information();">Approve</button>
						</c:if>
  ...
  <form id="additionalForm" method="POST">  <!-- Added ID to the form -->
    <div class="modal-body">
     ...
     <div class="modal-footer">
        ...
        <div class="col-6 text-right">
            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" onclick="closeModal()">Close</button>
           <c:if test="${report.comments_insp_offr == 0}">
							<button type="button"
								class="btn btn-primary btn-sm add-to-submit_approve"
								onclick="validate_cmt_on_partii();">Approve</button>
						</c:if>
...
function validate_Individual_training() {
	...
	$.post('Change_of_Individual_training?' + key + "=" + value, {
		...
		accCommissionTrainingRating : accCommissionTrainingRating,
		sus_no:sus_no
	},  function(data) {
		if (parseInt(data) > 0) {
			$('#ch_r_id').val(data);
...
var sus_no='${sus_no}';
	...
	$.post('Change_of_Collective_training?' + key + "=" + value, {
		...
		mobilisationRating : mobilisationRating,
		sus_no:sus_no
	},  function(data) {
		if (parseInt(data) > 0) {
			$('#ch_r_id').val(data);
...
var sus_no='${sus_no}';
	  ...
	  $.ajax({
	    ...
	    type: 'GET',
	    data: {
	      formType: formType,sus_no:sus_no
	    },
	    dataType: 'json',
