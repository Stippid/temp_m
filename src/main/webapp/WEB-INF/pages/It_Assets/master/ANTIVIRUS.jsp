...
<form:form name="Formname" id="Formid" action="ANTIVIRUSAction?${_csrf.parameterName}=${_csrf.token}" method="POST" commandName="ANTIVIRUSCMD">
<div class="container" align="center">
	<div class="card">
    <div class="card-header"> <h5>ANTIVIRUS MASTER</h5></div>
       <div class="card-body card-block cue_text">
<div class="col-md-12" id="divLine" style="display: none;"><span class="line"></span></div>
 <div class='col-md-6'>
	  <div class='row form-group'>
	      <div class='col col-md-4'>
	           <strong style="color: red;">*</strong> <label for="text-input" class="form-control-label">ANTIVIRUS NAME</label>
          </div>
          <div class='col-12 col-md-6'>
	             <form:input type="text" id="antivirus" path="antivirus"  class="form-control" autocomplete='off' maxlength="100" 
       ...
       <div class='card-footer' align='center'>
        <a href=ANTIVIRUS_Url class="btn btn-success btn-sm">Clear</a>
...
<div class="container" align="center">
<div class="col-md-12">
<table id="ANTIVIRUS_reporttbl" class="display table no-margin table-striped  table-hover  table-bordered report_print">
	<thead>
        <tr>
...
function data(tableName){
	...
	$.post("getANTIVIRUSReportDataList?"+key+"="+value,{startPage:startPage,pageLength:pageLength,Search:Search,orderColunm:orderColunm,orderType:orderType,antivirus:antivirus},function(j) {
		for (var i = 0; i < j.length; i++) {
			jsondata.push([j[i].antivirus,j[i].id]);
		}
	});
	$.post("getANTIVIRUSTotalCount?"+key+"="+value,{Search:Search,antivirus:antivirus},function(j) {
		FilteredRecords = j;
	});
}
