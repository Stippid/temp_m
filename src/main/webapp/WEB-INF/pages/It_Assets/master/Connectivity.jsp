...
<form:form name="Formname" id="Formid" action="Connectivity_Action?${_csrf.parameterName}=${_csrf.token}"
	method="POST" commandName="Connectivity_CMD">
	<div class="container" align="center">
		<div class="card">
			...
			<div class="card-footer" align="center" class="form-control">
			 <a href=CONNECTIVITY_Url class="btn btn-success btn-sm">Clear</a>
...
<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="comd1">
	...
	<input type="hidden" name="connectivity_type1" id="connectivity_type1" value="0" />
