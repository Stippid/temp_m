...
<form:form name="EditFormname" id="EditFormid"
	action="Editethernet_port_Action?${_csrf.parameterName}=${_csrf.token}" method="POST"
	commandName="Editethernet_port_CMD">
				...
				<div class='col-md-6'>
					<div class='row form-group'>
						<div class='col col-md-4'>
							<strong style="color: red;">*</strong><label for="text-input" class="form-control-label">ETHERNET PORT</label>
						</div>
...
$(document).ready(function () {
	...
	$("input#ethernet_port").val("${Editethernet_port_CMD1.ethernet_port}");
