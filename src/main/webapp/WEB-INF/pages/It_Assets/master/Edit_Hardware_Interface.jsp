...
<form:form name="EditFormname" id="EditFormid"
	action="EditHardware_interface_Action?${_csrf.parameterName}=${_csrf.token}" method="POST"
	commandName="EditHardware_interface_CMD">
				...
				<div class='col-md-8'>
					<div class='row form-group'>
						<div class='col col-md-4'>
							<strong style="color: red;">*</strong><label for="text-input" class="form-control-label">HARDWARE INTERFACE</label>
						</div>
  ...
  <div class='col-md-6'>Ex : Hardware Interfaces like HDMI, VGA, etc.
  </div></div>
...
$(document).ready(function () {
	...
	$("input#hardware_interface").val("${EditHardware_interface_CMD1.hardware_interface}");
});
