...
<form:form name="EditFormname" id="EditFormid" action="Editdply_env_mstrAction?${_csrf.parameterName}=${_csrf.token}" method="POST" commandName="Editdply_env_mstrCMD">
<div class="container" align="center">
	<div class="card">
    <div class="card-header"> <h5>UPDATE DEPLOYMENT ENVIRONMENT MASTER</h5></div>
       <div class="card-body card-block cue_text">
<div class="col-md-12" id="divLine" style="display: none;"><span class="line"></span></div>
<form:input type="hidden" id="id" path="id" value="${Editdply_env_mstrCMD1.id}" ></form:input>
 <div class='col-md-6'>
	  <div class='row form-group'>
          ...
          <div class='col-12 col-md-6'>
	             <form:input type="text" id="dply_env" path="dply_env" value="${Editdply_env_mstrCMD1.dply_env}" class="form-control" 
