...
<form:form name="EditFormname" id="EditFormid" action="Edityear_of_proc_mstrAction?${_csrf.parameterName}=${_csrf.token}" method="POST" commandName="Edityear_of_proc_mstrCMD">
