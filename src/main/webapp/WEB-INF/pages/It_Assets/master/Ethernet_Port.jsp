...
<form:form name="Formname" id="Formid" action="Ethernet_Port_Action?${_csrf.parameterName}=${_csrf.token}"
	method="POST" commandName="Ethernet_Port_CMD">
			...
			<div class="card-body card-block cue_text">
				...
				<div class='col-md-6'>
					<div class='row form-group'>
						<div class='col col-md-4'><strong style="color: red;">*</strong> 
							<label for="text-input" class="form-control-label">ETHERNET PORT
							</label>
						</div>
						<div class='col-12 col-md-6'>
							<form:input type="text" id="ethernet_port"
								path="ethernet_port" class="form-control" autocomplete='off'
								maxlength="50" oninput="this.value = this.value.toUpperCase()" onkeyup="return specialcharecterEthernet(this);" ></form:input>
						</div>
					</div>
				</div>
			</div>
...
<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="comd1">
	...
	<input type="hidden" name="ethernet_port1" id="ethernet_port1" value="0" />
</form:form> 
...
<div class="container" align="center">
	<div class="col-md-12">
		<table id="Ethernet_Port_mstr_reporttbl"
