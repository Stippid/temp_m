...
<form:form name="Formname" id="Formid" action="PeripheralMasterAction?${_csrf.parameterName}=${_csrf.token}" method="POST" commandName="PeripheralMasterCMD">
<div class="container" align="center">
	<div class="card">
    <div class="card-header"> <h5>PERIPHERAL MASTER</h5></div>
 ...
 <div class='col-md-6'>
	  <div class='row form-group'>
          ...
          <div class='col-12 col-md-6'>
	             <form:input type="text" id="peripheral_type" path="peripheral_type"  class="form-control" autocomplete='off' maxlength="50" oninput="this.value = this.value.toUpperCase()" ></form:input>
        </div>
    </div>
</div>
    </div>
...
<div class="container" align="center">
<div class="col-md-12">
<table id="PeripheralMaster_reporttbl" class="display table no-margin table-striped  table-hover  table-bordered report_print">
	<thead>
        <tr>
...
function data(tableName){
	...
	$.post("getPeripheralMasterReportDataList?"+key+"="+value,{startPage:startPage,pageLength:pageLength,Search:Search,orderColunm:orderColunm,orderType:orderType},function(j) {
		for (var i = 0; i < j.length; i++) {
			jsondata.push([j[i].peripheral_type,j[i].id]);
		}
	});
	$.post("getPeripheralMasterTotalCount?"+key+"="+value,{Search:Search},function(j) {
		FilteredRecords = j;
	});
}
