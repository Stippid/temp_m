...
<form:form name="Formname" id="Formid" action="hdd_mstrAction?${_csrf.parameterName}=${_csrf.token}" method="POST" commandName="hdd_mstrCMD">
<div class="container" align="center">
	<div class="card">
    <div class="card-header"> <h5>HDD CAPACITY MASTER</h5></div>
...
<div class="col-md-12" id="divLine" style="display: none;"><span class="line"></span></div>
 <div class='col-md-12'>
          ...
          <div class='col-md-3'>
	             <input type="text" id="hdd" name="hdd"  class="form-control" autocomplete='off' maxlength="10" 
       ...
       <div class='card-footer' align='center'>
           ...
           <a href=Hdd_mstr_Url class="btn btn-success btn-sm">Clear</a>
...
<div class="container" align="center">
<div class="col-md-12">
<table id="hdd_mstr_reporttbl" class="display table no-margin table-striped  table-hover  table-bordered report_print">
	<thead>
        <tr>
<th>HDD Capacity </th>
          <th>Action</th>
...
function data(tableName){
	...
	$.post("getHdd_mstrReportDataList?"+key+"="+value,{startPage:startPage,pageLength:pageLength,Search:Search,orderColunm:orderColunm,orderType:orderType,hdd:hdd,hdd_capacity:hdd_capacity},function(j) {
		for (var i = 0; i < j.length; i++) {
			jsondata.push([j[i].hdd,j[i].id]);
		}
	});
	$.post("getHdd_mstrTotalCount?"+key+"="+value,{Search:Search,hdd:hdd,hdd_capacity:hdd_capacity},function(j) {
		FilteredRecords = j;
	});
}
