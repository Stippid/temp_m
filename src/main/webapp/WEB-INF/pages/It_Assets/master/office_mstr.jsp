...
<div class="container" align="center">
	<div class="card">
    <div class="card-header"> <h5>OFFICE VERSION MASTER</h5></div>
 ...
 <div class='col-md-6'>
	  <div class='row form-group'>
       ...
       <div class='card-footer' align='center'>
             <a href=Office_mstr_Url class="btn btn-success btn-sm">Clear</a>
...
function data(tableName){
	...
	$.post("getOffice_mstrReportDataList?"+key+"="+value,{startPage:startPage,pageLength:pageLength,Search:Search,orderColunm:orderColunm,orderType:orderType,office:office},function(j) {
		for (var i = 0; i < j.length; i++) {
			jsondata.push([j[i].office,j[i].id]);
		}
	});
	$.post("getOffice_mstrTotalCount?"+key+"="+value,{Search:Search,office:office},function(j) {
		FilteredRecords = j;
	});
}
