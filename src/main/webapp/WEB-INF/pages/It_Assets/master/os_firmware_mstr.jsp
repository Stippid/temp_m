...
<form:form name="Formname" id="Formid" action="os_firmware_mstrAction?${_csrf.parameterName}=${_csrf.token}" method="POST" commandName="os_firmware_mstrCMD">
<div class="container" align="center">
	<div class="card">
    <div class="card-header"> <h5>OS/FIRMWARE/PATCH UPDATES MASTER</h5></div>
       <div class="card-body card-block cue_text">
<div class="col-md-12" id="divLine" style="display: none;"><span class="line"></span></div>
 <div class='col-md-6'>
	  <div class='row form-group'>
	      <div class='col col-md-6'>
	           <strong style="color: red;">*</strong> <label for="text-input" class="form-control-label"> OS/FIRMWARE/PATCH UPDATES</label>
          </div>
          <div class='col-12 col-md-6'>
	             <form:input type="text" id="os_firmware" path="os_firmware"  class="form-control" autocomplete='off' maxlength="100"  oninput="this.value = this.value.toUpperCase()"></form:input>
        </div>
    </div>
</div>
    </div>
...
<div class="container" align="center">
<div class="col-md-12">
<table id="os_firmware_mstr_reporttbl" class="display table no-margin table-striped  table-hover  table-bordered report_print">
	<thead>
        <tr>
...
function data(tableName){
	...
	$.post("getOs_firmware_mstrReportDataList?"+key+"="+value,{startPage:startPage,pageLength:pageLength,Search:Search,orderColunm:orderColunm,orderType:orderType,os_firmware:os_firmware},function(j) {
		for (var i = 0; i < j.length; i++) {
			jsondata.push([j[i].os_firmware,j[i].id]);
		}
	});
	$.post("getOs_firmware_mstrTotalCount?"+key+"="+value,{Search:Search,os_firmware:os_firmware},function(j) {
		FilteredRecords = j;
	});
}
