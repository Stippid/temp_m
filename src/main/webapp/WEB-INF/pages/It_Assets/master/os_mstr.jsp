...
<div class="container" align="center">
	<div class="card">
    <div class="card-header"> <h5>OPERATING SYSTEM MASTER</h5></div>
 ...
 <div class='col-md-6'>
	  <div class='row form-group'>
       ...
       <div class='card-footer' align='center'>
           <a href=Os_mstr_Url class="btn btn-success btn-sm">Clear</a>
...
function data(tableName){
	...
	$.post("getOs_mstrReportDataList?"+key+"="+value,{startPage:startPage,pageLength:pageLength,Search:Search,orderColunm:orderColunm,orderType:orderType,os:os},function(j) {
		for (var i = 0; i < j.length; i++) {
			jsondata.push([j[i].os,j[i].id]);
		}
	});
	$.post("getOs_mstrTotalCount?"+key+"="+value,{Search:Search,os:os},function(j) {
		FilteredRecords = j;
	});
}
