...
<div id="PopUp_UserIdUrl" style="display: block;"> 	 
			<div  class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
		           <table id="UserID_history" class="table no-margin table-striped  table-hover  table-bordered report_print">
		                 <thead style="text-align: center;">
		                        <tr>
									<th style="font-size: 15px ;width: 10%;">Ser No</th>
                                    <th style="font-size: 15px">UserID</th>
                                    <th style="font-size: 15px">H/T Reason</th>
                                    <th style="font-size: 15px">H/T Type</th>
                                    <th style="font-size: 15px">From Army No</th>
                                    <th style="font-size: 15px">To Army No</th>
                                    <th style="font-size: 15px">H/T Done By</th>
                                    <th style="font-size: 15px">H/T Taken on</th>
								 </tr>                                                        
		                  </thead> 
		                  <tbody>
