...
<form:form name="roleMst" id="roleMst" action="roleAction" method='POST' commandName="roleCMD">
			...
			<div class="card-header"> <h5>Link Role Master</h5></div>
       		<div class="card-body card-block cue_text">
 				...
 				<div class="col-md-12">
 					<div class="col-md-6">
             			<div class="row form-group">
               				...
               				<div  class="col-12 col-md-8 selectBox" onclick="showCheckboxes()">
 					...
 					<div class="col-md-6">
	            		<div class="row form-group">
	              			<div class="col col-md-4">
	               			...
	               			<div  class="col-12 col-md-8 selectBox" onclick="showModuleCheckboxes()">
 				...
 				<div class="col-md-12">
           			...
           			<div  class="col-12 col-md-10 selectBox" onclick="screenCheckboxes()">
