...
<form:form name="edit_animal_census" id="edit_animal_census"  action="edit_animal_census_act?${_csrf.parameterName}=${_csrf.token}" method='POST' commandName="edit_animal_census_cmnd" enctype="multipart/form-data">
	<div class="container" align="center">
		<div class="card">
			...
			<div class="card-body card-block">
				...
				<div class="card" id="textboxes"  margin-bottom: 0; border: 0;">
					<div class="card-header">
								...
								<div class="col-md-6">
									<div class="row form-group">
										...
										<div class="col-12 col-md-8">
											...
											<input type="hidden" id="dog_id" name="dog_id"  class="form-control autocomplete" autocomplete="off">
										</div>
									</div>
								</div>
								...
								<div class="col-12 col-md-8">
									<div class="row form-group">
										<div class="image-container">
												...
												<img  id="front_image_preview" src="animalimgConvertpath?i_id=${edit_animal_census_cmnd.id}&fildname=front_img_path"  
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								<div class="col col-md-4">
									<label for="text-input" class=" form-control-label"><strong
										style="color: red;">*</strong>Left Face Image <br> <span style="font-size: 10px;font-size:12px;color:red">(Only *.jpg, *.jpeg and *.png file extensions and file size max 2MB are allowed.)</span></label>
								</div>

								<div class="col-12 col-md-8">
									<div class="row form-group">
										<div class="image-container">
											<img id="left_image_preview" src="animalimgConvertpath?i_id=${edit_animal_census_cmnd.id}&fildname=left_img_path"  
												class="pull-right" style="height: 100px;"/>
										</div>
						...
						<div class="col-md-6">
							<div class="row form-group">
								<div class="col col-md-4">
									<label for="text-input" class=" form-control-label"><strong
										style="color: red;">*</strong>Right Face Image <br> <span style="font-size: 10px;font-size:12px;color:red">(Only *.jpg, *.jpeg and *.png file extensions and file size max 2MB are allowed.)</span></label>
								</div>

								<div class="col-12 col-md-8">
									<div class="row form-group">
										<div class="image-container">
											<img id="right_image_preview" src="animalimgConvertpath?i_id=${edit_animal_census_cmnd.id}&fildname=right_img_path"  
												class="pull-right" style="height: 100px;"/>
										</div>
				...
				<div class="form-control card-footer" align="center">
					...
					<a href="Search_Animal_Census" class="btn btn-success btn-sm">Back</a>
	...
	<script>
	 ...
	 <Script>
		...
		$(document).ready(function() {
			...
			calculate_age();
			$("#details_of_sire").val('${edit_animal_census_cmnd.sire_name}');
			$("#details_of_dam").val('${edit_animal_census_cmnd.dam_name}');
			$("#armyno_of_sire").val('${edit_animal_census_cmnd.sire_armyno}');
			$("#armyno_of_dam").val('${edit_animal_census_cmnd.dam_armyno}');
			$("#microchip_no").val('${edit_animal_census_cmnd.microchip_no}');
			$("#fitness_status").val('${edit_animal_census_cmnd.fitness_status}');
			$("#fitness_deployment").val('${edit_animal_census_cmnd.fitness_deployment}');
			$("#animal_purchase_cost").val('${edit_animal_census_cmnd.animal_purchase_cost}');
			$("#tos").val(ParseDateColumn('${edit_animal_census_cmnd.date_of_tos}'));
			$("#date_of_auth").val(ParseDateColumn('${edit_animal_census_cmnd.date_of_auth}'));
			$("#auth_no").val('${edit_animal_census_cmnd.auth_letter_no}');
			
			
			var fitness_status='${edit_animal_census_cmnd.fitness_status}';
			if (fitness_status == "3" || fitness_status == "7" ) {
				$('#date_admitted1').show();
