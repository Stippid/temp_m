...
<form:form id="dailyReceiptIssueReport" name="dailyReceiptIssueReport"
	action="#" method='POST' commandName="#">
	<div class="animated fadeIn">
		<div class="container" align="center">
			<div class="card">
				<div class="card-header">
					<h5>AVN DAILY RECEIPT REPORT</h5>
					<h6 class="enter_by">
						...
						<div class="col-md-6">
							<div class="row form-group" style="padding-top: 10px;">
								...
								<div class="col-12 col-md-8">
									<span id="drr_dir_ser_nolbl"></span> <input type="text"
										id="drr_dir_ser_no" name="drr_dir_ser_no" placeholder=""
										class="form-control autocomplete" autocomplete="off"
										style="width: 74%" maxlength="50">
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="date_report" name="date_report"
				...
				<div class="form-control card-footer" align="center">
					...
					<a class="btn btn-success" id="addAVNReceiptDetails" onclick='submitData()'>Save</a>
				</div>
				<div class="card-body card-block"
					style="overflow: auto;" id="avndrr">
						...
						<table
							...
							<thead>
								<tr>
									...
									<th style="text-align: center;">Tail No</th>
								</tr>
							</thead>
							<tbody>
				...
				<div class="form-control card-footer" align="center">
					<a href="avn_daily_receipt_report" type="reset"
						class="btn btn-success btn-sm"> Clear </a> <input type="hidden"
						id="count" value="0" name="count"> <input type="reset"
						class="btn btn-primary btn-sm" value="Reload" id="clear"
						onclick="reloadPage();">
				</div>
			</div>
		</div>
...
function submitData() {
    // Collect form data
    var drr_ser_no = $("#drr_dir_ser_nolbl").text() + $("#drr_dir_ser_no").val();  
    ...
    $("table#add_reports tbody").append(
        '<tr id="row_' + x + '">' +
            '<td style="text-align:center;">' + drr_ser_no + '</td>' + 
            '<td style="text-align:center;">' + agency_name + '</td>' + // Agency name (Received)
            '<td style="text-align:center;">' + unit_name + '</td>' +  // Unit Serial No (From)
            '<td style="text-align:center;">' + tail_no + '</td>' + // Tail No
        '</tr>'
    );
    ...
    jQuery.ajax({
        type: 'POST',
        url: "saveAviationData?" + key + "=" + value, 
        data: {
