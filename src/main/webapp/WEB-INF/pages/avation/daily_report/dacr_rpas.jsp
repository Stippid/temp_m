...
<div class="container" align="center">
	<div class="card">
		<div class="card-header">
			<h5>
				DAILY AVIATION CASUALTY RETURN FOR RPAS<br>
			</h5>
			<h6>
		...
		<table id="SearchReportPart1"
			...
			<thead>
				<tr>
					...
					<th rowspan="2" style="width: 13%">Locations</th>
					...
					<th rowspan="2" style="width: 9%">ENG Ser No<br>
					<span>---------</span><br>ENG Hrs
					</th>
					<th rowspan="2" style="width: 8%">HRS Left<br><span style="font-size: 10px;">(Next INSP)</span></th>
	...
	<div class="tbl_scroll" id="dacr_footer">
		<table id="SearchReportPart2"
			...
			<thead>
				<tr>
				   <th rowspan="2" style=" width:7%">Sr No</th>
					...
					<th rowspan="2" style="width: 12%">DAYS Left<br><span style="font-size: 10px;">(Next INSP)</span></th>
					<th rowspan="2" style="width: 12%">Next INSP</th>
			...
			<tbody>
				...
				<c:forEach items="${list}" var="item" varStatus="num">
					<tr>
						<td style="font-size: 15px; width:7%;">${num.index + 1}</td>
						
						<td style="width: 12%">${item[20]}</td>
						<td style="width: 12%">${item[10]}</td>
...
<c:url value="UpdategetDACRReportRPASList" var="searchUrl" />
...
var sus_no='${sus_no}';
	...
	else if((issue_summary != "" && issue_summary != null) || (description != "" && description != null))
	{
		...
		$.ajax({
			...
			url : "uploadDocDACRRPAS?${_csrf.parameterName}=${_csrf.token}",
			data : data,
			processData : false,
			contentType : false,
			cache : false,
