			...
			<div class="card-body">
				...
				<div class="watermarked" data-watermark="" id="divwatermark"
					...
					<table id="SearchReport"
						...
						<thead align="center">
							<tr>
								...
								<th colspan="2" style="width: 12%;">Eng Ser No</th>
							...
							<tr>
								...
								<th style="width: 6%;">LH Hrs</th>
								<th style="width: 6%;">RH Hrs</th>
					...
					<table id="SearchReport"
						class="table no-margin table-striped  table-hover  table-bordered report_print">
						<tbody>
							<c:if test="${getDACRReportMRList1.size() != 0}">
								<div>

									<h6 style="margin-right: 90%">MR & SOW</h6>


								</div>
								<c:forEach items="${getDACRReportMRList1}" var="list"
									varStatus="num">
									<tr>
										<td style="width: 4%;">${num.index + 1}</td>
										<td style="width: 6%;">${list[1]}</td>
					...
					<table
						...
						<tbody>
							<tr>
								<td colspan="4" style="width: 20%; text-align: center;"><B>Total</B></td>
								<td align="left" style="width: 5%; text-align: center;">${sumDay}</td>
								<td align="left" style="width: 5%; text-align: center;">${sumNight}</td>
								<td align="left" style="width: 30.5%; text-align: center;"><B></B></td>
					...
					<table
						...
						<tbody>
							<tr>
								<td colspan="4" style="width: 20%; text-align: center;"></td>
...
<c:url value="SearchAttributeReportDacr" var="backUrl" />
...
<c:url value="SeenDACRUrl" var="seenUrl" />
