	...
	<div class="col-md-12" align="center">
		<div class="card">
			<div class="card-header">
				<h5>APPROVE DAILY AVIATION CASUALTY RETURN</h5>
			</div>
			<div class="card-body">
				<div class="col-md-12">
					<div class="col-md-6">
			...
			<div class="card-body">
				...
				<table id="SearchReport"
					...
					<tbody align="center">
						<c:forEach items="${getDACRReportList}" var="list" varStatus="num">
							<tr>
								...
								<td style="width: 6%;">${list[17]}<br>
								<span>---</span><br>${list[7]}</td>
								<td style="width: 6%;">${list[18]}<br>
								<span>---</span><br>${list[8]}</td>
					...
					class="table no-margin table-striped  table-hover table-bordered report_print">
						<tbody>
						<c:if test="${getDACRReporMRtList.size() != 0}">
						<div>
							...
							<c:forEach items="${getDACRReporMRtList}" var="list"
								varStatus="num">
								<tr>
									<td style="width: 4%;">${num.index + 1}</td>
									<td style="width: 6%;">${list[1]}</td>
			...
			<div class="card-footer" id='aprrove_section' align="center">
				...
				<span>I certify that the above data are true to the best of
					my knowledge.</span><br>
				<br> <a href="#" class="btn btn-danger btn-sm"
					onclick="Reject();">Reject </a> <input type="submit"
					class="btn btn-success btn-sm" value="Approve"
					onclick="Approved();">
			</div>
		</div>
	</div>
...
<c:url value="ApproveddacrUrl" var="appUrl" />
...
<c:url value="rejectdacrUrl" var="rejectUrl" />
<form:form action="${rejectUrl}" method="post" id="rejectForm"
	name="rejectForm" modelAttribute="sus_no3">
