				...
				<table id="getpartBReportMcr"
					...
					<tbody>
						<c:if test="${getdetails_ue_uhrpasdacr.size() != 0}">
							<c:forEach items="${getdetails_ue_uhrpasdacr}" var="list"
								varStatus="num">
								<tr>
...
function generate_tail_no(asonDate1,issue_type){
	...
	$.post("generate_rpastail_no?"+key+"="+value, {sus_no:sus_no,asonDate:asonDate1,issue_type:issue_type}).done(function(k) {
		var i =1;
