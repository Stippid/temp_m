...
<div class="animated fadeIn" id="printableArea">
	<div class="">
    	<div class="col-md-12" align="center">
    		<div class="card">
    			<div class="card-header" align="center"><h5>AVIATION ASSETS STATUS FOR RPAS:LINE DTE</h5></div>
    				<div class="card-body">
    					<div class="col-md-12">
    						<div class="col-md-12">
	    			...
	    			<div class="form-control card-footer" align="center" id="buttonDiv">
	    				<a href="unit_wise_detailsforRPAS" class="btn btn-success btn-sm" style="border-radius: 5px;">Clear</a>  
							...
							<div class="col-md-12">
					   			<div  class="watermarked" data-watermark="" id="divwatermark">
									...
									<table id="getVehicleStatusTbl" class="table no-margin table-striped  table-hover  table-bordered report_print" style="margin-bottom: 0rem;">
										...
										<tbody>
											<c:if test="${getdetails_ue_uhrpasdacr.size() != 0}">
											<c:forEach var="item" items="${getdetails_ue_uhrpasdacr}" varStatus="num" >
												<tr>
...
<c:url value="unit_wise_status_detailsforRPAS" var="searchUrl" />
...
function getACTMainNameList(val){
	...
	//alert(val);
	$.post("getactMain_from_abc_codeRPAS?"+key+"="+value,{abc_code:val}).done(function(data) {	
	    if(data == ""){
			$("#srctable").empty();
			$("#tartable").empty();
