...
<div class="animated fadeIn" id="printableArea">
	<div class="">
    	<div class="col-md-12" align="center">
    		<div class="card">
    			<div class="card-header" align="center"><h5>AVIATION ASSETS STATUS FOR ROTARY WING:LINE DTE</h5></div>
    				<div class="card-body">
    					<div class="col-md-12">
    						<div class="col-md-12">
								<div class="row form-group">
							    	<div class="col col-md-3">
							        	<label class=" form-control-label"><strong style="color: red;">*</strong> Aircraft CAT</label>
							       	</div>
							        <div class="col-12 col-md-5">
										<select id="type_veh"  class="form-control-sm form-control" onchange="getPRFList(this.value)" style="width: 100%">
											<option value="" >----- Select -----</option>
											<option value="0">Rotary Wing</option>
							...
							<div class="col-md-12">
								<div class="row form-group">
							    	<div class="col col-md-3">
							        	<label class=" form-control-label"><strong style="color: red;">*</strong> Aircraft TYPE</label>
							       	</div>
							        <div class="col-12 col-md-5">
										<select id="prf_code"  class="form-control-sm form-control selectpicker" onchange="getACTMainNameList(this.value)" style="width: 100%">
										</select>
									</div>
								</div>		
							</div>
							...
							<div class="col-md-6">
								<div class="row form-group">
	                				...
	                				<div class="col-12 col-md-8">
										...
										<div class="col-md-6" id="type_of_force_div" style="display: none;">
											<div class="row form-group">
              									<div class="col col-md-4" >
              										<label for="selectLg" class=" form-control-label">Status</label>
              									</div>
           										<div class="col-12 col-md-8">
													...
													<option value="RE">RE</option> 
													 ...
													 <option value="ACCIDENTAL">ACCI</option> 
													 <option value="O/H">ROH</option> 
								                  	</select>
        										</div>
        									</div>
										</div>
						...
						<div class="row form-group">
							<div class="col col-md-4">
								<label class=" form-control-label"><strong style="color: red;">*</strong>As On dt</label>
							</div>
							<div class="col-12 col-md-8">
	    			...
	    			<div class="form-control card-footer" align="center" id="buttonDiv">
	    				<a href="unit_wise_detailsforRW" class="btn btn-success btn-sm" style="border-radius: 5px;">Clear</a>  
						<button class="btn btn-primary btn-sm" onclick="return Search();" style="border-radius: 5px;">Search</button>
						<input type="button" id="exportId" class="btn btn-sm btn_report" style="background-color: #e37c22;color: white;" value="Export" onclick="fnExcelReport();">
	             	</div>
	             	<div class="card-body">
							...
							<div class="col-md-12">
					   			<div  class="watermarked" data-watermark="" id="divwatermark">
									...
									<table id="getVehicleStatusTbl" class="table no-margin table-striped  table-hover  table-bordered report_print" style="margin-bottom: 0rem;">
										<thead>
							        		<tr>
					                            <th rowspan="2" style="text-align: center;width:5%;">SR No</th>
										        <th rowspan="2" style="text-align: center; width: 5%;">Comd</th>
										        <th rowspan="2" style="text-align: center; width: 5%;">Corps</th>
										        <th rowspan="2" style="text-align: center; width: 5%;">Division</th>
										        <th rowspan="2" style="text-align: center; width: 5%;">Brigade</th>
										        <th rowspan="2" style="text-align: center; width: 5%;">Unit Name</th>										 							      
										        <th rowspan="2" style="text-align: center; width: 5%;">Nomen</th>
												<th rowspan="2" style="text-align: center; width: 5%;">UE</th>
												<th colspan="7" style="text-align: center; width: 35.5%;">UH</th>
												<th rowspan="2" style="text-align: center; width: 5%;">TOTALUH</th>
												<th rowspan="2" style="text-align: center; width: 5%;">Surplus</th>
												<th rowspan="2" style="text-align: center; width: 5%;">Defi</th>
										        <th rowspan="2" style="text-align: center; width: 10%;"">ason date</th>
										    </tr>
										    <tr>
										...
										<tbody>
											<c:if test="${getdetails_ue_uhdacr.size() != 0}">
											<c:forEach var="item" items="${getdetails_ue_uhdacr}" varStatus="num" >
												<tr>
												     <td style="width:5%;" align="center"><b>${num.index+1}</b></td>
												     <td style="text-align: center; width: 5%;"><b>${item[0]}</b></td>
												     <td style="text-align: center; width: 5%;"><b>${item[1]}</b></td>
												     <td style="text-align: center; width: 5%;"><b>${item[2]}</b></td>
												     <td style="text-align: center; width: 5%;"><b>${item[3]}</b></td>
												     <td style="text-align: center; width: 5%;"><b>${item[4]}</b></td>
												     <td style="text-align: center; width: 5%;"><b>${item[8]}</b></td>
												     <td style="text-align: center; width: 5%;"><b>${item[9]}</b></td>
												     <td style="text-align: center; width: 5%;"><b>${item[11]}</b></td>
												     <td style="text-align: center; width: 5%;"><b>${item[12]}</b></td>
												     <td style="text-align: center; width: 5%;"><b>${item[13]}</b></td>
												     <td style="text-align: center; width: 5%;"><b>${item[14]}</b></td>
												     <td style="text-align: center; width: 5%;"><b>${item[15]}</b></td>
												     <td style="text-align: center; width: 5%;"><b>${item[16]}</b></td>
												     <td style="text-align: center; width: 5%;"><b>${item[17]}</b></td>
												     <td style="text-align: center; width: 5%;"><b>${item[10]}</b></td>
												     <td style="text-align: center; width: 5%;"><b>${item[18]}</b></td>
												     <td style="text-align: center; width: 5%;"><b>${item[19]}</b></td>
												     <td style="text-align: center; width: 10%;"><b>${item[6]}</b></td>										     												     												     
												      <!--  -->
												    </tr>
											</c:forEach>
											<tr>
											<td colspan="4" style="width: 35%; text-align: center;"><B>TOTAL</B></td>
									 ...
									 <tbody>
											...
											<c:forEach var="item" items="${getdetails_ue_uhchtldacr}" varStatus="num" >
												<tr>
												     <td style="width:5%;" align="center"><b>${num.index+1}</b></td>
												     <td style="text-align: center; width: 5%;"><b>${item[0]}</b></td>
												     <td style="text-align: center; width: 5%;"><b>${item[1]}</b></td>
									...
									<tbody>
									<c:if test="${getdetails_ue_uhdacr.size()==0 && getdetails_ue_uhchtldacr.size()==0 }">
												<tr>
...
<c:url value="unit_wise_status_detailsforRW" var="searchUrl" />
...
function getPRFList(val)
{
	...
	var options = '<option value="XNR">'+ "--- Select Aircraft Type ---" + '</option>';
	if(val !="")
	{
	    $.post("getTptSummaryInABCList?"+key+"="+value,{type : val}).done(function(j) {
	    	var abccd='${abc_code}';
    		abccd = abccd +",";
    		var abccd1=[];
	    	
			for ( var i = 0; i < j.length; i++) {				
				if(abccd.indexOf(j[i].abc_code+",")>=0){
					options += '<option value="'+j[i].abc_code+'" name="' + j[i].act_nomen+ '" selected=selected>'+ j[i].act_nomen+ '</option>';
					
					abccd1.push(j[i].abc_code);							
				}else{
					options += '<option value="'+j[i].abc_code+'" name="' + j[i].act_nomen+ '" >'+ j[i].act_nomen+ '</option>';
				}
			}	
			
			$("select#prf_code").html(options);
			getACTMainNameList(abccd1);
...
function getACTMainNameList(val){
	val=$("#prf_code").val();	
	...
	//alert(val);
	$.post("getactMain_from_abc_code?"+key+"="+value,{abc_code:val}).done(function(data) {	
	    if(data == ""){
			$("#srctable").empty();
			$("#tartable").empty();
...
function drawregn(j) {
	...
	$("#tartable").empty();
	for(var i = 0; i < j.length; i++){
		var row="<tr id='SRC"+j[i].act+"' padding='5px;'>";
		row=row+"<td>&nbsp;<input class='nrCheckBox' type=checkbox id='"+j[i].act+"' name='"+j[i].std_nomclature+"' onclick='findselected();'>&nbsp;";
		row=row+ j[i].act+" - "+j[i].std_nomclature +"</td>";
		$("#srctable").append(row);
		ii=ii+1;
	}
...
function Search(){
	if($("#type_veh").val() == "")
	{
		alert("Please select Aircraft CAT.");
	}
	...
	else
	{
		...
		$("#issue_date1").val($("#issue_date").val());
