...
<div class="animated fadeIn" id="printableArea">
	<div class="">
    	<div class="col-md-12" align="center">
    		<div class="card">
    			<div class="card-header" align="center"><h5>AVIATION ASSETS DETAILS FOR ROTARY WING:LINE DTE</h5></div>
    				<div class="card-body">
    					<div class="col-md-12">
    						<div class="col-md-12">
	    			...
	    			<div class="form-control card-footer" align="center" id="buttonDiv">
	    				<a href="tailno_wise_detailsforRW" class="btn btn-success btn-sm" style="border-radius: 5px;">Clear</a>  
							 ...
							 <c:if test="${list_A.size()>0}"> 
								...
								<div align="right"><h6>Total Count : ${list_B.size()}</h6></div>
					   			...
					   			<div  class="watermarked" data-watermark="" id="divwatermark">
									...
									<tbody>
									<c:if test="${list_A.size()==0 && list_B.size()==0}">
												<tr>
...
<c:url value="tailno_wise_status_detailsforRW" var="searchUrl" />
