	...
	<div class="container" align="center">
		<div class="card">
			<div class="card-header">
				<h5>SEARCH DAILY AVIATION CASUALTY RETURN FOR ALH/LCH/APACHE</h5>
			</div>
	...
	<div class="animated fadeIn">
		<div class="container" align="center">
			...
			<div class="watermarked" data-watermark="" id="divwatermark"
				style="display: block;">
				<span id="ip"></span>
				<table id="getSearchReportMvcr"
					class="table no-margin table-striped  table-hover  table-bordered report_print">
					<thead>
						<tr>
							<th style="width: 5%; text-align: center !important;">Ser No</th>
							<th style="width: 10%; text-align: center !important;">SUS
								No</th>
							<th style="width: 60%;">Unit Name</th>

							<th style="width: 10%; text-align: center !important;">As on
								Date</th>
					...
					<tbody>
						<c:if test="${list.size() == 0}">
							<tr>
								<td colspan="4" align="center" style="color: red;">Data Not
									Available</td>
							</tr>
						</c:if>
...
<c:url value="SearchAttributeReportDacr" var="searchUrl" />
<form:form action="${searchUrl}" method="post" id="searchForm"
	name="searchForm" modelAttribute="sus_noSer">
...
<c:url value="ViewDACRUrl" var="viewUrl" />
<form:form action="${viewUrl}" method="post" id="viewForm"
	name="viewForm" modelAttribute="sus_noV">
