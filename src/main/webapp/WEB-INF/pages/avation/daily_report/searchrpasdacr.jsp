...
<div class="animated fadeIn">
   	<div class="container" align="center">
   		<div class="card">
   			<div class="card-header"><h5>SEARCH DAILY AVIATION CASUALTY RETURN FOR RPAS</h5></div>
...
<c:url value="SearchRpasReportDacr" var="searchUrl" />
...
<c:url value="ViewrpasDACRUrl" var="viewUrl" />
