...
<form:form name="actmainActionForm" id="actmainActionForm"
	action="actMainAction" method="POST" commandName="aviation_main_masterCmd">
	<div class="animated fadeIn">
		<div class="container" align="center">
			<div class="card">
				<div class="card-header">
					<span id="lbladd"></span>
					<h5>AVIATION ALLOTMENT OF ROTARY WING ACT </h5>
					<h6 class="enter_by">
							...
							<div class="row form-group">
								...
								<div class="col-12 col-md-8">
									<select class="form-control" id="act_slot" name="act_slot">
										...
										<c:forEach var="item" items="${getAviationGroupNamelist}"
											varStatus="num">
