...
<form:form name="add_act_no" id="add_act_no" action="add_act_noAction" method="post" class="form-horizontal" commandName="add_act_noCMD"> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>ACT NO CREATION FOR ROTARY WING</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by MISO)</span></h6></div>
	            			...
	            			<div class="col-md-12">	              					
	              			...
	              			<div class="col-md-12">	              					
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
							              <div class="col-md-4">
							                  <label class=" form-control-label"><strong style="color: red;">* </strong>Type of AVN Asset</label>
							             </div>
							             <div class="col-md-8">
	              			...
	              			<div class="col-md-12" id="other1">	              					
	              				<div class="col-md-6">
	              					 <div class="row form-group">
						                ...
						                <div class="col-md-8">
						                     <input type="text" id="crew_code" name="crew_code" placeholder="" class="form-control autocomplete" autocomplete="off">
						                </div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
	              					 <div class="row form-group">
						                ...
						                <div class="col-md-8">
						                     <input type="text" id="seating_capacity" name="seating_capacity" placeholder="Enter No of Passenger" class="form-control autocomplete" value="0" autocomplete="off">
						                </div>
						            </div>
	              				</div>
	              			</div>
	              			
	              			<div class="col-md-12" id="other2">	              					
	              				<div class="col-md-6">
	              					 <div class="row form-group">
						                 <div class="col-md-4">
						                  <label class=" form-control-label">Take Off Power<br><span style="font-size: 10px;font-size:12px;color:red">(In KW)</span></label>
						                </div>
						                <div class="col-md-8">
						                     <input type="text" id="take_off_power" name="take_off_power" placeholder="" class="form-control autocomplete" maxlength="45" autocomplete="off">
						                </div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
	              					 <div class="row form-group">
						                 <div class="col-md-4">
						                    <label class=" form-control-label">Width <br><span style="font-size: 10px;font-size:12px;color:red">(In Meter)</span></label>
						                </div>
						                <div class="col-md-8">
						                     <input type="text" id="width" name="width" placeholder="" class="form-control autocomplete" maxlength="45" autocomplete="off">
						                </div>
						            </div>
	              				</div>
	              			</div>
	              			...
	              			<div class="col-md-12" id="other4">	              					
	              				
	              				<div class="col-md-6">
	              					 <div class="row form-group">
						                 <div class="col-md-4">
						                    <label class=" form-control-label">Empty weight<br><span style="font-size: 10px;font-size:12px;color:red">(In Tons)</span></label>
						                </div>
						                <div class="col-md-8">
						                     <input type="text" id="empty_weight" name="empty_weight" placeholder="" class="form-control autocomplete" maxlength="45" autocomplete="off">
						                </div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
	              					 <div class="row form-group">
						                 <div class="col-md-4">
						                    <label class=" form-control-label">Gross weight<br><span style="font-size: 10px;font-size:12px;color:red">(In Tons)</span></label>
						                </div>
						                <div class="col-md-8">
						                     <input type="text" id="gross_weight" name="gross_weight" placeholder="" class="form-control autocomplete" maxlength="45" autocomplete="off">
						                </div>
						            </div>
	              				</div>
	              			</div>
	              			<div class="col-md-12" id="other5">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
							              <div class="col-md-4">
							             ...
							             <div class="col-md-8">
											...
											<label for="inline-radio1" class="form-check-label "><input type="radio" id="carriage_capacity" name="carriage_capacity" value="Yes" class="form-check-input"  >Yes</label>&nbsp;&nbsp;&nbsp; 
										    <label for="inline-radio2" class="form-check-label "> <input type="radio" id="carriage_capacity" name="carriage_capacity" value="No" class="form-check-input" >No</label>&nbsp;&nbsp;&nbsp;
										</div>
							            </div>
						            </div>
	              				</div>
	              					...
	              					<div class="row form-group">
		                					...
		                					<div class="col-md-8">
		                					    <select id="type_fuel" name="type_fuel" class="form-control">
				                                    ...
				                                    <option value="ATF K-50">ATF K-50</option>
...
function validate(){    
	...
	if($("#crew_code").val() == ""){
		alert("Please Enter crew member number. ");
		return false;
	}
	...
	if($("#take_off_power").val() == ""){
		alert("Please Enter Take of Power. ");
		return false;
	}
	if($("#width").val() == ""){
	...
	if($("#empty_weight").val() == ""){
		alert("Please Enter Empty Weight. ");
		return false;
	} 
	if($("#gross_weight").val() == ""){
	...
	if($("#carriage_capacity").val() == ""){
		alert("Please Select under slung carriage capacity. ");
		return false;
	}
	/* if($("#lift_capacity").val() == ""){
		alert("Please Enter lift capacity. ");
		return false;
	} */
	if($("#type_fuel").val() == ""){
