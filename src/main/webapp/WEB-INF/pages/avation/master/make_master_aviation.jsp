...
<form:form name="make_master_aviation" id="make_master_aviation" action="make_master_aviationAction" method="post" class="form-horizontal" commandName="make_master_aviationCMD"> 
<spring:htmlEscape defaultHtmlEscape="true" /> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    			<div class="card-header"><h5>ALLOTMENT OF MAKE FOR ROTARY WING</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by MISO)</span></h6></div>
