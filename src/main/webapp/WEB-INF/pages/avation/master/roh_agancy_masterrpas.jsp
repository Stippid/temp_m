...
<form:form name="ROHagancy_masterRpas" id="ROHagancy_masterRpas"
	action="ROHagency_RpasAction" method="post" class="form-horizontal"
	commandName="add_ROHagencyCMD">
	<div class="animated fadeIn">
		<div class="container" align="center">
			<div class="card">
				<div class="card-header">
					<h5>ALLOTMENT OF REPAIR & OH AGENCY FOR RPAS</h5>
					<h6 class="enter_by">
							...
							<div class="row form-group roh-location-group">
								<div class="col-md-5" style="width: 45%;">
									<label class="form-control-label"><strong
										...
										<option value="IAI-MRO">IAI-MRO</option>
