...
<form:form name="add_tail_noCHTL" id="add_tail_noCHTL"
	...
	commandName="edit_CHTLtail_noCMD">
							...
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="std_nomen" name="std_nomen" placeholder=""
										class="form-control autocomplete" value="${edit_CHTLtail_noCMD.std_nomclature}" autocomplete="off" readonly>
								</div>
							</div>
						</div>
							...
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="tail_no" name="tail_no" placeholder=""
										class="form-control autocomplete"  value="${edit_CHTLtail_noCMD.tail_no}"  oninput="handleInput(this)" autocomplete="off" readonly>
								</div>
							</div>
						</div>
					</div>
...
<script>
	$(document).ready(function() {
		document.addEventListener('dragenter', function(event) {
		   ...
		   $("#tail_no").val('${edit_CHTLtail_noCMD.tail_no}');
		   var tail_no = $("#tail_no").val();

		   if (tail_no != "") {
			   $.post("getCHTLtailNODetails?" + key + "=" + value, {
				    tail_no: tail_no
				}).done(function(j) {
...
function submitData() {
    ...
    jQuery.ajax({
        type: 'POST',
        url: "updateCHTLtailNoData?" + key + "=" + value, 
        data: {
            std_nomen: std_nomen,
            tail_no: tail_no,
