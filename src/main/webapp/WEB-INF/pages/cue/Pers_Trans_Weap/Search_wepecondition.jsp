...
<div class="container card_outer" align="center">
	        	...
	        	<div class="card">
	        		<div class="card-header"> <h5><b>SEARCH WE/PE TITLES</b><br><span style="font-size: 10px;font-size:15px;color:red">(To be approved by Line Dte)</span></h5></div>
						...
						<div class="col-md-12">
							<div class="col-md-6">
             					<div class="row form-group">
               					<div class="col col-md-6">
                 						<label class=" form-control-label">Uploaded WE/PE No</label>
               					</div>
               					<div class="col-12 col-md-6">
...
<div style="width: 20%; padding-left: 1%; display: none;" id="divSerachInput">
 ...
 <div class="col s12" style="display: none;" id="divPrint">
		...
		<c:url value="searchWePecondition1" var="searchUrl" />
    		<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="we_pe_no1">
    			...
    			<input type="hidden" name="getroleid1" id="getroleid1" value="${wepe}"/>
    			<input type="hidden" name="setTypeOnclick1" id="setTypeOnclick1" value="0"/>
    		</form:form> 
    		
 	<c:url value="Approved_WE_PE_condition" var="appUrl" />
	<form:form action="${appUrl}" method="post" id="appForm" name="appForm" modelAttribute="appid">
		...
		<input type="hidden" name="uploaded_wepe2" id="uploaded_wepe2" value="0"/>
		<input type="hidden" name="suprcdd_we_pe_no2" id="suprcdd_we_pe_no2" value="0"/>
		<input type="hidden" name="table_title2" id="table_title2" value="0"/>
		<input type="hidden" name="sponsor_dire2" id="sponsor_dire2" value="0"/>
		<input type="hidden" name="arm_desc2" id="arm_desc2" value="0"/>
		<input type="hidden" name="doc_type2" id="doc_type2" value="0"/>
		<input type="hidden" name="status2" id="status2" value="0"/>
		<input type="hidden" name="getroleid2" id="getroleid2" value="0"/>
		<input type="hidden" name="setTypeOnclick2" id="setTypeOnclick2" value="0"/>
		<input type="hidden" name="superno2" id="superno2" value="0"/>
		<input type="hidden" name="appType" id="appType" value=""/>
		<input type="hidden" name="nwepe2" id="nwepe2" value=""/>
		<input type="hidden" name="type2" id="type2" value=""/>
		<input type="hidden" name="statusp" id="statusp" value=""/>
			<input type="hidden" name="copy2" id="copy2" value=""/>
	</form:form> 	
