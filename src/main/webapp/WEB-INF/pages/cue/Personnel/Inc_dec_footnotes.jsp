...
<form:form name="Inc_dec_footnotes" id="Inc_dec_footnotes" action="Inc_dec_footnotesAction" method='POST' commandName="Inc_dec_footnotesActionCMD">
	 	<div class="container" align="center">
        	<div class="card">
        		<div class="card-header"><h5><b>INCREASE/DECREASE GENERAL NOTES FOR PERSONNEL</b><br><span style="font-size: 12px;color:red">(To be entered by Line Dte)</span></h5></div>
          		<div class="card-body card-block cue_text">
            		<div class="col-md-12">	  
					  ...
					  <div class="col-12 col-md-6">
					              <select name="scenario" id="scenario" class=" form-control"  onchange="return categoryofpersonnel();">
					     ...
					     <div class="col-md-6">
	              		<div class="row form-group" id="getloc" style="display:none;">
                					...
                					<input type="hidden" id="location_code" name="location"  class="form-control" >
                  						<input type="text" id="location" name="" maxlength="5" class="form-control autocomplete" autocomplete="off" style="font-family: 'FontAwesome',Arial;" placeholder="&#xF002; Search">
                					</div>
              					</div>  
  					   ...
  					   <div class="col-md-12">	
  						...
  						<div class="row form-group">
				                ...
				                <div class="col-12 col-md-6">
				                	<select  id="category_of_personnel" name="category_of_personnel" class="form-control" onchange=" return categoryofpersonnel();">
				                	<option value="">--Select--</option>
  						...
  						<div class="col-md-6">
  							<div class="row form-group">
				                ...
				                <div class="col-12 col-md-6">
				                <input  id="parent_arm"  class="form-control">
  						...
  						<div class="col-md-6">
  							<div class="row form-group">
				                ...
				                <div class="col-12 col-md-6">
				                <select  id="rank_cat" name="rank_cat" class="form-control"  onchange="select_rank_cat();select_rank_app_trade();return rankdisable();" autocomplete="off">
				                <option value="">--Select--</option>
  						...
  						<div class="col-md-6">
  							<div class="row form-group">
				                ...
				                <input  id="appt_trade" name="appt_trade_name" maxlength="20"  class="form-control" autocomplete="off" onkeyup="return appttrade();" style="font-family: 'FontAwesome',Arial;" placeholder="&#xF002; Search">
				                </div>
				            </div>	  								
  						</div>
  					 </div>
  					...
  					<div class="col-md-12">	
  						<div class="col-md-6">
  							<div class="row form-group">
				                <div class="col col-md-6">
				                  	<label class=" form-control-label">Whether Increment/Decrement <strong style="color: red;">*</strong></label> 
				                </div>
				                <div class="col-12 col-md-6">
				                	 <div class="form-check-inline form-check">
  						 ...
  						 <div class="col-md-6">
  							<div class="row form-group">
				                ...
				                <div class="col-12 col-md-6">
				                <input  id="amt_inc_dec" name="amt_inc_dec" onfocus="if(this.value=='0') this.value='';" placeholder="" value="0" class="form-control" onkeypress="return isNumberKey(event, this);" onkeyup="selectradiobase();" autocomplete="off" maxlength="5">
				                </div>
				            </div>	  								
  						</div>
  						</div>
  				...
  				<div class="col-md-6">
					<div class="row form-group">
		                ...
		                <div class="col-12 col-md-6">
		                	<textarea  id="condition1" name="condition" maxlength="255" class="form-control"></textarea>
		                </div>
	            	</div>	
  				 </div>
	  						<div class="col-md-6">
 ...
 <div style="width: 20%; padding-left: 1%; display: none;" id="divSerachInput">
	...
	<div class="col s12" style="display: none;" id="divPrint">
			...
			<div  class="watermarked" data-watermark="" id="divwatermark" style="display: block;">
					<span id="ip"></span>
			<table id="IncDecReport1"  class="table no-margin table-striped  table-hover  table-bordered" style="width:100%;table-layout: fixed;word-wrap: break-word;">
				 <thead >
					<tr>
						...
						<th >Rank</th>
						<th style="font-size:15px">Gen Notes Condition</th>
						<th >Base Auth</th>
		...
		<c:url value="Inc_dec_footnotes1" var="searchUrl" />
...
function printDiv() 
{
	...
	printDivOptimize('divPrint','INCREASE/DECREASE GENERAL NOTES FOR PERSONNEL',printLbl,printVal,"select#status");
}
</script>
	   ...
	   if(window.location.href.includes("count="))
		{
			...
			if(m.includes("Updated+Successfully")){
				window.opener.getRefreshReport('foot_per',m);
...
$('select#rank').change(function() {
	...
	var c_p = $("select#category_of_personnel").val();
	var r = $(this).val();
	var arm = $("input#arm_code").val();
	
	var a_t =  $("input#appt_trade_code").val();
	var we_pe = $("input#we_pe_no").val();
	...
	$.post("getwepe_pers_detBaselist?"+key+"="+value,{ r_c : r_c , c_p : c_p , r : r , arm : arm , a_t : a_t ,we_pe :we_pe}).done(function(j) {
		 document.getElementById("base_autho").value=j;	
			...
			document.getElementById("base_auth_hidden").value=j;
			}
			else
			{
				document.getElementById("base_auth_hidden").value=j;
...
function categoryofpersonnel(){
var s = document.getElementById("category_of_personnel").value;
...
function rankdisable(){
	var s1 = document.getElementById("rank_cat").value;
	if(s1 == " " ){
...
function isvalidData(){	
	var r =  $('input:radio[name=we_pe]:checked').val();	
	 ...
	 if($("select#scenario").val()=="select" ||$("select#scenario").val()=="0" || $("select#scenario").val()==null || $("select#scenario").val()=="null" || $("select#scenario").val()==""){
   ...
   if(f == "Unit"){
	  ...
	  if($("select#category_of_personnel").val()=="" ){
		  alert("Please Select Category of Personnel");
			$("select#category_of_personnel").focus();
			return false;
		}
	  
		 else if($("select#category_of_personnel").find('option:selected').attr("name") == "ERE")
		{
	...
	var r =  $('input:radio[name=radio_status]:checked').val();	
	 ...
	 {		 
	  ...
	  if($("input#amt_inc_dec").val()=="" || $("input#amt_inc_dec").val()=="0"){
		  alert("Please Enter Amt of Increment/Decrement ");
			$("input#amt_inc_dec").focus();
			return false;
		}
	  var cond = $("textarea#condition1").val();
	  if(cond.trim()=="" )
	  {
		  alert("Please Enter Condition");
		  $("textarea#condition1").focus();
		  return false;	 
	  }
