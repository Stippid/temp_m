	  ...
	  wepetext.autocomplete({
	      source: function( request, response ) {
	       ...
	       url: "getWePeCondiByNoSearch1?"+key+"="+value,
   	        data: {we_pe : radio_doc , newRoleid: "ap",we_pe_no : document.getElementById('we_pe_no_from').value},
...
wepetext1.autocomplete({
    source: function( request, response ) {
      ...
      data: {type : radio_doc, newRoleid: "ap",suprcdd_we_pe_no : document.getElementById('suprcdd_we_pe_no').value},
        success: function( data ) {
          //response( data );
          if(data.length > 1){
        	var susval = [];
...
<form:form name="copy_we_pe_pers" id="copy_we_pe_pers" action="copy_we_pe_persAction?${_csrf.parameterName}=${_csrf.token}" method='POST' commandName="copy_we_pe_persCMD">
	        		...
	        		<div class="card-header"><h5><b>COPY WE/PE</b><br><span style="font-size:12px;color:red">(To be entered by Line Dte)</span></h5></div>
	                		...
	                		<div class="col-md-12">	
	                			<div class="col-md-6">
	              					...
	              					<div class="row form-group">
	                					...
	                					<div class="col-12 col-md-6">
	                  						<input  id="we_pe_no" name="we_pe_no" autocomplete="off"  maxlength="100" class="form-control autocomplete" placeholder="">
	                					</div>
	                					</div>
	              					</div>             					
	            				</div>            			
	  						...
	  						<div class="col-md-12" style="display: block;">
	  							<div class="row form-group row_content">
					                <div class="col col-md-4">
					                  <label class=" form-control-label" id="lbluc">Approved Uploaded WE/PE No </label>
					                </div>
					                <div class="col-12 col-md-7">
					                <input  class="form-control" id ="uploaded_wepe" maxlength="100" name ="uploaded_wepe" autocomplete="off" >
					                </div>
					            </div>	  								
	  						</div>
	  					</div>
						<div class="col-md-12">	              					
	              			<div class="col-md-6">
	              			 	<div class="row form-group"> 
	                					<div class="col col-md-6">
	                  						<label for="suprcdd_we_pe_no" class=" form-control-label">Superseded WE/PE No</label>
	                					</div>
	                					<div class="col-12 col-md-6">
	                						<input  id="suprcdd_we_pe_no" name="suprcdd_we_pe_no" autocomplete="off" maxlength="100" class="form-control" style="font-family: 'FontAwesome',Arial;" placeholder="&#xF002; Search" >
										</div>
	  								</div> 
	  						</div>
	  						<div class="col-md-6">
              					<div class="row form-group">
                					...
                					<div class="col-12 col-md-6">
                  						<input  id="table_title" name="table_title" autocomplete="off" maxlength="150" class="form-control">
                					</div>
                					</div>
              					</div>
	  					</div>
	  					...
	  					<div class="col-md-12">				
	  						<div class="col-md-6">
	  							<div class="row form-group">
					                ...
					                <div class="col-12 col-md-6">
					               		<input class="form-control" id ="letter_date" autocomplete="off" name ="letter_date" placeholder="dd-MM-yyyy">                                           
		                           </div>
					            </div>	  								
	  						</div>
	  					</div>
	  					...
	  					<div class="col-md-12">				
	  						<div class="col-md-6">
	  							<div class="row form-group">
					                <div class="col col-md-6">
					                  <label class=" form-control-label" id="lbltc" visible="false">Training Capacity </label>
					                </div>
					                <div class="col-12 col-md-6">
					               		<input class="form-control" id ="training_capacity" autocomplete="off" name ="training_capacity" visible="false" maxlength="5" onkeypress="return isNumber0_9Only(event,this);">
					                </div>
					            </div>	  								
	  						</div>
	  						<div class="col-md-6">
	  							<div class="row form-group">
					                <div class="col col-md-6">
					                  <label class=" form-control-label" id="lbluc" visible="false">Unit Category</label>
					                </div>
					                <div class="col-12 col-md-6">
					                <select  class="form-control" id ="unit_category" name ="unit_category" visible="false">
					                  <option value="">--Select--</option>
