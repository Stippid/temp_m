...
<form:form action="search_conver_restruc_reorga_redes_actionlist" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	          		<div class="card-header"><h5>AUTH IN CT-I/CT-II FMNS/UNITS (REG ARMY AND CIV) - USER ARM & CATEGORY WISE</h5></div> 
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>AUTH IN CT-I/CT-II FMNS/UNITS (REG ARMY AND CIV) - USER ARM & CATEGORY WISE<br>
						...
						<table id="SearchReport2" class="table no-margin table-striped  table-hover  table-bordered report_print">
							<thead style="background-color: #9c27b0; color: white;" align="center">
								<tr>
										...
										<th style="font-size: 13px" align="center" colspan="4"> OFFICERS </th>
										...
										<th style="font-size: 13px" align="center" colspan="2"> CIVILIANS </th>
										<th style="font-size: 13px" align="center"> NCsUE & CL-IV </th>
										<th style="font-size: 13px" align="center" > Grand Total</th>
								
								</tr>
								<tr>
										<th style="font-size: 13px" align="center"> </th>	
										<th style="font-size: 13px" align="center"> NON MED </th>
										<th style="font-size: 13px" align="center" > MED </th>
										<th style="font-size: 13px" align="center" > MNS </th>
										<th style="font-size: 13px" align="center" > TOTAL </th>
										<th style="font-size: 13px" align="center" > </th>
										<th style="font-size: 13px" align="center"></th>
										<th style="font-size: 13px" align="center" >  </th>
										<th style="font-size: 13px" align="center" > GAZ </th>
										<th style="font-size: 13px" align="center" > NON GAZ </th>
										<th style="font-size: 13px" align="center">  </th>
										<th style="font-size: 13px" align="center" > </th>
...
<c:url value="14_AUTH_EST_REG_ARMY_PERS_CIVIL_FORMATION" var="searchUrl4" />
