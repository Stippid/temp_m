...
<form:form action="search_conver_restruc_reorga_redes_actionlist" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	          		<div class="card-header"><h5>AUTH OF OFFICERs IN ARMY HQ - UNIT WISE</h5></div> 
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>AUTH OF OFFICERs IN ARMY HQ - UNIT WISE<br>
						...
						<table id="SearchReport2" class="table no-margin table-striped  table-hover  table-bordered report_print">
							<thead style="background-color: #9c27b0; color: white;" align="center">
									<tr>
										...
										<th style="font-size: 13px" align="center"> UNITS/EST OF ARMY HQ/ISOs </th>	
										<th style="font-size: 13px" align="center"> GEN </th>
										<th style="font-size: 13px" align="center"> LT GEN </th>
										<th style="font-size: 13px" align="center"> MAJ GEN </th>	
										<th style="font-size: 13px" align="center"> BRIG </th>
										<th style="font-size: 13px" align="center"> BRIG/COLONEL </th>
										<th style="font-size: 13px" align="center"> COL </th>
										<th style="font-size: 13px" align="center"> COL/LT COL </th>	
										<th style="font-size: 13px" align="center"> COL/LT COL/MAJ </th>
										<th style="font-size: 13px" align="center"> LT COL </th>
										<th style="font-size: 13px" align="center"> LT COL/MAJ </th>
										<th style="font-size: 13px" align="center"> LT COL/MAJ/CAPT </th>	
										<th style="font-size: 13px" align="center"> MAJ </th>
										<th style="font-size: 13px" align="center"> MAJ/CAPT </th>
										<th style="font-size: 13px" align="center"> CAPT </th>
										<th style="font-size: 13px" align="center"> LT </th>
										<th style="font-size: 13px" align="center"> RNS</th>
...
<c:url value="16_AUTH_OF_OFF_UNIT_WISE" var="searchUrl4" />
