...
<form:form action="search_conver_restruc_reorga_redes_actionlist" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	          		<div class="card-header"><h5>MAJ MIN UNIT CMD WISE</h5></div> 
						...
						<table id="SearchReport2" class="table no-margin table-striped  table-hover  table-bordered report_print">
							<thead style="background-color: #9c27b0; color: white;" align="center">
									<tr>
										...
										<th style="font-size: 13px" align="center"> COMD NAME </th>	
										<th style="font-size: 13px" align="center"> UNIT CATEGORY</th>
										<th style="font-size: 13px" align="center"> MAJ GEN AND ABOVE </th>
										<th style="font-size: 13px" align="center"> COL/BRIG </th>	
										<th style="font-size: 13px" align="center"> LT COL AND BELOW </th>
										<th style="font-size: 13px" align="center"> JCO OR</th>
										<th style="font-size: 13px" align="center"> MAJ GEN AND ABOVE COUNT </th>
										<th style="font-size: 13px" align="center"> COL/BRIG COUNT</th>	
										<th style="font-size: 13px" align="center"> LT COL AND BELOW COUNT</th>
										<th style="font-size: 13px" align="center"> JCO OR COUNT</th>
									</tr>
							</thead>
...
<c:url value="17_MAJ_MIN_UNIT_CMD_WISE" var="searchUrl4" />
