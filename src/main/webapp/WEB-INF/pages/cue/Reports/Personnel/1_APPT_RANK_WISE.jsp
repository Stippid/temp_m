...
<form:form  method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>APPOINTMENT RANKWISE</h5></div> 
						...
						<table id="SearchReport2" class="table no-margin table-striped  table-hover  table-bordered report_print">
							<thead style="background-color: #9c27b0; color: white;" align="center">
									<tr>
										...
										<th style="font-size: 13px" align="center"> APPOINTMENT/TRADE </th>
...
<c:url value="ue_persnl_appntrnkwise" var="searchUrl3" />
	<form:form action="${searchUrl3}" method="post" id="search3" name="search3" modelAttribute="sus_no1">
...
$(document).ready(function() {
    ...
    document.getElementById('sus_no').innerHTML = sus; 	
