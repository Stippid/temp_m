...
<form:form action="search_conver_restruc_reorga_redes_actionlist" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	          		<div class="card-header"><h5>DATASHEET FOR OFFRs/JCOs/OR/CIV</h5></div> 
								...
								<div class="col-md-6">
									<div class="row form-group">
	                					...
	                					<div class="col-12 col-md-8">
	                						<input type="text" id="rank_cat" name="" maxlength="255" class="form-control autocomplete" autocomplete="off" >
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>DATASHEET FOR OFFRs/JCOs/OR/CIV<br>
		    		...
		    		<div  class="watermarked" data-watermark="" id="divwatermark" >
						...
						<table id="SearchReport2" class="table no-margin table-striped  table-hover  table-bordered report_print">
							<thead style="background-color: #9c27b0; color: white;" align="center">
									<tr>
									    <th style="font-size: 13px" align="center"> PERSONNEL CAT </th>
										<th style="font-size: 13px" align="center"> RANK CAT</th>	
										<th style="font-size: 13px" align="center"> APPOINTMENT </th>
										<th style="font-size: 13px" align="center"> RANK </th>
										<th style="font-size: 13px" align="center"> BASE AUTH </th>
										<th style="font-size: 13px" align="center"> MODE AUTH </th>
										<th style="font-size: 13px" align="center"> FOOTNT AUTH </th>
										<th style="font-size: 13px" align="center"> TOTAL UE </th>
										<th style="font-size: 13px" align="center"> CT TYPE</th>
										<th style="font-size: 13px" align="center"> USER ARM CODE </th>
										<th style="font-size: 13px" align="center"> USER ARM NAME </th>
										<th style="font-size: 13px" align="center"> SUS NO </th>
										<th style="font-size: 13px" align="center"> PARENT ARM CODE </th>
										<th style="font-size: 13px" align="center"> PARENT ARM NAME </th>
									</tr>
							</thead>
...
<c:url value="ue_pers_data_officers" var="searchUrl4" />
	<form:form action="${searchUrl4}" method="post" id="search3" name="search3" modelAttribute="rank_cat1">
		<input type="hidden" name="from_date1" id="from_date1" value=""/>
		<input type="hidden" name="to_date1" id="to_date1" value=""/>
		<input type="hidden" name="rank_cat1" id="rank_cat1" value=""/>
...
$(document).ready(function() {
	...
	document.getElementById('rank_cat').innerHTML = rank_cat;
	document.getElementById('sus_no').innerHTML = sus_no; 
...
function Search(){
    ...
    $("input#rank_cat1").val($("#rank_cat").val());
...
$("#rank_cat").keypress(function(){
	var rank_cat = this.value;
 	var susNoAuto=$("#rank_cat");
  	susNoAuto.autocomplete({
      	source: function( request, response ) {
        	$.ajax({
        		type: 'POST',
        		url: "get_rank_cat_report?"+key+"="+value,
        		data: {rank_cat:rank_cat},
          		success: function(data) {
          			var susval = [];
		        	  var length = data.length-1;
		...
		minLength: 1,
      	...
      	change: function(event, ui) {
    	 	if (ui.item) {   	        	  
        		...
        		alert("Please Enter Approved Rank Category");
