...
<form:form action="search_conver_restruc_reorga_redes_actionlist" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	          		<div class="card-header"><h5>USER ARM/PARENT ARM WISE STRENGTH : JCOs</h5></div> 
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>USER ARM/PARENT ARM WISE STRENGTH : JCOs <br>
...
<c:url value="allontmnt_of_parntarm" var="searchUrl7" />
	<form:form action="${searchUrl7}" method="post" id="search3" name="search3" modelAttribute="type_of_report1">
