...
<form:form action="search_conver_restruc_reorga_redes_actionlist" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	          		<div class="card-header"><h5>USR ARM/PRNT ARM WISE STRENGTH : OR</h5></div> 
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>USER ARM/PARENT ARM WISE STRENGTH : OR<br>
...
<c:url value="allontmnt_of_vanc" var="searchUrl6" />
	<form:form action="${searchUrl6}" method="post" id="search3" name="search3" modelAttribute="type_of_report1">
