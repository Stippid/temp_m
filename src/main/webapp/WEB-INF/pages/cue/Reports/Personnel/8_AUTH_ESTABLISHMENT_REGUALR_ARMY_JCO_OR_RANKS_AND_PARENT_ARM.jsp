...
<form:form action="search_conver_restruc_reorga_redes_actionlist" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	          		<div class="card-header"><h5>AUTH ESTABLISHMENT REGUALR ARMY JCO OR RANKS AND PARENT ARM</h5></div> 
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>AUTH ESTABLISHMENT REGUALR ARMY JCO OR RANKS AND PARENT ARM<br>
						...
						<table id="SearchReport2" class="table no-margin table-striped  table-hover  table-bordered report_print">
							<thead style="background-color: #9c27b0; color: white;" align="center">
									<tr>										
										...
										<th style="font-size: 13px" align="center"> SUB MAJ </th>
										<th style="font-size: 13px" align="center"> SUB</th>
										<th style="font-size: 13px" align="center"> SUB/NSUB</th>	
										<th style="font-size: 13px" align="center"> RNS JCO</th>
										<th style="font-size: 13px" align="center"> NB SUB</th>									
										<th style="font-size: 13px" align="center"> TOTAL JCO</th>
										<th style="font-size: 13px" align="center"> HAV</th>
										<th style="font-size: 13px" align="center"> L/HAV</th>
										<th style="font-size: 13px" align="center"> NK</th>
										<th style="font-size: 13px" align="center"> L/NK</th>
										<th style="font-size: 13px" align="center"> SEP</th>
										<th style="font-size: 13px" align="center"> L/NK/SEP</th>
										<th style="font-size: 13px" align="center"> RNS OR</th>
										<th style="font-size: 13px" align="center"> TOTAL OR</th>										
									</tr>
...
<c:url value="AUTH_ESTABLISHMENT_REGUALR_ARMY_JCO_OR_RANKS_AND_PARENT_ARM" var="searchUrl10" />
	<form:form action="${searchUrl10}" method="post" id="search3" name="search3" modelAttribute="type_of_report1">
