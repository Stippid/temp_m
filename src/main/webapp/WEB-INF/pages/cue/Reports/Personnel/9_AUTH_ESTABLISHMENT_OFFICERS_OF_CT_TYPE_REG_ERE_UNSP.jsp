...
<form:form action="search_conver_restruc_reorga_redes_actionlist" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
                     <div class="card-header"><h5>AUTH ESTABLISHMENT OFFICERS OF CT TYPE REG ERE UNSP</h5></div> 
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>AUTH ESTABLISHMENT OFFICERS OF CT TYPE REG ERE UNSP<br>
						...
						<table id="SearchReport2" class="table no-margin table-striped  table-hover  table-bordered report_print">
							<thead style="background-color: #9c27b0; color: white;" align="center">
								...
								<tr>
										...
										<th style="font-size: 13px" align="center" colspan="4"> CTPARTI </th>
										<th style="font-size: 13px" align="center"  colspan="4"> CTPARTII</th>
										<th style="font-size: 13px" align="center">  </th>	
								</tr>
							
								<tr>
										<th style="font-size: 13px" align="center"> PARENT ARM NAME </th>	
										<th style="font-size: 13px" align="center"> REGIMENTAL </th>
										<th style="font-size: 13px" align="center"> ERE</th>
										<th style="font-size: 13px" align="center"> ERE UNSP</th>
...
<c:url value="AUTH_ESTABLISHMENT_OFFICERS_OF_CT_TYPE_REG_ERE_UNSP" var="searchUrl4" />
