...
<form:form action="search_conver_restruc_reorga_redes_actionlist" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	          		<div class="card-header"><h5>ALLOTMENT OF VACANCIES BY PARENT ARM </h5></div> 
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>ALLOTMENT OF VACANCIES BY PARENT ARM<br>
						...
						<table id="SearchReport2" class="table no-margin table-striped  table-hover  table-bordered report_print">
							<thead style="background-color: #9c27b0; color: white;" align="center">
									...
									<tr>
										...
										<th style="font-size: 13px" align="center"> AUTH EST </th>
										<th style="font-size: 13px" align="center"> MSM</th>
										<th style="font-size: 13px" align="center"> MAJ GEN AND ABOVE </th>
										<th style="font-size: 13px" align="center"> LS & GCM </th>	
										<th style="font-size: 13px" align="center"> MSM </th>
										<th style="font-size: 13px" align="center"> LS & GCM </th>	
...
<c:url value="ALLOTMENT_OF_VACANCIES_BY_PARENT_ARMcurl" var="searchUrlcue21" />
	<form:form action="${searchUrlcue21}" method="post" id="search3" name="search3" modelAttribute="type_of_report1">
