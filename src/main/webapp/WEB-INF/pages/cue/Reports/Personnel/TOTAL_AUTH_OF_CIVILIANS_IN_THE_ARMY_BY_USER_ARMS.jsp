...
<form:form action="search_conver_restruc_reorga_redes_actionlist" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	          		<div class="card-header"><h5>AUTH OF CIVILIANS USER ARMS WISE</h5></div> 
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>AUTH OF CIVILIANS USER ARMS WISE<br>
		    		...
		    		<div  class="watermarked" data-watermark="" id="divwatermark" >
						...
						<table id="SearchReport2" class="table no-margin table-striped  table-hover  table-bordered report_print">
							<thead style="background-color: #9c27b0; color: white;" align="center">
									...
									<tr>
										<th style="font-size: 13px" align="center" rowspan="1">  </th>
										<th style="font-size: 13px" align="center" rowspan="1">  </th>
										<th style="font-size: 13px" align="center" colspan="2"> GAZZETTED </th>
										<th style="font-size: 13px" align="center" colspan="1"> NCsUE </th>
										<th style="font-size: 13px" align="center" colspan="6"> NON GAZZETTED </th>	
										
										<th style="font-size: 13px" align="center">  </th>
										
									</tr>
									<tr>
									<th style="font-size: 13px" align="center" > CODE </th>
									<th style="font-size: 13px" align="center" > USER ARM NAME </th>
									<th style="font-size: 13px" align="center"> CIVIL CLASS I GAZETTED </th>
									<th style="font-size: 13px" align="center"> CIVIL CLASS II GAZETTED </th>
									<th style="font-size: 13px" align="center"> NCsUE </th>
									<th style="font-size: 13px" align="center"> CIVIL NON-GAZ INDUSTRIAL CL-II </th>
									<th style="font-size: 13px" align="center"> CIVIL NON-GAZ INDUSTRIAL CL-III </th>
									<th style="font-size: 13px" align="center"> CIVIL NON-GAZ INDUSTRIAL CL-IV </th>
									<th style="font-size: 13px" align="center"> CIVIL NON-GAZ NON-INDUSTRIAL CL-II </th>
									<th style="font-size: 13px" align="center"> CIVIL NON-GAZ NON-INDUSTRIAL CL-III </th>
									<th style="font-size: 13px" align="center"> CIVIL NON-GAZ NON-INDUSTRIAL CL-IV </th>
...
<c:url value="TOTAL_AUTH_OF_CIVILIANS_IN_THE_ARMY_BY_USER_ARMS" var="searchUrlcue22" />
	<form:form action="${searchUrlcue22}" method="post" id="search3" name="search3" modelAttribute="type_of_report1">
