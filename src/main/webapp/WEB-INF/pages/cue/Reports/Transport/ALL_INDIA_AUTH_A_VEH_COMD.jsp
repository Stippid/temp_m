...
<form:form action="search_conver_restruc_reorga_redes_actionlist" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	          		<div class="card-header"><h5>ALL INDIA AUTH A VEHICLE</h5></div> 
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>ALL INDIA AUTH A VEHICLE<br>
		    		...
		    		<div  class="watermarked" data-watermark="" id="divwatermark" >
						<span id="ip"></span>
							...
							<thead style="background-color: #9c27b0; color: white;" align="center">
									<tr>
										<th style="font-size: 13px" align="center"> VEHICLE TYPE </th>	
...
<c:url value="ALL_INDIA_AUTH_A_VEH_COMDURL" var="searchUrl17" />
	<form:form action="${searchUrl17}" method="post" id="search3" name="search3" modelAttribute="type_of_report1">
