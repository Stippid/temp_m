...
<form:form action="search_conver_restruc_reorga_redes_actionlist" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	          	<div class="card-header"><h5>ALL INDIA UNIT ENTITLEMENT OF B VEH WITH RSV FF NFF</h5></div> 
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>ALL INDIA UNIT ENTITLEMENT OF B VEH WITH RSV FF NFF<br>
						...
						<span id="ip"></span>
							...
							<thead style="background-color: #9c27b0; color: white;" align="center">
									<tr>
										...
										<th style="font-size: 13px" align="center" > PRF NAME </th>
...
<c:url value="ALL_INDIA_UNIT_ENTI_OF_B_VEH_WITHurl" var="searchUrl17" />
