...
<link href="themes/jquery/jquery-ui.css" rel="Stylesheet"></link>
...
<form:form action="search_conver_restruc_reorga_redes_actionlist" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	          		<div class="card-header"><h5>ALL INDIA UNIT ENTITLEMEMT OF B VEH W/O RESERVE</h5></div> 
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>ALL INDIA UNIT ENTITLEMEMT OF B VEH W/O RESERVE<br>
						...
						<span id="ip"></span>
							...
							<thead style="background-color: #9c27b0; color: white;" align="center">
									<tr>
										...
										<th style="font-size: 13px" align="center"> <span id="c_y"></span> </th>
										<th style="font-size: 13px" align="center"> <span id="p_y"></span> </th>
										<th style="font-size: 13px" align="center"> INCR/DECR </th>										
									</tr>
							</thead>
...
<c:url value="ALL_INDIA_UNIT_ENT_OF_B_VEH_INC_DECURL" var="searchUrl3" />
...
$(document).ready(function() {
    ...
    document.getElementById('p_y').innerHTML = p_y; 		
