...
<form:form action="search_conver_restruc_reorga_redes_actionlist" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	          		<div class="card-header"><h5>All INDIA AUTHORISATION OF A VEHICLES - COMMAND WISE</h5></div> 
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>All INDIA AUTHORISATION OF A VEHICLES - COMMAND WISE<br>
		    		...
		    		<div  class="watermarked" data-watermark="" id="divwatermark" >
						<span id="ip"></span>
							...
							<thead style="background-color: #9c27b0; color: white;" align="center">
									<tr>
										<td style="font-size: 13px" align="center"> GNL SPL </th>
...
<c:url value="all_india_auth_A" var="searchUrl3" />
