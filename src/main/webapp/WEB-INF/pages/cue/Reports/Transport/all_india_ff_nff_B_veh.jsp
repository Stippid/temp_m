...
<form:form action="search_conver_restruc_reorga_redes_actionlist" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	          	<div class="card-header"><h5>ALL INDIA AUTHORISATION FF NFF B VEH</h5></div> 
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>ALL INDIA AUTHORISATION FF NFF B VEH<br>
...
<c:url value="all_india_ff_nff_B_vehurl" var="searchUrl18" />
	<form:form action="${searchUrl18}" method="post" id="search3" name="search3" modelAttribute="type_of_report1">
