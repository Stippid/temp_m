...
<form:form action="search_conver_restruc_reorga_redes_actionlist" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	          		<div class="card-header"><h5>DATA VERIFICATION REPORT</h5></div> 
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>DATA VERIFICATION REPORT<br>
		    		...
		    		<div  class="watermarked" data-watermark="" id="divwatermark" >
						<span id="ip"></span>
							...
							<thead style="background-color: #9c27b0; color: white;" align="center">
									<tr>
										<th style="font-size: 13px" align="center"> ARM CODE </th>	
										<th style="font-size: 13px" align="center"> ARM NAME </th>	
										<th style="font-size: 13px" align="center" > WE/PE NO </th>
										<th style="font-size: 13px" align="center" > UNIT TYPE </th>
										<th style="font-size: 13px" align="center" > FORCE TYPE </th>
										<th style="font-size: 13px" align="center" > MODIFICATION </th>
										<th style="font-size: 13px" align="center" > PRF </th>
										<th style="font-size: 13px" align="center" > MCT </th>
										<th style="font-size: 13px" align="center" > NOMENCLATURE </th>
										<th style="font-size: 13px" align="center" > UE </th>
										<th style="font-size: 13px" align="center" > NO OF UNIT </th>
										<th style="font-size: 13px" align="center" > TOTAL AUTH </th>
									</tr>
							</thead>
...
<c:url value="DATA_VERIFICATION_REPORTURL" var="searchUrl17" />
