...
<form:form action="#" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	          		<div class="card-header"><h5>ALL INDIA UE REPORT</h5></div> 
...
<c:url value="all_ind_ue_rp" var="searchUrl1" />
	<form:form action="${searchUrl1}" id="search3" name="search3" modelAttribute="from_date1">
