...
<form:form action="search_conver_restruc_reorga_redes_actionlist" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	          		<div class="card-header"><h5>COMD WISE SUMMARY</h5></div> 
		    		...
		    		<div  class="watermarked" data-watermark="" id="divwatermark" >
						<span id="ip"></span>
							...
							<thead style="background-color: #9c27b0; color: white;" align="center">
									<tr>									
									<th style="font-size: 13px" align="center" >ITEM CODE</th>
									<th style="font-size: 13px" align="center">NOMEN</th>
									...
									<th style="font-size: 13px" align="center">FF TOTAL</th>
									<th style="font-size: 13px" align="center">NFF TOTAL</th>
									<th style="font-size: 13px" align="center">TRG TOTAL</th>
...
<c:url value="comd_wise_ue_reportrp" var="searchUrl22" />
	<form:form action="${searchUrl22}" method="post" id="search3" name="search3" modelAttribute="type_of_report1">
