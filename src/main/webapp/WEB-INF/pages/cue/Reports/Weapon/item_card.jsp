...
<form:form action="#" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	          		<div class="card-header"><h5>ITEM CARD FOR PROVISIONING POLICY</h5></div> 
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>ITEM CARD FOR PROVISIONING POLICY<br>
				...
				<div id="in" style="display: none;">
					...
					<table id="SearchReport2" class="table no-margin table-striped  table-hover  table-bordered report_print">
							<thead style="background-color: #9c27b0; color: white;" align="center">
									<tr>
										<th style="font-size: 13px" align="center" >ARM SER</th>
										<th style="font-size: 13px" align="center">UNIT NAME</th>	
										<th style="font-size: 13px" align="center">AUTH</th>
										<th style="font-size: 13px" align="center" >DESCRIPTION</th>
										<th style="font-size: 13px" align="center" >SCALE</th>
										<th style="font-size: 13px" align="center" >UNITS</th>
...
<c:url value="item_card_rp" var="searchUrl20" />
	<form:form action="${searchUrl20}" method="post" id="search3" name="search3" modelAttribute="type_of_report1">
