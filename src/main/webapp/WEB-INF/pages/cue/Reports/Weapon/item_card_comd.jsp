...
<form:form action="search_conver_restruc_reorga_redes_actionlist" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	          	<div class="card-header"><h5>ITEM CARD COMD</h5></div> 
								...
								<div class="col-md-6">
									<div class="row form-group">
	                					...
	                					<div class="col-12 col-md-8">
	                						<input type="text" id="item_type" name="item_type" maxlength="255" class="form-control autocomplete" autocomplete="off" >
	          				...
	          				<div class="col-md-12">
								<div class="col-md-6">
									<div class="row form-group">
	                					...
	                					<div class="col-12 col-md-8">
	                						<input type="date" id="from_date" name="from_date" class="form-control" max='${date}' placeholder="mm-yy" class="form-control" >
								...
								<div class="col-md-6">
									<div class="row form-group">
	                					...
	                					<div class="col-12 col-md-8">
	                						<input type="date" id="to_date" name="to_date" class="form-control" max='${date}' placeholder="mm-yy" class="form-control">
		    		...
		    		<div  class="watermarked" data-watermark="" id="divwatermark" >
						<span id="ip"></span>
							...
							<thead style="background-color: #9c27b0; color: white;" align="center">
								<tr>
									<th style="font-size: 13px" align="center">ARM DESC</th>
									<th style="font-size: 13px" align="center">UNIT NAME</th>
									<th style="font-size: 13px" align="center">COMD</th>
									...
									<th style="font-size: 13px" align="center">WE PE</th>
									<th style="font-size: 13px" align="center">WE PE NO</th>
...
<c:url value="item_card_comdrp" var="searchUrl23" />
	<form:form action="${searchUrl23}" method="post" id="search3" name="search3" modelAttribute="item_type1">
		<input type="hidden" name="from_date1" id="from_date1" value=""/>
		<input type="hidden" name="to_date1" id="to_date1" value=""/>
		<input type="hidden" name="item_type1" id="item_type1" value=""/>
	</form:form>
...
function Search(){
    ...
    $("input#item_type1").val($("#item_type").val());
...
$("#item_type").keypress(function(){
	var item_type = this.value;
 	var susNoAuto=$("#item_type");
  	susNoAuto.autocomplete({
      	source: function( request, response ) {
        	$.ajax({
        		type: 'POST',
        		url: "getitemtype_report?"+key+"="+value,
		...
		minLength: 1,
      	...
      	change: function(event, ui) {
    	 	if (ui.item) {   	        	  
        		...
        		alert("Please Enter Approved Item Type.");
