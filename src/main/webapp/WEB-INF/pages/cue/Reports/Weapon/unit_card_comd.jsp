...
<form:form action="search_conver_restruc_reorga_redes_actionlist" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	          	<div class="card-header"><h5>UNIT CARD COMD</h5></div> 
					...
					<table id="SearchReport2" class="table no-margin table-striped  table-hover  table-bordered report_print">
							<thead style="background-color: #9c27b0; color: white;" align="center">
								<tr>
									...
									<th style="font-size: 13px" align="center">WEP NOMENCLATURE</th>
									<th style="font-size: 13px" align="center">BASE AUTH</th>
									<th style="font-size: 13px" align="center">FOOTNOTE AUTH</th>
									<th style="font-size: 13px" align="center">MOD AUTH</th>
...
<c:url value="unit_card_comdrp" var="searchUrl24" />
	<form:form action="${searchUrl24}" method="post" id="search3" name="search3" modelAttribute="unit_name1">
 	...
 	var susNoAuto=$("#unit_name");
  	susNoAuto.autocomplete({
      	source: function( request, response ) {
        	$.ajax({
        		type: 'POST',
        		url: "get_unit_name_report?"+key+"="+value,
