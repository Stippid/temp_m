	 ...
	 var wepetext=$("#we_pe_no_from");
	  ...
	  wepetext.autocomplete({
	      source: function( request, response ) {
	        ...
	        data: {we_pe : radio_doc , newRoleid: "at",we_pe_no : document.getElementById('we_pe_no_from').value},
...
wepetext1.autocomplete({
  source: function( request, response ) {
    ...
    data: {type : radio_doc, newRoleid: "at",suprcdd_we_pe_no : document.getElementById('suprcdd_we_pe_no').value},
      success: function( data ) {
        //response( data );
        if(data.length > 1){
    	  var susval = [];
...
<form:form name="copy_we_pe_trans" id="copy_we_pe_trans" action="copy_we_pe_transAction?${_csrf.parameterName}=${_csrf.token}" method='POST' commandName="copy_we_pe_transCMD">
	                		...
	                		<div class="col-md-12">	
	                			<div class="col-md-6">
	              					<div class="row form-group">
	                					...
	                					<div class="col-12 col-md-6">
	                  						<input  id="we_pe_no_from" name="we_pe_no_from" class="form-control autocomplete" maxlength="100" autocomplete="off" style="font-family: 'FontAwesome',Arial;" placeholder="&#xF002; Search">
	                					</div>
	                					</div>
	              					</div>	 
	              					...
	              					<div class="row form-group">
	                					...
	                					<div class="col-12 col-md-6">
	                  						<input  id="we_pe_no" name="we_pe_no" autocomplete="off" maxlength="100" class="form-control autocomplete">
	                					</div>
	                					</div>
	              					</div>             					
	            				</div>            			
						...
						<div class="col-md-12">	              					
	              			<div class="col-md-6">
	              			 	<div class="row form-group"> 
	                					...
	                					<div class="col-12 col-md-6">
	                				<input  id="suprcdd_we_pe_no" name="suprcdd_we_pe_no" maxlength="100" autocomplete="off" class="form-control"  style="font-family: 'FontAwesome',Arial;" placeholder="&#xF002; Search">
										</div>
	  								</div> 
	  						</div>
	  						<div class="col-md-6">
