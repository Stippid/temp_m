...
<form:form name="delink_WE_PE_unitTrans" id="delink_WE_PE_unitTrans" action="delink_WE_PE_unitTransAction"  method='POST' commandName="delink_WE_PE_unitTransCmd">
	<div class="animated fadeIn">
		 	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5><b>DELINK SUS NO WITH WE/PE TRANSPORT</b><br><span style="font-size:12px;color:red">(To be entered by Line Dte)</span></h5></div>
		    		...
		    		<div class="col-md-12">
		    			<div class="col-md-6">	
 							<div class="row form-group">
	                			...
	                			<div class="col-12 col-md-6">
	                  				<textarea id="wepe_trans_no" name="wepe_trans_no" class="form-control autocomplete" autocomplete="off" disabled></textarea>
	                			</div>
	                		</div>
	                	  </div>
	                	  <div class="col-md-6">
...
<script>
        ...
        var wepetext=$("#unit_sus_no");
    	  ...
    	  wepetext.autocomplete({
    	      source: function( request, response ) {
    	        $.ajax({
    	        type: 'POST',
    	        url: "getCUEUnitSUSNoList_trans?"+key+"="+value,
 ...
 function getDetailsBySusNo(val)
 {
	if(val != "" || val != null)
	{
	    ...
	    $.post("getCUEUnitsList?"+key+"="+value, {sus_no : val}, function(j) {
	         if(j !="" && j != null){
		...
		$.post("getwepeTransno?"+key+"="+value, {sus_no : val}).done(function(j) {
			if(j[0] !="" && j[0] != null){
				$("#wepe_trans_no").val(j[0][0]);  
