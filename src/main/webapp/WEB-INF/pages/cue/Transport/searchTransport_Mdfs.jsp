...
function printDiv() 
{
	var printLbl = [];
	var printVal = [];
	printDivOptimize('tableshow','SEARCH AUTHORISATION of TRANSPORT UNDER MODIFICATION',printLbl,printVal,"select#status");
}
</script>

<form id="search_transport_mdfs" name="search_transport_mdfs" encrypt="multipart/form-data" method="post" class="form-horizontal"> 
	<div class="animated fadeIn">
		<div class="">
	    	<div class="container" align="center">
	    		<div class="card">
	    				<div class="card-header"><h5><b>SEARCH AUTHORISATION of TRANSPORT UNDER MODIFICATION</b><br>
	    				<!-- <span style="font-size: 10px;font-size:15px;color:red">(To be approved by SD Dte)</span> --></h5></div>
	            			...
	            			<div class="col-md-6">
              				...
              				<div class="col-md-6">	  
	            				<div class="row form-group">
                					...
                					<div class="col-12 col-md-6">
                  						<input type="text" id="modification" name="modification" style="font-family: 'FontAwesome',Arial;" placeholder="&#xF002; Search" class="form-control autocomplete" autocomplete="off">
                					</div>
              					</div>
              				</div>
              				  <div class="col-md-6">
...
<c:url value="search_transport_mdfs1" var="searchUrl" />
...
<c:url value="ApprovedMdfs" var="appUrl" />
...
function updatedata()
{
	...
	else if((remarks != "" && remarks != null) || (letter_no != "" && letter_no != null))
	{
		var id =document.getElementById('rejectid_model').value; 
		 $.post("updaterejectactionmdfs?"+key+"="+value, {remarks : remarks,letter_no : letter_no,id : id}).done(function(j) {
			 alert(j);
