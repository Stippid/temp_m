...
function printDiv() 
{
	var printLbl = [];
	var printVal = [];
	printDivOptimize('divPrint','SEARCH INCREASE/DECREASE GENERAL NOTES FOR TRANSPORT',printLbl,printVal,"select#status");
}
</script>

<form id="search_WE_PE_footnote_for_trans" name="search_WE_PE_footnote_for_trans" action="" method="post"  class="form-horizontal"> 
	<div class="animated fadeIn">
		<div class="">
	    	<div class="container" align="center">
	    		<div class="card">
	    			<div class="card-header"><h5><b>SEARCH INCREASE/DECREASE GENERAL NOTES FOR TRANSPORT</b><br>
	            		...
	            		<div class="col-md-6">
		            		...
		            		<div class="col-md-6">	
			            		<div class="row form-group">
									...
									<div class="col-12 col-md-6">
										<input type="text" id="we_pe_no" name="we_pe_no" style="font-family: 'FontAwesome',Arial;" placeholder="&#xF002; Search" class="form-control autocomplete validate" autocomplete="off">
									</div>
								</div>
							</div>
	  					</div>	
	  					...
	  					<div class="col-md-6">	
								<div class="row form-group">
	                				...
	                				<div class="col-12 col-md-6">
	                  					<input type="text" id="table_title" name="table_title" placeholder="" class="form-control autocomplete" readonly="readonly" autocomplete="off">
	                				</div>
	              				</div>
	            			</div>
	  					 <div class="col-md-6">	
...
<div class="col s12" style="display: none;" id="divPrint">
		...
		<span id="ip"></span>
				...
				<table id="getSearchReportFootnote11" class="table no-margin table-striped  table-hover  table-bordered  report_print" >
					 <thead >
						<tr>
...
<form:form action="${updateUrl}" method="post" id="updateForm"
 ...
 <c:url value="search_WE_PE_footnote_for_trans1" var="searchUrl" />
...
<c:url value="ApprovedFootnoteUrl" var="appUrl" />
...
$(document).ready(function() {	
	...
	watermarkreport();
	if('${status1}' != ""){
		$("#getSearchReportFootnote11").show();
		var we_pe3 = '${we_pe1}';
		...
		if('${list.size()}' == 0 ){
			...
			$("table#getSearchReportFootnote11").append("<tr><td colspan='10'  style='text-align:center;'>Data Not Available</td></tr>");
		 }
	...
	$("#searchInput").on("keyup", function() {
			...
			$("#getSearchReportFootnote11 tbody tr").filter(function() { 
...
function updatedata()
{
	...
	else if((remarks != "" && remarks != null) || (letter_no != "" && letter_no != null))
	{
		...
		$.post("updateRejectaction?"+key+"="+value, {remarks : remarks,
			letter_no : letter_no,
...
function clearAll(){
	...
	var tab = $("#getSearchReportFootnote11");
	tab.empty();
 	$("#searchInput").val("");
	$("#searchInput").hide();
	  ...
	  wepetext1.autocomplete({
	      ...
	      change: function(event, ui) {
	        ...
	        select: function( event, ui ) {
	        	...
	        	var std_nomclature = ui.item.value;           
