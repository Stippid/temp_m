...
<form:form name="delink_WE_PE_unitWeapons" id="delink_WE_PE_unitWeapons" action="delink_WE_PE_unitWeaponsAction"  method='POST' commandName="delink_WE_PE_unitWeaponsCmd">
	<div class="animated fadeIn">		
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5><b>DELINK SUS NO WITH WE/PE</b><br><span style="font-size:12px;color:red">(To be entered by Line Dte)</span></h5></div>
		    		...
		    		<div class="col-md-12">
		    			...
		    			<div class="row form-group">  								
               					...
               					<div class="col-12 col-md-6">
                 					<input  id="unit_sus_no" name="sus_no"  class="form-control autocomplete" autocomplete="off" style="font-family: 'FontAwesome',Arial;" placeholder="&#xF002; Search">
								</div>
 							</div>
 							</div>
 							<div class="col-md-6">
		    			...
		    			<div class="col-md-12">
		    			   <div class="col-md-6">	
			    				<div class="row form-group">
		                			...
		                			<div class="col-12 col-md-6">
		                  				<textarea id="wepe_weapon_no" name="wepe_weapon_no" class="form-control" disabled></textarea>
		                			</div>
		                		</div>
	                		</div>
	                		<div class="col-md-6">
...
<script>
        ...
        var wepetext=$("#unit_sus_no");
    	  ...
    	  wepetext.autocomplete({
    	      source: function( request, response ) {
    	        $.ajax({
    	        type: 'POST',
    	  	    url: "getCUEUnitSUSNoList_wep?"+key+"="+value,
 ...
 function getDetailsBySusNo(val)
 {
	if(val != "" || val != null)
	{
		...
		$.post("getCUEUnitsList?"+key+"="+value, {sus_no : val}).done(function(j) {
		 ...
		 $.post("getwepeWeaponsno?"+key+"="+value, {sus_no : val}).done(function(j) {
			 if(j.length > 0){
				 $("#wepe_weapon_no").val(j[0][0]);  
 ...
 function clearDescription(){
	 document.getElementById('wepe_weapon_no').value = "";
