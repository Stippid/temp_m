...
function printDiv() 
					...
					<div class="col-md-12">
						...
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-12 col-md-6">
									<select class="form-control" id="table_title_we_pe"
										name="doc_type">
				...
				<tbody>
					<c:forEach var="item" items="${list}" varStatus="num">
						<tr>
							...
							<td>${item.doc_type}</td>
							<td>${item.arm_desc}</td>
							<td id="thAction2">${item.doc_path}</td>
	...
	<c:url value="search_WE_PE1" var="searchUrl"/>
	...
	<c:url value="Approved_WE_PE_Url" var="appUrl"/>
	...
	{  
			document.getElementById("id1").value=id;
		  	document.getElementById("contraint").value="Search";
		   	document.getElementById("pageUrl").value="search_WE_PE_Tiles";
