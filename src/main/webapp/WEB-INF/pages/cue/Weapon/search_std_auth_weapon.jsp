...
function printDiv() 
  	{
	 	...
	 	printDivOptimize('divPrint','SEARCH STANDARD AUTHORISATION FOR WEAPONS',printLbl,printVal,"select#status");
 	 }
</script>


<body>
<form:form action="AttributeReportSearchStdAuthWpn" method="post" id="standard_auth_for_weaponsFORM" name="standard_auth_for_weaponsFORM" class="form-horizontal" commandName="standard_auth_for_weaponsActionCMD"> 
	    	<div class="container" align="center">
	        	<div class="card">
	          		<div class="card-header"><h5><b>SEARCH STANDARD AUTHORISATION FOR WEAPONS</b><br>
							                ...
							                <div class="col-12 col-md-6">
					                              <div class="form-check-inline form-check">
					                                <label for="inline-radio1" class="form-check-label ">
					                                  <input type="radio" id="inline-radio1" name="we_pe" value="WE" class="form-check-input">WE
					                                </label>&nbsp;&nbsp;&nbsp;
					                                <label for="inline-radio2" class="form-check-label ">
					                                  <input type="radio" id="inline-radio2" name="we_pe" value="PE" class="form-check-input">PE
					                                </label>&nbsp;&nbsp;&nbsp;
					                                <label for="inline-radio3" class="form-check-label ">
					                                  <input type="radio" id="inline-radio3" name="we_pe" value="FE" class="form-check-input">FE
					                                </label>&nbsp;&nbsp;&nbsp;
					                                <label for="inline-radio4" class="form-check-label ">
					                                  <input type="radio" id="inline-radio4" name="we_pe" value="GSL" class="form-check-input">GSL
					                                </label>&nbsp;&nbsp;&nbsp;
					                              </div>
							                 </div>					              
	                				</div>
	                			...
	                			<div class="col-md-6">
									 ...
									 <div class="col-12 col-md-6">
				                              <input  id="we_pe_no" name="we_pe_no" class="form-control" autocomplete="off" style="font-family: 'FontAwesome',Arial;" placeholder="&#xF002; Search"> 
				                           		<input  id="hidfotnotewepeno" type="hidden"> 
				                           		<input  id="hidmdfswepeno" type="hidden">
				                     </div>					              
	                				</div>
	                			</div>
	                		</div>
...
<div style="width: 20%; padding-left: 1%; display: none;" id="divSerachInput">
	...
	<c:url value="search_std_auth_weapon1" var="searchUrl" />
 		<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="we_pe_no1">
 			...
 			<input type="hidden" name="nomenClature1" id="nomenClature1" value="0"/>
 			<input type="hidden" name="we_pe1" id="we_pe1" value="0"/>
 			<input type="hidden" name="status1" id="status1" value="0"/>
 		</form:form> 
    			
	<c:url value="ApprovedPSawUrl" var="appUrl" />
	<form:form action="${appUrl}" method="post" id="appForm" name="appForm" modelAttribute="appid">
		...
		<input type="hidden" name="nomenClature2" id="nomenClature2" value="0"/>
		<input type="hidden" name="auth_weapon2" id="auth_weapon2" value="0"/>
        	...
        	<div class="form-group">	 
				...
				<div class="row" style="color: maroon; font-size: 16px; font-weight: bold;">
					<div class="col-sm-6">				 
						...
						<input type="radio" name="chk_model" value="Error"  onclick="modeldocument();" > Error<br>
					</div>
					<div class="col-sm-6">
		        		<input type="radio" name="chk_model" value="Ammedment" onclick="modeldocument();"> Amendment<br>
		        	</div>
...
function getWePeNoByType(we_pe1)
	...
	$(document).ready(function() {
		...
		if('${status1}' != ""){
			...
			$("#nomenClature").val('${nomenClature1}');
			$("#auth_weapon").val('${auth_weapon1}');
			$("#auth_weapon").val('${auth_weapon1}');
			...
			if('${list.size()}' == 0 ){
				...
				$("table#WeaponReport1").append("<tr><td colspan='7' style='text-align :center;'>Data Not Available</td></tr>");
			 }
		}
	  ...
	  else
	  {
		  ...
		  document.getElementById("item_seq_no").value="";
	  		 ...
	  		 function Search(){
	  	       ...
	  	       $("#nomenClature1").val($("#nomenClature").val());
	  		 ...
	  		 function Approved(id){
	    		  	...
	    		  	$("#auth_weapon2").val($("#auth_weapon").val());
	 	  	       $("#item_seq_no2").val($("#item_seq_no").val());
	 	  	    	$("#nomenClature2").val($("#nomenClature").val());
...
function updatedata()
{
	...
	else if((remarks != "" && remarks != null) || (letter_no != "" && letter_no != null))
	{
		...
		var id =document.getElementById('rejectid_model').value; 
	     $.post("updaterejectweapon?"+key+"="+value, {remarks : remarks,
				letter_no : letter_no,
