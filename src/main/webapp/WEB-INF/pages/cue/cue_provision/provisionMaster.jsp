...
function printDiv() 
  	{
	 	...
	 	printDivOptimize('divPrint','PROVISION POLICY (WEAPON)',printLbl,printVal,"select#status");
 	 }
</script>
...
<form:form name="provision_policyForm" id="provision_policyForm" action="provisionMstAct" method='POST' commandName="provisionMstCmd" > 
	<div class="animated fadeIn">
		 	<div class="container" align="center">
	    		<div class="card">
	          		<div class="card-header"><h5><b>PROVISION POLICY</b><br><span style="font-size:12px;color:red">(To be entered by MISO)</span></h5></div>
	          		<div class="card-body card-block cue_text">
	          			...
	          			<div class="col-md-12">	
	  						...
	  						<div class="row form-group">	           					
             					...
             					<div class="col-12 col-md-6">
                					<input id="month_cal" name="month_cal" type="number" min="1" max="12" step="1" maxlength="2" class="form-control"/>
             					</div>
             				</div>
             				</div>	
             				<div class="col-md-6">
	  						<div class="row form-group">	           					
             					...
             					<div class="col-12 col-md-6">
             						<input id="year_cal" name="year_cal" type="number" min="1900" max="2099" step="1" maxlength="4" class="form-control"/>
               					</div>
             				</div>
             				</div>	           					
	  					</div>	
	  					...
	  					<div class="col-md-12">	              					
	              			...
	              			<div class="row form-group">              			 	
               					...
               					<div class="col-12 col-md-6">
                 					<input id="letter_no" name="letter_no" class="form-control" maxlength="50">
								</div>
							</div>	 							
	  						</div>
	  						<div class="col-md-6">	
	              			<div class="row form-group">              			 	
               					...
               					<div class="col-12 col-md-6">
                 					<input id="letter_date" name="letter_date" class="form-control" maxlength="10" placeholder="dd-MM-yyyy">
								</div>
							</div>	 							
	  						</div>
	  					</div>
	          			...
	          			<div class="col-md-12">	              					
	              			...
	              			<div class="row form-group">              			 	
               					...
               					<div class="col-12 col-md-6">
                 					<input  id="we_pe_no" name="we_pe_no" maxlength="100" class="form-control" autocomplete="off" onchange="getArmByWePeNo(this.value);" style="font-family: 'FontAwesome',Arial;" placeholder="&#xF002; Search">
	  						...
	  						<div class="row form-group">	           					
             					...
             					<div class="col-12 col-md-6">
               						<input id="wet_pet_no"  name="wet_pet_no" class="form-control" maxlength="50" autocomplete="off" style="font-family: 'FontAwesome',Arial;" placeholder="&#xF002; Search">
             					</div>
             				</div>
             				</div>	 	
	  					</div>	
	            		...
	            		<div class="col-md-12">	              					
	              			...
	              			<div class="row form-group">              			 	
               					...
               					<div class="col-12 col-md-6">
                 					<input id="unit_type" name="unit_type" class="form-control" maxlength="150" autocomplete="off" >
								</div>
							</div>	 							
	  						</div>
	  						<div class="col-md-6">	
					...
					<div>
						...
						<input type="hidden" id="stItemHidWetPetNo" name="stItemHidWetPetNo">
						<input type="hidden" id="stAmtHidWetPetNo" name="stAmtHidWetPetNo">
					...
					<div class="" id="divModId" style="display: none;" align="center">
						...
						<div class="col-md-12">
			              	<table id="tblData2" class="table no-margin table-striped  table-hover  table-bordered" width="100%">
								<thead>
									<tr><th style="width: 6%;text-align: center">Ser No</th><th></th><th>Modification</th><th>No of Units</th></thead>
								<tbody id="tbodyModId1">							 
		  						</tbody>
							</table>
		              	</div>
		              </div>
	              	...
	              	<div class=""  id="divFootnoteId" style="display: none;" align="center">
						...
						<div class="col-md-12">
			              	<table id="tblData1" class="table no-margin table-striped  table-hover  table-bordered" width="100%">
								<thead>
									<tr><th style="width: 6%;text-align: center">Ser No</th><th style="display : none;">Id</th><th></th><th>Condition</th>
									<th style="display : none;">Item Code</th><th>Nomenclature</th><th>Scenario</th>
									<th>Loc/ Fmn/ Unit</th><th style="display : none;">Loc/Form/Unit Code</th>
					...
					<div class="col-md-12">
			              	<table id="tblData1" class="table no-margin table-striped  table-hover  table-bordered" >
								<thead>
									<tr  style="width: 6%;text-align: center"><th>Ser No</th>
									<th></th><th>Nomenclature</th>
									<th>Authorisation Amt</th>
									</thead>
...
<input id="searchInput" type="text" style="font-family: 'FontAwesome',Arial;width: 20%; padding-left: 1%;display: none;border-left-width: 2px;margin-left: 14px;;margin-bottom: 4px" placeholder="&#xF002; Search Word"  size="35" class="form-control" >
 <div class="col s12" style="display: none;" id="divPrint">
				...
				<div  class="watermarked" data-watermark="" id="divwatermark" style="display: block;">
					<span id="ip"></span>
		<table id="AttributeReportwep" class="table no-margin table-striped  table-hover  table-bordered report_print" >
			<thead>
				<tr>
...
<div id="newPage" class="tabcontent">
 <form:form name="copy_provision_policyForm" id="copy_provision_policyForm" action="copy_provision_policyAct" method='POST' commandName="copy_provision_policyCmd" > 
	<div class="animated fadeIn">
		 	<div class="container" align="center">
	    		<div class="card">
	          		<div class="card-header"><h5><b>COPY PROVISION POLICY</b><br><span style="font-size:12px;color:red">(To be entered by MISO)</span></h5> </div>
	          		<div class="card-body card-block cue_text">
	          		...
	          		<div class="col-md-12">	
	  						...
	  						<div class="row form-group">	           					
             					...
             					<div class="col-12 col-md-5">
                					<input id="month_cal_old" name="month_cal_old" type="number" min="1" max="12" step="1" maxlength="2" class="form-control"/>
             					</div>
             				</div>
             				</div>	
             				<div class="col-md-6">
	  						<div class="row form-group">	           					
             					...
             					<div class="col-12 col-md-5">
             						<input id="year_cal_old" name="year_cal_old" type="number" min="1900" max="2099" step="1" maxlength="4" class="form-control"/>
               					</div>
             				</div>
             				</div>	           					
	  					</div>	
	          			...
	          			<div class="col-md-12">	
	  						...
	  						<div class="row form-group">	           					
             					...
             					<div class="col-12 col-md-5">
                					<input id="month_cal_new" name="month_cal_new" type="number" min="1" max="12" step="1" maxlength="2" class="form-control"/>
             					</div>
             				</div>
             				</div>	
             				<div class="col-md-6">
	  						<div class="row form-group">	           					
             					...
             					<div class="col-12 col-md-5">
             						<input id="year_cal_new" name="year_cal_new" type="number" min="1900" max="2099" step="1" maxlength="4" class="form-control" />
               					</div>
             				</div>
             				</div>	           					
	  					</div>	
	  					...
	  					<div class="col-md-12">	              					
	              			...
	              			<div class="row form-group">              			 	
               					...
               					<div class="col-12 col-md-5">
                 					<input id="letter_no_new"  name="letter_no_new" class="form-control" maxlength="50">
								</div>
							</div>	 							
	  						</div>
	  						<div class="col-md-6">	
	              			<div class="row form-group">              			 	
               					...
               					<div class="col-12 col-md-5">
                 					<input id="letter_date_new" name="letter_date_new" class="form-control" maxlength="10" placeholder="dd-MM-yyyy">
								</div>
							</div>	 							
	  						</div>
	  					</div>
...
<c:url value="ProvisionMstUrl1" var="searchUrl" />
   		<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="month_cal1">
...
function deleteData(id){
	$.post("deleteProWepUrlAdd?"+key+"="+value, {deleteid : id}).done(function(j) {
    	alert(j);
		Search();
...
function getAllDetails()
{
		...
		for(var i=0; i< checkboxf.length; i++) {
			if(checkboxf[i].checked)
		    {
				...
				var idf="condition"+checkboxf[i].value;
					...
					footArray.push(document.getElementById("condition"+checkboxf[i].value).value);
				...
				var idfAm="amt"+checkboxf[i].value;
					...
					footAmtarray.push(document.getElementById("amt"+checkboxf[i].value).value);
				...
				if($('input#'+idfU).val() == "")
				{
					...
					footUnitsArray.push(document.getElementById("no_of_unitsf"+checkboxf[i].value).value);			
	...
	if(isVisibleStand == false)
	{
		...
		if(stItemArray != "" || stItemArray != null  )
		{
	...
	var wepetext1=$("#we_pe_no");
	  ...
	  wepetext1.autocomplete({
	      source: function( request, response ) {
	        ...
	        data: {newRoleid : "aw",we_pe_no: document.getElementById('we_pe_no').value},
	      ...
	      change: function(event, ui) {
	    	 if (ui.item) {   	        	  
	        	  ...
	        	  $("tbody#tbodyModId1").empty();
	        		...
	        		document.getElementById("wetItemHid").value="";
	        		document.getElementById("wetAmtHid").value="";
	        	  wepetext1.focus();
	        	  return false;	             
	          }   	         
	      }, 
...
$(document).ready(function() {
	...
	if('${month_cal1}' !="")
	{
		...
		if('${list.size()}' == 0 ){
			...
			$("table#AttributeReportwep").append("<tr><td colspan='5' style='text-align :center;'>Data Not Available</td></tr>");
		 }
	}
	...
	$("#searchInput").on("keyup", function() {
			...
			$("#AttributeReportwep tbody tr").filter(function() { 
	...
	try{
		...
		if(m.includes("Updated+Successfully")){
			window.opener.getRefreshReport('prov_weap',m);
...
function getArmByWePeNo(val)
{
	  if(val != "" && val != null)
	  {
		 ...
		 bindFootnote(val);
		 bindStandard(val);
		 bindWet_petdetail(document.getElementById("wet_pet_no").value);
		// bindWeyPet(val);
	  }
	  else
	  {
    ...
    $.post("getModByWeaponByWePeNo?"+key+"="+value, {we_pe_no : val}).done(function(j) {
		...
		{	
			...
			for(var i=0; i<j.length; i++)
			{
				k=k+1;
				row += '<tr>';
				row += '<td style="width: 6%;text-align: center"><label class="form-control-label">'+k+'</label></td>';
				row += '<td><input type="hidden" id="itemcode_tbl'+i+'" value="'+j[i][1]+'" class="form-control"><input type="checkbox" id="checkm'+i+'" value="'+i+'" name="checkm[]" class="form-control" style="width: 15px;"></td>';
				row += '<td><input type="hidden" id="amtincdec_tbl'+i+'" value="'+j[i][2]+'" class="form-control"><input id="mod'+i+'" class="form-control" value="'+j[i]+'" readonly="readonly"></td>';
				row += '<td><input id="no_of_unitsm'+i+'" class="form-control" maxlength="4" onkeypress="return validateNumber(event, this);"></td>';
				row += '</tr>';								
			}
			$("tbody#tbodyModId1").append(row);
		 }
     }).fail(function(xhr, textStatus, errorThrown) { });
    ...
    $.post("AttributeReportSearchfootnote24?"+key+"="+value, {we_pe_no : val, status : "1"}).done(function(j) {
			...
			for(var i=0; i<j.length; i++)
			{
				if(j[i].condition != "" && j[i].condition != null && j[i].condition != "null" && j[i].condition != "undefined")
				{
					...
					row += '<td><input type="checkbox" id="checkf'+i+'" value="'+i+'" name="checkf[]" class="form-control" style="width:15px;"></td>';
					row += '<td><input id="condition'+i+'" class="form-control" value="'+j[i].condition+'" readonly="readonly"></td>';
					row += '<td style="display : none;"><input type="text" id="item'+i+'" class="form-control" value="'+setItem+'" readonly="readonly"></td>';
					row += '<td><input type="text" id="itemName'+i+'" class="form-control" value="'+j[i].item_type+'" readonly="readonly"></td>';
					...
					row += '<td><input id="no_of_unitsf'+i+'" maxlength="4" class="form-control" onkeypress="return validateNumber(event, this);"></td>';
					row += '</tr>';
				}
				else
				{
...
function bindWet_petdetail(val) {
	var ItemArrayWetpetno=[], AmtArrayWetpetno=[];
	$.post("getWet_petdetailByWetPetNo?"+key+"="+value, {wet_pet_no : val}).done(function(j) {
		for(var i=0; i< j.length ;i++)
		{
			ItemArrayWetpetno.push(j[i][0]);
			AmtArrayWetpetno.push(j[i][1]);
		}
	 	document.getElementById("stItemHidWetPetNo").value=ItemArrayWetpetno.join('|');
	 	document.getElementById("stAmtHidWetPetNo").value=AmtArrayWetpetno.join('|'); 
     }).fail(function(xhr, textStatus, errorThrown) { });
}
		 ...
		 var k=0;
			for(var i=0; i<j.length; i++)
			{
				if(j[i][0] != "" && j[0] != null && j[0] != "null" && j[0] != "undefined")
				{
					...
					$.post("getStandardByWeaponByWePeNo?"+key+"="+value, {val : setItem}).done(function(j) {
