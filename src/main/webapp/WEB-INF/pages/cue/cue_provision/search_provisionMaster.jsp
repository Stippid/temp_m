...
function printDiv() 
  	{
	 	...
	 	printDivOptimize('divPrint','SEARCH PROVISION POLICY (WEAPON)',printLbl,printVal,"select#status");
 	 }
</script>
...
<form action="" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn">
		 	<div class="container" align="center">
	    		<div class="card">
	    			<div class="card-header"> <h5><b>SEARCH PROVISION POLICY</b><br><span style="font-size:12px;color:red">(To be approved by MISO)</span></h5></div>
	            			...
	            			<div class="col-md-6">
             				...
             				<div class="col-md-6">
	  						<div class="row form-group">	           					
             					...
             					<div class="col-12 col-md-6">
             						<input id="year_cal" name="year_cal" type="number" min="1900" max="2099" step="1" class="form-control"/>
               					</div>
             				</div>
             				</div>
...
<div style="width: 20%; padding-left: 1%; display: none;" id="divSerachInput">
 ...
 <div class="col s12" style="display: none;" id="divPrint">
	...
	<c:url value="searchProvisionMstUrl1" var="searchUrl" />
	...
	<c:url value="ApprovedProWepUrl" var="appUrl" />
	<form:form action="${appUrl}" method="post" id="appForm" name="appForm" modelAttribute="appid">
		...
		<c:url value="rejectProWepUrl" var="rejectUrl" />
	<form:form action="${rejectUrl}" method="post" id="rejectForm" name="rejectForm" modelAttribute="rejectid">
		...
		<input type="hidden" name=year_cal3 id="year_cal3" value="0"/>
   		<input type="hidden" name="we_pe_no3" id="we_pe_no3" value="0"/>
   		<input type="hidden" name="month_cal3" id="month_cal3" value="0"/>
		<input type="hidden" name="letter_no3" id="letter_no3" value="0"/>
		<input type="hidden" name="force_type3" id="force_type3" value="0"/>
	...
	if('${month_cal1}' != "")
		{ 
			...
			if('${list.size()}' == 0 ){
				 ...
				 $("table#AttributeReportwep").append("<tr><td colspan='6' style='text-align :center;'>Data Not Available</td></tr>");
			 }
		 }
	    ...
	    var wepetext=$("#we_pe_no");
		  ...
		  wepetext.autocomplete({
		      source: function( request, response ) {
		        ...
		        data: {type1 : "", newRoleid : "aw",we_pe_no: document.getElementById('we_pe_no').value},
...
function Reject(id){
	...
	$("#year_cal3").val($("#year_cal").val());
	$("#we_pe_no3").val($("#we_pe_no").val());
	$("#month_cal3").val($("#month_cal").val());
	$("#letter_no3").val($("#letter_no").val());
	$("#force_type3").val($("#force_type").val());
