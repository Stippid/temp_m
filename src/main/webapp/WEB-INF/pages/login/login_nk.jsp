...
<body oncontextmenu="return false">
		<header id="header" class="header">
			<div class="header-menu nAppBgPlate6">
	    		<div class="row ">
					...
					<div class="col-8 col-sm-10"><div class="heading_contenta nloginheading" ><span>M</span>ANAGEMENT <span>I</span>NFORMATION <span>S</span>YSTEM <span>O</span>RGANISATION&nbsp;<span><sup style="font-size:1rem;">Ver 3.1</sup></span><b style="display:none;" id="div_timeout">60</b></div></div>
...
<div class="content banner">
			<div class="middle_content" id="login">
				...
				<div class="col-10" style="padding: 0;">
					...
					<!-- chatbot janki code -->
					<%-- <tiles:insertAttribute name="chbot_login" /> --%>
					<!-- CHATBOT JANKI END  -->							
			<div class="digital_india" style="position:fixed;bottom:20px;left:5px;"><img src="login_file/digitalindia.png" class="img-fluid"></div>
			</div>
			</div>
				<div class="row">
					<div class="container">
							...
							<div class="login-form">
								<form role="form"  name='loginForm' action="#" method='POST' id="myFormId" class="login-form inputHeight">
									<div class="form-group">
										<input id="username" type='text' name='username' style="color:yellow;background-color:#918d8d" class="form-control disablecopypaste" maxlength="30" size="35" autocomplete="off" placeholder="Enter Username">					
									</div>
									<div class="form-group">
										<input id="password" type='password' name='password' style="color:yellow;background-color:#918d8d" class="form-control disablecopypaste" maxlength="28" size="35" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[@#$%!^\\&_.~*]).{8,28}$" autocomplete="off" placeholder="Enter Password"  />
									</div>
									<div class="row">
										<div class="col-md-6 col-sm-6 col-xs-12 enter_captcha">
											<div class="form-group">
												<input type='text' class="form-control disablecopypaste" size="35" id="txtInput" name="txtInput"  placeholder="Captcha"  autocomplete="off" style="color:yellow;background-color:#918d8d"/>	
											</div>
										</div>
									...
									<div class="form-group login"><center>
										<button style=type="submit" class="btn btn-success" onclick="return validation();">LOGIN</button>
										<div class="tooltip">
											<a>Reset Password</a>
...
function snGetNews() {
	var key = "${_csrf.parameterName}";
 	var value = "${_csrf.token}";
 	jQuery.post("generateWhatsNew?"+key+"="+value, function(j) {
 		alert(j);
		$("#nNews").text(j);
 	});
};
