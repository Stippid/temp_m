...
<body class="mmsbg">
<form:form name="army_store" id="army_store" action="Mms_Holding_Ls_CaptureAction?${_csrf.parameterName}=${_csrf.token}"  commandName="Mms_Holding_Ls_CaptureCMD" enctype="multipart/form-data" method="post"> 
	<div class="">
	        	   ...
	        	   <div class="card-header mms-card-header">
		    			...
		    			<div class="card-body card-block">
		    				<div class="col-md-12 row form-group" style="margin-top: -10px;">	            					
                				...
                				<div class="col-md-3">
                					<input type="hidden" id="store_type" name="store_type"	value="ACSFP"	>											
									<select name="loan_sanc_auth" id="loan_sanc_auth" class="form-control-sm form-control" >	
		    				...
		    				<div class="col-md-12 row form-group" style="margin-top: -20px;">		 
                				...
                				<div class="col-md-5">
                  					<input type="text" id="iv_by_unit_name" name="iv_by_unit_name" placeholder="Search Issuing Auth Unit Name..." class="form-control-sm form-control autocomplete" maxlength="100" autocomplete="off">
								</div>
								<div class="col-md-2" style="text-align: left;">
                  					<label class=" form-control-label"><strong style="color: red;">* </strong>Depot No</label>
                				</div>
                				<div class="col-md-3">
                					<input type="text" id="iv_by_sus_no" name="iv_by_sus_no" placeholder="Search Issuing Auth SUS No..." class="form-control-sm form-control autocomplete" maxlength="8" autocomplete="off">
		    				...
		    				<div class="col-md-12 row form-group" style="margin-top: -10px;">		 
                				...
                				<div class="col-md-3">
                  					<input type="text" id="auth_letter_no" name="auth_letter_no" placeholder="Enter Auth Letter No..." class="form-control-sm form-control" maxlength="50" autocomplete="off" >
								</div>
								<div class="col-md-2">
								</div>
								<div class="col-md-2" style="text-align: left;">
                				...
                				<div class="col-md-3">
                					<input type="date" id="auth_letter_date" name="auth_letter_date" class="form-control-sm form-control" autocomplete="off" >
								</div>			
		  					</div>
		    				<div class="col-md-12 row form-group" style="margin-top: -20px;">		 
              					<div class="col-md-2" style="text-align: left;" >
                  					<label class=" form-control-label"> <strong style="color: red;">* </strong>Letter No</label>
                				</div>
                				<div class="col-md-3">
                  					<input type="text" id="govt_letter_no" name="govt_letter_no" placeholder="Enter Command Letter No..." class="form-control-sm form-control" autocomplete="off">
								</div>
								<div class="col-md-2">
								</div>
								<div class="col-md-2" style="text-align: left;">
                				...
                				<div class="col-md-3">
                					<input type="file" id="upload_auth_letter1" name="upload_auth_letter1"  onchange="checkFileExtImage(this)" autocomplete="off" class="form-control-sm form-control">
								</div>			
		  					</div>
		    			</div>
		    		<div class="card-header" style="border: 1px solid rgba(0,0,0,.125);margin-top: -15px;">
		    			...
		    			<div class="card-body card-block">	
		    				<div class="col-md-12 row form-group">		 
                				...
                				<div class="col-md-5">
                  					<input type="text" id="unit_name1" name="unit_name1" placeholder="Search..." class="form-control-sm form-control autocomplete" maxlength="100" autocomplete="off">
								</div>
								<div class="col-md-2" style="text-align: left;">
                  					<label class=" form-control-label"><strong style="color: red;">* </strong>SUS No</label>
                				</div>
                				<div class="col-md-3">
                					<input type="text" id="sus_no1" name="sus_no1" placeholder="Search..." class="form-control-sm form-control autocomplete" maxlength="8" autocomplete="off">
		    				...
		    				<div class="col-md-12 row form-group" style="margin-top: -10px;">		 
                				...
                				<div class="col-md-3">
                  					<input type="text" id="iv_no" name="iv_no" placeholder="Enter IV No..." class="form-control-sm form-control" maxlength="50" autocomplete="off">
								</div>
                				...
                				<div class="col-md-3">
                					<input type="date" id="iv_date" name="iv_date" class="form-control-sm form-control" autocomplete="off">
								</div>			
		  					</div>
		  					<div class="col-md-12 row form-group" style="margin-top: -10px;">
		                			<div class="col-md-2" style="text-align: left;">
		    				...
		    				<div class="col-md-12 row form-group" style="margin-top: -10px;">		 
                				...
                				<div class="col-md-3">
                  					<input type="text" id="qty" maxlength="4" name="qty" class="form-control-sm form-control" placeholder="Max Four Character" onkeyup="formopen($(this).val())">
								</div>
								<div class="col-md-2">
	  							</div>
	  							<div class="col-md-2" style="text-align: left;">
                				...
                				<div class="col-md-3">
                					<input type="file" id="upload_voucher1" name="upload_voucher1" onchange="checkFileExtImage(this)" autocomplete="off" class="form-control-sm form-control">
								</div>			
		  					</div>
		    				<div class="col-md-12 row form-group" style="margin-top: -10px;">		 
              					<div class="col-md-2" style="text-align: left;">
                				...
                				<div class="col-md-10">
                  					<textarea id="rem" name="rem" class="form-control-sm form-control" placeholder="Enter Remarks..." maxlength="200"></textarea>
								</div>		
		  					</div> 				
		    			</div>
					...
					<div class="card-footer" align="center">
						<input type="button" class="btn btn-primary btn-sm" value="Clear" onclick="btn_clc();" />     
		              	<input type="button" class="btn btn-success btn-sm" value="Submit" onclick="return validate();">
...
function validate(){
	...
	if($("#loan_sanc_auth").val() == "-1"){
		alert("Please Enter the Loan Sanction Auth.");
		$("#loan_sanc_auth").focus();
		return false;
	}
	else if($("#iv_by_unit_name").val() == ""){
		alert("Please Enter the Issued By Auth Unit Name.");
		$("#iv_by_unit_name").focus();
		return false;
	}	
	else if($("#iv_by_sus_no").val() == ""){
		alert("Please Enter the Issued By Auth SUS No.");
		$("#iv_by_sus_no").focus();
		return false;
	}
	...
	else if($("#govt_letter_no").val() == ""){
		alert("Please Enter Command Letter No.");
		$("#govt_letter_no").focus();
		return false;
	}
...
$("#iv_by_sus_no").keyup(function(){
	...
	var para = "";
	var paravalue="";
	$().Autocomplete2('POST','getMMSRList',iv_by_sus_no,{a:sus_no,b:para,c:"DSUS",d:paravalue},'getMMSUnitNameBySUSNo',iv_by_unit_name);
});
...
$("#iv_by_unit_name").keyup(function(){
	...
	var para = "";
	var paravalue="";
	$().Autocomplete2('POST','getMMSRList',iv_by_unit_name,{a:unit_name,b:para,c:"DNAME",d:paravalue},'getMMSSUSNoByUnitName',iv_by_sus_no);
});
