...
<body class="mmsbg">
<form:form name="loan_store" id="loan_store" action="Mms_Holding_Ls_CaptureAction?${_csrf.parameterName}=${_csrf.token}"  commandName="Mms_Holding_Ls_CaptureCMD" enctype="multipart/form-data" method="post"> 
	...
	<div class="">
	      <div class="container" align="center">
	           <div class="card">
		            ...
		            <div class="card-header" style="border: 1px solid rgba(0,0,0,.125); text-align: center;" id="aa"> <strong>PARENT UNIT DETAILS</strong></div>
		    			...
		    			<div class="card-body card-block"> 
		    			    <div class="col-md-12 row form-group" style="margin-top: -10px;">	            					
                				...
                				<div class="col-md-3">
                					<input type="hidden" id="store_type" name="store_type" value="LOANAUTHORITY">							
		    				...
		    				<div class="col-md-12 row form-group" style="margin-top: -20px;">		 
              					<div class="col-md-2" style="text-align: left;">
                  					<label class=" form-control-label"><strong style="color: red;">* </strong>Loan Expiry Date </label>
                				</div>
                				<div class="col-md-3">
                  					<input type="date" id="loan_expiry_date" name="loan_expiry_date"  placeholder="" class="form-control-sm form-control" autocomplete="off" required>
								</div>
								...
								<div class="col-md-2">
					             ...
					             <div class="col-md-3">
									<input type="file" id="upload_auth_letter1" name="upload_auth_letter1" class="form-control-sm form-control" onchange="checkFileExtImage(this)" autocomplete="off" required>
								</div>			
		  					</div>
		    			</div>
		    			
			    		<div class="card-header" style="border: 1px solid rgba(0,0,0,.125); text-align: center;margin-top: -10px;" id="aa"> <strong>RECEIVING UNIT DETAILS</strong></div>
		    			...
		    			<div class="card-body card-block">	
		    				...
		    				<div class="col-md-12 row form-group" style="margin-top: -10px;">		 
                				...
                				<div class="col-md-3">
                  					<input type="text" id="iv_no" name="iv_no" placeholder="Enter IV No..." class="form-control-sm form-control" maxlength="50" autocomplete="off"  required>
								</div>
...
function validate(){
	...
	else if($("#loan_expiry_date").val() == ""){
		alert("Please Enter the Loan Expiry Date.");
		$("#loan_expiry_date").focus();
		return false;
	}
