				...
				<div class="card">
					...
					<div class="card-body card-block" style="text-align: left;">
						<div class="col-md-12 row form-group">
							...
							<div class="col-md-3">
								<input type="text" id="census_no" name="census_no" placeholder="Search..." class="form-control-sm form-control" autocomplete="off" tabindex="1"/>
							</div>
						</div>
						...
						<div class="col-md-12 row form-group" style="margin-top: -5px;">
							...
							<div class="col-md-9">
								<textarea id="nomen" name="nomen" placeholder="Search..." class="form-control-sm form-control" autocomplete="off"></textarea>
							</div>
						</div>
						...
						<div class="col-md-12 row form-group" style="margin-top: -5px;display: none;" id="b_data1">
							...
							<div class="col-md-9">
								<input type="text" id="cat_part_no" name="cat_part_no" class="form-control-sm form-control" readonly="readonly">
							</div>
						...
						<div class="col-md-12 row form-group" style="margin-top: -5px;display: none;" id="b_data2">
							...
							<div class="col-md-9">
								...
								<input type="hidden" id="prf_code" name="prf_code" class="form-control" />
							</div>
