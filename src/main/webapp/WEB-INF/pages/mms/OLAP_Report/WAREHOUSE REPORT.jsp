...
<form:form action="search_conver_restruc_reorga_redes_actionlist" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>WAREHOUSE REPORT</h5></div>
						...
						<span id="ip"></span>
							...
							<thead style="background-color: #9c27b0; color: white;" align="center">
									...
									<tr>
										...
										<th style="font-size: 13px" align="center"> NORMAL </th>
										<th style="font-size: 13px" align="center"> BATTLE CAS </th>
										<th style="font-size: 13px" align="center"> OTHERS </th>
										<th style="font-size: 13px" align="center"> TOTAL </th>
										<th style="font-size: 13px" align="center"> WASTAGE IN DEPOTS </th>
										<th style="font-size: 13px" align="center"> TOTAL WASTAGE ARISING </th>
...
<c:url value="WAREHOUSE_REPORT" var="searchUrltms13" />
