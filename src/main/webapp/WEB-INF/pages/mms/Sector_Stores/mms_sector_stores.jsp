...
<body class="mmsbg">
<form:form name="sector_store" id="sector_store" action="Mms_Holding_Ls_CaptureAction?${_csrf.parameterName}=${_csrf.token}"  commandName="Mms_Holding_Ls_CaptureCMD" method="post" enctype="multipart/form-data"><!--  method="post" enctype="multipart/form-data"> --> 
	           ...
	           <div class="card">
		    		...
		    		<div class="card-body card-block">
		    				<div class="col-md-12 row form-group" style="margin-top: -10px;">	            					
                				...
                				<div class="col-md-3">
                					<input type="hidden" id="store_type" name="store_type" value="SECTORAUTHORITY">										
								    <select name="loan_sanc_auth" id="loan_sanc_auth" class="form-control-sm form-control" required>	
		    				...
		    				<div class="col-md-12 row form-group" style="margin-top: -10px;">		 
                				...
                				<div class="col-md-3">
                  					<input type="text" id="auth_letter_no" name="auth_letter_no"  placeholder="Enter Auth Letter No..." class="form-control-sm form-control" autocomplete="off" maxlength="50" required>
								</div>
                				...
                				<div class="col-md-3">
                					<input type="date" id="auth_letter_date" name="auth_letter_date" class="form-control-sm form-control" autocomplete="off" required>
								</div>			
		  					</div>
		    				
		    				<div class="col-md-12 row form-group" style="margin-top: -20px;">		 
              					<div class="col-md-2" style="text-align: left;">
                  					<label class=" form-control-label" style="font-size: 15px;"><strong style="color: red;">* </strong>Sector Expiry Date </label>
                				</div>
                				<div class="col-md-3">
                  					<input type="date" id="sector_expiry_date" name="sector_expiry_date"  placeholder="" class="form-control-sm form-control" autocomplete="off" required>
								</div>
		    				...
		    				<div class="col-md-12 row form-group" style="margin-top: -20px;">		 
              					<div class="col-md-2" style="text-align: left;">
                  					<label class=" form-control-label"><strong style="color: red;">* </strong>Govt Letter No </label>
                				</div>
                				<div class="col-md-5">
                  					<input type="text" id="govt_letter_no" name="govt_letter_no" placeholder="Enter Govt Letter No..." class="form-control-sm form-control" autocomplete="off" maxlength="50" required>
								</div>	  																
		  					</div>	    				
		    			</div>
		    		<div class="card-header" style="border: 1px solid rgba(0,0,0,.125);margin-top: -15px;">  
		    			...
		    			<div class="card-body card-block">	
		    				...
		    				<div class="col-md-12 row form-group">		 
                				...
                				<div class="col-md-3">
                					<input type="text" id="sus_no1" name="sus_no1" placeholder="Search..." class="form-control-sm form-control autocomplete" autocomplete="off" maxlength="8" required>
		    				...
		    				<div class="col-md-12 row form-group" style="margin-top: -10px;">		 
                				...
                				<div class="col-md-3">
                  					<input type="text" id="qty" maxlength="4" name="qty" class="form-control-sm form-control" placeholder="Max Four Character" onkeyup="formopen($(this).val())" required>
								</div>
		    				...
		    				<div class="col-md-12 row form-group" style="margin-top: -10px;">		 
                				...
                				<div class="col-md-10">
                  					<!-- <input type="text" id="rem" name="rem" placeholder="" class="form-control-sm form-control" autocomplete="off" > -->
...
function validate(){
	...
	if($("#loan_sanc_auth").val() == "-1"){
		...
		alert("Please Select the Auth Letter Date.");
	...
	else if($("#sector_expiry_date").val() == ""){
		alert("Please Enter the Sector Expiry Date.");
		$("#sector_expiry_date").focus();
		return false;
	}
		...
		alert("Please Enter Govt Letter No.");
...
$(document).ready(function() {
	...
	var f_d = new Date('${ml_2[0]}');
	var e_date = f_d.getFullYear()+"-"+("0" + (f_d.getMonth()+1)).slice(-2)+"-"+("0" + f_d.getDate()).slice(-2);
	$("#sector_expiry_date").val(e_date);
	...
	$('#auth_letter_date').change(function(){
		var d = $('#auth_letter_date').val();
                $.post("getExtendDateOnChange?"+key+"="+value, {
                	d:d
            }, function(j) {
