...
%>
<form:form id="mms_inter_unit_tfr" name="mms_inter_unit_tfr" action="mms_inter_unit_tfrAction?${_csrf.parameterName}=${_csrf.token}" method='POST' commandName="mms_inter_unit_tfrCMD" enctype="multipart/form-data">
		<div class="">
		                 ...
		                 <div class="card-body card-block">         
					              ...
					              <div class="col-md-12 row form-group" style="margin-top: -10px;">
		  				         ...
		  				         <%	if (nPara.equalsIgnoreCase("ITFR") || nPara.equalsIgnoreCase("IDEP")) { %>
				  				       <div class="col-md-12 row form-group" style="margin-top: -10px;">
					             	 		 <div class="col-md-2" style="text-align: left;"> 
						               			  <label class=" form-control-label"><strong style="color: red;">* </strong>RV No</label>
						             		 </div>
						             		 <div class="col-md-3">
						             			  <input type="text" id="rv_no" name="rv_no" placeholder="Enter RV No..." class="form-control-sm form-control" autocomplete="off" maxlength="25" required>
						               		 </div>
						               		 ...
						               		 <div class="col-md-2" style="text-align: left;">
						                 		  <label class=" form-control-label"><strong style="color: red;">* </strong>RV Date</label>
						               		 </div>
						               		 <div class="col-md-3">
						               			  <input type="date" id="rv_date" name="rv_date" placeholder="" class="form-control-sm form-control" autocomplete="off"> 
											 </div>	    
		  					            </div>
										...
										<div class="col-md-12 row form-group" style="margin-top: -10px;">
					             	 		<div class="col-md-2" style="text-align: left;"> 
												 <label class=" form-control-label"><strong style="color: red;">* </strong>Upload RV</label>
											 </div>
														 <div class="col-md-3">
...
function getregn() {
	...
	if($("#rv_no").val() == ""){
		alert("Please Enter RV No");
		$("#rv_no").focus();
	    return false;
	}
	
	if($("#rv_date").val() == ""){
		alert("Please Select the RV Date");
		$("#rv_date").focus();
	    return false;
	}
...
<%			if (nPara.equalsIgnoreCase("ITFR")) { %>
				    ...
				    var Tocallfn = "getMMSUnitListBySearch?"+key+"="+value;
				    var fcodevalue = "A:R";
					var tcodevalue = "A:R";
<%			}  %>			
<%			if (nPara.equalsIgnoreCase("IDEP")) { %>
