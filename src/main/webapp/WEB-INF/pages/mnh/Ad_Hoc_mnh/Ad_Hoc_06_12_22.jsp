...
$(window).scroll(function(){
  ...
  <form:form id = "filed_form" >
  <div class="container" align="center">
  <div class="card">
	<div class="animated fadeIn"> 
		<div class="col-md-12" align="center">
		<div class="card-header">
									<h5> DYNAMIC QUERY ADHOC QUERY</h5>
								<!-- 	<h6 class="enter_by">
				...
				<div class="card-body card-block">
					<%-- <div class="col-md-12">
						...
						<div class="col-md-6">
							<div class="row form-group">
								<div class="col-md-4">
									<label class=" form-control-label"><strong style="color: red;"></strong>COMMAND NAME</label>
								</div>
								<div class="col-md-8">
									 <select name="command" id="command" class="form-control-sm form-control">
									 <option value="-1">-- Select All --</option>
		                                    <c:forEach var="item" items="${getMNHCommandName}" varStatus="num" >
...
<%--                   		           	<option value="${item[0]}"  name="${item[1]}" >${item[1]}</option>  --%>
									...
									<div class="col-md-6" id ="civilian_type_hid">
							<div class="row form-group">
								<div class="col-md-4">
									<label class=" form-control-label"><strong
												style="color: red;"> </strong>MEDICAL UNIT NAME</label>
								</div>
								<div class="col-md-8">
						 <input type="text" id="unit_name1" name="unit_name1" class="form-control-sm form-control" placeholder="Search..." 
							autocomplete="off" value="${unit_name}"  title="Type Unit Name or Part of Unit Name to Search">
						</div>
						</div>
						</div>
								...
								<div class="col-md-6">
									<div class="row form-group">
						                ...
						                <div class="col-12 col-md-8">
						                 	 ...
						                 	 <select name="rank.id" id="rank" data-placeholder="Select the Rank..." class="form-control-sm form-control" onchange="rank_change(this);">
								              <option value="-1">--Select--</option>
						                    	</select>
						                </div>
						            </div>
				...
				<div class="col-md-6">
	              <div class="row form-group">
		             <div class=" col col-md-4">
				          <label  class=" form-control-label" >AGE (Years)</label>
		         </div>
		              <div class="col-md-8">
			            <div class="row form-group">
			         <div class="col-md-6">
                    <input type="text" id="age_year" name="age_year" value="0" autocomplete="off" class="form-control-sm form-control" 
						maxlength="3" onkeypress="return isNumber0_9Only(event)" placeholder="Enter Age..." >
			    </div>
			       <div class="col-md-6">
				    <input type="text" id="age_month" name="age_month" class="form-control-sm form-control" autocomplete="off" 
				     placeholder="Enter Month..." >
		          			...
		          			<div class="col-md-6">
		          					<div class="row form-group">
										<div class="col col-md-4">
											<label class=" form-control-label">SEX/GENDER </label>
										</div>
										<div class="col-12 col-md-8">			
							...
							<div class="row form-group">
								<div class="col-md-4">
									<label class=" form-control-label"><strong style="color: red;"></strong>DISPOSAL</label>
								</div>
								<div class="col-md-8">
					...
					<div class="col-md-12">
						<div class="col-md-6">
		          					<div class="row form-group">
	                					<div class="col col-md-4">
	                  						<label class=" form-control-label">DISEASE TYPE</label>
							            </div>
							            <div class="col-12 col-md-8">
											
	                        	<select name="disease_type" id="disease_type" class="form-control-sm form-control" >
	                          <option value="0">--Select--</option>
										<c:forEach var="item" items="${getMedDisease_Type}" varStatus="num" >
											<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
										</c:forEach>
										</select>
										</div>
						...
						<div class="col-md-6">
							<div class="row form-group">
								<div class="col-md-4">
									<label class=" form-control-label"><strong style="color: red;"></strong>DISEASE SUB-TYPE</label>
								</div>
								<div class="col-md-8">
			                  ...
			                  placeholder="Search Disease Name...">
			                   -->
			                  <select name="disease_name" id="disease_name" class="form-control-sm form-control">
										<option value="0">--Select--</option>
										<c:forEach var="item" items="${getMedDisease_Type}" varStatus="num">
											<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
										</c:forEach>
					...
					<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									 <input type="date" id="frm_dt" name ="frm_dt" value="${to_date}" class="form-control-sm form-control"  onchange="CheckDate(this.value);" autocomplete="off" min="1899-01-01" max="${date}">
								</div>
							</div>
						</div>
							...
							<div class="row form-group">
								<div class="col-md-4">
									<label class=" form-control-label"><strong style="color: red;"></strong>DATE TO</label>
								</div>
								<div class="col-md-8">
	 	...
	 	<div class="col-md-12" id="button_div" > 
				<div class="card-footer" align="center" class="form-control">
				    <a href="ad_hoc_mnh_Url" class="btn btn-success btn-sm">Clear</a>  
...
<!-- 				<i class="action_icons searchButton"></i><input type="button" id="btdog" class="btn btn-info btn-sm" onclick="return Search()" value="Search">  -->
				 <i class="fa fa-search"></i>	<input type="button" class="btn btn-info btn-sm" value="Search" onclick="return Search()" > 
	...
	<div class="col-md-12"  id="div_query" style="display: none;">
		<div class="card">
		  ...
		  <div class="container" id="DataReport" > 	
	  ...
	  <table id="DataReport" border="1" class="table no-margin table-striped  table-hover  table-bordered report_print">
		                    <thead >   
		                     <tr>
			                        <th style="font-size: 15px ;width: 8%;">Ser No</th>
									<th style="font-size: 15px">Medical Unit Name</th>
									<th style="font-size: 15px">A & D no</th>
						  ...
						  <c:forEach var="item" items="${list}" varStatus="num" >
								<tr>
									<td style="width: 8%; text-align: left;">${num.index+1}</td>
									<td style="text-align: left;">${item.unit_name}</td>
									<td style="text-align: left;">${item.and_no}</td>
									<td style="text-align: left;">${item.name}</td>
									<td style="text-align: left;">${item.sys_code_value}</td>
...
//                                                                   }
		   ...
		   if($("#count_filter").val() != 0){
			  ...
			  $.post('Ad_hoc_mnh_Action?' + key + "=" + value, formdata , function(j){ 
				  //console.log(j)
				  var i=0;
				  var v=j.length;
				 /*  var size = $("#size").val(v); 
...
$("#column_search").keyup(function () {
	...
	function get_total() {
		 var tw1 = $("#table_name_hidden_list").val();
			 ...
			 $.post('get_group_by_List_mnh?' + key + "=" + value,function(j) {
		        }).done(function(j) {
		        	for(var l=0;l<j.length;l++){
...
var formdata=$('#filed_form').serialize();
		$.post('Download_Adhoc_Data_Serialize?' + key + "=" + value,formdata,function(j) {
        }).done(function(j) {
        	if(j == "SET"){
	...
	<script>
	  ...
	  $("#disease_name").keyup(function(){
	    ...
	    function fn_pre_domicile_Country() {
			var text = $("#disease_type option:selected").text();
			var disease_type = $('select#disease_type').val();
			//alert(disease_type);
			$
					.post("getMedDiseaseName1?" + key + "=" + value, {
					...
					.done(
							function(j) {
								...
								$("select#disease_name").html(options);
							}).fail(function(xhr, textStatus, errorThrown) {
					});
		}	
	    ...
	    function Search(){
	    		...
	    		$("#admsn_type1").val($('#admsn_type').val());
...
<c:url value="Download_Adhoc_Data" var="Download_Adhoc_Data" />
 <form:form action="${Download_Adhoc_Data}" method="post" id="Download_Adhoc_Data_FORM"
	name="Download_Adhoc_Data_FORM">
	<input type="hidden" name="header1" id="header1" value="" />	
</form:form>


<c:url value="Download_Adhoc_Data_Excel" var="Download_Adhoc_Data_Excel" />
<form:form action="${Download_Adhoc_Data_Excel}" method="post" id="ExcelForm" name="ExcelForm">
	<input type="hidden" name="header2" id="header2" value="" />
</form:form>


<c:url value="getSearch_ad_hocMnh" var="searchUrl" />
<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="relation1">
		...
		<input type="hidden" name="admsn_type1" id="admsn_type1" />
