...
<body>
	<div class="container" id="printableArea">
			<div class="row">
	    		<div class="card">
	    			<div class="card-header" align="center"> <strong style="text-decoration: underline;">DATA UPLOAD INFORMATION HOSPITAL</strong> 
	    			</div> 
					...
					<span id="ip"></span>
  						...
  						<datatables:table id="applicanttbl" url="getdatauploadinformationrpt" serverSide="true" pipelining="true" pipeSize="3"	row="latlon" rowIdBase="applicant_id" rowIdPrefix="latlon_"  displayLength="10" lengthMenu="10,20,100,500,5000" jqueryUI="true" 
	    					bDestroy="true" filterable="false" sortable="true" processing="true" border="1"  autoWidth="true" pageable="true" paginationType="full_numbers" stateSave="false" deferRender="true"  scrollX="100%" scrollCollapse="true" >  
							    <datatables:column title="UNIT NAME" property="unit_name" sortable="true"  data-halign="left" data-valign="left" />
							    <datatables:column title="USER NAME" property="username"  sortable="true" data-halign="left" data-valign="left"/>
						</datatables:table>    
                        <br/>
                        </div>
		        	</div>
