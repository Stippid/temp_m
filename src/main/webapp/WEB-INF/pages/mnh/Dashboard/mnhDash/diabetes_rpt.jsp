			...
			<div class="row">
	    		<div class="card">
					...
					<span id="ip"></span>
  						...
  						<datatables:table id="applicanttbl" url="getcmdihddeshrpt" serverSide="true" pipelining="true" pipeSize="3"	row="latlon" rowIdBase="applicant_id" rowIdPrefix="latlon_"  displayLength="10" lengthMenu="10,20,100,500,5000" jqueryUI="true" 
	    					bDestroy="true" filterable="false" sortable="true" processing="true" border="1"  autoWidth="true" pageable="true" paginationType="full_numbers" stateSave="false" deferRender="true"  scrollX="100%" scrollCollapse="true" >  
							    <%-- <datatables:column title="HOSPITAL NAME" property="unit_name" sortable="true"  data-halign="left" data-valign="left" />
							    <datatables:column title="OFFICER" property="off"  sortable="true" data-halign="left" data-valign="left"/>
							    <datatables:column title="MNS" property="mns"  sortable="true" data-halign="left" data-valign="left" />
							    <datatables:column title="JCO" property="jco"  data-halign="left" data-valign="left" />
							    <datatables:column title="OR" property="or"  data-halign="left" data-valign="left" />
							    <datatables:column title="TOTAL ADM" property="count"  data-halign="left" data-valign="left" /> --%>
							    
							    <datatables:column title="HOSPITAL NAME" property="unit_name" sortable="true"  data-halign="left" data-valign="left" />
							    <datatables:column title="COMMAND" property="cmd_name"  sortable="true" data-halign="left" data-valign="left"/>
							    <datatables:column title="CORPS" property="corps_name"  sortable="true" data-halign="left" data-valign="left" />
							    <datatables:column title="DIV" property="div_name"  data-halign="left" data-valign="left" />
							    <datatables:column title="BDE" property="bde_name"  data-halign="left" data-valign="left" />
							    <datatables:column title="OFFICER" property="off"  data-halign="left" data-valign="left" />
							    <datatables:column title="MNS" property="mns"  data-halign="left" data-valign="left" />
							    <datatables:column title="JCO" property="jco"  data-halign="left" data-valign="left" />
							    <datatables:column title="OR" property="or"  data-halign="left" data-valign="left" />
							    <datatables:column title="TOTAL" property="total"  data-halign="left" data-valign="left" />
