...
<form:form action="Scrutiny_approval_action" id="Scrutiny_approval"
	...
	<div class="container" align="center">
		<div class="card">
			...
			<div class="card-body card-block">
							...
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="sus_no1" name="sus_no1"
									 ...
									 <label id="sus"  style="display: none"></label>
								</div>
							</div>
						</div>
					</div>
					...
					<% if (nPara.equalsIgnoreCase("L1") || nPara.equalsIgnoreCase("L2")) { %>
	                   <div class="col-md-12" >
						<div class="col-md-6">
							<div class="row form-group">
								<div class="col-md-4">
									<label for="text-input" class=" form-control-label">ICD Remarks a</label>
								</div>
								<div class="col-md-8">
					...
					<div class="col-md-12" >
						...
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<select id="p_diag" name="p_diag" class="form-control-sm form-control">
             ...
             <% if (nPara.equalsIgnoreCase("UNIT")) { %>
         <a href="mnh_scrutiny_unit_approval" type="reset" class="btn btn-primary btn-sm" onclick="btn_clc();" > Clear </a> 
         <% } %>
         
          <% if (nPara.equalsIgnoreCase("L1")) { %>
         <a href="mnh_level1_approval" type="reset" class="btn btn-primary btn-sm" onclick="btn_clc();" > Clear </a> 
         <% } %>
          <% if (nPara.equalsIgnoreCase("L2")) { %>
         <a href="mnh_level2_approval" type="reset" class="btn btn-primary btn-sm" onclick="btn_clc();" > Clear </a> 
         <% } %>
	...
	<div class="container" id="divPrint" style="display: none;">
	   ...
	   <div id="divSerachInput" class="col-md-12">
						...
						<div class="row form-group">
						<div class="col-md-6" >
						 	<input id="searchInput" type="text" style="font-family: 'fontello',Arial;" placeholder="Search Word"  size="35" class="form-control">			
							 </div>
						 	  <% if (nPara.equalsIgnoreCase("L1")) { %> 
					    ...
					    <% } %>
					    <% if (nPara.equalsIgnoreCase("UNIT") || nPara.equalsIgnoreCase("L2")) { %> 
				...
				<tbody>
					<c:forEach var="item" items="${list}" varStatus="num">
						<tr>
							...
							<% if (nPara.equalsIgnoreCase("L2")) { %>
	                        <c:if
	                         test="${(stat1 == 'PNDUNIT' || stat1 == 'PASS')}">
							<td><input type="text" id="a_rem${item.id}"
								name="a_rem${item.id}" onkeypress="a_remAuto(this);" autocomplete="off" value="${item.diagnosis_code1d}">
							</td>
							<td><input type="text" id="d_rem${item.id}"
								name="d_rem${item.id}" autocomplete="off" onkeypress="d_remAuto(this);" value="${item.icd_cause_code1d}">
							</td>
				          </c:if>
