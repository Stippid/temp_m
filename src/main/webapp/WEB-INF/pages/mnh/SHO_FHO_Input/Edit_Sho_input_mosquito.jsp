...
<form:form name="Sho_input_mosquito_edit" id="Sho_input_mosquito_edit" action="Sho_input_mosquito_editAction" method='POST' commandName="Sho_input_mosquito_editCMD">
 
          <div class="card">
              <div class="card-header">
		           <h5 align="center">EDIT EPIDEMIOLOGICAL INVESTIGATION REPORT(MOSQUITO/VECTOR BORNE)</h5>
				<h6>
					...
					<div class="col-md-6">
						...
						<div class="col-md-8">
							<input type="text" id="case_no" name="case_no" class="form-control-sm form-control" placeholder="Enter..." 
								autocomplete="off">	
								<input type="hidden" id="eir_id" name="eir_id" >	
						...
						<div class="row form-group">
							...
							<div class="col-md-8">
								<input type="text" id="personal_name" name="personal_name" class="form-control-sm form-control" autocomplete="off"
									oninput="this.value = this.value.toUpperCase()" placeholder="Enter Personnel Name..." maxlength="100" value="${Sho_input_mosquito_editCMD.personal_name}">
							</div>
						</div>
					</div>
				</div>
						...
						<tbody data-spy="scroll" id="h_travel_tbody"
	                     ...
	                     <input type="text" id="travel_id1" name="travel_id1" value="0" class="form-control autocomplete" autocomplete="off">
							...
							<td style="width: 10%;"><a class="btn btn-success btn-sm"
								...
								onclick="h_travel_remove_fn(1);"><i class="fa fa-trash"></i></a></td>
                           </tr>
						</tbody>
					</table>
					...
					<table id="h_list_table" class="table-bordered "
						...
						<tbody data-spy="scroll" id="h_list_tbody"
                           ...
                           <td style="width: 20%;"><input type="text"
								 ...
								 <td style="display: none;">
	                     <input type="text" id="list_id1" name="list_id1" value="0" class="form-control autocomplete" autocomplete="off">
										</td>
                             <td style="width: 10%;"><a class="btn btn-success btn-sm"
						...
						<div id="divShow" style="display: block;">
							<div class="watermarked" data-watermark="" id="divwatermark">
								<table
									...
									<thead>
										<tr>
											<td><input type="text" id="en_loc1" name="en_loc1" placeholder="Enter Location1..." class="form-control" autocomplete="off" value="${Sho_input_mosquito_editCMD.en_loc1}"></td>
											<td><input type="text" id="en_loc2" name="en_loc2" placeholder="Enter Location2..." class="form-control" autocomplete="off" value="${Sho_input_mosquito_editCMD.en_loc2}"></td>
											<td><input type="text" id="en_loc3" name="en_loc3" placeholder="Enter Location3..." class="form-control" autocomplete="off" value="${Sho_input_mosquito_editCMD.en_loc3}"></td>
										</tr>
									</thead>
									<tbody>
										<c:forEach var="item" items="${list}" varStatus="num">
											<tr>
												...
												<th id="thAction1"
													style="font-size: 14px; text-align: center;" width="10%">${item.id}</th>
											</tr>
										</c:forEach>
									</tbody>
								</table>
   ...
   <div class="col-md-12">
				...
				<div class="col-md-12" style="margin-left:790px;">
						<div class="col-md-6">
							<div class="row form-group">
								<div class="col-md-4">
	 ...
	 <div class="form-control card-footer" align="center">			  
	         ...
	         <input type="submit" id="btn_update" class="btn btn-primary btn-sm" value="Update" onclick="return isvalidData();" />
         </div>
...
$(document).ready(function() {
	...
	$("#id").val('${Sho_input_mosquito_editCMD.id}');
	...
	$.post("getMNHUnitNameBySUSNo?" + key + "=" + value, {y : '${Sho_input_mosquito_editCMD.sus_no}'},
			function(j) {
    ...
    var l = '${Sho_input_mosquito_editCMD.persnl_no}'.length;
  
	$("#service").val(
			'${Sho_input_mosquito_editCMD.service}');
	
	if ('${Sho_input_mosquito_editCMD.category}' == "OR"
			&& '${Sho_input_mosquito_editCMD.service}' == "ARMY") {
	
		$("#persnl_no2").val('${Sho_input_mosquito_editCMD.persnl_no}'
						.substring(0, l - 1));
		$("#persnl_no3").val(
				'${Sho_input_mosquito_editCMD.persnl_no}'
						.substring(l - 1, l));
	} else if ('${Sho_input_mosquito_editCMD.service}' == "AIRFORCE"
			|| '${Sho_input_mosquito_editCMD.service}' == "NAVY") {
		...
		$("#persnl_no3").val(
				'${Sho_input_mosquito_editCMD.persnl_no}'
						.substring(l - 1, l));
	} else if ('${Sho_input_mosquito_editCMD.service}' == "ARMY"
			&& '${Sho_input_mosquito_editCMD.category}' != "OR") {
		
		$("#persnl_no1").val('${Sho_input_mosquito_editCMD.persnl_no}'.substring(0, 2));
		$("#persnl_no2").val(
				'${Sho_input_mosquito_editCMD.persnl_no}'
						.substring(2, l - 1));
		$("#persnl_no3").val(
				'${Sho_input_mosquito_editCMD.persnl_no}'
						.substring(l - 1, l));
	} else if ('${Sho_input_mosquito_editCMD.service}' == "OTHERS") {
	...
	if ('${Sho_input_mosquito_editCMD.service}' == "NAVY"
			|| '${Sho_input_mosquito_editCMD.service}' == "AIRFORCE") {
		
		$("#persnl_no1").attr('readonly', true);
		$("#category").attr('readonly', false);
	}
	if ('${Sho_input_mosquito_editCMD.service}' == "OTHERS") {
		$("#persnl_no1").attr('readonly', true);
	...
	if ('${Sho_input_mosquito_editCMD.service}' == "ARMY") {
		$("#category").attr('readonly', true);
	}

	if ('${Sho_input_mosquito_editCMD.service}' != "OTHERS") {
		$("#category").val(
				'${Sho_input_mosquito_editCMD.category}');
		getRank();
	}
	...
	$("#sus_no1").val('${Sho_input_mosquito_editCMD.sus_no}');
	$.post("getMNHUnitNameBySUSNo?"+key+"="+value, {y:'${Sho_input_mosquito_editCMD.sus_no}'},function(j) {
		var enc = j[j.length - 1].substring(0, 16);
		var a = dec(enc, j[0]);
		$("#unit_name1").val(a);
	});
	...
	$("#disease").val('${Sho_input_mosquito_editCMD.disease}');
	
	$("#case_no").val('${Sho_input_mosquito_editCMD.case_no}');
	$("#service").val('${Sho_input_mosquito_editCMD.service}');
	$("#relationship").val('${Sho_input_mosquito_editCMD.relationship}');
	
	
	if('${Sho_input_mosquito_editCMD.service}' != "OTHERS"){
		$("#category").val('${Sho_input_mosquito_editCMD.category}');
		getRank();
	}

	$("#personnel_unit").val('${Sho_input_mosquito_editCMD.personnel_unit}');
	$("#present_address").val('${Sho_input_mosquito_editCMD.present_address}');
	$("#contact_no").val('${Sho_input_mosquito_editCMD.contact_no}');
	$("#type_of_symptom").val('${Sho_input_mosquito_editCMD.type_of_symptom}');
	$("#history").val('${Sho_input_mosquito_editCMD.history}');
	$("#prob_source_insp").val('${Sho_input_mosquito_editCMD.prob_source_insp}');
	


	
	$("#final_epid_diag").val('${Sho_input_mosquito_editCMD.final_epid_diag}');
	$("#final_epid_diagnosis").val('${Sho_input_mosquito_editCMD.final_epid_diagnosis}');
	$("#action_for_patient").val('${Sho_input_mosquito_editCMD.action_for_patient}');
	//$("#action_by_sho").val('${Sho_input_mosquito_editCMD.action_by_sho}');
	$("#recommendation_unit").val('${Sho_input_mosquito_editCMD.recommendation_unit}');
	$("#recommendation_indl").val('${Sho_input_mosquito_editCMD.recommendation_indl}');
	$("#breeding_found").val('${Sho_input_mosquito_editCMD.breeding_found}');
	$("#follow_up_down").val('${Sho_input_mosquito_editCMD.follow_up_down}');
	$("#other_action_by_sho").val('${Sho_input_mosquito_editCMD.other_action_by_sho}');
	$("#history_Of_past").val('${Sho_input_mosquito_editCMD.history_Of_past}');
	Clearvalue() ;
	
	var reason = '${Sho_input_mosquito_editCMD.action_by_sho}'
		$.post("getaction_bySystem?" + key + "=" + value,
				function(j) {
	 ...
	 var d1 = new Date('${Sho_input_mosquito_editCMD.date_onset_symp}');
	var d2 = new Date('${Sho_input_mosquito_editCMD.date_repo_med_centre}');
 ...
 var date_of_birth = '${Sho_input_mosquito_editCMD.date_of_birth}';
	date_of_birth= date_of_birth.substring(0,10);
	
	$("#date_of_birth1").val(date_of_birth);
	calculate_age_edit('${Sho_input_mosquito_editCMD.date_of_birth}');
...
function getRank() {
	...
	$.post("getMNHRank?"+key+"="+value, {a1 : category,a2 : service},function(j) {
		...
		$("#rank").html(options);
		var q = '${Sho_input_mosquito_editCMD.eir_rank.id}';
		if(q != ""){
			$("#rank").val(q);
		}
	});
...
function getlistDetails() {
    ...
    var p_id = '${Sho_input_mosquito_editCMD.id}';
    var i = 0;
...
function funcheckbox(j){
	...
	for ( var i = 0; i < j.length ;i++) {
		...
		if(f == true)
		{
			$("#action_by_sho1").append("<input type='checkbox' name='action_by_sho' onchange='funcheckbox(this)' id='action_by_sho"+j[i][0] +"' value='" + j[i][0] + "'  checked/>&nbsp;<label>" + j[i][1] + " </label><br/> " );
		}	 			
		else
		{
			$("#action_by_sho1").append("<input type='checkbox' name='action_by_sho' onchange='funcheckbox(this)'  id='action_by_sho"+j[i][0] +"' value='" + j[i][0] + "'  />&nbsp;<label>" + j[i][1] + " </label><br/> " );
		}
	} 
