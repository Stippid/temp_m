	...
	<div class="container" align="center">
		<div class="card">
			<div class="card-header">
				<h5>SEARCH EPIDEMIOLOGICAL INVESTIGATION REPORT(AIR)</h5>
				<h6>
			...
			<div class="form-control card-footer" align="center">
				<a	href="search_air_ShoInput" type="reset" class="btn btn-primary btn-sm"> Clear </a> 
...
<c:url value="Search_mnh_inputs_air_get" var="searchUrl" />
