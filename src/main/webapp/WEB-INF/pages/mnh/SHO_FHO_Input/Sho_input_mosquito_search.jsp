	...
	<div class="container" align="center">
		<div class="card">
			<div class="card-header">
				<h5>SEARCH EPIDEMIOLOGICAL INVESTIGATION REPORT(MOSQUITO)</h5>
				<h6>
							...
							<div class="row form-group">
								...
								<div class="col-md-8">
									<select name="disease" id="disease"
										class="form-control-sm form-control" ><!-- onchange="Clearvalue()" -->
			...
			<div class="form-control card-footer" align="center">
				<a	href="Search_mnh_inputs_mosq_food_air" type="reset" class="btn btn-primary btn-sm"> Clear </a> 
...
<c:url value="search_mosq_ShoInput" var="searchUrl" />
...
<c:url value="edit_mosq_ShoInput" var="editUrl" />
<form:form action="${editUrl}" method="post" id="updateForm"
	name="updateForm" modelAttribute="id2">
	<input type="hidden" name="id2" id="id2" />
</form:form>

<c:url value="delete_mosq_ShoInput" var="deleteUrl" />
