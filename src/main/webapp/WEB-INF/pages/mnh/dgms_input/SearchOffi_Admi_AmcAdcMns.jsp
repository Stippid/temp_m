...
<form:form action="SearchOffi_Admi_AmcAdcMnsAction" id="SearchOffi_Admi_AmcAdcMns" method="post" class="form-horizontal" commandName="SearchOffi_Admi_AmcAdcMnsCMD">
      ...
      <div class="card">
         <div class="card-header">
			          <h5>SEARCH AMC/ADC/MNS OFFICERS ADMISSIONS </h5>
					...
					<div class="col-md-12">
						...
						<div class="col-md-3">
	               		 ...
	               		 <div class="col-md-9">
	               			  ...
	               			  <input type="text" id="unit_name" name ="unit_name" class="form-control-sm form-control" value="${unit_name}" placeholder="Search..." autocomplete="off" title="Type Unit Name or Part of Unit Name to Search">
						 </div>	 
						  </div>	 
						   </div>	 
							<div class="col-md-4">
						...
						<div class="col-md-4">
	             		 ...
	             		 <div class="col-md-8">
	             			  <input type="text" id="sus_no" name="sus_no" class="form-control-sm form-control" value="${sus_no}" placeholder="Search..." autocomplete="off" title="Type SUS No or Part of SUS No to Search" maxlength="8"/>
	               		 </div>  
  					</div> 
  					 </div>	 
  					  </div>	 
		    ...
		    <div class="col-md-6">
		      ...
		      <div class="col-md-6">
		       ...
		       <div class="form-control card-footer" align="center">
			        <a href="mnh_search_adm_officersDA" class="btn btn-primary btn-sm" >Clear</a> 
...
<c:url value="SearchOffi_Admi_AmcAdcMns" var="searchUrl" />
...
<c:url value="editOffi_Admi_AmcAdcMns" var="updateUrl" />
<form:form action="${updateUrl}" method="post" id="updateForm" name="updateForm" modelAttribute="id" >
	<input type="hidden" name="updateid" id="updateid" value="0" />
</form:form>
	
<c:url value="deleteOffi_Admi_AmcAdcMns" var="deleteUrl" />
