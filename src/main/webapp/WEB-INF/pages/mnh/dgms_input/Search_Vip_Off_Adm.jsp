...
<form:form action="mnh_search_assignAction" id="mnh_search_assign" method="post" class="form-horizontal" commandName="mnh_search_assignCMD">
      ...
      <div class="card">
         <div class="card-header">
			           <h5>SEARCH VIP(MAJ GEN & ABOVE) ADMISSIONS</h5>
		      </div> 
				  ...
				  <div class="row">
					<div class="col-md-12">
						...
						<div class="col-md-4">
	             		 ...
	             		 <div class="col-md-8">
	             			  <input type="text" id="sus_no1" name="sus_no1" value="${sus_no}" class="form-control-sm form-control" placeholder="Search..." autocomplete="off" title="Type SUS No or Part of SUS No to Search" maxlength="8"/>
	               		 </div>  
  					</div> 
  					 </div>	 
  					  </div>	 
            ...
            <label for="text-input" class=" form-control-label">Aadhar Card No.</label>
                 ...
                 <div class="form-control card-footer" align="center">
                    <a href="mnh_search_vip_officersDA" type="reset" class="btn btn-primary btn-sm"> Clear </a> 
...
<c:url value="vip_off_adm_searchAction" var="searchUrl" />
...
<c:url value="vip_off_adm_editUrl" var="editUrl" />
<form:form action="${editUrl}" method="post" id="editForm" name="editForm" modelAttribute="id1">
		<input type="hidden" name="id1" id="id1" value="0"/>
		
</form:form> 
<c:url value="vip_off_adm_deleteAction" var="deleteUrl" />
<form:form action="${deleteUrl}" method="post" id="deleteForm" name="deleteForm" modelAttribute="id2">
