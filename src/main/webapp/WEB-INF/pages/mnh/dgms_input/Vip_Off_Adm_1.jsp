...
<form:form name="vip_off_adm" id="vip_off_adm" action="vip_off_admAction" method='POST' commandName="vip_off_admCmd">
	...
	<div class="container" align="center">
			...
			<input type="hidden" id="btn_hid_v" name="btn_hid_v" class="form-control-sm form-control" value ="0">			     
			     <a href="mnh_vip_officersDA" class="btn btn-primary btn-sm" id="btn_clc" >Clear</a>	 
