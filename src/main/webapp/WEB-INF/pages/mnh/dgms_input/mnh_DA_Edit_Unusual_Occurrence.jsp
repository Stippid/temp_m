...
<form:form name="edit_unusual_occurrence" id="edit_unusual_occurrence"
	action="edit_unusual_occurrenceAction" method='POST'
	commandName="edit_unusual_occurrenceCMD">
	<div class="container" align="center">
		<div class="card">
			<div class="card-header">
				<h5>
					<span id="lbladd"></span> UPDATE UNUSUAL OCCURRENCE
				</h5>
				<h6>
			...
			<div class="card-body card-block">
				<div class="row">
					...
					<div class="col-md-12">
						...
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<select name="uo_rank.id" id="rank"
							...
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="contact_no" name="contact_no1"
										value="${edit_unusual_occurrenceCMD.contact_no}"
										autocomplete="off" class="form-control-sm form-control"
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="datetime-local" id="date_time_admission"
						...
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="datetime-local" id="date_time_incident"
					...
					<div class="col-md-12 from-group">
						...
						<div class="col-md-10">
							<form:input type="text" id="diagnosis" path="diagnosis"
								class="form-control-sm form-control" placeholder="Search..."
								autocomplete="off" />
						</div>
					</div>
			...
			<input type="hidden" id="id" name="id"
				value="${edit_unusual_occurrenceCMD.id}" class="form-control"
				autocomplete="off">
			<div class="card-footer" align="center">
				<a href="mnh_search_unusual_occurrencesDA"
					class="btn btn-danger btn-sm" id="btn_cancl">Cancel</a> <input
					type="submit" id="btn_update" class="btn btn-success btn-sm"
		...
		$
				.post(
						...
						function(j) {
							...
							$("#rank").html(options);
							var q = '${edit_unusual_occurrenceCMD.uo_rank.id}';
							if (q != "") {
								$("#rank").val(q);
							}
						});
	...
	$(document)
			.ready(
					function() {
						...
						$("#appointment").val(
								'${edit_unusual_occurrenceCMD.appointment}');
						$("#contact_no").val(
								'${edit_unusual_occurrenceCMD.contact_no}');

						$().getCurDt(dt_report1);

						var l = '${edit_unusual_occurrenceCMD.persnl_no}'.length;
						$("#service").val(
								'${edit_unusual_occurrenceCMD.service}');
						$("#type").val('${edit_unusual_occurrenceCMD.type}');
						$.post("getMNHUnitNameBySUSNo?" + key + "=" + value, {
							y : '${edit_unusual_occurrenceCMD.sus_no}'
						}, function(j) {
						...
						if ('${edit_unusual_occurrenceCMD.persnl_no}' == '-2') {
							$("#persnl_no_Original").val('-2');
						}

						if ('${edit_unusual_occurrenceCMD.category}' == "OR"
								&& '${edit_unusual_occurrenceCMD.service}' == "ARMY") {
							$("#persnl_no2").val(
									'${edit_unusual_occurrenceCMD.persnl_no}'
											.substring(0, l - 1));
							$("#persnl_no3").val(
									'${edit_unusual_occurrenceCMD.persnl_no}'
											.substring(l - 1, l));
						} else if ('${edit_unusual_occurrenceCMD.service}' == "AIRFORCE"
								|| '${edit_unusual_occurrenceCMD.service}' == "NAVY") {
							$("#persnl_no2").val(
									'${edit_unusual_occurrenceCMD.persnl_no}'
											.substring(0, l - 1));
							$("#persnl_no3").val(
									'${edit_unusual_occurrenceCMD.persnl_no}'
											.substring(l - 1, l));
						} else if ('${edit_unusual_occurrenceCMD.service}' == "ARMY"
								&& '${edit_unusual_occurrenceCMD.category}' != "OR") {
							$("#persnl_no1").val(
									'${edit_unusual_occurrenceCMD.persnl_no}'
											.substring(0, 2));
							$("#persnl_no2").val(
							...
							$("#persnl_no3").val(
									'${edit_unusual_occurrenceCMD.persnl_no}'
											.substring(l - 1, l));
						} else if ('${edit_unusual_occurrenceCMD.service}' == "OTHERS") {
							$("#persnl_no1").val('-1');
							$("#persnl_no2").val('');
							$("#persnl_no3").val('-1');
						}
						else if ('${edit_unusual_occurrenceCMD.service}' == "-1") {
							$("#persnl_no1").val('-1');
							$("#persnl_no2").val('');
							$("#persnl_no3").val('-1');
						...
						if ('${edit_unusual_occurrenceCMD.service}' == "NAVY"
								|| '${edit_unusual_occurrenceCMD.service}' == "AIRFORCE") {
							$("#persnl_no1").attr('readonly', true);
							$("#category").attr('readonly', false);
						}
						if ('${edit_unusual_occurrenceCMD.service}' == "OTHERS") {
							$("#persnl_no1").attr('readonly', true);
							$("#persnl_no2").attr('readonly', true);
							$("#persnl_no3").attr('readonly', true);
							$("#category").attr('readonly', true);
						...
						if ('${edit_unusual_occurrenceCMD.service}' == "ARMY") {
							$("#category").attr('readonly', true);
						}

						if ('${edit_unusual_occurrenceCMD.service}' != "OTHERS") {
							$("#category").val(
									'${edit_unusual_occurrenceCMD.category}');
							getRank();
						}
						$("#sex").val('${edit_unusual_occurrenceCMD.sex}');
						$("#relation").val(
								'${edit_unusual_occurrenceCMD.relation}');
						var dt_report = '${edit_unusual_occurrenceCMD.dt_report}'
								.substring(0, 10);
						$("#dt_report1").val(dt_report);
						$("#dt_report1Original").val(dt_report);

						var date_of_birth = '${edit_unusual_occurrenceCMD.date_of_birth}'
								.substring(0, 10);

						$("#date_of_birth1").val(date_of_birth);

						var d2 = new Date(
								'${edit_unusual_occurrenceCMD.date_time_admission}');
						var c_d2 = d2.getFullYear() + "-"
								+ ("0" + (d2.getMonth() + 1)).slice(-2) + "-"
								+ ("0" + d2.getDate()).slice(-2) + "T"
								+ ("0" + d2.getHours()).slice(-2) + ":"
								+ ("0" + d2.getMinutes()).slice(-2);
						$("#date_time_admission").val(c_d2);
						$("#diagnosis").val(
								'${edit_unusual_occurrenceCMD.diagnosis}');
						$("#remarks").text(
								'${edit_unusual_occurrenceCMD.remarks}');

						var d2_in = new Date(
								'${edit_unusual_occurrenceCMD.date_time_incident}');
...
<script>
	function personal_number() {
		...
		var personnel_no = '${edit_unusual_occurrenceCMD.persnl_no}';
