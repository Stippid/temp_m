...
<form:form name="Offic_Admi_AmcAdcMns" id="Offic_Admi_AmcAdcMns" action="Offic_Admi_AmcAdcMnsAction" method='POST' commandName="Offic_Admi_AmcAdcMnsCMD">
<div class="container" align="center">
			<div class="card">
		<div class="card-header">
           <h5> AMC/ADC/MNS OFFICERS ADMISSIONS </h5><h6><span style="font-size: 12px; color: red">(To be entered by Medical Unit)</span></h6>
      	</div>
   ...
   <div class="row">
		 ...
		 <div class="col-md-8">
			<div class="row form-group">
			   <div class="col-md-3">
				...
				<div class="col-md-9">
	                <input type="text" id="unit_name" name="unit_name" class="form-control-sm form-control" value="${unit_name}" placeholder="Search..." 
	  ...
	  <div class="col-md-6">
		<div class="row form-group">
			...
			<div class="col-md-8">
				<input type="text" id="persnl_name" name="persnl_name" onkeypress="return onlyAlphabets(event);" class="form-control-sm form-control" autocomplete="off" 
		...
		<div class="col-md-6">
		  <div class="row form-group">
			<div class="col-md-4">
		     ...
		     <div class="col-md-8">
				<select name="a_rank.id" id="rank" data-placeholder="Select the Rank..." class="form-control-sm form-control" onchange="rank_change(this);">
					 <option value="-1">--Select--</option>
				</select>
			 </div>
		  </div>
	...
	<div class="col-md-12">
		 ...
		 <div class="col-md-6">
		   <div class="row form-group">
				...
				<div class="col-md-8">
					<input type="date" id="dt_report" name="dt_report" class="form-control-sm form-control"   min="1899-01-01" max="${date}" >
				</div>
		    </div>
		 </div>
	</div>
	...
	<div class="col-md-12">
	  <div class="col-md-6">
		<div class="row form-group">
		  ...
		  <div class="col-md-8">
				<input type="date" id="date_of_birth1" name="date_of_birth" autocomplete="off" class="form-control-sm form-control" 
	...
	<div class="col-md-12">
	  <div class="col-md-6">
		<div class="row form-group">
		 ...
		 <div class="col-md-8">
			<input type="datetime-local" id="date_time_admission" name="date_time_admission" class="form-control-sm form-control" min="1899-01-01" max="${date}">		
		 </div>
	    </div>	  
	 </div>
	 <div class="col-md-6">
   	   ...
   	   <!--  <div class="col-md-12 from-group">
				<div class="col-md-2">
			  	...
			  	<div class="col-md-10" >
						 <input type="text" id="diagnosis" name="icd_code" class="form-control-sm form-control" 
	      ...
	      <div class="col-md-12">
						...
						<div class="col-md-8">
						 <input type="text" name="diagnosis_code1d" onkeypress="return onlyAlphaNumeric(event);" id="diagnosis_code1d" class="form-control-sm form-control" autocomplete="off" 
							  placeholder="Search...">
						</div>
				</div>
			</div>
						...
						<div class="col-md-4">
						 ...
						 <div class="col-md-8">
							 <input type="text" name="icd_cause_code1d" onkeypress="return onlyAlphaNumeric(event);" id="icd_cause_code1d" class="form-control-sm form-control" autocomplete="off" 
     ...
     <div class="col-md-12 from-group">
   	...
   	<div class="card-footer" align="center">
   		<input type="hidden" id="btn_hid_a" name="btn_hid_a" class="form-control-sm form-control" value ="0">
                 <a href="mnh_adm_officersDA" class="btn btn-primary btn-sm" >Clear</a>  
...
jQuery(function() {
    ...
    jQuery("#unit_name").keypress(function(){
			...
			$("#diagnosis").keyup(function(){
				var d1 = this.value;
				$().Autocomplete2('GET','getMNHDistinctICDList',diagnosis,{a:d1,b:"ALL"},'getMNHDistinctICDList_ID',diagnosis_id,'','','');
			});	
