...
<form:form name="daily_disease_sureve" id="daily_disease_sureve" action="daily_disease_sureveAction" method='POST' commandName="daily_disease_sureveCMD">
                ...
                <select name="type" id="type" class="form-control-sm form-control">	
				 ...
				 <div class="col-md-12">
                   ...
                   <input type="text" id="age_year" name="age_year"  placeholder="Enter Year.." autocomplete="off" class="form-control-sm form-control" 
								maxlength="3" onkeypress="return isNumber0_9Only(event)" value="0" placeholder="Enter Age..." readonly>
						  </div>
						   <div class="col-md-6">
						    <input type="text" id="age_month" name="age_month" class="form-control-sm form-control" autocomplete="off" 
						     placeholder="Enter Month..."  value="0"  readonly>
						  </div>
						</div>
						</div>
						</div>
