...
<form:form name="daily_disease_sureve_nil" id="daily_disease_sureve_nil" action="daily_disease_sureve_nilAction" method='POST' commandName="daily_disease_sureveCMD">
	
		      	<div class="container" align="center">
               <div class="card">
              <div class="card-header">
		             <h5> <span id="lbladd"></span> DAILY DISEASE SURVEILLANCE DETAILS</h5>
		             <h6>
                ...
                <input type="text" id="unit_name1" name="unit_name1" class="form-control-sm form-control" placeholder="Search..." 
						...
						<div class="col-md-8">
							...
							autocomplete="off" value="${sus_no}"  title="Type SUS No or Part of SUS No to Search">
						</div>
				 </div>
				  </div>
				   </div>
                ...
                <select id="service" name="service" class="form-control-sm form-control">
					...
					<div class="col-md-12">
						...
						<div class="col-md-8">
							...
							placeholder="Enter Personnel Name..." oninput="this.value = this.value.toUpperCase()" onkeypress="return onlyAlphabets(event);" maxlength="100"/>
						</div>
						</div>
						</div>
				        <div class="col-md-6">
						...
						<div class="col-md-4">
						 ...
						 <div class="col-md-8">
							...
							placeholder="Enter Appointment..." oninput="this.value = this.value.toUpperCase()" onkeypress="return onlyAlphaNumeric(event);" maxlength="50"/>
						  </div>
						  </div>
						  </div>
				    </div>
            ...
            <label for="text-input" class=" form-control-label">Aadhar Card No.</label>
						...
						<div class="col-md-8">
							<input type="text" id="adhar_card_no1" name="adhar_card_no1" class="form-control-sm form-control" 
				 ...
				 <div class="col-md-12">
						...
						<div class="col-md-4">
						  ...
						  <div class="col-md-8">
								<input type="date" id="date_of_birth1" name="date_of_birth1" autocomplete="off" class="form-control-sm form-control" 
								  onchange="calculate_age_new(this);" min="1899-01-01" max="${date}">
						  </div>
				          </div>
				          </div>
                        <div class="col-md-6">
						...
						<div class="col-md-4">
						 ...
						 <div class="col-md-8">
								...
								placeholder="Enter Unit..." onkeypress="return onlyAlphaNumeric(event);" oninput="this.value = this.value.toUpperCase()" maxlength="250"/>
						 </div>
				        </div>
				         </div>
				    ...
				    <div class="col-md-12">
						...
						<div class="row form-group">
						<div class="col-md-6">
                   <input type="text" id="age_year" name="age_year"  placeholder="Enter Year.." autocomplete="off" class="form-control-sm form-control" 
								maxlength="3" onkeypress="return isNumber0_9Only(event)" value="0" placeholder="Enter Age...">
						  </div>
						   <div class="col-md-6">
						    <input type="text" id="age_month" name="age_month" class="form-control-sm form-control" autocomplete="off" 
						     placeholder="Enter Month..."  value="0">
						  </div>
						</div>
						</div>
						</div>
  ...
  <div class="col-md-6">
				...
				<div class="col-md-12">
	              ...
	              <label for="text-input" class=" form-control-label"><strong style="color: red;">* </strong>Date/Time of Admission</label>
					...
					<label for="text-input" class=" form-control-label"><strong style="color: red;"> </strong>Date/Time of Onset</label>
						</div>
                   <div class="col-md-8">
				<input type="text" id="dt_incident" name="dt_incident" class="form-control-sm form-control" min="1899-01-01" max="${date}" readonly>
                        </div>
                         </div>
                         </div>
				    ...
				    <div class="col-md-12 from-group">
						...
						<label for="text-input" class=" form-control-label"><strong	style="color: red;">* </strong> Diagnosis</label>
						  	...
						  	<div class="col-md-10" >
									 ...
									 <select name="diagnosis.id" id="diagnosis" class="form-control-sm form-control">
										 <option value="-1">--Select--</option>
				    ...
				    <div class="col-md-12 from-group">
						...
						<div class="col-md-10">
							<textarea rows="2" cols="250" class="form-control char-counter1"
								...
								maxlength="255" onkeypress="return onlyAlphaNumeric(event);"></textarea>
						</div>
					</div>
			</div>
			</div>
			...
			<div class="card-footer" align="center">
		         ...
		         <input type="submit" id="btn_save" class="btn btn-success btn-sm" value="Send to Nil" onclick="return isvalidData();"/> 		         
           </div>
		</div>
</div>
</form:form>
