...
<form:form action="mnh_search_assignAction" id="mnh_search_assign" method="post" class="form-horizontal" commandName="mnh_search_assignCMD">
              ...
              <div class="card-header">
		             <h5> <span id="lbladd"></span> SEARCH DAILY DISEASE SURVEILLANCE DETAILS</h5>
					...
					<div class="col-md-12">
  					...
  					<div class="col-md-12">
						...
						<div class="col-md-4">
	               		 ...
	               		 <div class="col-md-8"> 
	               			  <input type="date" id="frm_dt" name ="frm_dt" class="form-control-sm form-control"  
	               			  onchange="CheckDate(this.value);" value="${to_date}"  autocomplete="off" min="1899-01-01" max="${date}">
            ...
            <label for="text-input" class=" form-control-label">Aadhar Card No.</label>
						...
						<div class="col-md-8">
							<input type="text" id="adhar_card_no" name="adhar_card_no" class="form-control-sm form-control" 
							 minlength="12" maxlength="14" onkeypress="return isNumber0_9Only(event)" placeholder=" Please Enter 12 Digit Aadhar card No..." autocomplete="off">
		      ...
		      <div class="form-control card-footer" align="center">
                    <a href="mnh_daily_disease_search" type="reset" class="btn btn-primary btn-sm"> Clear </a> 
				             ...
				             <table id="DataReport" border="1" class="table no-margin table-striped  table-hover  table-bordered report_print">
		                      ...
		                      <c:if test="${list.size()==0}">
								...
								<tr>
									...
									<td style="text-align: center;">${item.adhar_card_no}</td>
									<td style="text-align: center;">${item.contact_no}</td>
...
<c:url value="search_daily_disease" var="searchUrl" />
...
<c:url value="updatedaily_disease" var="updateUrl" />
<form:form action="${updateUrl}" method="post" id="updateForm" name="updateForm" modelAttribute="id" >
	<input type="hidden" name="updateid" id="updateid" value="0" />
</form:form>


<c:url value="delete_daily_disease_servill" var="deleteUrl" />
