...
<form:form action="edit_mortality_detailsAction" id="edit_mortality_details" method="post" class="form-horizontal" commandName="edit_mortality_detailsCMD">
					...
					<div class="col-md-12">
						<div class="col-md-8">
							<div class="row form-group">
								<div class="col-md-3">
								<input type="hidden" id="id" name="id" value="${edit_mortality_detailsCMD.id}" class="form-control" autocomplete="off">
					...
					<div class="col-md-12">
						...
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<form:input type="text" id="persnl_unit" path="persnl_unit"
										class="form-control-sm form-control" autocomplete="off"
										placeholder="Enter Unit..." maxlength="100"
										oninput="this.value = this.value.toUpperCase()"/>
								</div>
							</div>
						</div>
							...
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="date" id="date_of_birth1" name="date_of_birth2"
										...
										onchange="calculate_age(this);" maxlength="3" min="1899-01-01"
										max="${date}">
								</div>
							</div>
						</div>
							...
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="contact_no" name="contact_no1"
										value="${edit_mortality_detailsCMD.contact_no}"
										autocomplete="off" class="form-control-sm form-control"
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<form:input type="text" id="operation" path="operation"
										class="form-control-sm form-control" autocomplete="off"
										maxlength="100" placeholder="Enter Operation..." />
								</div>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<form:input type="text" id="sector" path="sector"
										class="form-control-sm form-control" autocomplete="off"
					...
					<div class="col-md-12">
						...
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<form:input  type="text" id="bde_div_corps_comd"
										path="bde_div_corps_comd" class="form-control-sm form-control"
										autocomplete="off" placeholder="Enter Data..." />
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<form:input type="text" id="and_no" path="and_no"
										class="form-control-sm form-control" autocomplete="off"
						...
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<form:input type="text" id="death_summary" path="death_summary"
										class="form-control-sm form-control" autocomplete="off"
					...
					<div class="col-md-12">
						...
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<form:input type="text" id="cause_of_death" path="cause_of_death"
										class="form-control-sm form-control" autocomplete="off"
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<form:input type="text" id="name_of_nok" path="name_of_nok"
										class="form-control-sm form-control" autocomplete="off"
						...
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<form:input type="text" id="address_of_nok" path="address_of_nok"
										class="form-control-sm form-control" autocomplete="off"
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<form:input type="text" path="icd_code" id="icd_code"
										class="form-control-sm form-control" autocomplete="off"
...
//	$("#service").val("ARMY");
	...
	$("#nok_informed").change(function(){
	 ...
	 var d = new Date('${edit_mortality_detailsCMD.date_of_death}');
		...
		$("#service").val('${edit_mortality_detailsCMD.service}');
		...
		if ('${edit_mortality_detailsCMD.category}' == "OR"
			&& '${edit_mortality_detailsCMD.service}' == "ARMY") {
		$("#persnl_no2").val(
				'${edit_mortality_detailsCMD.persnl_no}'
						.substring(0, l - 1));
		$("#persnl_no3").val(
				'${edit_mortality_detailsCMD.persnl_no}'
						.substring(l - 1, l));
	} else if ('${edit_mortality_detailsCMD.service}' == "AIRFORCE"
			|| '${edit_mortality_detailsCMD.service}' == "NAVY") {
		$("#persnl_no2").val(
				'${edit_mortality_detailsCMD.persnl_no}'
						.substring(0, l - 1));
		$("#persnl_no3").val(
				'${edit_mortality_detailsCMD.persnl_no}'
						.substring(l - 1, l));
	} else if ('${edit_mortality_detailsCMD.service}' == "ARMY"
			&& '${edit_mortality_detailsCMD.category}' != "OR") {
		$("#persnl_no1").val(
				'${edit_mortality_detailsCMD.persnl_no}'
						.substring(0, 2));
		$("#persnl_no2").val(
		...
		$("#persnl_no3").val(
				'${edit_mortality_detailsCMD.persnl_no}'
						.substring(l - 1, l));
	} else if ('${edit_mortality_detailsCMD.service}' == "OTHERS") {
		$("#persnl_no1").val('-1');
		$("#persnl_no2").val('');
		$("#persnl_no3").val('-1');
	}

	if ('${edit_mortality_detailsCMD.service}' == "NAVY"
			|| '${edit_mortality_detailsCMD.service}' == "AIRFORCE") {
		$("#persnl_no1").attr('readonly', true);
		$("#category").attr('readonly', false);
	}
	if ('${edit_mortality_detailsCMD.service}' == "OTHERS") {
		$("#persnl_no1").attr('readonly', true);
		$("#persnl_no2").attr('readonly', true);
		$("#persnl_no3").attr('readonly', true);
		$("#category").attr('readonly', true);
	...
	if ('${edit_mortality_detailsCMD.service}' == "ARMY") {
		$("#category").attr('readonly', true);
	}

	if ('${edit_mortality_detailsCMD.service}' != "OTHERS") {
		$("#category").val(
				'${edit_mortality_detailsCMD.category}');
		getRank();
	}
	...
	calculate_age_edit('${edit_mortality_detailsCMD.date_of_birth}');
});
</script>