...
<!-- bed_occ_ex_serv -->
<form:form action="bed_occ_servAct" id="bed_occ_serv"  method="post" class="form-horizontal" commandName="bed_occ_servCmd">		
<div class="container" align="center">
    <div class="card">
		 ...
		 <div class="card-body card-block" id="a2" style="display: none;">
		            ...
		            <div class="col-md-12">							
	               		 ...
	               		 <div class="col-md-6">
	               			  ...
	               			  <input type="text" id="unit_name1" name ="unit_name1" class="form-control-sm form-control" value="${unit_name}"
						 ...
						 <div class="col-md-2" style="text-align: left;"> 
	             		 ...
	             		 <div class="col-md-2">
	             			  ...
	             			  <input type="text" id="sus_no1" name="sus_no1" class="form-control-sm form-control" value="${sus_no}"
	             ...
	             <div class="col-md-2" style="text-align: left;">
	               		 ...
	               		 <div class="col-md-4">
	             			    <select name="quater" id="quater"  class="form-control-sm form-control" onchange="Quarter_exist()">
               					      <option value="-1">--Select--</option>
  				...
  				<div class="col-md-12" >
  					...
  					<div class="col-md-12" style="display: none;" id="b3">
  					     <div class="col-md-2" style="text-align: left;">
	               		 ...
	               		 <div class="col-md-2">
	               		      <input type="text" id="no_of_fmly_ref_adm1" name="no_of_fmly_ref_adm1" class="form-control-sm form-control" value="0"
	               		      autocomplete="off" maxlength="10" onkeypress="return isNumberPointKey(event)">
	               		 </div>
  					</div>
		 ...
		 <div class="card-footer" align="center">	        
	          <a href="mnh_input_bed_occupancy" class="btn btn-primary btn-sm"  id="btn_cler">Clear</a>	         
...
function defaultval(){
	...
	if($("#ofcr_fmly_max").val() == "") {
		$("#ofcr_fmly_max").val('0');
	}
	if($("#ofcr_fmly_tot").val() == "") {
		$("#ofcr_fmly_tot").val('0');
	}
	if($("#ofcr_fmly_avg").val() == "") {
		$("#ofcr_fmly_avg").val('0');
	}
	if($("#jco_fmly_max").val() == "") {
		$("#jco_fmly_max").val('0');
...
function Quarter_exist()
{

	
		
		 var qtr = $("select#quater").val();
		 var sus = $("#sus_no1").val();
		 var type =$("#type").val();
		 var yr =$("#yr").val();
		 $.ajaxSetup({
		 ...
		 var id = "0";
		 $.post("getquaterAlreadyExist?"+key+"="+value, {qtr : qtr,sus:sus,id:id,type:type,yr:yr}).done(function(j) {
			 	if(j == false){
					alert("Quater and SUS No already Exist.")
					$("input#sus").val("");
					$("select#quater").val("-1");
...
function validate(){
	...
	if(parseInt($("#ofcr_max").val()) > parseInt($("#ofcr_tot").val())){
		alert("Please Enter The Proper Max Value");
		$("#ofcr_max").focus();
		return false;
	}	
	 if(parseInt($("#jco_max").val()) > parseInt($("#jco_tot").val())){
		alert("Please Enter The Proper Max Value");
		$("#jco_max").focus();
		return false;
	}	
	 if(parseInt($("#ofcr_fmly_max").val()) > parseInt($("#ofcr_fmly_tot").val())){
		alert("Please Enter The Proper Max Value");
		$("#ofcr_fmly_max").focus();
		return false;
	}	
	 if(parseInt($("#jco_fmly_max").val()) > parseInt($("#jco_fmly_tot").val())){
		alert("Please Enter The Proper Max Value");
		$("#jco_fmly_max").focus();
		return false;
	}else{
