...
<form:form action="" id="" method="post"  class="form-horizontal">
	<div class="container" align="center">
		<div class="card">
			...
			<div class="card-body card-block">
					...
					<div class="col-md-12">
						<div class="col-md-8">
							<div class="row form-group">
								...
								<div class="col-md-9">
									<input type="text" id="unit_name1" name="unit_name1" value="${unit_name}" maxlength="100" class="form-control-sm form-control"
				...
				<div class="col-md-4">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="sus_no1" name="sus_no1" value="${sus_no}"maxlength="8" class="form-control-sm form-control" placeholder="Search..."
					...
					<div class="col-md-12 form-group">
								<div class="col-md-2">
									<label for="text-input" class=" form-control-label">Personnel No</label>
								</div>
			...
			<a href="mnh_input_hiv_search" class="btn btn-primary btn-sm" id="btn_clc" >Clear</a>
...
<c:url value="search_hiv_Input" var="searchUrl" />
<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="sus1">
	...
	<input type="hidden" name="relation1" id="relation1" value="0"/>
	
</form:form>
 		
<c:url value="edit_hiv_Input" var="editUrl" />
<form:form action="${editUrl}" method="post" id="updateForm" name="updateForm" modelAttribute="id2">
     <input type="hidden" name="id2" id="id2"/>
</form:form>	

<c:url value="delete_hiv_Input" var="deleteUrl" />
