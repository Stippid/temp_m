...
<form:form action="" method="post" class="form-horizontal" commandName="">
      ...
      <div class="container" >
          <div class="card">
              <div class="card-header"  align="center">
		             <h5>SEARCH INVALIDMENT DETAILS</h5>
		      </div>
			...
			<div class="card-body card-block">
				<div class="row">
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								<div class="col-md-4">
									<label for="text-input" class="form-control-label"> Date Place Origin</label>
								</div>
								<div class="col-md-8">
									<input type="date" id="date_place_origine" name="date_place_origine" placeholder="" class="form-control-sm form-control">
								</div>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="row form-group">
								<div class="col-md-4">
									<label for="text-input" class="form-control-label"> Date of IMB</label>
								</div>
								<div class="col-md-8">
									<input type="date" id="date_imb" name="date_imb" placeholder="" class="form-control-sm form-control">
								</div>
							</div>
						</div>
					</div>
		      ...
		      <div class="col-md-6">
				...
				<div class="card-footer" align="center">
						<a href="mnh_input_search_invalidment"  class="btn btn-primary btn-sm"  id="btn_clc" >Clear</a>
		                           ...
		                           <c:if test="${not empty list}">
		                                <c:forEach var="item" items="${list}" varStatus="num" >
							               <tr >
											   ...
											   <td >${item.diagnosis_remarks}</td>
											   <td >${item.icd_code}</td>
											    <td >${item.icd_cause}</td>
											   <td  >${item.date_imb}</td>
											   <td  >${item.date_place_origine}</td>
 ...
 <c:url value="search_invalid_IMB_Input" var="searchUrl" />
...
function searchData(){
	...
	var ps_no = $("#persnl_no1").val() + $("#persnl_no2").val() + $("#persnl_no3").val();
	$("#sus1").val($("#sus_no1").val());
	$("#unit1").val($("#unit_name1").val());
	$("#psn_no").val(ps_no);
	$("#dt_origin1").val($("#date_place_origine").val());
	$("#dt_imb1").val($("#date_imb").val());
