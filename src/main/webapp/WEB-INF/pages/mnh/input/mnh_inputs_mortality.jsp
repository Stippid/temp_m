...
<script type="text/javascript" src="js/AES_ENC_DEC/AesUtil.js"></script>
 ...
 <script src="js/miso/orbatJs/orbatAll.js" type="text/javascript"></script>
<form:form action="mortality_details_inputAction" id="mortality_details_input" method="post" class="form-horizontal" commandName="mortality_details_inputCMD">
   
      <div class="container">
          <div class="card">
              <div class="card-header"  align="center">
		             <h5>MORTALITY DETAILS</h5>
		             <h6>
					...
					<div class="col-md-12">
						...
						<div class="col-md-4">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="sus_no" name="sus_no"value="${sus_no}"
										class="form-control-sm form-control" placeholder="Search..."
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="persnl_name" name="persnl_name" onkeypress="return onlyAlphabets(event);"
										class="form-control-sm form-control" autocomplete="off"
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="date" id="dt_mortality" name="dt_mortality1"
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="operation" name="operation" onkeypress="return onlyAlphaNumeric(event);" 
										class="form-control-sm form-control" autocomplete="off"
						...
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="sector" name="sector" onkeypress="return onlyAlphaNumeric(event);" 
										class="form-control-sm form-control" autocomplete="off"
					...
					<div class="col-md-12">
						...
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="bde_div_corps_comd" onkeypress="return onlyAlphaNumeric(event);" 
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8"> 
									<input type="text" id="and_no" name="and_no" onkeypress="return onlyAlphaNumeric(event);" 
										class="form-control-sm form-control" autocomplete="off"
							...
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="name_of_nok" name="name_of_nok" onkeypress="return onlyAlphabets(event);"
										class="form-control-sm form-control" autocomplete="off"
										maxlength="100" placeholder="Enter Name of NOK..." readonly>
								</div>
							</div>
						</div>
							...
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="address_of_nok" name="address_of_nok" onkeypress="return onlyAlphaNumeric(event);" 
										class="form-control-sm form-control" autocomplete="off"
										maxlength="255" placeholder="Enter Address of NOK..." readonly>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-md-12">
						...
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" name="icd_cause" id="icd_cause" onkeypress="return onlyAlphaNumeric(event);" 
										class="form-control-sm form-control" autocomplete="off"
			...
			<div class="card-footer" align="center" >
			        <a href="mnh_input_mortality" class="btn btn-primary btn-sm"  id="btn_clc">Clear</a>  
