...
<form:form action="EditODPcasesAction" id="EditODPcases" method="post" class="form-horizontal" commandName="EditODPcasesCMD">
	<div class="container" align="center">
		<div class="card">
			<div class="card-header ">
				<h5>UPDATE OPD DETAILS</h5>
				<h6>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="col-md-8">
							<div class="row form-group">
								...
								<div class="col-md-9">
									<input type="text" id="unit_name" name="unit_name"  class="form-control-sm form-control" placeholder="Search..." autocomplete="off" maxlength="100" 
					...
					<div class="col-md-12">
						...
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="officer_self" name="officer_self" class="form-control-sm form-control" placeholder="0"
						...
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="officer_family" name="officer_family" class="form-control-sm form-control" placeholder="0"
									onkeypress="return isNumberPointKey(event)" maxlength="10" autocomplete="off" onkeyup="totalcal();">
								</div>
							</div>
						</div>
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="jco_ors_self" name="jco_ors_self" class="form-control-sm form-control" placeholder="0"
									onkeypress="return isNumberPointKey(event)" maxlength="10" autocomplete="off" onkeyup="totalcal();">
								</div>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="jco_ors_family" name="jco_ors_family" class="form-control-sm form-control" placeholder="0"
								   onkeypress="return isNumberPointKey(event)" maxlength="10" autocomplete="off" onkeyup="totalcal();">
								</div>
							</div>
						</div>
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="ex_serv_self" name=ex_serv_self class="form-control-sm form-control" placeholder="0"
									onkeypress="return isNumberPointKey(event)" maxlength="10" autocomplete="off" onkeyup="totalcal();">
								</div>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="ex_serv_family" name="ex_serv_family" class="form-control-sm form-control" placeholder="0"
									onkeypress="return isNumberPointKey(event)" maxlength="10" autocomplete="off" onkeyup="totalcal();">
								</div>
							</div>
						</div>
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									...
									placeholder="0" onkeypress="return isNumberPointKey(event)" maxlength="10" autocomplete="off" onkeyup="totalcal();">
								</div>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="para_mil_pers_family" name="para_mil_pers_family" class="form-control-sm form-control" placeholder="0"
										onkeypress="return isNumberPointKey(event)" maxlength="10" autocomplete="off" onkeyup="totalcal();">
								</div>
							</div>
						</div>
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="civilian_self" name="civilian_self" class="form-control-sm form-control" placeholder="0"
									onkeypress="return isNumberPointKey(event)" maxlength="10" autocomplete="off" onkeyup="totalcal();">
								</div>
							</div>
						</div>
 				<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="civilian_family" name="civilian_family" class="form-control-sm form-control" placeholder="0"
									onkeypress="return isNumberPointKey(event)" maxlength="10" autocomplete="off" onkeyup="totalcal();">
								</div>
							</div>
						</div>
							...
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="total_during_month" name="total_during_month" class="form-control-sm form-control"
										placeholder="0" readonly="readonly" autocomplete="off" maxlength="10" />
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-md-12">
						...
						<div class="col-md-10" >
							<textarea rows="2" cols="250" class="form-control char-counter1" maxlength="250" placeholder="Enter Your Remarks..."
			...
			<div class="card-footer" align="center">
			    <input type="hidden" id="id" name="id" value="${EditODPcasesCMD.id}" class="form-control" autocomplete="off">				
				<a href="mnh_input_search_opd_cases" class="btn btn-danger btn-sm">Cancel</a>
...
$(document).ready(function() {
	...
	$("#year").val(year);
		...
		$("#sus_no").val('${EditODPcasesCMD.sus_no}');
	
		$("#unit_name").attr('readonly',true);
		$.post("getMNHUnitNameBySUSNo?"+key+"="+value,{y:'${EditODPcasesCMD.sus_no}'},function(j) {
			var enc = j[j.length - 1].substring(0, 16);
			var a = dec(enc, j[0]);
			$("#unit_name").val(a);
		});
		getCommand('${EditODPcasesCMD.sus_no}');
		$("#ward").val('${EditODPcasesCMD.ward}');
		$("#quater").val('${EditODPcasesCMD.qtr}');
		$("#year").val('${EditODPcasesCMD.year}');
		
		if('${EditODPcasesCMD.officer_self}' != 0){
			$("#officer_self").val('${EditODPcasesCMD.officer_self}');
		}
		if('${EditODPcasesCMD.officer_family}' != 0){
			$("#officer_family").val('${EditODPcasesCMD.officer_family}');
		}
		if('${EditODPcasesCMD.jco_ors_self}' != 0){
			$("#jco_ors_self").val('${EditODPcasesCMD.jco_ors_self}');
		}
		if('${EditODPcasesCMD.jco_ors_family}' != 0){
			$("#jco_ors_family").val('${EditODPcasesCMD.jco_ors_family}');
		}
		if('${EditODPcasesCMD.ex_serv_self}' != 0){
			$("#ex_serv_self").val('${EditODPcasesCMD.ex_serv_self}');
		}
		if('${EditODPcasesCMD.ex_serv_family}' != 0){
			$("#ex_serv_family").val('${EditODPcasesCMD.ex_serv_family}');
		}
		if('${EditODPcasesCMD.para_mil_pers_self}' != 0){
			$("#para_mil_pers_self").val('${EditODPcasesCMD.para_mil_pers_self}');
		}
		if('${EditODPcasesCMD.para_mil_pers_family}' != 0){
			$("#para_mil_pers_family").val('${EditODPcasesCMD.para_mil_pers_family}');
		}
		if('${EditODPcasesCMD.civilian_self}' != 0){
			$("#civilian_self").val('${EditODPcasesCMD.civilian_self}');
		}
		if('${EditODPcasesCMD.civilian_family}' != 0){
			$("#civilian_family").val('${EditODPcasesCMD.civilian_family}');
		}
		if('${EditODPcasesCMD.total_during_month}' != 0){
			$("#total_during_month").val('${EditODPcasesCMD.total_during_month}');
		}
		
		$("#remarks").val('${EditODPcasesCMD.remarks}');
