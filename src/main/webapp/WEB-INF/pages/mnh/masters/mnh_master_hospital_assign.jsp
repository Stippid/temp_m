...
<form:form action="ms_hos_assignAction" id="ms_hos_assign"  method="post" class="form-horizontal" commandName="ms_hos_assignCMD">
      <div class="container" align="center">
          <div class="card">
              <div class="card-header">
		             <h5>ASSIGNMENTS OF MEDICAL UNITS</h5>
		             <h6>
...
$(document).ready(function() {
	...
	function getAssignData() {
		...
		$.post("getMNHASSIGNList?" + key + "=" + value, {user_id : user_id1}, function(j) {
