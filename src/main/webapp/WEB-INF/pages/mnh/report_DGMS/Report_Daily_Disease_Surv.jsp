      ...
      <div class="container" align="center">
          <div class="card">
		       ...
		       <div class="card-header ">
		           <h5> DAILY DISEASE SURVEILLANCE REPORT</h5>
		           <h6>
              ...
              <div class="row">
	              ...
	              <div class="row form-group">							
	               		 ...
	               		 <div class="col-md-9">
	             			 ...
	             			 <div class="row form-group">
							  <div class="col-md-4">
									<label for="text-input" class=" form-control-label" style="margin-left: 11px;">Diagnosis</label>
							  </div>
							  
							  <div class="col-md-8">
								     <select name="diagnosis" id="diagnosis" class="form-control-sm form-control">
		            ...
		            <div class="col-md-12">
		             <div class="col-md-6">
		                ...
		                <div class="col-md-6">
	              		<div class="row form-group">
					     <div class="col-md-4" >
						     <label for="text-input" class=" form-control-label" style="margin-left: 11px;">Category</label>
					     </div>
					     <div class="col-md-8">
            ...
            <a href="mnh_DR_dd_Surve" type="reset" class="btn btn-primary btn-sm"> Clear </a> 
						         ...
						         <c:if test="${list.size()==0}">
						               ...
						               <c:forEach var="item" items="${list}" varStatus="num" >
						                   <tr>
									               ...
									               <td style="text-align: left;">${item.disease_name}</td>
									               <td style="text-align: center;">${item.count_diag}</td>
					                   ...
					                   <tr>
					                    		<td style="text-align: right;font-size: 15px;width: 68.4%;" colspan="3"><B>Total</B></td>
...
<c:url value="getsearch_Daily_desease_Report" var="searchUrl" />
<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="sus1">
		...
		<input type="hidden" name="diag1" id="diag1"/>
...
function printDiv() {
	...
	printLbl = ["Command :","From Date :","To Date :"];
	 ...
	 printDivOptimize12('divShow','DAILY DISEASE SURVEILLANCE REPORT ',printLbl,printVal,"");
...
function chgCategory(){
	...
	if($("#service").val() == "OTHERS"){
		...
		$("#category option[value='OR']").show();
		$("#category option[value='PARAMIL']").show();
		$("#category").val('-1')
	}	
	...
	if($("#service").val() == "ARMY"){
		...
		$("#category option[value='MNS']").show();
		$("#category option[value='JCO']").show();
		$("#category option[value='PARAMIL']").hide();
	}
}
