...
<form:form action="" id="" method="post" class="form-horizontal" commandName="">
      ...
      <div class="container" align="center">
          <div class="card">
		       ...
		       <div class="card-header ">
		           <h5>DAILY MORNING BED STATE REPORT</h5>
		           <h6>
	 ...
	 <input type="hidden" id="sus_no" name="sus_no"> 	
            ...
            <a href="mnh_daily_bedstateDR" type="reset" class="btn btn-primary btn-sm"> Clear </a> 
            <i class="fa fa-search"></i><input type="button" id="search_btn" class="btn btn-success btn-sm" value="Search" onclick="Search();">
		                            ...
		                            <c:forEach var="list" items="${list}" varStatus="num" >
							          <tr>
							           ...
							           <td style="text-align: center;" width ="10%">${num.index+1}</td>
										 ...
										 <td id="thAction1" style="text-align: center;">${list[4]}</td>
...
<c:url value="getsearch_morning_bed_Report" var="searchUrl" />
...
<c:url value="viewdailymorningbedstatedata" var="updateUrl" />
<form:form action="${updateUrl}" method="post" id="updateForm" name="updateForm" modelAttribute="sus_no" target="result" >
...
var newWin;
function editData(sus_no,unit_name,total_all,beds_laid_out){
	//alert(id)
	...
	document.getElementById('updateid').value=sus_no;
...
function printDiv() {
	...
	printLbl = ["Command :","From Date :","To Date :"];
	 ...
	 printDivOptimize12('divShow','DAILY MORNING BED STATE REPORT ',printLbl,printVal,"");
