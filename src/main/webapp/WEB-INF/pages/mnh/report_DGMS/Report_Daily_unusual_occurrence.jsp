      ...
      <div class="container" align="center">
          <div class="card">
		       ...
		       <div class="card-header ">
		           <h5> DAILY UNUSUAL OCCURRENCE REPORT</h5>
		           <h6>
              ...
              <div class="form-control card-footer" align="center">
                    ...
                    <a href="mnh_DR_unusual" type="reset" class="btn btn-primary btn-sm"> Clear </a> 
						               ...
						               <c:forEach var="item" items="${list}" varStatus="num" >
						                   <tr>
									               ...
									               <td style="text-align: left;">${item.persnl_unit}</td>
										              ...
										              <td style="text-align: right;">${item.date_time_incident}</td>   
...
<c:url value="getsearch_Daily_unusual_Report" var="searchUrl" />
...
function printDiv() {
	...
	printLbl = ["Command :","From Date :","To Date :"];
	 ...
	 printDivOptimize12('divShow','DAILY UNUSUAL OCCURRENCE REPORT ',printLbl,printVal,"");
