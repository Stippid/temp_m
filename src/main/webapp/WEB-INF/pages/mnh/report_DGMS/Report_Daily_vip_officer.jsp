...
<form:form action="" id="" method="post" class="form-horizontal" commandName="">
      ...
      <div class="container" align="center">
          <div class="card">
		       ...
		       <div class="card-header ">
		           <h5> VIP(MAJ GEN & ABOVE) ADMISSION REPORT</h5>
		           <h6>
	...
	<div class="form-control card-footer" align="center">
		<a href="mnh_DR_adm1report" type="reset" class="btn btn-primary btn-sm"> Clear </a> 
...
<c:url value="getsearch_Daily_vip_Report" var="searchUrl" />
...
function printDiv() {
	...
	printLbl = ["Command :","From Date :","To Date :"];
	 ...
	 printDivOptimize12('divShow',' VIP(MAJ GEN & ABOVE) ADMISSION REPORT ',printLbl,printVal,"");
