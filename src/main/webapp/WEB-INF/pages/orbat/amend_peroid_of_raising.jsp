...
<form:form name="AmendPeriodOfRaisingForm" id="AmendPeriodOfRaisingForm" action="AmendPeriodOfRaisingFormAction?${_csrf.parameterName}=${_csrf.token}" method='POST' commandName="AmendPeriodOfRaisingFormCMD" enctype="multipart/form-data">

	<div class="animated fadeIn">
		<div class="container" align="center">
			<div class="row">
	        	<div class="card">
	        		<div class="card-header"><h5><b>EXTEND PERIOD OF RAISING/DISBANDMENT SCHEDULE</b><br></h5><h6><span style="font-size:12px;color:red;">(To be entered by SD Dte / MISO)</span></h6><strong>Schedule Details</strong> </div>
	        			<div class="card-body">
	          				<div class="col-md-12">
		          				<div class="col-md-6">
		          					<div class="row form-group">
	                					<div class="col col-md-4">
	                  						<label class=" form-control-label"><strong style="color: red;">*</strong> Authority of Extension</label>
	                					</div>
						...
						<div class="col-md-12">
	          			...
	          			<div class="col-md-12">
	          				<div class="col-md-6">
	          					<div class="row form-group">
				                	<div class="col col-md-4">
				                		<label for="text-input" class=" form-control-label"> Comd</label>
				                	</div>						                
									<div class="col-12 col-md-8">
...
<script>
	...
	function getOrbatDetailsFromUnitName(unitName){	
		$.post("getUnitDetailsList?"+key+"="+value,{unitName:unitName}, function(j) {
			if(j.length > 0) {
			    ...
			    getCONTBde(Contbde);
   	        	...
   	        	//SUS NO SPLIT FOR TYPEOFARM AND PARENT ARM
        	 	
   	        	ParentArm = Arm[0] + Arm[1]; 
   	        	TypeOfArm = Arm[0] + Arm[1] + Arm[2] + Arm[3]; 
   	        	
   	        	
   	        	$("input#comm_depart_date").val(dec(enc,j[19]));
   	        	$("input#compltn_arrv_date").val(dec(enc,j[20]));
   	        	//$("input#comm_depart_date").val(ParseDateColumn(j[i].comm_depart_date));
   	        	//$("input#compltn_arrv_date").val(ParseDateColumn1(j[i].compltn_arrv_date));
       ...
       function ParseDateColumn1(data) {
 		 	var d = new Date(data);
 		  	var date =   d.getFullYear() +'-'+ ("0" + (d.getMonth()+1)).slice(-2)+'-'+ ("0" + d.getDate()).slice(-2);
 		  	if(date=="NaN-NaN-NaN")
 		    	date="";
