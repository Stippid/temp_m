        ...
        <div  class="row">
        	<div class="col-md-12" id="addUnit" >						
				<datatables:table id="applicanttbl" url="LovUnit_SusNoList" serverSide="true" pipelining="true" pipeSize="3"	row="latlon" rowIdBase="applicant_id" rowIdPrefix="latlon_" displayLength="10"  jqueryUI="true"
		 					bDestroy="true" filterable="true" sortable="true" processing="true" border="1" scrollY="398" scrollX="100%" scrollCollapse="true" autoWidth="true" pageable="true" paginationType="full_numbers" stateSave="false" deferRender="true">  
