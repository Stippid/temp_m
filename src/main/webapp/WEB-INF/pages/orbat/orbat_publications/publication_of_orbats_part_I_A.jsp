...
<form action="" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn">
			<div  align="center">
	    		<div class="card">
	    			<div class="card-header"><h5>Publication Of Orbat : Part IA</h5></div>
	          			<div class="card-body">
	            			<div class="col-md-12">
		          				<div class="col-md-6">
						...
						<div class="card-footer" align="center">
							<a href="OrbatDetails_Report_Formation_Pub_CTPartIA" type="reset" class="btn btn-success btn-sm" style="border-radius: 5px;"> Clear </a> 
			            ...
			            <p style="color: red; font-size: 16px;">Warning: Screenshots of this page is not allowed. </p>
			            	<div class="" id="OrbatDetailsReport" >
								<datatables:table id="selection" url="getOrbatDetails_Formation_Rpt_Publications_CTPART_I_A" serverSide="true" pipelining="true" pipeSize="3"	row="latlon" rowIdBase="applicant_id" rowIdPrefix="latlon_" displayLength="25"  jqueryUI="true" lengthMenu="5,10,25,50,100,200,500,1000"
	    ...
	    <c:url value="search_OrbatDetails_profileSetSession_Publications_CTPARTIA" var="reloadUrl" />
