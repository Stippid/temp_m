...
<form:form name="updateAmendment" action="updateAmendment" method="post" commandName="relief_progCMD">
					 	...
					 	<div class="col-md-6 col-md-offset-1">
            			    ...
            			    <div class="row form-group">
                				<!-- <div class="col col-md-4">
                				 ...
                				 <div class="col-12 col-md-8">
                 					<input type="hidden" id="upload_document" name="upload_document" class="form-control"   readonly="readonly" value="${relief_progCMD.upload_document}"> 	
                 					<input type="hidden" id="arr_dep_report" name="arr_dep_report" class="form-control"   readonly="readonly" value="${relief_progCMD.arr_dep_report}">                 					
						...
						<div class="card-body card-block">
				          ...
				          <div class="row form-group">
		                      ...
		                      <div class="row form-group">
						                ...
						                <%-- 			<input type="hidden" id="typ_of_stn" name="typ_of_stn" placeholder="" class="form-control" value = "${relief_progCMD.typ_of_stn}" >
	              						            <input type="hidden" id="typ_of_terrain" name="typ_of_terrain" placeholder="" class="form-control" value = "${relief_progCMD.typ_of_terrain}" > --%>						                			
...
<%-- 			              				<div class="row form-group">
 ...
 --%>			              				<div class="row form-group" style="padding-top: 80px;">
					            ...
					            <div class="card-footer" align="center">
				                    ...
				                    <a href="getamendmentreport" type="reset" class="btn btn-danger btn-sm"> Cancel </a>				  
					            </div> 
