...
<form action="" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn">
	    		...
	    		<div class="card">
	    			<div class="card-header"><h5>View Orbat Details</h5></div>
						...
						<div class="card-footer" align="center">
							<a href="OrbatDetails_Report_Formation" type="reset" class="btn btn-success btn-sm" style="border-radius: 5px;"> Clear </a> 
			            ...
			            <div class="card-body">
			            	<div class="" id="OrbatDetailsReport" >
								<datatables:table id="selection" url="getOrbatDetails_Formation_Rpt" serverSide="true" pipelining="true" pipeSize="3"	row="latlon" rowIdBase="applicant_id" rowIdPrefix="latlon_" displayLength="5"  jqueryUI="true" lengthMenu="5,10,25,50,100,200,500,1000"
	    ...
	    <c:url value="search_OrbatDetails_profileSetSession" var="reloadUrl" />
