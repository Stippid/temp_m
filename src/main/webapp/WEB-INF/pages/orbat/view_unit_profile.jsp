...
<form:form action="" method="post"  class="form-horizontal"> 
	    	...
	    	<div class="row">
				<div class="card">
					<div class="card-header" style="border: 1px solid rgba(0,0,0,.125);"><h5><b>VIEW UNIT PROFILE</b></h5> <strong>Unit Details </strong> </div>
							<div class="card-body card-block">
									...
									<div class="col-md-6">
										<div class="row form-group">
						                	...
						                	<div class="col-12 col-md-8">
						                 		...
						                 		<select name="fmn" id="fmn" class="form-control-sm form-control">
								...
								<div class="col-md-12">	
									...
									<div class="col-md-6">
										<div class="row form-group" style="height: 33%">
						                	<div class="col col-md-4">
						                	...
						                	<div class="col-12 col-md-8">
						                		...
						                		<i class="fa fa-search" onclick="openLocLOV();"></i>
					                 			...
					                 			<!-- <input type="text" id="nrs_name" name="nrs_name" class="form-control" style="width:100%;" readonly="readonly"> -->
			              					</div>
					          			</div>
										<div class="row form-group" style="height: 33%">
						                	<div class="col col-md-4">
						                  		<label class=" form-control-label">Type Of Unit </label> <br>
						                  	</div>
						                	<div class="col-12 col-md-8">
					          			...
					          			<div class="row form-group" style="height: 33%">
						                	<div class="col col-md-4">
						                  		<label class=" form-control-label">CT Part I/II</label> <br>
						                  	</div>
						                	<div class="col-12 col-md-8">
						                		<select name="ct_part_i_ii" id="ct_part_i_ii"  class="form-control-sm form-control">
							                    	<option value="">--Select--</option>
		            ...
		            <div class="col-md-12" id="unitReport" >
         				<datatables:table id="applicanttbl" url="getUnitProfileRpt" serverSide="true" pipelining="true" pipeSize="3"	row="latlon" rowIdBase="applicant_id" rowIdPrefix="latlon_" displayLength="10"  jqueryUI="true"
	...
	<c:url value="viewUnitDetailsUrl" var="viewUrl" />
	...
	<c:url value="search_unit_profileSetSession" var="reloadUrl" />
