        			...
        			<div class="col-md-12">
								...
								<div class="col-md-6">
									<div class="row form-group">
			                			...
			                			<div class="col-12 col-md-8">
			                 				<select id="cont_corps" name="cont_corps" class="form-control" ></select>
			                			</div>
					              	</div>
								</div>
							</div>
								...
								<div class="col-md-6">
									<div class="row form-group">
						                ...
						                <div class="col-12 col-md-8">
						                 	<select id="cont_div" name="cont_div" class="form-control" ></select>
						                </div>
						            </div>
								</div>
								<div class="col-md-6">
									<div class="row form-group">
		                				...
		                				<div class="col-12 col-md-8">
		                 					<select id="cont_bde" name="cont_bde" class="form-control" ></select>
		                				</div>
					            	</div>
								</div>
							</div>
