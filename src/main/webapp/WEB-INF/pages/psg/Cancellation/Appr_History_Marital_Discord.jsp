		...
		<div class="container" align="center">
			<div class="card">
				<div class="card-header">
					<h5>APPROVE MARITAL DISCORD CANCEL HISTORY</h5>
					<h6 class="enter_by">
...
<c:url value="Appr_Cancel_Maritial_Discord_dat" var="cancelHisytoryUrl" />
...
<c:url value="Reject_Cancel_Maritial_Discord_dat" var="RejcancelHisytoryUrl" />
...
<c:url value="RejectCh_Cancel_Maritial_Discord_dat" var="RejChcancelHisytoryUrl" />
...
function RejCancelHistoryData(){
	$("#id_rj").val($("#p_id").val());
	$("#cat_rj").val($("#service_category_val").val()) ;	
...
function RejectCancelHistoryChData(ch_id){
	$("#id_rjP").val($("#p_id").val());
	$("#id_rjCh").val(ch_id);
	$("#cat_rjCh").val($("#service_category_val").val()) ;	
