...
<div class="col-md-12" style="padding-top: 5px; " align="center">
           ...
           <div class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
                 <table id="CDApopuptable" class="table no-margin table-striped  table-hover  table-bordered report_print">        
                                        <thead style="text-align: center;">
                                                <tr>
                                                    	<th >Ser No</th>
                                                       
                                                        <th >CDA Account No</th>                                                       											
                                                        <th >Updated By</th>
                                                        <th >Updated Date</th>
                                                        <th >Action</th>
                                           ...
                                           <tbody id="CDApopuptbody" align="center">
...
function getHistoryData(){
	...
	var status='${status}';
    $('#CDApopuptbody').empty(); 
     $.post('getCDAHistoryData?' + key + "=" + value, {status:status,comm_id:comm_id}, function(j){
                   var v=j.length;
                   if(v!=0){
                	   var i=0;          
           for(i;i<v;i++){
             ...
             $("table#CDApopuptable").append('<tr><td>'+am+'</td>'            		
            		 +'<td>'+j[i].cda_acc_no+'</td>'
				 ...
				 +'</tr>');
                	   ...
                	   $("table#CDApopuptable").append('<tr><td colspan="8" align="center">Data Not Available</td>'
                				 +'</tr>');
...
function getApproveHistoryData(){
     ...
     $.post('ApproveCDAHistoryData?' + key + "=" + value, {comm_id:comm_id}, function(j){
                  if(j==1){
...
function CancelHisCDAData(id){
	...
	$.post('CancelHisCDAData?' + key + "=" + value,{id:id,set_status:set_status}, function(j){
