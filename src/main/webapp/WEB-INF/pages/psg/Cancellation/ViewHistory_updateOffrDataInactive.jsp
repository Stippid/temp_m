			...
			<div class="panel-group" id="accordion">
				<div class="panel panel-default" id="insp_div1">
					...
					<div class="panel-heading">
						...
						<b>VIEW HISTORY DATA OF UNIT OFFR 
						  ...
						  <table id="battle_cause_table" class="table-bordered " style="margin-top: 10px; width: 100%;">
								<thead style="color: white; text-align: center;">
									<tr>
										...
										<th style="width: 10%;">Authority</th>
										<th style="width: 10%;">Date of Authority</th>
										<th style="width: 10%;">Classification of Casualty</th>
										<th style="width: 10%;">Nature of Casualty</th>
										<th style="width: 10%;">Name of Operation </th>
										<th style="width: 10%;">Date of Casualty</th>
										<th style="width: 10%;">Cause of Casualty</th>
										<th style="width: 10%;">Description</th>
										<th style="width: 10%;">Diagnosis</th>
										
										<th style="width: 10%;">Exact Place/Area/Post</th>
										<th style="width: 10%;">Whether On</th>
										<th style="width: 10%;">Unit</th>
										<th style="width: 10%;">BDE</th>
										<th style="width: 10%;">Div/Sub Area</th>
										...
										<th style="width: 10%;">District</th>
										<th style="width: 10%;">Tehsil</th>
										<th style="width: 10%;">Village/Town/City</th>
										<th style="width: 10%;">Pin</th>
										<th style="width: 10%;">Updated By</th>
										<th style="width: 10%;">Updated Date</th>
...
function validate_batnpc_save(){
		...
		if ($("#name_of_operation").val() == "" && $('input[name="classification_of_casuality"]:checked').val()!="physical_casuality") {
	 	...
	 	/* if(getformatedDate($("input#date_of_casuality").val()) > getformatedDate($("#batnpc_date_of_authority").val())) {
			alert("Date of Casualty should be Greater than Commission Date");
			return false;
	  } */
	     ...
	     if(v!=0){
			...
			for(i;i<v;i++){
				...
				$("table#battle_cause_table").append('<tr id="tr_battle_cause'+cor+'">'
	                     ...
	                     +'<td style="width: 10%;">'+j[i].authority+'</td>'
	                     +'<td style="width: 10%;">'+dauth+'</td>'
	                     +'<td style="width: 10%;">'+j[i].classification_of_casuality+'</td>'
	                     +'<td style="width: 10%;">'+j[i].nature_of_casuality+'</td>'
	                     +'<td style="width: 10%;">'+j[i].name_of_operation+'</td>'
	                     +'<td style="width: 10%;">'+dcause+'</td>'
	                     
	                     
	                     +'<td style="width: 10%;">'+j[i].cause_of_casuality+'</td>'
	                     +'<td style="width: 10%;">'+desc+'</td>'
	                     +'<td style="width: 10%;">'+j[i].diagnosis+'</td>'
...
// 		}
	...
	if ('${personnel_no_edit}' != ""){
		...
		var personnel_no = '${personnel_no_edit}';
		 var comm_id='${comm_id6}';
		    	 $.post('GetCensusDataApprove_noneffective?' + key + "=" + value,{ comm_id : comm_id },function(k) {
		    		 if(k.length > 0)
		    		 {
...
// 		    		    	$("#p_serving_status").text("Non-Effective");
...
function CancelHisChangeOfRankData(id){
	...
	$.post('CancelHisChangeOfRankData?' + key + "=" + value,{id:id,set_status:set_status,comm_id:comm_id}, function(j){
...
function CancelHisChangeOfNameData(id){
	...
	var comm_id=$('#comm_idV').val();
	$.post('CancelHisChangeOfNameData?' + key + "=" + value,{id:id,set_status:set_status,comm_id:comm_id}, function(j){
...
function CancelHisChangeInAppointment(id){
	...
	var comm_id=$('#comm_idV').val();
	$.post('CancelHisChangeInAppointment?' + key + "=" + value,{id:id,set_status:set_status,comm_id:comm_id}, function(j){
...
function CancelHisChangeIdentityCard(id){
	...
	var comm_id=$('#comm_idV').val();
	$.post('CancelHisChangeIdentityCard?' + key + "=" + value,{id:id,set_status:set_status,comm_id:comm_id}, function(j){
...
function CancelHisChangeInReligion(id){
	...
	$.post('CancelHisChangeInReligion?' + key + "=" + value,{id:id,set_status:set_status,comm_id:comm_id}, function(j){
...
function CancelHisMarriage(id){
	...
	$.post('CancelHisMarriage?' + key + "=" + value,{id:id,set_status:set_status,comm_id:comm_id}, function(j){
...
function CancelHisSpouseQualification(id){
	...
	$.post('CancelHisSpouseQualification?' + key + "=" + value,{id:id,set_status:set_status,comm_id:comm_id}, function(j){
...
function CancelHisChildDetails(id){
	...
	var comm_id=$('#comm_idV').val();
	$.post('CancelHisChildDetails?' + key + "=" + value,{id:id,set_status:set_status,comm_id:comm_id}, function(j){
...
function CancelHisNokDetails(id){
	...
	var comm_id=$('#comm_idV').val();
	$.post('CancelHisNokDetails?' + key + "=" + value,{id:id,set_status:set_status,comm_id:comm_id}, function(j){
...
function CancelHisAddressDetails(id){
	...
	var comm_id=$('#comm_idV').val();
	$.post('CancelHisAddressDetails?' + key + "=" + value,{id:id,set_status:set_status,comm_id:comm_id}, function(j){
...
function CancelHisQualification(id){
	...
	var comm_id=$('#comm_idV').val();
	$.post('CancelHisQualification?' + key + "=" + value,{id:id,set_status:set_status,comm_id:comm_id}, function(j){
...
function CancelHisLanguage(id){
	...
	var comm_id=$('#comm_idV').val();
	$.post('CancelHisLanguage?' + key + "=" + value,{id:id,set_status:set_status,comm_id:comm_id}, function(j){
...
function CancelHisContactDetails(id){
	...
	var comm_id=$('#comm_idV').val();
	$.post('CancelHisContactDetails?' + key + "=" + value,{id:id,set_status:set_status,comm_id:comm_id}, function(j){
...
function CancelHisPromotionalExam(id){
	...
	$.post('CancelHisPromotionalExam?' + key + "=" + value,{id:id,set_status:set_status,comm_id:comm_id}, function(j){
...
function CancelHisBPET(id){
	...
	$.post('CancelHisBPET?' + key + "=" + value,{id:id,set_status:set_status,comm_id:comm_id}, function(j){
...
function CancelHisFiringStandard(id){
	...
	var comm_id=$('#comm_idV').val();
	$.post('CancelHisFiringStandard?' + key + "=" + value,{id:id,set_status:set_status,comm_id:comm_id}, function(j){
...
function CancelHisAllergy(id){
	...
	var comm_id=$('#comm_idV').val();
	$.post('CancelHisAllergy?' + key + "=" + value,{id:id,set_status:set_status,comm_id:comm_id}, function(j){
...
function CancelHisForeignCountry(id){
	...
	var comm_id=$('#comm_idV').val();
	$.post('CancelHisForeignCountry?' + key + "=" + value,{id:id,set_status:set_status,comm_id:comm_id}, function(j){
...
function CancelHisAwardsNmedal(id){
	...
	$.post('CancelHisAwardsNmedal?' + key + "=" + value,{id:id,set_status:set_status,comm_id:comm_id}, function(j){
...
function CancelHisDiscipline(id){
	...
	var comm_id=$('#comm_idV').val();
	$.post('CancelHisDiscipline?' + key + "=" + value,{id:id,set_status:set_status,comm_id:comm_id}, function(j){
...
function CancelHisInter_arm_transfer(id){
	...
	var comm_id=$('#comm_idV').val();
	$.post('CancelHisInter_arm_transfer?' + key + "=" + value,{id:id,set_status:set_status,comm_id:comm_id}, function(j){
...
function CancelHisChange_of_commission(id){
	...
	var comm_id=$('#comm_idV').val();
	if('${ChangeOfComm}'>1){
	$.post('CancelHisChange_of_commission?' + key + "=" + value,{id:id,set_status:set_status,comm_id:comm_id}, function(j){
	...
	if(j==1){
		...
		alert("You Don't Cancel This Entry. First You Need Enter New Personal No Details.")
	}
...
function CancelHisExtension_of_comission(id){
	...
	var comm_id=$('#comm_idV').val();
	$.post('CancelHisExtension_of_comission?' + key + "=" + value,{id:id,set_status:set_status,comm_id:comm_id}, function(j){
...
function CancelHisSecondment(id){
	...
	$.post('CancelHisSecondment?' + key + "=" + value,{id:id,set_status:set_status,comm_id:comm_id}, function(j){
...
function CancelHisDeserter(id){
	...
	$.post('CancelHisDeserter?' + key + "=" + value,{id:id,set_status:set_status,comm_id:comm_id}, function(j){
...
function CancelHisCSD(id){
 ...
 function CancelHisMedicalDetails(id){
	 var comm_id=$('#comm_idV').val();
		...
		$.post('CancelHisMedicalDetails?' + key + "=" + value,{id:id,set_status:set_status,comm_id:comm_id}, function(j){
