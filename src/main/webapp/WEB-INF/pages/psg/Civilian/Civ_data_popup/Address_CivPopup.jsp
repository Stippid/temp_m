...
<form:form action="Change_Of_AddressCIV" method="post" class="form-horizontal" commandName="Change_Of_AddressCIVCMD">
<div class="" id="Change_Of_AddressCivUrl" style="display: block;">
		 ...
		 <c:if test="${list.size() != 0}">
			<c:forEach var="j" items="${list}" varStatus="num">
				...
				var spouse_country ='${j.spouse_country}';
	     		var spouse_state ='${j.present_state}';
	     		var spouse_district ='${j.present_district}';
	     		var spouse_tehsil ='${j.present_tehsil}';
				...
				$("table#ChangeInSpouseAddress_table").append('<tr id="tr_ChangeInPreAddress'+cor+'">'
	                     ...
	                     +'<td>'+'${j.stn_hq_sus_no}'+'</td>'
	                     +'<td>'+Stn_HQ_unit_name+'</td>'
	                     +'<td>'+'${j.created_by}'+'</td>'
	                     +'<td>'+dcod+'</td>'
	                     +'<td>'+'${j.modified_by}'+'</td>'
	                     +'<td>'+dmod+'</td>'
