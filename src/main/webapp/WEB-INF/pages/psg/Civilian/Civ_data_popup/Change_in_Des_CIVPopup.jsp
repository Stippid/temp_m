...
<form:form action="Change_Of_DesCIV" method="post" class="form-horizontal" commandName="Change_Of_DesCIVCMD">
<div class="" id="change_des" style="display: block;">
           <div class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
                 <table id="Change_Of_DesCivUrl" class="table no-margin table-striped  table-hover  table-bordered ">        
                                        <thead style="text-align: center;">
                                                <tr>
														...
														<th style="font-size: 10px; text-align: center">Designation</th>
														<th style="font-size: 10px; text-align: center">Date Of Designation</th>
                                          ...
                                          <c:if test="${list.size()==0}">
								             <tr>
                                                ...
                                                <c:forEach var="item" items="${list}" varStatus="num" >
							                           ...
							                           <c:if test="${ status1 != 1}">
															<td style="font-size: 10px;">${item[7]}${item[8]}
																${item[9]}</td>
														</c:if>
