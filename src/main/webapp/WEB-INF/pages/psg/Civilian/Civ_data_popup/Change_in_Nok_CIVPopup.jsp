...
<form:form action="Change_Of_NokCIV" method="post" class="form-horizontal" commandName="Change_Of_NokCIVCMD">
<div class="" id="Change_Of_NokCivUrl" style="display: block;">
           <div class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
                 <table id="Change_Of_NokCivUrl" class="table no-margin table-striped  table-hover  table-bordered ">        
                                        <thead style="text-align: center;">
                                                <tr>
														...
														<th style="font-size: 10px; text-align: center">Mobile No</th>
														<th style="font-size: 10px; text-align: center">Relation</th>
														<th style="font-size: 10px; text-align: center">Village</th>
														<th style="font-size: 10px; text-align: center">State</th>
														<th style="font-size: 10px; text-align: center">District</th>
														<th style="font-size: 10px; text-align: center">Tehsil</th>
														<th style="font-size: 10px; text-align: center">Pin</th>
														<th style="font-size: 10px; text-align: center">Country</th>
														<th style="font-size: 10px; text-align: center">Near Railway Station</th>
														<th style="font-size: 10px; text-align: center">Rural Urban Semi</th>
                                        ...
                                        <tbody >
                                          <c:if test="${list.size()==0}">
								             <tr>
									              <td style="font-size: 15px; text-align: center; color: red;" colspan="18">Data Not Available</td>
								             </tr>
										</c:if>
                                                <c:forEach var="item" items="${list}" varStatus="num" >
							                           ...
							                           <c:if test="${ status1 != 1}">
															<td style="font-size: 10px;">${item[16]}${item[17]}
																${item[18]}</td>
														</c:if>
