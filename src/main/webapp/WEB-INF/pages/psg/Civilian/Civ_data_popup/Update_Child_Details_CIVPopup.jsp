...
<form:form action="Update_Child_detailsCIV" method="post" class="form-horizontal" commandName="Update_Child_detailsCIVCMD">
<div class="" id="Update_Child_detailsCivUrl" style="display: block;">
           <div class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
                 <table id="Update_Child_detailsCivUrl" class="table no-margin table-striped  table-hover  table-bordered ">        
                                        <thead style="text-align: center;">
                                                <tr>
                                                        <th style="font-size: 10px; text-align: center">Ser No</th> 
								                        <th style="font-size: 10px; text-align: center">Name</th>
														<th style="font-size: 10px; text-align: center">Date of Birth</th>
														<th style="font-size: 10px; text-align: center">Relationship</th>
														<th style="font-size: 10px; text-align: center">If Adopted Child</th>
														<th style="font-size: 10px; text-align: center">Adoption Date</th>
														<th style="font-size: 10px; text-align: center">Aadhar Card No</th>
														<th style="font-size: 10px; text-align: center">Pan Card No</th>
...
$(document).ready(function() {
	 ...
	 colAdj("Update_Child_detailsCivUrl");
});
