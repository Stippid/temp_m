	...
	<div class="animated fadeIn">
    	<div class="col-md-12" align="center">
	    		<div class="card">
	    			...
	    			<div class="card-header"><h5>NON REGULAR ESTABLISHMENT </h5></div>
	 ...
	 <div class="col-md-12" id="Age_Wise_reporttbl" style="display: block;">
		<div class="watermarked" data-watermark="" id="divwatermark">
			...
			<table id="getSearch_Letter"
				...
				<thead>
						<tr>
							<th style="font-size: 15px; text-align: center;" rowspan = "3">SER NO </th>
							<th style="font-size: 15px; text-align: left;" rowspan = "3" >ARM/SERVICE</th>
							<th style="font-size: 15px; text-align: center;" colspan="6" >NON REGULAR EST </th>
							<th style="font-size: 15px; text-align: center;" rowspan = "3" >TOTAL</th>
							
						</tr>
						<tr>
						   <th style="font-size: 15px; text-align: center;" colspan="2"> PAID FROM REGULAR PAY HEADS </th>
						   <th style="font-size: 15px; text-align: center;" colspan="2">PAID FROM CONTINGENCIES </th>
						    <th style="font-size: 15px; text-align: center;" colspan="2">WORK CHARGED PERSONNEL AND OTHER </th>
						</tr>
						<tr>
						 <th style="font-size: 15px; text-align: center;" >NON INDUSTRIAL </th>
						  <th style="font-size: 15px; text-align: center;">INDUSTRIAL</th>
...
<%-- 							<th style="font-size: 15px; text-align: right;">${grand_total}</th> --%>
	...
	<c:url value="Download_Arm_Service_NonRegular" var="dwonloadUrl"/>
<form:form action="${dwonloadUrl}" method="post" id="downloadForm" name="downloadForm" >
</form:form>


<c:url value="Excel_Arm_Service_nonRegular" var="excelUrl" />
