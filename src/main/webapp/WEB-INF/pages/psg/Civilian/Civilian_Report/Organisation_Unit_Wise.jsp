...
<form action="" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn">
	    	...
	    	<div class="col-md-12" align="center">
	    		<div class="card">
	    			<div class="card-header"><h5>HELD STR OF CIVILIANS : ORGANISATION/ UNIT WISE</h5></div>
	    			<div class="card-header"><h5>DATA AS ON : ${date}</h5></div>
						...
						<div class="card-footer" align="center">
							<a href="Oraganisation_Unit_Wise_Url" type="reset" class="btn btn-success btn-sm"> Clear </a> 
		...
		<div class="col-md-12">
			<table id="Oraganisation_Unit_Wise_reporttbl" class="display table no-margin table-striped  table-hover table-bordered ">
				<thead>
			        <tr>
					
							<tr>
							<th rowspan ="4">SUS No</th>
							<th rowspan ="4">NAME OF ORG/UNIT</th>
							<th colspan ="6">HELD STR OF CIVILIANS </th>
							<th rowspan ="4">REMARKS</th>
							
						</tr>
						<tr>
						   <th colspan="2" rowspan = "2">GAZETTED </th>
						   <th colspan="4"  >NON GAZETTED </th>
						</tr>
						<tr>
...
<c:url value="Download_Oraganisation_Unit_Wise" var="dwonloadUrl"/>
...
<c:url value="Excel_Oraganisation_Unit_Wise" var="excelUrl" />
...
$(document).ready(function() {  
	...
	var select = '<option value="' + "0" + '">'+ "--Select--" + '</option>';
   	$('select#cont_comd').change(function() {
	   	...
	   	mockjax1('Oraganisation_Unit_Wise_reporttbl');
		table = dataTable('Oraganisation_Unit_Wise_reporttbl');
...
function data(tableName){
	if(tableName == "Oraganisation_Unit_Wise_reporttbl"){
		jsondata = [];
	...
	var s_groupa_gaz = 0; var s_groupb_gaz = 0; var s_groupb_nongaz_nonin = 0; var s_groupc_nongaz_nonin =0;
	var s_groupb_nongaz_in = 0; var s_groupc_nongaz_in = 0;
		$.post("getOraganisation_Unit_Wise_ReportDataList?"+key+"="+value,{startPage:startPage,pageLength:pageLength,Search:Search,orderColunm:orderColunm,orderType:orderType,
			cont_comd:cont_comd,cont_corps:cont_corps,cont_div:cont_div,cont_bde:cont_bde,unit_name:unit_name,sus_no:sus_no,parent_arm:parent_arm,
			cadre:cadre},function(j) {
			
			for (var i = 0; i < j.length; i++) {
				jsondata.push([j[i].sus_no, j[i].unit_name,j[i].groupa_gaz, j[i].groupb_gaz,j[i].groupb_nongaz_nonin,j[i].groupc_nongaz_nonin,
					j[i].groupb_nongaz_in,j[i].groupc_nongaz_in,""]);
				
				s_groupa_gaz += j[i].groupa_gaz; s_groupb_gaz +=j[i].groupb_gaz; s_groupb_nongaz_nonin +=j[i].groupb_nongaz_nonin;
				s_groupc_nongaz_nonin+=j[i].groupc_nongaz_nonin; s_groupb_nongaz_in +=j[i].groupb_nongaz_in; s_groupc_nongaz_in +=j[i].groupc_nongaz_in;
			}
			
			jsondata.push(["", "TOTAL".bold(),s_groupa_gaz, s_groupb_gaz,s_groupb_nongaz_nonin,s_groupc_nongaz_nonin,
				s_groupb_nongaz_in,s_groupc_nongaz_in,""]);
		});
		$.post("getOraganisation_Unit_Wise_TotalCount?"+key+"="+value,{Search:Search,cont_comd:cont_comd,cont_corps:cont_corps,cont_div:cont_div,
			cont_bde:cont_bde,unit_name:unit_name,sus_no:sus_no,parent_arm:parent_arm,cadre:cadre},function(j) {
			FilteredRecords = j;
		});
	}
