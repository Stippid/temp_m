...
<form:form name="Category_master" id="Category_master" action="CategoryAction" method="post" class="form-horizontal" commandName="CategoryCmd">
		...
		<div class="container" align="center">
			<div class="card">
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="category" name="category" class="form-control autocomplete" oninput="this.value = this.value.toUpperCase()" onkeypress="return onlyAlphabets(event);" maxlength="50" autocomplete="off"
										 />
								</div>
							</div>
						</div>
				...
				<div class="card-footer" align="center" class="form-control">
					<a href="category_url" class="btn btn-success btn-sm">Clear</a>
	...
	<br>
	<div class="container" id="category_search">
		<div class="">
			<div id="divShow" style="display: block;"></div>
			<div class="watermarked" data-watermark="" id="divwatermark" style="display: block;">
				<span id="ip"></span>
				<table id="category_search" class="table no-margin table-striped  table-hover  table-bordered report_print" width="100%">
...
<c:url value="Search_Category" var="searchUrl" />
...
<c:url value="Edit_Category" var="updateUrl" />
<form:form action="${updateUrl}" method="post" id="updateForm" name="updateForm" modelAttribute="id">
	<input type="hidden" name="updateid" id="updateid" value="0" />
</form:form>
<c:url value="Delete_Category" var="deleteUrl" />
<form:form action="${deleteUrl}" method="post" id="deleteForm" name="deleteForm" modelAttribute="id1">
	<input type="hidden" name="id1" id="id1" value="0" />
</form:form>
<c:url value="Category_Report" var="searchUrl" />
