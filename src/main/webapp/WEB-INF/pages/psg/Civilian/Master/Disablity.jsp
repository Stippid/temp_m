...
<form:form name="Disability_master" id="Disability_master" action="DisabilityAction" method="post" class="form-horizontal" commandName="DisabilityCMD">
	<div class="animated fadeIn">
		<div class="container" align="center">
			<div class="card">
				<div class="card-header">
					<h5>ADD/UPDATE DISABILITY</h5>
					<h6 class="enter_by">
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="disability" name="disability" class="form-control autocomplete" oninput="this.value = this.value.toUpperCase()" onkeypress="return onlyAlphabets(event);" maxlength="50"  autocomplete="off"
										 />
								</div>
							</div>
						</div>
				...
				<div class="card-footer" align="center" class="form-control">
					<a href="disability_url" class="btn btn-success btn-sm">Clear</a>
	...
	<br>
	<div class="container" id="disability_search">
		<div class="">
			<div id="divShow" style="display: block;"></div>
			<div class="watermarked" data-watermark="" id="divwatermark" style="display: block;">
				<span id="ip"></span>
				<table id="disability_search" class="table no-margin table-striped  table-hover  table-bordered report_print" width="100%">
...
<c:url value="Search_Disability" var="searchUrl" />
<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="cat1">
	<input type="hidden" name="disability1" id="disability1" value=""/>
	<input type="hidden" name="status1" id="status1" value="0" />
</form:form>
<c:url value="Edit_Disability" var="updateUrl" />
<form:form action="${updateUrl}" method="post" id="updateForm" name="updateForm" modelAttribute="id">
	<input type="hidden" name="updateid" id="updateid" value="0" />
</form:form>
<c:url value="Delete_Disability" var="deleteUrl" />
<form:form action="${deleteUrl}" method="post" id="deleteForm" name="deleteForm" modelAttribute="id1">
	<input type="hidden" name="id1" id="id1" value="0" />
</form:form>
<c:url value="Disability_Report" var="searchUrl" />
...
<script>
	...
	function Search() {
		$("#disability1").val($('#disability').val());
	...
	$(document).ready(function() {
		if ('${list.size()}' == "") {
			$("div#disability_search").hide();
		}
		if ('${disability1}' != "") {
			$("#disability").val('${disability1}');
		}
		if ('${status1}' != "") {
