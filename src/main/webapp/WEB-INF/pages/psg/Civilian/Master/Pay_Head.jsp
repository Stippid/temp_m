...
<form:form name="Pay_Head_master" id="Pay_Head_master" action="Pay_HeadAction" method="post" class="form-horizontal" commandName="Pay_HeadCmd">
	<div class="animated fadeIn">
		<div class="container" align="center">
			<div class="card">
				<div class="card-header">
					<h5>ADD/UPDATE PAY HEAD</h5>
					<h6 class="enter_by">
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="pay_head" name="pay_head" class="form-control autocomplete" oninput="this.value = this.value.toUpperCase()" onkeypress="return onlyAlphabets(event);" maxlength="50" autocomplete="off"
										 />
								</div>
							</div>
						</div>
				...
				<div class="card-footer" align="center" class="form-control">
					<a href="pay_head_url" class="btn btn-success btn-sm">Clear</a>
	...
	<br>
	<div class="container" id="pay_head_search">
		<div class="">
			<div id="divShow" style="display: block;"></div>
			<div class="watermarked" data-watermark="" id="divwatermark" style="display: block;">
				<span id="ip"></span>
				<table id="pay_head_search" class="table no-margin table-striped  table-hover  table-bordered report_print" width="100%">
...
<script>
	...
	$(document).ready(function() {
		if ('${list.size()}' == "") {
			$("div#pay_head_search").hide();
		}
		if ('${pay_head1}' != "") {
			$("#pay_head").val('${pay_head1}');
		}
		if ('${status1}' != "") {
