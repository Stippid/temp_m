		...
		<form id="post_out_form">
				...
				<div class="card-body card-block"><br>				 
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">							
									 <input type="text" id="from_sus_no" name="from_sus_no" onkeyup="search_sus1from(this,'unit_name')" tabindex="-1" onchange="To_sus_check()"
						...
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">											
								 <input type="text" id="unit_name" name="unit_name" onkeyup="search_unit1_from(this,'from_sus_no')" tabindex="-1" 
										class="form-control autocomplete" autocomplete="off" " onchange="To_sus_check();">									 							 	
								</div>
							</div>
						</div> 
					</div>
						...
						<div class="col-md-4">
							<div class="row form-group">
								<div class="col-md-4">
									...
									<div class="col-md-8">								
									<input type="text" id="employee_no" name="employee_no" class="form-control autocomplete" autocomplete="off"
										onchange="employee_number()" onkeyup="getemployee_no(this,'from_sus_no')">
								</div>
							</div>
						</div>
						<div class="col-md-4">
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="out_auth" name="out_auth" class="form-control autocomplete" autocomplete="off" onkeyup="return specialcharecter(this);" maxlength="50">
								</div>
							</div>
						</div>
						<div class="col-md-6">
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="o_to_sus_no" name="to_sus_no" onkeyup="search_sus(this,'unit_name1')"
									class="form-control autocomplete" autocomplete="off" maxlength="8" onchange="To_sus_check();" >									
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="unit_name1" name="unit_name1" onkeyup="search_unit(this,'o_to_sus_no')"
										class="form-control autocomplete" autocomplete="off" maxlength="8" onchange="To_sus_check();" >																	
								</div>
							</div>
						</div>
						...
						<div class="col-md-6">
						 ...
						 <!-- <div class="col-md-6" id="" >
							<div class="row form-group">
								...
								<div class="col-md-8">
									<textarea id="unit_description_out" name="unit_description_out" class="form-control autocomplete" onkeyup="return specialcharecter(this);"
					...
					<div class="card-footer" align="center" class="form-control">
						<a href="Posting_In_Out_CivilianUrl" class="btn btn-success btn-sm">Clear</a> 
					...
					<div class="card-body card-block"><br>
						...
						<div class="col-md-4">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="in_employee_no" name="employee_no" class="form-control autocomplete" autocomplete="off"
										onchange="Inemployee_number() ,statusPER();">
								</div>
							</div>
						</div>
					 	<div class="col-md-4">
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">								
									<input type="text" id="i_from_sus_no" name="from_sus_no" onkeyup="search_sus1from(this,'unit_nameIn')" class="form-control autocomplete" autocomplete="off" maxlength="8" onchange="from_sus_check()" >															
								</div>
							</div>
						</div>
						 <div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">									
								 	<input type="text" id="unit_nameIn" name="unit_nameIn" onkeyup="search_unit1_from(this,'i_from_sus_no')"
										class="form-control autocomplete" autocomplete="off" onchange="from_sus_check()">									 						 	
								</div>
							</div>
						</div> 
					</div>
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="in_auth" name="in_auth" class="form-control autocomplete" autocomplete="off" onkeyup="return specialcharecter(this);" maxlength="50">
								</div>
							</div>
						</div>
						<div class="col-md-6">
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="i_to_sus_no" name="to_sus_no"  onkeyup="search_sus(this,'unit_nameIn1')" tabindex="-1" class="form-control autocomplete" autocomplete="off" maxlength="8" onchange="from_sus_check()" >														
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="unit_nameIn1" name="unit_nameIn1" onkeyup="search_unit(this,'i_to_sus_no')" tabindex="-1" class="form-control autocomplete" autocomplete="off" maxlength="8" onchange="from_sus_check()" >																																			
								</div>
							</div>
						</div>
					</div>					 
...
/* Post In Start Save*/
	function save_postin() {
		var employee_no = $('#in_employee_no').val();
		...
		if ($("input#in_employee_no").val() == "") {
			alert("Please select Employee No");
			$("input#in_employee_no").focus();
			return false;
		}
		...
		if ($("input#in_auth").val().trim()  == "") {
			alert("Please Enter From Auth No");
			$("input#in_auth").focus();
			return false;
		}	
		...
		var prefix_per = $("#in_employee_no").text().substring(0,2);
		...
		var saveUrl;
			...
			saveUrl='Posting_In_CivilianAction?'
							
		$.post(saveUrl + key + "=" + value, {employee_no : employee_no,	rank : rank, from_sus_no : from_sus_no , to_sus_no : to_sus_no, 
				app_name : app_name,dt_of_tos : dt_of_tos,t_status : t_status,x_sus_no :x_sus_no,x_list_loc :x_list_loc,
				civ_id : civ_id,i_id : i_id	,in_auth : in_auth,in_auth_dt : in_auth_dt},
				function(data) {
			...
			if (data == "update")
				...
				window.location.href = "Search_Posting_In_Out_CivilianUrl";
			} else
				alert(data);
...
/* Post In End Save*/
 ...
 <script>
	...
	function statusPER(){		 
		var prefix_per = $("#in_employee_no").val().substring(0,2);		 
			if(prefix_per == "NT"){
				 $("#stats").show();
				}
			else{
...
/* Post Out Start Save*/
	function save_postout() {		
		...
		if(comm_date!=''){
			...
			var saveUrl;
			saveUrl='Posting_Out_CivilianAction?'	
					$.post(saveUrl + key + "=" + value, {unit_description:unit_description,from_sus_no:from_sus_no,employee_no : employee_no,
										rank:rank, to_sus_no : to_sus_no,out_auth : out_auth,out_auth_dt : out_auth_dt,dt_of_sos : dt_of_sos,
										civ_id : civ_id,h_id : h_id	},
				function(data) {        
			if (data == "update")
				alert("Data Updated Successfully");
...
/* Post Out Personnel No */
		...
		susNoAuto.autocomplete({
			source : function(request, response) {
				$.ajax({
					...
					data : {employee_no:employee_no,roleSus:roleSus},
					success : function(data) {
						var susval = [];
						var length = data.length - 1;
						var enc = data[length].substring(0, 16);
 ...
 /* Post Out End */
	...
	function fn_getOfficerData(){	
		...
		if (employee_no != "") {		 	
			var	perurl='GetEmployeeNoData?';							
			$.post(perurl + key + "=" + value, {employee_no:employee_no}, function(j) {
				console.log(j);
				var civ_id = j[0][0];
				var name = j[0][2];
				var rank = j[0][4];
				...
				$.post(cpurl + key + "=" + value,{ civ_id : civ_id},function(k) {
					 if(k.length > 0)
		    		 {							
						if(parseInt(k[0].status) != parseInt(1))	
							{								
							...
							{								
			    		    	...
			    		    	if(k[0].dt_of_tos != null)
			    		    	{
			    		    	 ...
			    		    	 if(k[0].joining_date_gov_service != null)
			    		    	{
			    		    		comm_date=ParseDateColumncommission(k[0].joining_date_gov_service);			    		    					    		    		
...
debugger;	 
		var employee_no = $("input#in_employee_no").val();
		if (employee_no != "") {
					
			var	perurl='CheckEmployeeNoData?';							
			$.post(perurl + key + "=" + value, {employee_no:employee_no}, function(j) {
				if(j.length!=0){
					if(j[0][1]=='4'){
						alert("Offcr In Non-Effective State");
						$("input#in_employee_no").val('');
						return false;
					}
					if(j[0][1] !='1' && j[0][1] !='5'){
						alert("Individual Record is still in Pending for Approval.Pl Notify the Approval to Approve all Pending Records in Update Offcr Form.");
				...
				$.post('GetCivilianOrCensusDataApprove?' + key + "=" + value,{ civ_id : civ_id},function(k) {
		    		 if(k.length > 0)
		    		 {
		    			 if(parseInt(k[0].status) != parseInt(1))		
							{						
	...
	$("input#in_employee_no").attr('readonly', false);
}
...
<script>
$("input#in_employee_no").keyup(function() {
		var employee_no = this.value;
		var susNoAuto = $("#in_employee_no");
	
		susNoAuto.autocomplete({
			source: function(request, response) {
				$.ajax({
					type: 'POST',
					url: "getEmpNoCivilianList?" + key + "=" + value,
					data: {
