...
<form:form name="" id="civilian_reg"
	action="editcivilianRegularAction?${_csrf.parameterName}=${_csrf.token}"
		...
		<div class="container-fluid" align="center">
			<div class="card">
				...
				<div class="card-body card-block">
					<div class="col-md-12">
						...
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" name="doa" id="doa" maxlength="10"
							...
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="employee_no" name="employee_no"
										onkeypress="return AvoidSpace(event)" oninput="this.value = this.value.toUpperCase()"
										value="${civilian_details_cmd.employee_no}" onchange="emp_no_already_exist();"
										 class="form-control autocomplete"
										autocomplete="off" maxlength="50">

								</div>
							
											<input type="hidden" id="employee_no_old" name="employee_no_old"  value="${civilian_details_cmd.employee_no}" class="form-control autocomplete" autocomplete="off">
							</div>
						</div>
							...
							<div class="row form-group">
								...
								<div class="col-md-8">
									...
									<input type="text" id="first_name" name="first_name"
										...
										class="form-control autocomplete"
										value="${civilian_details_cmd.first_name}" autocomplete="off"
							...
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" name="dob" id="dob" maxlength="10"
										...
										onblur="clickrecall(this,'DD/MM/YYYY');validateDate_BackDate(this.value,this);"
										onkeyup="clickclear(this, 'DD/MM/YYYY')"
										onchange="clickrecall(this,'DD/MM/YYYY');dobValidate(this);" aria-required="true" 
										autocomplete="off" style="color: rgb(0, 0, 0);">
								</div>
							</div>
						</div>
								...
								<div class="col-md-8">
									<select name="cadre" id="cadre"
										...
										<c:forEach var="item" items="${getCadre}" varStatus="num">
											<option value="${item[0]}"
												<c:if test="${item[0] eq civilian_details_cmd.cadre}">selected="selected"</c:if>>${item[1]}</option>
										</c:forEach>
									</select>
								</div>
							</div>
								...
								<div class="col-md-8">
									<select name="high_qual" id="high_qual"
										...
										<c:forEach var="item" items="${getCivHigh_Qualification}" varStatus="num">
											<option value="${item[0]}"
											<c:if test="${item[0] eq civilian_details_cmd.qualification}">selected="selected"</c:if>>${item[1]}</option>
										</c:forEach>
									</select>
								</div>
							</div>
								...
								<div class="col-md-8">
									<select name="classification_trade"
										...
										<c:forEach var="item" items="${getClassificationOfTradesList}"
											varStatus="num">
											<option value="${item[0]}"
												<c:if test="${item[0] eq civilian_details_cmd.classification_trade}">selected="selected"</c:if>>${item[1]}</option>
										</c:forEach>
									</select>
								</div>
								...
								<div class="col-md-8">
									<select name="whether_ex_serviceman" id="whether_ex_serviceman"
										...
										<c:forEach var="item" items="${getExservicemenList}"
											varStatus="num">
											<option value="${item[0]}"
												<c:if test="${item[0] eq civilian_details_cmd.whether_ex_serviceman}">selected="selected"</c:if>>${item[1]}</option>
										</c:forEach>
									</select>
								</div>
							</div>
								...
								<div class="col-md-8">
									<select name="whether_person_disability"
										...
										<c:forEach var="item" items="${getPersonWithDisabilityList}"
											varStatus="num">
											<option value="${item[0]}"
												<c:if test="${item[0] eq civilian_details_cmd.whether_person_disability}">selected="selected"</c:if>>${item[1]}</option>
										</c:forEach>
									</select>
								</div>
							</div>
								...
								<div class="col-md-8">
									<select name="post_initialy_appointed" id="initialy_appointed"
										...
										<c:forEach var="item" items="${getDesignationList}"
											varStatus="num">
											<option value="${item[0]}"
												<c:if test="${item[0] eq civilian_details_cmd.post_initialy_appointed}">selected="selected"</c:if>>${item[1]}</option>
										</c:forEach>
									</select>
								</div>
							</div>
								...
								<div class="col-md-8">
									...
									<select name="designation" id="designation"
										...
										<c:forEach var="item" items="${getDesignationList}"
											varStatus="num">
											<option value="${item[0]}"
												<c:if test="${item[0] eq civilian_details_cmd.designation}">selected="selected"</c:if>>${item[1]}</option>
										</c:forEach>
									</select>
								</div>
							</div>
							...
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="father_name" name="father_name"
										oninput="this.value = this.value.toUpperCase()"
										value="${civilian_details_cmd.father_name}"
										class="form-control autocomplete" autocomplete="off"
										onkeypress="return onlyAlphabets(event);" maxlength="50">
								</div>
							</div>
							...
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="mother_name" name="mother_name"
										oninput="this.value = this.value.toUpperCase()"
										value="${civilian_details_cmd.mother_name}"
										class="form-control autocomplete" autocomplete="off"
										onkeypress="return onlyAlphabets(event);" maxlength="50">
								</div>
							</div>
								...
								<div class="col-md-8">
									<div class="row form-group">
										...
										<input class="form-control" autocomplete="off"
											...
											type="text" onkeypress="return isNumber(event)" maxlength="4"
							...
							<div class="row form-group">
								...
								<div class="col-md-8">
									...
									<input type="text" id="pan_no" name="pan_no"
										value="${civilian_details_cmd.pan_no}"
										class="form-control autocomplete" autocomplete="off"
										onchange=" isPAN(this); "
					...
					<div class="col-md-12">
						<div class="col-md-4">
							<div class="row form-group">
								<div class="col-md-4">
									<label class=" form-control-label"> <strong
										style="color: red;">* </strong> Country
									</label>
								</div>
								<div class="col-md-8">
					...
					<div class="col-md-12">
						<div class="col-md-4" id="origin_country_other_div"
							...
							<div class="row form-group">
								<div class="col-md-4">
									<label class=" form-control-label"> <strong
										style="color: red;">* </strong> Country Other
									</label>
								</div>
								<div class="col-md-8">
						...
						<div class="col-md-4" id="origin_state_other_div"
							...
							<div class="row form-group">
								...
								<div class="col-md-4">
									<label class=" form-control-label"> <strong
										style="color: red;">* </strong> State Other
									</label>
								</div>
								<div class="col-md-8">
						...
						<div class="col-md-4" id="origin_dist_other_div"
							...
							<div class="row form-group">
								<div class="col-md-4">
									<label class=" form-control-label"> <strong
										style="color: red;">* </strong> District Other
									</label>
								</div>
								<div class="col-md-8">
									<input type="text" id="original_dist_other"
										name="original_dist_other" maxlength="50"
										class="form-control autocomplete" autocomplete="off"
										onkeypress="return onlyAlphabets(event);" />
								</div>
							</div>
					...
					<div class="col-md-12">
						...
						<div class="col-md-4" id="original_tehsil_other_div"
							...
							<div class="row form-group">
								<div class="col-md-4">
									<label class=" form-control-label"> <strong
										style="color: red;">* </strong> Tehsil Other
									</label>
								</div>
								<div class="col-md-8">
									<input type="text" id="original_tehsil_other"
										name="original_tehsil_other" maxlength="50"
										class="form-control autocomplete" autocomplete="off"
										onkeypress="return onlyAlphabets(event);" />
								</div>
							</div>
					...
					<div class="col-md-12">
						...
						<div class="col-md-4" id="present_dist_other_div"
							...
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="present_dist_other"
										name="present_dist_other" maxlength="50"
										class="form-control autocomplete" autocomplete="off"
										onkeypress="return onlyAlphabets(event);" />
								</div>
							</div>
					...
					<div class="col-md-12" id="div_eff" style="display: none;">
						<div class="col-md-4">
							<div class="row form-group">
								<div class="col-md-4">
									<label class=" form-control-label"><strong
					...
					<input type="hidden" name="edit_hd_r" id="edit_hd_r">
				</div>
				<input type="hidden" id="unit_sus_no1v" name="unit_sus_no1v"
					class="form-control autocomplete"> <input type="hidden"
					id="unit_name1v" name="unit_name1v"
					class="form-control autocomplete"> <input type="hidden"
					id="first_name1v" name="first_name1v"
					class="form-control autocomplete"> <input type=hidden
					id="status1v" name="status1v" class="form-control autocomplete">

				<div class="card-footer" align="center" class="form-control">
					<input type="submit" class="btn btn-primary btn-sm" value="Update"
						onclick="return validate();"> <a
						href="Search_civilian_regular" class="btn btn-info btn-sm">Back</a>
				</div>
			</div>
		</div>
	</div>
	  ...
	  var r = ('${roleAccess}');
		...
		$.post("getClassificationOfServiceList?"+key+"="+value,function(j) {
			$("#divContainer").empty();
	 		for ( var i = 0; i < j.length ;i++) {
	 		  var classification_services = '${civilian_details_cmd.classification_services}';
	 			var a = j[i][0];
	 		...
	 		ongaz('${civilian_details_cmd.classification_services}');
	 	});
		...
		$.post("getServiceStatusList?"+key+"="+value,function(j) {
			$("#div_service_status").empty();
	 		for ( var i = 0; i < j.length ;i++) { 
	 			  var service_status = '${civilian_details_cmd.service_status}';
		 			var as = j[i][0];
	...
	/* 	$.post("GetCiv_R_GroupList?"+key+"="+value,function(j) {
			$("#div_group").empty();
	 		for ( var i = 0; i < j.length ;i++) { 
	 			  ...
	 			  var civ_group = '${civilian_details_cmd.civ_group}';
		 			var g = j[i][0];

		 		 	if(g == civ_group){
		 		 		$("#div_group").append ( "<label>" + j[i][1] + "   </label>&nbsp;&nbsp<input type='radio' name='civ_group' id='civ_group' value='" + j[i][0] + "' checked />&nbsp;&nbsp &nbsp;&nbsp &nbsp;&nbsp  " );
		 			} else{ 
	 				$("#div_group").append ( "<label>" + j[i][1] + "   </label>&nbsp;&nbsp<input type='radio' name='civ_group' id='civ_group' value='" + j[i][0] + "'  /> &nbsp;&nbsp &nbsp;&nbsp &nbsp;&nbsp  " );
	 		} 
		 		 	}
	 	}); */
	 		...
	 		for ( var i = 0; i < j.length ;i++) { 
	 			  var civ_type = '${civilian_details_cmd.civ_type}';
		 			var t = j[i][0];
		 		 	...
		 		 	if(t == civ_type){
		 		 		$("#div_type").append ( "<label>" + j[i][1] + "   </label>&nbsp;&nbsp<input type='radio' name='civ_type' id='civ_type' value='" + j[i][0] + "' checked /> &nbsp;&nbsp &nbsp;&nbsp &nbsp;&nbsp &nbsp;&nbsp " );
		 			} else{ 
	  ...
	  if('${civilian_details_cmd.non_effective}' != 0 && '${civilian_details_cmd.date_non_effective}' != ""){
		     oneff1('yes');
		...
		datepicketDate('date_of_tos');
		 ...
		 $("#doa").val(ParseDateColumncommission('${civilian_details_cmd.dt_of_authority}'));
		 $("#unit_sus_no").val('${civilian_details_cmd.sus_no}');
		 $("#unit_sus_no").text('${civilian_details_cmd.sus_no}');
		 ...
		 $("#dob").val(ParseDateColumncommission('${civilian_details_cmd.dob}'));  
		 $("#date_of_joining").val(ParseDateColumncommission('${civilian_details_cmd.joining_date_gov_service}'));
		 $("#non_effective_date").val(ParseDateColumncommission('${civilian_details_cmd.date_non_effective}'));
		 $("#gender_other").val('${civilian_details_cmd.gender_other}');
		 $("#classification_of_trade_other").val('${civilian_details_cmd.classification_trade_other}');
		 $("#religion_other").val('${civilian_details_cmd.religion_other}');
		 $("#mother_tongue_other").val('${civilian_details_cmd.mother_tongue_other}');
		 $("#dt_of_designation").val(ParseDateColumncommission('${civilian_details_cmd.designation_date}'));
		 $("#nationality_other").val('${civilian_details_cmd.nationality_other}');
		 $("#service_other").val('${civilian_details_cmd.service_other}');
		 $("#date_of_tos").val(ParseDateColumncommission('${civilian_details_cmd.date_of_tos}'));
		 ...
		 if('${civilian_details_cmd.classification_services}' == "1")
		 	$("#cos_gaz").prop("checked", true);
		 else if('${civilian_details_cmd.classification_services}' == "2")
				$("#cos_non_gaz").prop("checked", true);
		 
		 if('${civilian_details_cmd.civ_group}' == "A")
			 	$("#group_a").prop("checked", true);
			 else if('${civilian_details_cmd.civ_group}' == "B")
					$("#group_b").prop("checked", true);
			 else if('${civilian_details_cmd.civ_group}' == "C")
					$("#group_c").prop("checked", true);
			 
		 if('${civilian_details_cmd.service_status}' == "1")
			 	$("#service_temporary").prop("checked", true);
			 else if('${civilian_details_cmd.service_status}' == "2")
		 ...
		 if('${civilian_details_cmd.whether_ex_serviceman}' != 0){
		 ...
		 if('${civilian_details_cmd.whether_person_disability}' != ""){
			 onWpwd('yes');
		 ...
		 $.ajaxSetup({
			...
			$("#country_original").val('${civilian_details_cmd.country_original}'); 
			fn_pre_domicile_Country_ready();
			$("Select#original_state").val('${civilian_details_cmd.state_original}'); 
			fn_pre_domicile_state();
			$("#original_district").val('${civilian_details_cmd.district_original}'); 
			fn_pre_domicile_district();
			if($("#original_tehsil").val()=='' || $("#original_tehsil").val()==null ){
			...
			$("#original_dist_other").val('${civilian_details_cmd.original_district_other}');
			$("#original_tehsil_other").val('${civilian_details_cmd.original_tehshil_other}');
			...
			$("#present_dist_other").val('${civilian_details_cmd.present_district_other}');
			$("#present_tehsil_other").val('${civilian_details_cmd.present_tehshil_other}');	
			$("#nationality").val('${civilian_details_cmd.nationality}'); 
  ...
  function ServiceOtherFn() {
  	...
  	function validate() {
  		 ...
  		 if ($("#authority").val().trim() == "") {
			...
			if ($("#doa").val() == "DD/MM/YYYY" || $("#doa").val().trim()=="") {
				alert("Please Select Date of Authority");
				$("#doa").focus();
				return false;
			} 
		 
		 var hd_r = $("#edit_hd_r").val();
		 if (hd_r == "MISO") {
		 ...
		 if ($("#dob").val() == "DD/MM/YYYY" || $("#dob").val().trim()=="") {
			...
			if ($("input[name='classification_services']:checked").val() == undefined) {
			 ...
			 if ($("input[name='civ_group']:checked").val() == undefined) {
			    ...
			    if(wpwd_yes=="yes"){
				 ...
				 if ($("#date_of_joining").val() == "DD/MM/YYYY" || $("#date_of_joining").val().trim()=="") {
				 ...
				 if(getformatedDate($("input#date_of_joining").val()) > getformatedDate($("#dt_of_designation").val())) {
				...
				if(getformatedDate($("input#date_of_joining").val()) > getformatedDate($("#date_of_tos").val())) {
				...
				if ($("#original_state").val() != "0") {
					...
					if(original_state == "OTHERS"){
						if ($("#original_state_other").val().trim() == "") {
							alert("Please Enter The Original Domicile of State Othe");
	...
	// unit name
	 ...
	 function Cancel(){
			...
			$("#unit_sus_no1").val($("#unit_sus_no1v").val()) ;
			$("#unit_name1").val($("#unit_name1v").val()) ;
			$("#first_name1").val($("#first_name1v").val()) ;
			$("#status1").val($("#status1v").val()) ;
	 ...
	 function classification_trade_other() {
			...
			if(classification_of_trade == "OTHERS"){
				...
				$("#classification_of_trade_other_div").hide();
				 ...
				 $("#classification_of_trade_other").val("");
			}
		}
	 function rel_other() {
				 		...
				 		for ( var i = 1; i < j.length ;i++) { 
				 			  ...
				 			  var civ_group = '${civilian_details_cmd.civ_group}';
					 			var g = j[i][1];
					 		 	...
					 		 	if(g == civ_group){
					 		 		$("#div_group").append ( "<label>" + j[i][1] + "   </label>&nbsp;&nbsp<input type='radio' name='civ_group' id='civ_group' value='" + j[i][1] + "' checked />&nbsp;&nbsp &nbsp;&nbsp &nbsp;&nbsp  " );
					 			} else{ 
				 				$("#div_group").append ( "<label>" + j[i][1] + "   </label>&nbsp;&nbsp<input type='radio' name='civ_group' id='civ_group' value='" + j[i][1] + "'  /> &nbsp;&nbsp &nbsp;&nbsp &nbsp;&nbsp  " );
				 		} 
					 		 	}
				 	});
			} 
	 ...
	 function AvoidSpace(event) {
	  ...
	  function openFullScreen() {
	     ...
	     function emp_no_already_exist()
		 {
			 ...
			 var emp_old = $("input#employee_no_old").val();	
