...
<form:form name="civilian_non_reg" id="civilian_non_reg"
	action="Edit_non_regular_civilian_personnel_Action?${_csrf.parameterName}=${_csrf.token}" method="post"
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="employee_no" name="employee_no" onkeypress="return AvoidSpace(event)"
...
function lengthadhar() {
 ...
 $(document).ready(function() {
	 ...
	 datepicketDate('non_effective_date');
	    $("#unit_sus_no1v").val('${unit_sus_no3}');
		$("#unit_name1v").val('${unit_name3}');
		$("#first_name1v").val('${first_name3}');
		$("#status1v").val('${status3}');
	 ...
	 pay_level_other1();
	 if('${civilian_details_cmd.pay_level_other}' !=null && '${civilian_details_cmd.pay_level_other}' !="")
		 {
		   $("#pay_head_other").show();
		 }
	 else
