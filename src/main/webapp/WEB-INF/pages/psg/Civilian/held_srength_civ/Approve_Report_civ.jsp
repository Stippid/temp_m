	...
	<div class="container" align="center">
		<div class="card">
			<div class="card-header">
				<h5>APPROVE CIVILIAN MONTHLY UNIT STR REPORT</h5>
		...
		<table id="getauthServingTable"
			...
			<thead>
				...
				<tr class="centered-row">
					...
					<th style="text-align: center;">Gazeeted/Non Gazzeted</th>
					<th style="text-align: center;">Group</th>
					<th style="text-align: center;">Non Industrial/Industrial</th>
					<th style="text-align: center;">Date of Joining in Govt
						Service</th>
					<th style="text-align: center;">Date of TOS</th>
					<th style="text-align: center;">Date of Designation</th>
			...
			<tbody>
				...
				<c:forEach var="item1" items="${list}" varStatus="num">
					<tr>
						...
						<td style="font-size: 15px; text-align: center;">${item1[6]}</td>
						<td style="font-size: 15px; text-align: center;">${item1[7]}</td>
						<td style="font-size: 15px; text-align: center;">${item1[8]}</td>
						<td style="font-size: 15px; text-align: center;">${item1[9]}</td>
						<td style="font-size: 15px; text-align: center;">${item1[10]}</td>
						<td style="font-size: 15px; text-align: center;">${item1[11]}</td>
	...
	<div class="watermarked" data-watermark="" id="divwatermark">
		...
		<table id="getauthcivTable"
			...
			<thead>
				...
				<tr>
					<th colspan="2" style="text-align: center;" id="date_of_seniority">
					</th>
					<th colspan="2" style="text-align: center;" id="date_of_seniority">
						NON INDUSTRIAL</th>
			...
			<tbody>
				...
				<c:forEach var="item9" items="${list9}" varStatus="num">
					<tr>
						<td style="font-size: 15px;">${item9[0]}</td>
						<td style="font-size: 15px;">${item9[1]}</td>
						<td style="font-size: 15px;">${item9[2]}</td>
						<td style="font-size: 15px;">${item9[3]}</td>
						<td style="font-size: 15px;">${item9[4]}</td>
						<td style="font-size: 15px;">${item9[5]}</td>
						<td style="font-size: 15px;">${item9[6]}</td>
			...
			<tbody>
				...
				<c:forEach var="item8" items="${list8}" varStatus="num">
					<tr>
						...
						<td style="font-size: 15px;">${item8[5]}</td>
						<td style="font-size: 15px;">${item8[6]}</td>
		...
		<table id="getsummuryTable"
			...
			<tbody>
				...
				<c:forEach var="item7" items="${list7}" varStatus="num">
					<tr>
						<td style="font-size: 15px; text-align: center;" id="civ_auth_09">${item7[0]}</td>
						<td style="font-size: 15px; text-align: center;"
							id="civ_posted_09">${item7[1]}</td>
						<td style="font-size: 15px; text-align: center;" id="civ_defi_09">${item7[2]}</td>
						<td style="font-size: 15px; text-align: center;" id="civ_sur_09">${item7[3]}</td>
			...
			<tbody>
				...
				<c:forEach var="item6" items="${list6}" varStatus="num">
					<tr>
						...
						<td style="font-size: 15px; text-align: center;">${item6[1]}</td>
						<td style="font-size: 15px; text-align: center;">${item6[2]}</td>					
                      </tr>
...
<div class="card-footer" align="center" class="form-control"
	...
	<c:if test="${roleType == 'APP'}">
		<a href="Search_Report_Civ_Url" class="btn btn-danger btn-sm">Cancel</a>
		<input type="submit" class="btn btn-primary btn-sm" value="Approve"
			onclick="if (confirm('Are You Sure You Want to Approve Civilian Data?')){return Report_Approve_fn();}else{return false;}">
...
<c:url value="Approve_civ" var="editUrl" />
<form:form action="${editUrl}" method="post" id="updateForm"
	...
	<input type="hidden" name="civilian_status5" id="civilian_status5">
</form:form>
...
<script>
		...
		function Report_Approve_fn(){
			...
			$("#civilian_status5").val($("#civilian_status").val());
		...
		$(document).ready(function() {
			...
			var civilian_status = '${civilian_status5}';
		 var getRegularcivDiv = document.getElementById("regular_civ_div");
			var getNonRegularcivDiv = document.getElementById("non_regular_civ_div");
			   
			
			if(civilian_status == "R"){
				
				 getRegularcivDiv.style.display = "block";
		    	   getNonRegularcivDiv.style.display = "none";
			}else {
				
				getRegularcivDiv.style.display = "none";
		    	getNonRegularcivDiv.style.display = "block";
			}
		...
		//if('${roleType}' == "APP" || '${roleType}' == "ALL"){	
			...
			$("#civilian_status").val('${civilian_status5}');
			...
			$("#observation").val('${observation5}');
				...
				$("#observation").attr("disabled", true);
