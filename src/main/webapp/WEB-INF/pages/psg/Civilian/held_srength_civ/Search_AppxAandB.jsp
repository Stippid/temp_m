...
<%-- <form:form name="" id="" action="" method="post" class="form-horizontal" commandName="">  --%>
	<div class="animated fadeIn">
	    <div class="container" align="center">
	    	<div class="card">
	    		<div class="card-header"><h5> SEARCH CIVILIAN MONTHLY APPX 'A' & APPX 'B'   </h5> <h6 class="enter_by"></h6></div>
			...
			<!-- 			<div class="row form-group">
						...
						<div class="card-footer" align="center" class="form-control" >
						 <input type="hidden" id="role" name="role" class="form-control ">
							<a href="Search_AppxAandB_Civ_Url" class="btn btn-success btn-sm" >Clear</a>  
...
<c:url value="GetSearch_appxAndB_Civ" var="searchUrl" />
	...
	<form:form action="${editUrl}" method="post" id="updateForm" name="updateForm" modelAttribute="unit_sus_no5">
	  	...
	  	<input type="hidden" name="pagename5" id="pagename5" >
	  	
	</form:form>

<c:url value="delete_Report_appxAandB_civ" var="deleteUrl" />
<form:form action="${deleteUrl}" method="post" id="deleteForm" name="deleteForm" modelAttribute="month6">
		...
		function editData(month,year,version,sus_no){		
			...
			$("#pagename5").val("Search_AppxAandB_Civ_Url");	
