...
<%-- <form:form name="" id="" action="" method="post" class="form-horizontal" commandName="">  --%>
	<div class="animated fadeIn">
	    <div class="container" align="center">
	    	<div class="card">
	    		<div class="card-header"><h5> SEARCH CIVILIAN MONTHLY UNIT STR REPORT   </h5> <h6 class="enter_by"></h6></div>
			...
			<div class="col-md-6">
						<div class="row form-group">
									...
									<strong style="color: red;">Note:- For Print of Approved civilian Data, Please Visit Into Module: PSG -> QUERIES -> CIVILIAN REPORT</strong>
						...
						<div class="card-footer" align="center" class="form-control" >
						 <input type="hidden" id="role" name="role" class="form-control ">
							<a href="Search_Report_Civ_Url" class="btn btn-success btn-sm" >Clear</a>  
...
<c:url value="GetSearch_appxAndB_Civ" var="searchUrl" />
	...
	<c:url value="GetDataAppxAandBforApprove" var="editUrl"/>
...
<c:url value="delete_Report_civ" var="deleteUrl" />
<form:form action="${deleteUrl}" method="post" id="deleteForm" name="deleteForm" modelAttribute="month6">
	    ...
	    <input type="hidden" name="civilian_status6" id="civilian_status6" > 
</form:form> 
	
		<script>
	
		function editData(month,year,version,sus_no){		
			$("#month5").val(month);
			$("#year5").val(year);
		...
		function deleteData(month,year,version,sus_no,civilian_status){		
			$("#month6").val(month);
			$("#year6").val(year);
			$("#version6").val(version);
			$("#unit_sus_no6").val(sus_no);
			$("#civilian_status6").val(civilian_status);
