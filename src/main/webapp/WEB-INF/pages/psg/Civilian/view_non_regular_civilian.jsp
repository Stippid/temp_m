	...
	<div class="container-fluid" align="center">
		<div class="card">
			...
			<div class="card-body card-block">
				...
				<div class="col-md-12" id="mother_tongue_other_div">
...
<form:form name="" id="civilian_reg"
	action="viewcivilianNonRegularAction" method="post"
	class="form-horizontal" commandName="civilian_details_cmd">
	<div class="panel-group" id="accordion">
		<div class="panel panel-default">

			<input type="hidden" id="id" name="id"
				class="form-control autocomplete" value="${listfull[0].id}"
				autocomplete="off"> <input type="hidden"
				id="civilian_status" name="civilian_status"
				class="form-control autocomplete"
				value="${listfull[0].civilian_status}" autocomplete="off"> <input
				type="hidden" id="main_id" name="main_id"
				class="form-control autocomplete" value="${listfull[0].main_id}"
				autocomplete="off"> <input type="hidden" id="cancel_status"
				name="cancel_status" class="form-control autocomplete"
				value="${listfull[0].cancel_status}" autocomplete="off">
			<div class="col-md-12" align="center">
				<p>
					<input type="checkbox" id="myCheck" onclick="myFunction();" />I certify that all the data has been checked and verified by me.
				</p>
			</div>
...
<c:url value="Reject_Non_Civilian" var="rejectUrl" />
