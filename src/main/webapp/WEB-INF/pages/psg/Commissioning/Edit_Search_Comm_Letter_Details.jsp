...
<form:form name="Edit_Search_Com_letter" id="Edit_Search_Com_letter" action="Edit_Search_Com_letterAction?${_csrf.parameterName}=${_csrf.token}" method="post" class="form-horizontal" commandName="Edit_Search_Com_letterCMD"> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5> UPDATE COMMISSIONING DETAILS </h5> <h6 class="enter_by"><span style="font-size:18px;color:red;">All Fields Mandatory</span></h6><h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by MISO)</span></h6></div>
	          			<div class="card-body card-block">
						               ...
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                 ...
						                 <input type="hidden" id="frm_dtV" name="frm_dtV" class="form-control autocomplete"  > 
						                  ...
						                  <input type="hidden" id="IsMns" name="IsMns" value='${IsMns}' > 
						            </div>
	              				</div>
						 	...
						 	<div class="col-md-10">
								    <div class="row form-group">
								    <div class="col-md-4">
									<select id="persnl_no1" name="persnl_no1" class="form-control-sm form-control" disabled="disabled">
									...
									<div class="col-md-4">
									<input type="text" id="persnl_no2" name="persnl_no2" onkeyup="onChangePerNo(this);" onkeypress="return isNumber0_9Only(event)"  class="form-control-sm form-control" autocomplete="off" placeholder="Enter No..." maxlength="5" disabled="disabled">
								</div>
								<div class="col-md-4">
									<input type="text" id="persnl_no3" name="persnl_no3" class="form-control-sm form-control" autocomplete="off"  maxlength="10" disabled="disabled" >
								</div>
									</div>
								</div> 
					</div> 
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                 <input type="text" id="batch_no" name="batch_no" class="form-control autocomplete" autocomplete="off" maxlength="50"  onkeypress="return isNumber0_9Only(event)">
						                </div>
						            </div>
	              				</div>
	              					...
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                 ...
						                 <input type="text" name="date_of_seniority" id="date_of_seniority" maxlength="10" value="DD/MM/YYYY" onclick="clickclear(this, 'DD/MM/YYYY')" class="form-control" style="width: 85%;display: inline;"
											onfocus="this.style.color='#000000'" onblur="clickrecall(this,'DD/MM/YYYY');validateDate_BackDate(this.value,this);" onkeyup="clickclear(this, 'DD/MM/YYYY')" 
											onchange="clickrecall(this,'DD/MM/YYYY')" aria-required="true" autocomplete="off" style="color: rgb(0, 0, 0);" >
						                </div>
						            </div>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                  <!-- <input type="date" id="date_of_rank" name="date_of_rank" class="form-control autocomplete" autocomplete="off" > -->  
						                <input type="text" name="date_of_rank" id="date_of_rank" maxlength="10" value="DD/MM/YYYY" onclick="clickclear(this, 'DD/MM/YYYY')" class="form-control" style="width: 85%;display: inline;"
											onfocus="this.style.color='#000000'" onblur="clickrecall(this,'DD/MM/YYYY');validateDate_BackDate(this.value,this);" onkeyup="clickclear(this, 'DD/MM/YYYY')" 
											onchange="clickrecall(this,'DD/MM/YYYY')" aria-required="true" autocomplete="off" style="color: rgb(0, 0, 0);" >
						                </div>
						            </div>
	              			   ...
	              			   <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <input type="text" name="date_of_birth" id="date_of_birth" maxlength="10" value="DD/MM/YYYY" onclick="clickclear(this, 'DD/MM/YYYY')" class="form-control" style="width: 85%;display: inline;"
											onfocus="this.style.color='#000000'" onblur="clickrecall(this,'DD/MM/YYYY');validateDate_BackDate(this.value,this);" onkeyup="clickclear(this, 'DD/MM/YYYY')" 
											onchange="clickrecall(this,'DD/MM/YYYY')" aria-required="true" autocomplete="off" style="color: rgb(0, 0, 0);" >
						                </div> 
	              			  ...
	              			  <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						            <label>${Edit_Search_Com_letterCMD.reject_remarks}</label>
						                </div>
						            </div>
	              				</div>
						...
						<div class="card-footer" align="center" class="form-control">							
		              		<input type="submit" class="btn btn-primary btn-sm" value="Update" onclick="return validate();"> 
		              		 ...
		              		 <a href="Search_Commissioning_LetterUrl" class="btn btn-info btn-sm" onclick="return setBackUrl(event);">Back</a>
			            </div> 		
	        	</div>
			</div>
	</div>	
...
if ($("select#persnl_no1").val() == "NR" || $("select#persnl_no1").val() == "NS") {
	...
	if ($("input#date_of_commission").val() == "" || $("input#date_of_commission").val() == "DD/MM/YYYY") {
	...
	if ($("#date_of_seniority").val() == "" || $("input#date_of_seniority").val() == "DD/MM/YYYY") {
	...
	if ($("#date_of_rank").val() == "" || $("input#date_of_rank").val() == "DD/MM/YYYY") {
	...
	if(getformatedDate($("input#date_of_commission").val()) > getformatedDate($("#date_of_rank").val())) {
	 ...
	 if ($("#date_of_birth").val() == "" || $("input#date_of_birth").val() == "DD/MM/YYYY") {
...
if(calculate_agediff(document.getElementById('date_of_birth'), document.getElementById('date_of_commission'))>=16) {
	 ...
	 if ($("#date_of_tos").val() == "" || $("input#date_of_tos").val() == "DD/MM/YYYY") {
...
//	}
	...
	$("#persnl_no1").prop("disabled",false);
	$("#persnl_no2").prop("disabled",false);
	$("#persnl_no3").prop("disabled",false);
...
$(document).ready(function() {
	...
	$("#unit_posted_toV").val('${unit_posted_to6}');
	$("#parent_armV").val('${parent_arm6}');
	$("#personnel_noV").val('${personnel_no6}');
	$("#nameV").val('${name6}');
	$("#type_of_comm_grantedV").val('${type_of_comm_granted6}');
	$("#date_of_commissionV").val(ParseDateColumncommission('${date_of_commission6}'));
	$("#frm_dtV").val(ParseDateColumncommission('${frm_dt6}'));
	
	var l = '${Edit_Search_Com_letterCMD.personnel_no}'.length;
	$("#authority").val('${Edit_Search_Com_letterCMD.authority}');

	if ('${Edit_Search_Com_letterCMD.date_of_authority}' != ''){
		$("#date_of_authority").val(ParseDateColumncommission('${Edit_Search_Com_letterCMD.date_of_authority}'));
	}
	
	$("#date_of_commission").val(ParseDateColumncommission('${Edit_Search_Com_letterCMD.date_of_commission}'));
	
	$("#date_of_seniority").val(ParseDateColumncommission('${Edit_Search_Com_letterCMD.date_of_seniority}'));
	
	$("#date_of_tos").val(ParseDateColumncommission('${Edit_Search_Com_letterCMD.date_of_tos}'));
	
	if ('${Edit_Search_Com_letterCMD.date_of_rank}' != ''){
		$("#date_of_rank").val(ParseDateColumncommission('${Edit_Search_Com_letterCMD.date_of_rank}'));
	}

	$("#date_of_birth").val(ParseDateColumncommission('${Edit_Search_Com_letterCMD.date_of_birth}'));

	$("#persnl_no1").val(
			'${Edit_Search_Com_letterCMD.personnel_no}'
					.substring(0,l-6));
	if($("#persnl_no1").val()== 'NR' || $("#persnl_no1").val()== 'NS'){
		 $('#medreg_no_div').show();
		 parent_arm("mns")
	...
	$("#cadet_no").val('${Edit_Search_Com_letterCMD.cadet_no}');
	$("#tnai_no").val('${Edit_Search_Com_letterCMD.tnai_no}');
	$("#batch_no").val('${Edit_Search_Com_letterCMD.batch_no}');
	$("#course").val('${Edit_Search_Com_letterCMD.course}');
	$("#name").val('${Edit_Search_Com_letterCMD.name}');
	$("#type_of_comm_granted").val('${Edit_Search_Com_letterCMD.type_of_comm_granted}');	
	$("#gender").val('${Edit_Search_Com_letterCMD.gender}');	
	$("#rank").val('${Edit_Search_Com_letterCMD.rank}');	
	$("#parent_arm").val('${Edit_Search_Com_letterCMD.parent_arm}');
	chgarm(document.getElementById("parent_arm"),'regiment');
	
	$("#unit_sus_no").val('${Edit_Search_Com_letterCMD.unit_sus_no}');	
	$("#regiment").val('${Edit_Search_Com_letterCMD.regiment}');	
	
	$("#id").val('${Edit_Search_Com_letterCMD.id}');
	$("#parent_sus_no").val('${Edit_Search_Com_letterCMD.parent_sus_no}');	
	$("#parent_unit").val('${Edit_Search_Com_letterCMD.parent_unit}');	

	
	
	var sus_no ='${Edit_Search_Com_letterCMD.unit_sus_no}';
	getunit(sus_no);
	...
	$("#unit_sus_no").keyup(function(){
	 ...
	 function Personal_no_already_exist()
	 {
		 ...
		 $.post("getPersonnelNoAlreadyExist?"+key+"="+value, {personnel_no : personnel_no,id:id}).done(function(j) {
			 	...
			 	if(j == false){
					alert("Personal No already Approved.")
	 ...
	 function setBackUrl(event) {
		    event.preventDefault();
		    var selectedValue = document.getElementById('persnl_no1').options[document.getElementById('persnl_no1').selectedIndex].getAttribute('name');
		    var url = (selectedValue === 'NR' || selectedValue === 'NS') 
		        ? 'Search_Commissioning_MnsLetterUrl' 
		        : 'Search_Commissioning_LetterUrl';
