					...
					<div id="collapse1a" class="panel-collapse collapse">
						<div class="card-body card-block"><br>
							...
							<div class="card-footer" align="center" class="form-control">
								<input type="button" class="btn btn-primary btn-sm" value="Update" onclick="validate_personal_no();">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="panel panel-default" id="e_div1">
					...
					<div id="collapse1e" class="panel-collapse collapse">
						<div class="card-body card-block"><br>
								...
								<div class="col-md-12">
									...
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<label class=" form-control-label" id="c_reject_remarks"></label> 
											</div>
										</div>
									</div>
								</div>
							...
							<div class="card-footer" align="center" class="form-control">
								<input type="button" class="btn btn-primary btn-sm" value="Update" onclick="validate_cadet();">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="panel panel-default" id="k_div1">
					...
					<div id="collapse1k" class="panel-collapse collapse">
						...
						<div class="card-body card-block"> <br>
								...
								<div class="col-md-12 form-group">
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<label class=" form-control-label" id="co_reject_remarks"></label> 
											</div>
										</div>
									</div>
								</div>
							...
							<div class="card-footer" align="center" class="form-control">
								<input type="button" class="btn btn-primary btn-sm" value="Update" onclick="validate_Course();">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="panel panel-default" id="p_div1">
					...
					<div id="collapse1p" class="panel-collapse collapse">
						<div class="card-body card-block"> <br>
							...
							<div class="card-footer" align="center" class="form-control">
								<input type="button" class="btn btn-primary btn-sm" value="Update" onclick="validate_Gender();">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="panel panel-default" id="r_div1">
					...
					<div id="collapse1r" class="panel-collapse collapse">
						<div class="card-body card-block">	<br>
								...
								<div class="col-md-12 form-group">
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<label class=" form-control-label" id="com_reject_remarks"></label> 
											</div>
										</div>
									</div>
								</div>
							...
							<div class="card-footer" align="center" class="form-control">
								<input type="button" class="btn btn-primary btn-sm" value="Update" onclick="validate_Commission();">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="panel panel-default" id="x_div1">
					...
					<div id="collapse1x" class="panel-collapse collapse">
						<div class="card-body card-block"> <br>
							...
							<div class="card-footer" align="center" class="form-control">
								<input type="button" class="btn btn-primary btn-sm" value="Update" onclick="validate_Birth();">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="panel panel-default" id="aa_div16">
					...
					<div id="collapse1aa" class="panel-collapse collapse">
						<div class="card-body card-block"> <br>
							...
							<div class="card-footer" align="center" class="form-control">
								<input type="button" class="btn btn-primary btn-sm" value="Update" onclick="validate_Regiment();">
							</div>
						</div>
					</div>
				</div>
					...
					<div id="collapse1b" class="panel-collapse collapse">
						<div class="card-body card-block"> <br>
								...
								<div class="col-md-12">
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<input type="hidden" id="unit_id" name="unit_id" value="0" class="form-control autocomplete" autocomplete="off">
								...
								<div class="col-md-12">
									...
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<label class=" form-control-label" id="u_reject_remarks"></label> 
											</div>
										</div>
									</div>
								</div>
							...
							<div class="card-footer" align="center" class="form-control">
								...
								<input type="button" class="btn btn-primary btn-sm" value="Update" onclick="validate_Unit();">
							</div>
						</div>
					</div>
				</div>
...
function SubmitAll(){
	var comm_id=$('#comm_id').val();
	 $.post('Submit_Reject_UpadteComm_LetterUrl?' + key + "=" + value,{ comm_id : comm_id },function(k) {
	Cancel();
...
function getpersonnelNo(){
	 var comm_id = '${id}';
	 $.post('getPersonalNOData3?' + key + "=" + value, {comm_id:comm_id}, function(j){
		 if(j!=""){
					 ...
					 $('#p_r_id').val(j[0].id);
					 $('#p_reject_remarks').text(j[0].reject_remarks);
		 }
	 });
	} 
function getcadet(){
	 var comm_id = '${id}';
	 $.post('getcadetData3?' + key + "=" + value, {comm_id:comm_id}, function(j){
		 if(j!=""){
					 ...
					 $('#c_id').val(j[0].id);
					 $('#c_reject_remarks').text(j[0].reject_remarks);
		 }
	 });
	}
function getcourseno(){
	 var comm_id = '${id}';
	 $.post('getCourseData3?' + key + "=" + value, {comm_id:comm_id}, function(j){
		 if(j!=""){
					 ...
					 $('#co_id').val(j[0].id);
					 $('#co_reject_remarks').text(j[0].reject_remarks);
		 }
	 });
	}
function getgender(){
	 var comm_id = '${id}';
	 $.post('getGenderData3?' + key + "=" + value, {comm_id:comm_id}, function(j){
		 if(j!=""){
					 ...
					 $('#g_id').val(j[0].id);
					 $('#g_reject_remarks').text(j[0].reject_remarks);
		 }
	 });
	}
function getcommison(){
	 var comm_id = '${id}';
	 $.post('getcommisonData3?' + key + "=" + value, {comm_id:comm_id}, function(j){
		 if(j!=""){
			 ...
			 $('#com_id').val(j[0].id);
			 $('#com_reject_remarks').text(j[0].reject_remarks);
		 }
	 });
  } 
function getdob(){
	 var comm_id = '${id}';
	 $.post('getdobData3?' + key + "=" + value, {comm_id:comm_id}, function(j){
		 if(j!=""){
			 ...
			 $('#birth_id').val(j[0].id);
			 $('#b_reject_remarks').text(j[0].reject_remarks);
		 }
	 });
 }
function getarmservice(){
	 var comm_id = '${id}';
	 $.post('getarmsirviceData3?' + key + "=" + value, {comm_id:comm_id}, function(j){
		 if(j!=""){
...
function getunit(){
	 var comm_id = '${id}';
	 $.post('getunitData3?' + key + "=" + value, {comm_id:comm_id}, function(j){
		 if(j!=""){
			 ...
			 $('#unit_id').val(j[0].id);
			 $('#u_reject_remarks').text(j[0].reject_remarks);
		 }
	 });
}
</script>
...
function validate_personal_no(){
   ...
   if ($("input#persnl_no2").val() == "") {
		...
		var comm_id=$("#comm_id").val();	
		formvalues+="&p_r_id="+p_r_id+"&comm_id="+comm_id+"&app_status="+app_status;
...
function validate_cadet(){
	 if ($("input#cadet_no").val() == "") {
		...
		var c_id=$("#c_id").val();	
		var comm_id=$("#comm_id").val();	
		formvalues+="&c_id="+c_id+"&comm_id="+comm_id+"&app_status="+app_status;
...
function validate_Course(){
	...
	if ($("select#course").val() == "0") {
		...
		var co_id=$("#co_id").val();	
		var comm_id=$("#comm_id").val();	
		formvalues+="&co_id="+co_id+"&comm_id="+comm_id+"&app_status="+app_status;
...
function validate_Gender(){
	 if ($("select#gender").val() == "0") {
		...
		var g_id=$("#g_id").val();	
		var comm_id=$("#comm_id").val();	
		formvalues+="&g_id="+g_id+"&comm_id="+comm_id+"&app_status="+app_status;
...
function validate_Commission(){
	...
	if ($("input#date_of_commission").val() == "") {
		...
		var comm_id=$("#comm_id").val();	
		formvalues+="&com_id="+com_id+"&comm_id="+comm_id+"&app_status="+app_status;
...
function validate_Birth(){
	if ($("#date_of_birth").val() == "") {
		...
		var comm_id=$("#comm_id").val();	
		formvalues+="&birth_id="+birth_id+"&comm_id="+comm_id+"&app_status="+app_status;
...
function validate_Regiment(){
	...
	if(sp14 == "INFANTRY" && $("select#regiment").val() == "0"){
		...
		var comm_id=$("#comm_id").val();	
		formvalues+="&reg_id="+reg_id+"&comm_id="+comm_id+"&app_status="+app_status;
...
function validate_Unit(){
    ...
    if ($("input#unit_posted_to").val() == "") {
	 ...
	 if ($("#date_of_tos").val() == "") {
		...
		var comm_id=$("#comm_id").val();	
		formvalues+="&unit_id="+unit_id+"&comm_id="+comm_id+"&app_status="+app_status;
