	...
	<div class="animated fadeIn">
	    		...
	    		<div class="card-header" align="center"><h5> SEARCH/APPROVE COMMISSIONING DETAIL </h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by MISO)</span></h6></div>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               ...
						               <select name="parent_arm" id="parent_arm" class="form-control-sm form-control"  onchange="chgarm();" >
											...
											<option value="4800" name="MILITARY NURSING SERVICE [MNS]">MILITARY NURSING SERVICE [MNS]</option>
											</select>
						                </div>
						            </div>
	              				</div>	              				
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="Search_Commissioning_MnsLetterUrl" class="btn btn-success btn-sm" >Clear</a>  
...
<c:url value="Edit_Commissioning_MnsLetterUrl" var="editUrl"/>
...
<c:url value="view_Commissioning_MnsLetterUrl" var="viewUrl"/>
...
<c:url value="Delete_Commissioning_MnsLetter" var="deleteUrl" />
				 ...
				 var susNoAuto=$("#personnel_no");
				  susNoAuto.autocomplete({
				      source: function( request, response ) {
				        $.ajax({
				        	type: 'POST',
					    	url: "getpersonnel_noMns?"+key+"="+value,
