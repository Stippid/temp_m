...
<form:form name="Search_S_C_LData" id="Search_S_C_LData" action="Search_S_C_LData_Action" method="post" class="form-horizontal" commandName="SearchS_C_LCMD"> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5> SEARCH/APPROVE COMMISSIONING DETAILS </h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be Approved by Co/Oc Unit)</span></h6></div>
	            	...
	            	<div class="col-md-12">	              					
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="Search_S_C_L_Url" class="btn btn-success btn-sm" >Clear</a>  
...
<c:url value="GetS_C_LData" var="searchUrl" />
