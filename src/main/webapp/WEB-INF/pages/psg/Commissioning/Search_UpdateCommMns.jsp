...
<form:form name="Search_S_C_LData" id="Search_S_C_LData" action="Search_S_C_LData_Action" method="post" class="form-horizontal" commandName="SearchS_C_LCMD"> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5> SEARCH/APPROVE COMMISSIONING DETAILS MNS </h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be Approved by Co/Oc Unit)</span></h6></div>
	            	...
	            	<div class="col-md-12">	              					
	              					...
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                 ...
						                 <input type="text" id="unit_sus_no" name="unit_sus_no" class="form-control autocomplete" onkeyup="return specialcharecter(this)" onkeypress="return AvoidSpace(event)" autocomplete="off" maxlength="8"  style="display: none" > 
						                </div>
						            </div>
	              				</div>
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="Search_S_C_L_MnsUrl" class="btn btn-success btn-sm" >Clear</a>  
				...
				<tbody>
					<c:if test="${list.size()==0}">
						<tr>
							<td style="font-size: 15px; text-align: center; color: red;"
								colspan="9">Data Not Available</td>
						</tr>
					</c:if>
					<c:forEach var="item" items="${list}" varStatus="num">
						<tr>
							...
							<td style="font-size: 15px; text-align: center; width: 20%;">${item[7]}
								${item[8]} ${item[9]} ${item[10]}  ${item[11]}</td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
...
<c:url value="GetS_C_LDataMns" var="searchUrl" />
...
<c:url value="view_ApproveUpadteCommDataUrl" var="ViewApproveUrl" />
...
<c:url value="Reject_UpadteComm_DataUrl" var="rejectUrl" />
<form:form action="${rejectUrl}" method="post" id="rejectForm" name="rejectForm" modelAttribute="id3"> 
	 <input type="hidden" name="rid3" id="rid3" value="0">
	  <input type="hidden" name="rpersonnel_no3" id="rpersonnel_no3" value="0">
</form:form>
...
function editData(id){		
	...
	if(getPersonnelNo(id,'epersonnel_no2','','')){
...
function Reject(id){
	$("#rid3").val(id);
	//$("#rpersonnel_no3").val(personnel_no);
	
	if(getPersonnelNo(id,'rpersonnel_no3','','')){
...
function AppViewData(id) {
	...
	if (getPersonnelNo(id, 'ap_personnel_no', '', '')) {
...
function ViewData(id) {
	...
	if (getPersonnelNo(id, 'personnel_no2', '', '')) {
