					...
					<div class="panel panel-default" id="insp_div1">
						<div class="panel-heading">
							<h4 class="panel-title main_title" id="insp_div5">
								<b>UPDATE COMMISSIONING DETAILS MNS </b>
							</h4>
						</div>
...
<div id="div_update_data" style="display: none;" class="subcontent">
			...
			<div class="panel-group" id="accordion6">
				<div class="panel panel-default" id="e_div1">
					...
					<div id="collapse1e" class="panel-collapse collapse">
						<div class="card-body card-block">
							<br> <input type="button" class="btn btn-primary btn-sm" value="View History" onclick="Pop_Up_History('cadet');" />
							<div class="row">
								<div class="col-md-12">
									<div class="col-md-6">
										<div class="row form-group">
								...
								<div class="col-md-12">
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<input type="text" id="cadet_no" name="cadet_no" class="form-control-sm form-control autocomplete" maxlength="7" autocomplete="off" onkeyup="return specialcharecterCadet(this);"  onkeypress="return AvoidSpace(event)">
											</div>
										</div>
									</div>
								</div>
					...
					<div id="collapse1k" class="panel-collapse collapse">
						<div class="card-body card-block">
							<br> <input type="button" class="btn btn-primary btn-sm"
								value="View History" onclick="Pop_Up_History('course_no');" />
							<div class="row">
								<div class="col-md-12">
									<div class="col-md-6">
										<div class="row form-group">
			...
			<div class="panel-group" id="accordion45">
				<div class="panel panel-default" id="r_div1">
					...
					<div id="collapse1r" class="panel-collapse collapse">
						<div class="card-body card-block">
							<br> <input type="button" class="btn btn-primary btn-sm" value="View History" onclick="Pop_Up_History('commission');" />
							<div class="row">
								<div class="col-md-12">
									<div class="col-md-6">
										<div class="row form-group">
	...
	<form id="form_regiment">
		<div class="card" id="armservice_div">
			<div class="panel-group" id="accordion17">
				<div class="panel panel-default" id="aa_div16">
					...
					<div id="collapse1aa" class="panel-collapse collapse">
						<div class="card-body card-block">
							<br> <input type="button" name="save" class="btn btn-primary btn-sm" value="View History" onclick="Pop_Up_History('arm_service');" />
							<div class="row">
								<div class="col-md-12">
									<div class="col-md-6">
										<div class="row form-group">
			...
			<div class="panel-group" id="accordion4">
				<div class="panel panel-default" id="b_div1">
					...
					<div id="collapse1b" class="panel-collapse collapse">
						<div class="card-body card-block">
							<br> <input type="button" class="btn btn-primary btn-sm" value="View History" onclick="Pop_Up_History('unit');" />
							<div class="row">
								<div class="col-md-12">
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<input type="hidden" id="unit_id" name="unit_id" value="0" maxlength="100" class="form-control autocomplete" autocomplete="off">
												<input type="text" id="u_authority" name="authority" class="form-control-sm form-control autocomplete" autocomplete="off" onkeyup="return specialcharecter(this)" maxlength="100">
											</div>
										</div>
									</div>
									<div class="col-md-6">
								...
								<div class="col-md-12">
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<input type="text" id="unit_sus_no" name="unit_sus_no" class="form-control-sm form-control autocomplete" onkeyup="return specialcharecter(this)" onkeypress="return AvoidSpace(event)" autocomplete="off" maxlength="8">
											</div>
										</div>
									</div>
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<input type="text" id="unit_posted_to" name="unit_posted_to" class="form-control-sm form-control autocomplete" onkeyup="return specialcharecter(this)" autocomplete="off" maxlength="50">
											</div>
										</div>
									</div>
								</div>
	...
	<!-- Start UPDATE RANK -->
	<form id="form_updaterank">
		<div class="card">
			<div class="panel-group" id="accordion5">
				<div class="panel panel-default" id="b_div2">
					<div class="panel-heading" id="rank_collapse2">
						<h4 class="panel-title main_title blue" id="b_div6">
							<a class="droparrow collapsed" data-toggle="collapse" data-parent="#accordion5" href="#" id="r_final1"  onclick="divN(this)" ><b>RANK</b></a>
						</h4>
					</div>
					<div id="collapse2" class="panel-collapse collapse">
						<div class="card-body card-block">
							<br> <input type="button" class="btn btn-primary btn-sm" value="View History" onclick="Pop_Up_History('rank');" />
							<div class="row">
								<div class="col-md-12">
									<div class="col-md-6">
										<div class="row form-group">
	...
	<c:url value="Preview_CadetNo_Url" var="Preview_CadetNo" />
	<form:form action="${Preview_CadetNo}" method="post" id="Preview_CadetNo_Form" name="Preview_CadetNo_Form" modelAttribute="id" target="result">
		<input type="hidden" name="comm_id1" id="comm_id1" value="0" />
		<input type="hidden" name="personnel_no11" id="personnel_no11" value="0" />
	</form:form>
	<c:url value="Preview_CourseNo_Url" var="Preview_CadetNo" />
	<form:form action="${Preview_CadetNo}" method="post" id="Preview_CourseNo_Form" name="Preview_CourseNo_Form" modelAttribute="id" target="result">
		<input type="hidden" name="comm_id2" id="comm_id2" value="0" />
		<input type="hidden" name="personnel_no2" id="personnel_no2" value="0" />
	</form:form>
	
	<c:url value="Preview_Gender_Url" var="Preview_CadetNo" />
	<form:form action="${Preview_CadetNo}" method="post" id="Preview_Gender_Form" name="Preview_Gender_Form" modelAttribute="id" target="result">
	...
	<form:form action="${Preview_CadetNo}" method="post" id="Preview_Commission_Form" name="Preview_Commission_Form" modelAttribute="id" target="result">
	...
	<form:form action="${Preview_CadetNo}" method="post" id="Preview_DateofBirth_Form" name="Preview_DateofBirth_Form" modelAttribute="id" target="result">
		<input type="hidden" name="comm_id5" id="comm_id5" value="0" />
		<input type="hidden" name="personnel_no5" id="personnel_no5" value="0" />
	</form:form>
	
	<c:url value="Preview_ArmService_Url" var="Preview_CadetNo" />
	<form:form action="${Preview_CadetNo}" method="post" id="Preview_ArmService_Form" name="Preview_ArmService_Form" modelAttribute="id" target="result">
		<input type="hidden" name="comm_id6" id="comm_id6" value="0" />
	</form:form>
	
	<c:url value="Preview_Unit_Url" var="Preview_CadetNo1" />
	<form:form action="${Preview_CadetNo1}" method="post" id="Preview_Unit_Form" name="Preview_Unit_Form" modelAttribute="id" target="result">
		<input type="hidden" name="comm_id7" id="comm_id7" value="0" />
		<input type="hidden" name="personnel_no7" id="personnel_no7" value="0" />
	</form:form>
	<c:url value="Preview_UpdateRank_Url" var="Preview_CadetNo1r" />
	<form:form action="${Preview_CadetNo1r}" method="post" id="Preview_UpdateRank_Form" name="Preview_UpdateRank_Form" modelAttribute="id" target="result">
		<input type="hidden" name="comm_id1r" id="comm_id1r" value="0" />
		<input type="hidden" name="personnel_no1r" id="personnel_no1r" value="0" />
	</form:form>
...
function Pop_Up_History(a) {
	...
	if(a == "cadet"){
		...
		$("#personnel_no11").val($("#personnel_no").val());
		document.getElementById('Preview_CadetNo_Form').submit();
	}
	if(a == "course_no"){
		$("#comm_id2").val(comm_id);
		$("#personnel_no2").val($("#personnel_no").val())
		document.getElementById('Preview_CourseNo_Form').submit();
	}
	if(a == "gender"){
		$("#comm_id3").val(comm_id);
		$("#personnel_no3").val($("#personnel_no").val())
		document.getElementById('Preview_Gender_Form').submit();
	}
	if(a == "commission"){
	...
	if(a == "arm_service"){
		$("#comm_id6").val(comm_id);
		document.getElementById('Preview_ArmService_Form').submit();
	}
	if(a == "unit"){
		$("#comm_id7").val(comm_id);
		$("#personnel_no7").val($("#personnel_no").val());
		$("#Preview_Unit_Form").submit();
	}
	if(a == "rank"){
		$("#comm_id1r").val(comm_id);
		$("#personnel_no7").val($("#personnel_no").val());
		$("#Preview_UpdateRank_Form").submit();
	}
}
		 ...
		 var susNoAuto=$("#personnel_no");
		  susNoAuto.autocomplete({
		      source: function( request, response ) {
		        $.ajax({
		        	type: 'POST',
			    	url: "getpersonnel_noListFORCommMns?"+key+"="+value,
...
function validate_cadet(){
	 //26-01-1994
	 if ($("#c_authority").val().trim() == "") {
			alert("Please Enter Authority");
			$("#c_authority").focus();
	 		return false;
		}
	 if ($("#c_date_of_authority").val().trim()=="" || $("#c_date_of_authority").val() == "DD/MM/YYYY" ) {
			alert("Please Enter Date of Authority");
			$("input#c_date_of_authority").focus();
			return false;
		} 
	 //
...
function validate_Gender(){
	 //26-01-1994
	 if ($("#g_authority").val().trim() == "") {
			alert("Please Enter Authority");
			$("#g_authority").focus();
	 		return false;
		}
	 if ($("#g_date_of_authority").val().trim()=="" || $("#g_date_of_authority").val() == "DD/MM/YYYY" ) {
			alert("Please Enter Date of Authority");
...
function validate_Regiment(){
	 //26-01-1994
	 if ($("#arm_authority").val().trim() == "") {
			alert("Please Enter Authority");
			$("#arm_authority").focus();
	 		return false;
		}
	 if ($("#arm_date_of_authority").val().trim()=="" || $("#arm_date_of_authority").val() == "DD/MM/YYYY" ) {
			alert("Please Enter Date of Authority");
			$("input#arm_date_of_authority").focus();
			return false;
		} 
	 //
...
function validate_Unit(){
	 //26-01-1994
	 if ($("#u_authority").val().trim() == "") {
			alert("Please Enter Authority");
			$("#u_authority").focus();
	 		return false;
		}
	 if ($("#u_date_of_authority").val().trim()=="" || $("#u_date_of_authority").val() == "DD/MM/YYYY" ) {
			alert("Please Enter Date of Authority");
			$("input#u_date_of_authority").focus();
			return false;
		} 
	 //
...
function validate_rank(){
	...
	/*  bisag 200323 v2 (new requirement) */
	 ...
	 if ($("#dt_rk").val() == "") {
		...
		/* if (parseInt(dt_rank1) <parseInt(dt_commission1) ||   parseInt(dt_rank2) <parseInt(dt_commission2)||parseInt(dt_rank3) <parseInt(dt_commission3)) {
			alert(" Date of Rank should be greater/equals to Date of Commission ");
			$("#dt_rk").focus();
	 		return false;
		}  
		
        if(getformatedDate($("input#comm_date").val()) == getformatedDate($("#dt_rk").val())) {
            alert("Date of Rank should be equal to Commissioning Date");
            $("#dt_rk").focus();
            return false;
} */
	 
	 var formvalues=$("#form_updaterank").serialize();

	
		var comm_id=$("#comm_id").val();	
		var rank_id=$("#rank_id").val();	
		
		formvalues+="&rank_id="+rank_id+"&comm_id="+comm_id+"&dt_commission="+dt_commission;
