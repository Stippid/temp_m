...
<body style="height: 400px">
	<div class="container" id="printableArea">
			<div class="row">
	    		<div class="card">
	    			<div class="card-header" align="center"> <strong style="text-decoration: underline;">OFFICIER DETAILS</strong> 
	    			</div> 
				...
				<table id="getSearchtable"
					...
					<thead>
						<tr>
							...
							<th style="text-align: center;" id="personnel_no">PERSONEL NO</th>
							<th style="text-align: center;" id="description"> RANK</th>
							<th style="text-align: center;" id="name">NAME</th>
							<th style="text-align: center;" id="date_of_birth"> DATE OF BIRTH</th>
							<th style="text-align: center;" id="date_of_commission">DATE OF COMMISSION</th>
							<th style="text-align: center;" id="date_of_seniority">DATE OF SENIORITY</th>
							<th style="text-align: center;" id="unit_sus_no"> UNIT NAME</th>
						</tr>
					</thead>
...
<!-- 				<input type="button" value="Excel" onclick="getExcel()" style="color:green; padding: 5px 10px 5px 10px; font-size: 14px; font-weight: bold;"> -->
		
<!-- 				<i class="fa fa-file-excel-o" id="btnExport" style="font-size: x-large; color: green; text-align: right;" aria-hidden="true" title="EXPORT TO EXCEL" onclick="getExcel();">Export</i> -->
<!-- <!-- 		<i class="fa fa-file-excel-o" id="btnExport" style="font-size: x-large; color: green; text-align: right;" aria-hidden="true" title="EXPORT TO EXCEL" onclick="getExcel();">Export</i> --> 
...
// 				    columns: [
// 				        { data: 'date_of_birth', render: DataTable.render.datetime('MM/DD/YYYY') },
// 				        { data: 'date_of_commission', render: DataTable.render.datetime('dddd D MMMM YYYY') }
// 				    ],
// 				    //dom: 'Bfrtip',
// 				    select: true
// 				});
		...
		//	colAdj("getSearchtable");
				mockjax1('getSearchtable');
				table = dataTable11('getSearchtable');
...
var orderType = order[0][1];
				...
				if (tableName == "getSearchtable" ) {
					...
					$.post("getSearchtabledatacount?" + key + "=" + value, {
						Search : Search,
					...
					$.post("getSearchtabledataoff?" + key + "=" + value, {
						startPage : startPage,
