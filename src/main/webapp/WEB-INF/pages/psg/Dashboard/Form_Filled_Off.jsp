...
<body style="height: 400px">
	<div class="container" id="printableArea">
			<div class="row">
	    		<div class="card">
	    			<div class="card-header" align="center"> <strong style="text-decoration: underline;">CENSUS FORM FILLED OFFICIER DETAILS </strong> 
	    			</div> 
					...
					<span id="ip"></span>
         		<table id="getSearchtable_formfilled"
					...
					<thead>
						<tr>
							...
							<th style="text-align: center;" id="unit_name"> UNIT NAME</th>
								<th style="text-align: center;" id="personnel_no">PERSONNEL NO</th>
						</tr>
					</thead>
...
<!-- <!-- 		<i class="fa fa-file-excel-o" id="btnExport" style="font-size: x-large; color: green; text-align: right;" aria-hidden="true" title="EXPORT TO EXCEL" onclick="getExcel();">Export</i> --> 
		...
		<script>	
			...
			$(document).ready(function() {
				...
				mockjax1('getSearchtable_formfilled');
				table = dataTable11('getSearchtable_formfilled');
			});
...
var orderType = order[0][1];
				...
				if (tableName == "getSearchtable_formfilled" ) {

					$.post("getSearchtabledata_form_filled_count?" + key + "=" + value, {
						Search : Search,
					...
					$.post("getSearchtabledata_form_filled?" + key + "=" + value, {
						startPage : startPage,
