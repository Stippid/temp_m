...
<html>
  <head>
	<title>UNIT CENSUS FILLED</title>
...
<body style="height: 400px">
	<div class="container" id="printableArea">
			<div class="row">
	    		<div class="card">
	    			<div class="card-header" align="center"> <strong style="text-decoration: underline;">CENSUS FORM FILLED UNIT DETAILS </strong> 
	    			</div> 
...
<%--   						<datatables:table id="applicanttbl" url="getformfilledunit" serverSide="true" pipelining="true" pipeSize="3"	row="latlon" rowIdBase="applicant_id" rowIdPrefix="latlon_"  displayLength="10" lengthMenu="10,20,100,500,5000" jqueryUI="true"  --%>
...
<%-- 						</datatables:table>     --%>
	...
	<table id="getSearchtable_formfilled_unit"
...
<!-- <!-- 		<i class="fa fa-file-excel-o" id="btnExport" style="font-size: x-large; color: green; text-align: right;" aria-hidden="true" title="EXPORT TO EXCEL" onclick="getExcel();">Export</i> --> 
		...
		<script>	
			...
			$(document).ready(function() {
				...
				watermarkreport(); 
				mockjax1('getSearchtable_formfilled_unit');
				table = dataTable11('getSearchtable_formfilled_unit');
...
var orderType = order[0][1];
				...
				if (tableName == "getSearchtable_formfilled_unit" ) {

					$.post("getSearchtabledata_form_filled_unit_count?" + key + "=" + value, {
						Search : Search,
					...
					$.post("getSearchtabledata_form_filled_unit?" + key + "=" + value, {
						startPage : startPage,
