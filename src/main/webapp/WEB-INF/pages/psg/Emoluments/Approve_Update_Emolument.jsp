...
<form:form name="Edit_Emolument" id="Edit_Emolument" action="Approve_Edit_Emolument_Action"
	method="post" class="form-horizontal" commandName="Approve_Edit_Emolument_CMD">
...
<!-- 						                   maxlength="9"  onchange="personal_number();">   -->
						                   	...
						                   	<label id="lblpersonnel_no"></label>
...
function m_emoDetails() {
	...
	$.post('getm_emu_detailsData?' + key + "=" + value,{comm_id:comm_id},function(j) {
...
function ch_m_emoDetails() {
	...
	$.post('App_getm_emu_detailsData?' + key + "=" + value,{comm_id:comm_id,c_status:c_status,i_status:i_status},function(j) {
...
function ch_m_emo_close_Details() {
	...
	$.post('App_getm_emu_close_detailsData?' + key + "=" + value,{comm_id:comm_id,c_status:c_status,i_status:i_status},function(j) {
...
function ch_m_emoDetails_app() {
	...
	$.post('App_getm_emu_detailsData_app?' + key + "=" + value,{comm_id:comm_id},function(j) {
...
var comm_id = $('#comm_id').val();
  ...
  //  alert(count_hidden_old);
     ...
     $.post('approve_update_eno?' + key + "=" + value, {comm_id:comm_id}, function(j){
              alert(j);
...
function Rejectdata(){
    var comm_id = $('#comm_id').val()
     ...
     $.post('Reject_App_Update_eno?' + key + "=" + value, {comm_id:comm_id}, function(j){
              alert(j);
              window.location.href="Search_Emoluments";
      });
}
...
function Closedata(){
	...
	var e_fid = $("#e_fid"+R).val();
	var c_id = $("#c_id"+R).val();
			
	var amount_release_add =  $("#amount_release_add"+R).val();
	
	 var reason_add = $("#reason_add"+R).val();
	 var updated_as_on_add = $("#updated_as_on_add"+R).val();
	
	 $.post('Close_App_Update_eno?' + key + "=" + value, {comm_id:comm_id,count_hidden_old:count_hidden_old,e_fid:e_fid,
		 amount_release_add:amount_release_add,reason_add:reason_add,updated_as_on_add:updated_as_on_add}, function(data){
			  if(data=="update")
...
var comm_id = $('#comm_id').val();
  ...
  //  alert(count_hidden_old);
     ...
     $.post('approve_close_eno?' + key + "=" + value, {comm_id:comm_id}, function(j){
              alert(j);
              window.location.href="Search_Emoluments";
      });
}
...
var comm_id = $('#comm_id').val();
  ...
  //  alert(count_hidden_old);
     ...
     $.post('reject_close_eno?' + key + "=" + value, {comm_id:comm_id}, function(j){
              alert(j);
              window.location.href="Search_Emoluments";
      });
}
