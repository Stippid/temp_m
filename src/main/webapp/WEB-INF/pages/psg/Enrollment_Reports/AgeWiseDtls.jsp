...
<div class="animated fadeIn">
	<div class="">
		<div class="col-md-12" align="center">
			<div class="card">
			    <div class="card-header" align="center"><h5>AGE WISE DETAILS OF PERSONNELS</h5></div>
				<div class="card-body">
					<div class="col-md-12">
						<div class="col-md-6">
...
<div class="col-md-6">
						...
						<div class="col-md-6">
							<div class="row form-group">
								<div class="col col-md-4">
									<label class=" form-control-label">Serving: </label>
								</div>
								<div class="col-12 col-md-8">
									<select id="servingID" name="servingID" class="form-control">
										<option value = "0">--Select--</option> 
										<option value = "below30">Below 30 Yrs</option>
										<option value = "30to40years">30 to 40 Yrs</option>
										<option value = "40to45years">40 to 45 Yrs</option>
										<option value = "below50">Below 50 Yrs</option>
							...
							<div class="card-footer" align="center">
								<a href="Age_wise_dtls" class="btn btn-success btn-sm" >Clear</a>  
...
function data(tableName) {
	...
	if (tableName == "getSearch") {
	    $.post("age_wise_dtls_tablecount?" + key + "=" + value,{Search:Search,
	    	cont_comd : cont_comd,
		...
		$.post("age_wise_dtls_table?" + key + "=" + value, {
			startPage : startPage,
			...
			for (var i = 0; i < j.length; i++) {
				...
				if (typeID=='1'){
				  jsondata.push([sr, j[i].unit_name, j[i].unit_sus_no, j[i].personnel_no,
					   j[i].description, j[i].name, j[i].serving]);
				}
				else {
					jsondata.push([sr, j[i].unit_name, j[i].unit_sus_no, j[i].army_no,
						   j[i].rank, j[i].full_name, j[i].serving]);
				}
			}
		});
	}
		...
		$.post("age_wise_dtls_tablecountsum?" + key + "=" + value,{Search:Search,
			cont_comd : cont_comd,
			cont_corps : cont_corps,
			cont_div : cont_div,
			cont_bde : cont_bde,
		...
		$.post("age_wise_dtls_tablesum?" + key + "=" + value, {
			startPage : startPage,
			pageLength : pageLength,
			Search:Search,
			orderColunm : orderColunm,
			...
			for (var i = 0; i < j.length; i++) {
				...
				jsondata.push([j[i].unit_name, j[i].unit_sus_no, j[i].serving,
