		...
		<div class="col-md-12" align="center">
			<div class="card">
				<div class="card-header" align="center">
					<h5>DETAILS OF BORDER AREA PERS</h5>
				</div>
				<div class="card-body">
					<div class="col-md-12">
						<div class="col-md-6">
				...
				<div class="card-footer" align="center">
					<a href="Details_of_Border_Area_Pers_Url"
			...
			<div class="card-body">
				...
				<div class="col-md-12 container">
							<table id="getSearch"class="display table no-margin table-striped  table-hover table-bordered">
...
function data(tableName) {
	...
	if (tableName == "getSearch") {
	    $.post("Details_of_Border_Area_Pers_Count?" + key + "=" + value,{Search:Search,
			cont_comd : cont_comd,
		...
		$.post("Details_of_Border_Area_PersList?" + key + "=" + value, {
			startPage : startPage,
			...
			for (var i = 0; i < j.length; i++) {
				...
				if (off_cat=='1'){
					...
					jsondata.push([j[i].cmd_unit, j[i].corp_unit, j[i].div_unit,
						...
						j[i].name,j[i].state_name,j[i].district_name, j[i].mobile_no]);
						...
						jsondata.push([j[i].cmd_unit, j[i].corp_unit, j[i].div_unit,
							   ...
							   ,j[i].state_name,j[i].district_name, j[i].mobile_no]);
					}
		...
		$.post("Details_of_Border_Area_Pers_Summary_Count?" + key + "=" + value,{Search:Search,
			cont_comd : cont_comd,
			cont_corps : cont_corps,
			cont_div : cont_div,
			cont_bde : cont_bde,
		...
		$.post("Details_of_Border_Area_Pers_Summary_List?" + key + "=" + value, {
			startPage : startPage,
			pageLength : pageLength,
			Search:Search,
			orderColunm : orderColunm,
			...
			for (var i = 0; i < j.length; i++) {
				...
				if (off_cat=='1'){
					...
					jsondata.push([j[i].cmd_unit, j[i].corp_unit, j[i].div_unit,
						j[i].bde_unit, j[i].unit_name, j[i].unit_sus_no, j[i].officer,j[i].total,""]);
			} 
				else {
				jsondata.push([j[i].cmd_unit, j[i].corp_unit, j[i].div_unit,
					   j[i].bde_unit, j[i].unit_name, j[i].unit_sus_no,
