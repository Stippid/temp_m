...
<div class="animated fadeIn">
	<div class="">
		<div class="col-md-12" align="center">
			<div class="card">
			    <div class="card-header" align="center"><h5>DETAILS OF CHILDREN AGE WISE</h5></div>
				<div class="card-body">
    					<div class="col-md-12">
    						<div class="col-md-6">
...
<!-- 										<option value = "0">--Select--</option> -->
		...
		<a href="Details_of_Children_Age_Wise" class="btn btn-success btn-sm" >Clear</a>  
								...
								<table id="getSearchCount2"
									...
									<thead style="font-size: 15px; text-align: center;">
										<tr>
											...
											<th rowSpan = "3">Age Wise</th>  <!--  2 -->
											<th colspan = "4" width = "50%">Category</th>  <!--  3 -->
...
// 	var typeID = $("#typeID").val();
	...
	if (tableName == "getSearch") {
	    $.post("details_of_children_tablecount?" + key + "=" + value,{Search:Search,
	    	cont_comd : cont_comd,
		...
		$.post("details_of_children_table?" + key + "=" + value, {
			startPage : startPage,
	 ...
	 if (tableName == "getSearchCount"  && typeID=="1"){
		...
		$.post("details_of_children_tablecountsum?" + key + "=" + value,{Search:Search,
			cont_comd : cont_comd,
			cont_corps : cont_corps,
			cont_div : cont_div,
			cont_bde : cont_bde,
		...
		$.post("details_of_children_tablesum?" + key + "=" + value, {
			startPage : startPage,
			pageLength : pageLength,
			Search:Search,
			orderColunm : orderColunm,
				...
				if(typeID=="1")
					{
						...
						jsondata.push([j[i].age_wise,j[i].officer_female, j[i].officer_male,  
							j[i].total]);
	...
	if (tableName == "getSearchCount2" && typeID=="2"){
		...
		$.post("details_of_children_jco_tablecountsum?" + key + "=" + value,{Search:Search,
			cont_comd : cont_comd,
			cont_corps : cont_corps,
			cont_div : cont_div,
			cont_bde : cont_bde,
		...
		$.post("details_of_children_jco_tablesum?" + key + "=" + value, {
			startPage : startPage,
			pageLength : pageLength,
			Search:Search,
			orderColunm : orderColunm,
			...
			for (var i = 0; i < j.length; i++) {
				...
				jsondata.push([j[i].age_wise,   j[i].jco_female,j[i].jco_male,
