...
<div class="animated fadeIn">
	<div class="">
		<div class="col-md-12" align="center">
			<div class="card">
			    <div class="card-header" align="center"><h5>DETAILS OF SPECIAL CHILDREN</h5></div>
				<div class="card-body">
    					<div class="col-md-12">
    						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-12 col-md-8">
									<select id="typeID" name="typeID" class="form-control" onchange="rankChange()">
<!-- 										<option value = "0">--Select--</option> -->
						...
						<div class="col-md-6">
							...
							<div class="col-md-6">
	              				<div class="row form-group">
						            ...
						            <div class="col-md-8">
						            	<input type="text" name="posn_date" value = "${posn_date}" id="posn_date" maxlength="10"  onclick="clickclear(this, 'DD/MM/YYYY')" class="form-control" style="width: 90%;display: inline;"
	              			...
	              			<div class="col-md-6">
								<div class="row form-group">
	                				<div class="col col-md-4">
	                  					<label class=" form-control-label"> Select Rank:</label>
	                				</div>
	                				<div class="col-12 col-md-8" id="off_rnk">
	                 					<select id="rankID" name="rankID" class="form-control-sm form-control" >
	                 						<option value="0">--Select--</option>
	                				...
	                				<div class="col-12 col-md-8" style="display: none" id="jco_rnk">
	                 					<select id="rankjcoID" name="rankjcoID" class="form-control-sm form-control" >
	                 						<option value="0">--Select--</option>
	              			...
	              			<div class="col-md-12">
	          					<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"> Age Of Child From: </label>
						                </div>
						                <div class="col-md-8">
						               <input type="text" name="from_date" id="from_date" maxlength="10"  onclick="clickclear(this, 'DD/MM/YYYY')" class="form-control" style="width: 90%;display: inline;"
											onfocus="this.style.color='#000000'" onblur="clickrecall(this,'DD/MM/YYYY');validateDate(this.value,this);" onkeyup="clickclear(this, 'DD/MM/YYYY')" 
											onchange="clickrecall(this,'DD/MM/YYYY')" aria-required="true" autocomplete="off" style="color: rgb(0, 0, 0);"  max="${date}">
						                </div>
						            </div>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"> Age Of Child To: </label>
						                </div>
						                <div class="col-md-8">
						               <input type="text" name="to_date" id="to_date" maxlength="10"  onclick="clickclear(this, 'DD/MM/YYYY')" class="form-control" style="width: 90%;display: inline;"
											onfocus="this.style.color='#000000'" onblur="clickrecall(this,'DD/MM/YYYY');validateDate(this.value,this);" onkeyup="clickclear(this, 'DD/MM/YYYY')" 
											onchange="clickrecall(this,'DD/MM/YYYY')" aria-required="true" autocomplete="off" style="color: rgb(0, 0, 0);"  max="${date}">
						                </div>
						            </div>
		...
		<a href="Details_of_Special_child" class="btn btn-success btn-sm" >Clear</a>  
...
<!-- 	<i class="fa fa-file-excel-o" id="btnExport" style="font-size: x-large; color: red; text-align: right;"aria-hidden="true" title="EXPORT TO EXCEL"onclick="getExcelmain();"></i> -->
			      ...
			      <div class="card-body">
					<div class="datatablediv" id="reportDiv1">
						<div class="">
				...
				<div class="card-body">
					<div class="datatablediv" id="reportDivoff">
						<div class="">
						<h4 align ="center"><u>SUMMARY</u></h4>
							<div class="watermarked" data-watermark="" id="divwatermark">
								<span id="ip"></span>
								
								<table id="getSearchCount"
									class="table no-margin table-striped  table-hover  table-bordered report_print">
									<thead style="font-size: 15px; text-align: center;">
										<tr>
											<th rowSpan = "3">Unit</th>
											<th rowSpan = "3">SUS No</th>
											<th rowSpan = "3">Age Wise</th>
											<th colspan = "2">Category</th>  
								     	    <th rowspan= "3">Total</th>    
										</tr>
										
										<tr>
										<th colSpan = "2"id ="th_officer">Offrs</th>
				...
				<div class="card-body">
					<div class="datatablediv" id="reportDivjco">
						<div class="">
						<h4 align ="center"><u>SUMMARY</u></h4>
							<div class="watermarked" data-watermark="" id="divwatermark">
								<span id="ip"></span>
								
								<table id="getSearchCount2"
									class="table no-margin table-striped  table-hover  table-bordered report_print">
									<thead style="font-size: 15px; text-align: center;">
										<tr>
											<th rowSpan = "3">Unit</th>
											<th rowSpan = "3">SUS No</th>
											<th rowSpan = "3">Age Wise</th>
											<th colspan = "4" width = "50%">Category</th>  
								     	    <th rowspan= "3">Total</th>    <!--  4 -->
										</tr>
...
/* 	$('#unit_sus_no').change(function(){
	...
	mockjax1('getSearchCount');
	table2 = dataTable11('getSearchCount');
	mockjax1('getSearchCount2');
	table3 = dataTable11('getSearchCount2');
	...
	$('#btn-reload').on('click', function(){
		  table.ajax.reload();
	    	...
	    	table3.ajax.reload();
	    	 ...
	    	 if(typeID == "2"){
	             document.getElementById('p_id').innerHTML='Army No';
	          }
...
$('#typeID').change(function () {
 //  $('#getSearchCount,#getSearchCount2').hide();
...
function AutoCompleteCourse(ele,val){
	type="";
	var c=$("#typeID").val();
...
function data(tableName) {
	...
	var posn_date = $("#posn_date").val();
	var typeID = $("#typeID").val();
	var rankID = $("#rankID").val();
	var rankjcoID = $("#rankjcoID").val();
// 	var typeID = $("#typeID").val();
	var o_female = 0;	var o_male = 0;	var j_female = 0;	var or_male = 0; var or_female = 0;	var j_male = 0; var s_total = 0;
	...
	if (tableName == "getSearch") {
	    $.post("special_child_tablecount?" + key + "=" + value,{Search:Search,
	    	cont_comd : cont_comd,
		...
		$.post("special_child_table?" + key + "=" + value, {
			startPage : startPage,
			...
			for (var i = 0; i < j.length; i++) {
				...
				if(typeID=="1")
				{
					 document.getElementById('p_id').innerHTML='Personnel No';
				//	alert (j[i].Gender);
			    	jsondata.push([ sr,j[i].unit_name, j[i].unit_sus_no, j[i].personnel_no, j[i].description,
					     j[i].name,j[i].child_name,j[i].age, j[i].gender_name]);
					...
					jsondata.push([ sr,j[i].unit_name,j[i].unit_sus_no, j[i].army_no, j[i].rank,
						j[i].full_name,j[i].name,j[i].age, j[i].gender_name]);
				}
			}
	 ...
	 if (tableName == "getSearchCount"  && typeID=="1"){
	
		$.post("special_child_tablecountsum?" + key + "=" + value,{Search:Search,
			cont_comd : cont_comd,
			cont_corps : cont_corps,
			cont_div : cont_div,
			cont_bde : cont_bde,
		...
		$.post("special_child_tablesum?" + key + "=" + value, {
			startPage : startPage,
			pageLength : pageLength,
			Search:Search,
			orderColunm : orderColunm,
				...
				if(typeID=="1")
					{
						...
						jsondata.push([ j[i].unit_name,j[i].unit_sus_no, j[i].age_wise,j[i].officer_female, j[i].officer_male,  
							j[i].total]);
						o_female +=  j[i].officer_female;   o_male +=  j[i].officer_male;  s_total +=  j[i].total;
						
						
					}
			}
			jsondata.push(["","","TOTAL",o_female, o_male, s_total]);
		});
	...
	if (tableName == "getSearchCount2" && typeID=="2"){
	//	alert("hiii");
	
		$.post("special_child_jco_tablecountsum?" + key + "=" + value,{Search:Search,
			cont_comd : cont_comd,
			cont_corps : cont_corps,
			cont_div : cont_div,
			cont_bde : cont_bde,
		...
		$.post("special_child_jco_tablesum?" + key + "=" + value, {
			startPage : startPage,
			pageLength : pageLength,
			Search:Search,
			orderColunm : orderColunm,
			...
			for (var i = 0; i < j.length; i++) {
				...
				jsondata.push([j[i].unit_name,j[i].unit_sus_no, j[i].age_wise,   j[i].jco_female,j[i].jco_male,
					j[i].ors_female,j[i].ors_male,j[i].total]);
					  
				j_female +=  j[i].jco_female;   j_male +=  j[i].jco_male;  or_male +=  j[i].ors_male;
				or_female +=  j[i].ors_female;   s_total +=  j[i].total; 
					
			}
			}
			jsondata.push(["","","TOTAL",j_female, j_male,or_female ,or_male, s_total]);
		});
	}
