		...
		<div class="col-md-12" align="center">
			<div class="card">
				<div class="card-header" align="center">
					<h5>DETAILS OF PAN/UID/AADHAAR ETC OF PERS/NOK OF UNITS/EST/FROM HQS ETC</h5>
				</div>
				<div class="card-body">
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								<div class="col col-md-4">
									<label class=" form-control-label">Officer Category</label>
								</div>
				...
				<div class="card-footer" align="center">
					<a href="Details_of_pan_uid_aadhaar_of_pers_from_hq_Url"
...
function data(tableName) {
	...
	if (tableName == "getSearch") {
	    $.post("Details_of_pan_uid_aadhaar_of_pers_from_hq_Count?" + key + "=" + value,{Search:Search,
			cont_comd : cont_comd,
		...
		$.post("Details_of_pan_uid_aadhaar_of_pers_from_hqList?" + key + "=" + value, {
			startPage : startPage,
			...
			for (var i = 0; i < j.length; i++) {
				...
				if (off_cat=='1'){
					...
					jsondata.push([sr, j[i].unit_name, j[i].unit_sus_no, j[i].personnel_no, j[i].description,
						j[i].name,j[i].pancard_number,j[i].adhar_number, j[i].mobile_no]);
					
					}
				else{
						jsondata.push([ sr, j[i].unit_name, j[i].unit_sus_no,
							   j[i].army_no, j[i].rank, j[i].full_name,j[i].pan_no,j[i].aadhar_no,  j[i].mobile_no]);
					}
		...
		$.post("Details_of_pan_uid_aadhaar_of_pers_from_hq_Summary_Count?" + key + "=" + value,{Search:Search,
			cont_comd : cont_comd,
			cont_corps : cont_corps,
			cont_div : cont_div,
			cont_bde : cont_bde,
		...
		$.post("Details_of_pan_uid_aadhaar_of_pers_from_hq_Summary_List?" + key + "=" + value, {
			startPage : startPage,
			pageLength : pageLength,
			Search:Search,
			orderColunm : orderColunm,
			...
			for (var i = 0; i < j.length; i++) {
				...
				if (off_cat=='1'){
					...
					jsondata.push([sr, j[i].unit_name, j[i].unit_sus_no, j[i].officer,j[i].total,""]);
			} 
				else {
				jsondata.push([sr, j[i].unit_name, j[i].unit_sus_no,
