		...
		<div class="col-md-12" align="center">
			<div class="card">
				<div class="card-header" align="center">
					<h5>LIST OF MARRIED AND UNMARRIED PERSONNELS OF UNITS/EST</h5>
				</div>
				<div class="card-body">
					<div class="col-md-12">
						<div class="col-md-6">
...
<!-- 										<option value="0" name="select">---Select---</option> -->
				...
				<div class="card-footer" align="center">
					<a href="List_of_Married_and_Unmarried_Personnel_of_Units_Est_Url"
							...
							<table id="getSearch"class="table no-margin table-striped  table-hover  table-bordered report_print">
								<thead style="font-size: 15px; text-align: center;">
									<tr>
										...
										<th>Rank</th>
										<th>Name</th>
										<th>Married / Unmarried/Divorced/Seperated</th>
										<th>Age</th>
									</tr>
								</thead>
								<tbody>
							...
							<table id="getSummary" class="table no-margin table-striped  table-hover  table-bordered report_print">
								<thead style="font-size: 15px; text-align: center;">
									<tr>
										...
										<th rowSpan="2">Married / Unmarried/Divorced/Seperated</th>
...
function data(tableName) {
	...
	var s_offrs = 0;
	var s_jco = 0;
	var s_ors = 0; var s_total = 0;
	
	if (tableName == "getSearch") {
	    $.post("List_of_Married_and_Unmarried_Personnel_of_Units_Est_Count?" + key + "=" + value,{Search:Search,
			cont_comd : cont_comd,
		...
		$.post("List_of_Married_and_Unmarried_Personnel_of_Units_EstList?" + key + "=" + value, {
			startPage : startPage,
			...
			for (var i = 0; i < j.length; i++) {
				...
				if (off_cat=='1'){
					...
					jsondata.push([sr, j[i].unit_name, j[i].unit_sus_no, j[i].personnel_no, j[i].description,
						j[i].name,j[i].marital_name,j[i].age]);
					
					}
				else{
						jsondata.push([sr, j[i].unit_name, j[i].unit_sus_no,
							j[i].army_no, j[i].rank,
							j[i].full_name,j[i].marital_name,j[i].age]);
					}
		...
		$.post("List_of_Married_and_Unmarried_Personnel_of_Units_Est_Summary_Count?" + key + "=" + value,{Search:Search,
			cont_comd : cont_comd,
			cont_corps : cont_corps,
			cont_div : cont_div,
			cont_bde : cont_bde,
		...
		$.post("List_of_Married_and_Unmarried_Personnel_of_Units_Est_Summary_List?" + key + "=" + value, {
			startPage : startPage,
			pageLength : pageLength,
			Search:Search,
			orderColunm : orderColunm,
			...
			for (var i = 0; i < j.length; i++) {
				...
				if (off_cat=='1'){
					...
					jsondata.push([j[i].cmd_unit, j[i].corp_unit, j[i].div_unit,
						j[i].bde_unit, j[i].unit_name, j[i].unit_sus_no, j[i].marital_name, j[i].officer, 
						j[i].total,""]);
					s_offrs +=  j[i].officer; s_total += j[i].total;
			} 
				else {
				jsondata.push([j[i].cmd_unit, j[i].corp_unit, j[i].div_unit,
					   j[i].bde_unit, j[i].unit_name, j[i].unit_sus_no, j[i].marital_name,
					   j[i].jco,j[i].ors,j[i].total]);
				s_jco +=  j[i].jco;
				s_ors +=  j[i].ors; s_total += j[i].total;
