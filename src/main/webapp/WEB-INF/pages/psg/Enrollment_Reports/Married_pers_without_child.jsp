...
<div class="animated fadeIn">
	<div class="">
		<div class="col-md-12" align="center">
			<div class="card">
			    <div class="card-header" align="center"><h5>DETAILS OF MARRIED PERS WITHOUT CHILDREN</h5></div>
				<div class="card-body">
    				<div class="col-md-12">
						<div class="col-md-6">
						...
						<div class="col-md-12">
							<div class="col-md-6">
								<div class="row form-group">
							    	<div class="col col-md-4">
							        	<label class=" form-control-label">Cont Command</label>
							       	</div>
							        <div class="col-12 col-md-8">
						...
						<div class="col-md-12">
							<div class="col-md-6">
								<div class="row form-group">
					                <div class="col col-md-4">
					                  <label class=" form-control-label">Cont Division</label>
					                </div>
					                <div class="col-12 col-md-8">
							...
							<div class="col-md-6">
								<div class="row form-group">
	                				<div class="col col-md-4">
	                  					<label class=" form-control-label">Cont Brigade</label>
	                				</div>
	                				<div class="col-12 col-md-8">
...
<!-- 	              			</div> -->
						...
						<div class="card-footer" align="center">
							<a href="Married_pers_without_child" class="btn btn-success btn-sm" >Clear</a>  
...
if (tableName == "getSearch") {
    $.post("married_pers_without_child_tablecount?" + key + "=" + value,{Search:Search,
    	cont_comd : cont_comd,
...
// 		to_date : to_date,
	...
	$.post("married_pers_without_child_table?" + key + "=" + value, {
		startPage : startPage,
...
// 		to_date : to_date,
		...
		for (var i = 0; i < j.length; i++) {
			...
			if (typeID=='1'){
			  jsondata.push([sr, j[i].unit_name, j[i].unit_sus_no, j[i].personnel_no,
				   j[i].description, j[i].name, j[i].age,
				   j[i].mar_date]);
			}
			else {
				jsondata.push([sr, j[i].unit_name, j[i].unit_sus_no, j[i].army_no,
					   j[i].rank, j[i].full_name, j[i].age,
					   j[i].mar_date]);
			}
		}
	});
	...
	$.post("married_pers_without_child_tablecountsum?" + key + "=" + value,{Search:Search,
		cont_comd : cont_comd,
		cont_corps : cont_corps,
		cont_div : cont_div,
		cont_bde : cont_bde,
...
// 		to_date : to_date,
	...
	$.post("married_pers_without_child_tablesum?" + key + "=" + value, {
		startPage : startPage,
		pageLength : pageLength,
		Search:Search,
		orderColunm : orderColunm,
