		...
		<div class="col-md-12" align="center">
			<div class="card">
				<div class="card-header" align="center">
					<h5>NUMBER OF BATTLE/PHYSICAL CASUALTY</h5>
				</div>
				<div class="card-body">
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-12 col-md-8">
									<select id="off_cat" name="off_cat" class="form-control">
										<option value="1" name="officer">Offrs</option>
											<option value="2" name="jco officer">JCO/OR</option>
									</select>
								</div>
							</div>
						</div>
				...
				<div class="card-footer" align="center">
					<a href="No_of_battle_Physical_Casualty_List_and_Total_Url"
						class="btn btn-success btn-sm">Clear</a> <i class="fa fa-search"></i><input
						type="button" class="btn btn-primary btn-sm" id="btn-reload"
						value="Search" />
				</div>
			</div>
							...
							<table id="getSearch"class="table no-margin table-striped  table-hover  table-bordered report_print">
								<thead style="font-size: 15px; text-align: center;">
									<tr>
										...
										<th>Unit</th>
										<th>SUS No</th>
										<th id="per_army_th_id">Personnel No</th>
										<th>Rank</th>
										<th>Name</th>
										<th>Classification of Cas(Battle/Physical)</th>
										<th>Date of Cas</th>
									</tr>
								</thead>
								<tbody>
							...
							<table id="getSummary" class="table no-margin table-striped  table-hover  table-bordered report_print">
								<thead style="font-size: 15px; text-align: center;">
									<tr>
										...
										<th rowSpan="2">Battle Cas</th>
										<th rowSpan="2">Physical Cas</th>
...
$('#btn-reload').on('click', function(){
	...
	if(off_cat == 2){
		...
		document.getElementById('per_army_th_id').innerHTML='Army No';
	...
	//	$('#th_or').css('display','block');
		...
		document.getElementById('per_army_th_id').innerHTML='Personnel No';
...
function data(tableName) {
	...
	if (tableName == "getSearch") {
	    $.post("No_of_battle_Physical_Casualty_List_and_Total_Count?" + key + "=" + value,{Search:Search,
			cont_comd : cont_comd,
		...
		$.post("No_of_battle_Physical_Casualty_List_and_TotalList?" + key + "=" + value, {
			startPage : startPage,
			...
			for (var i = 0; i < j.length; i++) {
				...
				if (off_cat=='1'){
					...
					jsondata.push([j[i].cmd_unit, j[i].corp_unit, j[i].div_unit,
						j[i].bde_unit, j[i].unit_name, j[i].unit_sus_no, j[i].personnel_no, j[i].description,
						j[i].name, j[i].classification_of_casuality,j[i].date_of_casuality]);
						...
						jsondata.push([j[i].cmd_unit, j[i].corp_unit, j[i].div_unit,
							   ...
							   , j[i].classification_of_casuality,j[i].date_of_casuality]);
					}
		...
		$.post("No_of_battle_Physical_Casualty_List_and_Total_Summary_Count?" + key + "=" + value,{Search:Search,
			cont_comd : cont_comd,
			cont_corps : cont_corps,
			cont_div : cont_div,
			cont_bde : cont_bde,
		...
		$.post("No_of_battle_Physical_Casualty_List_and_Total_Summary_List?" + key + "=" + value, {
			startPage : startPage,
			pageLength : pageLength,
			Search:Search,
			orderColunm : orderColunm,
			...
			for (var i = 0; i < j.length; i++) {
				...
				if (off_cat=='1'){
					...
					jsondata.push([j[i].cmd_unit, j[i].corp_unit, j[i].div_unit,
						j[i].bde_unit, j[i].unit_name, j[i].unit_sus_no, j[i].officer,
						j[i].battle_casuality,j[i].physical_casuality,j[i].total,""]);
			} 
				else {
