...
<div class="animated fadeIn">
	<div class="">
		<div class="col-md-12" align="center">
			<div class="card">
			    <div class="card-header" align="center"><h5>NUMBER OF PERS QUALIFIED ON FOREIGN LANGUAGE</h5></div>
				<div class="card-body">
				<div class="col-md-12">
						<div class="col-md-6">
				...
				<div class="col-md-12">
							...
							<div class="row form-group">
								...
								<div class="col-md-8">
									...
									<input type="text" id="unit_sus_no" name="unit_sus_no"
										...
										<!-- <input type="text" id="type_hid" name="type_hid"
										class="form-control autocomplete" autocomplete="off"
										maxlength="8" > -->
						...
						<div class="col-md-6">
							...
							<div class="col-md-6">
								<div class="row form-group">
		                			...
		                			<div class="col-12 col-md-8">
		                 				<select id="languageID" name="languageID" class="form-control-sm form-control" >
							...
							<div class="col-md-6">
								<div class="row form-group">
					                <div class="col col-md-4">
					                  <label class=" form-control-label"> Select Std:</label>
					                </div>
					                <div class="col-12 col-md-8">
					                 	<select id="stdID" name="stdID" class="form-control-sm form-control" >
					                 		<option value="0">--Select--</option>
							...
							<div class="col-md-6">
	          				...
	          				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong style="color: red;">* </strong> Posn as on </label>
						                </div>
						            </div>
	              				</div>
	              			</div> -->
					...
					<div class="card-footer" align="center">
						<a href="Pers_foreign_language" class="btn btn-success btn-sm" >Clear</a>  
					...
					<div class="datatablediv" id="reportDiv">
						<div class=" ">
							<div class="watermarked" data-watermark="" id="divwatermark">
								<span id="ip"></span>
								<table id="getSearch" class="table no-margin table-striped  table-hover  table-bordered report_print">
				...
				<div class="card-body">
					<div class="datatablediv" id="reportDiv">
						...
						<h4 align="center"><u>SUMMARY</u></h4>
							<div class="watermarked" data-watermark="" id="divwatermark">
								<span id="ip"></span>	
								<table id="getSummary" class="table no-margin table-striped  table-hover  table-bordered report_print">
									<thead style="font-size: 15px; text-align: center;">
										<tr>
											<th rowSpan = "2">Comd</th>
											<th rowSpan = "2">Corps/Area</th>
											<th rowSpan = "2">Div/Sub Area</th>
											<th rowSpan = "2">Bde</th>
									...
									<tbody>
										<c:if test="${list.size() == 0}">
											<tr>
												<td colspan="10" align="center" style="color: red;">Data
													Not Available</td>
											</tr>
										</c:if>
									</tbody>
...
function data(tableName) {
	...
	if (tableName == "getSearch") {
	    $.post("search_foreign_language_tablecount?" + key + "=" + value,{Search:Search,
			cont_comd : cont_comd,
		...
		$.post("search_foreign_language_table?" + key + "=" + value, {
			startPage : startPage,
			...
			for (var i = 0; i < j.length; i++) {
				var sr = i + 1;
				if (typeID=='1'){
				jsondata.push([j[i].cmd_unit, j[i].corp_unit, j[i].div_unit,
							   j[i].bde_unit, j[i].unit_name, j[i].unit_sus_no,
							    j[i].personnel_no, 
							   j[i].description, j[i].name,
							   j[i].foreign_language_name, j[i].lang_std]);
				
				
				} else {
					 jsondata.push([j[i].cmd_unit, j[i].corp_unit, j[i].div_unit,
						   j[i].bde_unit, j[i].unit_name, j[i].unit_sus_no,
						   j[i].army_no, j[i].rank, j[i].full_name,
						   j[i].foreign_language_name, j[i].lang_std]); 
	...
	else if (tableName == "getSummary"){
		$.post("search_foreign_language_tablecountsum?" + key + "=" + value,{Search:Search,
			cont_comd : cont_comd,
			cont_corps : cont_corps,
			cont_div : cont_div,
			cont_bde : cont_bde,
		...
		$.post("search_foreign_language_tablesum?" + key + "=" + value, {
			startPage : startPage,
			pageLength : pageLength,
			Search:Search,
			orderColunm : orderColunm,
			...
			for (var i = 0; i < j.length; i++) {
				...
				jsondata.push([j[i].cmd_unit, j[i].corp_unit, j[i].div_unit,
							   j[i].bde_unit, j[i].unit_name, j[i].unit_sus_no,
							   j[i].officer, j[i].foreign_language, j[i].total, ""]);
				s_offrs +=  j[i].officer; s_total +=  j[i].total; 
			} else {
				
				document.getElementById('o_id').innerHTML='JCO';
				document.getElementById("cat_id").colSpan = "2";
		       // $('#th_or').css('display','block');
		        table2.column(9).visible(true);
		        $("#th_or").show();
				jsondata.push([j[i].cmd_unit, j[i].corp_unit, j[i].div_unit,
					   j[i].bde_unit, j[i].unit_name, j[i].unit_sus_no,
					   j[i].jco, j[i].ors, j[i].foreign_language, j[i].total]);
