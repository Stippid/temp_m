...
<div class="animated fadeIn">
	<div class="">
		<div class="col-md-12" align="center">
			<div class="card">
			    <div class="card-header" align="center"><h5>NUMBER OF PERS QUALIFIED ON COURSE WITH GRADING</h5></div>
				<div class="card-body">
    					<div class="col-md-12">
    						<div class="col-md-6">
...
<!-- 										<option value = "0">--Select--</option> -->
				...
				<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-12 col-md-8">
									<input type="text" id="army_course_name1" name="army_course_name1" onkeypress="AutoCompleteCourse(this,0);"  
						...
						<div class="col-md-6">
							<div class="row form-group">
								<div class="col col-md-4">
									<label class=" form-control-label">Select Grading</label>
								</div>
								<div class="col-12 col-md-8">
		...
		<a href="Pers_qualified_course" class="btn btn-success btn-sm" >Clear</a>  
...
function data(tableName) {
	...
	var typeID = $("#typeID").val();
	var army_course_name1 = $("#army_course_name1").val();
	var army_course_div_grade1 = $("#army_course_div_grade1").val();
	var posn_date = $("#posn_date").val();
	
	if (tableName == "getSearch") {
	    $.post("search_qualification_tablecount?" + key + "=" + value,{Search:Search,
			cont_comd : cont_comd,
			...
			typeID : typeID,
			army_course_name1 : army_course_name1,
			army_course_div_grade1 : army_course_div_grade1,
			posn_date : posn_date
		...
		$.post("search_qualification_table?" + key + "=" + value, {
			startPage : startPage,
			...
			for (var i = 0; i < j.length; i++) {
				...
				if(typeID=="1")
				{
			    	...
			    	jsondata.push([ sr, j[i].cmd_unit, j[i].corp_unit, j[i].div_unit,
					     j[i].bde_unit, j[i].unit_name,j[i].unit_sus_no, j[i].personnel_no, j[i].rank,
					     j[i].name,j[i].course, j[i].grading, j[i].date_of_completion]);
					...
					jsondata.push([ sr, j[i].cmd_unit, j[i].corp_unit, j[i].div_unit,
						j[i].bde_unit, j[i].unit_name,j[i].unit_sus_no, j[i].army_no, j[i].rank,
						j[i].name,j[i].course, j[i].grading, j[i].date_of_completion]);
	...
	if (tableName == "getSearchCount") {
	    $.post("search_qualification_course_tablecount?" + key + "=" + value,{Search:Search,
			cont_comd : cont_comd,
			cont_corps : cont_corps,	
			cont_div : cont_div,
			cont_bde : cont_bde,
		...
		$.post("search_qualification_course_table?" + key + "=" + value, {
			startPage : startPage,
			pageLength : pageLength,
			Search:Search,
			orderColunm : orderColunm,
			...
			for (var i = 0; i < j.length; i++) {
				...
				if(typeID=="1")
					...
					table2.column(10).visible(false);
						...
						jsondata.push([ sr, j[i].cmd_unit, j[i].corp_unit, j[i].div_unit,
						j[i].bde_unit, j[i].unit_name,j[i].unit_sus_no,j[i].name_of_course, j[i].officer, j[i].total,""]);
				...
				//	  $('#th_or').css('display','block');
					...
					jsondata.push([ sr, j[i].cmd_unit, j[i].corp_unit, j[i].div_unit,
						j[i].bde_unit, j[i].unit_name,j[i].unit_sus_no, j[i].name_of_course, j[i].jco, j[i].ors,j[i].total]);
