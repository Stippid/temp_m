...
<div class="animated fadeIn">
	<div class="">
		<div class="col-md-12" align="center">
			<div class="card">
			    <div class="card-header" align="center"><h5>LIST AND TOTAL NUMBER OF PERS VISITED FOREIGN COUNTRIES</h5></div>
				<div class="card-body">
				<div class="col-md-12">
						<div class="col-md-6">
...
<!-- 	          			</div> -->
				...
				<div class="card-footer" align="center">
					<a href="Pers_visited_foreign_country" class="btn btn-success btn-sm" >Clear</a>  
								...
								<table id="getSearch1" class="table no-margin table-striped  table-hover  table-bordered report_print" >
									<thead style="font-size: 15px; text-align: center;">
										<tr>
											...
											<th rowSpan = "2" id = "p_id">Personnel No</th>
											<th rowSpan = "2">Rank</th>
											<th rowSpan = "2">Name</th>
											<th rowSpan = "2">Type of UN Mission</th>
				...
				<div class="card-body">
					<div class="datatablediv" id="reportDiv">
						...
						<h4 align="center"><u>SUMMARY</u></h4>
							<div class="watermarked" data-watermark="" id="divwatermark">
								<span id="ip"></span>
								<table id="getSummary1" class="table no-margin table-striped  table-hover  table-bordered report_print">
									<thead style="font-size: 15px; text-align: center;">
										<tr>
										<th rowSpan="2" >Ser No</th>
...
$(document).ready(function() {
	...
	mockjax1('getSearch1');
	table = dataTable11('getSearch1');

	mockjax1('getSummary1');
	table2 = dataTable11('getSummary1');
...
function data(tableName) {
	...
	if (tableName == "getSearch1") {
	    $.post("pers_foreign_visited_country_tablecount?" + key + "=" + value,{Search:Search,
	    	cont_comd : cont_comd,
		...
		$.post("pers_foreign_visited_country_table?" + key + "=" + value, {
			startPage : startPage,
			...
			for (var i = 0; i < j.length; i++) {
				...
				if (typeID=='1'){
				  jsondata.push([sr, j[i].unit_name, j[i].unit_sus_no, j[i].personnel_no,
					   j[i].description, j[i].name, j[i].type_of_un_miss,
					   j[i].from_dt,j[i].to_dt]);
				}
				else {
					jsondata.push([sr, j[i].unit_name, j[i].unit_sus_no, j[i].army_no,
						   j[i].rank, j[i].full_name, j[i].type_of_un_miss,
						   j[i].from_dt,j[i].to_dt]);
				}
			}
		});
	...
	else if (tableName == "getSummary1"){
		$.post("pers_foreign_visited_country_tablecountsum?" + key + "=" + value,{Search:Search,
			cont_comd : cont_comd,
			cont_corps : cont_corps,
			cont_div : cont_div,
			cont_bde : cont_bde,
		...
		$.post("pers_foreign_visited_country_tablesum?" + key + "=" + value, {
			startPage : startPage,
			pageLength : pageLength,
			Search:Search,
			orderColunm : orderColunm,
