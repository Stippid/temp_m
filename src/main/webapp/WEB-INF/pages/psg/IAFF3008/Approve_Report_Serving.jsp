...
<%-- <form:form name="Report_Serving" id="Report_Serving" action="Report_Serving_Action" method="post" class="form-horizontal" commandName="Report_Serving_CMD"> --%> 
	<div class="animated fadeIn">
	    <div class="container" align="center">
	    	<div class="card">
	    		<div class="card-header"><h5> APPROVE IAFF - 3008: STR RETURN OFFRS   </h5> <h6 class="enter_by"></h6></div>
	...
	<div class="col-md-12">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						             <textarea id="remarksforoffrstos" name="remarksforoffrstos" class="form-control autocomplete"  autocomplete="off" ></textarea>
						                </div>
						            </div>
	              				</div>   
	              					...
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						             <textarea id="remarksforoffrssos" name="remarksforoffrssos" class="form-control autocomplete"  autocomplete="off" ></textarea>
						                </div>
						            </div>
	              				</div>
	              					...
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						             <textarea id="remarksforoffrspostout" name="remarksforoffrspostout" class="form-control autocomplete"  autocomplete="off" ></textarea>
						                </div>
						            </div>
	              				</div>
	              					<div class="col-md-12">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						             <textarea id="remarksforoffrspostin" name="remarksforoffrspostin" class="form-control autocomplete"  autocomplete="off" ></textarea>
						                </div>
						            </div>
	              				</div>
	              					<div class="col-md-12">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						             <textarea id="remarksforoffrsunderretire" name="remarksforoffrsunderretire" class="form-control autocomplete"  autocomplete="off" ></textarea>
						                </div>
						            </div>
	              				</div>
	              					<div class="col-md-12">
			 ...
			 <div class="card-footer" align="center" class="form-control" id = "Savebtn" style="display: block;">
				<c:if test="${roleType == 'APP'}">		
			    	<a href="Search_Report_Url" class="btn btn-danger btn-sm" >Cancel</a>  		
		...
		<a href="Search_Report_Url" class="btn btn-danger btn-sm">Close</a>		
	
	</div>
	
	    <div class="card-footer" align="center" class="form-control"
		id="reporclose" style="display: none;">		 
		<a href="IAFF_3008_Query" class="btn btn-danger btn-sm">Close</a>		
	
	</div>
		
<%-- </form:form> --%>
		
		<c:url value="Approve_3008" var="editUrl"/>
	<form:form action="${editUrl}" method="post" id="updateForm" name="updateForm">
		...
		$(document).ready(function() {
			...
			else  if(r == "MISO"|| r == "Line_dte" || r == "Formation"){
		...
		//	$("#observation").val('${observation5}');
				$("#remarks").val('${remarks}');
				$("#remarksforoffrstos").val('${remarksforoffrstos}');
				$("#remarksforoffrssos").val('${remarksforoffrssos}');
				$("#remarksforoffrspostout").val('${remarksforoffrspostout}');
				$("#remarksforoffrspostin").val('${remarksforoffrspostin}');
				$("#remarksforoffrsunderretire").val('${remarksforoffrsunderretire}');
				$("#distr").val('${distr}');
				...
				$("#remarksforoffrstos").attr("disabled", true);
				$("#remarksforoffrssos").attr("disabled", true);
				$("#remarksforoffrspostout").attr("disabled", true);
				$("#remarksforoffrspostin").attr("disabled", true);
				$("#remarksforoffrsunderretire").attr("disabled", true);
