...
<form:form name="Report_Serving" id="Report_Serving" action="Report_Serving_Action" method="post" class="form-horizontal" commandName="Report_Serving_CMD"> 
	<div class="animated fadeIn">
	    <div class="container-xl" >
	    	...
	    	<div class="card">
	    		<div class="card-header"align="center" ><h5>  IAFF - 3008: STR RETURN OFFRS   </h5> <h6 class="enter_by"></h6></div>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                	 <label id="unit_sus_no_hid" style="display: none; text-transform: uppercase;"><b>${roleSusNo}</b></label> 
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                   <input type="text" id="present_return_no" name="present_return_no" class="form-control autocomplete" autocomplete="off" maxlength="10" onkeyup="return specialcharecter(this)" onkeypress="return AvoidSpace(event)" > 
						                </div>
						            </div>
	              				</div>            				
	              				<div class="col-md-6">
	              					...
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                    ...
						                    <input type="text" id="we_pe_no" name="we_pe_no" class="form-control autocomplete" readonly = "readonly" autocomplete="off" maxlength="15" onkeyup="return specialcharecter(this)" onkeypress="return AvoidSpace(event)">  
						                </div>
						            </div>
	              				</div>              				
	              			</div>            				              				              			              				              			
						...
						<div class="col-md-12 card-footer" align="center" class="form-control" >
							<a href="Report_SevingUrl" class="btn btn-success btn-sm" >Clear</a>  
		              		<input type="button" class="btn btn-info btn-sm" onclick="Search();" value="Search"> 
		              			<c:if test="${roleAccess == 'MISO'}" >	 																
					               <input type="button" class="btn btn-success btn-sm" onclick="openadd_offrs_3008();" value="Add/Post In/ Out Offr"> 	
				                </c:if> 
				                <c:if test="${roleAccess == 'Unit'}" >	 																
				                	<input type="button" class="btn btn-success btn-sm" onclick="openpostinout();" value="Post In/ Out Offr"> 	
				                </c:if>           		
                       
			            </div> 
			            </div>
			</div>
			<div class="col-lg-4 col-md-6 col-sm-12 col-12 instruction">
			<div class="card">
			<div class="card-header" align="center"><h5>  Note  </h5> <h6 class="enter_by"></h6></div>
	    		<div class="card-body" >
	    		<div class="hz-line"></div>
				    <label class="form-control-label alert info" style="font-weight: bold;" >
				    <div class="circle "></div>
					    * Please click on the "Edit" button to update any casualty details such as Rank, Name, Personal Number, CDA Account, ARM/Service, Medical Category,Date of Taken On Strength, Date of Birth, 
					    Date of Commission, Date of Seniority, and Date of Appointment for specific PERSONNEL no.
				    </label> 
					<label class="form-control-label alert info" style="font-weight: bold;">
					<div class="circle "></div>
						  	* Officers who are not posted in your unit can be updt through " Posting in / out " tab.
					</label> 	
							 <c:if test="${roleAccess == 'Unit'}" >	 																
					<label class="form-control-label alert info" style="font-weight: bold;" >
					<div class="circle "></div>
						* Officers which are not commissioned, please contact MISO at 39861
				     	or raise a ticket to enter commissioning details of the officer in the MISO database.
				     </label> 
								                </c:if>  
							
							</div>
						<div class="card-header" align="center"><h5>  IMPORTANT  </h5> <h6 class="enter_by"></h6></div>
							<div class="card-body" >
	    		<div class="hz-line"></div>
				    <label class="form-control-label alert info" style="font-weight: bold;" >
				    <div class="circle "></div>
					    * Unit to Approve/Genr IAFF 3008 before 3rd of each month, showing posn as at 2359hrs on last day of previous month.
				    </label> 
...
<div class="col-md-12" id="getSearch_Letter" style="display: block;">
	...
	<div class="col-md-12" id="getSearch_Letter" style="display: block;"> 	 
			<div  class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
		           <table id="getServingTable" class="table no-margin table-striped  table-hover  table-bordered ">
		                 <thead>
		                       <tr>
			                         <th style="text-align: center;" id="appt">Ser No</th>
			                         <th style="text-align: center;" id="appt">Update</th>	
			                         <th style="text-align: center;" id="appt"> <strong style="color: red;">* </strong>Appt </th>		                         
			                         ...
			                         <th style="text-align: center;" id="cda_acc_no"> CDA A/C No </th>
			                         <th style="text-align: center;" id="parent_arm"> Arm/Service </th>
			                         <th style="text-align: center;" id="med_cat"> Medical Cat </th>
			                         <th style="text-align: center;" id="dt_of_tos"> Date of TOS </th>
			                         <th style="text-align: center;" id="date_of_birth"> Date of Birth </th>
			                         <th style="text-align: center;" id="date_of_commission"> Date of Comm </th>
			                         <th style="text-align: center;" id="date_of_seniority"> Date of SEN </th>
			                         <th style="text-align: center;" id="date_of_appointment"> Date of Appt </th>
...
<div class="col-md-12" id="getSearch_Letter" style="display: block;">	
	...
	<div class="col-md-12" id="getSearch_Letter" style="display: block;"> 	 
			<div  class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
		           <table id="getSupernumTable" class="table no-margin table-striped  table-hover  table-bordered ">
		                 <thead>
		                       <tr>	
		                       		 <th style="text-align: center;" id="appt">Ser No</th>		                         
			                         <th style="text-align: center;" id="appt"> <strong style="color: red;">* </strong> Appt </th>	                         
...
<div class="col-md-12" id="getSearch_Letter" style="display: block;">	
	...
	<div class="col-md-12" id="getSearch_Letter" style="display: block;"> 	 
			<div  class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
		           <table id="getReEmployeeTable" class="table no-margin table-striped  table-hover  table-bordered ">
		                 <thead>
		                       <tr>	
		                       		 <th style="text-align: center;" id="appt">Ser No</th>
			                         <th style="text-align: center;" id="appt"><strong style="color: red;">* </strong> Appt</th>		                         
			                         <th style="text-align: center;" id="rankT"> Present Rank </th>
			                         <th style="text-align: center;" id="name"> Name </th>			                       
			                         <th style="text-align: center;" id="personnel_no"> Personal No </th>
			                         <th style="text-align: center;" id="cda_acc_no"> CDA A/C No </th>
			                         <th style="text-align: center;" id="parent_arm"> Arm/Service </th>
...
<div class="col-md-12" id="getSearch_Letter" style="display: block;"> 	 
			<div  class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
		           <table id="getDeserterTable" class="table no-margin table-striped  table-hover  table-bordered ">
		                 <thead>
		                       <tr>	
		                       		 <th style="text-align: center;" id="appt">Ser No</th>		                         
			                         <th style="text-align: center;" id="appt"> <strong style="color: red;">* </strong> Appt </th>	                         
			                         ...
			                         <th style="text-align: center;" id="date_of_seniority"> Date of SEN </th>
			                         <th style="text-align: center;" id="date_of_appointment"> Date of Appt </th>
			                         <th style="text-align: center;" id="dt_desertion"> Date of Desertion </th>
...
<%-- 										<td style="font-size: 15px;">${item6[17]}</td> --%>
		           ...
		           <table id="getAuthHeldTable" class="table no-margin table-striped  table-hover  table-bordered ">
		                 <thead>
		                       <tr>	
			                         ...
			                         <th style="text-align: center;" id="rankT"> Rank </th>
			                         <th style="text-align: center;" id="base_auth"> Base Auth </th>			                       
			                         <th style="text-align: center;" id="mod_auth"> Mod Auth </th>
			                         <th style="text-align: center;" id="foot_auth"> Foot Auth </th>
			                         <th style="text-align: center;" id="total_auth"> Total Auth </th>	
<!-- 			                         <th style="text-align: center;" id="total_held"> Total Held </th>			                          -->
		                          </tr>                                                        
		                  </thead> 
<!-- 		                  <tbody> -->
...
<!-- 		                  </tbody> -->
	...
	<div class="col-md-12" id="getSearch_Letter" style="display: block;"> 	 
			<div  class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
		           <table id="getHeldTable" class="table no-margin table-striped  table-hover  table-bordered ">
		                 <thead>
		                       <tr>	
		                       		 <th style="text-align: center;" id="rankT">Ser No</th>	                         
			                         <th style="text-align: center;" id="rankT"> Rank </th>
...
<div class="col-md-12" id="getSearch_Letter" style="display: block;">	
	...
	<div class="col-md-12" id="getSearch_Letter" style="display: block;"> 	 
			<div  class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
		           <table id="getSearch_Letter" class="table no-margin table-striped  table-hover  table-bordered ">
		                 <thead>
		                     <tr>			                                       
...
<div id="obr">	
    <div class="col-md-12">
        <div class="row form-group">
            <div class="col-md-4">
                <label class="form-control-label"> Offr TOS since submission of last report :</label>
            </div>
            <div class="col-md-8">
                <textarea id="remarksforoffrstos" name="remarksforoffrstos" class="form-control autocomplete" maxlength="250" autocomplete="off"></textarea>
            </div>
        </div>
    </div>   
    ...
    <div class="col-md-12">
        <div class="row form-group">
            <div class="col-md-4">
                <label class="form-control-label"> Offr SOS since submission of last report : </label>
            </div>
            <div class="col-md-8">
                <textarea id="remarksforoffrssos" name="remarksforoffrssos" class="form-control autocomplete" maxlength="250" autocomplete="off"></textarea>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="row form-group">
            <div class="col-md-4">
                <label class="form-control-label"> Offrs under order of posting out : </label>
            </div>
            <div class="col-md-8">
                <textarea id="remarksforoffrspostout" name="remarksforoffrspostout" class="form-control autocomplete" maxlength="250" autocomplete="off"></textarea>
            </div>
        </div>
    </div>
    <div class="col-md-12">
        <div class="row form-group">
            <div class="col-md-4">
                <label class="form-control-label"> Offrs under order of posting in : </label>
            </div>
            <div class="col-md-8">
                <textarea id="remarksforoffrspostin" name="remarksforoffrspostin" class="form-control autocomplete" maxlength="250" autocomplete="off"></textarea>
            </div>
        </div>
    </div>
    <div class="col-md-12">
        <div class="row form-group">
            <div class="col-md-4">
                <label class="form-control-label"> Offrs under order of Retirement / Release/SSC Release:</label>
            </div>
            <div class="col-md-8">
                <textarea id="remarksforoffrsunderretire" name="remarksforoffrsunderretire" class="form-control autocomplete" maxlength="250" autocomplete="off"></textarea>
            </div>
        </div>
    </div>
    <div class="col-md-12">
    ...
    <div class="col-md-12">
        <div class="row form-group">
            ...
            <div class="col-md-8">
                <textarea id="distr" name="distr" class="form-control autocomplete" maxlength="250" autocomplete="off"></textarea>
            </div>
        </div>
    </div>                                                
</div>
			 ...
			 <div class="col-md-12 card-footer" align="center" class="form-control" id = "Savebtn" >
...
<div id="nullFieldsPopup" style="display: none; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); background-color: white; padding: 20px; border: 1px solid black; z-index: 1000; max-height: 80vh; overflow-y: auto;">
  
    <table id="nullFieldsTable" border="1">
        <thead>
            <tr>
                <th>Personnel No</th>
                <th>Casualty Which Not Fill</th>
            </tr>
        </thead>
        <tbody id="nullFieldsContent">
        </tbody>
    </table>
    <button onclick="closeNullFieldsPopup()">Close</button>
</div>
		</form:form>
...
<form:form action="${changeinrankUrl}" method="post" id="changeinrankForm"
	name="changeinrankForm" modelAttribute="id" target="result">
    <input type="hidden" name="comm_id1" id="comm_id1" value="0" />
</form:form>
	
		<c:url value="change_in_perosonnel_no_3008" var="changeinpersonnelnnoUrl" />
<form:form action="${changeinpersonnelnnoUrl}" method="post" id="changeinpersonnelnnoForm"
	name="changeinpersonnelnnoForm" modelAttribute="id" target="result">
    <input type="hidden" name="comm_id2" id="comm_id2" value="0" />
</form:form>
	
			<c:url value="Update_officier_3008" var="update_officier_3008_Url" />
<form:form action="${update_officier_3008_Url}" method="post" id="update_officier_3008_Form"
	name="update_officier_3008_Form" modelAttribute="id" target="result">
    <input type="hidden" name="comm_id3" id="comm_id3" value="0" />
</form:form>

	<c:url value="form_census_3008" var="form_census_3008_Url" />
<form:form action="${form_census_3008_Url}" method="post" id="form_census_3008_Form"
	name="form_census_3008_Form" modelAttribute="id" target="result">
...
<form:form action="${popup_mtrls}" method="get" id="form_add_officer3008_Form"
	name="form_add_officer3008_Form" modelAttribute="cont_comd4" target="result"> 
</form:form> 
	<c:url value="Posting_OutUrl_3008" var="popup_mtrls" />
<form:form action="${popup_mtrls}" method="get" id="Posting_OutUrl_3008_Form"
	name="Posting_OutUrl_3008_Form" modelAttribute="cont_comd5" target="result"> 
</form:form> 
...
// 			colAdj("getSearch_Letter");
			...
			if('${roleType}' == "DEO"){	
			 ...
			 if('${size}'!= "" || '${size}'!= 0 ){
				...
				mockjax1('getReEmployeeTable');
				table3 = dataTable11('getReEmployeeTable');
				mockjax1('getDeserterTable');
				table4 = dataTable11('getDeserterTable');
				mockjax1('getAuthHeldTable');
				table5 = dataTable11('getAuthHeldTable');
				mockjax1('getHeldTable');
				table6 = dataTable11('getHeldTable');
		...
		function Report_Save_fn() {
		  debugger;
		    ...
		    if (nullFieldsList.length > 0) {
		      ...
		      /*   var nullFieldsContent = '';
		        for (var i = 0; i < nullFieldsList.length; i++) {
		            nullFieldsContent += '<tr>';
		            nullFieldsContent += '<td>' + nullFieldsList[i].personnel_no + '</td>';
		            nullFieldsContent += '<td>' + nullFieldsList[i].null_fields.join(', ') + '</td>';
		            nullFieldsContent += '</tr>';
		        } */

		      //  $('#nullFieldsContent').html(nullFieldsContent);
		      //  $('#nullFieldsPopup').show();
		      
		      alert("ERROR : \n 1. Fields such as Appts, CDA Ac No & Med Cat are yet to be filled for Offrs. \n 2. Pl fill in all detls before approving / submiting. \n 3. IAFF 3008 cannot have blank data.");
		       ...
		       // var observation = $("#observation").val();
		    	...
		    	var remarksforoffrstos=$("#remarksforoffrstos").val();
				var remarksforoffrssos=$("#remarksforoffrssos").val();
				var remarksforoffrspostout=$("#remarksforoffrspostout").val();
				var remarksforoffrspostin=$("#remarksforoffrspostin").val();
				var remarksforoffrsunderretire=$("#remarksforoffrsunderretire").val();
				var remarks=$("#remarks").val();
				var remarksdistr=$("#distr").val();

		        $.post('Insert_3008?' + key + "=" + value, {
		            month: month,
		            year: year,
		           ...
		           // observation: observation,
		           	remarksforoffrstos:remarksforoffrstos,
																remarksforoffrssos:remarksforoffrssos,
																remarksforoffrspostout:remarksforoffrspostout,
																remarksforoffrspostin:remarksforoffrspostin,
																remarksforoffrsunderretire:remarksforoffrsunderretire,
		...
		function closeNullFieldsPopup() {
debugger;
		    $('#nullFieldsPopup').hide();		    
		}
...
function data(tableName){
	...
	if (tableName=="getServingTable") {
		...
		$.post("getServing3008Count?"+key+"="+value,{Search:Search,month:month,year:year,unit_sus_no:unit_sus_no},function(j) {
			FilteredRecords = j;
		});
		$.post("getServing3008?"+key+"="+value,{startPage:startPage,pageLength:pageLength,Search:Search,orderColunm:orderColunm,orderType:orderType
			...
			for (var i = 0; i < j.length; i++) {
				var sr = i+1;
				 ...
				 var fieldsToCheck = [
		                'appt', 'rank', 'name', 'personnel_no', 'cda_acc_no',
		                'parent_arm', 'med_cat', 'dt_of_tos', 'date_of_birth', 'date_of_commission',
		                'date_of_seniority', 'date_of_appointment'
		            ];
				 
				 for (var field of fieldsToCheck) {
		                if (j[i][field] === null || j[i][field] === undefined || j[i][field] === '') {
				   ...
				   if (nullFields.length > 0) {
		                nullFieldsList.push({
		                    personnel_no: j[i].personnel_no || 'Unknown',
		                    null_fields: nullFields
		                });
		            }
				
				jsondata.push([sr,j[i].action,j[i].appt,j[i].rank,j[i].name,j[i].personnel_no,j[i].cda_acc_no,
					j[i].parent_arm,j[i].med_cat,j[i].dt_of_tos,j[i].date_of_birth,j[i].date_of_commission,
					j[i].date_of_seniority,j[i].date_of_appointment
				]);
		...
		$.post("getSupernum3008Count?"+key+"="+value,{Search:Search,month:month,year:year,unit_sus_no:unit_sus_no},function(j) {
			FilteredRecords = j;
		});
		
		$.post("getSupernum3008?"+key+"="+value,{startPage:startPage,pageLength:pageLength,Search:Search,orderColunm:orderColunm,orderType:orderType
			,month:month,year:year,unit_sus_no:unit_sus_no},function(j) {
	...
	/////////// Re Employee/////
	else if (tableName=="getReEmployeeTable") {
	
		$.post("getReEmployee3008Count?"+key+"="+value,{Search:Search,month:month,year:year,unit_sus_no:unit_sus_no},function(j) {
			FilteredRecords = j;
		});
		
		$.post("getReEmployee3008?"+key+"="+value,{startPage:startPage,pageLength:pageLength,Search:Search,orderColunm:orderColunm,orderType:orderType
			,month:month,year:year,unit_sus_no:unit_sus_no},function(j) {
	...
	/////////// Deserter /////
		...
		$.post("getDeserter3008Count?"+key+"="+value,{Search:Search,month:month,year:year,unit_sus_no:unit_sus_no},function(j) {
			FilteredRecords = j;
		});
		
		$.post("getDeserter3008?"+key+"="+value,{startPage:startPage,pageLength:pageLength,Search:Search,orderColunm:orderColunm,orderType:orderType
			,month:month,year:year,unit_sus_no:unit_sus_no},function(j) {
			...
			for (var i = 0; i < j.length; i++) {
				...
				jsondata.push([sr,j[i].appt,j[i].rank,j[i].name,j[i].personnel_no,j[i].cda_acc_no,
					j[i].parent_arm,j[i].med_cat,j[i].dt_of_tos,j[i].date_of_birth,j[i].date_of_commission,
					j[i].date_of_seniority,j[i].date_of_appointment,j[i].dt_desertion
				]);
	...
	/////////// AuthHeld /////
// 	else if (tableName=="getAuthHeldTable") {
...
// 		$.post("getAuthHeld3008Count?"+key+"="+value,{Search:Search,month:month,year:year,unit_sus_no:unit_sus_no},function(j) {
// 			FilteredRecords = j;
// 		});
		
// 		$.post("getAuthHeld3008?"+key+"="+value,{startPage:startPage,pageLength:pageLength,Search:Search,orderColunm:orderColunm,orderType:orderType
// 			,month:month,year:year,unit_sus_no:unit_sus_no},function(j) {
// 				console.log(j[0])
// 			for (var i = 0; i < j.length; i++) {
// 				var sr = i+1;
// 				jsondata.push([sr,j[i].rank,j[i].base_auth,j[i].mod_auth,j[i].foot_auth,j[i].total_auth,
// 					j[i].total_held
// 				]);
				
				
// 				var totalAuth1= j[i].total_auth;
...
// 				}						
// 				sum_auth += parseInt(totalAuth);
// 				sum_held += parseInt(totalHeld);		
// 				}	
			
// 			var sur = parseInt(sum_held) - parseInt(sum_auth);
// 			var defi=0;
// 			if(sur >= 0){
// 				defi = sur;
// 				sur = 0;
...
// 		var sum_auth=0;
		...
		$.post("getAuth3008Count?"+key+"="+value,{Search:Search,month:month,year:year,unit_sus_no:unit_sus_no},function(j) {
			FilteredRecords = j;
		});
		
		$.post("getAuth3008?"+key+"="+value,{startPage:startPage,pageLength:pageLength,Search:Search,orderColunm:orderColunm,orderType:orderType
			,month:month,year:year,unit_sus_no:unit_sus_no},function(j) {
...
// 		var sum_auth=0;
		...
		$.post("getHeld3008Count?"+key+"="+value,{Search:Search,month:month,year:year,unit_sus_no:unit_sus_no},function(j) {
			FilteredRecords = j;
		});
		
		$.post("getHeld3008?"+key+"="+value,{startPage:startPage,pageLength:pageLength,Search:Search,orderColunm:orderColunm,orderType:orderType
			,month:month,year:year,unit_sus_no:unit_sus_no},function(j) {
