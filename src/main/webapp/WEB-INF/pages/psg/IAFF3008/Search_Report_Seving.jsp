...
<%-- <form:form name="" id="" action="" method="post" class="form-horizontal" commandName="">  --%>
	<div class="animated fadeIn">
	    <div class="container" align="center">
	    	<div class="card">
	    		<div class="card-header"><h5> IAFF - 3008: STR RETURN OFFRS   </h5> <h6 class="enter_by"></h6></div>
					...
					<strong style="color: red;">Note:- For Printing of Approved IAFF-3008 Data, Please click on PERSONNEL -> REPORTS -> IAFF 3008 REPORT</strong>
			<!-- <div class="col-md-6">
						<div class="row form-group">
						...
						<div class="card-footer" align="center" class="form-control" >
						 <input type="hidden" id="role" name="role" class="form-control ">
							<a href="Search_Report_Url" class="btn btn-success btn-sm" >Clear</a>  
			                 ...
			                 <c:if test="${list.size()==0}">
		                       ...
		                       <c:forEach var="item1" items="${list}" varStatus="num" >
		                      		 <tr >
										...
										<td style="text-align: center;">${item1[4]}&nbsp;&nbsp;&nbsp;${item1[5]}</td>
									</tr>
...
<c:url value="GetSearch_Report_3008" var="searchUrl" />
...
<form:form action="${downloadUrl}" method="post" id="downloadForm"
	...
	<input type="hidden" name="hd_remarks6" id="hd_remarks6" value="">
		...
		function editData(month,year,version,sus_no,status){		
			...
			$("#status5").val(status);
			$("#pagename").val("Search_Report_Serving");
