...
<%-- <form:form name="" id="" action="" method="post" class="form-horizontal" commandName="">  --%>
	<div class="animated fadeIn">
	    <div class="container" align="center">
	    	<div class="card">
	    		<div class="card-header"><h5> SEARCH IAFF - 3009</h5> <h6 class="enter_by"></h6></div>
					...
					<div class="col-md-12">
						...
						<div class="row form-group">
									...
									<strong style="color: red;">Note:- For Printing of Approved IAFF-3009 Data, Please click on PERSONNEL -> REPORTS -> IAFF 3009 REPORT</strong>
						...
						<div class="card-footer" align="center" class="form-control" >
						 <input type="hidden" id="role" name="role" class="form-control ">
							<a href="Search_Report_3009_Url" class="btn btn-success btn-sm" >Clear</a>  
...
<%-- <c:url value="delete_Report_3008" var="deleteUrl" /> --%>
<c:url value="delete_Report_3009" var="deleteUrl" />
...
<form:form action="${downloadUrl}" method="post" id="downloadForm"
	...
	<input type="hidden" name="hd_remarks6" id="hd_remarks6" value="">
		...
		function editData(month,year,version,sus_no,status){		
			...
			$("#status5").val(status);
			$("#pagename").val("Search_Report_3009_Url");
