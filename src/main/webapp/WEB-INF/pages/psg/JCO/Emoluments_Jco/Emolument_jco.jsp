...
<form:form name="Emolument_jco" id="Emolument_jco" action="Emolument_Action_jco"
	method="post" class="form-horizontal" commandName="Emolument_jco_CMD">
		...
		<div class="col-md-12" align="center">
			<div class="card">
						...
						<div class="col-md-6">
							<div class="row form-group">
								...
								<input type="hidden" id="jco_id" name="jco_id" >
									  <input type="text" id="army_no" name="army_no" class="form-control autocomplete" autocomplete="off"
				...
				<div class="card-footer" align="center" class="form-control">
					<a href="Emolument_jco" class="btn btn-success btn-sm">Clear</a>
