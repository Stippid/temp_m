						...
						<div class="row form-group">
							...
							<div class="col-md-8">
								<input type="text" id="army_no" name="army_no"
									...
									type="hidden" id="jco_id" name="jco_id"
									class="form-control autocomplete" autocomplete="off">
...
<!-- 									<option value="4">Closed</option> -->
			...
			<div class="card-footer" align="center" class="form-control">
				<a href="Search_Emoluments_jco" class="btn btn-success btn-sm">Clear</a>
...
<c:url value="getsearch_Emolument_jco" var="searchUrl" />
...
<c:url value="Edit_Emoluments_jco" var="updateUrl" />
...
<c:url value="Approve_Update_EmolumentsJco" var="updateUrl" />
