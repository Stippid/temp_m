...
<div class="container-fluid" align="center">
	<form:form name="jco_Personnel_Detail" id="jco_Personnel_Detail"
		action="jco_Personnel_Detail_action" method="post"
		class="form-horizontal" commandName="jco_Personnel_DetailCMD">
		<div class="animated fadeIn">
			<div class="container-fluid" align="center">
				<div class="card">
					<div class="card-header">
						<h5> APPROVE JCO/OR DATA</h5>
						<h6 class="enter_by">
					...
					<div class="card-body card-block">
						...
						<div class="col-md-12" style="display: none;">
							<div id="country_main" class="col-md-6">
								<div class="row form-group">
									<div class="col-md-4">
						...
						<div class="col-md-12">
							...
							<div class="col-md-6">
								<div class="row form-group">
									...
									<div class="col-md-8">
										<label id="unit_sus_no_hid" style="display: none"></label> <label
											id="unit_sus_no"></label>
									</div>
								</div>
							</div>
						</div>
            ...
            <div style="width: -webkit-fill-available;">
				...
				<div id="submit_data" class="card-footer" align="center"
					...
					<input type="button" class="btn btn-primary btn-sm" value="Approve"
						...
						onclick="if (confirm('Are You Sure You Want to Approve JCO Data?')){return Approved();}else{return false;}">

					
					<input type="button" class="btn btn-primary btn-sm" value="Reject" id="reject_btn" style="display: none"
						onclick="if (confirm('Are You Sure You Want to JCO/OR Reject Data?')){addRemarkModel('Reject',0)}else{return false;}">
...
<c:url value="Approve_JCOs" var="approveUrl" />
...
<c:url value="Reject_JCOs" var="rejectUrl" />
...
var marital_status="";
	$(document)
			.ready(function() {
				...
				/*		$.post("getSiblingsValue?" + key + "=" + value, {
							jco_id : jco_id
						}, function(j) {
							if (j != "") {
								...
								for (var i = 0; i < j.length; i++) {
									...
									if (sibling.toUpperCase() == "OTHER") {
										$('#other_sibling_ser' + i).attr(
												'readonly', false);
										$('#sibling_personal_no' + i).attr(
												'readonly', true);
									...
									$("#family_sibtbody").append(
											' <tr id="tr_sibling1'+x1+'">'
						...
						$.post("getSpouseValue?" + key + "=" + value, {
							...
							if (j != "") {
								...
								for (var i = 0; i < j.length; i++) {
									...
									$("#family_marrtbody").append(
											' <tr id="tr_marriage1'+x1+'">'
						...
						$.post("getDIV_WIDValue?" + key + "=" + value, {
							jco_id : jco_id
						}, function(j) {
							if (j != "") {
								var x1 = 0;
								for (var i = 0; i < j.length; i++) {
									...
									$("#family_divotbody").append(
											' <tr id="tr_divorce1'+x1+'">'
						...
						$.post('getSpouse_EducationData?' + key + "="+ value,{
								jco_id : jco_id,status : 0},
										function(j) {
											...
											if (v != 0) {
												...
												$("#spouse_quali_radioDiv")
														.show();
												$("#spouse_education_id234")
														.text("Yes");
												for (i; i < v; i++) {
													cor = i + 1;
													...
													if (j[i].div.toUpperCase() == "OTHERS"
															|| j[i].div
																	.toUpperCase() == "OTHER") {
														div = j[i].class_other;
													}
													$(
															"table#spouse_quali_table")
															.append(
																	'<tr id="tr_spouse_quali'+cor+'">'
																			+ '<td class="anm_srno">'
																			+ cor
																			+ '</td>'
																			+ '<td style="width: 10%;">'
