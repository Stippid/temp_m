...
<div class="container-fluid" align="center">
	<form:form name="jco_Personnel_Detail" id="jco_Personnel_Detail" action="jco_Personnel_Detail_action?${_csrf.parameterName}=${_csrf.token}" method="post" class="form-horizontal" commandName="jco_Personnel_DetailCMD">
			...
			<div class="card-header-inner" id="aa"
							...
							<div class="col-md-6">
									<div class="row form-group">
										...
										<div class="col-md-8" style="margin-left:-13px;">
											<select name="category" id="category"  class="form-control" onchange=fn_category_rank();category_type();>
					...
					<div class="col-md-12 form-group">
						 	...
						 	<div class="col-md-10">
									...
									<div class="col-md-4">
									<input type="text" id="army_no2" name="army_no2"  onchange="army_length(),Army_no_already_exist()" onkeyup="onChangeArmyNo(this)"   onkeypress="return isNumber(event);" class="form-control-sm form-control" autocomplete="off" placeholder="Enter No..." maxlength="9">
								</div>
								<div class="col-md-4">
									<input type="text" id="army_no3" name="army_no3" class="form-control-sm form-control" autocomplete="off"  maxlength="10" disabled="disabled" >
								</div>
									</div>
								</div> 
					     </div> 
							...
							<div class="row form-group">
								...
								<div class="col-md-8">
								 <select name="gender" id="gender"
									...
									<!--  <input type="radio" class="from-control" id="gender1" name= "gender" value="1">Male 
									<input type="radio" class="from-control" id="gender2" name="gender" value="2">Female  -->
								</div>
							</div>
						</div>												
							...
							<div class="col-md-12" >
								<div class="col-md-6" style="display: none;">
									<div class="row form-group">
										...
										<div class="col-md-8">
											<select name="marital_status" id="marital_status" class="form-control" onchange="getmarital_status_jco()">
												<option value="0">--Select--</option>
							...
							<div class="col-md-12">	              					
									...
									<div class="row form-group">
										...
										<div class="col-md-8">
										 <!--  <input type="text" id="arm_service" name="arm_service" class="form-control autocomplete" autocomplete="off"  > 	 -->
										    <select name="arm_service" id="arm_service" class="form-control"   onchange="chgarm(this,'regiment');" >
												<option value="0">--Select--</option>
								...
								<div class="col-md-6">
									<div class="row form-group">
										...
										<div class="col-md-8">
										 <!--  <input type="text" id="regiment" name="regiment" class="form-control autocomplete" autocomplete="off"  > 	 -->
										     <select name="regiment" id="regiment" class="form-control"   disabled="disabled">
												<option value="0">--Select--</option>
							...
							<table id="family_table" class="table-bordered "
								...
								<tbody data-spy="scroll" id="family_sibtbody"
									...
									<tr id="tr_sibling1">
										...
										<td style="width: 10%;">
											 <input type="text" name="sib_date_of_birth1" id="sib_date_of_birth1"
											maxlength="10" onclick="clickclear(this, 'DD/MM/YYYY')"
											class="form-control" style="width: 85%; display: inline;"
											onfocus="this.style.color='#000000'"
											onblur="clickrecall(this,'DD/MM/YYYY');validateDate_BackDate(this.value,this);"
...
<!-- 													 <a style="display:none;" class="btn btn-danger btn-sm" value="REMOVE" title="REMOVE" id="married_remove1" onclick="married_remove_fn(1);"><i -->
<!-- 													class="fa fa-trash"></i></a> -->
							...
							<table id="divorce_table" class="table-bordered "
								...
								<tbody data-spy="scroll" id="family_divotbody"
									...
									<tr id="tr_divorce1">
										...
										<td class="hide-action"><a style="display: none;" class="btn btn-primary btn-sm"
					...
					<!-- </div>
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="JCOS_ORURL" class="btn btn-success btn-sm">Clear</a> 
	...
	dt_of_tos1 =dt_of_tos.substring(6,10);
	  ...
	  var ar = $("#category option:selected").val();
		...
		if(ar == "JCO") {
		  ...
		  var rnk = $("#rank option:selected").text();
			   ...
			   var aadhar3 = $("input#adhar_number3").val();
					...
					if(pan_no.trim()=="") {
					 ...
					 if ($("input#enroll_dt").val() == "" || $("#enroll_dt").val() == "DD/MM/YYYY") {
					  ...
					  var rk = $("#rank option:selected").text();
	  ...
	  $.post('getjco_siblingData?' + key + "=" + value, {p_id:p_id }, function(j){
		...
		if(v!=0){
			...
			$("table#family_table").append('<tr align="center" id="tr_sibling'+x+'"><td style="width: 2%;">'+x+'</td>'
					+'<td style="width: 10%;"> <input type="sib_name'+x+'" id="sib_name'+x+'"  value="'+j[i].name+'" class="form-control-sm form-control"  onkeypress="return onlyAlphabets(event);" oninput="this.value = this.value.toUpperCase()" >'								
					//+'<td style="width: 10%;"> <input type="date" id="sib_date_of_birth'+x+'" name="sib_date_of_birth'+x+'" value="'+ParseDateColumn(j[i].date_of_birth)+'" class="form-control autocomplete" autocomplete="off" ></td>'	
					+ '<td style="width: 10%;"> '
					...
					+'<option value="${item[0]}" name="${item[1]}">${item[1]}</option>'
					+'</c:forEach></select></td>'
					+ '<td style="width: 15%;"><input type="text" ' + '	id="sib_adhar_number' + x + '" name="sib_adhar_number' + x + '" ' + '	class="form-control autocomplete" maxlength="14"  ' + '	onkeypress="return isAadhar(this,event); " autocomplete="off" value="' + j[i].aadhar_no + '" ></td> ' 
					+ '<td style="width: 15%;"> '
					+ '	<input type="text" id="sib_pan_no' + x + '" name="sib_pan_no' + x + '" ' + '	class="form-control autocomplete" autocomplete="off" ' + '	onchange=" isPAN(this); " ' + '	oninput="this.value = this.value.toUpperCase()" ' + '	maxlength="10" value="' + pan + '" > ' + '	</td> ' 
					...
					+'<td style="width: 10%;"><a class="btn btn-success btn-sm" value = "ADD" title = "ADD" id = "family_add'+x+'" style="display:none;" onclick="family_add_fn('+aller+');" ><i class="fa fa-plus"></i></a> </td>' 
		    		+'</tr>');
...
function category_type() {
	...
	if(a == "OR") {
		  $("#army_no1").attr('disabled',true);
		  $("#army_no1").val("0");
		  $("#army_no2").val("");
		  $("#army_no3").val("");
	} 
	else {
		$("#army_no1").attr('disabled',false);
		$("#army_no2").val("");
		$("#army_no3").val("");
		$("#intake").hide();
	}
					...
					.autocomplete({
						...
						change : function(event, ui) {
							if (ui.item) {
								...
								alert("Please Enter Approved Record Office SUS No.");
								document
			...
			susNoAuto.autocomplete({
						...
						change : function(event, ui) {
							if (ui.item) {
								...
								alert("Please Enter Approved Record Office");
								document
...
{
	var a = $("select#rank option:selected").text();
...
function army_length() {
	
   var arm2=$("input#army_no2").val();
   
   if (arm2.length< 1 || arm2.length>9) {
	alert("Please Enter Valid Army No..");
	$("input#army_no2").focus();
	return false;
} 
...
function married_add_fn(q) {
	...
	$("table#married_table").append('<tr id="tr_marriage' + marr + '">' + '<td class="marr_srno">' + marr_srno + '</td>' + '<td> <input type="text" id="maiden_name' + marr + '" name="maiden_name' + marr + '" onkeypress="return onlyAlphabets(event);" oninput="this.value = this.value.toUpperCase()"  class="form-control autocomplete" autocomplete="off" ></td>' + '<td> ' + ' <input type="text" name="marriage_date_of_birth' + marr + '" id="marriage_date_of_birth' + marr + '" maxlength="10"  onclick="clickclear(this, \'DD/MM/YYYY\')" class="form-control" style="width: 85%;display: inline;" ' + '	onfocus="this.style.color=\'#000000\'" onblur="clickrecall(this,\'DD/MM/YYYY\');validateDate_BackDate(this.value,this);" onkeyup="clickclear(this, \'DD/MM/YYYY\')" ' + '	onchange="clickrecall(this,\'DD/MM/YYYY\');validateDate_FutureDate(this.value,this);" aria-required="true" autocomplete="off" style="color: rgb(0, 0, 0);"  value="DD/MM/YYYY">' + '</td>'
		...
		+ '<a class="btn btn-danger btn-sm" value="REMOVE" title = "REMOVE" id = "married_remove' + marr + '" onclick="married_remove_fn(' + marr + ');"><i class="fa fa-trash"></i></a>' + '</td></tr>');
...
function divorce_add_fn(q) {
	...
	$("table#divorce_table").append('<tr id="tr_divorce' + divo + '">' + '<td class="divosr_no">' + divo + '</td>' 
...
function married_remove_fn(R) {
	 ...
	 aller=R-1
	 $("input#spouse_count").val(aller);
	 $("#married_add"+aller).show();
	 if(aller!=1){
	 $("#married_remove"+aller).show();
	 $("#married_add"+aller).show();
	 }	else{
		 $("#married_add"+aller).show();
	 }
