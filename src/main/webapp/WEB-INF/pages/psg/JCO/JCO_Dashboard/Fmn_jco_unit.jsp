...
<%--   						<datatables:table id="applicanttbl" url="getjcowiseDetail" serverSide="true" pipelining="true" pipeSize="3"	row="latlon" rowIdBase="applicant_id" rowIdPrefix="latlon_"  displayLength="10" lengthMenu="10,20,100,500,5000" jqueryUI="true"  --%>
...
<%-- 						</datatables:table>     --%>
		...
		<script>	
			...
			$(document).ready(function() {
				...
				watermarkreport(); 
				mockjax1('getSearchtable_unit_jco');
				table = dataTable11('getSearchtable_unit_jco');
...
var unit_name4 = '${unit_name50}';
				...
				if (tableName == "getSearchtable_unit_jco" ) {

					$.post("getSearchtabledata_jco__unit_count?" + key + "=" + value, {
						Search : Search,
					...
					$.post("getSearchtabledata_unit_jco?" + key + "=" + value, {
						startPage : startPage,
