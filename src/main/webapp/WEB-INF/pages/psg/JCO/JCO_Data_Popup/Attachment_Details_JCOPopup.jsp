...
<form:form action="Change_Of_AppointmentJCO" method="post" class="form-horizontal" commandName="Change_Of_AppointmentJCOCMD">
<div class="" id="Change_Of_AppointmentUrl" style="display: block;">
           <div class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
                 <table id="Change_Of_AppointmentUrl" class="table no-margin table-striped  table-hover  table-bordered ">        
                                        <thead style="text-align: center;">
                                                <tr>
                                                        <th style="font-size: 15px ;">Ser No</th>
                                                        <th style="font-size: 15px">Authority</th>
                                                        <th style="font-size: 15px">Date of Authority</th>
                                                        <th style="font-size: 15px">Movement Order Number</th>
                                                        <th style="font-size: 15px">Date of Movement Order</th>
                                                        <th style="font-size: 15px">Attached to (Unit SUS No)</th>
                                                        <th style="font-size: 15px">Unit Name</th>
                                                        <th style="font-size: 15px">Place</th>
                                                        <th style="font-size: 15px">From Date</th>
                                                        <th style="font-size: 15px">To Date</th>
                                                        <th style="font-size: 15px">Duration</th>
                                                        <th style="font-size: 15px">Reasons</th>  
...
$(document).ready(function() {
	 ...
	 colAdj("Change_Of_AppointmentUrl");
});
