...
<form:form action="Change_Of_AddressJCO" method="post" class="form-horizontal" commandName="Change_Of_AddressJCOCMD">
<div class="" id="Change_Of_AddressUrl" style="display: block;">
