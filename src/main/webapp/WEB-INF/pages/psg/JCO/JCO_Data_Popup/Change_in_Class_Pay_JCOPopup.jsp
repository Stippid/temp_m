...
<form:form action="Change_Of_ClassJCO" method="post" class="form-horizontal" commandName="Change_Of_ClassJCOCMD">
<div class="" id="Change_Of_ClassUrl" style="display: block;">
           <div class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
                 <table id="Change_Of_ClassUrl" class="table no-margin table-striped  table-hover  table-bordered ">        
                                        <thead style="text-align: center;">
                                                <tr>
                                                        <th style="font-size: 15px ;">Ser No</th>
                                                        <th style="font-size: 15px">Authority</th>
                                                        <th style="font-size: 15px">Date of Authority</th>
                                                        <th style="font-size: 15px">New Class(Pay)</th>
                                                         <th style="font-size: 15px">Date of Class(Pay)</th>
                                          ...
                                          <c:if test="${list.size()==0}">
								             <tr>
                                                ...
                                                <c:forEach var="item" items="${list}" varStatus="num" >
                                                        ...
                                                        <td style="font-size: 15px;">${item[7]}</td>                                                        </tr>
                                                </c:forEach>
                                        </tbody>
