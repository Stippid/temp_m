...
<form:form action="Change_Of_Contact_DetailsJCO" method="post" class="form-horizontal" commandName="Change_Of_Contact_DetailsJCOCMD">
<div class="" id="Change_Of_Contact_DetailsUrl" style="display: block;">
           <div class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
                 <table id="Change_Of_Contact_DetailsUrl" class="table no-margin table-striped  table-hover  table-bordered ">        
...
$(document).ready(function() {
	 ...
	 colAdj("Change_Of_Contact_DetailsUrl");
});
