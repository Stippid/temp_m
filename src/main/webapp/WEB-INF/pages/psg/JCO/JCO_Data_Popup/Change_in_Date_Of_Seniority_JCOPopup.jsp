...
<form:form action="Change_In_Date_Of_SeniorityJCO" method="post" class="form-horizontal" commandName="Change_In_Date_Of_SeniorityCMD">
<div class="" id="Change_In_Date_Of_SeniorityUrl" style="display: block;">
           <div class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
                 <table id="Change_In_Date_Of_SeniorityUrl" class="table no-margin table-striped  table-hover  table-bordered ">        
                                        <thead style="text-align: center;">
                                                <tr>
                                                        <th style="font-size: 15px ;">Ser No</th>
                                                        <th style="font-size: 15px">Authority</th>
                                                        <th style="font-size: 15px">Date of Authority</th>
                                                        <th style="font-size: 15px">New Date of Seniority</th>
                                                         <th style="font-size: 15px">Reason For The Change</th>
...
$(document).ready(function() {
	 ...
	 colAdj("Change_In_Date_Of_SeniorityUrl");
});
