...
<form:form action="Change_Of_Identity_CardJCO" method="post" class="form-horizontal" commandName="Change_Of_Identity_CardJCOCMD">
<div class="" id="Change_Of_Identity_CardUrl" style="display: block;">
           <div class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
                 <table id="Change_Of_Identity_CardUrl" class="table no-margin table-striped  table-hover  table-bordered ">        
                                        <thead style="text-align: center;">
                                                <tr>
                                                        <th style="font-size: 15px ;">Ser No</th>
								                        <th style="font-size: 15px">Id Card No</th>
														<th style="font-size: 15px">Eye Color</th>
														<th style="font-size: 15px">Hair Color</th>
														<th style="font-size: 15px">ID Marks</th>
														<th style="font-size: 15px">Issue Authority</th>
														<th style="font-size: 15px">Issue Date</th>
...
$(document).ready(function() {
	 ...
	 colAdj("Change_Of_Identity_CardUrl");
});
