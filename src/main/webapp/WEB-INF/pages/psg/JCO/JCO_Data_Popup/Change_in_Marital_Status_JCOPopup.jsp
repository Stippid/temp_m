...
<form:form action="Change_In_Marital_StatusUrl" method="post" class="form-horizontal" commandName="">
<div class="" id="Change_In_Marital_StatusUrl" style="display: block;"> 	 
			...
			<div class="card-header"><h5>Marital Details</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;"></span></h6></div>
		           <table id="Change_In_Marital_StatusUrl" class="table no-margin table-striped  table-hover  table-bordered">
...
$(document).ready(function() {
	 ...
	 colAdj("Change_In_Marital_StatusUrl");
