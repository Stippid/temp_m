...
<form:form action="Change_Of_NameJCO" method="post" class="form-horizontal" commandName="Change_Of_NameJCOCMD">
<div class="" id="Change_Of_NameUrl" style="display: block;">
           <div class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
                 <table id="Change_Of_NameUrl" class="table no-margin table-striped  table-hover  table-bordered ">        
                                        <thead style="text-align: center;">
                                                <tr>
                                                        ...
                                                        <th style="font-size: 15px">Middle Name</th>
