...
<form:form action="Change_Of_NokJCO" method="post" class="form-horizontal" commandName="Change_Of_NokJCOCMD">
<div class="" id="Change_Of_NokUrl" style="display: block;">
           <div class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
                 <table id="Change_Of_NokUrl" class="table no-margin table-striped  table-hover  table-bordered ">        
