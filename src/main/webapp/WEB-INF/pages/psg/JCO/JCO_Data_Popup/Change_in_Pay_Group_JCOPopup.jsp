...
<form:form action="Change_Of_Pay_GroupJCO" method="post" class="form-horizontal" commandName="Change_Of_Pay_GroupJCOCMD">
<div class="" id="Change_Of_Pay_GroupUrl" style="display: block;">
           <div class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
                 <table id="Change_Of_Pay_GroupUrl" class="table no-margin table-striped  table-hover  table-bordered ">        
                                        <thead style="text-align: center;">
                                                <tr>
                                                        <th style="font-size: 15px ;">Ser No</th>
                                                        <th style="font-size: 15px">Authority</th>
                                                        <th style="font-size: 15px">Date of Authority</th>
                                                        <th style="font-size: 15px">New Pay Group</th>
                                                         <th style="font-size: 15px">Date of New Pay Group</th>
