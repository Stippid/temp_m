...
<form:form action="Change_Of_RankJCO" method="post" class="form-horizontal" commandName="Change_Of_RankJCOCMD">
<div class="" id="Change_Of_RankUrl" style="display: block;">
           <div class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
                 <table id="Change_Of_RankUrl" class="table no-margin table-striped  table-hover  table-bordered ">        
                                        <thead style="text-align: center;">
                                                <tr>
                                                        ...
                                                        <th style="font-size: 15px">Date of Attestation</th>
                                                        <th style="font-size: 15px">Army No.</th>
