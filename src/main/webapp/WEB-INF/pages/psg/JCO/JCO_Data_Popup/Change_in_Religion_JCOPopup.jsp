...
<form:form action="Change_Of_ReligionJCO" method="post" class="form-horizontal" commandName="Change_Of_ReligionJCOCMD">
<div class="" id="Change_Of_ReligionUrl" style="display: block;">
           <div class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
                 <table id="Change_Of_ReligionUrl" class="table no-margin table-striped  table-hover  table-bordered ">        
