...
<form:form action="typeofpostJCO" method="post" class="form-horizontal" commandName="typeofpostCOCMD">
<div class="" id="Change_typeofpostingJCOUrl" style="display: block;">
           <div class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
                 <table id="Change_typeofpostingJCOUrl" class="table no-margin table-striped  table-hover  table-bordered ">        
                                        <thead style="text-align: center;">
                                                <tr>
                                                        <th style="font-size: 15px ;">Ser No</th>
                                                        <th style="font-size: 15px">Type of Posting</th>
...
$(document).ready(function() {
	 ...
	 colAdj("Change_typeofpostingJCOUrl");
});
