...
<form:form action="DeserterJCO" method="post" class="form-horizontal" commandName="Popup_Deserter_JCOCMD">

<div class="" id="DeserterUrl" style="display: block;"> 	 
			<div  class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
		           <table id="DeserterUrl" class="table no-margin table-striped  table-hover  table-bordered">
		                 <thead style="text-align: center;">
		                        <tr>
									<th style="font-size: 15px ;">Ser No</th>
                                    <th style="font-size: 15px">Arms Type</th>
                                    <th style="font-size: 15px">Date of Desertion</th>
                                    <th style="font-size: 15px">Arm Type Weapon</th>
                                    <th style="font-size: 15px">Date Recovered</th>
                                    <th style="font-size: 15px">Cause of Desertion </th>
                                    <th style="font-size: 15px">Ot Desertion Cause</th>
