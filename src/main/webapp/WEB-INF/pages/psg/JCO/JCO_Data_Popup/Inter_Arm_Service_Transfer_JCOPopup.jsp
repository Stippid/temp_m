...
<form:form action="Inter_Arm_Service_TransferJCOUrl" method="post" class="form-horizontal" commandName="Inter_Arm_Service_TransferJCOCMD">
<div class="" id="Inter_Arm_Service_TransferUrl" style="display: block;">
           <div class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
                 <table id="Inter_Arm_Service_TransferUrl" class="table no-margin table-striped  table-hover  table-bordered ">        
                                        <thead style="text-align: center;">
                                                <tr>
                                                        <th style="font-size: 15px ;">Ser No</th>
								                        <th style="font-size: 15px">Authority</th>
														<th style="font-size: 15px">Date of Authority</th>
														<th style="font-size: 15px">Parent Arm Service</th>
														<th style="font-size: 15px">Regt</th>
														<th style="font-size: 15px">Record Office</th>
														<th style="font-size: 15px">With Effect From</th>
...
$(document).ready(function() {
	 ...
	 colAdj("Inter_Arm_Service_TransferUrl");
});
