...
<form:form action="Non_Effective_Status_DetailsJCO" method="post" class="form-horizontal" commandName="Popup_Non_Effective_StatusJCOCMD">
<div class="" id="Non_Effective_Status_DetailsUrl" style="display: block;">
           <div class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
                 <table id="Non_Effective_Status_DetailsUrl" class="table no-margin table-striped  table-hover  table-bordered">        
                                        <thead style="text-align: center;">
                                                <tr>
                                                    <th style="font-size: 12px ;">Ser No</th>
                                                        <th style="font-size: 10px">Authority</th>
                                                        <th style="font-size: 10px">Date of Authority</th>
                                                        <th style="font-size: 10px">Cause of Non Effective</th>
                                                        <th style="font-size: 10px">Data of Non Effective</th>
...
$(document).ready(function() {
	 ...
	 colAdj("Non_Effective_Status_DetailsUrl");
});
