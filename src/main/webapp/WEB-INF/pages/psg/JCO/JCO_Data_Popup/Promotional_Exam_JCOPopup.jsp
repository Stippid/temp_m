...
<form:form action="Promotional_ExamJCO" method="post" class="form-horizontal" commandName="Popup_Promotional_ExamJCOCMD">
<div class="" id="Promotional_ExamUrl" style="display: block;">
           <div class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
                 <table id="Promotional_ExamUrl" class="table no-margin table-striped  table-hover  table-bordered">        
                                        <thead style="text-align: center;">
                                                <tr>
                                                    <th style="font-size: 15px ;">Ser No</th>
                                                        <th style="font-size: 15px">Authority</th>
                                                        <th style="font-size: 15px">Date of Authority</th>
                                                        <th style="font-size: 15px">Exam</th>
                                                        <th style="font-size: 15px">Other Exam</th>
                                                        <th style="font-size: 15px">Date of Passing</th>
