...
<form:form action="SSC_to_Permt_CommissionJCO" method="post" class="form-horizontal" commandName="SSC_to_Permt_CommissionJCOCMD">
<div class="" id="SSC_to_Permt_Commission_Url" style="display: block;">
<div class="card-header"><h5>INDIAN LANGUAGE</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;"></span></h6></div>
           <div class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
                 <table id="SSC_to_Permt_Commission_Url" class="table no-margin table-striped  table-hover  table-bordered">        
                                        <thead style="text-align: center;">
                                                <tr>
                                                   <th style="font-size: 15px;">Ser No</th>
													...
													<th style="font-size: 15px">Date of Permanent Commission</th>
...
$(document).ready(function() {
	 ...
	 colAdj("SSC_to_Permt_Commission_Url");
});
