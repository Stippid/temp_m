...
<form:form action="SecondmentJCO" method="post" class="form-horizontal" commandName="Popup_Secondment_JCOCMD">

<div class="" id="SecondmentUrl" style="display: block;"> 	 
			<div  class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
		           <table id="SecondmentUrl" class="table no-margin table-striped  table-hover  table-bordered">
		                 <thead style="text-align: center;">
		                        <tr>
                                    ...
                                    <th style="font-size: 15px"> Secondment With Effect From</th>
