...
<form:form action="Update_BPET_DetailsJCO" method="post" class="form-horizontal" commandName="Popup_Update_BPETDetailsJCOCMD">
<div class="" id="Update_BPET_DetailsUrl" style="display: block;">
           <div class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
                 <table id="Update_BPET_DetailsUrl" class="table no-margin table-striped  table-hover  table-bordered">        
                                        <thead style="text-align: center;">
                                                <tr>
                                                    <th style="font-size: 15px ;">Ser No</th>
                                                        <th style="font-size: 15px">BPET Result</th>
                                                        <th style="font-size: 15px">Other BPET Result</th>
                                                        <th style="font-size: 15px">BPET QTR</th>
                                                        <th style="font-size: 15px">Year</th>
                                                        <th style="font-size: 15px">Conducted at Unit</th>
