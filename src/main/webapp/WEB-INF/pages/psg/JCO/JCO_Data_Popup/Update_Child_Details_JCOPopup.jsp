...
<form:form action="Update_Child_detailsJCO" method="post" class="form-horizontal" commandName="Update_Child_detailsJCOCMD">
<div class="" id="Update_Child_detailsUrl" style="display: block;">
           <div class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
                 <table id="Update_Child_detailsUrl" class="table no-margin table-striped  table-hover  table-bordered ">        
...
$(document).ready(function() {
	 ...
	 colAdj("Update_Child_detailsUrl");
});
