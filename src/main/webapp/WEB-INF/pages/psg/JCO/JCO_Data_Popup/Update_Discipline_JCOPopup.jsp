...
<form:form action="Update_DisciplineJCOUrl" method="post" class="form-horizontal" commandName="Update_DisciplineJCOCMD">
<div class="" id="Update_DisciplineUrl" style="display: block;">
           <div class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
                 <table id="Update_DisciplineUrl" class="table no-margin table-striped  table-hover  table-bordered ">        
                                        <thead style="text-align: center;">
                                                <tr>
                                                        <th style="font-size: 15px ;">Ser No</th>
								                        <th style="font-size: 15px">Authority</th>
														<th style="font-size: 15px">Authority Date</th>
														<th style="font-size: 15px">Army Act Sec</th>
														<th style="font-size: 15px">Sub Clause</th>
														<th style="font-size: 15px">Trialed By</th>
														<th style="font-size: 15px">Punishment Awarded</th>
