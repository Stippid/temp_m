...
<form:form action="Update_Visit_Foriegn_DetailsJCO" method="post" class="form-horizontal" commandName="Popup_Update_VisitForiegnJCOCMD">
<div class="" id="Update_Visit_Foriegn_DetailsUrl" style="display: block;">
           <div class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
                 <table id="Update_Visit_Foriegn_DetailsUrl" class="table no-margin table-striped  table-hover  table-bordered">        
                                        <thead style="text-align: center;">
                                                <tr>
                                                    <th style="font-size: 15px ;">Ser No</th>
                                                        <th style="font-size: 15px">Country Visited</th>
                                                        <th style="font-size: 15px">From</th>
                                                        <th style="font-size: 15px">To</th>
                                                        <th style="font-size: 15px">Duration</th>
                                                        <th style="font-size: 15px">Purpose of Visit</th> 
...
$(document).ready(function() {
	 ...
	 colAdj("Update_Visit_Foriegn_DetailsUrl");
});
