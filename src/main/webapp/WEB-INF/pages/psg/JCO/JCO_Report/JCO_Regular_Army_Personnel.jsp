...
<form action="" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn">		
	    <div class="col-md-12" align="center">
    		<div class="card">
    			<div class="card-header"><h5>STR OF REGULAR ARMY PERSONNEL JCO/OR</h5></div>
		...
		<div class="col-md-12 container">
			...
			<div class="col-md-12">
	    		<div class="card">
	    			<div class="card-header"><h5>INFANTRY</h5></div>
				</div>
	        </div>
		<div class="col-md-12 container">
...
<c:url value="Download_Regular_ArmyPersonnel_query_jco" var="dwonloadUrl"/>
	<form:form action="${dwonloadUrl}" method="post" id="downloadForm" name="downloadForm" modelAttribute="">
</form:form>

<c:url value="Excel_Regular_ArmyPersonnel_query_jco" var="excelUrl" />
...
function data(tableName){
	if(tableName == "Regular_ArmyGorkha_reporttbl"){
		...
		$.post("getRegular_ArmyGorkha_ReportDataList_JCO?"+key+"="+value,{startPage:startPage,pageLength:pageLength,Search:Search,orderColunm:orderColunm,orderType:orderType,
		...
		$.post("getRegular_ArmyGorkha_TotalCount_jco?"+key+"="+value,{Search:Search,cont_comd:cont_comd,cont_corps:cont_corps,cont_div:cont_div,
	...
	if(tableName == "Regular_ArmyInfantary_reporttbl"){
		...
		var cont_comd=$("#cont_comd").val();
	 	...
	 	var s_auth = 0;var s_total = 0;
		$.post("getRegular_ArmyInfantary_ReportDataList_jco?"+key+"="+value,{startPage:startPage,pageLength:pageLength,Search:Search,orderColunm:orderColunm,orderType:orderType,
			cont_comd:cont_comd,cont_corps:cont_corps,cont_div:cont_div,cont_bde:cont_bde,unit_name:unit_name,sus_no:sus_no},function(j) {
		...
		$.post("getRegular_ArmyInfantary_TotalCount_jco?"+key+"="+value,{Search:Search,cont_comd:cont_comd,cont_corps:cont_corps,cont_div:cont_div,
			cont_bde:cont_bde,unit_name:unit_name,sus_no:sus_no},function(j) {
			FilteredRecords = j;
		});
	}
