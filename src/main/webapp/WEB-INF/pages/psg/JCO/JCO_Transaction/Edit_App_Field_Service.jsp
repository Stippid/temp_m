	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                  <input type="text" id="unit_name" name="unit_name" readonly class="form-control autocomplete" autocomplete="off" maxlength="50" >				
	              					...
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                   ...
						                   <input type="text" id="authority1" name="authority1" readonly class="form-control autocomplete" autocomplete="off" maxlength="100" onkeyup="return specialcharecter(this)"> 
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
<!-- 						                  <input type="Date" id="authority_date1" name="authority_date1" readonly class="form-control autocomplete" autocomplete="off" >
 -->						                
...
<div id="Field_Service" class="tabcontent"  style="display:block;">
  	<div class="card" style="margin-top:20px;">
									...
									<div class="card_body">
						<table id="fieldSerivice_table" class="table-bordered watermarked" style="margin-top:10px;width: 100%;">
...
<a href=Search_field_service_Jco_url id="searchlnk" class="btn btn-success btn-sm" style="display: none"></a>
...
// 	    $("#personnel_no3v").val('${personnel_no3}');
// 		$("#fd_service3v").val('${fd_service3}');
// 		$("#unit_location3v").val('${unit_location3}');
// 		$("#operation3v").val('${operation3}');
		
// 		$("#status3v").val('${status3}');
// 		$("#unit_name3v").val('${unit_name3}');
// 		$("#unit_sus_no3v").val('${unit_sus_no3}');
	
// 	if('${fd_services2}' != ""){
		
// 		$("#fd_service1").val('${fd_services2}');
// 		getFieldService();
// 		$("#bk_id").show();
...
// 	if(from_date!="" && to_date!="" && from_date!="DD/MM/YYYY" && to_date!="DD/MM/YYYY"){
// 		var joining=getformatedDate(from_date);
// 		var dishcharge=getformatedDate(to_date);
		
// 		if(dishcharge>=joining){
// 			var automonth=monthDiff(joining, dishcharge);
...
// 	if(d2.getFullYear() > d1.getFullYear() && d2.getMonth() < d1.getMonth()){
// 		months -= 12;
//     }
// 	months += (new Date(d2-d1)).getMonth();
...
function field_service_add_fn(q){
	...
	$("table#fieldSerivice_table").append('<tr id="tr_field_service'+qua+'">'
			...
			+'<td><input type="text" id="place'+qua+'" name="place'+qua+'" class="form-control autocomplete" autocomplete="off" onkeyup="return specialcharecter(this)"></td>'
...
// 	}
	...
	if ($("#from_date"+qs).val().trim() == ""&&  $("#from_date"+qs).val().trim() == "DD/MM/YYYY") {
			alert("Please Select From Date");
			$("#from_date"+qs).focus();
			return false;
	}
	if ($("#to_date"+qs).val() == "" && $('#ch_status'+qs).val() == 1) {
...
// 		var census_id=$("#census_id"+qs).val();
		  ...
		  $('.qua_srno').each(function(i, obj) {
	 			index=i+1;
				   ...
				   $.post('field_serviceApprUpdJCOAction?' + key + "=" + value, {personnel_no:personnel_no,fd_service:fd_service,from_date:from_date
					   ,to_date:to_date,duration:duration,place:place,unit_location:unit_location,operation:operation,authority:authority,authority_date:authority_date,ch_id:ch_id,jco_id:jco_id,p_id:p_id,ch_status:ch_status}, function(data){	   
...
// 	 var cat=$('#service_category').val(); 
	 var p_url="";
		 ...
		 p_url="getFieldServiceAppr_Jco?";
		 ch_url="getFieldServiceApprCh_Jco?";
	 ...
	 $.post(p_url + key + "=" + value, {q_id:q_id }, function(j){
			...
			if(v!=0){
				...
				$('select#fd_service1').val( j[0].fd_services );
			 	...
			 	var ad = ParseDateColumncommission(j[0].authority_date);
			  
				$('#p_id').val(j[0].id);
				  $('#authority1').val(j[0].authority);
				  $("#authority_date1").val(ad);
				//  $('#authority_date1').val(authority_date);
	 ...
	 var i=0;
	  $.post(ch_url + key + "=" + value, {p_id:p_id }, function(j){
		...
		$("table#fieldSerivice_table").append('<tr id="tr_field_service'+qu+'" '+GreenStyle+'>'
			...
			+'<td><input type="text" id="personnel_no'+qu+'" name="personnel_no'+qu+'" onkeypress="personnelNumber('+qu+');" value="' + j[i].personnel_no +'" class="form-control autocomplete" autocomplete="off" readonly></td>'
			...
			+'<td><input type="text" id="place'+qu+'" '+genread+' name="place'+qu+'" value="' + j[i].place +'" class="form-control autocomplete" autocomplete="off" onkeyup="return specialcharecter(this)"></td>'
