...
<form:form name="Edit_Marital_DiscordJCO" id="Edit_Marital_DiscordJCO" action="Edit_Marital_DiscordJCO_action?${_csrf.parameterName}=${_csrf.token}" method="post" class="form-horizontal" commandName="Edit_Marital_DiscordJCO_CMD"> 
	<div class="animated fadeIn">
		<div class="container" align="center">
			<div class="card">
				<div class="card-header">
					<h5>UPDATE MARITAL DISCORD JCO/OR</h5>
					<h6 class="enter_by">
							...
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="personnel_no" name="personnel_no" class="form-control autocomplete" autocomplete="off"
										onchange="personal_number()" onkeyup="return specialcharecter(this)" onkeypress="return AvoidSpace(event)" maxlength="12" > 
...
$(document).ready(function() {
	...
	$("#id").val('${Edit_Maritial_Discord_CMD.id}');
 	...
 	$("#dt_of_comp").val(ParseDateColumncommission('${Edit_Maritial_Discord_CMD.dt_of_complaint}'));
