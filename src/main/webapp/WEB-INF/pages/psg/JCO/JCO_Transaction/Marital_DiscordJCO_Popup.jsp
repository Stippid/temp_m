...
<form:form action="Popup_Marital_DiscordUrl" method="post" class="form-horizontal" commandName="Popup_Marital_DiscordCMD">

<div class="" id="Popup_Marital_DiscordUrl" style="display: block;"> 	 
