		...
		<div class="container" align="center">
			<div class="card">
				<div class="card-header">
					<h5>APPROVE MARITAL DISCORD CANCEL HISTORY JCO/OR</h5>
					<h6 class="enter_by">
...
<c:url value="Appr_Cancel_Maritial_Discord_JCO" var="cancelHisytoryUrl" />
...
<c:url value="Reject_Cancel_Maritial_Discord_JCO" var="RejcancelHisytoryUrl" />
...
<c:url value="RejectCh_Cancel_Maritial_DiscordJCO_dat" var="RejChcancelHisytoryUrl" />
