...
<div id="Field_Service" class="tabcontent"  style="display:block;">
  	<div class="card" style="margin-top:20px;">
									<label class=" form-control-label" style="color: red;"><strong
										style="color: red;">Note:</strong>       1)Individual Army NO can be Cancelled from cross icon in Action on Table. <br> 2)Whole Record can be Cancelled from Cancel All Button.</label>
											<div class="card_body">
...
<c:url value="Cancel_field_service_dat_Jco" var="cancelHisytoryUrl" />
...
<c:url value="Cancel_field_service_Child_Jco" var="cancelChildHisytoryUrl" />
