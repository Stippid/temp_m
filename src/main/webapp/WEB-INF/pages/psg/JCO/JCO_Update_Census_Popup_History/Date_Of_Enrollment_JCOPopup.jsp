...
<div class="" id="DateOfEnroll_History" style="display: block;"> 	 
			<div  class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
		           <table id="DateOfEnroll_History" class="table no-margin table-striped  table-hover  table-bordered">
		                 <thead style="text-align: center;">
		                       <tr>
			                        <th style="font-size: 15px ;">Ser No</th>
			                         <th style="font-size: 15px">Date of Enrollment</th>
			                 ...
			                 <c:if test="${list.size()==0}">
		                       ...
		                       <c:forEach var="item" items="${list}" varStatus="num" >
									<tr>
										...
										<td style="font-size: 15px;">${item.date_of_enrollment}</td>
