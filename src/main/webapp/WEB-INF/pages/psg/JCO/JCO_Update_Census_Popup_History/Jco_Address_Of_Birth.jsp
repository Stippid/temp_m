...
<div class="" id="Address_History" style="display: block;">
	<div class="watermarked" data-watermark="" id="divwatermark">
		<span id="ip"></span>
		<table id="Address_History"
			class="table no-margin table-striped  table-hover  table-bordered">
			<thead style="text-align: center;">
				<tr>
					<th style="font-size: 15px;">Ser No</th>
					<th style="font-size: 15px">Place of Birth</th>
			...
			<tbody>
				...
				<c:forEach var="item" items="${list}" varStatus="num">
					<tr>
						...
						<td style="font-size: 15px;">${item.place_of_birth}</td>
						<td style="font-size: 15px;">${item.country}</td>
						<td style="font-size: 15px;">${item.state}</td>
						<td style="font-size: 15px;">${item.district}</td>
