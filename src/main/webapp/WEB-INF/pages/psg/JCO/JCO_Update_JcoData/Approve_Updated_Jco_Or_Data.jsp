						...
						<div class="panel-heading">
							<div class="panel-heading">
								<h4 class="panel-title main_title" id="insp_div5">
									<b>APPROVE DATA OF UPDATED JCO/OR</b>
								</h4>
								<p>
								...
								<div class="col-md-3">
									<div class="row form-group">
										...
										<div class="col-md-8">
											...
											<input type="hidden" id="marital_status_hp" 
												name="marital_status_hp" class="form-control autocomplete"
												autocomplete="off">
										</div>
									</div>
								</div>
						...
						<div class="card-body card-block">
							...
							<div class="row">
								...
								<div class="col-md-12">
									...
									<div class="col-md-6" id="army_no1Div_label">
										<div class="row form-group">
											<div class="col-md-4">
												<label class=" form-control-label"> Army No </label> <input
													type="hidden" id="army_no_id" name="army_no_id" value="0"
													class="form-control-sm form-control" autocomplete="off"
													maxlength="10" readonly="readonly">
											</div>
											<div class="col-md-8">
												<label class=" form-control-label" id="army_nolb"></label>
							...
							<div class="card-footer" align="center" class="form-control">
								<!-- 	<input type="button"   class="btn btn-primary btn-sm" value="Reject" onclick="getChangeOfRank_Reject();">  -->
								<input type="button" class="btn btn-primary btn-sm"
									value="Reject"
									onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('getChangeOfRank_Reject',0)}else{return false;}">
								<!-- 			            	 <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){return getChangeOfRank_Reject();}else{return false;}"> -->
				...
				<div class="panel panel-default" id="b_div1">
					...
					<div id="collapse1b" class="panel-collapse collapse">
						<div class="card-body card-block">
									...
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												...
												<input type="hidden" id="na_authority" name="authority" onkeyup="return specialcharecter(this)"
													class="form-control autocomplete" autocomplete="off">
								...
								<div class="col-md-12">
									<div class="col-md-4">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<label class=" form-control-label" id="first_namelb"></label>
									...
									<div class="col-md-4">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<label class=" form-control-label" id="middle_namelb"></label>
									...
									<div class="col-md-4">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<label class=" form-control-label" id="last_namelb"></label>
							...
							<div class="card-footer" align="center" class="form-control">
								<!-- 		              		<input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="Change_of_name_Reject();"> -->
								<!--   <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){return Change_of_name_Reject();}else{return false;}">
		              	 -->
								<input type="button" class="btn btn-primary btn-sm"
									value="Reject"
									onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('Change_of_name_Reject',0)}else{return false;}">
							</div>
					...
					<div id="collapse1c" class="panel-collapse collapse">
						<div class="card-body card-block">
							...
							<div class="row">
									...
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												...
												<input type="hidden" id="appt_authority" onkeyup="return specialcharecter(this)"
										...
										<div class="row form-group">
											...
											<div class="col-md-8">
												...
												<select id="appointment_val" name="appointment_val"
													...
													<option value="0">--Select--</option>
													<c:forEach var="item"
														items="${getTypeofAppointementJCOList}" varStatus="num">
														<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
													</c:forEach>
												</select>
								...
								<!-- 								</div> -->
								<!-- 								<div class="col-md-8"> -->
								<!-- 									 <label    id="x_sus_no" name="x_sus_no"  -->
								...
								<!-- 								</div> -->
								<!-- 								<div class="col-md-8"> -->
								<!-- 									 <label    id="x_list_loc" name="x_list_loc" class=" autocomplete" >   </label> -->
								<!-- 								</div> -->
								<!-- 							</div> -->
								<!-- 						</div> -->
								<!-- 					</div> -->
							...
							<div class="card-footer" align="center" class="form-control">
								<!-- 		              		 <input type="button" name="save" class="btn btn-primary btn-sm" value="Reject" onclick="Appointment_Reject();" />		 -->
								<!--  <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){return Appointment_Reject();}else{return false;}">
		              	 -->
								<input type="button" class="btn btn-primary btn-sm"
									value="Reject"
									onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('Appointment_Reject',0)}else{return false;}">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="panel-group" id="accordion43">
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="col-md-6">
										<div class="row form-group">
											<div class="col-md-4">
												<label class=" form-control-label"> Issuing Authority (Unit/Fmn Name) </label>
											</div>
											<div class="col-md-8">
									...
									<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label">Issuing Authority Sus </label>
						                </div>
						                <div class="col-md-8">
						                <label id="issue_authority_susno" class=" form-control-label"></label>
						              <input type="hidden" id="issue_authority_susno" name="issue_authority_susno" class="form-control autocomplete" autocomplete="off" maxlength="20" onkeyup="return specialcharecter(this)">
								...
								<div class="col-md-12">
									<div class="col-md-6" id="other_id">
										<div class="row form-group">
											<div class="col-md-4">
												<label class=" form-control-label"> Hair Colour
													Other </label>
											</div>
											<div class="col-md-8">
									...
									<div class="col-md-6" id="other_eye">
										<div class="row form-group">
											<div class="col-md-4">
												<label class=" form-control-label"> Eye Colour Other
												</label>
											</div>
											<div class="col-md-8">
   			...
   			<div class="col-md-12">	              					
	              				...
	              				<!-- <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                  <label id="unit_sus_noidcard"></label>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                			                  <label id="unit_name_idcard"></label>
								...
								<div class="col-md-12">
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<img id="identity_image_preview" alt="JCO/OR Image"
							...
							<div class="card-footer" align="center" class="form-control">
								...
								<!--  <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){return IdentityCard_Reject();}else{return false;}">
		              	 -->

								<input type="button" class="btn btn-primary btn-sm"
									value="Reject"
									onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('IdentityCard_Reject',0)}else{return false;}">
							</div>
						</div>
					</div>
				</div>
					...
					<div id="collapse1e" class="panel-collapse collapse">
						<div class="card-body card-block">
									...
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												...
												<input type="hidden" id="rel_authority" name="authority"  onkeyup="return specialcharecter(this)"
													class="form-control autocomplete" autocomplete="off">
							...
							<div class="card-footer" align="center" class="form-control">
								...
								<!-- 			            <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){return Religion_Reject();}else{return false;}"> -->
								<input type="button" class="btn btn-primary btn-sm"
									value="Reject"
									onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('Religion_Reject',0)}else{return false;}">
					...
					<div id="collapse1f" class="panel-collapse collapse">
						<div class="card-body card-block">
											...
											<div class="row form-group">
												...
												<div class="col-md-8">
													<input type="hidden" id="marr_ch_id" name="marr_ch_id"
														...
														id="marriage_authority" class=" form-control-label"></label>
													<input type="hidden" id="marriage_authority"
														name="marriage_authority"
														class="form-control autocomplete" autocomplete="off">
												</div>
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="row form-group">
												...
												<div class="col-md-8">
													...
													<input type="hidden" id="marriage_date"
														name="marriage_date" class="form-control autocomplete"
														autocomplete="off">
												</div>
											</div>
										</div>
									...
									<div class="col-md-12">
										...
										<div class="col-md-6">
											<div class="row form-group">
												...
												<div class="col-md-8">
													<label id="marriage_nationality"
														class=" form-control-label"></label> <select
														name="marriage_nationality" id="marriage_nationality_val"
														class="form-control" style="display: none;">
														<option value="0">--Select--</option>
										...
										<div class="col-md-6">
											<div class="row form-group">
												...
												<div class="col-md-8">
													...
													<input type="hidden" id="divorce_date" name="divorce_date"
														class="form-control autocomplete" autocomplete="off">
												</div>
											</div>
										</div>
									...
									<div class="col-md-12" id="spouse_quali_radioDiv"
										...
										<label class=" form-control-label"
											style="margin-right: 100px;"><h4>Qualification
												Details of Spouse</h4></label> <label id="spouse_quali_radio"></label> <br>
							...
							<div class="card-footer" align="center" class="form-control">
								...
								<input type="button" class="btn btn-primary btn-sm"
									value="Reject"
									onclick="if (confirm('Are You Sure You Want to Reject Officer Data?')){addRemarkModel('Marital_Reject',0)}else{return false;}">
							</div>
						</div>
					</div>
				</div>
				...
				<div id="collapse1g" class="panel-collapse collapse">
						...
						<table id="m_children_details_table" class="table-bordered "
							...
							<thead style="color: white; text-align: center;">
								<tr>
									...
									<th style="width: 10%;">Aadhar Card No</th>
					...
					<div class="card-footer" align="center" class="form-control">
						<!-- 	<input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="Children_Reject();">		              
			             -->
						<!-- <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){return Children_Reject();}else{return false;}">
		              	  -->

						<input type="button" class="btn btn-primary btn-sm" value="Reject"
							onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('Children_Reject',0)}else{return false;}">
					...
					<div id="collapse1h" class="panel-collapse collapse">
						<div class="card-body card-block">
							...
							<div class="row">
										...
										<div class="row form-group">
											...
											<div class="col-md-8">
												<label id="nok_state" class=" form-control-label"></label> <select
													...
													onchange="fn_nok_state();" style="display: none">
													<option value="0">--Select--</option>
								...
								<div class="col-md-12">
									...
									<div class="col-md-6" id="nok_other_st" style="display: none;">
										<div class="row form-group">
											<div class="col-md-4">
												<label class=" form-control-label">STATE/PROVINCE
													OTHER</label>
											</div>
											<div class="col-md-8">
								...
								<div class="col-md-12">
									...
									<div class="col-md-6" id="nok_other_te" style="display: none;">
										<div class="row form-group">
											<div class="col-md-4">
												<label class=" form-control-label">TEHSIL/MUNICIPALITY
													OTHER</label>
											</div>
											<div class="col-md-8">
							...
							<div class="card-footer" align="center" class="form-control">
		              		 ...
		              		 -->
								<!--  <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){return Nok_details_Reject();}else{return false;}">
		              		    -->

								<input type="button" class="btn btn-primary btn-sm"
									value="Reject"
									onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('Nok_details_Reject',0)}else{return false;}">
							</div>
						</div>
					</div>
				</div>
										...
										<div class="row form-group">
											...
											<div class="col-md-8">
												...
												<select name="pre_country_val" id="pre_country_val"
													onchange="fn_pre_domicile_Country()" class="form-control"
													style="display: none;">
													<option value="0">--Select--</option>
													<c:forEach var="item" items="${getMedCountryName}"
														varStatus="num">
										...
										<div class="row form-group">
											...
											<div class="col-md-8">
												<label id="pre_domicile_district"
													...
													id="pre_domicile_district_val"
													onchange="fn_pre_domicile_district();" class="form-control"
													style="display: none;">
													<option value="0">--Select--</option>
													<c:forEach var="item" items="${getMedDistrictName}"
														varStatus="num">
										...
										<div class="row form-group">
											...
											<div class="col-md-8">
												...
												<select name="pre_domicile_tesil_val"
													...
													style="display: none;" onchange="fn_pre_domicile_tesil();">
										...
										<div class="row form-group">
											...
											<div class="col-md-8">
												...
												<select name="per_home_addr_state_val"
													...
													onchange="fn_per_home_addr_state();" style="display: none;">
													<option value="0">--Select--</option>
													<c:forEach var="item" items="${getMedStateName}"
														varStatus="num">
														<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
               	...
               	<label for="text-input" class=" form-control-label" style="color: #dd1a3e; margin-left:10px;">  Same as Permanent Address </label>
										...
										<div class="row form-group">
											...
											<div class="col-md-8">
												...
												<select name="pers_addr_country_val"
													...
													style="display: none;" onchange="fn_pers_addr_Country();">
													<option value="0">--Select--</option>
													<c:forEach var="item" items="${getMedCountryName}"
														varStatus="num">
														<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
										...
										<div class="row form-group">
											...
											<div class="col-md-8">
												...
												<select name="pers_addr_state_val" id="pers_addr_state_val"
													class="form-control" onchange="fn_pers_addr_state();"
													style="display: none;">
													<option value="0">--Select--</option>
													<c:forEach var="item" items="${getMedStateName}"
														varStatus="num">
										...
										<div class="row form-group">
											...
											<div class="col-md-8">
												...
												<select name="pers_addr_district_val"
													...
													onchange="fn_pers_addr_district();" style="display: none;">
													<option value="0">--Select--</option>
													<c:forEach var="item" items="${getMedDistrictName}"
														varStatus="num">
														<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
										...
										<div class="row form-group">
											...
											<div class="col-md-8">
												...
												<select name="pers_addr_tehsil_val"
													...
													style="display: none;" onchange="fn_pers_addr_tehsil();">
							 ...
							 <input type="radio" id="pers_addr_semi_urban" name="pers_addr_rural_urban" value="semi_urban" >Semi Urban</label>  -->
								...
								<div id="spouse_addressInnerdiv" style="display: none">
									<label for="text-input" class=" form-control-label"
										style="color: #dd1a3e; margin-left: 10px;"> If Family
									...
									<div class="col-md-12">
										...
										<div class="col-md-6">
											<div class="row form-group">
												...
												<div class="col-md-4">
													<label class=" form-control-label"
														id="spouse_addr_rural_urban"></label>
							...
							<div class="card-footer" align="center" class="form-control">
								<c:if test="${NonEffective == 0}">
									...
									<!--   <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){return Changeaddress_details_reject();}else{return false;}">
			         -->
									<input type="button" class="btn btn-primary btn-sm"
										value="Reject"
										onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('Changeaddress_details_reject',0)}else{return false;}">
								</c:if>
							</div>
				...
				<div id="collapse1j" class="panel-collapse collapse">
					<div class="card-body card-block">
						...
						<div class="card-footer" align="center" class="form-control">
							...
							<!-- <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){return CDA_Reject();}else{return false;}">              
			             -->

							<input type="button" class="btn btn-primary btn-sm"
								value="Reject"
								onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('CDA_Reject',0)}else{return false;}">
		...
		<div class="panel-group" id="accordion15">
			<div class="panel panel-default" id="k_div1">
				...
				<div id="collapse1k" class="panel-collapse collapse">
					...
					<div class="card-footer" align="center" class="form-control">
						<input type="button" class="btn btn-primary btn-sm" value="Reject"
							onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('getlanguage_Reject',0)}else{return false;}">
			...
			<div class="panel panel-default" id="l_div1">
				...
				<div id="collapse1l" class="panel-collapse collapse">
					...
					<div class="card-footer" align="center" class="form-control">
						...
						<!--  <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){return getQualification_Reject();}else{return false;}">    
			            -->

						<input type="button" class="btn btn-primary btn-sm" value="Reject"
							onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('getQualification_Reject',0)}else{return false;}">
				...
				<div id="collapse1m" class="panel-collapse collapse">
						...
						<div class="col-md-12">
							<div class="col-md-6">
								<div class="row form-group">
									...
									<div class="col-md-8">
										<label id="promo_exam_authority" name="promo_exam_authority"
											class=" autocomplete"> </label>
									</div>
								</div>
							</div>
							<div class="col-md-6">
								<div class="row form-group">
									...
									<div class="col-md-8">
										<label id="promo_exam_date_of_authority"
											name="promo_exam_date_of_authority"></label>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="card-footer" align="center" class="form-control">
						<!-- <input type="button"   class="btn btn-primary btn-sm" value="Reject"   onclick="get_promotion_Reject();"> 	
			              -->
						<!--  <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){return get_promotion_Reject();}else{return false;}">    
			             -->
						<input type="button" class="btn btn-primary btn-sm" value="Reject"
							onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('get_promotion_Reject',0)}else{return false;}">
		...
		<div class="panel-group" id="accordion98">
			<div class="panel panel-default" id="cc_div1">
				...
				<div id="collapse1cc" class="panel-collapse collapse">
					...
					<div class="card-footer" align="center" class="form-control">
						<input type="button" class="btn btn-primary btn-sm" value="Reject"
							onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('get_ArmyCourse_Reject',0)}else{return false;}">
				...
				<div id="collapse1p" class="panel-collapse collapse">
					...
					<div class="card-footer" align="center" class="form-control">
						<!-- <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="getBPET_Reject();">		              
			             -->
						<!--    
			            <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){return getBPET_Reject();}else{return false;}">    
			             -->

						<input type="button" class="btn btn-primary btn-sm" value="Reject"
							onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('getBPET_Reject',0)}else{return false;}">
		...
		<div class="panel-group" id="accordion19">
			<div class="panel panel-default" id="q_div1">
				...
				<div id="collapse1q" class="panel-collapse collapse">
					...
					<!-- </div> -->
					<div class="card-footer" align="center" class="form-control">
						<!-- 	<input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="getfiringStandard_Reject();">		              
			            -->
						<!--  <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){return getfiringStandard_Reject();}else{return false;}">    
			             -->
						<input type="button" class="btn btn-primary btn-sm" value="Reject"
							onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('getfiringStandard_Reject',0)}else{return false;}">
					...
					<div id="collapse1r" class="panel-collapse collapse">
						...
						<div class="card-footer" align="center" class="form-control">
							<!-- <input type="button"   class="btn btn-primary btn-sm" value="Reject" onclick="Allergy_Reject();"> 	
			            	 -->
							<!--  <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){return Allergy_Reject();}else{return false;}">    
			             -->
							<input type="button" class="btn btn-primary btn-sm"
								value="Reject"
								onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('Allergy_Reject',0)}else{return false;}">
					...
					<div id="collapse1s" class="panel-collapse collapse">
						<div class="card-body card-block">
							...
							<div class="card-footer" align="center" class="form-control">
								...
								<!-- 
			                         	 <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){return get_Medical_Reject();}else{return false;}"> 
			                 -->

								<input type="button" class="btn btn-primary btn-sm"
									value="Reject"
									onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('get_Medical_Reject',0)}else{return false;}">
...
<c:if test="${ForeignCountry != 0}">
	<div class="card" id="form_foreign_country">
				...
				<div id="collapse1t" class="panel-collapse collapse">
					...
					<div class="card-footer" align="center" class="form-control">
						<!-- <input type="button"   class="btn btn-primary btn-sm" value="Reject" onclick="Foregin_Country_Reject();"> 	
			            	 -->
						<!-- 	 <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){return Foregin_Country_Reject();}else{return false;}"> 
			                 -->
						<input type="button" class="btn btn-primary btn-sm" value="Reject"
							onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('Foregin_Country_Reject',0)}else{return false;}">
					</div>
			...
			<div class="panel panel-default" id="u_div1">
				...
				<div id="collapse1u" class="panel-collapse collapse">
					...
					<div class="card-footer" align="center" class="form-control">
						...
						<!-- 		 <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){return Award_Reject();}else{return false;}"> 
			                 -->
						<input type="button" class="btn btn-primary btn-sm" value="Reject"
							onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('Award_Reject',0)}else{return false;}">
					...
					<div id="collapse1v" class="panel-collapse collapse">
						...
						<div class="card-footer" align="center" class="form-control">
							<!-- <input type="button"   class="btn btn-primary btn-sm" value="Reject" onclick="BattleCasulity_Reject();"> 	
			            	 -->
							<!-- <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){return BattleCasulity_Reject();}else{return false;}"> 
			                 -->
							<input type="button" class="btn btn-primary btn-sm"
								value="Reject"
								onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('BattleCasulity_Reject',0)}else{return false;}">
						...
						<div class="card-body card-block">
								...
								<div class="col-md-12">
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<label id="disi_authority" class=" form-control-label">
												</label>
											</div>
										</div>
									</div>
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<label id="disi_authority_date" class=" form-control-label">
												</label>
											</div>
										</div>
									</div>
							...
							<div class="card-footer" align="center" class="form-control">
			                 ...
			                 -->
								...
								<input type="button" class="btn btn-primary btn-sm"
									value="Reject"
									onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('getDiscipline_Reject',0)}else{return false;}">


								<!-- <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){return getDiscipline_Reject();}else{return false;}"> 
			                 -->
							</div>
						</div>
					</div>
				...
				<div class="panel-heading">
					<h4 class="panel-title main_title blue" id="x_div5">
						<a class="droparrow collapsed" data-toggle="collapse"
							...
							onclick="divN(this)"><b>INTER ARM/SERVICE
								TRANSFER</b></a>
					</h4>
				</div>
				<div id="collapse1x" class="panel-collapse collapse">
					<div class="card-body card-block">
							...
							<div class="col-md-12">
								<div class="col-md-6">
									<div class="row form-group">
										...
										<div class="col-md-8">
											...
											<input type="hidden" id="inter_arm_authority"
								...
								<div class="col-md-6">
									<div class="row form-group">
										...
										<div class="col-md-8">
											<label id="inter_arm_date_of_authority"
												class=" form-control-label"></label> <input type="hidden"
												id="inter_arm_date_of_authority" name="date_of_authority"
												class="form-control autocomplete" autocomplete="off"
												maxlength="50">
										</div>
									</div>
							...
							<div class="col-md-12">
								<div class="col-md-6">
									<div class="row form-group">
										...
										<div class="col-md-8">
											<label id="inter_arm_parent_arm_service"
												class=" form-control-label"></label> <select
												name="parent_arm_service"
												id="inter_arm_parent_arm_service_val" class="form-control"
												style="display: none;">
												<option value="0">--Select--</option>
												<c:forEach var="item" items="${getParentArmList}"
													varStatus="num">
								...
								<div class="col-md-6">
									<div class="row form-group">
										<div class="col-md-4">
											<label class=" form-control-label"><strong
												style="color: red;"> </strong> Regt (INF) </label>
										</div>
										<div class="col-md-8">
											<label id="inter_arm_regt" class=" form-control-label"></label>
											<select name="regt" id="inter_arm_regt_val"
												class="form-control" style="display: none;">
												<option value="0">--Select--</option>
												<c:forEach var="item" items="${getRegtList}" varStatus="num">
													<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
							...
							<div class="col-md-12">
								<div class="col-md-6">
									<div class="row form-group">
										...
										<div class="col-md-8">
											<label class=" form-control-label"
												id="inter_arm_record_office_suslb"></label>
								...
								<div class="col-md-6">
									<div class="row form-group">
										<div class="col-md-4">
											<label class=" form-control-label"><strong
												style="color: red;"> </strong> Old Record Office Unit Name</label>
										</div>
										<div class="col-md-8">
											<label class=" form-control-label"
												id="inter_arm_record_office_unitlb"></label>
							...
							<div class="col-md-12">
								<div class="col-md-6">
									<div class="row form-group">
										<div class="col-md-4">
											<label class=" form-control-label"><strong
												style="color: red;">*</strong> New Record Office SUS</label>
										</div>
										<div class="col-md-8">

											<label class=" form-control-label" id="record_office_sus"></label>
										</div>
									</div>
								</div>
								<div class="col-md-6">
									<div class="row form-group">
										<div class="col-md-4">
											<label class=" form-control-label"><strong
												style="color: red;"> *</strong> New Record Office Unit Name
											</label>
										</div>
										<div class="col-md-8">

											<label class=" form-control-label" id="record_office_unit"></label>
										</div>
									</div>
								</div>
							</div>
							<div class="col-md-12">
								<div class="col-md-6">
									<div class="row form-group">
										...
										<div class="col-md-8">
											<label id="inter_arm_with_effect_from"
												class=" form-control-label"></label> <input type="hidden"
												id="inter_arm_with_effect_from" name="with_effect_from"
												class="form-control autocomplete" autocomplete="off"
												maxlength="50">
										</div>
									</div>
						...
						<div class="card-footer" align="center" class="form-control">
							...
							<!--      <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){return getInterArm_Reject();}else{return false;}"> 
			               
			               -->
							<input type="button" class="btn btn-primary btn-sm"
								value="Reject"
								onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('getInterArm_Reject',0)}else{return false;}">
						...
						<div class="card-body card-block">
							...
							<div class="row">
										...
										<div class="row form-group">
											...
											<div class="col-md-8">
												<label id="cause_of_non_effective"
													...
													style="display: none">
													<option value="0">--Select--</option>
													<c:forEach var="item" items="${getJcoOr_Non_EffectiveList}"
														varStatus="num">
														<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
													</c:forEach>
												</select>
										...
										<div class="row form-group">
											...
											<div class="col-md-8">
												<label id="perm_home_addr_country"
													...
													onchange="fn_perm_home_addr_Country()"
													style="display: none;">
													<option value="0">--Select--</option>
													<c:forEach var="item" items="${getMedCountryName}"
														varStatus="num">
										...
										<div class="row form-group">
											...
											<div class="col-md-8">
												...
												<select name="per_home_addr_state_val"
													...
													onchange="fn_prem_domicile_state()" style="display: none;">
													<option value="0">--Select--</option>
													<c:forEach var="item" items="${getMedStateName}"
														varStatus="num">
														<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
								...
								<div class="col-md-12">
									<div class="col-md-6" id="Ot_perm_hm_addr_con_div"
										...
										<div class="row form-group">
											<div class="col-md-4">
												<label class=" form-control-label">Others Country</label>
											</div>
											<div class="col-md-8">
												<label id="per_home_addr_country_other"
													name="per_home_addr_country_other"> </label>
											</div>
										</div>
									</div>
									<div class="col-md-6" id="Ot_perm_hm_addr_state_div"
										...
										<div class="row form-group">
											<div class="col-md-4">
												<label class=" form-control-label">Others
													State/Province</label>
											</div>
											<div class="col-md-8">
												<label id="per_home_addr_state_other"
													name="per_home_addr_state_other"> </label>
											</div>
										</div>
									</div>
								</div>
										...
										<div class="row form-group">
											...
											<div class="col-md-8">
												<label id="perm_home_addr_district"
													...
													onchange="fn_prem_domicile_district()"
													style="display: none;">
													<option value="0">--Select--</option>
													<c:forEach var="item" items="${getMedDistrictName}"
														varStatus="num">
								...
								<div class="col-md-12">
									<div class="col-md-6" id="Ot_perm_hm_addr_dis_div"
										...
										<div class="row form-group">
											<div class="col-md-4">
												<label class=" form-control-label">Others District</label>
											</div>
											<div class="col-md-8">
												<label id="per_home_addr_district_other"
													name="per_home_addr_district_other"> </label>
											</div>
										</div>
									</div>
									<div class="col-md-6" id="Ot_perm_hm_addr_teh_div"
										...
										<div class="row form-group">
											<div class="col-md-4">
												<label class=" form-control-label">Others
													Tehsil/Municipality</label>
											</div>
											<div class="col-md-8">
												<label id="per_home_addr_tehsil_other"
													name="per_home_addr_tehsil_other"></label>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-md-12">
									...
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<label for="lbl_perm_home_addr_rural" id="perm_home_addr_non"></label>
						 ...
						 <input type="radio" id="per_border_area" name="border_area" value="yes"   >Yes</label> 
							...
							<div class="card-footer" align="center" class="form-control">
			            	 ...
			            	 -->
								<!--  <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){return NonEffective_Reject();}else{return false;}"> 
			               
			                 -->
								<input type="button" class="btn btn-primary btn-sm"
									value="Reject"
									onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('NonEffective_Reject',0)}else{return false;}">
				...
				<div class="panel panel-default" id="dd_div1">
					...
					<div id="collapse1dd" class="panel-collapse collapse">
						<div class="card-body card-block">
			             ...
			             -->
								<!--     <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){return Deserter_Reject();}else{return false;}"> 
			            -->
								<input type="button" class="btn btn-primary btn-sm"
									value="Reject"
									onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('Deserter_Reject',0)}else{return false;}">
			...
			<div class="panel-group" id="accordion8">
				<div class="panel panel-default" id="ee_div1">
					...
					<div id="collapse1ee" class="panel-collapse collapse">
			            ...
			            -->
							<!--    <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){return CSD_Reject();}else{return false;}"> 
			             -->
							<input type="button" class="btn btn-primary btn-sm"
								value="Reject"
								onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('CSD_Reject',0)}else{return false;}">
				...
				<div class="panel panel-default" id="ff_div16">
					<div class="panel-heading">
						<h4 class="panel-title main_title green" id="ff_div5">
							<a class="droparrow collapsed" data-toggle="collapse"
								data-parent="#accordion17" href="#" id="ff_final"
								onclick="divN(this)"><b>CHANGE IN TRADE</b></a>
						</h4>
					</div>
					<div id="collapse1ff" class="panel-collapse collapse">
						<div class="card-body card-block">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<label class=" form-control-label" id="td_authority"></label>
									...
									<div class="col-md-6">
										<div class="row form-group">
											...
											onchange="clickrecall(this,'DD/MM/YYYY');validateDate_FutureDate(this.value,this);" aria-required="true" autocomplete="off" style="color: rgb(0, 0, 0);" > -->
												...
												<label class=" form-control-label" id="td_date_authority"></label>
								...
								<div class="col-md-12">
									...
									<div class="col-md-6">
										<div class="row form-group">
											<div class="col-md-4">
												<label class=" form-control-label"> New Trade</label>
											</div>
											<div class="col-md-8">

												<label id="trade"> </label> <select name="trade_val"
													id="trade_val" class="form-control" style="display: none;">
													<option value="-1">--Select--</option>
													<c:forEach var="item" items="${getTradeList}"
														varStatus="num">
														<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
													</c:forEach>
												</select>
								...
								<div class="col-md-12">
									...
									<div class="col-md-6">
										<div class="row form-group">
											<div class="col-md-4">
												<label class=" form-control-label"> Date of Change
													of Trade</label>
											</div>
											<div class="col-md-8">

												<label id="date_of_trade"> </label>
							...
							<div class="card-footer" align="center" class="form-control">
								<!-- <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="Change_Trade_Reject();">
			             -->
								<!--  <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){return Change_Trade_Reject();}else{return false;}"> 
			              -->
								<input type="button" class="btn btn-primary btn-sm"
									value="Reject"
									onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('Change_Trade_Reject',0)}else{return false;}">
				...
				<div class="panel panel-default" id="gg_div16">
					<div class="panel-heading">
						<h4 class="panel-title main_title green" id="gg_div5">
							<a class="droparrow collapsed" data-toggle="collapse"
								data-parent="#accordion17" href="#" id="gg_final"
								onclick="divN(this)"><b>CHANGE IN CLASS (PAY)</b></a>
						</h4>
					</div>
					<div id="collapse1gg" class="panel-collapse collapse">
						<div class="card-body card-block">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<label id="cla_authority"> </label> <input type="hidden"
													id="cla_id" name="cla_id" value="0" class="form-control"
													autocomplete="off">
											</div>
										</div>
									</div>
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<label id="cla_date_authority"> </label>
								...
								<div class="col-md-12">
									...
									<div class="col-md-6">
										<div class="row form-group">
											<div class="col-md-4">
												<label class=" form-control-label"> New Class(PAY)</label>
											</div>
											<div class="col-md-8">
												<label id="cla_class"></label> <select name="cla_class_val"
													id="cla_class_val" class="form-control"
													style="display: none;">
													<option value="-1">--Select--</option>
													<c:forEach var="item" items="${getClassPayList}"
														varStatus="num">
														<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
													</c:forEach>
												</select>
								...
								<div class="col-md-12">
									...
									<div class="col-md-6">
										<div class="row form-group">
											<div class="col-md-4">
												<label class=" form-control-label"> Date of New
													Class(PAY)</label>
											</div>
											<div class="col-md-8">

												<label id="date_of_class"></label>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="card-footer" align="center" class="form-control">
								<!--  <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="Class_Pay_Reject();">		              
			             -->
								<!--  <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){return Class_Pay_Reject();}else{return false;}"> 
			              -->

								<input type="button" class="btn btn-primary btn-sm"
									value="Reject"
									onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('Class_Pay_Reject',0)}else{return false;}">
				...
				<div class="panel panel-default" id="hh_div16">
					<div class="panel-heading">
						<h4 class="panel-title main_title green" id="hh_div5">
							<a class="droparrow collapsed" data-toggle="collapse"
								data-parent="#accordion17" href="#" id="hh_final"
								onclick="divN(this)"><b>CHANGE IN PAY GROUP</b></a>
						</h4>
					</div>
					<div id="collapse1hh" class="panel-collapse collapse">
						<div class="card-body card-block">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<label id="gp_authority"></label> <input type="hidden"
													id="gp_id" name="gp_id" value="0" class="form-control"
													autocomplete="off">
											</div>
										</div>
									</div>
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<label id="gp_date_authority"></label>
											</div>
										</div>
									</div>
								</div>
								<div class="col-md-12">
									...
									<div class="col-md-6">
										<div class="row form-group">
											<div class="col-md-4">
												<label class=" form-control-label"> NEW PAY GROUP</label>
											</div>
											<div class="col-md-8">
												<label id="gp_group"></label> <select name="gp_group_val"
													id="gp_group_val" class="form-control"
													style="display: none;">
													<option value="-1">--Select--</option>
													<c:forEach var="item" items="${getPayGroupList}"
														varStatus="num">
														<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
													</c:forEach>
												</select>
								...
								<div class="col-md-12">
									...
									<div class="col-md-6">
										<div class="row form-group">
											<div class="col-md-4">
												<label class=" form-control-label"> Date of New PAY
													GROUP</label>
											</div>
											<div class="col-md-8">
												<label id="date_of_group"></label>
							...
							<div class="card-footer" align="center" class="form-control">
								<!--  <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="pay_group_reject();">		              
			            -->
								<!-- <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){return pay_group_reject();}else{return false;}"> 
			              -->
								<input type="button" class="btn btn-primary btn-sm"
									value="Reject"
									onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('pay_group_reject',0)}else{return false;}">
				...
				<div class="panel panel-default" id="ii_div16">
					<div class="panel-heading">
						<h4 class="panel-title main_title green" id="ii_div5">
							<a class="droparrow collapsed" data-toggle="collapse"
								data-parent="#accordion17" href="#" id="ii_final"
								onclick="divN(this)"><b>CHANGE IN DATE OF
									SENIORITY</b></a>
						</h4>
					</div>
					<div id="collapse1ii" class="panel-collapse collapse">
						<div class="card-body card-block">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<label id="se_authority"></label> <input type="hidden"
													id="se_id" name="se_id" value="0" class="form-control"
													autocomplete="off">
											</div>
										</div>
									</div>
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<label id="se_date_authority"></label>
											</div>
										</div>
									</div>
								</div>
								<div class="col-md-12">
									<div class="col-md-6">
										<div class="row form-group">
											<div class="col-md-4">
												<label class=" form-control-label">Old Date of
													Seniority</label>
											</div>
											<div class="col-md-8">
									...
									<div class="col-md-6">
										<div class="row form-group">
											<div class="col-md-4">
												<label class=" form-control-label"> New Date of
													Seniority</label>
											</div>
											<div class="col-md-8">
								...
								<div class="col-md-12">
									...
									<div class="col-md-6">
										<div class="row form-group">
											<div class="col-md-4">
												<label class=" form-control-label"> Reason for the
													Change</label>
											</div>
											<div class="col-md-8">
												<label id="reason_for_change"></label>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="card-footer" align="center" class="form-control">
								<!-- <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="seniority_reject();">		              
			             -->
								<!--  <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){return seniority_reject();}else{return false;}"> 
			              -->
								<input type="button" class="btn btn-primary btn-sm"
									value="Reject"
									onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('seniority_reject',0)}else{return false;}">
				...
				<div class="panel panel-default" id="jj_div16">
					<div class="panel-heading">
						<h4 class="panel-title main_title green" id="jj_div5">
							<a class="droparrow collapsed" data-toggle="collapse"
								data-parent="#accordion17" href="#" id="jj_final"
								onclick="divN(this)"><b>ATTACHMENT DETAILS</b></a>
						</h4>
					</div>
					<div id="collapse1jj" class="panel-collapse collapse">
						<div class="card-body card-block">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<label id="att_authority"></label> <input type="hidden"
													id="att_id" name="att_id" value="0" class="form-control"
													autocomplete="off">
											</div>
										</div>
									</div>
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<label id="att_date_authority"></label>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-md-12">
									<div class="col-md-6">
										<div class="row form-group">
											<div class="col-md-4">
												<label class=" form-control-label"> Movement Order
													Number</label>
											</div>
											<div class="col-md-8">
												<label id="att_movement_number"></label>
											</div>
										</div>
									</div>
									<div class="col-md-6">
										<div class="row form-group">
											<div class="col-md-4">
												<label class=" form-control-label"> Date of Movement
													Order</label>
											</div>
											<div class="col-md-8">
												<label id="att_date_of_move"></label>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-md-12">
									...
									<div class="col-md-6">
										<div class="row form-group">
											<div class="col-md-4">
												<label class=" form-control-label"> Attached to
													(Unit SUS No)</label>
											</div>
											<div class="col-md-8">
												<label id="att_sus_no"> </label>
											</div>
										</div>
									</div>
								...
								<div class="col-md-12" style="font-size: 15px;">
									<label for="text-input" class=" form-control-label"
										style="color: #dd1a3e; margin-left: 10px;"><u>Period
											of Attachment</u> </label>
								</div>
								...
								<div class="col-md-12">
									...
									<div class="col-md-6">
										<div class="row form-group">
											<div class="col-md-4">
												<label class=" form-control-label"> Reasons</br>(Med/Legal/Official/Adm
													etc...)
												</label>
											</div>
											<div class="col-md-8">
												<label id="att_reasons"> </label>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="card-footer" align="center" class="form-control">
								<!--  <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="validate_attachment_reject();">		              
			            -->
								<!--   <input type="button" class="btn btn-primary btn-sm" value="Reject" onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){return validate_attachment_reject();}else{return false;}"> 
			              -->

								<input type="button" class="btn btn-primary btn-sm"
									value="Reject"
									onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('validate_attachment_reject',0)}else{return false;}">
			...
			<div class="panel-group" id="accordion4">
				<div class="panel panel-default" id="pp_div1">
					<div class="panel-heading">
						<h4 class="panel-title main_title red" id="a_div5">
							<a class="droparrow collapsed" data-toggle="collapse"
								data-parent="#accordion17" href="#" id="pp_final"
								onclick="divN(this)"><b>CHANGE IN TYPE OF
									POSTING</b></a>
						</h4>
					</div>
					<div id="collapse1pp" class="panel-collapse collapse">
								...
								<div class="col-md-12">
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<input type="hidden" id="ch_pp_id" name="ch_pp_id" value="0"
													class="form-control" /> <label class=" form-control-label"
													id="type_of_posting"></label> <select name="post_val"
													id="post_val" class="form-control" style="display: none">
													<option value="-1">--Select--</option>
													<c:forEach var="item" items="${gettype_of_postingList}"
														varStatus="num">
														<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
													</c:forEach>
												</select>
			            ...
			            -->
			              ...
			              -->
								...
								<input type="button" class="btn btn-primary btn-sm"
									value="Reject"
									onclick="if (confirm('Are You Sure You Want to Reject JCO/OR Data?')){addRemarkModel('validate_post_reject',0)}else{return false;}">
...
<form:form name="Approve_JCO_Data" id="Approve_JCO_Data"
	action="Approve_JCO_DataAction" method="post" class="form-horizontal"
	commandName="Approve_JCO_DataCMD">
	<div class="animated fadeIn">
		<div class="card">
			<input type="hidden" id="rank_v" name="rank_v" value="0"
				class="form-control "> <input type="hidden" id="name_v"
				name="name_v" class="form-control "> <input type="hidden"
				id="dt_rank" name="dt_rank" class="form-control "> <input
				type="hidden" id="per_no" name="per_no" class="form-control ">
			<input type="hidden" id="type_of_comm_granted"
				name="type_of_comm_granted" class="form-control "> <input
				type="hidden" id="dt_seniority" name="dt_seniority"
				class="form-control "> <input type="hidden" id="dt_comm"
				name="dt_comm" class="form-control "> <input type="hidden"
				id="m_status" name="m_status" class="form-control "> <input
				type="hidden" id="relign" name="relign" class="form-control ">
			...
			<input type="hidden" id="jco_id" name="jco_id"
				...
				type="hidden" id="whetherJCOOR" name="whetherJCOOR"
				class="form-control autocomplete" autocomplete="off"> <input
				type="hidden" id="status" name="status" value="0"
				class="form-control autocomplete" autocomplete="off"> <input
				type="hidden" id="event" name="event" value="0"
				class="form-control autocomplete" autocomplete="off">
			<div class="panel-group" id="accordion">
				<div class="panel panel-default">
					...
					<div class="col-md-12" id="submit_a" align="center">
						...
						<input type="submit" class="btn btn-primary btn-sm"
							value="Approve"
							onclick="if (confirm('Are You Sure You Want to Approve JCO/OR Data?')){return true;}else{return false;}">
					</div>
				</div>
			</div>
		</div>
...
function getChangeOfRank_Reject(){
	 ...
	 $.post('getChangeOfRankJCOReject?' + key + "=" + value, {jco_id:jco_id,ch_r_id:ch_r_id,reject_remarks:reject_remarks}, function(j){
	 ...
	 var jco_id = '${jco_id}';
	  ...
	  $.post('change_of_name_JCOGetData?' + key + "=" + value, {jco_id:jco_id}, function(j){
		  if(j!=""){
				 ...
				 $("#first_namelb").text(j[0].first_name);
				 $("#middle_namelb").text(j[0].middle_name);
				 $("#last_namelb").text(j[0].last_name);
...
function Change_of_name_Reject(){
	 ...
	 var reject_remarks = $("#reject_remarks").val();
	 $.post('getChangeOfNameJCOReject?' + key + "=" + value, {jco_id:jco_id,name_id:name_id,reject_remarks:reject_remarks}, function(j){
	      if(j == "1"){
              alert("Data Rejected Successfully");
...
// 		var appname = $("#appointment_val option:selected").text();
...
function Appointment_Reject(){
	...
	var jco_id='${jco_id}';
	 ...
	 var reject_remarks = $("#reject_remarks").val();
	 $.post('getChangeOfAppointmentJCOReject?' + key + "=" + value, {jco_id:jco_id,appoint_id:appoint_id,reject_remarks:reject_remarks}, function(j){
	...
	var jco_id = '${jco_id}';
	  $.post('getIdentity_CardJCO?' + key + "=" + value, {jco_id:jco_id}, function(j){
			if(j!=0){
				 ...
				 $("#issue_authority").text(fn_getUnitnamefromSusIdcard(j[0].issue_authority));
				 $('#issue_authority_susno').text(j[0].issue_authority);
				 $("#unit_name_idcard").text(fn_getUnitnamefromSusHis(j[0].unit_sus_no));
				 $('#unit_sus_noidcard').text(j[0].unit_sus_no);
				 ...
				 $('#identity_image_preview').attr("src","censusIdentityJCOConvertpath?i_id="+j[0].id+"");
				 $("#hair_other").text(j[0].hair_other);
				 $("#eye_other").text(j[0].eye_other);
				 
					var text = $("#hair_colourselect option:selected").text();
...
function IdentityCard_Reject(){
	 ...
	 var reject_remarks = $("#reject_remarks").val();
	 $.post('getIdentitycardJCOReject?' + key + "=" + value, {jco_id:jco_id,card_id:card_id,reject_remarks:reject_remarks}, function(j){
	      if(j == "1"){
              alert("Data Rejected Successfully");
...
function TA_Status_Reject(){
	 ...
	 var ta_id = $("#ta_id").val();
	 var reject_remarks = $("#reject_remarks").val();
	 $.post('getTAStatusJCOReject?' + key + "=" + value, {jco_id:jco_id,ta_id:ta_id,reject_remarks:reject_remarks}, function(j){
	      if(j == "1"){
            alert("Data Rejected Successfully");
            $('#form_ta_status').hide();
    }else {
...
function Religion_Reject(){
	var jco_id='${jco_id}'; 
	 ...
	 var reject_remarks = $("#reject_remarks").val();
	 $.post('getReligionReject_jco?' + key + "=" + value, {jco_id:jco_id,rel_id:rel_id,reject_remarks:reject_remarks}, function(j){
	     if(j == "1"){
             alert("Data Rejected Successfully");
             $('#form_religion').hide();
     }else {
...
function Marital_Reject(){
	...
	var jco_id='${jco_id}';
	 ...
	 var reject_remarks = $("#reject_remarks").val();
	 $.post('getMaritalJCOReject?' + key + "=" + value, {jco_id:jco_id,marr_ch_id:marr_ch_id,reject_remarks:reject_remarks}, function(j){
	     if(j == "1"){
             alert("Data Rejected Successfully");
             $('#f_div1').hide();
     }else {
...
function getfamily_marriageDetails(){
	 ...
	 var jco_id='${jco_id}';
	 var event='${event}';
	  $.post('update_getfamily_marriageJCOData1?' + key + "=" + value, {event:event,jco_id:jco_id }, function(j){
...
//	 						  $('#mrgqualibtn_save').hide();
				...
				$('#separated_from_dt').text(convertDateFormate(j[0].separated_from_dt));
...
function Children_Reject(){
	var jco_id = '${jco_id}'; 
	 ...
	 /* var marital_event='${event}'; */
	/*  var marr_ch_id = $("#marr_ch_id").val(); */
	 $.post('getchildren_Reject_jco?' + key + "=" + value, {jco_id:jco_id,reject_remarks:reject_remarks}, function(j){
		  if(j == "1"){
	             alert("Data Rejected Successfully");
	             $('#g_div1').hide();
	     }else {
...
function Nok_details_Reject(){
	 ...
	 var reject_remarks = $("#reject_remarks").val();
	 $.post('getNOKReject_jco?' + key + "=" + value, {jco_id:jco_id,nok_id:nok_id,reject_remarks:reject_remarks}, function(j){
		    if(j == "1"){
	              alert("Data Rejected Successfully");
...
function Changeaddress_details_reject(){
	 ...
	 var reject_remarks = $("#reject_remarks").val();
	 $.post('getChangeAddressJCOReject?' + key + "=" + value, {jco_id:jco_id,addr_ch_id:addr_ch_id,reject_remarks:reject_remarks}, function(j){
             if(j == "1"){
	             alert("Data Rejected Successfully");
...
function CDA_Reject(){
	 ...
	 var reject_remarks = $("#reject_remarks").val();
	 $.post('GetCDA_Reject_jco?' + key + "=" + value, {jco_id:jco_id,cda_id:cda_id,reject_remarks:reject_remarks}, function(j){
		 if(j == "1"){
             alert("Data Rejected Successfully");
             $('#j_div1').hide();
...
function getlanguage_Reject(){
	 ...
	 $.post('getlanguage_Reject_jco?' + key + "=" + value, {jco_id:jco_id,reject_remarks:reject_remarks}, function(j){
...
function getQualification_Reject(){
	 ...
	 $.post('getQualification_JCOReject?' + key + "=" + value, {jco_id:jco_id,reject_remarks:reject_remarks}, function(j){
...
function getBPET_Reject(){
	 ...
	 $.post('getBPET_JCOReject?' + key + "=" + value, {jco_id:jco_id,reject_remarks:reject_remarks}, function(j){
		  if(j == "1"){
             alert("Data Rejected Successfully");
             $('#p_div1').hide();
           }else {
...
function getfiringStandard_Reject(){
	 var jco_id = '${jco_id}';
	 var reject_remarks = $("#reject_remarks").val();
	 $.post('getfirStan_Reject_jco?' + key + "=" + value, {jco_id:jco_id,reject_remarks:reject_remarks}, function(j){
...
function Foregin_Country_Reject(){
	 var jco_id='${jco_id}';
	 var reject_remarks = $("#reject_remarks").val();
	  $.post('getforeginCountry_Reject_jco?' + key + "=" + value, {jco_id:jco_id,reject_remarks:reject_remarks}, function(j){
		  if(j == "1"){
				 alert("Data Rejected Successfully.");
				 $("#form_foreign_country").hide();
			 }else{
				 alert("Data Not Rejected.");
			 }
	 });
...
function Award_Reject(){
	 var jco_id='${jco_id}';
	 var reject_remarks = $("#reject_remarks").val();
	  $.post('getaward_Reject_jco?' + key + "=" + value, {jco_id:jco_id,reject_remarks:reject_remarks}, function(j){
		  if(j == "1"){
				 alert("Data Rejected Successfully.");
...
function BattleCasulity_Reject(){
	 ...
	 var reject_remarks = $("#reject_remarks").val();
	  ...
	  $.post('getBattleCasulity_Reject_jco?' + key + "=" + value, {jco_id:jco_id,reject_remarks:reject_remarks}, function(j){
		  if(j == "1"){
	             alert("Data Rejected Successfully");
	...
	var jco_id = '${jco_id}';
	 ...
	 $.post('getInterArmJCO?' + key + "=" + value, {jco_id:jco_id }, function(j){
		  if(j!=""){
				...
				$('#record_office_unit').text(j[0].record_office_unit);
				$('#record_office_sus').text(j[0].record_office_sus);
				$('#p_id').val(j[0].id);
...
function getInterArm_Reject(){
	 ...
	 $.post('get_InterArmJCOReject?' + key + "=" + value, {jco_id:jco_id,ch_r_id:ch_r_id,reject_remarks:reject_remarks}, function(j){
		 if(j == "1"){
             alert("Data Rejected Successfully");
             $('#x_div1').hide();
           }else {
...
function get_non_eff_address_details(){
	...
	$.post('address_details_GetJCOData?' + key + "=" + value,{jco_id:jco_id }, function(j){
		...
		/* 	$("#perm_home_addr_country").val(j[0].permanent_country);
            ...
            var permanent= j[0].permanent_rural_urban_semi;
            if(permanent == "rural"){
                    $("#perm_home_addr_non").text("Rural");
             } 
            if(permanent == "urban"){
            	 $("#perm_home_addr_non").text("Urban");
             }
            if(permanent == "semi_urban")
            {
            	 $("#perm_home_addr_non").text("Semi Urban");
             }  
            var br= j[0].permanent_border_area;
            if(br == "yes"){
...
function NonEffective_Reject(){
	 ...
	 var reject_remarks = $("#reject_remarks").val();
	  ...
	  $.post('getNonEffective_JCOReject?' + key + "=" + value, {jco_id:jco_id,reject_remarks:reject_remarks}, function(j){
		   if(j == "1"){
	             alert("Data Rejected Successfully");
...
function getDiscipline_Reject(){
	 ...
	 $.post('get_DisciplineReject_jco?' + key + "=" + value, {jco_id:jco_id,ch_r_id:ch_r_id,reject_remarks:reject_remarks}, function(j){
...
function get_promotion_Reject(){
	 ...
	 $.post('getPromotionExamReject_jco?' + key + "=" + value, {jco_id:jco_id,reject_remarks:reject_remarks}, function(j){
...
function get_ArmyCourse_Reject(){
	 ...
	 $.post('getArmyCourse_JCOReject?' + key + "=" + value, {jco_id:jco_id,reject_remarks:reject_remarks}, function(j){
...
function Allergy_Reject(){
	 var jco_id = '${jco_id}';
	 var reject_remarks = $("#reject_remarks").val();
	 $.post('getAllergyReject_jco?' + key + "=" + value, {jco_id:jco_id,reject_remarks:reject_remarks}, function(j){
...
function get_Medical_Reject(){
	 ...
	 $.post('getMedical_Reject_jco?' + key + "=" + value, {jco_id:jco_id,reject_remarks:reject_remarks}, function(j){
...
function Deserter_Reject(){
	 ...
	 $.post('GetDeserter_Reject_jco?' + key + "=" + value, {jco_id:jco_id,des_ch_id:des_ch_id,reject_remarks:reject_remarks}, function(j){
...
function CSD_Reject(){
	 ...
	 $.post('getCSD_Reject_jco?' + key + "=" + value, {jco_id:jco_id,reject_remarks:reject_remarks}, function(j){
		  if(j == "1"){
	             alert("Data Rejected Successfully");
	             $('#forminspupdate1').hide();
	     }else {
	             alert("Data Not Rejected"); 
	     }
...
function fn_getUnitnamefromSusIdcard(sus_no){
	var un="";
	$.ajaxSetup({
		async : false
	});
...
function trade_details(){
	...
	var jco_id=$('#jco_id').val(); 
	  $.post('change_of_trade_JCOGetData?' + key + "=" + value, {jco_id:jco_id}, function(j){
		  if(j!=""){
			  $('#td_id').val(j[0].id);
				 $("#td_authority").text(j[0].td_authority);
				 $("#td_date_authority").text(convertDateFormate(j[0].td_date_authority));
				 $("#date_of_trade").text(convertDateFormate(j[0].date_of_trade));
				 $("#trade").val(j[0].trade);
				 $('#trade_val').val(j[0].trade);
			     $('#trade').text($( "#trade_val option:selected" ).text()); 
		  }
	  });
}	
function Change_Trade_Reject(){
	...
	var jco_id=$('#jco_id').val(); 
	 ...
	 $.post('getChangeOfTradeJCOReject?' + key + "=" + value, {jco_id:jco_id,td_id:td_id,reject_remarks:reject_remarks}, function(j){
		  if(j == "1"){
	             alert("Data Rejected Successfully");
	             $('#form_trade').hide();
	     }else {
...
function class_pay_details(){
	
	var jco_id=$('#jco_id').val(); 
	  $.post('change_class_pay_JCOGetData?' + key + "=" + value, {jco_id:jco_id}, function(j){
		  if(j!=""){
			    $('#cla_id').val(j[0].id);
				 $("#cla_authority").text(j[0].cla_authority);
				 $("#cla_date_authority").text(convertDateFormate(j[0].cla_date_authority));
				 $("#date_of_class").text(convertDateFormate(j[0].date_of_class));
				 $('#cla_class_val').val(j[0].cla_class);
			     $('#cla_class').text($( "#cla_class_val option:selected" ).text()); 
		  }
	  });
}	
function Class_Pay_Reject(){
	
	var jco_id=$('#jco_id').val(); 
	 var cla_id = $("#cla_id").val();
	 var reject_remarks = $("#reject_remarks").val();

	 $.post('getChangeOfClassPayJCOReject?' + key + "=" + value, {jco_id:jco_id,cla_id:cla_id,reject_remarks:reject_remarks}, function(j){
		 if(j == "1"){
             alert("Data Rejected Successfully");
             $('#form_class_pay').hide();
         }else {
...
function gorup_pay_details(){
	
	var jco_id=$('#jco_id').val(); 
	  $.post('change_pay_group_JCOGetData?' + key + "=" + value, {jco_id:jco_id}, function(j){
		  if(j!=""){
			  $('#gp_id').val(j[0].id);
				 $("#gp_authority").text(j[0].gp_authority);
				 $("#gp_date_authority").text(convertDateFormate(j[0].gp_date_authority));
				 $("#date_of_group").text(convertDateFormate(j[0].date_of_group));
				 $('#gp_group_val').val(j[0].gp_group);
			     $('#gp_group').text($( "#gp_group_val option:selected" ).text()); 
		  }
	  });
}	
function pay_group_reject(){
	...
	var jco_id=$('#jco_id').val(); 
	 ...
	 $.post('getChangeOfPayGroupJCOReject?' + key + "=" + value, {jco_id:jco_id,gp_id:gp_id,reject_remarks:reject_remarks}, function(j){
...
function seniority_details(){
	
	var jco_id=$('#jco_id').val(); 
	  $.post('change_seniority_JCOGetData?' + key + "=" + value, {jco_id:jco_id}, function(j){
		  if(j!=""){
			  $('#se_id').val(j[0].id);
				 $("#se_authority").text(j[0].se_authority);
				 $("#se_date_authority").text(convertDateFormate(j[0].se_date_authority));
				 $("#date_of_seniority").text(convertDateFormate(j[0].date_of_seniority));
				 $('#reason_for_change').text(j[0].reason_for_change);
		  }
	  });
}	
function seniority_reject(){
	 var jco_id=$('#jco_id').val(); 
	 var se_id = $("#se_id").val();
	 var reject_remarks = $("#reject_remarks").val();


	 $.post('getChangeOfSeniorityJCOReject?' + key + "=" + value, {jco_id:jco_id,se_id:se_id,reject_remarks:reject_remarks}, function(j){
		 if(j == "1"){
             alert("Data Rejected Successfully");
             $('#form_seniority').hide();
     }else {
...
//*************************************Start Attachment DETAIL*****************************//
 function get_attachment_details(){
	 ...
	 var i=0;
	  $.post('attachment_JCOGetData?' + key + "=" + value, {jco_id:jco_id }, function(j){
			...
			if(v!=0){
				$('#att_id').val(j[0].id);
				 $("#att_authority").text(j[0].att_authority);
				 $("#att_date_authority").text(convertDateFormate(j[0].att_date_authority));
				 $("#att_movement_number").text(j[0].att_movement_number);
				 $("#att_date_of_move").text(convertDateFormate(j[0].att_date_of_move)); 
				 $("#att_sus_no").text(j[0].att_sus_no);
				 $("#att_place").text(j[0].att_place);
				 $("#att_from").text(convertDateFormate(j[0].att_from));
				 $("#att_to").text(convertDateFormate(j[0].att_to));
				 $("#att_duration").text(j[0].att_duration);
				 $("#att_reasons").text(j[0].att_reasons);
				 
				 var sus_no = j[0].att_sus_no;
					if(sus_no!=""){
    		    		getunit(sus_no);
    		    	}
    		    	...
    		    	function getunit(val) {	
    		            $.post("getTargetUnitNameList?"+key+"="+value, {
    		            	sus_no : sus_no
    		    				   ...
    		    				   var length = j.length-1;
    		    	                   var enc = j[length].substring(0,16); 
    		    	                   $("#att_unit_name").text(dec(enc,j[0])); 
    		        }).fail(function(xhr, textStatus, errorThrown) {
    		        });
    		    }
 ...
 function validate_attachment_reject(){
	 var jco_id=$('#jco_id').val(); 
	 var att_id = $("#att_id").val();
	 var reject_remarks = $("#reject_remarks").val();


	 $.post('getAttachmentJCOReject?' + key + "=" + value, {jco_id:jco_id,att_id:att_id,reject_remarks:reject_remarks}, function(j){
		  if(j == "1"){
	             alert("Data Rejected Successfully");
...
function get_postingtype(){
	 ...
	 var i=0;
	  $.post('change_of_posting_JCOGetData?' + key + "=" + value, {jco_id:jco_id}, function(j){
			...
			if(v!=0){
				$('#ch_pp_id').val(j[i].id);
				// $("#type_of_posting").text(j[i].type_of_post);
				 $('#post_val').val( j[i].type_of_post );	
				 $('#type_of_posting').text($( "#post_val option:selected" ).text());
				
				
			}
	  });
}
 function validate_post_reject(){
	 var jco_id=$('#jco_id').val(); 
	 var ch_pp_id = $("#ch_pp_id").val();
	 var reject_remarks = $("#reject_remarks").val();


	 $.post('getChangeOfpostJCOReject?' + key + "=" + value, {jco_id:jco_id,ch_pp_id:ch_pp_id,reject_remarks:reject_remarks}, function(j){
		  if(j == "1"){
	             alert("Data Rejected Successfully");
