										...
										<div class="row form-group">
											...
											<div class="col-md-8">
												<input type="text" id="personnel_no" name="personnel_no" class="form-control autocomplete" autocomplete="off"  > 						                   
							               		...
							               		<input type="hidden" id="whetherJCOOR" name="whetherJCOOR" class="form-control autocomplete" autocomplete="off"  > 					                   							                 
					...
					<div id="collapse1a" class="panel-collapse collapse">
					 ...
					 <div class="col-md-12">	              					
	              		 ...
	              		 <div class="col-md-12">	              					
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                          <select name="rank" id="rank" class="form-control"  onchange="change_rankFN(this);" >
														<option value="0">--Select--</option>
	              				...
	              				<div class="col-md-6" id="attestationDiv" style="display:none">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong
										style="color: red;">* </strong> Date of Attestation </label>
						                </div>
						                <div class="col-md-8">
						                   <input type="text" name="date_of_attestation" id="date_of_attestation" maxlength="10"  onclick="clickclear(this, 'DD/MM/YYYY')" class="form-control" style="width: 93%;display: inline;"
											onfocus="this.style.color='#000000'" onblur="clickrecall(this,'DD/MM/YYYY');validateDate_BackDate(this.value,this);" onkeyup="clickclear(this, 'DD/MM/YYYY')" 
											onchange="clickrecall(this,'DD/MM/YYYY');validateDate_FutureDate(this.value,this);" aria-required="true" autocomplete="off" style="color: rgb(0, 0, 0);" >
						                </div>
						            </div>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                       <label class=" form-control-label" id="rank_reject_remarks"></label>		 
						                </div>
						            </div>
	              				</div>
	              			</div>
	              				<div class="col-md-12 form-group" id="army_no1Div_label">
								<div class="col-md-2">
									<label for="text-input" class=" form-control-label"><strong
										style="color: red;"> </strong>Army No</label>
										<input type="hidden" id="army_no_id" name="army_no_id" value="0" class="form-control-sm form-control" autocomplete="off"  maxlength="10" readonly="readonly" >
								</div>
								
						 	<div class="col-md-10">
								    <div class="row form-group">
								 
								    <div class="col-md-4" id="army_no1Div">
									<select id="army_no1" name="army_no1" class="form-control">
										<option value="0">--Select--</option>
									...
									<div class="col-md-4">
									<input type="text" id="army_no2" name="army_no2" onkeypress="return isNumber0_9Only(event)" onkeyup="onChangeArmyNo(this);"  class="form-control-sm form-control" autocomplete="off" placeholder="Enter No..." maxlength="9">
								</div>
								<div class="col-md-4">
						  ...
						  <div class="card-footer" align="center" class="form-control">
								<input type="button" class="btn btn-primary btn-sm" value="Update" onclick="validate_ChngofRank_save();"> 	
								<input type="button" class="btn btn-danger btn-sm" value="Delete" onclick="validate_ChngofRank_remove();">
			...
			<div class="panel-group" id="accordion5">
				<div class="panel panel-default" id="b_div1">
					...
					<div class="row">
						<div class="col-md-12">	              					
								...
								<div class="col-md-4">
									<div class="row form-group">
										...
										<div class="col-md-8">
											<input type="text" id="first_name" name="first_name" class="form-control autocomplete" autocomplete="off" 
							...
							<div class="col-md-12">	              						              				            				
	              					...
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                       <label class=" form-control-label" id="name_reject_remarks"></label>		 
						                </div>
						            </div>
	              				</div>              				
	              			</div>	
			            ...
			            <input type="button" class="btn btn-danger btn-sm" value="Delete" onclick="validate_Change_of_name_remove();">
			            </div> 	
						</div>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
										   <select  id="appointment" name="appointment" class="form-control" onchange=""  >
														<option value="0">--Select--</option>
														<c:forEach var="item" items="${getTypeofAppointementJCOList}" varStatus="num">
														<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
														</c:forEach>
											</select> 
						                </div>
...
<!-- 								</div> -->
<!-- 								<div class="col-md-8"> -->
<!-- 									 <input type="text"   id="x_sus_no" name="x_sus_no" value="" onkeyup="search_sus(this,'')" -->
<!-- 										class="form-control autocomplete" autocomplete="off">    -->
<!-- 								</div> -->
<!-- 							</div> -->
<!-- 						</div> -->
...
<!-- 					</div> -->
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                       <label class=" form-control-label" id="appoit_reject_remarks"></label>		 
						                </div>
						            </div>
	              				</div>
	              				</div>
						...
						<div class="card-footer" align="center" class="form-control">
		              		 ...
		              		 <input type="button" name="remove" class="btn btn-danger btn-sm" value="Delete" onclick=" validate_appointment_remove();" />		                       
			            </div>  
						</div>
					</div>
				</div>
				...
				<div class="panel panel-default" id="d_div1">
					...
					<br>
							...
							<div class="col-md-12">	
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong
										style="color: red;">* </strong> Visible Identification Marks</label>
						                </div>
						                <div class="col-md-8">
						...
						<div class="card-footer" align="center">
								<input type="button" name="save" class="btn btn-primary btn-sm" value="Update" onclick=" validate_identity_card_save();" /> 
						<input type="button" name="remove" class="btn btn-danger btn-sm" value="Delete" onclick=" validate_identity_card_remove();" />
						</div>
					</div>
					</div>
				</div>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                  <input type="text" id="ta_authority" name="ta_authority" class="form-control"  
						                   autocomplete="off" maxlength="100" onkeyup="return specialcharecter(this)">	
								           <input type="hidden" id="ta_id" name="ta_id" value="0" class="form-control"  autocomplete="off" >
						                </div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
										   <select  id="ta_status" name="ta_status" class="form-control" onchange=""  >
														<option value="0">--Select--</option>
...
<!-- 					</div> -->
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                       <label class=" form-control-label" id="ta_reject_remarks"></label>		 
						                </div>
						            </div>
	              				</div>
	              				</div>
						...
						<div class="card-footer" align="center" class="form-control">
		              		 <input type="button" name="save" class="btn btn-primary btn-sm" value="Update" onclick=" validate_ta_jco_save_fn();" />		     
		              		 <input type="button" name="remove" class="btn btn-danger btn-sm" value="Delete" onclick=" validate_ta_jco_remove();" />		                       
			            </div>  
						</div>
					</div>
				</div>
				...
				<div class="panel panel-default" id="e_div1">
					...
					<div id="collapse1e" class="panel-collapse collapse">
					  <div class="card-body card-block">
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                    <input type="text" id="rel_authority" name="authority" maxlength="100" class="form-control autocomplete" autocomplete="off" maxlength="50" onkeyup="return specialcharecter(this)"> 
	              			  ...
	              			  <div class="col-md-6" id = "other_div" style="display: none;">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
					                	<input type="text" id="religion_other" name="religion_other" class="form-control autocomplete" autocomplete="off" onkeypress="return onlyAlphabets(event);" maxlength="50"> 
					                	 </div>
						            </div>
	              				</div>	             				
	              			</div>
	              			     ...
	              			     <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                       <label class=" form-control-label" id="religion_reject_remarks"></label>		 
						                </div>
						            </div>
	              				</div>
	              				</div>
					    ...
					    <div class="card-footer" align="center" class="form-control">
		              		<input type="button" class="btn btn-primary btn-sm" value="Update" onclick="validate_Religion_save_fn();">		              
			            <input type="button" name="remove" class="btn btn-danger btn-sm" value="Delete" onclick=" validate_Religion_remove();" />
			            </div> 	
						</div>
					</div>
				</div>
						...
						<br>
								...
								<thead style="color: white; text-align: center;">
									<tr>
										...
										<th style="width: 20%;">Aadhar Card No </th>
								...
								<tbody data-spy="scroll" id="m_children_detailstbody" style="min-height: 46px; max-height: 650px; text-align: center;">
									<tr id="tr_children1">
										...
										<td style="width: 5%;">
									<%-- 	<select name="sib_type1" id="sib_type1" class="form-control">
											<option value="0">--Select--</option>
											<c:forEach var="item" items="${getChild_TypeList}" varStatus="num">
											<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
											</c:forEach>
										</select> --%>
										...
										<td style="width: 10%;"><select name="child_service1" id="child_service1" onchange="otherfunction(1)"
												class="form-control-sm form-control"
												>
												<option value="0">--Select--</option>
												<c:forEach var="item" items="${getExservicemenList}"
											...
											<td style="width: 10%;"><input type="text" id="child_personal_no1"
												name="child_personal_no1" class="form-control autocomplete"
												autocomplete="off" maxlength="15"
												onkeypress="return /[0-9a-zA-Z]/i.test(event.key)"
												oninput="this.value = this.value.toUpperCase()">
											</td>
											<td style="width: 10%;"><input type="text" id="other_child_ser1"
	              			     ...
	              			     <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                       <label class=" form-control-label" id="child_reject_remarks"></label>		 
						                </div>
						            </div>
	              				</div>
	              				</div>
				...
				<div class="panel panel-default" id="h_div1">
					...
					<div id="collapse1h" class="panel-collapse collapse">
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                   <input type="text" id="authority" name="authority" maxlength="100" class="form-control autocomplete" autocomplete="off" maxlength="50" onkeyup="return specialcharecter(this)"> 						                   
						                </div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
	              				...
	              				<div class="col-md-6" id = "nok_other_te" style="display: none;">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
					                	<input type="text" id="nok_tehsil_other" name="nok_tehsil_other" maxlength="100" class="form-control autocomplete" autocomplete="off" onkeypress="return onlyAlphabets(event);">
					                	 </div>
						            </div>
	              				</div>
	              					</div>
					    ...
					    <div class="card-footer" align="center" class="form-control">
		              		...
		              		<input type="button" name="remove" class="btn btn-danger btn-sm" value="Delete" onclick=" validate_nok_remove();" />	              
			            </div> 
						</div>
					</div>
				</div>
		 				...
		 				<div class="col-md-6">
              					<div class="row form-group">
					               <div class="col-md-4">
					                ...
					                <select name="pre_country" id="pre_country" class="form-control"   >
						                          <option value="0">--Select--</option>
												<c:forEach var="item" items="${getMedCountryName}" varStatus="num">
													<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
												</c:forEach>
					               ...
					               <div class="col-md-4">
					                ...
					                <div class="col-md-8">
						                 <input type="hidden" id="addr_ch_id" name="addr_ch_id" value="0" class="form-control autocomplete" autocomplete="off" > 							                     
					               			<select name="pre_domicile_state" id="pre_domicile_state" class="form-control"   >
						                        <option value="0">--Select--</option>
												<c:forEach var="item" items="${getMedStateName}" varStatus="num">
													<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
												</c:forEach>
              			 ...
              			 <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                 <select name="pre_domicile_district" id="pre_domicile_district" class="form-control"   >
					                		<option value="0">--Select--</option>
											<c:forEach var="item" items="${getMedDistrictName}" varStatus="num">
												<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
											</c:forEach>
								...
								<div class="col-md-6" id = "add_other_dt" style="display: none;">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
					                	<input type="text" id="pre_domicile_district_other" maxlength="100" name="pre_domicile_district_other" class="form-control autocomplete" autocomplete="off" onkeypress="return onlyAlphabets(event);">
					                	 </div>
						            </div>
	              				</div>
	              				<div class="col-md-6" id = "add_other_te" style="display: none;">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
					                	<input type="text" id="pre_domicile_tesil_other" maxlength="100" name="pre_domicile_tesil_other" class="form-control autocomplete" autocomplete="off" onkeypress="return onlyAlphabets(event);">
					                	 </div>
						            </div>
	              				</div>
	              					</div>
						...
						<div class="col-md-6">
              					<div class="row form-group">
					               <div class="col-md-4">
					                ...
					                <div class="col-md-8">
					                <select name="per_home_addr_country" id="per_home_addr_country" class="form-control"   >
						                        <option value="0">--Select--</option>
												<c:forEach var="item" items="${getMedCountryName}" varStatus="num">
													<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
												</c:forEach>
              				...
              				<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                	<select name="per_home_addr_state" id="per_home_addr_state" class="form-control"   >
						                        <option value="0">--Select--</option>
												<c:forEach var="item" items="${getMedStateName}" varStatus="num">
													<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
												</c:forEach>
								...
								<div class="col-md-6" id = "per_home_addr_country_other_hid" style="display: none;">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
					                	<input type="text" id="per_home_addr_country_others" maxlength="100" name="per_home_addr_country_others" class="form-control autocomplete" autocomplete="off" onkeypress="return onlyAlphabets(event);">
					                	 </div>
						            </div>
	              				</div>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                <select name="per_home_addr_district" id="per_home_addr_district" class="form-control"   >
					                		<option value="0">--Select--</option>
											<c:forEach var="item" items="${getMedDistrictName}" varStatus="num">
												<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
											</c:forEach>
	              			...
	              			<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
											<input type="text" id="per_home_addr_village" name="per_home_addr_village" 	onkeypress="return onlyAlphabets(event);"  class="form-control autocomplete" autocomplete="off"  maxlength="50">				               
						                </div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
						...
						<div class="col-md-6">
              					<div class="row form-group">
					               <div class="col-md-4">
					                ...
					                <select name="pers_addr_country" id="pers_addr_country" class="form-control"   >
						                          <option value="0">--Select--</option>
												<c:forEach var="item" items="${getMedCountryName}" varStatus="num">
													<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
												</c:forEach>
              				...
              				<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                	<select name="pers_addr_state" id="pers_addr_state" class="form-control"   >
						                        <option value="0">--Select--</option>
												<c:forEach var="item" items="${getMedStateName}" varStatus="num">
													<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
												</c:forEach>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                <select name="pers_addr_district" id="pers_addr_district" class="form-control"   >
					                		<option value="0">--Select--</option>
											<c:forEach var="item" items="${getMedDistrictName}" varStatus="num">
												<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
											</c:forEach>
...
<!-- 											</div> -->
	              			     ...
	              			     <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                       <label class=" form-control-label" id="address_reject_remarks"></label>		 
						                </div>
						            </div>
	              				</div>
	              				</div>
						...
						<div class="card-footer" align="center" class="form-control">
		              		<input type="button" class="btn btn-primary btn-sm" value="Update" onclick="validate_changeaddress_details_save();">		              
			           <input type="button" name="remove" class="btn btn-danger btn-sm" value="Delete" onclick=" validate_changeaddress_details_remove();" />
			            </div> 
						</div>
					</div>
				</div>
			            ...
			            <br>
	              		...
	              		<div class="col-md-12">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                 <input type="hidden" id="cda_id" name="cda_id" value="0" class="form-control autocomplete" autocomplete="off"  maxlength="64">
						                   <input type="text" id="gmail" name="gmail" class="form-control autocomplete" autocomplete="off" onchange="validateEmail(this);" > 
						                </div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                   <input type="text" id="nic_mail" name="nic_mail" class="form-control autocomplete" autocomplete="off" maxlength="64" onchange="validateEmail(this);"> 
						                </div>
						            </div>
	              				</div>
	              			</div>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                   <input type="text" id="mobile_no" name="mobile_no" maxlength="10" class="form-control autocomplete" autocomplete="off" onkeypress="return isNumber0_9Only(event)" > 
						                </div>
						            </div>
	              				</div>
	              				   <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                       <label class=" form-control-label" id="contact_reject_remarks"></label>		 
						                </div>
						            </div>
	              				</div>
	              			</div>
							...
							<div class="card-footer" align="center" class="form-control">
		              		 ...
		              		 <input type="button" name="remove" class="btn btn-danger btn-sm" value="Delete" onclick=" validate_cda_acnt_no_remove();" />
				...
				<div class="panel panel-default" id="k_div1">
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                  <input type="text" id="language_authority" name="language_authority" maxlength="100" class="form-control autocomplete" autocomplete="off" maxlength="50" onkeyup="return specialcharecter(this)"> 
						                </div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
				   ...
				   <tbody data-spy="scroll" id="langtbody" style="min-height:46px; max-height:650px; text-align: center;">
						<tr id="tr_lang1">
							...
							<td style="width: 10%;">
			 <input type="text" id="other_language1" name="other_language1" class="form-control autocomplete"  maxlength="100" readonly autocomplete="off" onkeypress="return onlyAlphaNumeric(event);">
						</td>
							<td style="width: 10%;">
							  <select  id="lang_std1" name="lang_std1" class="form-control autocomplete" onchange="onLanguage_std(1)" >
							   <option value="0">--Select--</option>
								...
								<td style="width: 10%;">
			 <input type="text" id="other_lang_std1" name="other_lang_std1" class="form-control autocomplete"  maxlength="100" readonly autocomplete="off" onkeypress="return onlyAlphaNumeric(event);">
						</td>
						<%-- 	<td style="width: 10%;">
							  ...
							  <td style="width: 10%;">
							   <input type="date" id="language_date_of_authority1" name="language_date_of_authority1"  max="${date}" min='1899-01-01' class="form-control autocomplete" autocomplete="off" maxlength="10">
							   </td> --%>
					...
					<table id="foregin_language_table" class="table-bordered " style="margin-top:10px;">
							   ...
							   <tbody data-spy="scroll" id="flangtbody" style="min-height:46px; max-height:650px; text-align: center;">
									<tr id="tr_flang1">
										...
										<td style="width: 10%;">
			                       <input type="text" id="f_other_language1" name="f_other_language1" maxlength="100" class="form-control autocomplete"  readonly autocomplete="off" onkeypress="return onlyAlphaNumeric(event);">
						         </td>
										<td style="width: 10%;">
										...
										<td style="width: 10%;">
			                         <input type="text" id="f_other_lang_std1" name="f_other_lang_std1" maxlength="100" class="form-control autocomplete"  readonly autocomplete="off" onkeypress="return onlyAlphaNumeric(event);">
						                  </td>
										<td style="width: 10%;">
										...
										<td style="width: 10%;">
			                         <input type="text" id="f_other_prof1" name="f_other_prof1" class="form-control autocomplete"  maxlength="100" readonly autocomplete="off" onkeypress="return onlyAlphaNumeric(event);">
						                  </td>
										<td style="width: 10%;">
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                 <input type="text" id="qualification_authority" name="qualification_authority" maxlength="100" class="form-control autocomplete" autocomplete="off" maxlength="50" onkeyup="return specialcharecter(this)">
						                </div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
                    ...
                    <div class="col-md-12">
						<div class="col-md-6" id ="other_div_exam" style="display: none;">
									...
									style="color: red;">* </strong>Examination Other  </label>
						                ...
						                <div class="col-md-8">
					                	<input type="text" id="exam_other" name="exam_other" class="form-control autocomplete" autocomplete="off" >
					                	 </div>
						            </div>
	              				</div>	   
                        </div>
				 ...
				 <div class="col-md-12">
						<div class="col-md-6" id ="other_div_qualiDeg" style="display: none;">
									...
									style="color: red;">* </strong>Degree Other  </label>
						                ...
						                <div class="col-md-8">
					                	<input type="text" id="quali_deg_other" name="quali_deg_other" class="form-control autocomplete" autocomplete="off" >
					                	 </div>
						            </div>
	              				</div>	   
	              				...
	              				<div class="col-md-6" id ="other_div_qualiSpec" style="display: none;">
									...
									style="color: red;">* </strong>Specialization Other  </label>
						                ...
						                <div class="col-md-8">
					                	<input type="text" id="quali_spec_other" name="quali_spec_other" class="form-control autocomplete" autocomplete="off" >
					                	 </div>
						            </div>
	              				</div>
                        </div>
					...
					<div class="col-md-12" id ="other_div_class" style="display: none;" >
				       <div class="col-md-6" >
									...
									style="color: red;">* </strong>Div/Grade Other </label>
						                ...
						                <div class="col-md-8">
					                	<input type="text" id="class_other" name="class_other" class="form-control autocomplete" autocomplete="off" >
					                	 </div>
						            </div>
	              		</div>	   
...
<div class="col-md-12">	            
	              			     <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                       <label class=" form-control-label" id="qulification_reject_remarks"></label>		 
						                </div>
						            </div>
	              				</div>
	              				</div>
			...
			<div class="card-footer" align="center" class="form-control">
					 <input type="button" class="btn btn-primary btn-sm" value="Update" onclick="qualification_save_fn();">
			</div>
			...
			<thead>
				<tr>
					...
					<th style="text-align: center;">Examination Pass</th>	
				...
				<div class="panel panel-default" id="m_div1">
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                  <input type="text" id="promo_exam_authority" maxlength="100" name="promo_exam_authority" class="form-control autocomplete" autocomplete="off" maxlength="50" onkeyup="return specialcharecter(this)"> 
						                </div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
				   ...
				   <tbody data-spy="scroll" id="promo_examtbody" style="min-height:46px; max-height:650px; text-align: center;">
						<tr id="tr_promo_exam1">
							...
							<td style="width: 10%;">
						 <input type="text" id="exam_other1" name="exam_other1" class="form-control autocomplete"  readonly autocomplete="off" >
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                 <input type="text" id="army_course_authority" maxlength="100" name="army_course_authority"  class="form-control autocomplete" autocomplete="off" maxlength="50" onkeyup="return specialcharecter(this)">
						                </div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
...
<!-- 										<th style="width: 10%;">Other Course Type</th> -->
							   ...
							   <tbody data-spy="scroll" id="army_coursetbody" style="min-height:46px; max-height:650px; text-align: center;">
									<tr id="tr_army_course1">
										...
										<td style="width: 10%;">
										 <input type="text" id="army_course_name1" name="army_course_name1" onkeyup="AutoCompleteCourse(this,1,0);"   class="form-control autocomplete" autocomplete="off" maxlength="20">
										</td>
										<td style="width: 10%;">
										 <input type="text" id="army_course_abbreviation1" name="army_course_abbreviation1" onkeyup="AutoCompleteCourse(this,1,1);"   class="form-control autocomplete" autocomplete="off" maxlength="20">
										</td>
										...
										<td style="width: 10%;">
										  <select  id="army_course_institute1" name="army_course_institute1" class="form-control autocomplete"  onchange="onArmyCourseInstiChange(1)">
										   <option value="0">--Select--</option>
											...
											<td style="width: 10%; ">
										  <input type="text" id="army_course_institute_ot1" name="army_course_institute_ot1" class="form-control autocomplete"  readonly autocomplete="off" onkeypress="return onlyAlphabets(event);">
										</td>
										<td style="width: 10%;">
										...
										<td style="width: 10%;">
										  <input type="text" id="ar_course_div_ot1" name="ar_course_div_ot1" class="form-control autocomplete"  readonly autocomplete="off" onkeypress="return /[0-9a-zA-Z]/i.test(event.key)">
										</td>
										<td style="width: 10%;">
										...
										<td style="width: 10%; display: none">
										  <input type="text" id="course_type_ot1" name="course_type_ot1" class="form-control autocomplete"  readonly autocomplete="off" onkeypress="return /[0-9a-zA-Z]/i.test(event.key)">
										</td>
										<td style="width: 10%;">
								...
								<table id="bpet_table" class="table-bordered "
									...
									<thead style="color: white; text-align: center;">
										<tr>
											...
											<th style="width: 10%;">Other BPET Result</th>
											<th style="width: 20%;">BPET QTR</th>
									...
									<tbody data-spy="scroll" id="bpettbody"
										...
										<tr id="tr_bpet1">
											...
											<select name="BPET_result1" id="BPET_result1" onchange="onBeptResult(1)"
												...
												<td style="width: 10%;">
										  <input type="text" id="bept_result_others1" name="bept_result_others1" class="form-control autocomplete"  readonly autocomplete="off" onkeypress="return onlyAlphabets(event);">
										</td>
											<td style="width: 20%;"><select name="BPET_qe1" id="BPET_qe1"
												class="form-control">
													 <option value="-1">--Select--</option>
											...
											<td style="width: 20%;">
											<input type="text"id="bpet_year1" name="year1"	class="form-control autocomplete" autocomplete="off" maxlength="4" 
											onkeypress="return isNumberPointKey(event);">
											</td>
											<td style="width: 20%;">
											<input type="text" id="unit_name1" name="unit_name1" class="form-control autocomplete" onkeypress="BPET_UnitAuto(this);" autocomplete="off">
											<input type="hidden" id="unit_sus_no1" name="unit_sus_no1" class="form-control autocomplete" autocomplete="off">
											</td>
											<td style="display: none;">
											<input type="text" id="id1" name="id1" value="0" class="form-control autocomplete" autocomplete="off">
											</td>
											<td style="width: 20%;">
											<a class="btn btn-primary btn-sm" value="SAVE" title="Update" id="bpet_save1" onclick="bpet_save_fn(1);">
	              			     ...
	              			     <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                       <label class=" form-control-label" id="bept_reject_remarks"></label>		 
						                </div>
						            </div>
	              				</div>
	              				</div>
							...
							<div class="card-body card-block" id="total_table">
								...
								<tbody data-spy="scroll" id="fire_stdtbody"
									...
									<tr id="tr_fire_std1">
										...
										<td style="width: 10%;">
										  <input type="text" id="ot_firing_grade1" name="ot_firing_grade1" class="form-control autocomplete"  readonly autocomplete="off" onkeypress="return onlyAlphabets(event);">
										</td>
										<td style="width: 20%;">
										...
										autocomplete="off" maxlength="4" onkeypress="return isNumberPointKey(event);">
										</td>
										<td style="width: 20%;">
										<input type="text" id="firing_unit_name1" name="firing_unit_name1" class="form-control autocomplete" onkeypress="Firing_UnitAuto(this);" autocomplete="off">
										...
										<td style="width: 20%;">
										<a class="btn btn-primary btn-sm" value="SAVE" title="Update" id="fire_std_save1" onclick="fire_std_save_fn(1);">
											<i class="fa fa-save"></i></a>
										</td>
									</tr>
								</tbody>
	              			     ...
	              			     <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                       <label class=" form-control-label" id="firing_reject_remarks"></label>		 
						                </div>
						            </div>
	              				</div>
	              				</div>
						...
						<tr>
				   		...
				   		<tbody data-spy="scroll" id="allergictbody" style="min-height: 46px; max-height: 650px; text-align: center;">
							<tr id="tr_allergic1">
								...
								<td><input type="text" id="allergic1" maxlength="100" name="allergic1"
									class="form-control autocomplete" autocomplete="off">
								</td>
	              			     ...
	              			     <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                       <label class=" form-control-label" id="allergi_reject_remarks"></label>		 
						                </div>
						            </div>
	              				</div>
	              				</div>
...
<!-- 					 <input type="hidden" id="med_cat_ch_id" name="med_cat_ch_id" value="0" class="form-control autocomplete" autocomplete="off" > 							                      -->
							...
							<input type="text" id="madical_authority"
								name="madical_authority" class="form-control autocomplete" maxlength="100" onkeyup="return specialcharecter(this)" 
								autocomplete="off">
						</div>
					</div>
				</div>
...
<!-- 							<input type="date" id="1bx_to_date" name="1bx_to_date" class="form-control autocomplete" autocomplete="off"> -->
			...
			<div class="card-header-inner" style="text-align: center;margin-bottom:20px;"> <strong>S - Psychological & Congnitive</strong></div>
			<div class="">
...
<!-- 														   </td> -->
		...
		<div class="card-header-inner" style="text-align: center;margin-bottom:20px;"> <strong>H - Hearing</strong></div>
				<div>
...
<!-- 														   </td> -->
					...
					<br/>
				<div class="card-header-inner" style="text-align: center;margin-bottom:20px;"> <strong>A - Appendages</strong></div>		
					<div>
...
<!-- 														   </td> -->
					...
					<br/>
					<div class="card-header-inner" style="text-align: center;margin-bottom:20px;"> <strong>P - Physical Capacity</strong></div>	
					<div>
...
<!-- 														   </td> -->
	...
	<div class="card-header-inner" style="text-align: center;margin-bottom:20px;"> <strong>E - Eye Sight</strong></div>			
					<div>
...
<!-- 														   </td> -->
	              			     ...
	              			     <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                       <label class=" form-control-label" id="medical_reject_remarks"></label>		 
						                </div>
						            </div>
	              				</div>
	              				</div>
	     ...
	     <div class="card-footer" align="center" class="form-control"> 
		        ...
		        <input type="button" name="remove" class="btn btn-danger btn-sm" value="Delete" onclick=" validate_medical_cat_remove();" />	              
		 </div> 
						</div>
					</div>
				</div>
							...
							<table id="foreign_country_visit" class="table-bordered " style="margin-top:10px;">
							   ...
							   <tbody data-spy="scroll" id="foregin_Country_tbody" style="min-height:46px; max-height:650px; text-align: center;">
									<tr id="tr_foregin_country1">
										...
										<td style="width: 10%;">
										  <input type="text" id="foregin_Country_ot1" name="foregin_Country_ot1" class="form-control autocomplete"  readonly autocomplete="off" onkeypress="return onlyAlphaNumeric(event);">
										</td>
									  <td style="width: 10%;">
										...
										<td style="width: 10%;">
										  <input type="text" id="period1" name="period1" class="form-control autocomplete" autocomplete="off" maxlength="4" onkeypress="isNumber0_9Only(event)" >
										</td>
										<td style="width: 5%;">
										...
										<td style="width: 10%;">
										  <input type="text" id="purpose_visit_ot1" name="purpose_visit_ot1" class="form-control autocomplete"  readonly autocomplete="off" onkeypress="return onlyAlphaNumeric(event);">
										</td>
	              			     ...
	              			     <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                       <label class=" form-control-label" id="foregin_country_reject_remarks"></label>		 
						                </div>
						            </div>
	              				</div>
	              				</div>
                                                        ...
                                                        <table id="awardsNmedal_table" class="table-bordered " style="margin-top:10px;">
                                                           ...
                                                           <tbody data-spy="scroll" id="awardsNmedal_tbody" style="min-height:46px; max-height:650px; text-align: center;">
                                                                        <tr id="tr_awardsNmedal">
                                                                                ...
                                                                                <td style="width: 10%;">
                                                                                  <input type="text" id="awardsNmedal_authority1" maxlength="100"  name="awardsNmedal_authority1" class="form-control autocomplete" autocomplete="off" maxlength="50" onkeyup="return specialcharecter(this)">
                                                                                 </td>
                                                                                     <td style="width: 10%;">
	              			     ...
	              			     <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                       <label class=" form-control-label" id="award_reject_remarks"></label>		 
						                </div>
						            </div>
	              				</div>
	              				</div>   
									...
									<div class="col-md-6">
										...
										style="color: red;">* </strong>Authority</label>
										 ...
										 <input type="hidden" id="batnpc_ch_id" name="batnpc_ch_id" value="0" class="form-control autocomplete" autocomplete="off" > 							                     
												<input type="text" id="batnpc_authority" maxlength="100" onkeyup="return specialcharecter(this)"
														...
														<div class="col-md-12">
																...
																<div class="col-md-6" id="onduityotherdiv" style="display: none;">
																	<div class="row form-group">
																		...
																		<div class="col-md-8">
																			<input type="text" id="onduityother"
															...
															<div class="col-md-12">
																...
																<div class="col-md-6">
																	<div class="row form-group">
																		<div class="col-md-4">
																			<label class=" form-control-label">STATE/UT/PROVINCE</label>
																		</div>
																		<div class="col-md-8">
															...
															<div class="col-md-12">
																...
																<div class="col-md-6" style="display: none;" id= "state_other_div">
																	<div class="row form-group">
																		<div class="col-md-4">
																			<label class=" form-control-label">STATE/UT/PROVINCE OTHER</label>
																		</div>
																		<div class="col-md-8">
															...
															<div class="col-md-12">
																		...
																		<div class="col-md-6">
																			<div class="row form-group">
																				<div class="col-md-4">
																					<label class=" form-control-label">TEHSIL/MUNICIPALITY</label>
																				</div>
																				<div class="col-md-8">
																...
																<div class="col-md-6" id="district_other_div" style="display: none;">
																	<div class="row form-group">
																		...
																		<div class="col-md-8">
																		<input type="text" id="district_other" onkeypress="return onlyAlphabets(event);"
																...
																<div class="col-md-6" style="display: none;" id= "tehsil_other_div">
																	<div class="row form-group">
																		...
																		<div class="col-md-8">
																			<input type="text" id=tehsil_other onkeypress="return onlyAlphabets(event);"
																...
																<div class="col-md-12">
																	<div class="col-md-6">
																		<div class="row form-group">
																			...
																			<div class="col-md-8">						
																				<input type="text" id="batnpc_exact_place" onkeypress="return onlyAlphaNumeric(event);"
										...
										<div class="col-md-12">
											<div class="col-md-6">
												<div class="row form-group">
													<div class="col-md-4">
														<label class=" form-control-label"><strong
										                                  style="color: red;">* </strong>Name of Operation</label>
													</div>
													<div class="col-md-8">						
														<input type="text" id="name_of_operation"
															name="name_of_operation" class="form-control autocomplete" maxlength="200"  onkeypress="getNameOfOperation(this);"
															autocomplete="off">
													</div>
												</div>
											</div>
																	...
																	<div class="col-md-12">
																						<div class="col-md-6">
																							<div class="row form-group">
																								...
																								<div class="col-md-8">
																									<input type="text" id="hospital_name" onkeypress="return onlyAlphabets(event);"
...
<!-- 							<div class="card-header-inner" style="margin-left:20px;margin-bottom:20px;"> <strong>Cause of Casuality </strong></div> -->
							<div class="col-md-12">
										<div class="col-md-6">
											<div class="row form-group">
											<div class="col-md-4">
							...
							<div class="col-md-12">
										...
										<div class="col-md-6">
											<div class="row form-group">
												<div class="col-md-4">
													<label class=" form-control-label"><strong
										                                  style="color: red;">* </strong>Diagnosis
													</label>
												</div>
												<div class="col-md-8">	
									...
									<div class="col-md-12">
										<div class="col-md-6">
											...
											<div class="col-md-4">
													<label class=" form-control-label"><strong
										style="color: red;">* </strong>Whether NOK Informed or Not</label>
												</div>	
...
<!-- 							<div class="card-header-inner" style="margin-left:20px;margin-bottom:20px;"> <strong>Geographical Location</strong></div> -->
							   ...
							   <input type="button" name="remove" class="btn btn-danger btn-sm" value="Delete" onclick=" validate_batnpc_remove();" />
					...
					<div class="card-body card-block">
						<br>
							...
							<%-- 	 <div class="col-md-12">	              					
	              			...
	              			<div class="col-md-6">
								...
								<div class="col-md-6">
									<div class="row form-group">
										...
										<div class="col-md-8">
											<input type="text" id="disi_authority" name="disi_authority" maxlength="100" class="form-control autocomplete" autocomplete="off" 	onkeyup="return specialcharecter(this)">
										</div>
									</div>
								</div>
								<div class="col-md-6">
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                    <textarea name="description" id="description1"   onkeypress="return onlyAlphabets(event);" class="form-control" maxlength="200" autocomplete="off"></textarea> 
						                </div>
						            </div>
	              				</div>
	              			</div>
	              				...
	              				<div class="col-md-6">
						            ...
						            <div class="row form-group" id="type_of_entry_otherDiv" style="display: none">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">						                    
											<input type="text" name="type_of_entry_other" id="type_of_entry_other"  style="display: none;" class="form-control" maxlength="50" autocomplete="off" onkeypress="return onlyAlphabets(event);"/>
						                </div>
						            </div>
	              				</div>	
	              				 <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"> <strong
											style="color: red;">* </strong> Award Date </label>
						                </div>
						                <div class="col-md-8">
							  ...
							  <div class="card-footer" align="center" class="form-control">
								<input type="button" class="btn btn-primary btn-sm" value="Update" onclick="validate_Discipline_save();"> 
								<input type="button" name="remove" class="btn btn-danger btn-sm" value="Delete" onclick=" validate_Discipline_remove();" />	
			            	</div>
						</div>
					</div>
				</div>
					...
					<div id="collapse1x" class="panel-collapse collapse">
	              			...
	              			<div class="col-md-12">
								<div class="col-md-6">
									<div class="row form-group">
										<div class="col-md-4">
											<label class=" form-control-label"><strong
												style="color: red;"> </strong> Old Record Office SUS </label>
										</div>
										<div class="col-md-8">
										<label class=" form-control-label" id="inter_arm_record_office_suslb"></label> 
								...
								<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong style="color: red;"> </strong> Old Record Office Unit Name</label>
						                </div>
						                <div class="col-md-8">
						                <label class=" form-control-label" id="inter_arm_record_office_unitlb"></label> 
	              			...
	              			<div class="col-md-12">	
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong style="color: red;">*</strong> New Record Office SUS</label>
						                </div>
						                <div class="col-md-8">
						                      <input type="text" name="record_office_sus" id="record_office_sus" class="form-control"  onkeypress="return onlyAlphaNumeric(event);" maxlength="8" >
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong style="color: red;"> *</strong> New Record Office Unit Name </label>
						                </div>
						                <div class="col-md-8">
						                     <input type="text" name="record_office_unit" id="record_office_unit" class="form-control" onkeypress="return onlyAlphaNumeric(event);" maxlength="50">
	              				  ...
	              				  <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                       <label class=" form-control-label" id="arm_reject_remarks"></label>		 
						                </div>
						            </div>
	              				</div>
	              			</div> 
	              	...
	              	<div class="card-footer" align="center" class="form-control">
		              		 <input type="button" class="btn btn-primary btn-sm" value="Update" onclick="validate_inter_arm_transfer_save();"> 	              
			           	<input type="button" name="remove" class="btn btn-danger btn-sm" value="Delete" onclick=" validate_inter_arm_transfer_remove();" />
			            </div>  
	              			</div>	
					</div>
				</div>
						...
						<div class="col-md-12">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                  <input type="text" id="non_ef_authority" name="non_ef_authority" maxlength="100" value="" onkeyup="return specialcharecter(this)" class="form-control"  autocomplete="off" maxlength="50">	
	              			...
	              			<div class="col-md-12">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                   <label for="cause"><strong
										                                  style="color: red;">* </strong> Cause of Non Effective <span class="star_design"></span></label>
						                </div>
						                <div class="col-md-8">
						                	<select  id="cause_of_non_effective" name="cause_of_non_effective" class="form-control"   >      <!-- onchange="retire_add_fn(this);" -->
														<option value="0">--Select--</option>
														<c:forEach var="item" items="${getJcoOr_Non_EffectiveList}" varStatus="num">
														<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
														</c:forEach>
											</select> 
						                </div>
	              			    ...
	              			    <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label for="Date Non"><strong
										                                  style="color: red;">* </strong> Date of Non Effective <span class="star_design"></span></label>
						                </div>
						                <div class="col-md-8">
				   ...
				   <!--  country-->
						...
						<div class="col-md-6">
	              		...
	              		<div class="col-md-12">	
							  <div class="col-md-6" id = "Ot_perm_hm_addr_con_div" style="display: none;">
              					<div class="row form-group">
					               <div class="col-md-4">
					                    <label class=" form-control-label"><strong style="color: red;">* </strong>OTHERS COUNTRY</label>
					                </div>
					                <div class="col-md-8">
					                  <input type="text" id="perm_home_addr_country_other" name="per_home_addr_country_other"   class="form-control autocomplete" autocomplete="off" onkeypress="return onlyAlphaNumeric(event);"  maxlength="50">				               
					                </div>
					            </div>
              				</div>
              				...
              				<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong style="color: red;">* </strong>OTHERS STATE/PROVINCE</label>
						                </div>
						               <div class="col-md-8">
					                  <input type="text" id="perm_home_addr_state_other" name="per_home_addr_state_other"  class="form-control autocomplete" autocomplete="off"  onkeypress="return onlyAlphaNumeric(event);" maxlength="50">				               
					                </div>
						            </div>
	              			</div>
	              	</div>
	              	...
	              	<div class="col-md-12">	
						<div class="col-md-6" id = "Ot_perm_hm_addr_dis_div" style="display: none;">
              					<div class="row form-group">
					               <div class="col-md-4">
					                    <label class=" form-control-label"><strong style="color: red;">* </strong>OTHERS DISTRICT</label>
					                </div>
					                <div class="col-md-8">
					                  <input type="text" id="perm_home_addr_district_other" name="per_home_addr_district_other"  onkeypress="return onlyAlphaNumeric(event);"  class="form-control autocomplete" autocomplete="off"  maxlength="50">				               
					                </div>
					            </div>
              				</div>
              				...
              				<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong style="color: red;">* </strong>OTHERS TEHSIL/MUNICIPALITY</label>
						                </div>
						               <div class="col-md-8">
					                  <input type="text" id="perm_home_addr_tehsil_other" name="per_home_addr_tehsil_other" onkeypress="return onlyAlphaNumeric(event);"  class="form-control autocomplete" autocomplete="off"  maxlength="50">				               
					                </div>
						            </div>
	              			</div>
	              	</div>
	              			...
	              			<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
											<input type="text" id="perm_home_addr_village" name="per_home_addr_village"   class="form-control autocomplete" onkeypress="return onlyAlphabets(event);"  autocomplete="off"  maxlength="50">				               
						                </div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                   <input type="text" id="perm_home_addr_pin" name="per_home_addr_pin" class="form-control autocomplete" autocomplete="off"  onkeypress="return isNumber0_9Only(event)" maxlength="6"> 						                   
						                </div>
						            </div>
	              				</div>
	              			</div>
	              			...
	              			<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                 <input type="text" id="perm_home_addr_rail" name="per_home_addr_rail" onkeypress="return onlyAlphaNumeric(event);" class="form-control autocomplete" autocomplete="off" maxlength="100"> 						                     
	              			     ...
	              			     <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                       <label class=" form-control-label" id="non_reject_remarks"></label>		 
						                </div>
						            </div>
	              				</div>
	              				</div>
			            ...
			            <input type="button" name="remove" class="btn btn-danger btn-sm" value="Delete" onclick=" validate_non_effect_remove();" />
			            </div>  
						</div>
					</div>
				</div>
		...
		<div class="card">
			<div class="panel-group" id="accordion8">
					...
					<%-- 	<div class="col-md-6">
						...
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="arm_type_weapon" name="arm_type_weapon" class="form-control autocomplete"
									 autocomplete="off" maxlength="100" onkeypress="return onlyAlphaNumeric(event);">
								</div>
							</div>
						</div>
					</div>
				...
				<!-- 		<div class="col-md-6">
						...
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="ot_desertion_cause" name="ot_desertion_cause" class="form-control autocomplete" autocomplete="off">
								</div>
							</div>
						</div>
				</div>
				<div class="col-md-12">	            
	              			     <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                       <label class=" form-control-label" id="desertion_reject_remarks"></label>		 
						                </div>
						            </div>
	              				</div>
	              				</div>
                        ...
                        <div class="card-footer" align="center" class="form-control">
							 <input id="btnsave" type="button" class="btn btn-primary btn-sm" value="Update" onclick="validate_Deserter_save_fn()">		              
			           <input type="button" name="remove" class="btn btn-danger btn-sm" value="Delete" onclick=" validate_Deserter_remove();" />
			            </div>
						</div>
					</div>
				</div>
...
<c:if test="${csdde != 0}"> 
	<form id="csddeForm">
					...
					<thead style=" color: white; text-align: center;">
				   	...
				   	<tbody data-spy="scroll" id="CSDtbody" style="min-height: 46px; max-height: 650px; text-align: center;">
						<tr id="tr_csd1">
							...
							<input type="hidden" id="name1" name="name1" class="form-control autocomplete" autocomplete="off"></td>
							...
							<td>
								<label for="type_of_card_grocery1"><input type="radio" class="from-control" id="type_of_card_grocery1" name= "type_of_card1" value="grocery"> Grocery </label>
							...
							<td><input type="text" id="card_no1" name="card_no1" maxlength="25" class="form-control autocomplete" autocomplete="off"  onkeypress="return /[0-9a-zA-Z]/i.test(event.key)" ></td>
	 ...
	 <!-- CSD End -->
	  ...
	  <!-- START TRADE DETAIL -->
<c:if test="${TradeDetails != 0}"> 
 <form id="form_trade">
		<div class="card">
			<div class="panel-group" id="accordion17">
				<div class="panel panel-default" id="ff_div16">
					<div class="panel-heading">
						<h4 class="panel-title main_title green" id="ff_div5">
							<a class="droparrow collapsed" data-toggle="collapse"
								data-parent="#accordion17" href="#" id="ff_final" onclick="divN(this)"
								><b>CHANGE IN TRADE</b></a>
						</h4>
					</div>
					<div id="collapse1ff" class="panel-collapse collapse">
			           <div class="card-body card-block">
			            <br>
			            <input type="button" name="save" class="btn btn-primary btn-sm" value="View History" onclick="Pop_Up_History('Trade');" /> 
							<div class="row">
						<div class="col-md-12">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                   <input type="text" id="td_authority" name="td_authority" onkeyup="return specialcharecter(this)" maxlength="100"  class="form-control autocomplete" autocomplete="off" > 
						                   <input type="hidden" id="td_id" name="td_id" value="0" class="form-control"  autocomplete="off" >
						                </div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						               <input type="text" name="td_date_authority" id="td_date_authority" maxlength="10"  onclick="clickclear(this, 'DD/MM/YYYY')" class="form-control" style="width: 93%;display: inline;"
											onfocus="this.style.color='#000000'" onblur="clickrecall(this,'DD/MM/YYYY');validateDate_BackDate(this.value,this);" onkeyup="clickclear(this, 'DD/MM/YYYY')" 
											onchange="clickrecall(this,'DD/MM/YYYY');validateDate_FutureDate(this.value,this);" aria-required="true" autocomplete="off" style="color: rgb(0, 0, 0);" >
						                </div>
						            </div>
	              			...
	              			<div class="col-md-12">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label">Old Trade</label>
						                </div>
						                <div class="col-md-8">
											<label id="old_trade"> </label>
						                </div>
						            </div>
	              				</div>
	              			    <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"> <strong
											style="color: red;">* </strong>New Trade</label>
						                </div>
						                <div class="col-md-8">
						                <select name="trade" id="trade" class="form-control">
												<option value="-1">--Select--</option>
												<c:forEach var="item" items="${getTradeList}" varStatus="num">
													<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
												</c:forEach>
											</select>
						                </div>
	              			...
	              			<div class="col-md-12">	              					
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong
											style="color: red;">* </strong> Date of Change of  Trade</label>
						                </div>
						                <div class="col-md-8">
						               <input type="text" name="date_of_trade" id="date_of_trade" maxlength="10"  onclick="clickclear(this, 'DD/MM/YYYY')" class="form-control" style="width: 93%;display: inline;"
											onfocus="this.style.color='#000000'" onblur="clickrecall(this,'DD/MM/YYYY');validateDate_BackDate(this.value,this);" onkeyup="clickclear(this, 'DD/MM/YYYY')" 
											onchange="clickrecall(this,'DD/MM/YYYY');validateDate_FutureDate(this.value,this);" aria-required="true" autocomplete="off" style="color: rgb(0, 0, 0);" >
						                </div>
						            </div>
	              			     ...
	              			     <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                       <label class=" form-control-label" id="trade_reject_remarks"></label>		 
						                </div>
						            </div>
	              				</div>
					...
					<!-- 	<div class="card-footer" align="center" class="form-control">
		              		 <input type="button" class="btn btn-primary btn-sm" value="Update" onclick="validate_trade();">		              
			            </div>   -->
			            
			               <div class="card-footer" align="center" class="form-control">
		              		<input type="button" class="btn btn-primary btn-sm" value="Update" onclick="validate_trade();">
			            <input type="button" class="btn btn-danger btn-sm" value="Delete" onclick="validate_trade_remove();">
			            </div> 
						</div>
					</div>
				</div>
	...
	<c:if test="${PayDetails != 0}"> 
 <form id="form_class_pay">
		<div class="card">
			<div class="panel-group" id="accordion17">
				<div class="panel panel-default" id="gg_div16">
					<div class="panel-heading">
						<h4 class="panel-title main_title green" id="gg_div5">
							<a class="droparrow collapsed" data-toggle="collapse"
								data-parent="#accordion17" href="#" id="gg_final" onclick="divN(this)"
								><b>CHANGE IN CLASS (PAY)</b></a>
						</h4>
					</div>
					<div id="collapse1gg" class="panel-collapse collapse">
			            <div class="card-body card-block">
			            <br>
			            <input type="button" name="save" class="btn btn-primary btn-sm" value="View History" onclick="Pop_Up_History('Trade');" /> 
							<div class="row">
						<div class="col-md-12">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                   <input type="text" id="cla_authority" name="cla_authority" onkeyup="return specialcharecter(this)" class="form-control autocomplete" autocomplete="off" maxlength="100" > 
						                   <input type="hidden" id="cla_id" name="cla_id" value="0" class="form-control"  autocomplete="off" >
						                </div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						               <input type="text" name="cla_date_authority" id="cla_date_authority" maxlength="10"  onclick="clickclear(this, 'DD/MM/YYYY')" class="form-control" style="width: 93%;display: inline;"
											onfocus="this.style.color='#000000'" onblur="clickrecall(this,'DD/MM/YYYY');validateDate_BackDate(this.value,this);" onkeyup="clickclear(this, 'DD/MM/YYYY')" 
											onchange="clickrecall(this,'DD/MM/YYYY');validateDate_FutureDate(this.value,this);" aria-required="true" autocomplete="off" style="color: rgb(0, 0, 0);" >
						                </div>
						            </div>
	              			...
	              			<div class="col-md-12">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label">Old Class(PAY)</label>
						                </div>
						                <div class="col-md-8">
											<label id="old_class"> </label>
						                </div>
						            </div>
	              				</div>
	              			    <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong
											style="color: red;">* </strong> New Class(PAY)</label>
						                </div>
						                <div class="col-md-8">
						                <select name="cla_class" id="cla_class" class="form-control">
												<option value="-1">--Select--</option>
												<c:forEach var="item" items="${getClassPayList}" varStatus="num">
													<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
												</c:forEach>
											</select>
						                </div>
	              			...
	              			<div class="col-md-12">	              					
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong
											style="color: red;">* </strong> Date of New Class(PAY)</label>
						                </div>
						                <div class="col-md-8">
						               <input type="text" name="date_of_class" id="date_of_class" maxlength="10"  onclick="clickclear(this, 'DD/MM/YYYY')" class="form-control" style="width: 93%;display: inline;"
											onfocus="this.style.color='#000000'" onblur="clickrecall(this,'DD/MM/YYYY');validateDate_BackDate(this.value,this);" onkeyup="clickclear(this, 'DD/MM/YYYY')" 
											onchange="clickrecall(this,'DD/MM/YYYY');validateDate_FutureDate(this.value,this);" aria-required="true" autocomplete="off" style="color: rgb(0, 0, 0);" >
						                </div>
						            </div>
	              			     ...
	              			     <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                       <label class=" form-control-label" id="class_reject_remarks"></label>		 
						                </div>
						            </div>
	              				</div>
						...
						<div class="card-footer" align="center" class="form-control">
		              		 <input type="button" class="btn btn-primary btn-sm" value="Update" onclick="validate_class_pay();">
		              		  <input type="button" class="btn btn-danger btn-sm" value="Delete" onclick="validate_class_pay_remove();">		              
			            </div>  
						</div>
					</div>
				</div>
...
<c:if test="${GroupDetails != 0}"> 
 <form id="form_pay_group">
		<div class="card">
			<div class="panel-group" id="accordion17">
				<div class="panel panel-default" id="hh_div16">
					<div class="panel-heading">
						<h4 class="panel-title main_title green" id="hh_div5">
							<a class="droparrow collapsed" data-toggle="collapse"
								data-parent="#accordion17" href="#" id="hh_final" onclick="divN(this)"
								><b>CHANGE IN PAY GROUP</b></a>
						</h4>
					</div>
					<div id="collapse1hh" class="panel-collapse collapse">
			          <div class="card-body card-block">
			            <br>
			            <input type="button" name="save" class="btn btn-primary btn-sm" value="View History" onclick="Pop_Up_History('Trade');" /> 
							<div class="row">
						<div class="col-md-12">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                   <input type="text" id="gp_authority" name="gp_authority" onkeyup="return specialcharecter(this)" class="form-control autocomplete" autocomplete="off" maxlength="100" > 
						                   <input type="hidden" id="gp_id" name="gp_id" value="0" class="form-control"  autocomplete="off" >
						                </div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						               <input type="text" name="gp_date_authority" id="gp_date_authority" maxlength="10"  onclick="clickclear(this, 'DD/MM/YYYY')" class="form-control" style="width: 93%;display: inline;"
											onfocus="this.style.color='#000000'" onblur="clickrecall(this,'DD/MM/YYYY');validateDate_BackDate(this.value,this);" onkeyup="clickclear(this, 'DD/MM/YYYY')" 
											onchange="clickrecall(this,'DD/MM/YYYY');validateDate_FutureDate(this.value,this);" aria-required="true" autocomplete="off" style="color: rgb(0, 0, 0);" >
						                </div>
						            </div>
	              			...
	              			<div class="col-md-12">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label">Old PAY GROUP</label>
						                </div>
						                <div class="col-md-8">
											<label id="old_group"> </label>
						                </div>
						            </div>
	              				</div>
	              			    <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong
											style="color: red;">* </strong> NEW PAY GROUP</label>
						                </div>
						                <div class="col-md-8">
						                <select name="gp_group" id="gp_group" class="form-control">
												<option value="-1">--Select--</option>
	              			...
	              			<div class="col-md-12">	              					
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong
											style="color: red;">* </strong> Date of New PAY GROUP</label>
						                </div>
						                <div class="col-md-8">
						               <input type="text" name="date_of_group" id="date_of_group" maxlength="10"  onclick="clickclear(this, 'DD/MM/YYYY')" class="form-control" style="width: 93%;display: inline;"
											onfocus="this.style.color='#000000'" onblur="clickrecall(this,'DD/MM/YYYY');validateDate_BackDate(this.value,this);" onkeyup="clickclear(this, 'DD/MM/YYYY')" 
											onchange="clickrecall(this,'DD/MM/YYYY');validateDate_FutureDate(this.value,this);" aria-required="true" autocomplete="off" style="color: rgb(0, 0, 0);" >
						                </div>
						            </div>
	              			     ...
	              			     <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                       <label class=" form-control-label" id="pay_reject_remarks"></label>		 
						                </div>
						            </div>
	              				</div>
						...
						<div class="card-footer" align="center" class="form-control">
		              	<input type="button" class="btn btn-primary btn-sm" value="Update" onclick="validate_pay_group();">		              
			             <input type="button" class="btn btn-danger btn-sm" value="Delete" onclick="validate_group_pay_remove();">
			            </div>  
						</div>
					</div>
				</div>
	...
	<!-- END PAY GROUP DETAIL -->
	
	
	<!-- START SENIORITY DETAIL -->
<c:if test="${SeniorityDetails != 0}"> 
 <form id="form_seniority">
		<div class="card">
			<div class="panel-group" id="accordion17">
				<div class="panel panel-default" id="ii_div16">
					<div class="panel-heading">
						<h4 class="panel-title main_title green" id="ii_div5">
							<a class="droparrow collapsed" data-toggle="collapse"
								data-parent="#accordion17" href="#" id="ii_final" onclick="divN(this)"
								><b>CHANGE IN DATE OF SENIORITY</b></a>
						</h4>
					</div>
					<div id="collapse1ii" class="panel-collapse collapse">
			          <div class="card-body card-block">
			            <br>
			            <input type="button" name="save" class="btn btn-primary btn-sm" value="View History" onclick="Pop_Up_History('Trade');" /> 
							<div class="row">
						<div class="col-md-12">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                   <input type="text" id="se_authority" name="se_authority" onkeyup="return specialcharecter(this)" class="form-control autocomplete" autocomplete="off" maxlength="100" > 
						                   <input type="hidden" id="se_id" name="se_id" value="0" class="form-control"  autocomplete="off" >
						                </div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						               <input type="text" name="se_date_authority" id="se_date_authority" maxlength="10"  onclick="clickclear(this, 'DD/MM/YYYY')" class="form-control" style="width: 93%;display: inline;"
											onfocus="this.style.color='#000000'" onblur="clickrecall(this,'DD/MM/YYYY');validateDate_BackDate(this.value,this);" onkeyup="clickclear(this, 'DD/MM/YYYY')" 
											onchange="clickrecall(this,'DD/MM/YYYY');validateDate_FutureDate(this.value,this);" aria-required="true" autocomplete="off" style="color: rgb(0, 0, 0);" >
						                </div>
						            </div>
	              			...
	              			<div class="col-md-12">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label">Old Date of Seniority</label>
						                </div>
						                <div class="col-md-8">
											<label id="old_dt_seniority"> </label>
						                </div>
						            </div>
	              				</div>
	              			    <div class="col-md-6">
	              			...
	              			<div class="col-md-12">	              					
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong
											style="color: red;">* </strong> Reason for the Change</label>
						                </div>
						                <div class="col-md-8">
						                <input type="text" id="reason_for_change" onkeypress="return onlyAlphabets(event);" onkeyup="return specialcharecter(this)" class="form-control autocomplete" autocomplete="off" maxlength="50" >
						                </div>
						            </div>
	              				</div>
	              			     ...
	              			     <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                       <label class=" form-control-label" id="seniority_reject_remarks"></label>		 
						                </div>
						            </div>
	              				</div>
						...
						<div class="card-footer" align="center" class="form-control">
		              		 <input type="button" class="btn btn-primary btn-sm" value="Update" onclick="validate_seniority();">
		              		 <input type="button" class="btn btn-danger btn-sm" value="Delete" onclick="validate_seniority_remove();">		              
			            </div>  
						</div>
					</div>
				</div>
	...
	<c:if test="${AttachmentDetails != 0}"> 
 <form id="form_attachment">
		<div class="card">
			<div class="panel-group" id="accordion17">
				<div class="panel panel-default" id="jj_div16">
					<div class="panel-heading">
						<h4 class="panel-title main_title green" id="jj_div5">
							<a class="droparrow collapsed" data-toggle="collapse"
								data-parent="#accordion17" href="#" id="jj_final" onclick="divN(this)"
								><b>ATTACHMENT DETAILS</b></a>
						</h4>
					</div>
					<div id="collapse1jj" class="panel-collapse collapse">
			          <div class="card-body card-block">
			            <br>
							<div class="row">
						<div class="col-md-12">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                   <input type="text" id="att_authority" name="att_authority" onkeyup="return specialcharecter(this)" class="form-control autocomplete" autocomplete="off" maxlength="100" > 
						                   <input type="hidden" id="att_id" name="att_id" value="0" class="form-control"  autocomplete="off" >
						                </div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						               <input type="text" name="att_date_authority" id="att_date_authority" maxlength="10"  onclick="clickclear(this, 'DD/MM/YYYY')" class="form-control" style="width: 93%;display: inline;"
											onfocus="this.style.color='#000000'" onblur="clickrecall(this,'DD/MM/YYYY');validateDate_BackDate(this.value,this);" onkeyup="clickclear(this, 'DD/MM/YYYY')" 
											onchange="clickrecall(this,'DD/MM/YYYY');validateDate_FutureDate(this.value,this);" aria-required="true" autocomplete="off" style="color: rgb(0, 0, 0);" >
						                </div>
						            </div>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong
											style="color: red;">* </strong> Movement Order Number</label>
						                </div>
						                <div class="col-md-8">
						                   <input type="text" id="att_movement_number" name="att_movement_number" onkeypress="return onlyAlphaNumeric(event);" class="form-control autocomplete" autocomplete="off" maxlength="100" > 
						                </div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong
											style="color: red;">* </strong> Date of Movement Order</label>
						                </div>
						                <div class="col-md-8">
						               <input type="text" name="att_date_of_move" id="att_date_of_move" maxlength="10"  onclick="clickclear(this, 'DD/MM/YYYY')" class="form-control" style="width: 93%;display: inline;"
											onfocus="this.style.color='#000000'" onblur="clickrecall(this,'DD/MM/YYYY');validateDate_BackDate(this.value,this);" onkeyup="clickclear(this, 'DD/MM/YYYY')" 
											onchange="clickrecall(this,'DD/MM/YYYY');validateDate_FutureDate(this.value,this);" aria-required="true" autocomplete="off" style="color: rgb(0, 0, 0);" >
						                </div>
						            </div>
	              			...
	              			<div class="col-md-12">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label">Parent Arm/Service</label>
						                </div>
						                <div class="col-md-8">
											<label id="old_att_parent_arm"> </label>
						                </div>
						            </div>
	              				</div>
	              			    <div class="col-md-6">
	              					<div class="row form-group">
						                ...
						                <div class="col-md-8">
											<label id="old_att_regiment"> </label>
						                </div>
						            </div>
	              				</div>
	              			</div>
	              			...
	              			<div class="col-md-12">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label">From Unit SUS No</label>
						                </div>
						                <div class="col-md-8">
											<label id="old_att_sus_no"> </label>
						                </div>
						            </div>
	              				</div>
	              			    <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                  ...
						                  <div class="col-md-8">
											<label id="old_att_unit_name" > </label>
						                </div>
						            </div>
	              				</div>
	              			</div>
	              			...
	              			<div class="col-md-12">	              					
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong
											style="color: red;">* </strong> Attached to (Unit SUS No)</label>
						                </div>
						                <div class="col-md-8">
						                <input type="text" id="att_sus_no" name="att_sus_no" onkeyup="return specialcharecter(this)" class="form-control autocomplete" autocomplete="off" maxlength="8" >
						                </div>
						            </div>
	              				</div>
	              					...
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                <input type="text" id="att_unit_name" name="att_unit_name" onkeyup="search_unit(this,'i_from_sus_no') ; specialcharecter(this)" class="form-control autocomplete" autocomplete="off" maxlength="50" >
						                </div>
						            </div>
	              				</div>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong
											style="color: red;">* </strong> Place</label>
						                </div>
						                <div class="col-md-8">
						                <input type="text" id="att_place" name="att_place" onkeypress="return onlyAlphabets(event);" onkeyup="return specialcharecter(this)" class="form-control autocomplete" autocomplete="off" maxlength="50" >
						                </div>
						            </div>
	              				</div>
	              			</div>
	              				 	...
	              				 	<div class="col-md-12" style="font-size: 15px;">	
               	<label for="text-input" class=" form-control-label" style="color: #dd1a3e; margin-left:10px;"><u>Period of Attachment</u> </label>
            </div>
            	...
            	<div class="col-md-12">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                   <input type="text" name="att_from" id="att_from" maxlength="10"  onclick="clickclear(this, 'DD/MM/YYYY')" class="form-control" style="width: 93%;display: inline;"
											onfocus="this.style.color='#000000'" onblur="clickrecall(this,'DD/MM/YYYY');validateDate_BackDate(this.value,this);" onkeyup="clickclear(this, 'DD/MM/YYYY')" 
											onchange="clickrecall(this,'DD/MM/YYYY');calc_duration();validateDate_FutureDate(this.value,this);" aria-required="true" autocomplete="off" style="color: rgb(0, 0, 0);" >
						                </div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						               <input type="text" name="att_to" id="att_to" maxlength="10"  onclick="clickclear(this, 'DD/MM/YYYY')" class="form-control" style="width: 93%;display: inline;"
											onfocus="this.style.color='#000000'" onblur="clickrecall(this,'DD/MM/YYYY');validateDate_BackDate(this.value,this);" onkeyup="clickclear(this, 'DD/MM/YYYY')" 
											onchange="clickrecall(this,'DD/MM/YYYY');calc_duration();validateDate_FutureDate(this.value,this);" aria-required="true" autocomplete="off" style="color: rgb(0, 0, 0);" >
						                </div>
						            </div>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                <input type="text" id="att_duration" name="att_duration" onkeyup="return specialcharecter(this)" class="form-control autocomplete" autocomplete="off" maxlength="50" readonly="readonly">
						                </div>
						            </div>
	              				</div>
	              					...
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong
											style="color: red;">* </strong> Reasons</br>(Med/Legal/Official/Adm etc...)</label>
						                </div>
						                <div class="col-md-8">
						                <input type="text" id="att_reasons" name="att_reasons" onkeyup="return specialcharecter(this)" class="form-control autocomplete" autocomplete="off" maxlength="50" >
						                </div>
						            </div>
	              				</div>
	              			</div>
						...
						<div class="card-footer" align="center" class="form-control">
		              		 <input type="button" class="btn btn-primary btn-sm" value="Update" onclick="validate_attachment();">
		              		 <input type="button" class="btn btn-danger btn-sm" value="Delete" onclick="validate_attachment_remove();">		              
			            </div>  
						</div>
					</div>
				</div>
	...
	<!-- Start TYPE OF POSTING -->
		<c:if test="${changeofposting != 0}"> 
	 <form id="form_Changetype_of_posting">
		<div class="card">
			<div class="panel-group" id="accordion4">
				<div class="panel panel-default" id="pp_div1">
					<div class="panel-heading">
						<h4 class="panel-title main_title red" id="a_div5">
								<a class="droparrow collapsed" data-toggle="collapse"
								data-parent="#accordion17" href="#" id="pp_final" onclick="divN(this)"
								><b>CHANGE IN TYPE OF POSTING</b></a>
						</h4>
					</div>
					<div id="collapse1pp" class="panel-collapse collapse">
			                <div class="card-body card-block"><br>
					 ...
					 <div class="col-md-12">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong
										style="color: red;">* </strong>Type of Posting</label>
						                </div>
						                <div class="col-md-8">
						                   <input type="hidden" id="ch_pp_id" name="ch_pp_id" value="0" class="form-control" />  
						                <select name="type_of_posting" id="type_of_posting" class="form-control">
												<option value="-1">--Select--</option>
												<c:forEach var="item" items="${gettype_of_postingList}" varStatus="num">
													<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
												</c:forEach>
											</select>
						                </div>
	              			     ...
	              			     <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                       <label class=" form-control-label" id="post_reject_remarks"></label>		 
						                </div>
						            </div>
	              				</div>
	              				</div>
						...
						<div class="card-footer" align="center" class="form-control">
		              		 <input type="button" class="btn btn-primary btn-sm" value="Update" onclick="validate_post();">
		              		 <input type="button" class="btn btn-danger btn-sm" value="Delete" onclick="validate_post_remove();">		              
			            </div>  
						</div>
					</div>
				</div>
...
function divN(obj){
	...
	var hasC=$("#"+sib_id).hasClass("show");
		...
		else if (obj.id == "ff_final") {
			if(!hasC){
				get_trade_details();
			}
		}
		
		else if (obj.id == "gg_final") {
			if(!hasC){
				get_class_pay_details();
			}
		}
		
		else if (obj.id == "hh_final") {
			if(!hasC){
				get_pay_group_details();
			}
		} 
		
		else if (obj.id == "ii_final") {
			if(!hasC){
				get_seniority_details();
			}
		} 
		
		else if (obj.id == "jj_final") {
			if(!hasC){
...
function get_postingtype(){
	 ...
	 var i=0;
	  $.post('change_of_post_GetJCOData3?' + key + "=" + value, {jco_id:jco_id}, function(j){
			var v=j.length;
			
			if(v!=0){
				$('#ch_pp_id').val(j[i].id);
				 $("#type_of_posting").val(j[i].type_of_post);
				 $("#post_reject_remarks").text(j[i].reject_remarks);
	    	...
	    	$.post('GetJcoOrCensusDataApprove?' + key + "=" + value,{ jco_id : jco_id },function(k) {
	    		 if(k.length > 0)
	    		 {
	    			  ...
	    			  $('#marriage_div').show();
	    			   ...
	    			   $("#cadet_name").text(k[0].full_name);
	    		    	...
	    		    	if(k[0].date_of_attestation!=null){
	    		    		dateOfAttestaion=ParseDateColumncommission(k[0].date_of_attestation);
	    		    	}
	    		    	if(k[0].rank=='RECTS' && dateOfAttestaion=='')
	    		    		$("#attestationDiv").show();
	    		    	else
	    		    		$("#attestationDiv").hide();
	    		    	...
	    		    	$('#old_att_parent_arm').text(k[0].parent_arm );
	    		    	...
	    		    	if(k[0].regiment!=0){
	    		    		...
	    		    		$('#old_att_regiment').text($( "#inter_arm_regt_val option:selected" ).text());
	    		    	}
	    		    	else{
	    		    		$('#p_regt').text("");
	    		    	}
	    		    	
	    		    	$("#old_att_sus_no").text(k[0].unit_sus_no);
	    		    	var att_sus_no = $("#old_att_sus_no").text(k[0].unit_sus_no);
	    	 ...
	    	 $.post('GetServingStatusJCO?' + key + "=" + value,{ jco_id : jco_id },function(k) {
	    		 if(k.length > 0)
	    		 {
	    		    	...
	    		    	$.post("getJcoOr_Non_EffectiveList?" + key + "=" + value, {
...
function SubmitAll(){
	var jco_id=$('#jco_id').val();
	var event ='${event}';
	 $.post('Submit_Reject_UpadteJCODataUrl?' + key + "=" + value,{ jco_id : jco_id,event:event },function(k) {
...
function validate_ChngofRank_remove(){
       ...
       if(rc){
       var id=$('#ch_r_id').val();
        $.post('ChngofRank_delete_JCOaction?' + key + "=" + value, {id:id}, function(data){ 
                         if(data=='1'){
...
function validate_ChngofRank_save(){
	...
	var army_no_id=$('#army_no_id').val();
	   ...
	   $.post('Change_of_Rank_JCOaction?' + key + "=" + value, {dateOfAttestaion:dateOfAttestaion,app_status:app_status,army_no_id:army_no_id,preCategory:preCategory,change_category:change_category,army_no1:army_no1,army_no2:army_no2,army_no3:army_no3,prerank:prerank,date_of_attestation:date_of_attestation,authority:authority,date_of_authority:date_of_authority,
		  rank:rank,date_of_rank:date_of_rank,enroll_date:enroll_date,jco_id:jco_id,ch_r_id:ch_r_id}, function(data){
...
function getChangeOfRank(){
	...
	var jco_id=$('#jco_id').val();
	var i=0;
	 $.post('getChangeOfRankDataJCO3?' + key + "=" + value, {jco_id:jco_id}, function(j){
		 if(j!=""){
			 $('#ch_r_id').val(j[0].id);
				...
				$.post('getChangeOfArmy_NO_JCOData3?' + key + "=" + value, {rank_id:rank_id,jco_id:jco_id}, function(k){
					 if(k.length!=0){
						 
						if(k[0].army_no == '' || k[0].army_no==null)
						{
						...
						else
						{
						 ...
						 var l1=k[0].army_no.length;
						
						 if(change_category=="JCO"){
						var l2=k[0].army_no.split(/\d/)[0].length;
						 $('#army_no1').val(k[0].army_no.split(/\d/)[0]);
						 $('#army_no2').val(k[0].army_no.slice(l2, l1-1));
						 $('#army_no3').val(k[0].army_no.substr(-1));
						 }
						 /* else{
								$("#army_no1Div").hide();
								$("#army_no1").val("0");
							 $('#army_no2').val(k[0].army_no.slice(0, l1-1));
							 $('#army_no3').val(k[0].army_no.substr(-1));
						 } */
					 }
				 });
...
function Army_no_already_exist()
{
	 ...
	 var army_no = "";
	 if(change_category=="JCO")
	 	army_no=army_no1 + army_no2 + army_no3;
	 else
		 army_no=army_no2 + army_no3;
	 
	 var army_id=$('#army_no_id').val();
	 var j2=false;
	 	$.post("getArmyNoAlreadyExist?"+key+"="+value, {army_no : army_no,army_id:army_id}).done(function(j) {
	 		
		 	if(j == false){
				alert("Army Number already Exits")
				$("select#army_no1").val("0");
				$("input#army_no2").val("");
				$("input#army_no3").val("0");
			} 
			j2=!j;
		}); 
	 return j2;	
...
function validate_post(){
	 ...
	 var ch_pp_id=$('#ch_pp_id').val();
		...
		formdata+="&jco_id="+jco_id+"&ch_pp_id="+ch_pp_id;	
...
function validate_post_remove(){
	   var rc = confirm("Are You Sure! You Want To Delete");
if(rc){
var id=$('#ch_pp_id').val();


$.post('Change_of_post_JCOdelete_action?' + key + "=" + value, {id:id}, function(data){ 
    if(data=='1'){
        alert("Data Deleted Successfully");
        $('#ch_pp_id').val(0);
				 $("#type_of_posting").val('-1');
				 $('#form_Changetype_of_posting').hide();
    }
     else{
         alert("Data not Deleted ");
      }
...
function get_change_of_name(){
	 ...
	 var jco_id = '${jco_id}';
var i=0;
	  $.post('change_of_name_GetJCOData3?' + key + "=" + value, {jco_id:jco_id }, function(j){
...
function validate_Change_of_name_remove(){
    ...
    if(rc){
    var id=$('#name_id').val();
     $.post('Change_of_name_JCOdelete_action?' + key + "=" + value, {id:id}, function(data){ 
                      if(data=='1'){
                          alert("Data Deleted Successfully");
                          $('#name_id').val(0);
         				 $("#na_authority").val('');
...
function validate_Change_of_name_save_fn(){
	...
	formdata+="&jco_id="+jco_id+"&enroll_date="+enroll_date+"&app_status="+app_status;		
...
function get_Appointment(){
	 ...
	 var jco_id = '${jco_id}';
	  $.post('get_AppointmentJCO3?' + key + "=" + value, { jco_id:jco_id}, function(j){
...
// 				 appNamechng();
// 				 $("#x_sus_no").val(j[0].x_list_sus_no);
// 				 $("#x_list_loc").val(j[0].x_list_loc);
			}
	  });
}	
...
function validate_appointment_remove(){
 ...
 var id=$('#appoint_id').val();
  $.post('appointment_delete_JCOaction?' + key + "=" + value, {id:id}, function(data){ 
                   if(data=='1'){
                       alert("Data Deleted Successfully");
                       $('#appoint_id').val(0);
      				 $("#appt_authority").val('');
...
function validate_appointment_save(){
	...
	formdata+="&jco_id="+jco_id+"&enroll_date="+enroll_date+"&tos_date="+tos_date;	
...
function getIdentity_Card(){
	 ...
	 var jco_id=$('#jco_id').val(); 
	 var i=0
	  $.post('getIdentity_CardJCO3?' + key + "=" + value, {jco_id:jco_id }, function(j){
			var v=j.length;
			if(v!=0){
...
function validate_identity_card_remove(){
 ...
 if(rc){
 var id=$('#card_id').val();
  $.post('Change_identity_card_JCOdeleteaction?' + key + "=" + value, {id:id}, function(data){ 
                   if(data=='1'){
                       alert("Data Deleted Successfully");
                       $('#card_id').val('');
      				 $("#id_card_no").val('');
...
function validate_identity_card_save(){
	...
	if(eye_colourV == "OTHERS" || eye_colourV == "OTHER"){
		if(lengthValidation($("input#eye_colour").val().trim(),auth_length)){
	...
	if(years>=8){
	 ...
	 var form_data = new FormData(document.getElementById("form_identity_card"));		
		form_data.append("jco_id",jco_id);
...
//***********************START TA STATUS****************************//
function get_ta_status_reject(){
	
	 var jco_id = '${jco_id}';
var i=0;
	  $.post('ta_status_jco_GetData3?' + key + "=" + value, {jco_id:jco_id }, function(j){
...
function validate_ta_jco_remove(){
	   var rc = confirm("Are You Sure! You Want To Delete");
    if(rc){
    var id=$('#ta_id').val();
     $.post('Change_TA_Status_jco_delete_action?' + key + "=" + value, {id:id}, function(data){ 
                      if(data=='1'){
                          alert("Data Deleted Successfully");
                          $('#ta_id').val(0);
         				 $("#ta_authority").val('');
...
function validate_ta_jco_save_fn(){
	 if ($("input#ta_authority").val().trim()=="") {
			alert("Please Enter Authority");
			$("input#ta_authority").focus();
			return false;
		}
	 if(lengthValidation($("input#ta_authority").val().trim(),auth_length)){
			alert("Authority Length Should be Less or Equal To 100")
			$("#ta_authority").focus();
			return false;
		}
	 	...
	 	if ($("input#ta_status").val() == "0") {
			alert("Please select TA Status ");
			$("input#ta_status").focus();
			return false;
		}
	...
	formdata+="&jco_id="+jco_id+"&enroll_date="+enroll_date+"&app_status="+app_status;		
	   $.post('ta_status_jco_action?' + key + "=" + value, formdata, function(data){		      
	          if(data=="update")
	        	  alert("Data Updated Successfully");
	          else if(parseInt(data)>0){
...
function validate_Religion_remove(){
 ...
 if(rc){
 var id=$('#rel_id').val();
  $.post('Change_Religion_delete_action_jco?' + key + "=" + value, {id:id}, function(data){ 
                   if(data=='1'){
                       alert("Data Deleted Successfully");
                       $('#rel_id').val(0);
      				 $("#rel_authority").val('');
...
function get_religion(){
	var jco_id=$('#jco_id').val(); 
	  ...
	  $.post('religion_GetData3_jco?' + key + "=" + value, {jco_id:jco_id}, function(j){
			if(j!=0){
				$('#rel_id').val(j[0].id);
...
function married_remove_fn(){
 ...
 var marital_event=$('#marital_event').val();
  $.post('updated_family_marriage_delete_JCOaction?' + key + "=" + value, {jco_id:jco_id}, function(data){ 
                   if(data=='1'){
                       alert("Data Deleted Successfully");
                       $("#marr_save").hide();
                       $("#marr_ch_id").val(0);
...
function married_save_fn(ps){
    ...
    if(lengthValidation($("input#marriage_authority").val().trim(),auth_length)){
		alert("Authority Length Should be Less or Equal To 100");
		$("#marriage_authority").focus();
		return false;
     ...
     if(getformatedDate($("input#enroll_date").val()) > getformatedDate($("#marriage_date_of_authority").val())) {
        ...
        if(marital_event == 1 || marital_event == 3){
        	...
        	if(curr_marital_status==13){
                ...
                if($("#marriage_nationality option:selected").text().toUpperCase()==other || $("#marriage_nationality option:selected").text().toUpperCase()=="OTHER" ) {
                ...
                if($("#marriage_nationality option:selected").text().toUpperCase()==other || $("#marriage_nationality option:selected").text().toUpperCase()=="OTHER" ) {
	                if(lengthValidation($("input#spouseNationality_other").val().trim(),auth_length)){
	    				alert("Nationality Other Length Should be Less or Equal To 100")
	    				$("#spouseNationality_other").focus();
	    				return false;
	    			}
                }
                ...
                if(ser_radio=="Yes"){
                        if(spouse_service==null || spouse_service=='0'){
                                ...
                                else if(spouse_service=='4'){
            						if(lengthValidation($("input#spouseSer_other").val().trim(),auth_length)){
            							alert("Service Other Length Should be Less or Equal To 100")
            							$("#spouseSer_other").focus();
            							return false;
            						}
            					}
        ...
        if(marital_event=='4'){
           ...
           $.post('update_family_marriage_JCOaction?' + key + "=" + value, {separated_to_dt:separated_to_dt,separated_from_dt:separated_from_dt,curr_marital_status:curr_marital_status,maiden_name:maiden_name,marriage_date_of_birth:marriage_date_of_birth,
                   ...
                   ,marriage_nationality_other:marriage_nationality_other,enroll_date:enroll_date,marital_event:marital_event,jco_id:jco_id ,marital_status:marital_status,ser_radio:ser_radio,spouse_service:spouse_service,spouseSer_other:spouseSer_other,spouse_personal_no:spouse_personal_no}, function(data){
                	   if(data=="update"){
...
if(institute.trim()=="") {
	...
	$.post('spouse_qualification_JCOaction?' + key + "=" + value, {
		type: type,
		...
		spouse_id: spouse_id,app_status:app_status
	}, function(data) {
		if(parseInt(data) > 0) {
			if(($('#marital_event').val()=='1' && curr_marital_status==10)  || $('#marital_event').val()=='3'){
...
function remove_spouse_qualificationFn(){
	var jco_id=$('#jco_id').val();	
	  $.post('updated_family_marriage_delete_JCOaction?' + key + "=" + value, {jco_id:jco_id,qali_status:1}, function(data){ 
	                   if(data=='1'){
...
function getSpouseQualificationData() {
	var jco_id = $('#jco_id').val();
	var i = 0;
	$.post('getSpouseQualificationJCOData?' + key + "=" + value, {
		jco_id:jco_id,app_status:app_status
	}, function(j) {
		var v = j.length;
		if(v != 0) {
...
var cur_merital_event="";
function getfamily_marriageDetails(){	
	 var jco_id=$('#jco_id').val(); 
	 var marital_event=$('#marital_event').val();
	  $.post('update_getfamily_marriageDataJCO3?' + key + "=" + value, {marital_event:marital_event,jco_id:jco_id,app_status:app_status }, function(j){
			var v=j.length;
		if(v!=0){
...
//*************************************Start Children Details*****************************//
		...
		function m_children_details_save_fn(ps) {
			...
			$.post('m_children_details_action_jco?' + key + "=" + value, {
				sib_name : sib_name,
		...
		function m_children_details_remove_fn(R){
			...
			var sib_ch_id=$('#sib_ch_id'+R).val();
			  $.post('m_children_details_delete_action_jco?' + key + "=" + value, {sib_ch_id:sib_ch_id }, function(data){ 
...
// 					  			 }
		...
		function m_children_Details() {
			var jco_id = $('#jco_id').val();
			var i = 0;
			$.post('getm_children_detailsData3_jco?' + key + "=" + value,{jco_id:jco_id},function(j) {
				var v = j.length;
				if (v != 0) {
...
function validate_nok_remove(){
 ...
 if(rc){
 var id=$('#nok_id').val();
  $.post('NOK_delete_action_jco?' + key + "=" + value, {id:id}, function(data){ 
                   if(data=='1'){
                       alert("Data Deleted Successfully");
                       $("#authority").val('');
       				$('#date_authority').val(''); 
  ...
  var text2 = $("#nok_state option:selected").text().toUpperCase();
   ...
   var jco_id =$("#jco_id").val();
	var nok_id=$("#nok_id").val();		
		formvalues+="&nok_id="+nok_id+"&jco_id="+jco_id+"&enroll_date="+enroll_date+"&app_status="+app_status;	
		formvalues+="&nok_country_text="+nok_country_text;
		 $.post('nok_details_action_jco?' + key + "=" + value,formvalues, function(data){
			 if(data=="update")
	        	  alert("Data Updated Successfully");
	          else if(parseInt(data)>0){
	        	  $("#nok_id").val(data);	
...
function get_nokaddress_details(){
	 var jco_id='${jco_id}';
	$.post('nok_details_GetData3_jco?' + key + "=" + value,{jco_id:jco_id }, function(j){
		var v=j.length;
			if(v!=0){
				//////nok//////
...
function validate_changeaddress_details_remove(){
 ...
 var id=$('#addr_ch_id').val();
  $.post('Changeaddress_details_delete_JCOaction?' + key + "=" + value, {id:id}, function(data){ 
                   if(data=='1'){
                       alert("Data Deleted Successfully");
                       $("#pre_country").val(0);
...
var text14 = $("#spouse_addr_district option:selected").text().toUpperCase();
	...
	var addr_ch_id=$("#addr_ch_id").val();	
		...
		formvalues+="&addr_ch_id="+addr_ch_id+"&jco_id="+jco_id+"&marital_status="+marital_status+"&enroll_date="+enroll_date+"&app_status="+app_status;	
		...
		formvalues+="&per_home_addr_country_text="+per_home_addr_country_text;
		 $.post('changeaddress_details_JCOaction?' + key + "=" + value,formvalues, function(data){
			 if(data=="update")
	        	  alert("Data Updated Successfully");
	          else if(parseInt(data)>0){
	        	  $("#addr_ch_id").val(data);	
...
function get_changeaddress_details(){
	...
	$.post('address_details_GetDataJCO3?' + key + "=" + value,{jco_id:jco_id }, function(j){
		var v=j.length;
		if(v!=0){
			...
			if($("#marital_status_p").text() == '8' && j[0].spouse_country != 0){
				...
				$("#add_reject_remarks").text(j[0].reject_remarks);
...
function validate_cda_acnt_no_remove(){
 ...
 if(rc){
 var id=$('#cda_id').val();
  $.post('Cda_acnt_no_delete_action_jco?' + key + "=" + value, {id:id}, function(data){ 
                   if(data=='1'){
                       alert("Data Deleted Successfully");
                       $("#cda_account_no").val('');
           			$("#gmail").val('');
...
/*  if ($("input#nic_mail").val().trim()=="") {
 ...
 if ($("input#mobile_no").val().trim()=="" || $("input#mobile_no").val().trim().length<10 || $("input#mobile_no").val().trim().length>10) {
		...
		var jco_id=$("#jco_id").val();	
		formvalues+="&cda_id="+cda_id+"&jco_id="+jco_id+"&app_status="+app_status;
...
function get_cda_acnt_no(){
	var jco_id=$("#jco_id").val();
	$.post('cda_acnt_no_GetData3_jco?' + key + "=" + value,{ jco_id:jco_id}, function(j){
		...
		if(j!=0){
			...
			$("#cda_id").val(j[0].id);
			$("#contact_reject_remarks").text(j[0].reject_remarks);
		}
	  		}).fail(function(xhr, textStatus, errorThrown) {alert("fail to fetch")
		});
}
...
if (lang_std == "0") {
 ...
 var country_sel1 = $("#lang_std"+ps+" option:selected").text();
	  ...
	  $.post('update_offr_language_detail_action_jco?' + key + "=" + value, {language:language,other_lan:other_lan,lang_std:lang_std,other_lan_std:other_lan_std,lang_ch_id:lang_ch_id,jco_id:jco_id,lang_authority:lang_authority,lang_doa:lang_doa,enroll_date:enroll_date,app_status:app_status }, function(data){
	          if(data=="update")
	        	  alert("Data Updated Successfully");
	          else if(parseInt(data)>0){
...
function get_language_details(){
    var jco_id=$('#jco_id').val(); 
    var i=0;
     $.post('update_offr_getlanguagedetailsData3_jco?' + key + "=" + value, {jco_id:jco_id}, function(j){
                   var v=j.length;
                   if(v!=0){
           ...
           for(i;i<v;i++){
                   if(j[i].language!="0"){
                           ...
                           +'<select  id="language'+xl+'" name="language'+xl+'" value="'+j[i].language+'"  onchange="onLanguage('+xl+')" class="form-control autocomplete"  >'
                             +' <option value="0">--Select--</option>'
                              +'<c:forEach var="item" items="${getIndianLanguageList}" varStatus="num">'
                                   ...
                                   +'</select>'
                                   +'</td>'
                                   +'<td style="width: 10%;"> <input type="text" id="other_language'+xl+'" onkeypress="return onlyAlphaNumeric(event);" maxlength="100" name="other_language'+xl+'" value="'+j[i].other_language+'" class="form-control autocomplete" autocomplete="off" ></td>'                
                           +'<td style="width: 10%;"> '
                           ...
                           +'        </c:forEach>'
                           +'</select> </td> '
                           +'<td style="width: 10%;"> <input type="text" id="other_lang_std'+xl+'" name="other_lang_std'+xl+'" maxlength="100" onkeypress="return onlyAlphaNumeric(event);" value="'+j[i].other_lang_std+'" class="form-control autocomplete" autocomplete="off" ></td>'                
                   /*         +'<td style="width: 10%;">'
                           ...
                           $("table#foregin_language_table").append('<tr id="tr_flang'+xf+'">'
                                       ...
                                       +'        <c:forEach var="item" items="${getForiegnLangugeList}" varStatus="num">'
                                           ...
                                           +'        </c:forEach>'
                                           +'        </select></td>'
                                           +'<td style="width: 10%;"> <input type="text" id="f_other_language'+xf+'" maxlength="100" onkeypress="return onlyAlphaNumeric(event);" name="f_other_language'+xf+'" value="'+j[i].f_other_language+'" class="form-control autocomplete" autocomplete="off" ></td>'                
                                           +'<td style="width: 10%;"> '
                                           ...
                                           +'        </c:forEach>'
                                           +'</select> </td> '
                                           +'<td style="width: 10%;"> <input type="text" id="f_other_lang_std'+xf+'" maxlength="100" onkeypress="return onlyAlphaNumeric(event);" name="f_other_lang_std'+xf+'" value="'+j[i].f_other_lang_std+'" class="form-control autocomplete" autocomplete="off" ></td>'                
                                           ...
                                           +'        </c:forEach>'
                                           +' </select></td> '
                                           +'<td style="width: 10%;"> <input type="text" id="f_other_prof'+xf+'" name="f_other_prof'+xf+'" maxlength="100" value="'+j[i].f_other_prof+'" onkeypress="return onlyAlphaNumeric(event);" class="form-control autocomplete" autocomplete="off" ></td>'                        
...
function foregin_language_save_fn(ps){
	...
	if (lang_doa.trim()=="" || lang_doa == "DD/MM/YYYY") {
	 ...
	 if (exam_pass.trim()=="") {
	  ...
	  $.post('update_offr_foreginlanguage_detail_action_jco?' + key + "=" + value, {language:language,lang_prof:lang_prof,f_ot_language:f_ot_language,f_ot_std:f_ot_std,f_ot_prof:f_ot_prof,exam_pass:exam_pass,lang_authority:lang_authority,lang_doa:lang_doa,lang_std:lang_std,lang_ch_id:lang_ch_id,jco_id:jco_id}, function(data){
	          if(data=="update")
	        	  alert("Data Updated Successfully");
	          else if(parseInt(data)>0){
...
if(institute.trim()=="") {
	...
	$.post('update_offr_qualification_JCOaction?' + key + "=" + value, {
		type: type,
		examination_pass: examination_pass,
		passing_year: passing_year,
		div_class: div_class,
		...
		degree: degree,
		specialization: specialization,
		jco_id:jco_id,exam_other_qua:exam_other_qua,class_other_qua:class_other_qua,
		degree_other:degree_other,spec_other:spec_other,
		dateofBirthyear: dateofBirthyear,
...
function getQualifications() {
	var jco_id = $('#jco_id').val();
	var i = 0;
	$.post('getQualificationJCOData?' + key + "=" + value, {
		jco_id: jco_id,app_status:app_status
	}, function(j) {
		var v = j.length;
...
function deleteQualificationData(id) {
	...
	$.post('qualification_delete_JCOaction?' + key + "=" + value, {
		qualification_ch_id: qualification_ch_id
	}, function(data) {
		if(data == '1') {
			getQualifications();
...
function promo_exam_save_fn(ps){
	...
	if( Date.parse(dateofEnrollMonthY)> Date.parse((promo_exam_dop+"-01"))){
	  ...
	  $.post('update_offr_promo_exam_detail_action_jco?' + key + "=" + value, {exam_other_select:country_sel,promo_exam:promo_exam,e_ot:e_ot,promo_exam_dop:promo_exam_dop,promo_exam_ch_id:promo_exam_ch_id,jco_id:jco_id,promo_exam_authority:promo_exam_authority,promo_exam_doa:promo_exam_doa,app_status:app_status }, function(data){
	          if(data=="update")
	        	  alert("Data Updated Successfully");
	          else if(parseInt(data)>0){
...
function get_promo_exam_details(){
	 var jco_id=$('#jco_id').val(); 
	 var i=0;
	  $.post('get_PromotionExam3_jco?' + key + "=" + value, {jco_id:jco_id}, function(j){
			var v=j.length;
			if(v!=0){
		xpro=0;
		for(i;i<v;i++){
...
function onCoursetype(ind){
	var army_course_type = $("#army_course_type"+ind+" option:selected").text().toUpperCase();
	 
	if(army_course_type != "OTHERS" && army_course_type != "OTHER"){
	...
	if (army_course_date_of_completion.trim()=="" || army_course_date_of_completion == "DD/MM/YYYY") {
	  ...
	  $.post('update_JCO_army_course_detail_action?' + key + "=" + value, 
			  {enroll_date:enroll_date,army_course_name:army_course_name,army_course_div_grade:army_course_div_grade,ar_course_div_ot:ar_course_div_ot,
		  		...
		  		jco_id:jco_id,army_course_authority:army_course_authority,army_course_doa:army_course_doa,army_course_institueV:army_course_institueV,army_course_abbr:army_course_abbr,army_course_institue:army_course_institue,army_course_institue_ot:army_course_institue_ot }, function(data){
	          if(data=="update")
	        	  alert("Data Updated Successfully");
	          else if(parseInt(data)>0){
...
function get_army_course_details(){
	 ...
	 var jco_id=$('#jco_id').val(); 
	 var i=0;
	  $.post('get_ArmyCourseJCO3?' + key + "=" + value, {jco_id:jco_id}, function(j){
			var v=j.length;
			if(v!=0){
		xaco=0;
		for(i;i<v;i++){
...
function onBeptResult(ind){
	...
	var l_result_others=$('#bept_result_others'+ps).val().toUpperCase();
    ...
    var unit_sus_no=$('#be_unit_sus_no'+ps).val();
	...
	if (BPET_result == "-1") {
	   ...
	   $.post('BPET_JCOaction?' + key + "=" + value, {BPET_result : BPET_result ,bept_result_others:bept_result_others,BPET_qe : BPET_qe,
		   year:year,unit_sus_no:unit_sus_no,id : id,jco_id:jco_id,app_status:app_status }, function(data){
	          if(data=="update")
	        	  alert("Data Updated Successfully");
	          else if(parseInt(data)>0){
	        	 $('#id'+ps).val(data);
...
function bpet_Details() {
	...
	var jco_id = $('#jco_id').val();
	var i = 0;
	$.post('getbpet_DataJCO3?' + key + "=" + value,{jco_id:jco_id},function(j) {
		var v = j.length;
		if (v != 0) {
			$('#bpettbody').empty();
			for (i; i < v; i++) {
				...
				$("#bept_reject_remarks").text(j[i].reject_remarks);
				onBeptResult(x);
...
/////////////////////For data get fire standard
		function fire_Details() {
			var jco_id = $('#jco_id').val();
			var i = 0;
			$.post('getfire_detailsData3_jco?' + key + "=" + value,{jco_id:jco_id},function(j) {
				var v = j.length;
				if (v != 0) {
					$('#fire_stdtbody').empty();
					for (i; i < v; i++) {
...
function fire_std_save_fn(ps){
	...
	$.post('fire_std_action_jco?' + key + "=" + value, {firing_grade:firing_grade,ot_firing_grade:ot_firing_grade,firing_event_qe:firing_event_qe,
	   year:year,firing_unit_sus_no:firing_unit_sus_no,fire_id:fire_id,jco_id:jco_id,app_status:app_status }, function(data){
	      if(data=="update")
	    	  alert("Data Updated Successfully");
	      else if(parseInt(data)>0){
	    	 $('#fire_id'+ps).val(data);
...
function allergic_save_fn(ps){
	...
	if (allergic == "") {
	  ...
	  $.post('update_offr_allergic_detail_action_jco?' + key + "=" + value, {allergic:allergic,allergic_ch_id:allergic_ch_id,jco_id:jco_id,app_status:app_status }, function(data){
	          if(data=="update")
	        	  alert("Data Updated Successfully");
	          else if(parseInt(data)>0){
...
function get_allergic_details(){
	var jco_id='${jco_id}';
	 ...
	 var i=0;
	  $.post('get_Allergy3_jco?' + key + "=" + value, {jco_id:jco_id}, function(j){
		...
		for(i;i<v;i++){
			...
			xaller=xaller+1;
				...
				$("#allergi_reject_remarks").text(j[i].reject_remarks);
			...
			if(pup_sel == "OTHERS" ||  pup_sel == "OTHER"){
				if(lengthValidation($("input#purpose_visit_ot"+ps).val().trim(),auth_length)){
					...
					return false;
					   ...
					   $.post('UPforegin_country_action_jco?' + key + "=" + value, {country:country,other_ct:other_ct,period:period,from_dt:from_dt,to_dt:to_dt,purpose_visit:purpose_visit,other_purpose_visit:other_purpose_visit,foregin_country_ch_id:foregin_country_ch_id,jco_id:jco_id,app_status:app_status}, function(data){	 
			          if(data=="update")
			        	  alert("Data Updated Successfully");
			          else if(parseInt(data)>0){
...
function getUPForeign_CountriesDetails(){
    var jco_id=$('#jco_id').val(); 
    var i=0;
     $.post('get_ForeignCountry3_jco?' + key + "=" + value, {jco_id:jco_id }, function(j){
                   var v=j.length;
                   if(v!=0){
           ...
           for(i;i<v;i++){
             ...
             $("#foregin_country_reject_remarks").text(j[i].reject_remarks);
              onPurposeVisited(f);
...
function awardsNmedal_save_fn(qs){
                ...
                $.post('awardsNmedal_action_jco?' + key + "=" + value, {Category_8:Category_8,select_desc:select_desc,date_of_award:date_of_award,awardsNmedal_unit:awardsNmedal_unit,awardsNmedal_bde:awardsNmedal_bde,awardsNmedal_div_subarea:awardsNmedal_div_subarea,awardsNmedal_corps_area:awardsNmedal_corps_area,awardsNmedal_command:awardsNmedal_command,awardsNmedal_ch_id:awardsNmedal_ch_id,jco_id:jco_id,anm_authority:anm_authority,anm_doa:anm_doa,app_status:app_status }, function(data){           
                          if(data=="update")
                                  alert("Data Updated Successfully");
                          else if(parseInt(data)>0){
...
function getawardsNmedals(){
    var jco_id=$('#jco_id').val();
    var i=0;
     $.post('get_Award3_jco?' + key + "=" + value, {jco_id:jco_id}, function(j){
                   var v=j.length;
                   if(v!=0){
...
function validate_batnpc_remove(){
 ...
 var id=$('#batnpc_ch_id').val();
  $.post('batnpc_delete_action_jco?' + key + "=" + value, {id:id}, function(data){ 
                   if(data=='1'){
                       alert("Data Deleted Successfully");
...
function validate_batnpc_save(){
	...
	if(lengthValidation($("input#batnpc_authority").val().trim(),auth_length)){
		alert("Authority Length Should be Less or Equal To 100");
		$("#batnpc_authority").focus();
		return false;
 	...
 	if(getformatedDate($("input#enroll_date").val()) > getformatedDate($("#batnpc_date_of_authority").val())) {
		alert("Authority Date should be Greater than Enrollment Date");
		$("input#batnpc_date_of_authority").focus();
		return false;
  }
 	...
 	if(getformatedDate($("input#dob_date").val()) >= getformatedDate($("#date_of_casuality").val())) {
		alert("Date of Casualty should be Greater than Date Of Birth");
		$("input#date_of_casuality").focus();
		return false;
	}
	...
	if ($('input[name="nok_informed"]:checked').length == 0) {
		alert("Please Select Whether NOK Informed or Not");
	...
	//validation Ends
	  var formvalues=$("#form_battle_physical_casuality").serialize();
		...
		formvalues+="&jco_id="+jco_id+"&enroll_date="+enroll_date+"&app_unit_name="+app_unit_name;	
	   $.post('battle_physical_casualityAction_jco?' + key + "=" + value,formvalues, function(data){
		   if(data=="update"){
			   alert("Data Updated Successfully");
		   }
		   else if(parseInt(data)>0){
...
function get_Battle_and_Physical_Casuality_details(){
	...
	bindRadioBt();
	bindRadioButton();
	$.post('get_BattleCasulity3_jco?' + key + "=" + value,{jco_id:jco_id }, function(j){
		var v=j.length;
		if(v!=0){
			$.ajaxSetup({
				async : false
			...
			$("input#tehsil_other").val(j[0].tehsil_other);
			 $("#physical_reject_remarks").text(j[0].reject_remarks);
...
function onTypeofEntry(){
 ...
 function get_change_of_Discipline(){
	var jco_id=$("#jco_id").val();
	  ...
	  $.post('get_Discipline3_jco?' + key + "=" + value, {jco_id:jco_id }, function(j){
			var v=j.length;
			if(v!=0){
				$('#disi_id').val(j[0].id);
 ...
 function validate_Discipline_remove(){
  ...
  if(rc){
  var id=$('#disi_id').val();
   $.post('Discipline_delete_action_jco?' + key + "=" + value, {id:id}, function(data){ 
                    if(data=='1'){
                        alert("Data Deleted Successfully");
                        $('#disi_id').val(0);
        				/* $("#army_no1").val(j[0].army_no);
 ...
 function validate_Discipline_save(){
		...
		var jco_id=$('#jco_id').val();			
		formvalues+="&jco_id="+jco_id+"&app_status="+app_status;	
...
//   }
  ...
  function validate_inter_arm_transfer_remove(){
	 ...
	 if(rc){
	 var id=$('#p_id').val();
	  $.post('inter_arm_transfer_delete_JCOaction?' + key + "=" + value, {id:id}, function(data){ 
	                   if(data=='1'){
	                       alert("Data Deleted Successfully");
...
// 			} 
	...
	var record_office_sus=$('#record_office_sus').val();
 	...
 	var jco_id=$('#jco_id').val();
	   ...
	   $.post('Inter_arm_JCOaction?' + key + "=" + value, {authority1:authority1, date_of_authority1:date_of_authority1,
		   ...
		   with_effect_from1:with_effect_from1,regt1:regt1,pre_ch_id:pre_ch_id,jco_id:jco_id,app_status:app_status}, function(data){
 ...
 function getInterArm(){
	 ...
	 var jco_id='${jco_id}';
	  ...
	  $.post('get_InterArmJCO3?' + key + "=" + value, {jco_id:jco_id }, function(j){
		  if(j!=""){
				...
				$('#record_office_unit').val(j[0].record_office_unit);
				$('#record_office_sus').val(j[0].record_office_sus);
				$('#inter_arm_with_effect_from').val(td);
				$('#inter_arm_regt').val(j[0].regt);
				$('#p_id').val(j[0].id);
				 $("#arm_reject_remarks").text(j[0].reject_remarks);
		  }
 			...
 			susNoAuto
 					.autocomplete({
 						...
 						select : function(event, ui) {
 							...
 							$.post(
 									"getRecordofficeSUSNoFromUnitName?" + key
 											+ "=" + value, {
 										record_office : record_office
 									}, function(j) {
...
function getNon_effective(){
	 ...
	 var i=0;
	  $.post('get_NonEffectiveJCO3?' + key + "=" + value, {jco_id:jco_id }, function(j){
			var v=j.length;
			if(v!=0){
				$('#nf_id').val(j[i].id);
...
function get_non_eff_address_details(){
	var census_id=$("#census_id").val();	
	var jco_id=$("#jco_id").val();	
	$.post('address_details_GetDataJCO3?' + key + "=" + value,{census_id:census_id,jco_id:jco_id }, function(j){
		var v=j.length;
		if(v!=0){
			$("#perm_home_addr_country").val(j[0].permanent_country);
			fn_perm_home_addr_Country();
...
var addr_id= $("#non_addr_ch_id").val();   
 var id=$('#nf_id').val();
  $.post('non_effect_delete_JCOaction?' + key + "=" + value, {id:id,addr_id:addr_id}, function(data){ 
                   if(data=='1'){
                       alert("Data Deleted Successfully");
                       $('#nf_id').val(0);
...
//	 	 	+'   </td>'
		 ...
		 function validate_medical_cat_remove(){
			 ...
			 if(rc){
			  ...
			  $.post('medical_cat_delete_action_jco?' + key + "=" + value, {id:id}, function(data){ 
			                   if(data=='1'){
			                       alert("Data Deleted Successfully");
			                   	$('#s_madtbody').empty(); 
			                   	$('#h_madtbody').empty(); 
		 ...
		 function medical_cat_save(){
			 ...
			 if ($("#check_1bx").prop('checked')){
				...
				var jco_id=$('#jco_id').val();			
				formvalues+="&jco_id="+jco_id+"&enroll_date="+enroll_date+"&app_status="+app_status;
...
// 			    }
			   ...
			   $.post('medical_categoryAction_jco?' + key + "=" + value,formvalues, function(data){
...
//	 		   jco_id:jco_id,p_id:p_id,sShape_ch:sShape_ch,Shape:Shape}, function(data){
...
function validate_Deserter_remove(){
 ...
 var id=$('#des_ch_id').val();
  $.post('deserter_delete_action_jco?' + key + "=" + value, {id:id}, function(data){ 
                   if(data=='1'){
                       alert("Data Deleted Successfully");
                       $("#div_dt_rec").hide();
       				$("#des_ch_id").val(0);
...
function validate_Deserter_save_fn(){
	...
	/* if(indl_class == null || indl_class==""){ 
	    ...
	    $.post('deserterAction_jco?' + key + "=" + value, {
		   ...
		   des_ch_id:des_ch_id,jco_id:jco_id,enroll_date:enroll_date,app_status:app_status
		   }, function(data){
	          if(data=="update")
	        	  alert("Data Updated Successfully");
	          else if(parseInt(data)>0){
...
function get_deserter(){
	var jco_id=$('#jco_id').val();
	$.post('deserter_GetData3_jco?' + key + "=" + value,{jco_id:jco_id}, function(j){
		var v=j.length;
		if(v!=0){
...
function get_trade_details(){
	 ...
	 var jco_id=$('#jco_id').val();
	 var i=0;
	  $.post('change_of_trade_JCOGetData3?' + key + "=" + value, {jco_id:jco_id }, function(j){
			var v=j.length;
			if(v!=0){
				$('#td_id').val(j[i].id);
				 ...
				 $("#trade").val(j[i].trade);
				 $("#trade_reject_remarks").text(j[i].reject_remarks);
...
function validate_trade(){
	...
	formdata+="&jco_id="+jco_id+"&enroll_date="+enroll_date;	
...
function validate_trade_remove(){
	   var rc = confirm("Are You Sure! You Want To Delete");
 if(rc){
 var id=$('#td_id').val();
  $.post('Change_Trade_JCOdelete_action?' + key + "=" + value, {id:id}, function(data){ 
                   if(data=='1'){
                       alert("Data Deleted Successfully");
                       $('#td_id').val(0);
      				 $("#td_authority").val('');
      				 $("#td_date_authority").val('');
      				 $("#trade").val(0);        				
      				 $("#date_of_trade").val('');
      				$('#form_trade').hide();
                   }
...
function get_class_pay_details(){
	 ...
	 var jco_id=$('#jco_id').val();
	 var i=0;
	  $.post('change_class_pay_JCOGetData3?' + key + "=" + value, {jco_id:jco_id }, function(j){
			var v=j.length;
			if(v!=0){
				$('#cla_id').val(j[i].id);
				 ...
				 $("#class_reject_remarks").text(j[i].reject_remarks);
			}
	  });
}	
...
function validate_class_pay_remove(){
	   var rc = confirm("Are You Sure! You Want To Delete");
if(rc){
var id=$('#cla_id').val();


$.post('Change_Class_Pay_JCOdelete_action?' + key + "=" + value, {id:id}, function(data){ 
                if(data=='1'){
                    alert("Data Deleted Successfully");
                    $('#cla_id').val(0);
   				 $("#cla_authority").val('');
   				 $("#cla_date_authority").val('');
   				 $("#cla_class").val(0);        				
   				 $("#date_of_class").val('');
   				$('#form_class_pay').hide();
                }
...
function get_pay_group_details(){
	 ...
	 var jco_id=$('#jco_id').val();
	 var i=0;
	  $.post('change_pay_group_JCOGetData3?' + key + "=" + value, {jco_id:jco_id }, function(j){
			var v=j.length;
			if(v!=0){
				$('#gp_id').val(j[i].id);
				 ...
				 $("#pay_reject_remarks").text(j[i].reject_remarks);
			}
	  });
}	
...
function validate_group_pay_remove(){
	   var rc = confirm("Are You Sure! You Want To Delete");
if(rc){
var id=$('#gp_id').val();


$.post('Change_Group_Pay_JCOdelete_action?' + key + "=" + value, {id:id}, function(data){ 
             if(data=='1'){
                 alert("Data Deleted Successfully");
                 $('#gp_id').val(0);
				 $("#gp_authority").val('');
				 $("#gp_date_authority").val('');
				 $("#gp_group").val(0);        				
				 $("#date_of_group").val('');
				$('#form_pay_group').hide();
             }
...
function get_seniority_details(){
	 ...
	 var jco_id=$('#jco_id').val();
	 var i=0;
	  $.post('change_seniority_JCOGetData3?' + key + "=" + value, {jco_id:jco_id }, function(j){
			var v=j.length;
			if(v!=0){
				$('#se_id').val(j[i].id);
				 ...
				 $("#seniority_reject_remarks").text(j[i].reject_remarks);
			}
	  });
}	
...
function validate_seniority(){
	...
	formdata+="&jco_id="+jco_id+"&enroll_date="+enroll_date+"&dob_date="+dob_date;	
...
function validate_seniority_remove(){
	   var rc = confirm("Are You Sure! You Want To Delete");
if(rc){
var id=$('#se_id').val();


$.post('Change_Seniority_JCOdelete_action?' + key + "=" + value, {id:id}, function(data){ 
          if(data=='1'){
              alert("Data Deleted Successfully");
              $('#se_id').val(0);
				 $("#se_authority").val('');
				 $("#se_date_authority").val('');
				 $("#reason_for_change").val('');        				
				 $("#date_of_seniority").val('');
				$('#form_seniority').hide();
          }
           else{
               alert("Data not Deleted ");
...
//*************************************Start Attachment DETAIL*****************************//
 function get_attachment_details(){
	 ...
	 var jco_id=$('#jco_id').val();
	 var i=0;
	  $.post('attachment_JCOGetData3?' + key + "=" + value, {jco_id:jco_id }, function(j){
			var v=j.length;
			if(v!=0){
				$('#att_id').val(j[i].id);
...
function validate_attachment_remove(){
	   var rc = confirm("Are You Sure! You Want To Delete");
if(rc){
var id=$('#att_id').val();


$.post('Change_Attachment_JCOdelete_action?' + key + "=" + value, {id:id}, function(data){ 
       if(data=='1'){
           alert("Data Deleted Successfully");
           $('#att_id').val(0);
				 $("#att_authority").val('');
				 $("#att_date_authority").val('');
				 $("#att_movement_number").val('');        				
				 $("#att_date_of_move").val('');
				 $("#att_sus_no").val('');
				 $("#att_place").val('');
				 $("#att_from").val('');        				
				 $("#att_to").val('');
...
function CSD_save_fn(ps){
	...
	if (card_no.trim()=="" || card_no.trim().length<10) {
	  ...
	  $.post('CSD_action_jco?' + key + "=" + value, {jco_id:jco_id,name:name,Sname:Sname,date_of_birth:date_of_birth,relation:relation,card_no:card_no,type_of_card:type_of_card,CSD_Card_ch_id:CSD_Card_ch_id }, function(data){
	          if(data=="update")
	        	  alert("Data Updated Successfully");
	          else if(parseInt(data)>0){
...
function get_CSD_details(){//keval
	 var jco_id=$('#jco_id').val(); 
	 var i=0;
	  $.post('getCSD_Data3_jco?' + key + "=" + value, {jco_id:jco_id}, function(j){
		  var v=j.length;
			if(v!=0){
				$('#CSDtbody').empty(); 
...
function getDob(val){
	...
	var id = $("select#Dname"+val).val();
	 var jco_id=$('#jco_id').val(); 
	$.post('getChilddob_jco?' + key + "=" + value, {id:id,jco_id:jco_id}, function(j){
...
function getNameAndDob(val){
	 ...
	 var jco_id=$('#jco_id').val(); 
		if(rela=='1' || rela=='3' || rela=='4' || rela=='2'){ 
			 ...
			 $.post('getSelfMotFatName_jco?' + key + "=" + value, {jco_id:jco_id}, function(j){				 
			 ...
			 $.post('getSpouseName_jco?' + key + "=" + value, {jco_id:jco_id}, function(j){
			...
			$.post('getChildName_jco?' + key + "=" + value, {jco_id:jco_id,rela:rela}, function(j){
