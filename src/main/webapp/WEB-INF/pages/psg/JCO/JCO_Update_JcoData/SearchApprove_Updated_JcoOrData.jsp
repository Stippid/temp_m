...
<script src="js/miso/orbatJs/orbatAll.js" type="text/javascript"></script>
	...
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5> Search/Approve Data of Updated JCO/OR </h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by unit)</span></h6></div>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                  <input type="text" id="personnel_no" name="personnel_no" class="form-control autocomplete" autocomplete="off"  maxlength="12" onkeyup="return specialcharecter(this)" onkeypress="return AvoidSpace(event)"> 
						                </div>
						            </div>
	              				</div>
	             				<div class="col-md-6">
		                  ...
		                  <tbody>
			                 <c:if test="${list.size()==0}">
		                       ...
		                       <c:forEach var="item" items="${list}" varStatus="num" >
									...
									<td style="font-size: 15px;text-align: center;" >${item[5]} ${item[6]} ${item[7]}  ${item[8]}  </td> 
...
<c:url value="Approve_UpadteJcoDataUrl" var="ViewUrl"/>
<form:form action="${ViewUrl}" method="post" id="ViewForm" name="ViewForm" modelAttribute="id2">
	  ...
	  <input type="hidden" name="personnel_no2" id="personnel_no2" value="0">
	   <input type="hidden" name="jco_id1" id="jco_id1" value="0">
	   <input type="hidden" name="event1" id="event1" value="0"/>
</form:form>



<c:url value="view_UpadteJCODataUrl" var="ViewUrl"/>
...
<c:url value="viewHistory_UpadteJCODataUrl" var="ViewHisUrl"/>
<form:form action="${ViewHisUrl}" method="post" id="ViewhisForm" name="ViewhisForm" modelAttribute="idV">
	   <input type="hidden" name="jco_idhis" id="jco_idhis" value="0">
...
<c:url value="Approve_viewHistory_UpadteJCODataUrl" var="ViewcanhisUrl"/>
<form:form action="${ViewcanhisUrl}" method="post" id="ViewcanhisForm" name="ViewcanhisForm" modelAttribute="idcanhisV">
	   <input type="hidden" name="jco_idcanhis" id="jco_idcanhis" value="0">
...
<c:url value="view_ApproveUpadteJCODataUrl" var="ViewApproveUrl"/>
<form:form action="${ViewApproveUrl}" method="post" id="ap_ViewForm" name="ap_ViewForm" modelAttribute="idV">
	<input type="hidden" name="ap_id" id="ap_id" value="0">
	  <input type="hidden" name="ap_personnel_no" id="ap_personnel_no" value="0">
	   <input type="hidden" name="ap_jco_id" id="ap_jco_id" value="0">
...
<c:url value="Reject_UpadteJCODataUrl" var="rejectUrl" />
...
<c:url value="viewHistory_Inactive_Upadte_JCODataUrl" var="viewHistory_Inactive_Upadte_JCODataUrl"/>
<form:form action="${viewHistory_Inactive_Upadte_JCODataUrl}" method="post" id="ViewhisIForm" name="ViewhisIForm" modelAttribute="idcanhisI">
	  <input type="hidden" name="idcanhisI" id="idcanhisI" value="0">
	   <input type="hidden" name="jco_idhisI" id="jco_idhisI" value="0">
		 ...
		 var susNoAuto=$("#personnel_no");
		  susNoAuto.autocomplete({
		      source: function( request, response ) {
		        $.ajax({
		        	type: 'POST',
			    	url: "Search_getArmy_no?"+key+"="+value,
...
function editData(id){		
	...
	if(getArmyNoFromJco(id,'personnel_no_edit','event3')){
...
function AppViewData(id){        
	...
	if(getArmyNoFromJco(id,'ap_personnel_no','ap_event')){

		$("#personnel_no5").val($("#personnel_no").val()) ;	
		$("#status5").val($("#statusA").val()) ;		
		$("#rank5").val($("#rank").val()) ;	
		$("#jco_id5").val($("#jco_id").val()) ;
  ...
  function ViewData(id){	
	...
	if(getArmyNoFromJco(id,'personnel_no2','event1')){
...
function ViewHistoryData(id){        
    ...
    $.ajaxSetup({
     ...
     if(getArmyNoFromJco(id,'personnel_no_edithis','')){
...
function ViewCancelHistoryData(id){        
    ...
    $.ajaxSetup({
     ...
     if(getArmyNoFromJco(id,'personnel_no_editcanhis','')){
...
function ViewHistoryInactiveData_FN(id){      
    ...
    $.ajaxSetup({
     ...
     if(getArmyNoFromJco(id,'personnel_no_edithisI','')){
