...
<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5> View Officer Records JCO</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;"></span></h6></div>
	            	...
	            	<div class="col-md-12">	              					
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                   <input type="text" id="year_of_comm" name="year_of_comm" class="form-control autocomplete" autocomplete="off" > 
						                </div>
						            </div>
	              				</div>              				
	              			</div>
	              			...
	              			<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                   <input type="text" id="year_of_dob" name="year_of_dob" class="form-control autocomplete" autocomplete="off" > 
						                </div>
						            </div>
	              				</div>              					
	              			<!-- 	<div class="col-md-6">
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="View_UpdateOfficerDataUrlJCO" class="btn btn-success btn-sm" >Clear</a>  
		              		<input type="button" class="btn btn-info btn-sm" onclick="Search();" value="Search"> 
		              		<a href="View_UpdateOfficerDataUrlJCO" class="btn btn-danger btn-sm" >Cancel</a>     
			            </div> 		
	        	</div>
			</div>
	</div>
		 ...
		 var susNoAuto=$("#personnel_no");
		  susNoAuto.autocomplete({
		      source: function( request, response ) {
		        $.ajax({
		        	type: 'POST',
			    	url: "getApprove_noListApproved?"+key+"="+value, data: {personnel_no:personnel_no},			    
