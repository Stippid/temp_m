			...
			<div class="panel-group" id="accordion">
				<div class="panel panel-default" id="insp_div1">
					...
					<div class="panel-heading">
						...
						<b>UPDATE DATA JCOs,OR and RECTS </b>
					...
					<div id="collapse1a" class="panel-collapse collapse">
					 ...
					 <div class="col-md-12">	              					
	              		 ...
	              		 <div class="col-md-12">	              					
						 	...
						 	<div class="col-md-10" id="army_no1Div">
								    <div class="row form-group">
								    <div class="col-md-4" >
									...
									<div class="col-md-4">
									<input type="text" id="army_no2" name="army_no2" 
									onchange="Army_no_already_exist()" onkeyup="onChangeArmyNo(this)"   class="form-control-sm form-control" autocomplete="off" placeholder="Enter No..." maxlength="9">
								</div>
								<div class="col-md-4">
							...
							<div class="col-md-12">	
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"> <strong
										style="color: red;">* </strong>Issuing Authority (Unit/Fmn Name) </label>
						                </div>
						                <div class="col-md-8">
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"> <strong
										style="color: red;">* </strong>Issuing Authority Sus </label>
						                </div>
						                <div class="col-md-8">
						              <input type="text" id="issue_authority_susno" name="issue_authority_susno" class="form-control autocomplete" autocomplete="off" maxlength="256" onkeyup="return specialcharecter(this)">
	                 		...
	                 		<div class="col-md-12">	
	              			<div class="col-md-6">
	              				...
	              				<!-- <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                   <input type="text" id="unit_sus_noidcard" name="unit_sus_noidcard" class="form-control autocomplete" autocomplete="off" maxlength="8" onkeypress="return AvoidSpace(event)"  onkeyup="return specialcharecter(this)" > 
						                </div>
						            </div>
	              				</div>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                  <input type="text" id="unit_name_idcard" name="unit_name_idcard" class="form-control autocomplete" autocomplete="off" maxlength="100" onkeyup="return specialcharecter(this)">
								...
								<div class="col-md-6">
									<div class="row form-group">
										<img id="identity_image_preview" alt="JCO/OR Image"  src="js/img/No_Image.jpg" width="100" height="100" />
			...
			<div class="panel-group" id="accordion404">
				<div class="panel panel-default" id="ta_div1">
					...
					<div id="collapse_ta" class="panel-collapse collapse">
						...
						<div class="card-footer" align="center" class="form-control">
		              		 <input type="button" name="save" class="btn btn-primary btn-sm" value="Submit for Approval" onclick="validate_ta_jco_save_fn();" />		              
			            </div>  
						</div>
					</div>
				</div>
						               ...
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                 <input type="hidden" id="cda_id" name="cda_id" value="0" class="form-control autocomplete" autocomplete="off"  >
						                   <input type="text" id="gmail" name="gmail" class="form-control autocomplete" autocomplete="off" onchange="validateEmail(this);" maxlength="64"> 
						                </div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
							...
							<td>
							  <select  id="lang_std1" name="lang_std1" class="form-control autocomplete" onchange="onLanguage_std(1)" >
							   <option value="0">--Select--</option>
								...
								<td>
			 <input type="text" id="other_lang_std1" name="other_lang_std1" maxlength="100" class="form-control autocomplete"  readonly autocomplete="off" onkeypress="return onlyAlphaNumeric(event);">
						</td>
							   ...
							   <tbody data-spy="scroll" id="flangtbody" style="min-height:46px; max-height:650px; text-align: center;">
			                       ...
			                       <input type="text" id="f_other_language1" name="f_other_language1" maxlength="100" class="form-control autocomplete"  readonly autocomplete="off" onkeypress="return onlyAlphaNumeric(event);">
			                         ...
			                         <input type="text" id="f_other_lang_std1" name="f_other_lang_std1" maxlength="100" class="form-control autocomplete"  readonly autocomplete="off" onkeypress="return onlyAlphaNumeric(event);">
										...
										<td>
			                         <input type="text" id="f_other_prof1" name="f_other_prof1" class="form-control autocomplete"  readonly autocomplete="off" onkeypress="return onlyAlphaNumeric(event);">
						                  </td>
										<td>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                 <input type="text" id="promo_exam_authority" name="promo_exam_authority" maxlength="100" class="form-control autocomplete" autocomplete="off" maxlength="50" onkeyup="return specialcharecter(this)"> 
						                </div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                 <input type="text" id="army_course_authority" name="army_course_authority"  maxlength="100" class="form-control autocomplete" autocomplete="off" maxlength="50" onkeyup="return specialcharecter(this)">
						                </div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
						...
						<table id="army_course_table" class="table-bordered " style="margin-top:10px; width: -webkit-fill-available;">
							   ...
							   <tbody data-spy="scroll" id="army_coursetbody" style="min-height:46px; max-height:650px; text-align: center;">
									<tr id="tr_army_course1">
										...
										<td>
										 <input type="text" id="army_course_name1" name="army_course_name1" onkeyup="AutoCompleteCourse(this,1,0);"   class="form-control autocomplete" autocomplete="off" maxlength="50">
										</td>
										<td>
										 <input type="text" id="army_course_abbreviation1" name="army_course_abbreviation1" onkeyup="AutoCompleteCourse(this,1,1);"   class="form-control autocomplete" autocomplete="off" maxlength="50">
										</td>
									...
									<tbody data-spy="scroll" id="bpettbody"
										...
										<tr id="tr_bpet1">
										  ...
										  <input type="text" id="bept_result_others1" name="bept_result_others1" class="form-control autocomplete"  readonly autocomplete="off" onkeypress="return onlyAlphabets(event);">
											...
											<td>
											<input type="text" id="b_unit_name1" name="unit_name1" class="form-control autocomplete" onkeypress="BPET_UnitAuto(this);" autocomplete="off" maxlength="50">
											<input type="hidden" id="be_unit_sus_no1" name="be_unit_sus_no1" class="form-control autocomplete" autocomplete="off" maxlength="50">
											</td>
											<td style="display: none;">
							...
							<input type="button" class="btn btn-primary btn-sm" value="View History" onclick="Pop_Up_History('firing_standard');" />
								...
								<tbody data-spy="scroll" id="fire_stdtbody"
									...
									<tr id="tr_fire_std1">
										...
										<td style="width: 20%;">
										<input type="text" id="firing_unit_name1" name="firing_unit_name1" class="form-control autocomplete" onkeypress="Firing_UnitAuto(this);" autocomplete="off" maxlength="50">
										<input type="hidden" id="firing_unit_sus_no1" name="firing_unit_sus_no1" class="form-control autocomplete" autocomplete="off" maxlength="50">
										</td>
										<td style="display: none;">
							...
							<table id="foreign_country_visit" class="table-bordered " style="margin-top:10px;">
							   ...
							   <tbody data-spy="scroll" id="foregin_Country_tbody" style="min-height:46px; max-height:650px; text-align: center;">
									<tr id="tr_foregin_country1">
										...
										<td style="width: 10%;">
										  <input type="text" id="period1" name="period1" class="form-control autocomplete" autocomplete="off" maxlength="4" onkeypress="isNumber0_9Only(event)" readonly="readonly">
										</td>
										<td style="width: 5%;">
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                     <input type="text" name="record_office_unit" id="record_office_unit" onkeypress="return onlyAlphaNumeric(event);" class="form-control" maxlength="50">
				   ...
				   <!--  country-->
						...
						<div class="col-md-6">
	              		...
	              		<div class="col-md-12">	
							  <div class="col-md-6" id = "Ot_perm_hm_addr_con_div" style="display: none;">
              					<div class="row form-group">
					               <div class="col-md-4">
					                ...
					                <div class="col-md-8">
					                  <input type="text" id="perm_home_addr_country_other" name="per_home_addr_country_other"  onkeypress="return onlyAlphaNumeric(event);"  class="form-control autocomplete" autocomplete="off"  maxlength="50">				               
					                </div>
					            </div>
              				</div>
              				...
              				<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong style="color: red;">* </strong>OTHER STATE/PROVINCE</label>
						                </div>
						               <div class="col-md-8">
					                  <input type="text" id="perm_home_addr_state_other" name="per_home_addr_state_other"  onkeypress="return onlyAlphaNumeric(event);" class="form-control autocomplete" autocomplete="off"  maxlength="50">				               
					                </div>
						            </div>
	              			</div>
	              	</div>
						...
						<div class="col-md-6" id = "Ot_perm_hm_addr_dis_div" style="display: none;">
              					<div class="row form-group">
					               <div class="col-md-4">
					                ...
					                <div class="col-md-8">
					                  <input type="text" id="perm_home_addr_district_other" name="per_home_addr_district_other"   class="form-control autocomplete" onkeypress="return onlyAlphaNumeric(event);"  autocomplete="off"  maxlength="50">				               
					                </div>
					            </div>
              				</div>
              				...
              				<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong style="color: red;">* </strong>OTHER TEHSIL/MUNICIPALITY</label>
						                </div>
						               <div class="col-md-8">
					                  <input type="text" id="perm_home_addr_tehsil_other" name="per_home_addr_tehsil_other"  class="form-control autocomplete" autocomplete="off"  onkeypress="return onlyAlphaNumeric(event);" maxlength="50">				               
					                </div>
						            </div>
	              			</div>
	              	</div>
	              			...
	              			<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
											<input type="text" id="perm_home_addr_village" name="per_home_addr_village" onkeypress="return onlyAlphabets(event);"   class="form-control autocomplete" autocomplete="off"  maxlength="50">				               
						                </div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
				...
				<div class="panel panel-default" id="ff_div16">
					...
					<div id="collapse1ff" class="panel-collapse collapse">
			           <div class="card-body card-block">
						...
						<div class="card-footer" align="center" class="form-control">
		              		 <input type="button" class="btn btn-primary btn-sm" value="Submit for Approval" onclick="validate_trade();">		              
			            </div>  
						</div>
					</div>
				</div>
			...
			<div class="panel-group" id="accordion17">
				<div class="panel panel-default" id="gg_div16">
					...
					<div id="collapse1gg" class="panel-collapse collapse">
			            <div class="card-body card-block">
			            <br>
			            <input type="button" name="save" class="btn btn-primary btn-sm" value="View History" onclick="Pop_Up_History('Change_In_Class');" /> 
							<div class="row">
						<div class="col-md-12">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
						...
						<div class="card-footer" align="center" class="form-control">
		              		 <input type="button" class="btn btn-primary btn-sm" value="Submit for Approval" onclick="validate_class_pay();">		              
			            </div>  
						</div>
					</div>
				</div>
			...
			<div class="panel-group" id="accordion17">
				<div class="panel panel-default" id="hh_div16">
					...
					<div id="collapse1hh" class="panel-collapse collapse">
			          <div class="card-body card-block">
			            <br>
			            <input type="button" name="save" class="btn btn-primary btn-sm" value="View History" onclick="Pop_Up_History('Change_In_Pay_Group');" /> 
							<div class="row">
						<div class="col-md-12">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
						...
						<div class="card-footer" align="center" class="form-control">
		              		 <input type="button" class="btn btn-primary btn-sm" value="Submit for Approval" onclick="validate_pay_group();">		              
			            </div>  
						</div>
					</div>
				</div>
			...
			<div class="panel-group" id="accordion17">
				<div class="panel panel-default" id="ii_div16">
					...
					<div id="collapse1ii" class="panel-collapse collapse">
			          <div class="card-body card-block">
			            <br>
			            <input type="button" name="save" class="btn btn-primary btn-sm" value="View History" onclick="Pop_Up_History('Change_In_Date_Of_Seniority');" /> 
							<div class="row">
						<div class="col-md-12">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               ...
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
											<label id="old_dt_seniority"> </label>
											 ...
											 <%-- <select name="old_dt_seniority_val" id="old_dt_seniority_val" class="form-control" style="display: none;">
												<option value="-1">--Select--</option>
												<c:forEach var="item" items="${getClassPayList}" varStatus="num">
													<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
												</c:forEach>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                <input type="text" id="reason_for_change" name="reason_for_change" onkeyup="return specialcharecter(this)" onkeypress="return onlyAlphabets(event);" class="form-control autocomplete" autocomplete="off" maxlength="50" >
						                </div>
						            </div>
	              				</div>
	              			</div>
						...
						<div class="card-footer" align="center" class="form-control">
		              		 <input type="button" class="btn btn-primary btn-sm" value="Submit for Approval" onclick="validate_seniority();">		              
			            </div>  
						</div>
					</div>
				</div>
			...
			<div class="panel-group" id="accordion17">
				<div class="panel panel-default" id="jj_div16">
					...
					<div id="collapse1jj" class="panel-collapse collapse">
			          <div class="card-body card-block">
			            <br>
			            <input type="button" name="save" class="btn btn-primary btn-sm" value="View History" onclick="Pop_Up_History('Attachment_Details');" /> 
							<div class="row">
						<div class="col-md-12">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
            	...
            	<div class="col-md-12">	              					
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               ...
						               <input type="text" name="att_to" id="att_to" maxlength="10"  onclick="clickclear(this, 'DD/MM/YYYY')" class="form-control" style="width: 93%;display: inline;"
											onfocus="this.style.color='#000000'" onblur="clickrecall(this,'DD/MM/YYYY');validateDate_BackDate(this.value,this);" onkeyup="clickclear(this, 'DD/MM/YYYY')" 
											onchange="clickrecall(this,'DD/MM/YYYY');calc_duration();" aria-required="true" autocomplete="off" style="color: rgb(0, 0, 0);" >
						                </div>
						            </div>
	              				</div>
	              			</div>
						...
						<div class="card-footer" align="center" class="form-control">
		              		 <input type="button" class="btn btn-primary btn-sm" value="Submit for Approval" onclick="validate_attachment();">		              
			            </div>  
						</div>
					</div>
				</div>
			...
			<div class="panel-group" id="accordion4">
				<div class="panel panel-default" id="pp_div1">
					...
					<div id="collapse1pp" class="panel-collapse collapse">
			                <div class="card-body card-block"><br>
			                <input type="button" class="btn btn-primary btn-sm" value="View History" onclick="Pop_Up_History('type_of_posting');" />
							<div class="row">
					 <div class="col-md-12">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
						  ...
						  <div class="card-footer" align="center" class="form-control">
								<input type="button" class="btn btn-primary btn-sm" value="Submit for Approval" onclick="validate_Chngofposting_save();"> 	
...
function fn_getUnitnamefromSusIdcard(sus_no,e){
	
	$.post("getTargetUnitNameListActiveInactiveInvalid?"+key+"="+value, {sus_no:sus_no}).done(function(data) {
		var l=data.length-1;
		  var enc = data[l].substring(0,16);    	   	 
	 		e.value=dec(enc,data[0]);
		}).fail(function(xhr, textStatus, errorThrown) {
		 ...
		 var susNoAuto=$("#issue_authority");
		  susNoAuto.autocomplete({
		      source: function( request, response ) {
		        $.ajax({
		        	type: 'POST',
			    	url: "getIssuingAuthorityListIdCard?"+key+"="+value,
		      ...
		      select: function( event, ui ) {
			    	 var unit_name = ui.item.value;
				            $.post("getTargetSusNoFromUnitNameActiveInactiveInvalid?"+key+"="+value,{unit_name:unit_name}, function(data) {
				            }).done(function(data) {
				            	var length = data.length-1;
					        	var enc = data[length].substring(0,16);
					        	$("#issue_authority_sus").val(dec(enc,data[0]));
					        	$("#issue_authority_susno").val(dec(enc,data[0]));
				            }).fail(function(xhr, textStatus, errorThrown) {
				            });
			      } 	     
			}); 		     
...
$("#issue_authority_susno").keyup(function(){
	var sus_no = this.value;
	var susNoAuto=$("#issue_authority_susno");

	susNoAuto.autocomplete({
	      source: function( request, response ) {
	        $.ajax({
	        type: 'POST',
	        url: "getIssuingAuthoritySusListIdCard?"+key+"="+value,
	        data: {sus_no:sus_no},
	          success: function( data ) {
	        	  var susval = [];
                  var length = data.length-1;
	      ...
	      change: function(event, ui) {
	    	 if (ui.item) {   	        	  
	        	  ...
	        	  alert("Please Enter Approved Issue Authority Sus");
	        	  document.getElementById("issue_authority_susno").value="";
	        	  susNoAuto.val("");	        	  
	        	  susNoAuto.focus();
	        	  return false;	             
	          }   	         
		...
		select: function( event, ui ) {
			var sus_no = ui.item.value;			      	
			 $.post("getTargetUnitNameListActiveInactiveInvalid?"+key+"="+value, {
				 sus_no:sus_no
         }, function(j) {
        	 ...
        	 var length = j.length-1;
             var enc = j[length].substring(0,16);
             $("#issue_authority").val(dec(enc,j[0]));   
...
function m_children_Details() {
	...
	var jco_id = $('#jco_id').val();
	var i = 0;
	$.post('getm_children_detailsData_jco?' + key + "=" + value,{jco_id:jco_id},function(j) {
		var v = j.length;
		if (v != 0) {
...
function validate_cda_acnt_no()
{
	 ...
	 if ($("input#mobile_no").val().trim()=="" || $("input#mobile_no").val().trim().length<10 || $("input#mobile_no").val().trim().length>10) {
		...
		var jco_id=$("#jco_id").val();	
		formvalues+="&cda_id="+cda_id+"&jco_id="+jco_id;
...
function get_cda_acnt_no(){
	...
	var jco_id=$("#jco_id").val();
	$.post('cda_acnt_no_GetData_jco?' + key + "=" + value,{ jco_id:jco_id}, function(j){
		var v=j.length;
		if(v!=0){
...
function getNon_effective(){
	 ...
	 $.ajaxSetup({
	  ...
	  $.post('getNon_JCOeffective?' + key + "=" + value, {jco_id:jco_id }, function(j){
			var v=j.length;		
			if(v!=0){
				$('#nf_id').val(j[i].id);
...
function get_non_eff_address_details(){
	...
	$.post('address_details_GetJCOData?' + key + "=" + value,{jco_id:jco_id }, function(j){
		var v=j.length;
		if(v!=0){
...
function get_religion(){
	 ...
	 var jco_id=$('#jco_id').val(); 
	 var i=0;
	  $.post('religion_GetData_jco?' + key + "=" + value, {jco_id:jco_id}, function(j){
			var v=j.length;
...
function get_change_of_name(){
	 ...
	 var jco_id=$('#jco_id').val();
	 var i=0;
	  $.post('change_of_name_JCOGetData?' + key + "=" + value, {jco_id:jco_id }, function(j){
			var v=j.length;
			if(v!=0){
				$('#name_id').val(j[i].id);
...
function get_ta_status(){
	 ...
	 var jco_id=$('#jco_id').val();
	 var i=0;
	  $.post('ta_status_jco_GetData?' + key + "=" + value, {jco_id:jco_id }, function(j){
			var v=j.length;
			if(v!=0){
				$('#ta_id').val(j[i].id);
...
function getChangeOfRank(){
	...
	var jco_id=$('#jco_id').val();
	var i=0;
	 $.post('getChangeOfRankJCOData?' + key + "=" + value, {jco_id:jco_id}, function(j){
		 if(j!=""){
			 ...
			 $('#ch_r_id').val(j[0].id);
				...
				$.post('getChangeOfArmy_NO_JCOData?' + key + "=" + value, {rank_id:rank_id,jco_id:jco_id}, function(k){
					 if(k.length!=0){
...
function awardsNmedal_save_fn(qs){
    ...
    $.post('awardsNmedal_action_jco?' + key + "=" + value, {Category_8:Category_8,select_desc:select_desc,date_of_award:date_of_award,awardsNmedal_unit:awardsNmedal_unit,awardsNmedal_bde:awardsNmedal_bde,awardsNmedal_div_subarea:awardsNmedal_div_subarea,awardsNmedal_corps_area:awardsNmedal_corps_area,awardsNmedal_command:awardsNmedal_command,awardsNmedal_ch_id:awardsNmedal_ch_id,jco_id:jco_id,anm_authority:anm_authority,anm_doa:anm_doa }, function(data){           
              if(data=="update")
                      alert("Data Updated Successfully");
              else if(parseInt(data)>0){
...
function getawardsNmedals(){
    ...
    var jco_id=$('#jco_id').val();
    var i=0;
     $.post('getawardsNmedalData_jco?' + key + "=" + value, {jco_id:jco_id}, function(j){
                   var v=j.length;
                   if(v!=0){
...
function language_save_fn(ps){
  ...
  if (lang_std == "0") {
   ...
   var country_sel1 = $("#lang_std"+ps+" option:selected").text();
    ...
    $.post('update_offr_language_detail_action_jco?' + key + "=" + value, {language:language,other_lan:other_lan,lang_std:lang_std,other_lan_std:other_lan_std,lang_ch_id:lang_ch_id,jco_id:jco_id,lang_authority:lang_authority,lang_doa:lang_doa,enroll_date:enroll_date }, function(data){
            if(data=="update")
                    alert("Data Updated Successfully");
            else if(parseInt(data)>0){
...
function get_language_details(){
	 ...
	 var jco_id=$('#jco_id').val(); 
	 var i=0;
	  $.post('update_offr_getlanguagedetailsData_jco?' + key + "=" + value, {jco_id:jco_id}, function(j){
			var v=j.length;
			if(v!=0){
...
//***************FOREIGN  COUNTRY************//
 ...
 function getUPForeign_CountriesDetails(){
 	 var jco_id=$('#jco_id').val(); 
 	 var i=0;
 	  $.post('getUPForeginCountryData_jco?' + key + "=" + value, {jco_id:jco_id }, function(j){
 			var v=j.length;
 			if(v!=0){
 			...
 			if(pup_sel == "OTHERS" ||  pup_sel == "OTHER"){
 				if(lengthValidation($("input#purpose_visit_ot"+ps).val().trim(),auth_length)){
 					...
 					return false;
 					   ...
 					   $.post('UPforegin_country_action_jco?' + key + "=" + value, {country:country,other_ct:other_ct,period:period,from_dt:from_dt,to_dt:to_dt,purpose_visit:purpose_visit,other_purpose_visit:other_purpose_visit,foregin_country_ch_id:foregin_country_ch_id,jco_id:jco_id}, function(data){	 
 			          if(data=="update")
 			        	  alert("Data Updated Successfully");
 			          else if(parseInt(data)>0){
	...
	if ($("input#record_office_unit").val().trim()=="") {
 	...
 	var jco_id=$('#jco_id').val();
	   ...
	   $.post('Inter_arm_JCOaction?' + key + "=" + value, {authority1:authority1, date_of_authority1:date_of_authority1,
		   ...
		   with_effect_from1:with_effect_from1,regt1:regt1,pre_ch_id:pre_ch_id,jco_id:jco_id}, function(data){
...
function getInterArm(){
	 ...
	 var jco_id=$('#jco_id').val(); 
	 var i=0;
	  $.post('getInterArmJCO?' + key + "=" + value, {jco_id:jco_id }, function(j){
			var v=j.length;
			if(v!=0){
...
function getfamily_marriageDetails(){
	 ...
	 var jco_id=$('#jco_id').val(); 
	 var marital_event=$('#marital_event').val();
	  $.post('update_getfamily_marriageJCOData?' + key + "=" + value, {marital_event:marital_event,jco_id:jco_id }, function(j){
			var v=j.length;
		if(v!=0){
...
var jco_id = $('#jco_id').val();
var i = 0;
$.post('getfire_detailsData_jco?' + key + "=" + value,{ jco_id:jco_id},function(j) {
...
$.post('fire_std_action_jco?' + key + "=" + value, {firing_grade:firing_grade,ot_firing_grade:ot_firing_grade,firing_event_qe:firing_event_qe,
  year:year,firing_unit_sus_no:firing_unit_sus_no,fire_id:fire_id,jco_id:jco_id }, function(data){
     if(data=="update")
   	  alert("Data Updated Successfully");
     else if(parseInt(data)>0){
   	 $('#fire_id'+ps).val(data);
...
function bpet_save_fn(ps){
	...
	if (BPET_result == "-1") {
	   ...
	   $.post('BPET_JCOaction?' + key + "=" + value, {BPET_result : BPET_result ,bept_result_others:bept_result_others,BPET_qe : BPET_qe,
		   year:year,unit_sus_no:unit_sus_no,id : id,jco_id:jco_id }, function(data){
	          if(data=="update")
	        	  alert("Data Updated Successfully");
	          else if(parseInt(data)>0){
	        	 $('#id'+ps).val(data);
...
function bpet_Details() {
	...
	var jco_id = $('#jco_id').val();
	var i = 0;
	$.post('getbpet_JCOData?' + key + "=" + value,{jco_id:jco_id},function(j) {
		var v = j.length;
		if (v != 0) {
			$('#bpettbody').empty();
			for (i; i < v; i++) {
				...
				$("table#bpet_table").append('<tr id="tr_bpet'+x+'">'
                   ...
                   +' </c:forEach>'
					...
					+'<input type="hidden" id="be_unit_sus_no'+x+'" name="be_unit_sus_no'+x+'" value="'+j[i].unit_sus_no+'"  class="form-control autocomplete" autocomplete="off" maxlength="50">'
					+'</td>'
...
function getIdentity_Card(){
	 ...
	 var jco_id=$('#jco_id').val(); 
	 var i=0;
	  $.post('getIdentity_CardJCO?' + key + "=" + value, {jco_id:jco_id}, function(j){
			var v=j.length;
			if(v!=0){
				if(j[i].status==0){
				$('#card_id').val(j[i].id);
				 ...
				 $("#issue_authority_susno").val(j[i].issue_authority);
				
				 fn_getUnitnamefromSusIdcard(j[i].issue_authority, document.getElementById("issue_authority"));
				 $("#id_marks").val(j[i].id_marks);
				 $("#hair_colour").val(j[i].hair_colour);
				 $("#eye_colour").val(j[i].eye_colour);
				 $("#unit_sus_noidcard").val(j[i].unit_sus_no);
				 fn_getUnitnamefromSus(j[i].unit_sus_no, document.getElementById("unit_name_idcard"));
...
var text14 = $("#spouse_addr_district option:selected").text().toUpperCase();
	...
	var addr_ch_id=$("#addr_ch_id").val();	
		...
		formvalues+="&addr_ch_id="+addr_ch_id+"&jco_id="+jco_id+"&marital_status="+marital_status+"&enroll_date="+enroll_date;	
  ...
  var text2 = $("#nok_state option:selected").text().toUpperCase();
   ...
   var enroll_date=$('#enroll_date').val();
	...
	var nok_id=$("#nok_id").val();		
		formvalues+="&nok_id="+nok_id+"&jco_id="+jco_id+"&enroll_date="+enroll_date;	
...
function get_nokaddress_details(){
	var jco_id=$("#jco_id").val();	
	$.post('nok_details_GetData_jco?' + key + "=" + value,{jco_id:jco_id }, function(j){
		var v=j.length;
			if(v!=0){
				//////nok//////
...
function DiagnoseChanged(){
	if ($("#batnpc_diagnosis").val().toUpperCase()=="OTHERS") {
		$('#diagnosisotdiv').show();
		}
	else{
		$('#diagnosisotdiv').hide();
...
function get_Battle_and_Physical_Casuality_details(){
	...
	bindRadioBt();
	bindRadioButton();
	$.post('Battle_and_Physical_Casuality_GetData_jco?' + key + "=" + value,{census_id:census_id,jco_id:jco_id }, function(j){
		var v=j.length;
		if(v!=0){
			$.ajaxSetup({
				async : false
...
// 						}
	 ...
	 function medical_cat_save(){
		 ...
		 if ($("#check_1bx").prop('checked')){
			...
			var jco_id=$('#jco_id').val();			
			formvalues+="&jco_id="+jco_id+"&enroll_date="+enroll_date;
...
function promo_exam_save_fn(ps){
	...
	if( Date.parse(dateofEnrollMonthY)> Date.parse((promo_exam_dop+"-01"))){
	  ...
	  $.post('update_offr_promo_exam_detail_action_jco?' + key + "=" + value, {exam_other_select:country_sel,promo_exam:promo_exam,e_ot:e_ot,promo_exam_dop:promo_exam_dop,promo_exam_ch_id:promo_exam_ch_id,jco_id:jco_id,promo_exam_authority:promo_exam_authority,promo_exam_doa:promo_exam_doa }, function(data){
	          if(data=="update")
	        	  alert("Data Updated Successfully");
	          else if(parseInt(data)>0){
...
function get_promo_exam_details(){
	 ...
	 var jco_id=$('#jco_id').val(); 
	 var i=0;
	  $.post('update_offr_promo_exam_getData_jco?' + key + "=" + value, {jco_id:jco_id}, function(j){
			var v=j.length;
			if(v!=0){
		xpro=0;
		for(i;i<v;i++){
...
function get_army_course_details(){
	 ...
	 var jco_id=$('#jco_id').val(); 
	 var i=0;
	  $.post('update_JCO_army_course_getData?' + key + "=" + value, {jco_id:jco_id}, function(j){
			var v=j.length;
			if(v!=0){
		xaco=0;
		for(i;i<v;i++){
...
function get_Appointment(){
	 ...
	 var jco_id=$('#jco_id').val(); 
	 var i=0;
	  $.post('get_AppointmentJCO?' + key + "=" + value, { jco_id:jco_id}, function(j){
			var v=j.length;
			if(v!=0){
...
var jco_id=$("#jco_id").val();
	 ...
	 var i=0;
	  $.post('getdisciplineData_jco?' + key + "=" + value, {jco_id:jco_id }, function(j){
			var v=j.length;
			if(v!=0){
				$('#disi_id').val(j[i].id);
...
function allergic_save_fn(ps){
	...
	if (allergic.trim()=="") {
	  ...
	  $.post('update_offr_allergic_detail_action_jco?' + key + "=" + value, {allergic:allergic,allergic_ch_id:allergic_ch_id,jco_id:jco_id }, function(data){
	          if(data=="update")
	        	  alert("Data Updated Successfully");
	          else if(parseInt(data)>0){
...
function get_allergic_details(){
	 ...
	 var jco_id=$('#jco_id').val(); 
	 var i=0;
	  $.post('update_offr_allergic_getData_jco?' + key + "=" + value, {jco_id:jco_id}, function(j){
			var v=j.length;
			if(v!=0){
		xaller=0;
		for(i;i<v;i++){
...
function validate_Deserter_save_fn(){
	...
	/* if(indl_class == null || indl_class==""){ 
	    ...
	    $.post('deserterAction_jco?' + key + "=" + value, {
		   ...
		   des_ch_id:des_ch_id,jco_id:jco_id,enroll_date:enroll_date
		   }, function(data){
	          if(data=="update")
	        	  alert("Data Updated Successfully");
	          else if(parseInt(data)>0){
...
function get_deserter(){
	...
	var jco_id=$('#jco_id').val();
	$.post('deserter_GetData_jco?' + key + "=" + value,{jco_id:jco_id}, function(j){
		var v=j.length;
		if(v!=0){
	 ...
	 $.post('deserter_GetDataA_jco?' + key + "=" + value,{jco_id:jco_id}, function(j){
			var v=j.length;
			if(v!=0){
...
function get_CSD_details(){
	 ...
	 var jco_id=$('#jco_id').val(); 
	 var i=0;
	  $.post('updateCSD_getData_jco?' + key + "=" + value, {jco_id:jco_id}, function(j){
		  var v=j.length;
			if(v!=0){
				$('#CSDtbody').empty(); 
...
function get_trade_details(){
	 ...
	 var jco_id=$('#jco_id').val();
	 var i=0;
	  $.post('change_of_trade_JCOGetData?' + key + "=" + value, {jco_id:jco_id }, function(j){
			var v=j.length;
			if(v!=0){
				$('#td_id').val(j[i].id);
...
function get_postingtype(){
	 ...
	 var jco_id=$('#jco_id').val(); 
	 var i=0;
	  $.post('change_of_posting_JCOGetData?' + key + "=" + value, {jco_id:jco_id}, function(j){
			var v=j.length;
...
function get_class_pay_details(){
	 ...
	 var jco_id=$('#jco_id').val();
	 var i=0;
	  $.post('change_class_pay_JCOGetData?' + key + "=" + value, {jco_id:jco_id }, function(j){
			var v=j.length;
			if(v!=0){
				$('#cla_id').val(j[i].id);
...
function get_pay_group_details(){
	 ...
	 var jco_id=$('#jco_id').val();
	 var i=0;
	  $.post('change_pay_group_JCOGetData?' + key + "=" + value, {jco_id:jco_id }, function(j){
			var v=j.length;
			if(v!=0){
				$('#gp_id').val(j[i].id);
...
function get_seniority_details(){
	 ...
	 var jco_id=$('#jco_id').val();
	 var i=0;
	  $.post('change_seniority_JCOGetData?' + key + "=" + value, {jco_id:jco_id }, function(j){
			var v=j.length;
			if(v!=0){
				$('#se_id').val(j[i].id);
...
//*************************************Start Attachment DETAIL*****************************//
 function get_attachment_details(){
	 ...
	 var jco_id=$('#jco_id').val();
	 var i=0;
	  $.post('attachment_JCOGetData?' + key + "=" + value, {jco_id:jco_id }, function(j){
			var v=j.length;
			if(v!=0){
				$('#att_id').val(j[i].id);
...
function Pop_Up_History(a) {
	...
	if(a == "known_allergy"){
		$("#known_allergy_jco_id").val(jco_id);
...
// 		$("#canteen_census_id").val(census_id);
   	...
   	if(a == "Change_Medicle")
   		{
   			$("#change_in_medicle_jco_id").val(jco_id);
//    			$("#cim_census_id").val(census_id);
   			document.getElementById('Change_In_Medicle_Form').submit();
   		}
 	if(a == "Trade")
		{
			$("#trade_jco_id").val(jco_id);
//			$("#cim_census_id").val(census_id);
			document.getElementById('Change_In_Trade_Form').submit();
		} 
	if(a == "Change_In_Class")
		{
			$("#class_jco_id").val(jco_id);
//			$("#cim_census_id").val(census_id);
			document.getElementById('Change_In_Class_Form').submit();
		}
	if(a == "Change_In_Pay_Group")
		{
			$("#pay_group_jco_id").val(jco_id);
//			$("#cim_census_id").val(census_id);
			document.getElementById('Change_In_Pay_Group_Form').submit();
		} 
	if(a == "Change_In_Date_Of_Seniority")
		{
			$("#date_of_jco_id").val(jco_id);
//			$("#cim_census_id").val(census_id);
			document.getElementById('Change_In_Date_Of_Seniority_Form').submit();
		}
	
	if(a == "Attachment_Details")
	{
		$("#attachment_jco_id").val(jco_id);
		document.getElementById('Attachment_Details_Form').submit();
	}
	if(a == "type_of_posting"){
		$("#posting_jco_id").val(jco_id);
		document.getElementById('Change_posting_Form').submit();
	}
...
// Unit SUS No
	...
	$("#unit_sus_noidcard").keyup(function(){
		var sus_no = this.value;
		var susNoAuto=$("#unit_sus_noidcard");
		...
		susNoAuto.autocomplete({
		      ...
		      change: function(event, ui) {
		    	 if (ui.item) {   	        	  
		        	  ...
		        	  alert("Please Enter Approved Unit SUS No.");
		        	  document.getElementById("unit_name_idcard").value="";
		        	  susNoAuto.val("");	        	  
		        	  susNoAuto.focus();
		        	  return false;	             
		          }   	         
			...
			select: function( event, ui ) {
				var sus_no = ui.item.value;			      	
	        	 ...
	        	 var length = j.length-1;
	             var enc = j[length].substring(0,16);
	             $("#unit_name_idcard").val(dec(enc,j[0]));   
	...
	// unit name
	 $("input#unit_name_idcard").keypress(function(){
			var unit_name = this.value;
				 var susNoAuto=$("#unit_name_idcard");
				  susNoAuto.autocomplete({
				      source: function( request, response ) {
				        $.ajax({
				        	type: 'POST',
				      ...
				      select: function( event, ui ) {
				    	 var unit_name = ui.item.value;
					            ...
					            $.post("getTargetSUSFromUNITNAME?"+key+"="+value,{target_unit_name:unit_name}, function(data) {
					            	...
					            	var length = data.length-1;
						        	var enc = data[length].substring(0,16);
						        	$("#unit_sus_noidcard").val(dec(enc,data[0]));
					            }).fail(function(xhr, textStatus, errorThrown) {
					            });
				      } 	     
				}); 			
...
<c:url value="Update_Visit_To_Foreign_CountryJCOUrl" var="Update_Visit_To_Foreign_CountryJCOUrl" />
<form:form action="${Update_Visit_To_Foreign_CountryJCOUrl}" method="post" id="Update_Visit_Foriegn_Form" name="Update_Visit_Foriegn_Form"  target="result">
<input type="hidden" name="update_visit_to_foreign_country_jco_id" id="update_visit_to_foreign_country_jco_id" value="0"/>
<!--  <input type="hidden" name="vf_census_id" id="vf_census_id" value="0"/>  -->
</form:form>

<c:url value="Non_Effective_StatusJCOUrl" var="Non_Effective_StatusJCOUrl" />
<form:form action="${Non_Effective_StatusJCOUrl}" method="post" id="Non_Effective_Status_Form" name="Non_Effective_Status_Form"  target="result">
<input type="hidden" name="non_effective_status_jco_id" id="non_effective_status_jco_id" value="0"/>
...
<c:url value="Change_in_RankJCOUrl" var="Change_in_RankJCOUrl" />
<form:form action="${Change_in_RankJCOUrl}" method="post" id="Change_Rank_Form" name="Change_Rank_Form"  target="result">
<input type="hidden" name="rank_jco_id" id="rank_jco_id" value="0"/> 
</form:form> 


<!-- /////////// Update_Child_Details_Form //////////////// -->
<c:url value="Update_Child_DetailsUrl" var="Update_Child_DetailsUrl" />
<form:form action="${Update_Child_DetailsUrl}" method="post" id="update_child_dtlForm"
	name="update_child_dtlForm" target="result">
 <input type="hidden" name="updatechild_jco_id" id="updatechild_jco_id" value="0" />  

</form:form>

<!-- /////////// Change In Nok //////////////// -->
<c:url value="Change_in_NokUrl" var="Change_in_NokUrl" />
<form:form action="${Change_in_NokUrl}" method="post" id="nok_updateForm"
	name="nok_updateForm" target="result">
<input type="hidden" name="nok_jco_id" id="nok_jco_id" value="0" /> 
</form:form>
...
<form:form action="${Change_in_ReligionUrl}" method="post" id="Change_In_Religion_Form"
	...
	<input type="hidden" name="religion_jco_id" id="religion_jco_id" value="0" />
</form:form>
...
<form:form action="${Change_in_NameUrl}" method="post" id="Change_Name_Form"
	...
	<input type="hidden" name="name_jco_id" id="name_jco_id" value="0" />
</form:form>

<!-- /////////////////// PROMOTIONAL EXAM//////////////// -->
<c:url value="Pramotional_ExamJCOUrl" var="Pramotional_ExamJCOUrl" />
<form:form action="${Pramotional_ExamJCOUrl}" method="post" id="Promotional_Exam_Form" name="Promotional_Exam_Form"  target="result">
<input type="hidden" name="pramotional_exam_jco_id" id="pramotional_exam_jco_id" value="0"/> 
</form:form>
<!-- /////////////////// MaritaL Status//////////////// -->
<c:url value="Change_in_Marital_StatusUrl" var="Change_in_Marital_StatusUrl" />
<form:form action="${Change_in_Marital_StatusUrl}" method="post" id="Change_In_Marital_Status_Form" name="Change_In_Marital_Status_Form" modelAttribute="id" target="result">
<input type="hidden" name="maritalstatus_jco_id" id="maritalstatus_jco_id" value="0" />
</form:form>


<!-- /////////////////// Add Language//////////////// -->
<c:url value="Add_LanguageJCOUrl" var="Add_LanguageJCOUrl" />
<form:form action="${Add_LanguageJCOUrl}" method="post" id="Add_Language_Form" name="Add_Language_Form"  target="result">
<input type="hidden" name="add_language_jco_id" id="add_language_jco_id" value="0"/>
<input type="hidden" name="add_foriegn_language_jco_id" id="add_foriegn_language_jco_id" value="0"/>
</form:form>

<!-- /////////////////// Update Qualification//////////////// -->
<c:url value="Update_QualificationJCOUrl" var="Update_QualificationJCOUrl" />
<form:form action="${Update_QualificationJCOUrl}" method="post" id="Update_Qualification_Form" name="Update_Qualification_Form"  target="result">
<input type="hidden" name="update_qualification_jco_id" id="update_qualification_jco_id" value="0"/>
</form:form>
...
<form:form action="${Change_in_AppointmentUrl}" method="post" id="Change_Appointment_Form"
	...
	<input type="hidden" name="appointment_jco_id" id="appointment_jco_id" value="0" />
</form:form>

<!-- /////////////////// Change In  IdentityCard//////////////// -->
<c:url value="Change_in_IdentityCardUrl" var="Change_in_IdentityCardUrl" />
<form:form action="${Change_in_IdentityCardUrl}" method="post" id="Change_Identity_Card_Form"
	name="Change_Identity_Card_Form" modelAttribute="id" target="result">
	<input type="hidden" name="identitycard_jco_id" id="identitycard_jco_id" value="0" />
</form:form>

<!-- /////////// TA_Status //////////////// -->
 
<c:url value="Change_In_TAJCOUrl" var="Change_In_TAJCOUrl" />
<form:form action="${Change_In_TAJCOUrl}" method="post" id="Change_TA_Form"
	name="Change_TA_Form" modelAttribute="id" target="result">
	<input type="hidden" name="ta_jco_id" id="ta_jco_id" value="0" />
</form:form>

<!-- /////////////////// Update ArmyCource//////////////// -->
<c:url value="Army_CourseJCOUrl" var="Army_CourseJCOUrl" />
<form:form action="${Army_CourseJCOUrl}" method="post" id="Army_Course_Form" name="Army_Course_Form"  target="result">
<input type="hidden" name="army_course_jco_id" id="army_course_jco_id" value="0"/>
</form:form>


<!-- /////////// Change_In_Address_Form //////////////// -->
<c:url value="Change_of_AddressUrl" var="Change_of_AddressUrl" />
<form:form action="${Change_of_AddressUrl}" method="post" id="change_in_addressForm"
	name="change_in_addressForm" target="result">
 <input type="hidden" name="address_jco_id" id="address_jco_id" value="0" />  
</form:form>

<!-- ///////////////////////UPDATE BPET DETAILS///////////// -->
<c:url value="Update_Bpet_DetailsJCOUrl" var="Update_Bpet_DetailsJCOUrl" />
<form:form action="${Update_Bpet_DetailsJCOUrl}" method="post" id="Update_BPETDetails_Form" name="Update_BPETDetails_Form"  target="result">
<input type="hidden" name="update_bpet_details_jco_id" id="update_bpet_details_jco_id" value="0"/>
</form:form>
...
<input type="hidden" name="contactdetails_jco_id" id="contactdetails_jco_id" value="0" /> 
 </form:form> 
...
<!-- /////////// Known_Allergy_Form //////////////// -->
<c:url value="Known_AllergyJCOUrl" var="Known_AllergyJCOUrl" />
<form:form action="${Known_AllergyJCOUrl}" method="post" id="known_allergyForm"
	name="known_allergyForm" target="result">
 <input type="hidden" name="known_allergy_jco_id" id="known_allergy_jco_id" value="0" />  
<!-- <input type="hidden" name="ka_census_id" id="ka_census_id" value="0" /> -->
</form:form>

<!-- /////////// Update_Battle_And_Physical_Casuality_Form //////////////// -->

<c:url value="Update_Battel_And_Physical_CasualtyUrl" var="Update_Battel_And_Physical_CasualtyUrl" />
<form:form action="${Update_Battel_And_Physical_CasualtyUrl}" method="post" id="Update_Battle_And_Physical_Casuality_Form"
	name="Update_Battle_And_Physical_Casuality_Form" modelAttribute="id" target="result">
	<input type="hidden" name="battel_physical_casualty_jco_id" id="battel_physical_casualty_jco_id" value="0" />
<!-- 	<input type="hidden" name="bp_census_id" id="bp_census_id" value="0" /> -->
</form:form>

 <!-- /////////// Update_Discipline_Form //////////////// -->

<c:url value="Update_DisciplineJCOUrl" var="Update_DisciplineJCOUrl" />
<form:form action="${Update_DisciplineJCOUrl}" method="post" id="Update_Discipline_Form"
	name="Update_Discipline_Form" modelAttribute="id" target="result">
	<input type="hidden" name="discipline_jco_id" id="discipline_jco_id" value="0" />
<!-- 	<input type="hidden" name="ud_census_id" id="ud_census_id" value="0" /> -->
</form:form>

 <!-- ///////////  Inter_Arm_Service_Transfer_Form //////////////// -->

<c:url value="Inter_Arm_Service_TransferJCOUrl" var="Inter_Arm_Service_TransferJCOUrl" />
<form:form action="${Inter_Arm_Service_TransferJCOUrl}" method="post" id="Inter_Arm_Service_Transfer_Form"
	name="Inter_Arm_Service_Transfer_Form" modelAttribute="id" target="result">
	<input type="hidden" name="inter_arm_jco_id" id="inter_arm_jco_id" value="0" />
...
<form:form action="${Ssc_To_Permit_CommissionUrl}" method="post" id="Ssc_To_Permit_Commission_Form"
	...
	<input type="hidden" name="ssc_jco_id" id="ssc_jco_id" value="0" />
	<input type="hidden" name="ssc_census_id" id="ssc_census_id" value="0" />
</form:form>


<c:url value="Update_Firing_StandardJCOUrl" var="Update_Firing_StandardJCOUrl" />
<form:form action="${Update_Firing_StandardJCOUrl}" method="post" id="Firing_Standard_Form" name="Firing_Standard_Form"  target="result">
<input type="hidden" name="update_firing_standard_jco_id" id="update_firing_standard_jco_id" value="0"/>
...
<form:form action="${Extension_of_SSCUrl}" method="post" id="Extension_of_SSC_Form"
	...
	<input type="hidden" name="eos_jco_id" id="eos_jco_id" value="0" />
...
<form:form action="${SecondmentUrl}" method="post" id="Secondment_Form"
	...
	<input type="hidden" name="Secondment_jco_id" id="Secondment_jco_id" value="0" />
	<input type="hidden" name="Secondment_census_id" id="Secondment_census_id" value="0" />
</form:form>

<c:url value="DeserterJCOUrl" var="DeserterJCOUrl" />
<form:form action="${DeserterJCOUrl}" method="post" id="Deserter_Form"
	name="Deserter_Form" modelAttribute="id" target="result">
	<input type="hidden" name="deserter_jco_id" id="deserter_jco_id" value="0" />
	<input type="hidden" name="deserter_census_id" id="deserter_census_id" value="0" />
</form:form>

<!-- /////////// Update_Award_Medal_Form //////////////// -->
<c:url value="Update_Awards_MedalsJCOUrl" var="Update_Awards_MedalsJCOUrl" />
<form:form action="${Update_Awards_MedalsJCOUrl}" method="post" id="update_awards_medalForm"
	name="update_awards_medalForm" target="result">
 <input type="hidden" name="update_awards_medals_jco_id" id="update_awards_medals_jco_id" value="0" />  
<!-- <input type="hidden" name="am_census_id" id="am_census_id" value="0" /> -->
</form:form>


<!-- ///////////Canteen History //////////////// -->
<c:url value="CSDJCOUrl" var="CSDJCOUrl" />
<form:form action="${CSDJCOUrl}" method="post" id="canteenForm"
	name="canteenForm" target="result">
 <input type="hidden" name="csd_jco_id" id="csd_jco_id" value="0" />  
...
<c:url value="Change_In_MedicleJCOUrl" var="Change_In_MedicleJCOUrl" />
<form:form action="${Change_In_MedicleJCOUrl}" method="post" id="Change_In_Medicle_Form" name="Change_In_Medicle_Form"  target="result">
<input type="hidden" name="change_in_medicle_jco_id" id="change_in_medicle_jco_id" value="0"/>
<!--  <input type="hidden" name="cim_census_id" id="cim_census_id" value="0"/>  -->
</form:form>

<!-- ///////////////CHANGE IN TRADE /////////////////////////////////////////// -->
<c:url value="Change_in_TradeJCOUrl" var="Change_in_TradeJCOUrl" />
<form:form action="${Change_in_TradeJCOUrl}" method="post" id="Change_In_Trade_Form" name="Change_In_Trade_Form"  target="result">
<input type="hidden" name="trade_jco_id" id="trade_jco_id" value="0"/>
<!--  <input type="hidden" name="cim_census_id" id="cim_census_id" value="0"/>  -->
</form:form>

<!-- ///////////////  Change_In_Class /////////////////////////////////////////// -->
<c:url value="Change_in_ClasssJCOUrl" var="Change_in_ClasssJCOUrl" />
<form:form action="${Change_in_ClasssJCOUrl}" method="post" id="Change_In_Class_Form" name="Change_In_Class_Form"  target="result">
<input type="hidden" name="class_jco_id" id="class_jco_id" value="0"/>
<!--  <input type="hidden" name="cim_census_id" id="cim_census_id" value="0"/>  -->
</form:form>

<!-- ///////////////   Change_In_Pay_Group_Form  /////////////////////////////////////////// -->
<c:url value="Change_in_Pay_GroupJCOUrl" var="Change_in_Pay_GroupJCOUrl" />
<form:form action="${Change_in_Pay_GroupJCOUrl}" method="post" id="Change_In_Pay_Group_Form" name="Change_In_Pay_Group_Form"  target="result">
<input type="hidden" name="pay_group_jco_id" id="pay_group_jco_id" value="0"/>
<!--  <input type="hidden" name="cim_census_id" id="cim_census_id" value="0"/>  -->
</form:form>

<!-- ///////////////    Change_In_Date_Of_Seniority_Form/////////////////////////////////////////// -->
<c:url value="Change_In_Date_Of_SeniorityJCOUrl" var="Change_In_Date_Of_SeniorityJCOUrl" />
<form:form action="${Change_In_Date_Of_SeniorityJCOUrl}" method="post" id="Change_In_Date_Of_Seniority_Form" name="Change_In_Date_Of_Seniority_Form"  target="result">
<input type="hidden" name="date_of_jco_id" id="date_of_jco_id" value="0"/>
<!--  <input type="hidden" name="cim_census_id" id="cim_census_id" value="0"/>  -->
</form:form>

<!-- ///////////////Attachment_Details_Form/////////////////////////////////////////// -->
<c:url value="Attachment_DetailsJCOUrl" var="Attachment_DetailsJCOUrl" />
<form:form action="${Attachment_DetailsJCOUrl}" method="post" id="Attachment_Details_Form" name="Attachment_Details_Form"  target="result">
<input type="hidden" name="attachment_jco_id" id="attachment_jco_id" value="0"/>
<!--  <input type="hidden" name="cim_census_id" id="cim_census_id" value="0"/>  -->
</form:form>

<c:url value="Change_typeofpostingJCOUrl" var="Change_typeofpostingJCOUrl" />
<form:form action="${Change_typeofpostingJCOUrl}" method="post" id="Change_posting_Form" name="Change_posting_Form"  target="result">
<input type="hidden" name="posting_jco_id" id="posting_jco_id" value="0"/> 
</form:form>
