			...
			<div class="panel-group" id="accordion">
				<div class="panel panel-default" id="insp_div1">
					...
					<div class="panel-heading">
						...
						<b>APPROVED DATA OF UPDATED JCO/OR</b>
						</h4>
					</div> 
								...
								<div class="col-md-12">
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<label class=" form-control-label" id="ta_authority"></label>
												<input type="hidden" id="ta_authority" name="ta_authority" class="form-control autocomplete" autocomplete="off">
												<input type="hidden" id="ta_id" name="ta_id" class="form-control autocomplete" autocomplete="off">
									...
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<label class=" form-control-label" id="ta_date_of_authority"></label>
												<input type="hidden" id="ta_date_of_authority" name="ta_date_of_authority" class="form-control autocomplete" autocomplete="off">
											</div>
										</div>
									</div>
								</div>
			...
			<div class="panel-group" id="accordion2">
				<div class="panel panel-default" id="f_div1">
					...
					<div id="collapse1f" class="panel-collapse collapse">
						...
						<div class="col-md-12"  id="marital_eventDiv" style="display: none;">
							<div class="col-md-6">
								<div class="row form-group">
									<div class="col-md-4">
										<label class=" form-control-label"><strong
							...
							<div class="col-md-12" id="divorceDiv" style="display:none">				
										<div class="col-md-6">
											<div class="row form-group">
												...
												<div class="col-md-8">
												<label id="divorce_date" class=" form-control-label"></label></div>
											</div>
										</div>
									</div>
				...
				<div class="panel panel-default" id="g_div1">
					...
					<div id="collapse1g" class="panel-collapse collapse">
						<div class="card-body card-block">
								...
								<table id="m_children_details_table" class="table-bordered watermarked" style="margin-top: 10px; width: 100%;">
						...
						<div class="col-md-6">
              					<div class="row form-group">
					               <div class="col-md-4">
					                ...
					                <select name="nok_countrySelect" id="nok_countrySelect" class="form-control" style="display:none" >
						                         <option value="0">--Select--</option>
						               ...
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                 <label id="nok_state" class=" form-control-label"></label>
						                	<select name="nok_stateSelect" id="nok_stateSelect" class="form-control-sm form-control" style="display:none"  >
						                        <option value="0">--Select--</option>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <select name="nok_districtSelect" id="nok_districtSelect" class="form-control" style="display:none"  >
					                		<option value="0">--Select--</option>
					...
					<div id="collapse1i" class="panel-collapse collapse">
              					...
              					<div class="row form-group">
					               <div class="col-md-4">
					                ...
					                <div class="col-md-8">
					                       ...
					                       <select name="pre_country_val" id="pre_country_val" class="form-control" style="display: none;">
						                          <option value="0">--Select--</option>
												<c:forEach var="item" items="${getMedCountryName}" varStatus="num">
													<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
												</c:forEach>
					               ...
					               <div class="col-md-4">
					                ...
					                <div class="col-md-8">
						                 ...
						                 <label id="pre_domicile_state" class=" form-control-label"></label>									                     
					               			<select name="pre_domicile_state_val" id="pre_domicile_state_val" class="form-control" style="display: none;">
						                        <option value="0">--Select--</option>
												<c:forEach var="item" items="${getMedStateName}" varStatus="num">
													<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
												</c:forEach>
	              					...
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                 ...
						                 <select name="pre_domicile_district_val" id="pre_domicile_district_val" class="form-control" style="display: none;">
					                		<option value="0">--Select--</option>
											<c:forEach var="item" items="${getMedDistrictName}" varStatus="num">
					               ...
					               <div class="col-md-4">
					                ...
					                <div class="col-md-8">
						                   <label id="pre_domicile_tesil" class=" form-control-label"></label>			                     
					               			<select name="pre_domicile_tesil_val" id="pre_domicile_tesil_val" class="form-control"  style="display: none;">
						...
						<div class="col-md-6">
					              ...
					              <label id="per_home_addr_country" class=" form-control-label"></label>			                   
					                <select name="per_home_addr_country_val" id="per_home_addr_country_val" class="form-control"  style="display: none;" >
						                        <option value="0">--Select--</option>
												<c:forEach var="item" items="${getMedCountryName}" varStatus="num">
													<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
												</c:forEach>
						               ...
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                 <label id="per_home_addr_state" class=" form-control-label"></label>	
						                	<select name="per_home_addr_state_val" id="per_home_addr_state_val" class="form-control"   style="display: none;"  >
						                        <option value="0">--Select--</option>
												<c:forEach var="item" items="${getMedStateName}" varStatus="num">
													<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
												</c:forEach>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <select name="per_home_addr_district_val" id="per_home_addr_district_val" class="form-control"  style="display: none;"  >
					                		<option value="0">--Select--</option>
											<c:forEach var="item" items="${getMedDistrictName}" varStatus="num">
												<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
											</c:forEach>
	              					...
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                 ...
						                 <select name="per_home_addr_tehsil_val" id="per_home_addr_tehsil_val" class="form-control" style="display: none;">
			 	 ...
			 	 <div class="col-md-12">	
              					...
              					<div class="row form-group">
					               <div class="col-md-4">
					                ...
					                <div class="col-md-8">
					                    ...
					                    <select name="pers_addr_country_val" id="pers_addr_country_val" class="form-control" style="display: none;"  >
						                          <option value="0">--Select--</option>
												<c:forEach var="item" items="${getMedCountryName}" varStatus="num">
													<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
												</c:forEach>
              				...
              				<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <label id="pers_addr_state" class=" form-control-label"></label>	
						                	<select name="pers_addr_state_val" id="pers_addr_state_val" class="form-control" style="display: none;"  >
						                        <option value="0">--Select--</option>
												<c:forEach var="item" items="${getMedStateName}" varStatus="num">
													<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
												</c:forEach>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <select name="pers_addr_district_val" id="pers_addr_district_val" class="form-control" style="display: none;"    >
					                		<option value="0">--Select--</option>
											<c:forEach var="item" items="${getMedDistrictName}" varStatus="num">
												<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
											</c:forEach>
	              					...
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                 ...
						                 <select name="pers_addr_tehsil_val" id="pers_addr_tehsil_val" class="form-control" style="display: none;"     >
						...
						<!-- 	 <input type="radio" id="pers_addr_rural" name="pers_addr_rural_urban" value="rural" > Rural</label> 
							...
							<label for="text-input"	class=" form-control-label"
									style="color: #dd1a3e; margin-left: 10px;"> Family Staying SF ACCN </label>
							<div class="col-md-12">
								<div class="col-md-6">
									<div class="row form-group">
										<div class="col-md-4">
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                 <input type="text" id="qualification_authority" name="qualification_authority" class="form-control autocomplete" autocomplete="off" maxlength="50" onkeyup="return specialcharecter(this)">
						                </div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
	...
	<form id="madical_category_form">
		<div class="card">
			...
			<input type="hidden" id="mad_classification_count" name="mad_classification_count" value="NIL">
				...
				<div  id="shapediv" class="watermarked" style="width: -webkit-fill-available;">				
						...
						<div class="col-md-12">
							...
							<div class="col-md-6">
								...
								<!--  <input type="radio" id="classification_of_casuality1" name="classification_of_casuality" value="physical_casuality" onchange="Casuality_radio();">
								  ...
								  <label for="physical_casuality">Physical Casuality</label>
						...
						<div class="col-md-6">
              					<div class="row form-group">
					               <div class="col-md-4">
					                ...
					                <select name="per_home_addr_country_val" id="perm_home_addr_country_val" class="form-control"  style="display: none;" >
						                        <option value="0">--Select--</option>
												<c:forEach var="item" items="${getMedCountryName}" varStatus="num">
													<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
												</c:forEach>
						               ...
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                 <label id="perm_home_addr_state" class=" form-control-label"></label>	
						                	<select name="per_home_addr_state_val" id="perm_home_addr_state_val" class="form-control"  style="display: none;" >
						                        <option value="0">--Select--</option>
												<c:forEach var="item" items="${getMedStateName}" varStatus="num">
													<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
												</c:forEach>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <select name="per_home_addr_district" id="perm_home_addr_district_val" class="form-control" style="display: none;"  >
					                		<option value="0">--Select--</option>
											<c:forEach var="item" items="${getMedDistrictName}" varStatus="num">
												<option value="${item[0]}" name="${item[1]}">${item[1]}</option>
											</c:forEach>
						...
						<div class="col-md-12">	              					
	              					...
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <label id="trade"> </label>
						                 <select name="trade_val" id="trade_val" class="form-control" style="display: none;">
												<option value="-1">--Select--</option>
	              			...
	              			<div class="col-md-12">	              					
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"> Date of Change of  Trade</label>
						                </div>
						                <div class="col-md-8">
						...
						<div class="col-md-12">	              					
	              			    ...
	              			    <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                <label id="cla_class"></label>
						                <select name="cla_class_val" id="cla_class_val" class="form-control" style="display: none;">
												<option value="-1">--Select--</option>
	              			...
	              			<div class="col-md-12">	              					
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"> Date of New Class(PAY)</label>
						                </div>
						                <div class="col-md-8">
						...
						<div class="col-md-12">	              					
	              			    ...
	              			    <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                  <label id="gp_group"></label>
						                <select name="gp_group_val" id="gp_group_val" class="form-control" style="display: none;">
												<option value="-1">--Select--</option>
	              			...
	              			<div class="col-md-12">	              					
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"> Date of New PAY GROUP</label>
						                </div>
						                <div class="col-md-8">
						...
						<div class="col-md-12">	              					
	              			...
	              			<div class="col-md-12">	              					
	              			    ...
	              			    <div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"> New Date of Seniority</label>
						                </div>
						                <div class="col-md-8">
	              			...
	              			<div class="col-md-12">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"> Reason for the Change</label>
						                </div>
						                <div class="col-md-8">
...
<!-- START ATTACHMENT DETAIL -->
 ...
 <form id="form_attachment">
			          ...
			          <div class="card-body card-block">
						...
						<div class="col-md-12">	              					
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"> Movement Order Number</label>
						                </div>
						                <div class="col-md-8">
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"> Date of Movement Order</label>
						                </div>
						                <div class="col-md-8">
	              			...
	              			<div class="col-md-12">	              					
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"> Attached to (Unit SUS No)</label>
						                </div>
						                <div class="col-md-8">
            	...
            	<div class="col-md-12">	              					
	              			...
	              			<div class="col-md-12">	              					
	              				...
	              				<div class="col-md-6">
	              					...
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"> Reasons</br>(Med/Legal/Official/Adm etc...)</label>
						                </div>
						                <div class="col-md-8">
	...
	<c:if test="${ChangeOfposting1.size() != 0}">
					 ...
					 <div class="col-md-12">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               ...
						               <label class=" form-control-label" id="type_of_posting"></label>
						               <select name="post_val" id="post_val" class="form-control" style="display: none">
												<option value="-1">--Select--</option>
...
function getChangeOfRank(){
	...
	<c:if test="${ChangeOfRank.size() != 0}">
				 $('#ch_r_id').val('${ChangeOfRank.get(0).id}');
					...
					$('#date_of_attestation').text(convertDateFormate('${ChangeOfRank.get(0).date_of_attestation}'));
				if($('#date_of_attestation').text()!=''){
					$("#attestationDiv").show();
				}
					var rank_id='${ChangeOfRank.get(0).id}';
			
					$.post('getChangeOfArmy_NO_JCODataAPP?' + key + "=" + value, {rank_id:rank_id,jco_id:jco_id}, function(k){
						 if(k.length!=0){
...
function get_change_of_name(){
	...
	<c:if test="${ChangeOfName.size() != 0}">
				 ...
				 $("#first_namelb").text('${ChangeOfName.get(0).first_name}');
				 $("#middle_namelb").text('${ChangeOfName.get(0).middle_name}');
				 $("#last_namelb").text('${ChangeOfName.get(0).last_name}');
...
function get_Appointment(){
	...
	<c:if test="${ChngAppointment.size() != 0}">
				...
				$('#appoint_id').val('${ChngAppointment.get(0).id}');
				 ...
				 $("#appt_date_of_authority").text('${ChngAppointment.get(0).appt_date_of_authority}' );
...
function getIdentity_Card(){
	...
	<c:if test="${IdentityCard.size() != 0}">
				 ...
				 $('#identity_image_preview').attr("src", "censusIdentityJCOConvertpath?i_id="+'${IdentityCard.get(0).id}'+" ");
...
function getSpouseQualificationData(){
	...
	var jco_id = '${jco_id}';
	 var i=0;
	var  app_status=1;
	  $.post('getSpouseQualificationJCOData?' + key + "=" + value, {jco_id:jco_id,app_status:app_status }, function(j){
		  var v = j.length;
			if(v != 0) {
...
function csd_details() {


	var xaller = 0;
	
	
		<c:forEach var="j" items="${CSDDetails}" varStatus="num">
// 		x = x + 1;
		xaller=xaller+1;
		var dob = convertDateFormate('${j.date_of_birth}');
		...
		$("table#CSD_table").append('<tr id="tr_csd'+xaller+'">'
				...
				+'<td><label id="relation_lb'+xaller+'"></label><select style="display:none"  id="relation'+xaller+'" name="relation'+xaller+'" value="${j.relation}" onchange="getNameAndDob('+xaller+');" class="form-control autocomplete" >'
				+' <option value="0">--Select--</option>'
				...
				+'<td><label  id="name'+xaller+'">${j.name}</label></td>'
				+'<td>' 
				+' <label   id="date_of_birth'+xaller+'">'+dob+'</label>'
				+ '</td>'
				+'<td>'
				...
				+'</tr>');
		$('#relation' + xaller).val('${j.relation }');
...
function getInterArm(){
	<c:if test="${InterArmTransfer.size() != 0}">
				...
				$('#record_office_unit').text('${InterArmTransfer.get(0).record_office_unit}');
				$('#record_office_sus').text('${InterArmTransfer.get(0).record_office_sus}');
...
function get_non_eff_address_details(){
	...
	$.post('address_details_GetJCODataAppr?' + key + "=" + value,{jco_id:jco_id,app_status:app_status }, function(j){
		var v=j.length;
		if(v!=0){
...
function per_address(){
  ...
  /// if($("#check_per_address").prop('checked') == true){  
   //
   	$.post('getPerAddressDataStatus1?' + key + "=" + value, {jco_id:jco_id}, function(j){
...
function get_change_of_Discipline(){
		...
		<c:if test="${Discipline.size() != 0}">
		$("#disi_authority").text('${Discipline.get(0).disi_authority}');
		$("#disi_authority_date").text(convertDateFormate('${Discipline.get(0).disi_authority_date}'));
...
function get_promo_exam_details(){
		...
		<c:forEach var="j" items="${Promotional_Exam}" varStatus="num"> 
			xpro=xpro+1;
				if(xpro==1){
				...
				$("table#promo_exam_table").append('<tr id="tr_lang'+xpro+'">'
						...
						+'</td>'
						+'</tr>');
				 $('#promo_exam'+xpro).val('${j.exam}' );
				 $('#promo_examlb'+xpro).text($('#promo_exam'+xpro+" option:selected").text() );
				 if('${j.exam_other}'!=null && '${j.exam_other}'!='' && ( $('#promo_examlb'+xpro).text().toUpperCase()==other ||  $('#promo_examlb'+xpro).text().toUpperCase()==others)){
					 $('#promo_examlb'+xpro).text('${j.exam_other}');
					}
				 $('#promo_exam_dop'+xpro).text('${j.date_of_passing}');
				 $('#promo_exam_authority').text('${j.authority}' );
...
function get_allergic_details(){
		...
		xaller=0;
	 	<c:forEach var="j" items="${Allergy}" varStatus="num"> 
			...
			xaller=xaller+1;
				...
				$("table#allergic_table").append('<tr id="tr_lang'+xaller+'">'
						+'<td class="proex_srno" style="width: 2%;">'+xaller+'</td>'
						+'<td><label  id="allergic'+xaller+'" name="allergic'+xaller+'" class=" autocomplete" >'+"${j.medicine}"+'</label>'
						+'</td>'
						+'</tr>');
...
function trade_details(){
	<c:if test="${trade1.size() != 0}">
	var jco_id = $("#jco_idV").val();
	
	 $('#td_id').val( '${trade1.get(0).id}');
	 $("#td_authority").text('${trade1.get(0).td_authority}');
	 $("#td_date_authority").text(convertDateFormate('${trade1.get(0).td_date_authority}'));
	 $("#date_of_trade").text(convertDateFormate('${trade1.get(0).date_of_trade}'));
	 $('#trade_val').val('${trade1.get(0).trade}');
...
<c:if test="${cl1.size() != 0}">
var jco_id = $("#jco_idV").val();
 $('#cla_id').val( '${cl1.get(0).id}');
 $("#cla_authority").text('${cl1.get(0).cla_authority}');
 $("#cla_date_authority").text(convertDateFormate('${cl1.get(0).cla_date_authority}'));
 $("#date_of_class").text(convertDateFormate('${cl1.get(0).date_of_class}'));
 $('#cla_class_val').val('${cl1.get(0).cla_class}');
...
<c:if test="${group1.size() != 0}">
var jco_id = $("#jco_idV").val();
 $('#gp_id').val( '${group1.get(0).id}');
 $("#gp_authority").text('${group1.get(0).gp_authority}');
 $("#gp_date_authority").text(convertDateFormate('${group1.get(0).gp_date_authority}'));
 $("#date_of_group").text(convertDateFormate('${group1.get(0).date_of_group}'));
 $('#gp_group_val').val('${group1.get(0).gp_group}');
...
<c:if test="${seniority1.size() != 0}">
var jco_id = $("#jco_idV").val();
 $('#se_id').val('${seniority1.get(0).id}');
 $("#se_authority").text('${seniority1.get(0).se_authority}');
 $("#se_date_authority").text(convertDateFormate('${seniority1.get(0).se_date_authority}'));
 $("#date_of_seniority").text(convertDateFormate('${seniority1.get(0).date_of_seniority}'));
 $('#reason_for_change').text('${seniority1.get(0).reason_for_change}');
 $("#old_dt_seniority").text(convertDateFormate('${seniority1_old.get(0).date_of_seniority}'));
...
function get_attachment_details(){
	...
	<c:if test="${attachment1.size() != 0}">
	 $('#att_id').val('${attachment1.get(0).id}');
	 $("#att_authority").text('${attachment1.get(0).att_authority}');
	 $("#att_date_authority").text(convertDateFormate('${attachment1.get(0).att_date_authority}'));
	 $("#att_date_of_move").text(convertDateFormate('${attachment1.get(0).att_date_of_move}'));
	 $('#att_movement_number').text('${attachment1.get(0).att_movement_number}');
	 
	 $('#att_from').text(convertDateFormate('${attachment1.get(0).att_from}'));
	 $("#att_to").text(convertDateFormate('${attachment1.get(0).att_to}'));
	 
	 $('#att_sus_no').text('${attachment1.get(0).att_sus_no}');
	 
	 

	 var sus_no = '${attachment1.get(0).att_sus_no}';
	 ...
	 $("#att_place").text('${attachment1.get(0).att_place}');
	 
	 $('#att_reasons').text('${attachment1.get(0).att_reasons}');
	 $("#att_duration").text('${attachment1.get(0).att_duration}');
...
function get_postingtype(){
	...
	<c:if test="${ChangeOfposting1.size() != 0}">
			     ...
			     $('#ch_pp_id').val('${ChangeOfposting1.get(0).id}' );
				//$("#type_of_posting").text('${ChangeOfposting.get(0).type_of_post}');
				 
		 $('#post_val').val('${ChangeOfposting1.get(0).type_of_post}');	
