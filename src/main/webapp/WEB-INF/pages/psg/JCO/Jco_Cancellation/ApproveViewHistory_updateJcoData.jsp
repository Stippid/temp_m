			...
			<div class="panel-group" id="accordion">
				<div class="panel panel-default" id="insp_div1">
					...
					<div class="panel-heading">
						...
						<b>VIEW HISTORY/CANCEL DATA OF UNIT JCO/OR 
...
<!-- 										<th style="width: 10%;">Rank Type</th> -->
										...
										<th style="width: 10%;">Date of Attestation</th>
...
<!-- 									<th style="font-size: 10px">Exact Place</th> -->
<!-- 									<th style="font-size: 10px">Whether On</th> -->
					...
					<div id="collapse1x" class="panel-collapse collapse">
								...
								<thead style="color: white; text-align: center;">
									<tr>
										...
										<th style="width: 10%;">Record Office</th>
...
<!-- 	END INTER ARM -->
			...
			<div class="panel-group" id="accordion17">
				<div class="panel panel-default" id="ff_div16">
					...
					<div id="collapse1ff" class="panel-collapse collapse">
			           <div class="card-body card-block">
			           <table id="trade_table" class="table-bordered " style="margin-top: 10px; width: 100%;">
								<thead style="color: white; text-align: center;">
									<tr>
										<th style="width: 2%;">Sr No</th>
										<th style="width: 10%;">Authority</th>
										<th style="width: 10%;">Date of Authority</th>
										<th style="width: 10%;">New Trade</th>
										<th style="width: 10%;">Date of Change of  Trade</th>										
										<th style="width: 10%;">Updated By</th>
										<th style="width: 10%;">Updated Date</th>
										<th style="width: 10%;">Action</th>
									</tr>
								</thead>
								<tbody data-spy="scroll" id="trade_tbody" style="min-height: 46px; max-height: 650px; text-align: center;">
			...
			<div class="panel-group" id="accordion17">
				<div class="panel panel-default" id="gg_div16">
					...
					<div id="collapse1gg" class="panel-collapse collapse">
			            <div class="card-body card-block">
			            <table id="pay_class_table" class="table-bordered " style="margin-top: 10px; width: 100%;">
								<thead style="color: white; text-align: center;">
									<tr>
										<th style="width: 2%;">Sr No</th>
										<th style="width: 10%;">Authority</th>
										<th style="width: 10%;">Date of Authority</th>
										<th style="width: 10%;">New Class(PAY)</th>
										<th style="width: 10%;">Date of New Class(PAY)</th>										
										<th style="width: 10%;">Updated By</th>
										<th style="width: 10%;">Updated Date</th>
										<th style="width: 10%;">Action</th>
									</tr>
								</thead>
								<tbody data-spy="scroll" id="pay_class_tbody" style="min-height: 46px; max-height: 650px; text-align: center;">
 ...
 <form id="form_pay_group">
			...
			<div class="panel-group" id="accordion17">
				<div class="panel panel-default" id="hh_div16">
					...
					<div id="collapse1hh" class="panel-collapse collapse">
			          <div class="card-body card-block">
			          <table id="pay_group_table" class="table-bordered " style="margin-top: 10px; width: 100%;">
								<thead style="color: white; text-align: center;">
									<tr>
										<th style="width: 2%;">Sr No</th>
										<th style="width: 10%;">Authority</th>
										<th style="width: 10%;">Date of Authority</th>
										<th style="width: 10%;">NEW PAY GROUP</th>
										<th style="width: 10%;">Date of New PAY GROUP</th>										
										<th style="width: 10%;">Updated By</th>
										<th style="width: 10%;">Updated Date</th>
										<th style="width: 10%;">Action</th>
									</tr>
								</thead>
								<tbody data-spy="scroll" id="pay_group_tbody" style="min-height: 46px; max-height: 650px; text-align: center;">
	...
	<c:if test="${seniorityDtdetails > 0}">
			...
			<div class="panel-group" id="accordion17">
				<div class="panel panel-default" id="ii_div16">
					...
					<div id="collapse1ii" class="panel-collapse collapse">
			          <div class="card-body card-block">
			          <table id="dt_seniority_table" class="table-bordered " style="margin-top: 10px; width: 100%;">
								<thead style="color: white; text-align: center;">
									<tr>
										<th style="width: 2%;">Sr No</th>
										<th style="width: 10%;">Authority</th>
										<th style="width: 10%;">Date of Authority</th>
										<th style="width: 10%;">New Date of Seniority</th>
										<th style="width: 10%;">Reason for the Change</th>										
										<th style="width: 10%;">Updated By</th>
										<th style="width: 10%;">Updated Date</th>
										<th style="width: 10%;">Action</th>
									</tr>
								</thead>
								<tbody data-spy="scroll" id="dt_seniority_tbody" style="min-height: 46px; max-height: 650px; text-align: center;">
			...
			<div class="panel-group" id="accordion17">
				<div class="panel panel-default" id="jj_div16">
					...
					<div id="collapse1jj" class="panel-collapse collapse">
			          <div class="card-body card-block">
			          <table id="attachment_table" class="table-bordered " style="margin-top: 10px; width: 100%;">
								<thead style="color: white; text-align: center;">
									<tr>
										<th rowspan="2" style="width: 2%;">Sr No</th>
										<th rowspan="2" style="">Authority</th>
										<th rowspan="2" style="">Date of Authority</th>
										<th rowspan="2" style="">Movement Order Number</th>
										<th rowspan="2" style="">Date of Movement Order</th>
										<th rowspan="2" style="">Attached to (Unit Name)</th>
										<th rowspan="2" style="">Place</th>
										<th colspan="4" style="">Period of Attachment</th>
										<th rowspan="2" style="">Updated By</th>
										<th rowspan="2" style="">Updated Date</th>
								...
								<tbody data-spy="scroll" id="attachment_tbody" style="min-height: 46px; max-height: 650px; text-align: center;">
...
<div class="card-header-inner" style="margin-left:20px;margin-bottom:20px;"> <strong>E - Exclusive Limitations</strong></div>
  ...
  <form:form name="Approve_Jco_Data" id="Approve_Jco_Data" action="Approve_ViewHistoryJco_DataAction" method="post" class="form-horizontal" >
	<div class="animated fadeIn">
		<div class="card">
		                          	
						            						                   
			               		<input type="hidden" id="jco_idApp" name="jco_idApp" value="0" class="form-control autocomplete" autocomplete="off"  > 						                   
	...
	//alert("hello---" + personnel_no);
	 $.post('GetPersonnelNoData?' + key + "=" + value,{ personnel_no : personnel_no },function(j) {
		 if(j!=""){
	    	...
	    	var jco_id =j[0][0]; 
	    	 $.post('GetCensusDataApprove?' + key + "=" + value,{ jco_id : jco_id },function(k) {
	    		 if(k.length > 0)
	    		 {alert(k[0][1]);
	    			  $('#census_id').val(k[0][1]); 
	    	 ...
	    	 $.post('GetServingStatus?' + key + "=" + value,{ jco_id : jco_id },function(k) {
	    		 if(k.length > 0)
	    		 {
...
//*************************************Start Children Details*****************************//
		...
		function m_children_Details() {
			...
			var i=0;
			 $.post('getHisChildData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
...
function get_cda_acnt_no(){
	...
	var jco_id=$('#jco_idV').val();
	var i=0;
	 $.post('getHisContactDetailsData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
		 var v=j.length;
...
//************************************* START NON EFFECTIVE DETAIL*****************************//
 function getNon_effective(){
	 ...
	 $.post('getHisNon_effectiveData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
		 var v=j.length;
		 $('#non_eff_tbody').empty(); 
	     if(v!=0){
...
function get_non_eff_address_details(){
	...
	$.post('address_details_GetData_jco?' + key + "=" + value,{jco_id:jco_id }, function(j){
		var v=j.length;
		if(v!=0){
...
function non_effect_save(){
	...
	formdata+="&jco_id="+jco_id+"&comm_date="+comm_date;	
...
function get_religion(){
	...
	var jco_id=$('#jco_idV').val();
	var i=0;
	 $.post('getHisChangeOfReligionData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
		 var v=j.length;
...
function get_change_of_name(){
	...
	var jco_id=$('#jco_idV').val();
	var i=0;
	 $.post('getHisChangeOfNameData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
		 var v=j.length;
	     ...
	     if(v!=0){
			...
			for(i;i<v;i++){
				...
				$("table#changeOfName_table").append('<tr id="tr_changeOfName'+con+'">'
	                     ...
	                     +'<td style="width: 10%;">'+j[i].authority+'</td>'
	                     +'<td style="width: 10%;">'+dauth+'</td>'
	                     +'<td style="width: 10%;">'+j[i].first_name+'</td>'
	                     +'<td style="width: 10%;">'+j[i].middle_name+'</td>'
	                     +'<td style="width: 10%;">'+j[i].last_name+'</td>'
	                     +'<td style="width: 10%;">'+j[i].modified_by+'</td>'
	                     +'<td style="width: 10%;">'+dmod+'</td>'
	                     +'<td style="display:none;"><input type="text" id="changeOfRank_ch_id'+con+'" name="changeOfRank_ch_id'+con+'"  value="' + j[i].id + '" class="form-control autocomplete" autocomplete="off" ></td>'
	                     +'<td style="width: 10%;"><a  class="btn btn-danger btn-sm" value="REMOVE" title = "REJECT" '+j[i].action+'><i class="fa fa-times"></i></a>'
...
var jco_id=$('#jco_idV').val();
var i=0;
 $.post('getHisChangeOfRankData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
	 var v=j.length;
...
//                      +'<td style="width: 10%;">'+j[i].rank_type+'</td>'
                     ...
                     +'<td style="width: 10%;">'+convertDateFormate(j[i].date_of_attestation)+'</td>'
                     +'<td style="width: 10%;">'+j[i].army_no+'</td>'
                     +'<td style="width: 10%;">'+j[i].modified_by+'</td>'
                     +'<td style="width: 10%;">'+dmod+'</td>'
...
function getawardsNmedals(){
    ...
    var i=0;
                           ...
                           $.post('getHisAwardAndMedalData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
                        		 var v=j.length;
...
function get_language_details(){
	...
	var jco_id=$('#jco_idV').val();
	var i=0;
	 $.post('getHisLanguageDetailsData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
			var v=j.length;
			$('#langtbody').empty(); 
			 if(v!=0){
...
function get_foreign_language_details(){
	...
	var jco_id=$('#jco_idV').val();
	var i=0;
	 $.post('getHisForeignLangData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
			var v=j.length;
			$('#flangtbody').empty(); 
			 if(v!=0){
...
function get_Secondment(){
		 ...
		 var jco_id=$('#jco_idV').val(); 
		 var i=0;
		 $.post('getHisSecondmentData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
			 var v=j.length;
...
function getUPForeign_CountriesDetails(){
	...
	var jco_id=$('#jco_idV').val();
	var i=0;
	 $.post('getHisForeignCountryData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
			var v=j.length;
...
function getInterArm(){
	 ...
	 var jco_id=$('#jco_idV').val(); 
	 var i=0;
	 $.post('getHisInter_arm_service_transferData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
		 var v=j.length;
	     ...
	     if(v!=0){
			...
			for(i;i<v;i++){
				...
				$("table#interArm_table").append('<tr id="tr_changeOfName'+con+'">'
	                     ...
	                     +'<td style="width: 10%;">'+j[i].record_office_unit+'</td>'
...
function getfamily_marriageDetails(){
	...
	var jco_id=$('#jco_idV').val();
	var i=0;
	 $.post('getHisfamily_marriedData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
		 var v=j.length;
	     ...
	     if(v!=0){
			...
			for(i;i<v;i++){
	     		...
	     		$("table#Marital_status_table").append('<tr id="tr_Marital_status'+cor+'">'
	                     ...
	                     +'<td style="width: 10%;">'+j[i].separated_from_dt+'</td>'
...
function getSpouseQualificationData(){
	...
	var i=0;
	 $.post('getHisPendingSpouseQualificationData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
		 var v=j.length;
...
function fire_Details() {
	...
	var jco_id=$('#jco_idV').val();
	var i=0;
	 $.post('getHisFiringDetailsData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
			var v=j.length;
			$('#fire_stdtbody').empty(); 
			 if(v!=0){
...
function bpet_save_fn(ps){
    ...
    if($('#unit_name'+ps).val() == ""){
	   ...
	   $.post('BPET_action?' + key + "=" + value, {BPET_result : BPET_result ,bept_result_others:bept_result_others,BPET_qe : BPET_qe,
		   year:year,unit_sus_no:unit_sus_no,id : id,census_id :census_id,jco_id:jco_id }, function(data){
	          if(data=="update")
	        	  alert("Data Updated Successfully");
	          else if(parseInt(data)>0){
	        	 $('#id'+ps).val(data);
...
function bpet_Details() {
	...
	var jco_id=$('#jco_idV').val();
	var i=0;
	 $.post('getHisBpetDetailsData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
			var v=j.length;
			$('#bpettbody').empty(); 
			 if(v!=0){
...
function getIdentity_Card(){
	...
	var jco_id=$('#jco_idV').val();
	var i=0;
	 $.post('getHisIdentity_CardData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
		 var v=j.length;
	     ...
	     if(v!=0){
			...
			for(i;i<v;i++){
				...
				$("table#Identity_card_table").append('<tr id="tr_Identity_card'+cor+'">'
	                     ...
	                     +'<td style="width: 10%;"><img alt="Jco/Or Image"  src="censusIdentityJCOConvertpath?i_id='+j[i].id+'" width="100" height="100" /></td>'
	                     +'<td style="width: 10%;">'+j[i].modified_by+'</td>'
	                     +'<td style="width: 10%;">'+dmod+'</td>'
	                     +'<td style="display:none;"><input type="text" id="Identity_card_ch_id'+cor+'" name="Identity_card_ch_id'+cor+'"  value="' + j[i].id + '" class="form-control autocomplete" autocomplete="off" ></td>'
	                     +'<td style="width: 10%;"><a  class="btn btn-danger btn-sm" value="REMOVE" title = "REJECT" '+j[i].action+'><i class="fa fa-times"></i></a>'
...
function get_changeinaddress_details(){
	...
	var jco_id=$('#jco_idV').val();
	var i=0;
	 $.post('getHisAddressData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
		 var v=j.length;
...
function get_changeaddress_details(){
	...
	$.post('address_details_GetData?' + key + "=" + value,{jco_id:jco_id }, function(j){
		var v=j.length;
		if(v!=0){
  ...
  var text2 = $("#nok_state option:selected").text();
   ...
   var comm_date=$('#comm_date').val();
	...
	var nok_id=$("#nok_id").val();		
		formvalues+="&nok_id="+nok_id+"&jco_id="+jco_id+"&comm_date="+comm_date;	
...
function get_nokaddress_details(){
	...
	var jco_id=$('#jco_idV').val();
	var i=0;
	 $.post('getHisNokAddressData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
		 var v=j.length;
...
function get_Battle_and_Physical_Casuality_details(){
	...
	var jco_id=$('#jco_idV').val();
	var i=0;
	 $.post('getHisBattle_physical_casualityData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
		 var v=j.length;
...
// 	 	+'   </td>'
	 ...
	 function medical_cat_save(){
		 var count_classi = 0;
			...
			var jco_id=$('#jco_id').val();			
			formvalues+="&jco_id="+jco_id+"&comm_date="+comm_date;
...
// }
	 function getsShapeDetails(id){
		 ...
		 var Shape='S'
		 var i=0;
		  $.post('madical_cat_HisGetData_jco?' + key + "=" + value, {id:id}, function(j){
				var v=j.length;
...
//qualification
  ...
  function getQualifications(){
		...
		var jco_id=$('#jco_idV').val();
		var i=0;
		 $.post('getHisQualificationData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
				var v=j.length;
...
function get_promo_exam_details(){
	...
	var jco_id=$('#jco_idV').val();
	var i=0;
	 $.post('getHisPromotionalExamData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
			var v=j.length;
...
function army_course_add_fn(q){
	...
	$("table#army_course_table").append('<tr id="tr_army_course'+armyc+'">'
			...
			+'<td style="width: 10%;">'
			+'<input type="text" id="army_course_name'+armyc+'" name="army_course_name'+armyc+'" class="form-control autocomplete" onkeyup="AutoCompleteCourse(this);" autocomplete="off" maxlength="20">'
			+'</td>'
			+'<td style="width: 10%;">'
...
function get_army_course_details(){
	...
	var jco_id=$('#jco_idV').val();
	var i=0;
	 $.post('getHisArmyCourseData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
			var v=j.length;
...
function get_Appointment(){
	...
	var jco_id=$('#jco_idV').val();
	var i=0;
	 $.post('getHisChangeOfAppointmentData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
		 var v=j.length;
...
// 		}
	...
	if ('${personnel_no_edit}' != ""){
		var personnel_no = '${personnel_no_edit}';
		    	...
		    	var jco_id ='${jco_id6}'; 
		    	$.post('GetJcoOrCensusDataCancelHistory?' + key + "=" + value,{ jco_id : jco_id },function(k) {
		    		 if(k.length > 0)
		    		 {
...
function get_change_of_Discipline(){
	...
	var jco_id=$("#jco_id").val();
	 ...
	 var i=0;
	$.post('getHisDisciplineData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
		 var v=j.length;
...
function get_allergic_details(){
	...
	var jco_id=$('#jco_idV').val();
	var i=0;
	 $.post('getHisAllergyData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
			var v=j.length;
			$('#allergictbody').empty(); 
			 if(v!=0){
...
function get_deserter(){
	 ...
	 var jco_id=$('#jco_idV').val(); 
	 var i=0;
	 $.post('getHisDeserterData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
		 var v=j.length;
...
function get_CSD_details(){
	 ...
	 var jco_id=$('#jco_idV').val(); 
	 var i=0;
	 $.post('getHisCSDData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
		 var v=j.length;
		 $('#csd_tbody').empty(); 
	     if(v!=0){
...
function get_trade_details(){
	 ...
	 var jco_id=$('#jco_idV').val(); 
	 var i=0;
	 $.post('getHisTradeData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
		 var v=j.length;
		 $('#trade_tbody').empty(); 
	     if(v!=0){
			...
			for(i;i<v;i++){
	     		...
	     		var mod=convertDateFormate(j[i].modified_date);
	     		var doa=convertDateFormate(j[i].td_date_authority);
	     		var dot=convertDateFormate(j[i].date_of_trade);
	     	
				$("table#trade_table").append('<tr id="tr_trade'+cor+'">'
	                     +'<td class="anm_srno">'+cor+'</td>'
	                     +'<td style="width: 10%;">'+j[i].td_authority+'</td>'
	                     +'<td style="width: 10%;">'+doa+'</td>'
	                     +'<td style="width: 10%;">'+j[i].trade+'</td>'
	                     +'<td style="width: 10%;">'+dot+'</td>'
	                     +'<td style="width: 10%;">'+j[i].modified_by+'</td>'
	                     +'<td style="width: 10%;">'+mod+'</td>'                    
	                     +'<td style="width: 10%;"><a  class="btn btn-danger btn-sm" value="REMOVE" title = "REJECT" '+j[i].action+'><i class="fa fa-times"></i></a>'
	                     +'</td></tr>');
...
function get_class_pay_details(){
	 ...
	 var jco_id=$('#jco_idV').val(); 
	 var i=0;
	 $.post('getHisPayClassData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
		 var v=j.length;
		 $('#pay_class_tbody').empty(); 
	     if(v!=0){
			...
			for(i;i<v;i++){
	     		...
	     		var mod=convertDateFormate(j[i].modified_date);
	     		var doa=convertDateFormate(j[i].cla_date_authority);
	     		var doc=convertDateFormate(j[i].date_of_class);
	     	
				$("table#pay_class_table").append('<tr id="tr_pay_class'+cor+'">'
	                     +'<td class="anm_srno">'+cor+'</td>'
	                     +'<td style="width: 10%;">'+j[i].cla_authority+'</td>'
	                     +'<td style="width: 10%;">'+doa+'</td>'
	                     +'<td style="width: 10%;">'+j[i].class_pay+'</td>'
	                     +'<td style="width: 10%;">'+doc+'</td>'
	                     +'<td style="width: 10%;">'+j[i].modified_by+'</td>'
	                     +'<td style="width: 10%;">'+mod+'</td>'                    
	                     +'<td style="width: 10%;"><a  class="btn btn-danger btn-sm" value="REMOVE" title = "REJECT" '+j[i].action+'><i class="fa fa-times"></i></a>'
...
function get_pay_group_details(){
	 ...
	 var jco_id=$('#jco_idV').val(); 
	 var i=0;
	 $.post('getHisPayGroupData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
		 var v=j.length;
		 $('#pay_group_tbody').empty(); 
	     if(v!=0){
			...
			for(i;i<v;i++){
	     		...
	     		var mod=convertDateFormate(j[i].modified_date);
	     		var doa=convertDateFormate(j[i].gp_date_authority);
	     		var dog=convertDateFormate(j[i].date_of_group);
	     	
				$("table#pay_group_table").append('<tr id="tr_pay_group'+cor+'">'
	                     +'<td class="anm_srno">'+cor+'</td>'
	                     +'<td style="width: 10%;">'+j[i].gp_authority+'</td>'
	                     +'<td style="width: 10%;">'+doa+'</td>'
	                     +'<td style="width: 10%;">'+j[i].pay_group+'</td>'
	                     +'<td style="width: 10%;">'+dog+'</td>'
	                     +'<td style="width: 10%;">'+j[i].modified_by+'</td>'
	                     +'<td style="width: 10%;">'+mod+'</td>'                    
	                     +'<td style="width: 10%;"><a  class="btn btn-danger btn-sm" value="REMOVE" title = "REJECT" '+j[i].action+'><i class="fa fa-times"></i></a>'
	                     +'</td></tr>');
...
function get_seniority_details(){
	 ...
	 var jco_id=$('#jco_idV').val(); 
	 var i=0;
	 $.post('getHisSeniorityDT_Data_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
		 var v=j.length;
		 $('#dt_seniority_tbody').empty(); 
	     if(v!=0){
			...
			for(i;i<v;i++){
	     		...
	     		var mod=convertDateFormate(j[i].modified_date);
	     		var doa=convertDateFormate(j[i].se_date_authority);
	     		var dos=convertDateFormate(j[i].date_of_seniority);
	     	
				$("table#dt_seniority_table").append('<tr id="tr_sen_dt'+cor+'">'
	                     +'<td class="anm_srno">'+cor+'</td>'
	                     +'<td style="width: 10%;">'+j[i].se_authority+'</td>'
	                     +'<td style="width: 10%;">'+doa+'</td>'
	                     +'<td style="width: 10%;">'+dos+'</td>'
	                     +'<td style="width: 10%;">'+j[i].reason_for_change+'</td>'
	                     +'<td style="width: 10%;">'+j[i].modified_by+'</td>'
	                     +'<td style="width: 10%;">'+mod+'</td>'                    
	                     +'<td style="width: 10%;"><a  class="btn btn-danger btn-sm" value="REMOVE" title = "REJECT" '+j[i].action+'><i class="fa fa-times"></i></a>'
	                     +'</td></tr>');
...
function get_attachment_details(){
	 ...
	 var jco_id=$('#jco_idV').val(); 
	 var i=0;
	 $.post('getHisAttachmentDetails_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
		 var v=j.length;
	     ...
	     if(v!=0){
			...
			for(i;i<v;i++){
	     		...
	     		var mod=(j[i].modified_date);
	     		var doa=(j[i].date_of_authority);
	     	
				$("table#attachment_table").append('<tr id="tr_sen_dt'+cor+'">'
	                     +'<td class="anm_srno">'+cor+'</td>'
	                     +'<td style="width: 10%;">'+j[i].att_authority+'</td>'
	                     +'<td style="width: 10%;">'+doa+'</td>'
	                     +'<td style="width: 10%;">'+j[i].att_movement_number+'</td>'
	                     +'<td style="width: 10%;">'+j[i].date_of_move+'</td>'
	                     +'<td style="width: 10%;">'+j[i].unit_name+'</td>'
	                     +'<td style="width: 10%;">'+j[i].att_place+'</td>'
	                     +'<td style="width: 10%;">'+j[i].from_date+'</td>'
	                     +'<td style="width: 10%;">'+j[i].to_date+'</td>'
	                     +'<td style="width: 10%;">'+j[i].att_duration+'</td>'
	                     +'<td style="width: 10%;">'+j[i].att_reasons+'</td>'
	                     +'<td style="width: 10%;">'+j[i].modified_by+'</td>'
	                     +'<td style="width: 10%;">'+mod+'</td>'                    
	                     +'<td style="width: 10%;"><a  class="btn btn-danger btn-sm" value="REMOVE" title = "REJECT" '+j[i].action+'><i class="fa fa-times"></i></a>'
	                     +'</td></tr>');
...
function CancelHisChangeOfRankData(id){
	...
	$.post('CancelHisChangeOfRankData_jco?' + key + "=" + value,{id:id,set_status:set_status}, function(j){
...
function CancelHisChangeOfNameData(id){
	...
	$.post('CancelHisChangeOfNameData_jco?' + key + "=" + value,{id:id,set_status:set_status}, function(j){
...
function CancelHisChangeInAppointment(id){
	...
	$.post('CancelHisChangeInAppointment_jco?' + key + "=" + value,{id:id,set_status:set_status}, function(j){
...
function CancelHisChangeIdentityCard(id){
	...
	$.post('CancelHisChangeIdentityCard_jco?' + key + "=" + value,{id:id,set_status:set_status}, function(j){
...
function CancelHisChangeInReligion(id){
	...
	$.post('CancelHisChangeInReligion_jco?' + key + "=" + value,{id:id,set_status:set_status}, function(j){
...
function CancelHisMarriage(id){
	...
	$.post('CancelHisMarriage_jco?' + key + "=" + value,{id:id,set_status:set_status}, function(j){
...
function CancelHisSpouseQualification(id){
	...
	$.post('CancelHisSpouseQualification_jco?' + key + "=" + value,{id:id,set_status:set_status}, function(j){
...
function CancelHisChildDetails(id){
	...
	$.post('CancelHisChildDetails_jco?' + key + "=" + value,{id:id,set_status:set_status}, function(j){
...
function CancelHisNokDetails(id){
	...
	$.post('CancelHisNokDetails_jco?' + key + "=" + value,{id:id,set_status:set_status}, function(j){
...
function CancelHisAddressDetails(id){
	...
	$.post('CancelHisAddressDetails_jco?' + key + "=" + value,{id:id,set_status:set_status}, function(j){
...
function CancelHisQualification(id){
	...
	$.post('CancelHisQualification_jco?' + key + "=" + value,{id:id,set_status:set_status}, function(j){
...
function CancelHisLanguage(id){
	...
	$.post('CancelHisLanguage_jco?' + key + "=" + value,{id:id,set_status:set_status}, function(j){
...
function CancelHisContactDetails(id){
	...
	$.post('CancelHisContactDetails_jco?' + key + "=" + value,{id:id,set_status:set_status}, function(j){
...
function CancelHisPromotionalExam(id){
	...
	$.post('CancelHisPromotionalExam_jco?' + key + "=" + value,{id:id,set_status:set_status}, function(j){
...
function CancelHisArmyCourse(id){
	...
	$.post('CancelHisArmyCourse_jco?' + key + "=" + value,{id:id,set_status:set_status}, function(j){
...
function CancelHisBPET(id){
	...
	$.post('CancelHisBPET_jco?' + key + "=" + value,{id:id,set_status:set_status}, function(j){
...
function CancelHisFiringStandard(id){
	...
	$.post('CancelHisFiringStandard_jco?' + key + "=" + value,{id:id,set_status:set_status}, function(j){
...
function CancelHisAllergy(id){
	...
	$.post('CancelHisAllergy_jco?' + key + "=" + value,{id:id,set_status:set_status}, function(j){
...
function CancelHisForeignCountry(id){
	...
	$.post('CancelHisForeignCountry_jco?' + key + "=" + value,{id:id,set_status:set_status}, function(j){
...
function CancelHisAwardsNmedal(id){
	...
	$.post('CancelHisAwardsNmedal_jco?' + key + "=" + value,{id:id,set_status:set_status}, function(j){
...
function CancelHisBatt_phy_casuality(id,con){
	...
	var jco_id=$('#jco_idV').val();
	$.post('CancelHisBatt_phy_casuality_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id,con:con}, function(j){
...
function CancelHisDiscipline(id){
	...
	$.post('CancelHisDiscipline_jco?' + key + "=" + value,{id:id,set_status:set_status}, function(j){
...
function CancelHisInter_arm_transfer(id){
	...
	$.post('CancelHisInter_arm_transfer_jco?' + key + "=" + value,{id:id,set_status:set_status}, function(j){
...
function CancelHisNon_effective(id,con){
	...
	var jco_id=$('#jco_idV').val();
	$.post('CancelHisNon_effective_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id,con:con}, function(j){
...
function CancelHisDeserter(id){
	...
	$.post('CancelHisDeserter_jco?' + key + "=" + value,{id:id,set_status:set_status}, function(j){
...
function CancelHisCSD(id){
	...
	$.post('CancelHisCSD_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
...
function CancelHisTrade(id){
	var jco_id=$('#jco_idV').val();
	
	$.post('CancelHisTrade_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
...
function CancelHisPayClass(id){
	var jco_id=$('#jco_idV').val();
	
	$.post('CancelHisPayClass_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
...
function CancelHisPayGroup(id){
	var jco_id=$('#jco_idV').val();
	
	$.post('CancelHisPayGroup_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
...
function CancelHisSeniorityDT(id){
	var jco_id=$('#jco_idV').val();
	
	$.post('CancelHisSeniority_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
...
function CancelHisAttachment(id){
	var jco_id=$('#jco_idV').val();
	
	$.post('CancelHisAttachmentDetails_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
 ...
 function CancelHisMedicalDetails(id){
		...
		$.post('CancelHisMedicalDetails_jco?' + key + "=" + value,{id:id,set_status:set_status}, function(j){
	...
	function getMedicalDetails(){
	    ...
	    var i=0;
	                           ...
	                           $.post('getHisMedicalCategoryData_jco?' + key + "=" + value, {jco_id:jco_id,cancel_status:cancel_status}, function(j){
	                        		 var v=j.length;
	                        		 $('#medicaltbody').empty(); 
	                        	     if(v!=0){
