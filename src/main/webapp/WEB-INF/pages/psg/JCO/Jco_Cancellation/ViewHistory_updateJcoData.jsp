						   ...
						   <table id="updateDiscipline_table" class="table-bordered " style="margin-top: 10px; width: 100%;">
								<thead style="color: white; text-align: center;">
									<tr>
										...
										<th style="width: 10%;">Punishment Awarded</th>
...
function CancelHisChangeOfRankData(id){
	...
	$.post('CancelHisChangeOfRankData_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
...
function CancelHisChangeOfNameData(id){
	...
	var jco_id=$('#jco_idV').val();
	$.post('CancelHisChangeOfNameData_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
...
function CancelHisChangeInAppointment(id){
	...
	var jco_id=$('#jco_idV').val();
	$.post('CancelHisChangeInAppointment_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
...
function CancelHisChangeIdentityCard(id){
	...
	var jco_id=$('#jco_idV').val();
	$.post('CancelHisChangeIdentityCard_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
...
function CancelHisChangeInReligion(id){
	...
	$.post('CancelHisChangeInReligion_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
...
function CancelHisMarriage(id){
	...
	$.post('CancelHisMarriage_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
...
function CancelHisSpouseQualification(id){
	...
	$.post('CancelHisSpouseQualification_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
...
function CancelHisChildDetails(id){
	...
	var jco_id=$('#jco_idV').val();
	$.post('CancelHisChildDetails_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
...
function CancelHisNokDetails(id){
	...
	var jco_id=$('#jco_idV').val();
	$.post('CancelHisNokDetails_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
...
function CancelHisAddressDetails(id){
	...
	if(confirm("This Will Cancel Present Domicile, Permanent Address And Present Address.")){ 
	var jco_id=$('#jco_idV').val();
	$.post('CancelHisAddressDetails_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
...
function CancelHisQualification(id){
	...
	var jco_id=$('#jco_idV').val();
	$.post('CancelHisQualification_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
...
function CancelHisLanguage(id){
	...
	var jco_id=$('#jco_idV').val();
	$.post('CancelHisLanguage_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
...
function CancelHisContactDetails(id){
	...
	var jco_id=$('#jco_idV').val();
	$.post('CancelHisContactDetails_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
...
function CancelHisPromotionalExam(id){
	...
	$.post('CancelHisPromotionalExam_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
...
function CancelHisArmyCourse(id){
	...
	var jco_id=$('#jco_idV').val();
	$.post('CancelHisArmyCourse_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
...
function CancelHisBPET(id){
	...
	$.post('CancelHisBPET_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
...
function CancelHisFiringStandard(id){
	...
	var jco_id=$('#jco_idV').val();
	$.post('CancelHisFiringStandard_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
...
function CancelHisAllergy(id){
	...
	var jco_id=$('#jco_idV').val();
	$.post('CancelHisAllergy_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
...
function CancelHisForeignCountry(id){
	...
	var jco_id=$('#jco_idV').val();
	$.post('CancelHisForeignCountry_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
...
function CancelHisAwardsNmedal(id){
	...
	$.post('CancelHisAwardsNmedal_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
...
function CancelHisDiscipline(id){
	...
	var jco_id=$('#jco_idV').val();
	$.post('CancelHisDiscipline_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
...
function CancelHisInter_arm_transfer(id){
	...
	var jco_id=$('#jco_idV').val();
	$.post('CancelHisInter_arm_transfer_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
...
function CancelHisDeserter(id){
	...
	$.post('CancelHisDeserter_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
...
function CancelHisAttachment(id){
 ...
 function CancelHisMedicalDetails(id){
	 var jco_id=$('#jco_idV').val();
		...
		$.post('CancelHisMedicalDetails_jco?' + key + "=" + value,{id:id,set_status:set_status,jco_id:jco_id}, function(j){
	                        	     ...
	                        	     if(v!=0){
	                        			...
	                        			for(i;i<v;i++){
	                        				...
	                        				$("table#medical_table").append('<tr id="tr_medical'+cor+'">'
	                        	                     ...
	                        	                     +'<td style="width: 10%;">'+j[i].modify_by+'</td>'
	                        	                     +'<td style="width: 10%;">'+dmod+'</td>'                    
	                        	                     +'<td style="width: 10%;"><i class="fa fa-eye"  onclick="viewMedicaldetailFn(\''+s_id+'\',\''+h_id+'\',\''+a_id+'\',\''+p_id+'\',\''+e_id+'\',\''+c_c_id+'\',\''+c_o_id+'\',\''+c_p_id+'\',\''+c_e_id+'\')" data-toggle="modal" data-target="#medicalModal" title="View Data"></i><a  class="btn btn-danger btn-sm" value="REMOVE" title = "CANCEL"  onclick="CancelHisMedicalDetails(\''+action+'\')"><i class="fa fa-times"></i></a>'
	                        	                     +'</td></tr>');
