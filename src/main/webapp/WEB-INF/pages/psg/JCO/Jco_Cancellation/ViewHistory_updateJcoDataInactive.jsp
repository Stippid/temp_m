	                        	     ...
	                        	     if(v!=0){
	                        			...
	                        			for(i;i<v;i++){
	                        				...
	                        				$("table#medical_table").append('<tr id="tr_medical'+cor+'">'
	                        	                     ...
	                        	                     +'<td style="width: 10%;">'+j[i].modify_by+'</td>'
	                        	                     +'<td style="width: 10%;">'+dmod+'</td>'                    
	                        	                     +'<td style="width: 10%;"><i class="fa fa-eye"  onclick="viewMedicaldetailFn(\''+s_id+'\',\''+h_id+'\',\''+a_id+'\',\''+p_id+'\',\''+e_id+'\',\''+c_c_id+'\',\''+c_o_id+'\',\''+c_p_id+'\',\''+c_e_id+'\')" data-toggle="modal" data-target="#medicalModal" title="View Data"></i>'
	                        	                     +'</td></tr>');
