...
<form:form name="Cause_of_non_effective_JCO" id="Cause_of_non_effective_JCO" action="Cause_of_non_effectiveJCOAction?${_csrf.parameterName}=${_csrf.token}" method="post" class="form-horizontal" commandName="Cause_of_non_effectiveCMD"> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>ADD/UPDATE CAUSE OF NON EFFECTIVE</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by MISO)</span></h6></div>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
											<input type="text" id="causes_name" name="causes_name" oninput="this.value = this.value.toUpperCase()" maxlength="100" class="form-control autocomplete" autocomplete="off" > 
										</div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
									<div class="row form-group">
										<div class="col-md-4">
											<label class=" form-control-label"><strong style="color: red;">* </strong>TYPE OF OFFICER</label>
										</div>
										<div class="col-md-8">
										<select name="type_of_officer" id="type_of_officer" class="form-control">
						...
						<div class="card-footer" align="center" class="form-control">
							...
							<a href="Cause_of_non_eff_JCOUrl" class="btn btn-success btn-sm">Clear</a> 
				...
				<table id="Causeof_non_eff_Search" class="table no-margin table-striped  table-hover  table-bordered report_print" width = "100%">
						<thead style="color: white;text-align: center;">
							<tr>
								...
								<th style="font-size: 15px">Type of Officer</th>
...
<c:url value="Search_Causeof_non_eff_JCO" var="searchUrl" />
	<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="causes_name1">
			...
			<input type="hidden" name="type_of_officer1" id="type_of_officer1" value="0"/>
			<input type="hidden" name="status1" id="status1" value="0"/>
			
	</form:form> 
	
	  <c:url value="Edit_Causeof_non_eff_JCO" var="editUrl"/>
	<form:form action="${editUrl}" method="post" id="updateForm" name="updateForm" modelAttribute="id2">
		  <input type="hidden" name="id2" id="id2">
	</form:form>
	
   <c:url value="delete_Causeof_non_eff_JCO" var="deleteUrl" />
	<form:form action="${deleteUrl}" method="post" id="deleteForm" name="deleteForm" modelAttribute="id1">
		<input type="hidden" name="id1" id="id1" value="0"/> 
	</form:form> 
	
	 <c:url value="Causeof_non_effreport_JCO" var="searchUrl" />
...
<Script>
	$(document).ready(function() {
		...
		{}else
		{
			$("#type_of_officer").val('${type_of_officer1}') ;
		} 
	});
	if('${status1}' != ""){
	...
	function Search(){
			...
			$("#type_of_officer1").val($('#type_of_officer').val());
	...
	function Validate() {
		...
		if ($("select#type_of_officer").val() == "0") {
