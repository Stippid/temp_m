...
<form:form name="CLASS" id="CLASS" action="CLASSAction?${_csrf.parameterName}=${_csrf.token}" method="post" class="form-horizontal" commandName="CLASSCMD"> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>ADD/UPDATE CLASS</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by MISO)</span></h6></div>
	          			<div class="card-body card-block">
	            			<div class="col-md-12">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong style="color: red;">* </strong> CLASS</label>
						                </div>
						                <div class="col-md-8">
						                   <input type="text" id="class_e" name="class_e" oninput="this.value = this.value.toUpperCase()" maxlength="50" class="form-control autocomplete" autocomplete="off" onkeyup="return specialcharecter(this)" /> 
						                </div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
						...
						<div class="card-footer" align="center" class="form-control">
							...
							<a href="Class_Url" class="btn btn-success btn-sm">Clear</a> 
	...
	<div class="container" id="class_Search">
		<div class="">
			...
			<div class="watermarked" data-watermark="" id="divwatermark" style="display: block;">
				<span id="ip"></span>
				<table id="Class_search" class="table no-margin table-striped  table-hover  table-bordered report_print" width = "100%">
...
<Script>
	$(document).ready(function() {
		 ...
		 if('${list.size()}' == ""){
			   $("div#class_Search").hide();
			 }
		 
		 if('${class_e1}'== "")
			{}else
			{
				$("#class_e").val('${class_e1}') ;
			} 
	});
	if('${status1}' != ""){
