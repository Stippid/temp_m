...
<form:form name="promoExamJCOName" id="promoExamJCOId" action="promoExamJCOAction?${_csrf.parameterName}=${_csrf.token}" method="post" class="form-horizontal" commandName="promoExamJCOCMD"> 
	    	...
	    	<div class="container" align="center">
	    		...
	    		<div class="card-header"><h5>ADD/UPDATE PROMOTIONAL EXAM</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by MISO)</span></h6></div>
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="PromoExamJCOUrl" class="btn btn-success btn-sm" >Clear</a> 
...
<c:url value="getpromoExamJCOSearch" var="searchUrl" />
...
<c:url value="Edit_promoJCOExam" var="editUrl"/>
<form:form action="${editUrl}" method="post" id="updateForm" name="updateForm" modelAttribute="id2">
	  <input type="hidden" name="id2" id="id2">
</form:form>

<c:url value="deletePExamJCOURL" var="deleteUrl" />
<form:form action="${deleteUrl}" method="post" id="deleteForm" name="deleteForm" modelAttribute="id1">
	<input type="hidden" name="id1" id="id1" value="0"/> 
</form:form>
<c:url value="promoExamreportJCO" var="searchUrl" />
