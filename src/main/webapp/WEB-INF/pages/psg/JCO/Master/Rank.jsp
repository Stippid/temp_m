...
<form:form name="Rank" id="Rank" action="RankAction?${_csrf.parameterName}=${_csrf.token}" method="post" class="form-horizontal" commandName="RankCmd">
	<div class="animated fadeIn">
		<div class="container" align="center">
			<div class="card">
				<div class="card-header">
					<h5>ADD/UPDATE Rank</h5>
					<h6 class="enter_by">
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="rank" name="rank" oninput="this.value = this.value.toUpperCase()" maxlength="100" class="form-control autocomplete" autocomplete="off">
								</div>
							</div>
						</div>
						<div class="col-md-6">
				...
				<div class="card-footer" align="center" class="form-control">
					<a href="Rank" class="btn btn-success btn-sm">Clear</a>
	...
	<br>
	<div class="container" id="rank_search">
		<div class="">
			<div id="divShow" style="display: block;"></div>
			<div class="watermarked" data-watermark="" id="divwatermark" style="display: block;">
				<span id="ip"></span>
				<table id="rank_Search" class="table no-margin table-striped  table-hover  table-bordered report_print" width="100%">
...
<c:url value="search_Rank" var="search_Rank" />
<form:form action="${search_Rank}" method="post" id="searchForm" name="searchForm" modelAttribute="rank1">
	<input type="hidden" name="rank1" id="rank1" />
	<input type="hidden" name="category1" id="category1" />
	<input type="hidden" name="status1" id="status1" value="0" />
</form:form>
<c:url value="edit_Rank" var="updateUrl" />
<form:form action="${updateUrl}" method="post" id="updateForm" name="updateForm" modelAttribute="id">
	<input type="hidden" name="updateid" id="updateid" value="0" />
</form:form>
<c:url value="Rank_delete" var="deleteUrl" />
<form:form action="${deleteUrl}" method="post" id="deleteForm" name="deleteForm" modelAttribute="id1">
	<input type="hidden" name="id1" id="id1" value="0" />
</form:form>
<c:url value="Rankreport" var="searchUrl" />
...
<script>
	function Validate() {
		...
		if ($("input#category").val().trim() == "") {
		 ...
		 if ($("select#category").val() == "inactive") {
