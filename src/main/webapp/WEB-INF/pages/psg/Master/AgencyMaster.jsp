...
<!-- 	</div><br> -->
	...
	<div class="container" id="Agency_Search">
		<div class="">
			 <div id="divShow" style="display: block;"></div>
			<div class="watermarked" data-watermark="" id="divwatermark" style="display: block;">
				<span id="ip"></span>
				<table id="Agency_Search" class="table no-margin table-striped  table-hover  table-bordered report_print" width = "100%">
...
<Script>
	$(document).ready(function() {
		 ...
		 if('${list.size()}' == ""){
			   $("div#Agency_Search").hide();
			 }
		 
		 if('${Agency_name1}'== "")
			{}else
			{
				$("#agency_name").val('${Agency_name1}') ;
			} 
	});
	if('${status1}' != ""){
