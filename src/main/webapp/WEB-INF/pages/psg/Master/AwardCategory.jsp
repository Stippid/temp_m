...
<form:form name="awardCategory" id="awardCategory" action="awardCategoryAction" method="post" class="form-horizontal" commandName="awardCategoryCMD"> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>ADD/UPDATE AWARD CATEGORY</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by MISO)</span></h6></div>
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="awardCategoryUrl" class="btn btn-success btn-sm" >Clear</a> 
		           ...
		           <table id="getbankSearch" class="table no-margin table-striped  table-hover  table-bordered report_print">
		                 <thead style="text-align: center;">
		                       <tr>
									...
									<th style="font-size: 15px">Award Category</th>
...
<c:url value="getAwardCatSearch" var="searchUrl" />
<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="awardCat1">
		<input type="hidden" name="awardCat1" id="awardCat1" />
		<input type="hidden" name="status1" id="status1" />
</form:form> 

<c:url value="Edit_awardCat" var="editUrl"/>
<form:form action="${editUrl}" method="post" id="updateForm" name="updateForm" modelAttribute="id2">
	  <input type="hidden" name="id2" id="id2">
</form:form>

<c:url value="deleteAwardURL" var="deleteUrl" />
<form:form action="${deleteUrl}" method="post" id="deleteForm" name="deleteForm" modelAttribute="id1">
	<input type="hidden" name="id1" id="id1" value="0"/> 
</form:form>
<c:url value="AwardCatreport" var="searchUrl" />
...
function Search(){
	...
	if($('#awardCat').val() == "" && $('#status').val() == "0"){
		alert("Please Enter Something to Search");
		$('#awardCat').focus();
		return  false;
	}
	
	    $("#awardCat1").val($('#awardCat').val());
