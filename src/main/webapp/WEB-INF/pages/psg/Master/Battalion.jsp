...
<form:form name="Battalion" id="Battalion" action="BattalionAction" method="post" class="form-horizontal" commandName="BattalionCmd"> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>ADD/UPDATE Battalion</h5> 
...
<!-- 												<option value="0">--Select--</option> -->
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="Battalion" class="btn btn-success btn-sm" >Clear</a>
	...
	<div class="container" id="battalion_search">
		<div class="">
			 <div id="divShow" style="display: block;"></div>
			<div class="watermarked" data-watermark="" id="divwatermark" style="display: block;">
				<span id="ip"></span>
				<table id="battalion_search" class="table no-margin table-striped  table-hover  table-bordered report_print" width = "100%">
...
<c:url value="search_Battalion" var="searchUrl" />
	<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="battalion_name1">
			<input type="hidden" name="battalion_name1" id="battalion_name1" />
			<input type="hidden" name="status1" id="status1" value="0"/>
			
	</form:form> 
	 <c:url value="edit_Battalion" var="updateUrl" />
<form:form action="${updateUrl}" method="post" id="updateForm" name="updateForm" modelAttribute="id" >
	<input type="hidden" name="updateid" id="updateid" value="0" />
</form:form> 
<c:url value="Battalion_delete" var="deleteUrl" />
	<form:form action="${deleteUrl}" method="post" id="deleteForm" name="deleteForm" modelAttribute="id1">
		<input type="hidden" name="id1" id="id1" value="0"/> 
	</form:form>
 <c:url value="Battalionreport" var="searchUrl" />
...
function Search(){
	$("#battalion_name1").val($('#battalion_name').val());
...
$(document).ready(function() {
	 ...
	 if('${list.size()}' == ""){
		   $("div#battalion_search").hide();
		 }
	 if('${battalion_name1}' != ""){
		 
	 	$("#battalion_name").val('${battalion_name1}') ;
		}
	 if('${status1}' != ""){
