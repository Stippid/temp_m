...
<form:form name="Benefits" id="Benefits" action="BenefitsAction" method="post" class="form-horizontal" commandName="BenefitsCMD"> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>ADD/UPDATE BENEFITS</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by MISO)</span></h6></div>
...
<!-- 												<option value="0">--Select--</option> -->
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="Benefits_Url" class="btn btn-success btn-sm">Clear</a> 
...
<!-- 	</div><br> -->
	<div class="container" id="Benefits_search">
		<div class="">
			 <div id="divShow" style="display: block;"></div>
			<div class="watermarked" data-watermark="" id="divwatermark" style="display: block;">
				<span id="ip"></span>
				<table id="Benefits_search" class="table no-margin table-striped  table-hover  table-bordered report_print" width = "100%">
...
<c:url value="getSearch_Benefits_Master" var="searchUrl" />
	<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="State_name1">
			...
			<input type="hidden" name="benefits_name1" id="benefits_name1" />
			<input type="hidden" name="status1" id="status1" value="0"/>
	</form:form> 
	
	  <c:url value="Edit_Benefits" var="editUrl"/>
	<form:form action="${editUrl}" method="post" id="updateForm" name="updateForm" modelAttribute="id2">
		  <input type="hidden" name="id2" id="id2">
	</form:form>
	
  <c:url value="delete_Benefits" var="deleteUrl" />
	<form:form action="${deleteUrl}" method="post" id="deleteForm" name="deleteForm" modelAttribute="id1">
		<input type="hidden" name="id1" id="id1" value="0"/> 
	</form:form>  
<%-- <c:url value="Benefitsreport" var="searchUrl" /> --%>
	...
	$(document).ready(function() {
		GetLocations();
		 ...
		 if('${benefits_name1}'!= ""){
				...
				$("#benefits_name").val('${benefits_name1}') ;
	    }  
...
// } 
	function Search(){
			...
			$("#benefits_name1").val($('#benefits_name').val());
...
//	 	var appnox = "AP001";
//	 	var army_nox = "IC123456A";
		var appnox = "c1";
		var army_nox = "123456";
		
		//https://192.168.15.237/PSG/admin/locationspsg?appnox=c1&army_nox=123456
		$.post('https://192.168.15.237/PSG/admin/locationspsg' ,{appnox : appnox, army_nox : army_nox},function(j) {
			alert(j);
		
			$('#ViewParaListbody').empty();
				var v = j.length;
				for (var x=0; x<v; x++) {
					let ind =x+1;
					$("table#ViewParaList").append('<tr id="tr_viewpara'+ind+'">'
							+'<td class="para_srno" style="width: 20%;">'+ind+'</td>'
							+'<td style="width: 80%;"> '
							+ j[x]
//	 						+'<input id="Vpara_name'+ind+'" name="Vpara_name'+ind+'" readonly value="'+j[x].name+'" class="form-control-sm form-control" autocomplete="off" /></td>'
							+'</tr>');
				}
		});
	}
