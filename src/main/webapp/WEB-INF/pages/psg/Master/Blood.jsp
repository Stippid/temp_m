...
<form:form name="Blood" id="Blood" action="BloodAction" method="post" class="form-horizontal" commandName="BloodCmd">
	<div class="animated fadeIn">
		<div class="container" align="center">
			<div class="card">
				<div class="card-header">
					<h5>ADD/UPDATE BLOOD GROUP</h5>
					<h6 class="enter_by">
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								...
								<div class="col-md-8">
									<input type="text" id="blood_desc" name="blood_desc" class="form-control autocomplete" oninput="this.value = this.value.toUpperCase()"  autocomplete="off"
									maxlength="3" onkeyup="return blood_group_validate(this)" />
								</div>
							</div>
						</div>
						<div class="col-md-6">
				...
				<div class="card-footer" align="center" class="form-control">
					<a href="Blood" class="btn btn-success btn-sm">Clear</a>
	...
	<br>
	<div class="container" id="blood_search">
		<div class="">
			<div id="divShow" style="display: block;"></div>
			<div class="watermarked" data-watermark="" id="divwatermark" style="display: block;">
				<span id="ip"></span>
				<table id="blood_search" class="table no-margin table-striped  table-hover  table-bordered report_print" width="100%">
...
<script>
	...
	function Search() {
		$("#blood_desc1").val($('#blood_desc').val());
	...
	$(document).ready(function() {
		if ('${list.size()}' == "") {
			$("div#blood_search").hide();
		}
		if ('${blood_desc1}' != "") {
			$("#blood_desc").val('${blood_desc1}');
		}
		if ('${status1}' != "") {
