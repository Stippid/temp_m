...
<form:form name="" id="" action="Casuality1_Action" method="post" class="form-horizontal" commandName="Casuality1_CMD"> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>ADD/UPDATE CASUALTY</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by MISO)</span></h6></div>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                   <input type="text" id="casuality1" name="casuality1" class="form-control autocomplete" autocomplete="off" onkeypress="return onlyAlphabets(event);"> 
						                </div>
						            </div>
	              				</div>
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="Casuality1_Url" class="btn btn-success btn-sm" >Clear</a> 
...
<c:url value="getCasuality1Search" var="searchUrl" />
<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="casuality_v1">
		<input type="hidden" name="casuality_v1" id="casuality_v1" />
		<input type="hidden" name="status1" id="status1" />
</form:form>

<c:url value="Edit_Casuality1" var="editUrl"/>
<form:form action="${editUrl}" method="post" id="updateForm" name="updateForm" modelAttribute="id2">
	  <input type="hidden" name="id2" id="id2">
</form:form>

<c:url value="deleteCasuality1URL" var="deleteUrl" />
<form:form action="${deleteUrl}" method="post" id="deleteForm" name="deleteForm" modelAttribute="id1">
	<input type="hidden" name="id1" id="id1" value="0"/> 
</form:form>

<c:url value="Report_Casuality1" var="searchUrl" />
...
function validate(){
	if ($("input#casuality1").val().trim() == "") {
		alert("Please Enter Casualty.");
		$("input#casuality1").focus();
		return false;
	}
...
function Search(){
	...
	if($('#casuality1').val() == "" && $('#status').val() == "0"){
		alert("Please Enter Something to Search");
		$('#casuality1').focus();
		return  false;
	}
	
	    $("#casuality_v1").val($('#casuality1').val());
