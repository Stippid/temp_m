...
<form:form name="Cause_of_non_effective" id="Cause_of_non_effective" action="Cause_of_non_effectiveAction" method="post" class="form-horizontal" commandName="Cause_of_non_effectiveCMD"> 
	    	...
	    	<div class="container" align="center">
	    		...
	    		<div class="card-header"><h5>ADD/UPDATE CAUSE OF NON EFFECTIVE</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by MISO)</span></h6></div>
						...
						<div class="card-footer" align="center" class="form-control">
							...
							<a href="Cause_of_non_effUrl" class="btn btn-success btn-sm">Clear</a> 
...
<c:url value="Search_Causeof_non_eff" var="searchUrl" />
	<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="causes_name1">
	  ...
	  <c:url value="Edit_Causeof_non_eff" var="editUrl"/>
	<form:form action="${editUrl}" method="post" id="updateForm" name="updateForm" modelAttribute="id2">
		  <input type="hidden" name="id2" id="id2">
	</form:form>
	
   <c:url value="delete_Causeof_non_eff" var="deleteUrl" />
	<form:form action="${deleteUrl}" method="post" id="deleteForm" name="deleteForm" modelAttribute="id1">
		<input type="hidden" name="id1" id="id1" value="0"/> 
	</form:form> 
	
	 <c:url value="Causeof_non_effreport" var="searchUrl" />
...
<Script>
	...
	function Validate() {
		if ($("#causes_name").val().trim() == "") {
			alert("Please Enter Causes Name");
			$("#causes_name").focus();
			return false;
		}
		if ($("#type_of_officer").val() == "0") {
			alert("Please Select Type of Officer");
			$("#type_of_officer").focus();
			return false;
		}
