...
<form:form name="Company" id="Company" action="CompanyAction"
	method="post" class="form-horizontal" commandName="CompanyCmd">
	<div class="animated fadeIn">
		<div class="container" align="center">
			<div class="card">
				<div class="card-header">
					<h5>ADD/UPDATE Company</h5>
					<h6 class="enter_by">
					...
					<div class="col-md-12">
							...
							<div class="row form-group">
								<div class="col-md-4">
									<label class=" form-control-label"><strong
										style="color: red;">* </strong> BATTALION NAME </label>
								</div>
								<div class="col-md-8">
						...
						<div class="col-md-6">
							<div class="row form-group">
								<div class="col-md-4">
									<label class=" form-control-label"><strong
										style="color: red;">* </strong> COMPANY NAME</label>
								</div>
								<div class="col-md-8">
									<input type="text" id="company_name" name="company_name" oninput="this.value = this.value.toUpperCase()" maxlength="50"
...
<!-- 												<option value="0">--Select--</option> -->
				...
				<div class="card-footer" align="center" class="form-control">
					<a href="Company" class="btn btn-success btn-sm">Clear</a> 
					<input
						type="submit" class="btn btn-primary btn-sm" value="Save" onclick="return Validate();"> 
...
<div align="right" class="container">
	...
	<div class="container" id="company_search">
		<div class="">
			<div id="divShow" style="display: block;"></div>
			<div class="watermarked" data-watermark="" id="divwatermark"
				style="display: block;">
				<span id="ip"></span>
				<table id="company_search"
...
<c:url value="search_Company" var="searchUrl" />
<form:form action="${searchUrl}" method="post" id="searchForm"
	name="searchForm" modelAttribute="company_name1">
	<input type="hidden" name="bat_id1" id="bat_id1" />
	<input type="hidden" name="company_name1" id="company_name1" />
	<input type="hidden" name="status1" id="status1" value="0"/>
</form:form>

<c:url value="edit_Company" var="updateUrl" />
<form:form action="${updateUrl}" method="post" id="updateForm"
	name="updateForm" modelAttribute="id">
	<input type="hidden" name="updateid" id="updateid" value="0" />
</form:form>

<c:url value="Company_delete" var="deleteUrl" />
<form:form action="${deleteUrl}" method="post" id="deleteForm"
	name="deleteForm" modelAttribute="id1">
	<input type="hidden" name="id1" id="id1" value="0" />
</form:form>
<c:url value="Companyreport" var="searchUrl" />
...
function Validate() {
	...
	if ($("select#bat_id").val() == "0") {
		alert("Please Select Battalion Name");
		$("select#bat_id").focus();
		return false;
	} 
	
	if ($("input#company_name").val().trim() == "") {
	...
	function Search(){
/* if ($("select#bat_id").val() != "" || $("input#company_name").val() != "" || $("select#status").val() != "0")
	{ */
	$("#bat_id1").val($('#bat_id').val());
