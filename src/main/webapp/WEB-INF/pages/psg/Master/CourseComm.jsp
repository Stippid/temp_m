...
<form:form name="Course" id="Course" action="CourseAction" method="post" class="form-horizontal" commandName="CourseCMD"> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>ADD/UPDATE COURSE</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by MISO)</span></h6></div>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                   <input type="text" id="course_name" name="course_name" oninput="this.value = this.value.toUpperCase()" maxlength="50" class="form-control" autocomplete="off" > 
						                </div>
						            </div>
	              				</div>
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="CourseCommUrl" class="btn btn-success btn-sm" >Clear</a> 
...
<c:url value="getSearchCourseMaster" var="searchUrl" />
<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="course_name1">
		<input type="hidden" name="course_name1" id="course_name1" />
		<input type="hidden" name="status1" id="status1" />
</form:form> 

<c:url value="Edit_Course" var="editUrl"/>
<form:form action="${editUrl}" method="post" id="updateForm" name="updateForm" modelAttribute="id2">
	  <input type="hidden" name="id2" id="id2">
</form:form>

<c:url value="deleteCourseMasterURL" var="deleteUrl" />
<form:form action="${deleteUrl}" method="post" id="deleteForm" name="deleteForm" modelAttribute="id1">
	<input type="hidden" name="id1" id="id1" value="0"/> 
</form:form>
<c:url value="CourseCommreport" var="searchUrl" />
...
function Search(){
	if($('#course_name').val() == "" && $('#status').val() == "0"){
