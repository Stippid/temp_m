...
<form:form name="Disc_trade" id="Disc_trade" action="Disc_trialedAction" method="post" class="form-horizontal" commandName="disc_trialedActionCMD"> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>ADD/UPDATE DISCIPLINE TRIALED MASTER</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by MISO)</span></h6></div>
						...
						<div class="card-footer" align="center" class="form-control">
							...
							<a href="Discipline_Trialed_Url" class="btn btn-success btn-sm">Clear</a> 
	...
	<div class="container" id="Discipline_Trialed_Search">
		<div class="">
			 <div id="divShow" style="display: block;"></div>
			<div class="watermarked" data-watermark="" id="divwatermark" style="display: block;">
				<span id="ip"></span>
				<table id="Discipline_Trialed_Search" class="table no-margin table-striped  table-hover  table-bordered report_print" >
						<thead style="color: white;text-align: center;">
							<tr>
								<th style="font-size: 15px ;width: 10%;">Ser No</th>
								<th style="font-size: 15px">Discipline Trialed</th>
...
<c:url value="Search_Discipline_trialed" var="searchUrl" />
<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="disc_trialed1">
	<input type="hidden" name="disc_trialed1" id="disc_trialed1" />
	<input type="hidden" name="status1" id="status1" value="0"/>
			
</form:form> 
	
<c:url value="Edit_Discipline_Trialed" var="editUrl"/>
<form:form action="${editUrl}" method="post" id="updateForm" name="updateForm" modelAttribute="id2">
	<input type="hidden" name="id2" id="id2">
</form:form>
	
<c:url value="delete_Discipline_Trialed" var="deleteUrl" />
<form:form action="${deleteUrl}" method="post" id="deleteForm" name="deleteForm" modelAttribute="id1">
	<input type="hidden" name="id1" id="id1" value="0"/> 
</form:form> 
	
<c:url value="Discipline_TrialedReport" var="searchUrl" />
...
$(document).ready(function() {
	 ...
	 if('${list.size()}' == ""){
		   $("div#Discipline_Trialed_Search").hide();
		 }
	 
	 if('${disc_trialed1}'== "")
		{}else
		{
			$("#disc_trialed").val('${disc_trialed1}') ;
		} 
});
...
function Search(){
		...
		$("#disc_trialed1").val($('#disc_trialed').val());
