...
<form:form name="Edit_Indian_lan" id="Edit_Indian_lan" action="Edit_Indian_lanAction" method="post" class="form-horizontal" commandName="Edit_Indian_lanCMD"> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>UPDATE INDIAN LANGUAGE</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by MISO)</span></h6></div>
...
<!-- 												<option value="0">--Select--</option> -->
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="Indian_languageUrl" class="btn btn-danger btn-sm" >Cancel</a>    
...
$(document).ready(function() {
	...
	$("#ind_language").val('${Edit_Indian_lanCMD.ind_language}');
	
	$("#status").val('${Edit_Indian_lanCMD.status}');	

	$("#id").val('${Edit_Indian_lanCMD.id}');
