...
<form:form name="Edit_BPETqt" id="Edit_BPETqt" action="Edit_BPETqtAction" method="post" class="form-horizontal" commandName="Edit_BPETqtCMD"> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>UPDATE BPET QT</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by MISO)</span></h6></div>
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="BPETqtUrl" class="btn btn-danger btn-sm">Cancel</a>
