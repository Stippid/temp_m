...
<form:form name="Edit_Promo_exam" id="Edit_Promo_exam" action="Edit_Promo_examAction" method="post" class="form-horizontal" commandName="Edit_Promo_examCMD"> 
	    	...
	    	<div class="container" align="center">
	    		...
	    		<div class="card-header"><h5>UPDATE PROMOTIONAL EXAM</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by MISO)</span></h6></div>
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="promoExamUrl" class="btn btn-danger btn-sm">Cancel</a>
...
$(document).ready(function() {
	$("#promoExam").val('${Edit_pExamCMD.promo_exam}');	
	$("#id").val('${Edit_pExamCMD.id}');
	$("select#status").val('${Edit_pExamCMD.status}');
});
