...
<form:form name="Examination_passeda" id="Examination_passeda" action="Examination_passedAction" method="post" class="form-horizontal" commandName="Examination_passedCmd"> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>ADD/UPDATE Examination Passed</h5> 
...
<!-- 												<option value="0">--Select--</option> -->
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="Examination_PassedUrl" class="btn btn-success btn-sm" >Clear</a>
	...
	<div class="container" id="examination_passed_search">
		<div class="">
			 <div id="divShow" style="display: block;"></div>
			<div class="watermarked" data-watermark="" id="divwatermark" style="display: block;">
				<span id="ip"></span>
				<table id="examination_passed_search" class="table no-margin table-striped  table-hover  table-bordered report_print" width = "100%">
						<thead style="color: white;text-align: center;">
							<tr>
								<th style="font-size: 15px ;width: 10%;">Ser No</th>
								<th style="font-size: 15px">Examination Passed</th>
								<th style="font-size: 15px">Qualification Type</th>
	...
	<c:url value="getSearch_Examination_passed" var="searchUrl" />
	<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="qualification_type1">
	<input type="hidden" name="examination_passed1" id="examination_passed1" value="0" />
			<input type="hidden" name="qualification_type1" id="qualification_type1" />
			<input type="hidden" name="status1" id="status1" value="0"/>
	</form:form>
	
	<c:url value="Edit_Examination_passed" var="editUrl"/>
	<form:form action="${editUrl}" method="post" id="updateForm" name="updateForm" modelAttribute="id2">
		  <input type="hidden" name="id2" id="id2" value="0"/>
	</form:form>
	
	<c:url value="delete_Examination_passed" var="deleteUrl" />
	<form:form action="${deleteUrl}" method="post" id="deleteForm" name="deleteForm" modelAttribute="id1">
		<input type="hidden" name="id1" id="id1" value="0"/> 
	</form:form>
	<c:url value="ExaminationPassedreport" var="searchUrl" />
<form:form action="${searchUrl}" method="post" id="search2" name="search2" modelAttribute="comd1">
	...
	$(document).ready(function() {
		...
		if('${list.size()}' == ""){
			   $("div#examination_passed_search").hide();
			 }
		 if('${examination_passed1}' != ""){
			 
		 	$("#examination_passed").val('${examination_passed1}') ;
			}
		 if('${qualification_type1}' != ""){
			 
			 	$("#qualification_type").val('${qualification_type1}') ;
				}
		 if('${status1}' != ""){
	...
	function Search(){
		$("#examination_passed1").val($('#examination_passed').val());
		$("#qualification_type1").val($('#qualification_type').val());
	...
	function Validate() {
		...
		if ($("select#qualification_type").val() == 0) {
			alert("Please Select Qualification Type");
			$("select#qualification_type").focus();
			return false;
		}
