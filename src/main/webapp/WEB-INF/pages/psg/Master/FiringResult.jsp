...
<form:form name="firingresult" id="firingresult" action="firingresultAction" method="post" class="form-horizontal" commandName="firingresultCMD"> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>ADD/UPDATE FIRING RESULT</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by MISO)</span></h6></div>
	          			<div class="card-body card-block">
	            			<div class="col-md-12">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong style="color: red;">* </strong> FIRING RESULT</label>
						                </div>
						                <div class="col-md-8">
						                   <input type="text" id="firing" name="firing" oninput="this.value = this.value.toUpperCase()" maxlength="50" class="form-control autocomplete" autocomplete="off" onkeypress="return onlyAlphabets(event);"> 
						                </div>
						            </div>
	              				</div>
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="FiringResultUrl" class="btn btn-success btn-sm" >Clear</a> 
		           ...
		           <table id="getbankSearch" class="table no-margin table-striped  table-hover  table-bordered report_print">
		                 <thead style="text-align: center;">
		                       <tr>
									...
									<th style="font-size: 15px">FIRING RESULT</th>
...
function validate(){
	if ($("input#firing").val().trim() == "") {
		alert("Please Enter Firing Result");
		$("input#firing").focus();
		return false;
	}
...
function Search(){
	...
	if($('#firing').val() == "" && $('#status').val() == "0"){
		alert("Please Enter Something to Search");
		$('#firing').focus();
		return  false;
	}
	
	    $("#firing1").val($('#firing').val());
