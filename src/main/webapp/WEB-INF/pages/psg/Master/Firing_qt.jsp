...
<form:form name="firingqt" id="firingqt" action="firingqtAction" method="post" class="form-horizontal" commandName="firingqtCMD"> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>ADD/UPDATE FIRING QT</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by MISO)</span></h6></div>
	          			<div class="card-body card-block">
	            			<div class="col-md-12">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong style="color: red;">* </strong> FIRING QT</label>
						                </div>
						                <div class="col-md-8">
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="FiringQtUrl" class="btn btn-success btn-sm" >Clear</a> 
		           ...
		           <table id="getbankSearch" class="table no-margin table-striped  table-hover  table-bordered report_print">
		                 <thead style="text-align: center;">
		                       <tr>
									...
									<th style="font-size: 15px">FIRING QT</th>
...
<c:url value="getFiringQtSearch" var="searchUrl" />
...
<c:url value="Edit_Firingqt" var="editUrl"/>
<form:form action="${editUrl}" method="post" id="updateForm" name="updateForm" modelAttribute="id2">
	  <input type="hidden" name="id2" id="id2">
</form:form>

<c:url value="deletefiringQtURL" var="deleteUrl" />
<form:form action="${deleteUrl}" method="post" id="deleteForm" name="deleteForm" modelAttribute="id1">
	<input type="hidden" name="id1" id="id1" value="0"/> 
</form:form>
<c:url value="FiringQreport" var="searchUrl" />
