...
<form:form name="gender" id="gender" action="gender_Action" method="post" class="form-horizontal" commandName="gender_CMD"> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>ADD/UPDATE GENDER</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by MISO)</span></h6></div>
...
<!-- 												<option value="0">--Select--</option> -->
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="Gender" class="btn btn-success btn-sm" >Clear</a>  
		           ...
		           <table id="getgenderSearch" class="table no-margin table-striped  table-hover  table-bordered report_print">
		                 <thead style="text-align: center;">
		                       <tr>
									...
									<th style="font-size: 15px">Gender Name</th>
...
<c:url value="getSearchgenderMaster" var="searchUrl" />
<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="gender_name1">
		<input type="hidden" name="gender_name1" id="gender_name1" />
		<input type="hidden" name="status1" id="status1"  value="0" />
</form:form> 

<c:url value="Edit_Gender" var="editUrl"/>
<form:form action="${editUrl}" method="post" id="updateForm" name="updateForm" modelAttribute="updateid">
	  <input type="hidden" name="updateid" id="updateid" value="0">
</form:form>

<c:url value="deletegenderMasterURL" var="deleteUrl" />
<form:form action="${deleteUrl}" method="post" id="deleteForm" name="deleteForm" modelAttribute="id1">
	<input type="hidden" name="id1" id="id1" value="0"/> 
</form:form>
<c:url value="Genderreport" var="searchUrl" />
...
$(document).ready(function() {
	 ...
	 if('${gender_name1}'== null || '${gender_name1}'=='')
		{
			$("#gender_name").val('') ;
		}else
		{
			$("#gender_name").val('${gender_name1}') ;
		} 
...
function Search(){
		...
		$("#gender_name1").val($('#gender_name').val());
