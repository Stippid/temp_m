...
<form:form name="Hair_Color" id="Hair_Color" action="Hair_ColorAction" method="post" class="form-horizontal" commandName="Hair_ColorCMD"> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>ADD/UPDATE HAIR COLOUR</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by MISO)</span></h6></div>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                   <input type="text" id="hair_cl_name" name="hair_cl_name" oninput="this.value = this.value.toUpperCase()" maxlength="50" class="form-control autocomplete" autocomplete="off" onkeypress="return onlyAlphabets(event);"> 						                   
						                </div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
...
<!-- 												<option value="0">--Select--</option> -->
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="Hair_Colour" class="btn btn-success btn-sm" >Clear</a>  
	...
	<div class="container" id="divPrint" style="display: block;"> 	 
			<div  class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
		           <table id="getHair_colour" class="table no-margin table-striped  table-hover  table-bordered report_print">
		                 <thead>
		                       <tr>
...
<c:url value="GetSearch_hair_Colour" var="searchUrl" />
	<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="hair_cl_name2">
		<input type="hidden" name="hair_cl_name2" id="hair_cl_name2" value="0"/>
		<input type="hidden" name="status2" id="status2" value="0"/>
		
	</form:form> 
	
<c:url value="Edit_Hair_ColourUrl" var="editUrl"/>
<form:form action="${editUrl}" method="post" id="updateForm" name="updateForm" modelAttribute="id2">
	  <input type="hidden" name="id2" id="id2" value="0">
</form:form>

<c:url value="Delete_Hair_Colour" var="deleteUrl" />
<form:form action="${deleteUrl}" method="post" id="deleteForm" name="deleteForm" modelAttribute="id1">
	<input type="hidden" name="id1" id="id1" value="0"/> 
</form:form>
<c:url value="HairColourreport" var="searchUrl" />
...
$(document).ready(function() {
	 ...
	 if('${hair_cl_name2}'!= ""){
			...
			$("#hair_cl_name").val('${hair_cl_name2}') ;
		} 
		//$("#hair_cl_name").val('${hair_cl_name2}');
		 if('${status2}' != ""){
...
function Search(){
	...
	$("#hair_cl_name2").val($("#hair_cl_name").val()) ;	
