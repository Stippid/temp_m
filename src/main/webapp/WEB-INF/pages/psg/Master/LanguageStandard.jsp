...
<form:form name="LanguageSTD" id="LanguageSTD" action="LanguageSTDAction" method="post" class="form-horizontal" commandName="LanguageSTDCmd"> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>ADD/UPDATE LANGUAGE STANDARD</h5> 
	    		<h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by MISO)</span></h6></div>
	            			...
	            			<div class="col-md-12">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong style="color: red;">* </strong>LANGUAGE STANDARD</label>
						                </div>
						                <div class="col-md-8">
						                   <input type="text" id="language" name="language" class="form-control autocomplete" oninput="this.value = this.value.toUpperCase()" maxlength="50" autocomplete="off"  onkeypress="return onlyAlphabets(event);"> 
						                </div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="LanguageStandard" class="btn btn-success btn-sm">Clear</a> 
...
<c:url value="search_LanguageSTD" var="searchUrl" />
	<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="language1">
	 ...
	 <c:url value="edit_LanguageSTD" var="updateUrl" />
<form:form action="${updateUrl}" method="post" id="updateForm" name="updateForm" modelAttribute="id" >
	<input type="hidden" name="updateid" id="updateid" value="0" />
</form:form> 
<c:url value="languageSTD_delete" var="deleteUrl" />
	<form:form action="${deleteUrl}" method="post" id="deleteForm" name="deleteForm" modelAttribute="id1">
		<input type="hidden" name="id1" id="id1" value="0"/> 
	</form:form>
 <c:url value="LangStdreport" var="searchUrl" />
...
function Validate(){
	if ($("input#language").val().trim() == "") {
		alert("Please Enter Language Standard");
