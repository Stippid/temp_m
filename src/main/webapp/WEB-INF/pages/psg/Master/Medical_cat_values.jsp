...
<form:form name="med_cat_values" id="med_cat_values"
	action="med_cat_valuesAction" method="post" class="form-horizontal"
	commandName="med_cat_valuesCMD">
	<div class="animated fadeIn">
		<div class="container" align="center">
			<div class="card">
				<div class="card-header">
					<h5>ADD/UPDATE MEDICAL CATEGORY VALUES</h5>
					<h6 class="enter_by">
...
<!-- 										<option value="0">--Select--</option> -->
				...
				<div class="card-footer" align="center" class="form-control">
					<a href="Med_cat_Url" class="btn btn-success btn-sm">Clear</a> 
	...
	<br>
	<div class="container" id="getMedical" style="display: block;">
			...
			<table id="getMedical"
				...
				<thead>
					<tr>
						...
						<th style="text-align: center;">Shape Status</th>
...
<c:url value="GetSearch_med_cat_values" var="searchUrl" />
<form:form action="${searchUrl}" method="post" id="searchForm"
	name="searchForm" modelAttribute="shape_status2">
	<input type="hidden" name="shape_status2" id="shape_status2" value="0" />
	<input type="hidden" name="values2" id="values2" value="0" />
	<input type="hidden" name="status2" id="status2" value="0" />
</form:form>

<c:url value="Edit_med_cat_values" var="editUrl" />
<form:form action="${editUrl}" method="post" id="updateForm"
	name="updateForm" modelAttribute="id2">
	<input type="hidden" name="id2" id="id2" value="0">
</form:form>

<c:url value="Delete_med_cat_values" var="deleteUrl" />
<form:form action="${deleteUrl}" method="post" id="deleteForm"
	name="deleteForm" modelAttribute="id1">
	<input type="hidden" name="id1" id="id1" value="0" />
</form:form>
<c:url value="MedicalValuesreport" var="searchUrl" />
...
<Script>
	$(document).ready(function() {
		...
		if ('${shape_status2}' != 0) {
			...
			$("#shape_status").val('${shape_status2}');
		}
	...
	function Search() {
		...
		$("#shape_status2").val($("#shape_status").val());
