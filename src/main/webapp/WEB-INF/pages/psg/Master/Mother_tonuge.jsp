...
<form:form name="M_T" id="M_T" action="M_TAction" method="post" class="form-horizontal" commandName="M_TCMD"> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>ADD/UPDATE MOTHER TONGUE</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by MISO)</span></h6></div>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                   <input type="text" id="mothertounge" name="mothertounge" oninput="this.value = this.value.toUpperCase()" maxlength="50" class="form-control autocomplete" autocomplete="off" onkeypress="return onlyAlphabets(event);"> 
						                </div>
						            </div>
	              				</div>
...
<!-- 												<option value="0">--Select--</option> -->
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="Mother_tongueUrl" class="btn btn-success btn-sm" >Clear</a> 
		           ...
		           <table id="getbankSearch" class="table no-margin table-striped  table-hover  table-bordered report_print">
		                 <thead style="text-align: center;">
		                       <tr>
									...
									<th style="font-size: 15px">Mother Tongue</th>
...
$(document).ready(function() {
	$("#mothertounge").val('${mothertounge1}');
	if('${status1}' != '')
	$("#status").val('${status1}');
});
function getExcel() {
...
function validate(){
	if ($("input#mothertounge").val().trim() == "") {
		alert("Please Enter Mother Tongue");
		$("input#mothertounge").focus();
		return false;
	}
...
function Search(){
	...
	if($('#mothertounge').val() == "" && $('#status').val() == "0"){
		alert("Please Enter Something to Search");
		$('#mothertounge').focus();
		return  false;
	}
	
	    $("#mothertounge1").val($('#mothertounge').val());
