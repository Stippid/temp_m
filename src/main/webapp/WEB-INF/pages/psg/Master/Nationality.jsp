...
<form:form name="Nationality" id="Nationality" action="NationalityAction" method="post" class="form-horizontal" commandName="NationalityCMD"> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>ADD/UPDATE NATIONALITY</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by MISO)</span></h6></div>
	          			<div class="card-body card-block">
	            			<div class="col-md-12">	              					
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong style="color: red;">* </strong> NATIONALITY NAME</label>
						                </div>
						                <div class="col-md-8">
						                   <input type="text" id="nationality_name" name="nationality_name" oninput="this.value = this.value.toUpperCase()"  maxlength="50" class="form-control autocomplete" autocomplete="off" onkeypress="return onlyAlphabets(event);"> 
...
<!-- 												<option value="0">--Select--</option> -->
			            ...
			            <div class="card-footer" align="center" class="form-control">
							<a href="Nationality" class="btn btn-success btn-sm">Clear</a> 
...
<div align="right" class="container">
	...
	<div class="container" id="nationalit_search">
		<div class="">
			 <div id="divShow" style="display: block;"></div>
			<div class="watermarked" data-watermark="" id="divwatermark" style="display: block;">
				<span id="ip"></span>
				<table id="nationality_search" class="table no-margin table-striped  table-hover  table-bordered report_print" width = "100%">
						<thead style="color: white;text-align: center;">
							<tr>
								<th style="font-size: 15px ;width: 10%;">Ser No</th>
								<th style="font-size: 15px">Country Name</th>
								<th style="font-size: 15px">Nationality Name</th>
	...
	<c:url value="getSearch_Nationality_Master" var="searchUrl" />
	<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="country_id1">
			...
			<input type="hidden" name="nationality_name1" id="nationality_name1" value="0" />
			<input type="hidden" name="status1" id="status1" value="0"/>
	</form:form> 
	
	<c:url value="Edit_Nationality" var="editUrl"/>
	<form:form action="${editUrl}" method="post" id="updateForm" name="updateForm" modelAttribute="id2">
		  <input type="hidden" name="id2" id="id2" value="0"/>
	</form:form>
	
	<c:url value="delete_Nationality" var="deleteUrl" />
	<form:form action="${deleteUrl}" method="post" id="deleteForm" name="deleteForm" modelAttribute="id1">
		<input type="hidden" name="id1" id="id1" value="0"/> 
	</form:form>
	<c:url value="Nationalityreport" var="searchUrl" />
<form:form action="${searchUrl}" method="post" id="search2" name="search2" modelAttribute="comd1">
	...
	$(document).ready(function() {
		 ...
		 if('${nationality_name1}' != "")
			{
				$("#nationality_name").val('${nationality_name1}') ;
			}
		 if('${status1}' != ""){
	...
	function Search(){
			$("#nationality_name1").val($('#nationality_name').val());
	...
	function Validate() {
		...
		if ($("input#nationality_name").val().trim() == "") {
			alert("Please Enter Nationality Name");
			$("input#nationality_name").focus();
			return false;
		}
