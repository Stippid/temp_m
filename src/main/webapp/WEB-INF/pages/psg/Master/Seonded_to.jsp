...
<form:form name="SecondedTO" id="SecondedTO" action="SecondedTOAction" method="post" class="form-horizontal" commandName="SecondedTOCMD"> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>ADD/UPDATE SECONDED TO</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by MISO)</span></h6></div>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                   <input type="text" id="secondedto" name="secondedto" oninput="this.value = this.value.toUpperCase()" maxlength="50" class="form-control autocomplete" autocomplete="off" onkeypress="return onlyAlphabets(event);"> 
						                </div>
						            </div>
	              				</div>
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="SecondedToUrl" class="btn btn-success btn-sm" >Clear</a> 
		           ...
		           <table id="getbankSearch" class="table no-margin table-striped  table-hover  table-bordered report_print">
		                 <thead style="text-align: center;">
		                       <tr>
									...
									<th style="font-size: 15px">Seconded To</th>
...
<c:url value="getsecondedToSearch" var="searchUrl" />
<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="secondedto1">
		<input type="hidden" name="secondedto1" id="secondedto1" />
		<input type="hidden" name="status1" id="status1" />
</form:form> 

<c:url value="Edit_SecondedTo" var="editUrl"/>
<form:form action="${editUrl}" method="post" id="updateForm" name="updateForm" modelAttribute="id2">
	  <input type="hidden" name="id2" id="id2">
</form:form>

<c:url value="deleteSTOURL" var="deleteUrl" />
<form:form action="${deleteUrl}" method="post" id="deleteForm" name="deleteForm" modelAttribute="id1">
	<input type="hidden" name="id1" id="id1" value="0"/> 
</form:form>
<c:url value="STOreport" var="searchUrl" />
...
function validate(){
	if ($("input#secondedto").val().trim() == "") {
		alert("Please Enter Seconded To");
		$("input#secondedto").focus();
		return false;
	}
...
function Search(){
	...
	if($('#secondedto').val() == "" && $('#status').val() == "0"){
		alert("Please Enter Something to Search");
		$('#secondedto').focus();
		return  false;
	}
	
	    $("#secondedto1").val($('#secondedto').val());
