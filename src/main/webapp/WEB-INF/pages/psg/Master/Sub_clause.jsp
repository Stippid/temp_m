...
<form:form name="Sub_clause" id="Sub_clause" action="Sub_clauseAction" method="post" class="form-horizontal" commandName="Sub_clauseActionCMD"> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>SUB CLAUSE</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by MISO)</span></h6></div>
						...
						<div class="card-footer" align="center" class="form-control">
							...
							<a href="Sub_Clause_Url" class="btn btn-success btn-sm">Clear</a> 
	...
	<div class="container" id="Sub_Clause_Search">
		<div class="">
			 <div id="divShow" style="display: block;"></div>
			<div class="watermarked" data-watermark="" id="divwatermark" style="display: block;">
				<span id="ip"></span>
				<table id="Sub_Clause_Search" class="table no-margin table-striped  table-hover  table-bordered report_print" >
						<thead style="color: white;text-align: center;">
							<tr>
								<th style="font-size: 15px ;width: 10%;">Ser No</th>
								<th style="font-size: 15px">Sub Clause</th>
...
$(document).ready(function() {
	 ...
	 if('${list.size()}' == ""){
		   $("div#Sub_Clause_Search").hide();
		 }
	 
	 if('${sub_clause1}'== "")
		{}else
		{
			$("#sub_clause").val('${sub_clause1}') ;
		} 
});
...
function Search(){
		...
		$("#sub_clause1").val($('#sub_clause').val());
