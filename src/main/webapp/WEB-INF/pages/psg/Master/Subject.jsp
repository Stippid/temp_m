...
<form:form name="diva" id="diva" action="Sub_Action" method="post" class="form-horizontal" commandName="Sub_CMD"> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>ADD/UPDATE Subject</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by MISO)</span></h6></div>
	          			<div class="card-body card-block">
	            			<div class="col-md-12">	              					
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong style="color: red;">* </strong>Subject</label>
						                </div>
						                <div class="col-md-8">
						                   <input type="text" id="subject" name="subject" oninput="this.value = this.value.toUpperCase()" maxlength="30"  class="form-control autocomplete" autocomplete="off" onkeypress="return onlyAlphabets(event);" > 
						                </div>
						            </div>
	              				</div>
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="Subject" class="btn btn-success btn-sm" >Clear</a>  
...
<c:url value="getSearchSubjectMaster" var="searchUrl" />
<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="subject1">
...
<c:url value="deletesubMasterURL" var="deleteUrl" />
