...
<form:form name="TypeofEntry" id="TypeofEntry" action="TypeofEntryAction" method="post" class="form-horizontal" commandName="TypeofEntryCMD"> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>ADD/UPDATE TYPE OF ENTRY</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by MISO)</span></h6></div>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                   <input type="text" id="typeofentry" name="typeofentry" oninput="this.value = this.value.toUpperCase()" maxlength="50" class="form-control autocomplete" autocomplete="off" onkeypress="return onlyAlphabets(event);"> 
						                </div>
						            </div>
	              				</div>
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="TypeofEntryUrl" class="btn btn-success btn-sm" >Clear</a> 
		           ...
		           <table id="getbankSearch" class="table no-margin table-striped  table-hover  table-bordered report_print">
		                 <thead style="text-align: center;">
		                       <tr>
									...
									<th style="font-size: 15px">Type of Entry</th>
...
<c:url value="getEntrytypeSearch" var="searchUrl" />
<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="mothertounge1">
		<input type="hidden" name="typeofentry1" id="typeofentry1" />
		<input type="hidden" name="status1" id="status1" />
</form:form> 

<c:url value="Edit_TypeofEntry" var="editUrl"/>
<form:form action="${editUrl}" method="post" id="updateForm" name="updateForm" modelAttribute="id2">
	  <input type="hidden" name="id2" id="id2">
</form:form>

<c:url value="deleteEntryURL" var="deleteUrl" />
<form:form action="${deleteUrl}" method="post" id="deleteForm" name="deleteForm" modelAttribute="id1">
	<input type="hidden" name="id1" id="id1" value="0"/> 
</form:form>
<c:url value="TypeOfEntryreport" var="searchUrl" />
...
function validate(){
	if ($("input#typeofentry").val().trim() == "") {
		alert("Please Enter Type of Entry");
		$("input#typeofentry").focus();
		return false;
	}
...
function Search(){
	...
	if($('#typeofentry').val() == "" && $('#status').val() == "0"){
		alert("Please Enter Something to Search");
		$('#typeofentry').focus();
		return  false;
	}
	
	    $("#typeofentry1").val($('#typeofentry').val());
