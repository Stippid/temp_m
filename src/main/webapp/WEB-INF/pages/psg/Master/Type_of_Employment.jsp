...
<form:form name="Type_of_emp" id="Type_of_emp" action="Type_of_empAction" method="post" class="form-horizontal" commandName="Type_of_empCMD"> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    			<div class="card-header"><h5>ADD/UPDATE TYPE OF EMPLOYMENT </h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by MISO)</span></h6></div>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                   <input type="text" id="name" name="name" class="form-control autocomplete" oninput="this.value = this.value.toUpperCase()" maxlength="50" autocomplete="off" onkeyup="return specialcharecter(this)"> 
						                </div>
						            </div>
	              				</div>
	              				<div class="col-md-6">
...
<!-- 												<option value="0">--Select--</option> -->
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="Type_of_Employment" class="btn btn-success btn-sm" >Clear</a>  
...
<c:url value="GetSearch_Type_of_Employment" var="searchUrl" />
	<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="name1">
		<input type="hidden" name="name1" id="name1" value="0"/>
		<input type="hidden" name="status1" id="status1" value="0"/>
	</form:form> 
	
<c:url value="Edit_Type_of_EmploymentUrl" var="editUrl"/>
<form:form action="${editUrl}" method="post" id="updateForm" name="updateForm" modelAttribute="id2">
	  <input type="hidden" name="id2" id="id2" value="0">
</form:form>

<c:url value="Delete_Type_of_Employment" var="deleteUrl" />
<form:form action="${deleteUrl}" method="post" id="deleteForm" name="deleteForm" modelAttribute="id1">
	<input type="hidden" name="id1" id="id1" value="0"/> 
</form:form>
<c:url value="EmploymentTypereport" var="searchUrl" />
