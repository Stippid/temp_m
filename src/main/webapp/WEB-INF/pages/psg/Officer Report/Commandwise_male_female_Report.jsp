...
<form:form name="Commandwise_male_female" id="Commandwise_male_female" action="Commandwise_male_femaleAction" method="post" class="form-horizontal" commandName=""> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5> COMMANDWISE MALE-FEMALE REPORT  </h5> <h6 class="enter_by">Reported On: ${date}</h6></div>
				...
				<div class="card-footer" align="center" class="form-control">
					<a href="Command_wise_male_fe_Url" class="btn btn-success btn-sm">Clear</a>
...
<div class="container" id="viewpage">	
	<div class="col-md-12" id="getSearch_cmd_m_f" style="display: block;">
		<div class="watermarked" data-watermark="" id="divwatermark">
			<span id="ip"></span>
			<table id="getSearch_cmd_m_f"
				...
				<thead>
						<tr>
							...
							<th style="font-size: 15px; text-align: center;">LEVEL C</th>
							<th style="font-size: 15px; text-align: center;">MALE</th>
							<th style="font-size: 15px; text-align: center;">FEMALE</th>
							<th style="font-size: 15px; text-align: center;">OTHER</th>
				...
				<tbody>
					...
					<th style="text-align: center;">${fMale}</th>
					<th style="text-align: center;">${fFemale}</th>
					<th style="text-align: center;">${oOther}</th>
...
<c:url value="GetSearch_Command_M_F_Report" var="searchUrl" />
...
<c:url value="search_report_commandwise" var="reportUrl" />
