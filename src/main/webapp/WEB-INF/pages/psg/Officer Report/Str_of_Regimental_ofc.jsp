...
<form:form name="Str_of_Regimental_ofc" id="Str_of_Regimental_ofc" action="Str_of_Regimental_ofcAction" method="post" class="form-horizontal" commandName=""> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		...
	    		<h5>STR OF OFFICERS IN REGIMENTAL CENTRE</h5> 
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="row form-group">
								<div class="col-md-4">
									<label class=" form-control-label"> Unit_name  </label>
								</div>
								<div class="col-md-8">
				...
				<div class="card-footer" align="center" class="form-control">
					<a href="str_of_regimental_report_url" class="btn btn-success btn-sm">Clear</a>
			...
			<table id="getSearch_Letter "
				...
				<thead>
						<tr>
							...
							<th style="font-size: 15px; text-align: center;width:300px;">UNIT SUS NO</th>
							<th style="font-size: 15px; text-align: center;width: 59%;">UNIT NAME</th>
...
<c:url value="GetSearch_regimental_ofc" var="searchUrl" />
...
<c:url value="search_report_regimental_ofc" var="reportUrl" />
