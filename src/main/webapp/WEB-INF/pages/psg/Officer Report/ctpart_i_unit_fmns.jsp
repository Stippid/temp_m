...
<form:form name="cause_of_wastage" id="cause_of_wastage" action="cause_of_wastageAction" method="post" class="form-horizontal" commandName=""> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>ACTUAL STR OF OFFRS IN USER ARM UNITS AND ESTABLISHMENT OF CT PART -1 UNIT/FMNS</h5> <h6 class="enter_by">Reported On: ${date}</h6></div>
				...
				<div class="card-footer" align="center" class="form-control">
					<a href="GetSearch_ctpartiUrl" class="btn btn-success btn-sm">Clear</a>
	...
	<div class="container">
	<div class="col-md-12" id="GetSearch_Ctparti" style="display: block;">
		<div class="watermarked" data-watermark="" id="divwatermark">
			<span id="ip"></span>
			<table id="GetSearch_Ctparti "
...
<c:url value="GetSearch_Ctparti" var="searchUrl" />
...
<c:url value="Search_CTparti_pdf" var="reportUrl" />
<form:form action="${reportUrl}" method="post" id="searchviewForm" name="searchviewForm">
	<input type="hidden" name="ctpartiReport1" id=ctpartiReport1 value="0" />
	</form:form>
...
function getPDF()
{   
	document.getElementById('ctpartiReport1').value='pdfL';
