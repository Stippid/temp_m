...
<form:form action="Change_In_AppointmentUrl" method="post" class="form-horizontal" commandName="Popup_Change_AppointmentCMD">

<div class="" id="Change_In_AppointmentUrl" style="display: block;"> 	 
			<div  class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
		           <table id="Change_In_AppointmentUrl" class="table no-margin table-striped  table-hover  table-bordered">
...
<!--                                     <th style="font-size: 15px">X list sus no</th> -->
<!--                                     <th style="font-size: 15px">X list loc</th> -->
...
$(document).ready(function() {
	 ...
	 colAdj("Change_In_AppointmentUrl");
});
