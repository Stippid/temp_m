...
<form:form action="Change_In_MedicleUrl" method="post" class="form-horizontal" commandName="Change_In_MedicleCMD">
<div class="" id="Change_In_MedicleUrl" style="display: block;">
           <div class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
                 <table id="Change_In_MedicleUrl" class="table no-margin table-striped  table-hover  table-bordered">        
                                        <thead style="text-align: center;">
                                                <tr>
                                                    	<th style="font-size: 10px ;">Ser No</th>
                                                    	<th style="font-size: 10px">Authority</th>
                                                        <th style="font-size: 10px">Date of Authority</th>
                                                        <th style="font-size: 10px">S - Psychological & Congnitive</th>
                                                        <th style="font-size: 10px">H - Hearing</th>
                                                        <th style="font-size: 10px">A - Appendages</th>
                                                        <th style="font-size: 10px">P - Physical Capacity</th>
                                                        <th style="font-size: 10px">E - Eye Sight</th>
                                                        <th style="font-size: 10px">C - Climate and Terrain Restrictions</th>
                                                        <th style="font-size: 10px">O - Degree of Medical Observation Required</th>
                                                        <th style="font-size: 10px">P - Physical Capability Limitations</th>
                                                        <th style="font-size: 10px">E - Exclusive Limitations</th>
                                                        <th style="font-size: 10px">S - From Date</th>
                                                        <th style="font-size: 10px">S - To Date</th>
                                                        <th style="font-size: 10px">H - From Date</th>
                                                        <th style="font-size: 10px">H - To Date</th>
                                                        <th style="font-size: 10px">A - From Date</th>
                                                        <th style="font-size: 10px">A - To Date</th>
                                                        <th style="font-size: 10px">P - From Date</th>
                                                        <th style="font-size: 10px">P - To Date</th>
                                                        <th style="font-size: 10px">E - From Date</th>
                                                        <th style="font-size: 10px">E - To Date</th>
                                          ...
                                          <c:if test="${list.size()==0}">
								             <tr>
									              <td style="font-size: 15px; text-align: center; color: red;" colspan="16">Data Not Available</td>
								             </tr>
										</c:if>
