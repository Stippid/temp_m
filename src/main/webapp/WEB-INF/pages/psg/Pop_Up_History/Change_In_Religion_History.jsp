...
<form:form action="Change_In_Religion_Form" method="post" class="form-horizontal" commandName="Popup_Change_Identity_CardCMD">
<div class="" id="Change_In_ReligionUrl" style="display: block;"> 	 
			<div  class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
		           <table id="Change_In_ReligionUrl" class="table no-margin table-striped  table-hover  table-bordered">
