...
<form:form action="Change_In_NameUrl" method="post" class="form-horizontal" commandName="Popup_Change_NameCMD">

<div class="" id="Change_In_NameUrl" style="display: block;"> 	 
			<div  class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
		           <table id="Change_In_NameUrl" class="table no-margin table-striped  table-hover  table-bordered">
		                 <thead style="text-align: center;">
		                        <tr>
                                    ...
                                    <th style="font-size: 15px">Date Of Change In Name</th>
