...
<form:form name="change_nok" id="change_nok" action="change_nokaction" method="post"
	class="form-horizontal" commandName="changenokcmd">
						...
						<tr>
							<c:if test="${ status1 != 1}">
								<td style="font-size: 15px; text-align: center; color: red;"
									colspan="18">Data Not Available</td>
							</c:if>
