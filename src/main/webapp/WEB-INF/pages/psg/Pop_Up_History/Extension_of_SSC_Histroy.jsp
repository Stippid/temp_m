...
<form:form action="Extension_of_SSCUrl" method="post" class="form-horizontal" commandName="Popup_Extension_of_SSC_CMD">

<div class="" id="Extension_of_SSCUrl" style="display: block;"> 	 
			<div  class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
		           <table id="Extension_of_SSCUrl" class="table no-margin table-striped  table-hover  table-bordered">
