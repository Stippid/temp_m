...
<form:form action="Known_Allergy_HistoryUrl" method="post" class="form-horizontal" commandName="Known_Allergy_HistoryCMD">
<div class="" id="Known_Allergy_HistoryUrl" style="display: block;"> 	 
			<div  class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
		           <table id="Known_Allergy_HistoryUrl" class="table no-margin table-striped  table-hover  table-bordered">
		                 <thead style="text-align: center;">
		                       <tr>
			                        <th style="font-size: 15px ;">Ser No</th>
			                        <th style="font-size: 15px">Allergy</th>
			                 ...
			                 <c:if test="${list.size()==0}">
		                       ...
		                       <c:forEach var="item" items="${list}" varStatus="num" >
									<tr>
										...
										<td style="font-size: 15px;">${item.medicine}</td>
...
$(document).ready(function() {
	 ...
	 colAdj("Known_Allergy_HistoryUrl");
});
