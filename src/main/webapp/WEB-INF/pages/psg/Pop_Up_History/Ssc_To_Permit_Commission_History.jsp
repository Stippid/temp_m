...
<form:form action="Ssc_To_Permit_CommissionUrl" method="post" class="form-horizontal" commandName="">
<div class="" id="Ssc_To_Permit_CommissionUrl" style="display: block;"> 	 
			<div  class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
		           <table id="Ssc_To_Permit_CommissionUrl" class="table no-margin table-striped  table-hover  table-bordered">
		                 <thead style="text-align: center;">
		                       <tr>
			                        <th style="font-size: 15px;">Ser No</th>
			                        <th style="font-size: 15px">Authority</th>
								    <th style="font-size: 15px">Date of Authority</th>
								    <th style="font-size: 15px">Old Personal No</th>
									<th style="font-size: 15px">New Personal No</th>
									<th style="font-size: 15px">Previous Commission</th>
									<th style="font-size: 15px">Type of Commission</th>
									<th style="font-size: 15px">Date of Commission</th>
									<th style="font-size: 15px">Date of Seniority</th>
...
$(document).ready(function() {
	 ...
	 colAdj("Ssc_To_Permit_CommissionUrl");
});
