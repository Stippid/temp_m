...
<form:form action="Update_Firing_StandardUrl" method="post" class="form-horizontal" commandName="Popup_Update_FiringStandardCMD">
<div class="" id="Update_Firing_StandardUrl" style="display: block;">
           <div class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
                 <table id="Update_Firing_StandardUrl" class="table no-margin table-striped  table-hover  table-bordered">        
                                        <thead style="text-align: center;">
                                                <tr>
                                                    <th style="font-size: 15px ;">Ser No</th>
                                                        <th style="font-size: 15px">Firing Grade</th>
                                                        <th style="font-size: 15px">Firing Event QTR</th>
...
$(document).ready(function() {
	 ...
	 colAdj("Update_Firing_StandardUrl");
});
