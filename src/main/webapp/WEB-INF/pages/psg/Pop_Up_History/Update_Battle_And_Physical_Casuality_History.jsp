...
<form:form action="Update_Battle_And_Physical_CasualityUrl" method="post" class="form-horizontal" commandName="Popup_Change_Identity_CardCMD">
<div class="" id="Update_Battle_And_Physical_CasualityUrl" style="display: block;"> 	 
			<div  class="watermarked" data-watermark="" id="divwatermark"><span id="ip"></span>
		           <table id="Update_Battle_And_Physical_CasualityUrl" class="table no-margin table-striped  table-hover  table-bordered">
...
$(document).ready(function() {
	 ...
	 colAdj("Update_Battle_And_Physical_CasualityUrl");
});
