...
<form:form name="update_child" id="update_child" action="update_childaction" method="post"
	class="form-horizontal" commandName="changechildcmd">
			...
			<table id="getSearch_Letter"
				...
				<thead>
					<tr>
						...
						<th style="font-size: 10px; text-align: center">Aadhaar Card No</th>
					...
					<c:if test="${list.size()==0}">
						<tr>
							<td style="font-size: 15px; text-align: center; color: red;"
									colspan="12">Data Not Available</td>
						</tr>
					</c:if>
