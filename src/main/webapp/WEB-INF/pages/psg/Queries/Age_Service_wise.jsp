...
<form action="" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn">
	    	...
	    	<div class="col-md-12" align="center">
	    		<div class="card">
	    			<div class="card-header"><h5>HELD STR OF OFFRS AGE WISE</h5></div>
	    			<div class="card-header"><h5>DATE AS ON: ${date}  </h5></div>
				...
				<thead>
					<c:forEach var="item" items="${list}" varStatus="num">
						<tr>
							...
							<th style="font-size: 15px; width:50%; text-align: center;">No of Offers</th>
						</tr>
						<tr>
						...
						<tr>
							<th style="font-size: 15px; text-align: center;">YRS 30 ONWARDS LESS THAN 35YRS</th>
							<td style="background-color:#f0f3f5; color:black;text-align: center;" ><span>${item[2]}</span></td>
						</tr>	<tr>
							<th style="font-size: 15px; text-align: center;">YRS 35 ONWARDS LESS THAN 40YRS</th>
							<td style="background-color:#f0f3f5; color:black; text-align: center;"><span>${item[3]}</span></td>
						</tr>
						<tr>
							<th style="font-size: 15px; text-align: center;">YRS 40 ONWARDS LESS THAN 45YRS</th>
							<td style="background-color:#f0f3f5; color:black; text-align: center;"><span>${item[4]}</span></td>
						</tr>
						<tr>
							<th style="font-size: 15px; text-align: center;">YRS 45 ONWARDS LESS THAN 50YRS</th>
							<td style="background-color:#f0f3f5; color:black; text-align: center;"><span>${item[5]}</span></td>
						</tr>
						<tr>
							<th style="font-size: 15px; text-align: center;">YRS 50 ONWARDS LESS THAN 55YRS</th>
							<td style="background-color:#f0f3f5; color:black; text-align: center;"><span>${item[6]}</span></td>
						</tr>
						<tr>
							<th style="font-size: 15px; text-align: center;">YRS 55 ONWARDS LESS THAN 60YRS</th>
...
<c:url value="Download_Age_Service_query" var="dwonloadUrl"/>
<form:form action="${dwonloadUrl}" method="post" id="downloadForm" name="downloadForm" >
</form:form>

<c:url value="Excel_Age_Service_wise_query" var="excelUrl" />
