...
<form action="" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn">		
	    	<div class="col-md-12" align="center">
	    		<div class="card">
	    			<div class="card-header"><h5>IAFF 3008 Search Report (MNS)</h5></div>
	          			<div class="card-body">
		          			<div class="col-md-12">
								<div class="col-md-6">
							...
							<div class="col-md-12">
		          				<div class="col-md-6">
		          					<div class="row form-group">
										...
										<div class="col-12 col-md-8">			
											<input type="text" id="unit_name" name="unit_name" maxlength="100" placeholder="select Unit Name" class="form-control autocomplete" autocomplete="off" >
										</div>
									</div>
		          				</div>
		          				<div class="col-md-6">
		          					<div class="row form-group">
							            ...
							            <div class="col-12 col-md-8">
											<input type="text" id="sus_no" name="sus_no" maxlength="8" placeholder="Select SUS No" class="form-control autocomplete" autocomplete="off">
										</div>
	              					</div>
		          				</div>
		          			</div>						
    ...
    <select id="line_dte" name="line_dte" class="form-control">
        ...
        <c:forEach var="item" items="${getLineDteList}" varStatus="num">
            <option value="${item[0]}" <c:if test="${line_dte_sus_no != null && item[0].equals(line_dte_sus_no)}">selected</c:if>>${item[1]}</option>
        </c:forEach>
    </select>
</div>
						</div>
						...
						<div class="card-footer" align="center">
							<a href="IAFF_3008_Query_mns" type="reset" class="btn btn-success btn-sm"> Clear </a> 
		              		<i class="fa fa-search"></i><input type="button" class="btn btn-primary btn-sm"  id="btn-reload" onclick="Search();" value="Search" />
...
<div class="container-fluid" id = "report_all" style="display: none;">		
	...
	<div class="col-md-12" id="getSearch_Letter" style="display: block;"> 	 
		...
		<c:url value="GetI3008_Serving_mns" var="searchUrl" />
...
<c:url value="Excel_IAFF_3008_query_mns" var="excelUrl" />
<form:form action="${excelUrl}" method="post" id="ExcelForm" name="ExcelForm" modelAttribute="cont_comd_txt">
	...
	<script>
		...
		$(document).ready(function() {
			...
			$("#report_all").hide() ;	
			   ...
			   if('${roleAccess}' == 'MISO' || '${roleAccess}' == 'DGMS')
				{
				     if('${month1}' != 0){
						 $("#month").val('${month1}');	
					     $("#report_all").show() ;	
...
function editData(month,year,version,sus_no,status){
	...
	$("#status5").val(status);
	$("#pagename").val("IAFF_3008_Querymns");
