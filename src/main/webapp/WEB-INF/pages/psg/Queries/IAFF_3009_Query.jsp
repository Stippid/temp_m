		...
		<div class="col-md-12" align="center">
			<div class="card">
				<div class="card-header">
					<h5>IAFF - 3009: UNIT STR RETURN</h5>
				</div>
				<div class="card-body">
					<div class="col-md-12">
						<div class="col-md-6">
...
<div class="col-md-6">
				...
				<input type="hidden" id="unit_sus_no" name="unit_sus_no" value="0">
				


				<div class="card-footer" align="center">
					<a href="IAFF_3009_Query" type="reset"
						class="btn btn-success btn-sm"> Clear </a> <!-- <i class="fa fa-search"></i> -->
				...
				<table id="getauthServingTable"
					...
					<thead>
						...
						<tr class="centered-row">
							...
							<th style="text-align: center; vertical-align: middle;" id="appt">Arms
								/Services</th>
							<th style="text-align: center; vertical-align: middle;"
								id="rankT">Offrs</th>
							<th style="text-align: center; vertical-align: middle;" id="name">MNS
								Offrs</th>
							<th style="text-align: center; vertical-align: middle;"
								id="personnel_no">JCOs</th>
							<th style="text-align: center; vertical-align: middle;"
								id="cda_acc_no">OR</th>
							<th style="text-align: center; vertical-align: middle;"
								id="med_cat">Remarks</th>
						</tr>
			...
			<div class="watermarked" data-watermark="" id="divwatermark">
				...
				<table id="getSearch_Letter "
					...
					<thead>
						<tr class="centered-row">
							<th rowspan="2"
								style="text-align: center; width: 300px; vertical-align: middle;"
								id="appt">Arms /Services</th>
					...
					<tbody>
						...
						<c:forEach var="item3" items="${list3}" varStatus="num">
							<tr>

								<td style="font-size: 15px;">${item3[0]}</td>
								<td style="font-size: 15px;">${item3[1]}</td>
								<td style="font-size: 15px;">${item3[2]}</td>
								<td style="font-size: 15px;">${item3[3]}</td>
								<td style="font-size: 15px;">${item3[4]}</td>
								<td style="font-size: 15px;">${item3[5]}</td>							
								<td style="font-size: 15px;">${item3[6]}</td>
								<td style="font-size: 15px;">${item3[7]}</td>
								<td style="font-size: 15px;">${item3[8]}</td>
								<td style="font-size: 15px;">${item3[9]}</td>
								<td style="font-size: 15px;">${item3[10]}</td>
								<td style="font-size: 15px;">${item3[11]}</td>
								<td style="font-size: 15px;">${item3[12]}</td>
								<td style="font-size: 15px;">${item3[13]}</td>
								<td style="font-size: 15px;">${item3[14]}</td>
								<td style="font-size: 15px;">${item3[15]}</td>
								<td style="font-size: 15px;">${item3[16]}</td>
								<td style="font-size: 15px;">${item3[17]}</td>
								<td style="font-size: 15px;">${item3[18]}</td>
								<td style="font-size: 15px;">${item3[19]}</td>
								<td style="font-size: 15px;">${item3[20]}</td>
			...
			<table id="getsummuryTable"
				...
				<th colspan="" style="text-align: center;" id=""></th>
						...
						<tr>
							...
							<th style="text-align: center;" id="rankT">Over and Above</th>
							...
							<th style="text-align: center;" id="cda_acc_no">Auth No</th>
						</tr>
					...
					<thead>
						...
						<tr>
							...
							<th rowspan="2"
								...
								id="rankT">Trade</th>
							<th colspan="4"
								style="text-align: center; vertical-align: middle;" id="name">JCOs</th>
							<th colspan="4"
								style="text-align: center; vertical-align: middle;"
								id="cda_acc_no">OR</th>
							<!--  <th colspan="2"  style="text-align: center;" id="parent_arm"> Civ Employed in lieu of Combatant </th> -->
							<th rowspan="2"
								style="text-align: center; vertical-align: middle;" id="med_cat">
								Total</th>
						</tr>
						<tr>
							<th style="text-align: center; vertical-align: middle;"
								id="date_of_appointment">Sub Maj</th>
							<th style="text-align: center; vertical-align: middle;"
								id="date_of_appointment">Sub</th>
							<th style="text-align: center; vertical-align: middle;"
								id="date_of_appointment">Nb Sub</th>
							<th style="text-align: center; vertical-align: middle;"
								id="date_of_appointment">WARRANT OFFICER</th>
							<th style="text-align: center; vertical-align: middle;"
								id="date_of_appointment">Hav</th>
							<th style="text-align: center; vertical-align: middle;"
								id="date_of_appointment">NK</th>
							<th style="text-align: center; vertical-align: middle;"
								id="date_of_appointment">LNK/Sep</th>
							<th style="text-align: center; vertical-align: middle;"
								id="date_of_appointment">RECTS</th>
					...
					<tbody>
						...
						<c:forEach var="item5" items="${list5}" varStatus="num">
							<tr>
								...
								<td style="font-size: 15px;">${item5[1]}</td>
								<td style="font-size: 15px;">${item5[2]}</td>
								<td style="font-size: 15px;">${item5[3]}</td>
								<td style="font-size: 15px;">${item5[4]}</td>
								<td style="font-size: 15px;">${item5[5]}</td>
								<td style="font-size: 15px;">${item5[6]}</td>
								<td style="font-size: 15px;">${item5[7]}</td>
								<td style="font-size: 15px;">${item5[8]}</td>
								<td style="font-size: 15px;">${item5[9]}</td>
								<td style="font-size: 15px;">${item5[10]}</td>
			...
			<div class="watermarked" data-watermark="" id="divwatermark">
				...
				<table id="getreligiousTable"
					...
					<thead>
						<tr class="centered-row">
							<th rowspan="2"
								style="text-align: center; vertical-align: middle;" id="rankT">
								Religion</th>
							<th rowspan="2"
								style="text-align: center; vertical-align: middle;" id="appt">Arms
								/Services</th>
							<th colspan="2"
								style="text-align: center; vertical-align: middle;" id="name">Posted
								Str incl ERE pers</th>
							<th colspan="2"
								style="text-align: center; vertical-align: middle;"
								id="cda_acc_no">Religious Teacher</th>
						</tr>
						<tr>
...
<div class="col-md-12">
		<div class="col-md-10">
			<div class="row form-group">
				<div class="col-md-4">
					<label class=" form-control-label"> Remarks:(Defi/ Surplus str if any to be Mentioned)</label>
				</div>
				<div class="col-md-8">
...
<form:form action="${searchUrl}" method="post" id="searchForm"
	...
	<c:url value="Approve_Report_3009_Url" var="editUrl"/>
	<form:form action="${editUrl}" method="post" id="updateForm" name="updateForm" modelAttribute="unit_sus_no5">
     	...
     	<input type="hidden" name="unit_sus_no1" id="unit_sus_no6"   >
	    <input type="hidden" name="hd_cmd_sus5" id="hd_cmd_sus5" value="0">
	   <input type="hidden" name="hd_corp_sus5" id="hd_corp_sus5" value="0">
	  <input type="hidden" name="hd_div_sus5" id="hd_div_sus5" value="0">
	   <input type="hidden" name="hd_bde_sus5" id="hd_bde_sus5" value="0">
	   <input type="hidden" name="line_dte5" id="line_dte1"  value="">
	  	
	</form:form>	

<c:url value="Download_IAFF3009_query" var="downloadUrl" />
<form:form action="${downloadUrl}" method="post" id="downloadForm"
	...
	<input type="hidden" name="version2" id="version2" value="0">
...
<c:url value="Excel_IAFF_3009_query" var="excelUrl" />
...
<script>
	...
	function print_report(month,year,version,sus_no,status) {
...
<script>
	...
	function editData(month,year,version,sus_no,status){	
		...
		$("#status5").val(status);
		$("#pagename").val("IAFF_3009_Query");		
		$("#unit_sus_no6").val($("#unit_sus_no").val());

		$("#hd_cmd_sus5").val($("#hd_cmd_sus").val());
		$("#hd_corp_sus5").val($("#hd_corp_sus").val());
		$("#hd_div_sus5").val($("#hd_div_sus").val());
		$("#hd_bde_sus5").val($("#hd_bde_sus").val());
