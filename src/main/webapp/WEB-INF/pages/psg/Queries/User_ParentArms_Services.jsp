...
<form action="" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn">
	    	...
	    	<div class="col-md-12" align="center">
	    		<div class="card">
	    			<div class="card-header"><h5>HELD STR OF OFFRS BY USER ARMS/ FMN AND PARENT ARM/SERVICES.</h5></div>
	    			<div class="card-header"><h5>DATA AS ON: ${date}</h5></div>
	    			<div class="card-header"><h5>REPORT NO MISO/OFFRS/03</h5></div>
...
<c:url value="Download_User_ParentArms_query" var="dwonloadUrl"/>
...
<c:url value="Excel_User_ParentArms_query" var="excelUrl" />
...
$(document).ready(function() {  
	...
	table = dataTable('User_ParentArms_reporttbl_ctpart2');
	$('#btn-reload').on('click', function(){
		table.ajax.reload();
	});
...
function data(tableName){
	if(tableName == "User_ParentArms_reporttbl"){
		...
		$.post("getUser_ParentArms_ReportDataList?"+key+"="+value,{startPage:startPage,pageLength:pageLength,Search:Search,orderColunm:orderColunm,orderType:orderType,
			},function(j) {
		...
		$.post("getUser_ParentArms_TotalCount?"+key+"="+value,{Search:Search},function(j) {
			FilteredRecords = j;
		});
	}
	if(tableName == "User_ParentArms_reporttbl_ctpart2"){
		...
		$.post("getUser_ParentArms_reporttbl_ctpart2?"+key+"="+value,{startPage:startPage,pageLength:pageLength,Search:Search,orderColunm:orderColunm,orderType:orderType,
			},function(j) {
		...
		$.post("getUser_ParentArms_reporttbl_ctpart2_TotalCount?"+key+"="+value,{Search:Search},function(j) {
			FilteredRecords = j;
		});
	}
}	
