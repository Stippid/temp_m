		...
		<div class="col-md-12" align="center">
			<div class="card">
				<div class="card-header">
					<h5>APPX 'A' & APPX 'B' TO IAFF-3009 : CIVILIANS REPORTS</h5>
				</div>
				<div class="card-body">
					<div class="col-md-12">
						<div class="col-md-6">
				...
				<div class="card-footer" align="center">
					<a href="appxAandB_Query" type="reset"
...
<c:url value="GetappxAandB_CivReports" var="searchUrl" />
...
<c:url value="Download_AppxABReport" var="downloadUrl" />
<form:form action="${downloadUrl}" method="post" id="downloadForm"
	...
	<input type="hidden" name="version1" id="version1" value="0">
</form:form>
...
debugger;
	...
	function downloaddata(month,year,version,sus_no) {
