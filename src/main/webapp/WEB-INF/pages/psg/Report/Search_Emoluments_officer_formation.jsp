		...
		<div class="col-md-12" align="center">
			<div class="card">
				...
				<div class="card-footer" align="center" class="form-control">
					<a href="SearchEmolumentsFormationOfficer_url"
	...
	<div id="viewpage" class=col-md-12>
		<div class="col-md-12" id="getSearch_Letter" style="display: block;">
			<div class="watermarked" data-watermark="" id="divwatermark">
				<span id="ip"></span>
				<table id="getSearch_Emoluments_wise"
...
<c:url value="SearchEmolumentsbattle" var="Searchformationbattle" />
...
function data(getSearch_Emoluments_wise){
	jsondata = [];

	var table = $('#'+getSearch_Emoluments_wise).DataTable();
	...
	$.post("getEmoluments?"+key+"="+value,{startPage:startPage,pageLength:pageLength,Search:Search,orderColunm:orderColunm,orderType:orderType,cont_comd:cont_comd,cont_corps:cont_corps,cont_div:cont_div,cont_bde:cont_bde,unit_name:unit_name,sus_no:sus_no,personnel_no:personnel_no,
		rank:rank,dt_of_casuality:dt_of_casuality,scase:scase,
		},function(j) {
			
		for (var i = 0; i < j.length; i++) {
			
			jsondata.push([j[i].personnel_no,j[i].name,j[i].rank,j[i].unit_name,j[i].action,
			]);
	...
	$.post("getEmolumentsCount?"+key+"="+value,{Search:Search,cont_comd:cont_comd,cont_corps:cont_corps,cont_div:cont_div,cont_bde:cont_bde,unit_name:unit_name,sus_no:sus_no,personnel_no:personnel_no,
		rank:rank,dt_of_casuality:dt_of_casuality,scase:scase,
		},function(j) {
		FilteredRecords = j;
	});
...
<Script>
	$(document).ready(function() {
		...
		mockjax1('getSearch_Emoluments_wise');
		table = dataTable('getSearch_Emoluments_wise');
...
<script>
	...
	/*  function AppViewData(comm_id){
			document.getElementById('comm_id').submit();	 
