...
<form id="Edit_posting_out" action="Edit_posting_out_Action?${_csrf.parameterName}=${_csrf.token}" method="post"  commandName="Edit_posting_out_CMD" >
...
<c:url value="Search_Posting_OutUrl" var="searchUrl" />
