				...
				<div class="col-md-12" style="display:none">
					...
					<div class="col-md-12">						 
						 <div class="col-md-6" id="stats_out" style="display: none;">
							<div class="row form-group">
								<div class="col-md-4">
									<strong style="color: red;"> </strong><label class=" form-control-label">TA Status </label>
								</div>
								<div class="col-md-8">
							...
							<div class="row form-group">
								...
								<div class="col-md-8">
									<!-- <input type="text" id="in_personnel_no" name="personnel_no"
										...
										onkeyup="getPersonnel_noin(this,'i_from_sus_no') ; ; specialcharecter(this)"
...
// 								});
		    		    	...
		    		    	// base on personnel number susno bind 
		    		      	...
		    		      	// End base on personnel number susno bind 
	...
	debugger;
		...
		susNoAuto.autocomplete({
			source: function(request, response) {
				$.ajax({
					type: 'POST',
					url: "getPersonnelNoOfficerList?" + key + "=" + value,
					data: {
