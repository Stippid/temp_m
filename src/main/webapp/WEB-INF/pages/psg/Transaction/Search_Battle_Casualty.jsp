...
<script src="js/miso/orbatJs/orbatAll.js" type="text/javascript"></script>
	...
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5> SEARCH/APPROVE BATTLE CASUALTY</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by Unit)</span></h6></div>
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="Search_BattleCAUrl" class="btn btn-success btn-sm" >Clear</a>  
...
<c:url value="GetSearch_BattleCA" var="searchUrl" />
...
<c:url value="Approve_BattleCA" var="approveUrl" />
...
<c:url value="Reject_BatlleCA" var="rejectUrl" />
...
<c:url value="Edit_Search_BattleCA" var="editUrl"/>
...
<c:url value="Delete_BattleCA" var="deleteUrl" />
