	           ...
	           <div class="card-body card-block">
	            	<div class="col-md-12">	              					
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="Search_Field_Service_url" class="btn btn-success btn-sm" >Clear</a>  
			                 ...
			                 <c:if test="${list.size()==0}">
		                       ...
		                       <c:forEach var="item" items="${list}" varStatus="num" >
									<tr>
										...
										<td style="font-size: 15px;text-align: center;" >${item[8]} ${item[9]} ${item[10]} ${item[11]}</td> 																		
									</tr>
								</c:forEach>
		                     </tbody>
		                 </table>
...
<c:url value="GetSearch_field_service_data" var="searchUrl" />
...
<c:url value="Edit_field_service_dataUrl" var="editUrl"/>
...
<c:url value="Edit_Appr_field_service" var="editAppUrl"/>
...
<c:url value="ApproveSearch_field_service_dat" var="approveUrl" />
...
<c:url value="View_field_service_dat" var="viewUrl" />
...
<c:url value="View_field_service_history_dat" var="viewHisytoryUrl" />
...
<c:url value="Approve_field_service_history_dat" var="ApprHisytoryUrl" />
...
<c:url value="Delete_Search_field_service_data" var="deleteUrl" />
