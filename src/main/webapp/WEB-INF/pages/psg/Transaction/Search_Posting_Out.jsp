	...
	<div id="div_post_out" class="tabcontent" style="display:none ;">
		<form id="post_out_form">
				...
				<div class="card-footer" align="center" class="form-control">
					<a href="Search_Posting_OutUrl" class="btn btn-success btn-sm">Clear</a>
...
<c:url value="Search_Posting_Out" var="searchUrl" />
...
<c:url value="Search_Posting_In" var="searchUrl" />
...
<c:url value="Approve_PostOUT" var="approveUrl" />
<form:form action="${approveUrl}" method="post" id="approveForm" name="approveForm" modelAttribute="id3">
 ...
 <c:url value="Approve_PostIN" var="inapproveUrl" />
<form:form action="${inapproveUrl}" method="post" id="inapproveForm" name="inapproveForm" modelAttribute="id4">
 ...
 <c:url value="Reject_PostOUT" var="rejectUrl" />
<form:form action="${rejectUrl}" method="post" id="rejectForm" name="rejectForm" modelAttribute="idoutr">
 ...
 <c:url value="Reject_PostIN" var="inrejectUrl" />
...
<c:url value="Edit_Post_Out_Url" var="updateUrl" />
...
<c:url value="Edit_Post_In_Url" var="updateUrl" />
...
<c:url value="CancelRejectHistory_PostINOUT" var="CancelRejectUrl" />
<form:form action="${CancelRejectUrl}" method="post" id="CancelRejectForm" name="CancelRejectForm" modelAttribute="idcrh">
 ...
 <c:url value="ApproveCancelHistory_PostINOUT" var="ApproveCancelUrl" />
...
function  search_sus(sus_obj,unit_id){		
	...
	$("input#personnel_no").keyup(function() {
		...
		if($('#service_category').val()=='1'){
			perurl='getpersonnel_noListApprovedpostin?';
		}
