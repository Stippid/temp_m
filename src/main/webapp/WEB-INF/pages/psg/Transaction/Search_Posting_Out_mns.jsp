		...
		<div class="container" align="center">
			...
			<form>
				<div class="card-header">
					<h5>Search/Approve Posting Mns</h5>
					<h6 class="enter_by">
					 	...
					 	<div class="col-md-6" style="display: none;">
              				<div class="row form-group">
					           <div class="col-md-4">
					            ...
					            <div class="col-md-8">
				                  <select name="service_category" id="service_category" onchange="fnType()" class="form-control-sm form-control" >
	...
	<div id="div_post_out" class="tabcontent" style="display:none ;">
		<form id="post_out_form">
				...
				<div class="card-footer" align="center" class="form-control">
					<a href="Search_Posting_OutMnsUrl" class="btn btn-success btn-sm">Clear</a>
					<input type="button" class="btn btn-info btn-sm"
						onclick="getPostData();" value="Search">
				</div>
			</div>
	              					...
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">				           
											...
											<select name="statusin" id="statusin" class="form-control-sm form-control"  >
													<option value="0">Pending</option>
												    <option value="1">Approved</option>	
													<option value="3">Rejected</option>
													<option value="4">View History/Cancel</option>
	              					...
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                 ...
						                 <select name="in_cr_by" id="in_cr_by" class="form-control-sm form-control"   >
                                                                                                <option value="">--Select--</option>
                                                                                                <c:forEach var="item" items="${getRoleNameList_dash}" varStatus="num">
                                                                                                <option value="${item.userId}"  name="${item.userName}">${item.userName}</option>
                                                                                                </c:forEach>
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						               	<input type="text" name="in_cr_date" id="in_cr_date" maxlength="10"   onclick="clickclear(this, 'DD/MM/YYYY')" class="form-control" style="width: 85%;display: inline;"  >
		...
		<table id="searchPostTable"
			...
			<thead>
				<tr>
					...
					<!-- <th style="font-size: 15px; text-align: center;" id="th_sos">Date of SOS</th> -->
...
<c:url value="Search_Posting_Out_Mns" var="searchUrl" />
...
<c:url value="Search_Posting_In_Mns" var="searchUrl" />
<form:form action="${searchUrl}" method="post" id="searchForm1"
	...
	<input type="hidden" name="type2" id="type2" value="0" />
		<input type="hidden" name="in_cr_date1" id="in_cr_date1"  />
	<input type="hidden" name="in_cr_by1" id="in_cr_by1"  />
	
</form:form>


<c:url value="Approve_PostOUTMns" var="approveUrl" />
<form:form action="${approveUrl}" method="post" id="approveForm" name="approveForm" modelAttribute="id3">
	 ...
	 <input type="hidden" name="comm_idapp1" id="comm_idapp1" value="0"/>  
	 ...
	 <input type="hidden" name="service_categoryAppout" id="service_categoryAppout" value="0" />
 ...
 <c:url value="Approve_PostINMns" var="inapproveUrl" />
<form:form action="${inapproveUrl}" method="post" id="inapproveForm" name="inapproveForm" modelAttribute="id4">
	...
	<input type="hidden" name="comm_idapp2" id="comm_idapp2" value="0"/>  
	...
	<input type="hidden" name="service_categoryAppin" id="service_categoryAppin" value="0" />
 ...
 <c:url value="Reject_PostOUTMns" var="rejectUrl" />
<form:form action="${rejectUrl}" method="post" id="rejectForm" name="rejectForm" modelAttribute="idoutr">
	 ...
	 <input type="hidden" name="comm_idoutr" id="comm_idoutr" value="0"/>  
	 <input type="hidden" name="from_sus_nooutr" id="from_sus_nooutr" value="0"/>  
	 <input type="hidden" name="service_categoryAppoutr" id="service_categoryAppoutr" value="0" />
	 ...
	 <input type="hidden" name="rej_remarksoutr" id="rej_remarksoutr" value="0"/> 
</form:form>
 
 <c:url value="Reject_PostINMns" var="inrejectUrl" />
<form:form action="${inrejectUrl}" method="post" id="inrejectForm" name="inrejectForm" modelAttribute="idinr">
	...
	<input type="hidden" name="comm_idinr" id="comm_idinr" value="0"/>  
	...
	<input type="hidden" name="service_categoryAppinr" id="service_categoryAppinr" value="0" />
	...
	<input type="hidden" name="rej_remarksinr" id="rej_remarksinr" value="0"/> 	
</form:form> 

<c:url value="Edit_Post_Out_MnsUrl" var="updateUrl" />
<form:form action="${updateUrl}" method="post" id="updateForm" name="updateForm" modelAttribute="updateid">
	<input type="hidden" name="updateid" id="updateid" value="0" />
	<input type="hidden" name="service_categoryout" id="service_categoryout" value="0" />	
	...
	<input type="hidden" name="service_category6" id="service_category6" value="0" />
</form:form>

<c:url value="Edit_Post_In_MnsUrl" var="updateUrl" />
<form:form action="${updateUrl}" method="post" id="inupdateForm" name="inupdateForm" modelAttribute="updateid">
	...
	<input type="hidden" name="service_categoryin" id="service_categoryin" value="0" />
	...
	<input type="hidden" name="service_category3" id="service_category3" value="0" />	
</form:form>
 
<!--  //////////////////////Cancel History//////////////////////////// -->

<c:url value="CancelRejectHistory_PostINOUTMns" var="CancelRejectUrl" />
<form:form action="${CancelRejectUrl}" method="post" id="CancelRejectForm" name="CancelRejectForm" modelAttribute="idcrh">
	 ...
	 <input type="hidden" name="service_categoryAppcrh" id="service_categoryAppcrh" value="0" />
 ...
 <c:url value="ApproveCancelHistory_PostINOUTMns" var="ApproveCancelUrl" />
<form:form action="${ApproveCancelUrl}" method="post" id="ApproveCancelForm" name="ApproveCancelForm" modelAttribute="idach">
	...
	<input type="hidden" name="service_categoryAppach" id="service_categoryAppach" value="0" />
...
function INSearch() {
	...
	$("#type2").val($("#type").val());
	$("#cr_by1").val($("#in_cr_by").val()) ;
	$("#cr_date1").val($("#in_cr_date").val()) ;
	document.getElementById('searchForm1').submit();
}
function Approved(id,comm_id,unit_sus_no){
	
	$("#id3").val(id);
	$("#comm_idapp1").val(comm_id);
...
function InApproved(id,comm_id,unit_sus_no){
	
	$("#id4").val(id);
	$("#comm_idapp2").val(comm_id);
	$("#unit_sus_noapp2").val(unit_sus_no);
	$("#typeapp2").val($("#type").val());
	$('#service_categoryAppin').val($('#service_category').val());	
...
function Reject(id,comm_id,unit_sus_no){
	
	$("#idoutr").val(id);
	$("#comm_idoutr").val(comm_id);
	$("#unit_sus_nooutr").val(unit_sus_no);
	$("#typeoutr").val($("#type").val());
	$('#service_categoryAppoutr').val($('#service_category').val());		
	...
	$("#rej_remarksoutr").val($("#reject_remarks").val()); 	
	document.getElementById('rejectForm').submit();		
}
function InReject(id,comm_id,unit_sus_no){
	
	$("#idinr").val(id);
	$("#comm_idinr").val(comm_id);
	$("#unit_sus_noinr").val(unit_sus_no);
	$("#typeinr").val($("#type").val());
	$('#service_categoryAppinr').val($('#service_category').val());	
	...
	$("#rej_remarksinr").val($("#reject_remarks").val()); 	
...
function editData(id) {
	...
	$("#type6").val($("#type").val());
	$("#service_category6").val($("#service_category").val());
	$("#status6").val($("#statusout").val());
	document.getElementById('updateid').value = id;
	$('#service_categoryout').val($('#service_category').val());
...
function IneditData(id) {		
	...
	$('#service_categoryin').val($('#service_category').val());
...
function getPostData(){
	...
	var cpurl;
	if(type!='0' && $('#service_category').val()!='0'){
		if(type=='postin' ){
			cpurl='Search_Posting_In_Mns?';
			 ...
			 status=$("#statusin").val();
			 cr_by=$("#in_cr_by").val();
			 cr_date=$("#in_cr_date").val();
			
		}
		else if(type=='postout'){
			cpurl='Search_Posting_Out_Mns?';
...
function deletePostData(id){
	...
	var service_category=$('#service_category').val();			
		$.post( 'Delete_PostIN?'+ key + "=" + value,{ service_category:service_category,id:id},function(k) {
			alert(k);
			getPostData();
...
function  search_sus(sus_obj,unit_id){		
	...
	$("input#personnel_no").keyup(function() {
		...
		if($('#service_category').val()=='1'){
			perurl='getpersonnel_noListApprovedpostinMns?';
		}
...
////Personal No
	...
	$("input#inpersonnel_no").keyup(function() {
		var personel_no = this.value;
...
function RejectCancelHisData(idcan,comm_idcan){
	...
	$('#service_categoryAppcrh').val($('#service_category').val());
...
function ApprovedCancelHisData(idcan,comm_idcan){
	...
	$('#service_categoryAppach').val($('#service_category').val());
