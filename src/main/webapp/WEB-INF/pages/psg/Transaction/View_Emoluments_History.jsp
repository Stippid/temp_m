	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                    <b><label id="personnel_no" name ="personnel_no"></label></b>
	             				...
	             				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                    <b><label id="rank" name ="rank"></label></b>
		          				...
		          				<div class="col-md-6">
		          					<div class="row form-group">
										...
										<div class="col-12 col-md-8">	
										    <b><label id="name" name ="name"></label></b>
...
<br>
<div class="container-fluid" id="view_Emoluments_HistoryUrl" style="display: block;"> 	 
