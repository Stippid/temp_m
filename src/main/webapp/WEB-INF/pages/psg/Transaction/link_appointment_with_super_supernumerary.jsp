...
<form:form action="AppointmentAction?${_csrf.parameterName}=${_csrf.token}" method="post" class="form-horizontal" commandName="AppointmentCMD"> 
...
<!-- 												<option value="0">--Select--</option> -->
			            ...
			            <div class="card-footer" align="center" class="form-control">
							<a href="appointment" class="btn btn-success btn-sm">Clear</a> 
		              		<input type="submit" class="btn btn-primary btn-sm" value="Add"  onclick="return Validate();">  
				...
				<table id="appointment_search" class="table no-margin table-striped  table-hover  table-bordered report_print" width = "100%">
						<thead style="color: white;text-align: center;">
							<tr>
								...
								<th style="font-size: 15px">Appoinment</th>
...
// 			} 
	...
	function editData(id,appointment){
