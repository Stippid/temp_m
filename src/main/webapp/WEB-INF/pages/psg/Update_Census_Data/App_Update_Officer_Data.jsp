			...
			<div class="panel-group" id="accordion">
				<div class="panel panel-default" id="insp_div1">
					...
					<div class="panel-heading">
						...
						<b>APPROVE DATA OF UPDATED OFFR</b>
						</h4>
								...
								<div class="col-md-12">
										...
										<div class="row form-group">
											<div class="col-md-4">
												...
												</strong>Spouse PAN Card No</label>
											</div>
											<div class="col-md-8">
...
<form:form name="Approve_officer_Data" id="Approve_officer_Data" action="Approve_officer_DataAction?${_csrf.parameterName}=${_csrf.token}" method="post" class="form-horizontal" commandName="Approve_officer_DataCMD">
	<div class="animated fadeIn">
		<div class="card">
