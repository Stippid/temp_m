...
<script src="js/miso/orbatJs/orbatAll.js" type="text/javascript"></script>
	...
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>Search/Approve CDA Account No</h5> <h6 class="enter_by">
<!-- 	    		<span style="font-size:12px;color:red;">(To be entered by Unit)</span> -->
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="Search_CDAUrl" class="btn btn-success btn-sm" >Clear</a>  
		           ...
		           <table id="getSearch_CDA" class="table no-margin table-striped  table-hover  table-bordered report_print_scroll">
		                 <thead>
		                       <tr>
			                          ...
			                          <th style="text-align: center;"> CDA (O) A/C No</th>
			                           <c:if test="${status1 == '3'}" >
		                  ...
		                  <tbody>
			                 <c:if test="${list.size()==0}">
		                       ...
		                       <c:forEach var="item" items="${list}" varStatus="num" >
									...
									<c:if test="${status1!=1}">
									 <td style="font-size: 15px;text-align: center;" >${item[3]} ${item[4]} ${item[5]} ${item[7]} ${item[6]} </td> 
									</c:if>
...
<c:url value="Approve_Search_CDA" var="approveUrl" />
...
<c:url value="Reject_Search_CDA" var="rejectUrl" />
<form:form action="${rejectUrl}" method="post" id="rejectForm" name="rejectForm" modelAttribute="idR">
	...
	<c:url value="Edit_Search_CDA" var="editUrl"/>
...
<!-- 		<input type="hidden" name="cda_acc_no5" id="cda_acc_no5"  /> -->
</form:form>
...
<c:url value="ViewCancelHistoryCDA" var="ViewCancelHistoryCDAUrl" />
<form:form action="${ViewCancelHistoryCDAUrl}" method="post" id="ViewCancelHistoryCDAForm"
	name="ViewCancelHistoryCDAForm" modelAttribute="id" target="result">
...
function editData(id,comm_id){
	...
	if ($("#unit_name").val()!="") {
		...
		$("#unit_name5").val($("#unit_sus_no_hid").text()) ;
	
	if ($("#unit_sus_no").val()!="") {
		$("#unit_sus_no5").val($("#unit_sus_no").val()) ;
	}
	else
		$("#unit_sus_no5").val($("#unit_name_l").text()) ;
		
	$("#cda_acc_no5").val($("#cda_acc_no5").val()) ;	
