...
<script src="js/miso/orbatJs/orbatAll.js" type="text/javascript"></script>
	...
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5> SEARCH/APPROVE Seniority</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by Unit)</span></h6></div>
	              					...
	              					<div class="row form-group">
						               <div class="col-md-4">
						                ...
						                <div class="col-md-8">
						                 ...
						                 <input type="text" id="unit_sus_no" name="unit_sus_no" class="form-control autocomplete" autocomplete="off"   style="display: none" maxlength="8" onkeypress="return AvoidSpace(event)"  onkeyup="return specialcharecter(this)"> 
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="Search_SeniorityUrl" class="btn btn-success btn-sm" >Clear</a>  
		              		<input type="button" class="btn btn-info btn-sm" onclick="Search();" value="Search"> 
		              		<!-- <a href="Search_SeniorityUrl" class="btn btn-danger btn-sm" >Cancel</a>      -->
			            </div> 		
	        	</div>
			</div>
	</div>
		           ...
		           <table id="getSearch_CDA" class="table no-margin table-striped  table-hover  table-bordered report_print_scroll">
		                 <thead>
		                       <tr>
			                          ...
			                          <th style="text-align: center;"> Date of Seniority</th>
			                          <c:if test="${status1 == '3'}" >
									   ...
									   <th style="text-align: center;"> Date of Effect From</th>
		                  ...
		                  <tbody>
			                 <c:if test="${list.size()==0}">
		                       ...
		                       <c:forEach var="item" items="${list}" varStatus="num" >
									...
									<td style="font-size: 15px;text-align: center;" >${item[5]} ${item[6]} ${item[7]} ${item[8]} ${item[9]} </td>
...
<c:url value="GetSearch_Seniority" var="searchUrl" />
...
<c:url value="Approve_Search_Seniority" var="approveUrl" />
...
<c:url value="Reject_Search_Seniority" var="rejectUrl" />
...
<c:url value="Edit_Search_Seniority" var="editUrl"/>
...
<c:url value="Delete_Search_Seniority" var="deleteUrl" />
<form:form action="${deleteUrl}" method="post" id="deleteForm" name="deleteForm" modelAttribute="id1">
	<input type="hidden" name="id1" id="id1" value="0"/> 
</form:form>


<c:url value="ViewCancelHistorySeniority" var="ViewCancelHistorySeniorityUrl" />
<form:form action="${ViewCancelHistorySeniorityUrl}" method="post" id="ViewCancelHistorySeniorityForm"
	name="ViewCancelHistorySeniorityForm" modelAttribute="id" target="result">
	...
	function ViewCancelHistoryData(comm_id,status) {
		...
		window.onfocus = function () { 
			...
			if(getPersonnelNo(comm_id,'can_pers_no','','')){
				...
				document.getElementById('ViewCancelHistorySeniorityForm').submit();
			}else{
				return false;
			}
