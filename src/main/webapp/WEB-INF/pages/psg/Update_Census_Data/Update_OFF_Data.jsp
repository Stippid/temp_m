	              				...
	              				<div class="col-md-6">
									...
									<div class="col-md-6">
										<div class="row form-group">
											...
											<div class="col-md-8">
												<input type="text" id="personnel_no" name="personnel_no" class="form-control autocomplete"  maxlength="9"
													min="7" autocomplete="off"  > 						                   
							               		<input type="hidden" id="comm_id" name="comm_id" class="form-control autocomplete" autocomplete="off"  > 						                   
							                    <input type="hidden" id="census_id" name="census_id" value="0" class="form-control autocomplete" autocomplete="off">
						...
						<div class="row">
							<div class="col-md-12">	
	              				...
	              				<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label"><strong style="color: red;">* </strong> Issuing Authority (Unit/Fmn Name) </label>
						                </div>
						                <div class="col-md-8">
                                                                        ...
                                                                        <tr id="tr_awardsNmedal1">
                                                                                ...
                                                                                <td style="width: 10%;">
                                                                                  ...
                                                                                  <input type="text" id="awardsNmedal_unit1" name="awardsNmedal_unit1" class="form-control autocomplete" 
                                                                                     onkeyup="activeAndInactiveUnitData(this)" autocomplete="off" maxlength="255">
                                                                                </td>
                                                                                <td style="width: 10%;">
		 ...
		 var susNoAuto=$("#personnel_no");
		  susNoAuto.autocomplete({
		      source: function( request, response ) {
		        $.ajax({
		        	type: 'POST',
			    	url: "getpersonnel_noListApprovedWithoutMns?"+key+"="+value,
		      ...
		      change: function(event, ui) {
					 var personnelNo = document.getElementById("personnel_no").value;
					if(ui.item) {				 
						    checkPersonnelNo(personnelNo, function(response) { 
						        if (response) { 
						           if(response == "True"){
						        	   return true;
		                       }else {
						...
						if (personnelNo.length < 8) {
						    alert("Please Enter Approved Personal No");
						} else {
						    checkPersonnelNo(personnelNo, function(response) { 				    	
						    	alert(response == 'True' ? "Please Enter Approved Personal No" : response);
						   });
						}
...
function awardsNmedal_add_fn(q){
  ...
  /*  +'<td style="width: 10%;"><input type="date" id="awardsNmedal_date_of_authority'+anm+'" name="awardsNmedal_date_of_authority'+anm+'" class="form-control autocomplete" autocomplete="off" maxlength="10" min="1899-01-01" max="${date}">'
   ...
   +'<td style="width: 10%;"><input type="text" id="awardsNmedal_unit'+anm+'" name="awardsNmedal_unit'+anm+'" onkeyup="activeAndInactiveUnitData(this)" class="form-control autocomplete" autocomplete="off" maxlength="255"></td>'
             ...
             $("table#awardsNmedal_table").append('<tr id="tr_awardsNmedal'+am+'">'
                                   ...
                                   +'<td style="width: 10%;"><select name="select_desc'+am+'" id="select_desc'+am+'" class="form-control"><option value="0">--Select--</option></select>'
		                            +'<td style="width: 10%;">' 
		           					...
		           					+ '</td>'
                                   +'<td style="width: 10%;"><input type="text" id="awardsNmedal_unit'+am+'" name="awardsNmedal_unit'+am+'" value="'+j[i].unit+'" onkeyup="activeAndInactiveUnitData(this)" class="form-control autocomplete" autocomplete="off" maxlength="255"></td>'
