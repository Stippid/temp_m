...
<script>
function Cancel(){
	var personnel_no = $("#personnel_no").val().slice(0, 2);
	...
	$("#unit_sus_no1").val($("#unit_sus_noV").val()) ;
	 if(personnel_no == 'NR' || personnel_no == 'NS' ){
...
<form:form action="${searchUrl}" method="post" id="searchFormMns"
	name="searchFormMns" modelAttribute="personnel_no1">
	<input type="hidden" name="personnel_no1" id="personnel_no1" value="0" />
	<input type="hidden" name="rank1" id="rank1" value="0" />
	<input type="hidden" name="status1" id="status1" value="0" />
	<input type="hidden" name="unit_name1" id="unit_name1" />
						...
						<div class="panel-heading">
							<div class="panel-heading">
								<h4 class="panel-title main_title" id="insp_div5">
									<b>APPROVED DATA OF UPDATED OFFR</b>
								</h4>
							</div>
							<div class="col-md-12"
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label">TA Status </label>
						                </div>
						                <div class="col-md-8">
								...
								<div class="col-md-6">
	              					<div class="row form-group">
						               <div class="col-md-4">
						                    <label class=" form-control-label">Date of TA Status </label>
						                </div>
						                <div class="col-md-8">
...
function getChangeOfTnaiNo(){
	...
	<c:if test="${changeTnaiNo.size() != 0}">
				 $('#ch_tnai_id').val('${changeTnaiNo.get(0).id}');
					 $('#tnai_authority').text('${changeTnaiNo.get(0).authority}');
					 $('#tnai_date_of_authority').text(convertDateFormate('${changeTnaiNo.get(0).date_of_authority}'));					
					 $('#tnaino').text('${changeTnaiNo.get(0).tnai_no}');						
					 $('#change_in_tnaino_date').text(convertDateFormate('${changeTnaiNo.get(0).change_in_name_date}')); 				
...
function getfamily_marriageDetails(){
	 ...
	 var marital_event='${event}';
		...
		<c:if test="${Marital.size() != 0}">
			...
			$('#separated_from_dt').text(convertDateFormate( '${Marital.get(0).separated_form_dt}'));	
			...
			if('${Marital.get(0).if_spouse_ser}'=="Yes"){
				...
				$('#spouse_profession_val').val( '${Marital.get(0).spouse_profession}');
...
function getSpouseQualificationData(){
	 ...
	 var i=0;
	var  app_status=1;
	  $.post('getUpdatedSpouseQualificationData?' + key + "=" + value, {comm_id:comm_id,app_status:app_status }, function(j){
		  var v = j.length;
			if(v != 0) {
...
function get_ArmyCourse_Reject(){
	var ch_id='${census_id}'; 
	 ...
	 $.post('getArmyCourse_Reject?' + key + "=" + value, {ch_id:ch_id,comm_id:comm_id}, function(j){
