...
<form:form name="Search_Update_Off_Data" id="Search_Update_Off_Data" action="Search_Update_Off_Data_Action" method="post" class="form-horizontal" commandName="Search_Update_Off_DataMns_CMD"> 
	<div class="animated fadeIn">
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5> SEARCH/APPROVE UPDATED DATA OF MNS OFFR </h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by unit)</span></h6></div>
	            	...
	            	<div class="col-md-12">	              					
						...
						<div class="card-footer" align="center" class="form-control">
							<a href="Search_UpdateOfficerDataMnsUrl" class="btn btn-success btn-sm" >Clear</a>  
...
<c:url value="Approve_UpadteOfficerDataMnsUrl" var="ViewUrl"/>
...
<c:url value="Update_Off_DataUrl_MnsEdit" var="editUrl"/>
		 ...
		 var susNoAuto=$("#personnel_no");
		  susNoAuto.autocomplete({
		      source: function( request, response ) {
		        $.ajax({
		        	type: 'POST',
			    	url: "Search_getpersonnel_no_Mns?"+key+"="+value,
