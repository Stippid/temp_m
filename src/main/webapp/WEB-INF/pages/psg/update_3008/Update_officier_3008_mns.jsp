...
<body>
	...
	<div class="container-fluid" align="center">
						...
						<div class="panel panel-default" id="insp_div1">
							...
							<div class="panel-heading">
								<h4 class="panel-title main_title" id="insp_div5">
									<b>UPDATE DATA OF OFFR 3008 MNS
								</h4>
							</div>
							<div class="col-md-12"
							...
							<input type="hidden" id="cr_dateV" name="cr_dateV"
								class="form-control autocomplete">
										...
										<input type="hidden" id="cen_id" name="cen_id"
								class="form-control autocomplete">
													...
													<div class="row form-group">
														...
														<div class="col-md-8">
															<select name="type_of_commission_granted"
																...
																<option value="0">--Select--</option>															
																	<option value="3" name="PERMANENT">PERMANENT</option>															
															</select>
														</div>
													</div>
												</div>
							...
							<div class="panel panel-default" id="b_div1">
								<div class="panel-heading">
									<h4 class="panel-title main_title blue" id="b_div5">
										<a class="droparrow collapsed" data-toggle="collapse"
											data-parent="#accordion5" href="#" id="tn_final"
								...
								<div id="collapsetn" class="panel-collapse collapse">
									<div class="card-body card-block">
										...
										<div class="card-footer" align="center" class="form-control">
											<input type="button" class="btn btn-primary btn-sm"
												value="Save/Approve" onclick="validate_Change_of_tnaino_save_fn();">
	  ...
	  <form id="formMaritalEvent">
		<div class="card">
			<div class="panel-group" id="accordion2">
				<div class="panel panel-default" id="f_div1">
					<div class="panel-heading">
						<h4 class="panel-title main_title blue" id="f_div5">
							<a class="droparrow collapsed" data-toggle="collapse"
					...
					<!-- 	<div align="left">
						<input type="button" class="btn btn-primary btn-sm" value="View History" onclick="Pop_Up_History('marital_status');">
							...
							<div class="row"  id="withcensusdiv">

                            <div class="col-md-12" id="marr_quali_radioDiv" style="margin-top: 10px; width: 100%; margin-bottom: 16px; display:none">
...
<!-- 							 bisag v2 03072023(Observation) -->
					...
					<select name="spouse_profession" id="spouse_profession" class="form-control"   >
							...
							<div class="col-md-12" id="divorceDiv" style="display:none">				
								...
								<div class="col-md-12" id="spouse_quali_radioDiv" style="width: 100%; display: none;">
	...
	<!-- ==============================marriage detail without census ======================== -->
										<div id="withoutcensusdiv" class="row">
											<div class="col-md-12">
												<div class="col-md-6">
													<div class="row form-group">
														<div class="col-md-4">
														...
														<div class="col-md-8">
															...
															<input type="text" id="marriage_authority1"
																name="marriage_authority1"
																class="form-control autocomplete" autocomplete="off"
																onkeyup="return specialcharecter(this)" maxlength="100">
														</div>
													</div>
												...
												<div class="col-md-6">
													<div class="row form-group">
														...
														<div class="col-md-8">
															<input type="text" name="marriage_dt_of_autority"
																id="marriage_dt_of_autority" maxlength="10"
																onclick="clickclear(this, 'DD/MM/YYYY')"
																class="form-control"
																style="width: 93%; display: inline;"
																onfocus="this.style.color='#000000'"
											...
											<div class="col-md-12" id="marital_eventDiv">
												...
												<div class="col-md-6">
													<div class="row form-group">
														...
														<div class="col-md-8">
															<select name="marital_status1" id="marital_status1"
																class="form-control">
																<option value="0">--Select--</option>
												...
												<div class="col-md-6">
													<div class="row form-group">
														<div class="col-md-4">
															<label class=" form-control-label"><strong
																style="color: red;">* </strong>Marital Status Date</label>
														</div>
														<div class="col-md-8">
															<input type="text" name="marriage_dte"
																id="marriage_dte" maxlength="10"
																onclick="clickclear(this, 'DD/MM/YYYY')"
																class="form-control"
																style="width: 93%; display: inline;"
																onfocus="this.style.color='#000000'"
										...
										<!-- ============================= end marriage detail without census ======================== -->					
							</div>
								<div class="card-footer" align="center" class="form-control"> 
										<input type="button" id="mrgbtn_save" class="btn btn-primary btn-sm" value="Save/Approve" onclick="return married_save_fn();" >
										<input type="button" id="mrgqualibtn_save" class="btn btn-primary btn-sm" value="Save/Approve" onclick="return spouse_qualification_save_fn();" style="display: none">		              
							   </div>
						</div>
					</div>
				</div>
...
$(document).ready(function() {
	jQuery(function($){ 
		...
		datepicketDate('date_of_rank');
		 ...
		 datepicketDate('marriage_dt_of_autority');
		 datepicketDate('marriage_date');
		 datepicketDate('marriage_dte');
...
function validate_Change_of_tnaino_save_fn(){
	...
	formdata+="&census_id="+census_id+"&comm_id="+comm_id+"&comm_date="+comm_date+"&tnaino="+tnaino+"&change_in_tnaino_date="+change_in_tnaino_date+"&tnai_date_of_authority="+tnai_date_of_authority+"&tnai_authority="+tnai_authority;	
	   $.post('change_of_3008_tnai_action?' + key + "=" + value, formdata, function(data){		      
	          if(data=="update"){
	        	  alert("Data approved successfully");
		          window.location.reload(); 
	          }	        
...
function validate_insertSeniorityAction_save(){
    ...
    var comm_date=$('#comm_date').val();
     ...
     if ($("input#coc_date_of_seniority").val().trim()=="" || $("input#coc_date_of_seniority").val() == "DD/MM/YYYY") {
                     ...
                     $.post('coc_3008action_mns?' + key + "=" + value, {authority:authority,date_of_authority:date_of_authority,persnl_no1:persnl_no1,persnl_no2:persnl_no2,persnl_no3:persnl_no3,
...
function married_save_fn (){
	var p_id=$('#cen_id').val();
	if(p_id>0){
		married_save_fn_withcensus();
	}else {
		married_save_fn_withoutcensus();
	}
...
function married_save_fn_withoutcensus(){
	  var marriage_authority1=$('#marriage_authority1').val();
	  var marriage_dt_of_autority=$('#marriage_dt_of_autority').val();
	   var marital_status1=$('#marital_status1').val();
	   var marriage_dte=$('#marriage_dte').val();
		var comm_id=$('#comm_id').val();
		var formdata=$('#formMaritalEvent').serialize();
	  if (marriage_authority1 == null || marriage_authority1.trim()=="") {
	         alert("Please Enter Authority");
	         $('#marriage_authority').focus()
	         return false;
		   }
	  
	  if (marriage_dt_of_autority == null || marriage_dt_of_autority.trim()=="") {
	         alert("Please Enter Date of Authority");
	         $('#marriage_dt_of_autority').focus()
	         return false;
		   }
	  ...
	  if (marital_status1 == null || marital_status1.trim()=="" || marital_status1.trim()== 0) {
	         alert("Please Enter Marital Status");
	         $('#marital_status').focus()
	         return false;
		   }
	  
	  if (marriage_dte == null || marriage_dte.trim()=="") {
		...
		formdata+="&comm_id="+comm_id+"&marriage_authority1="+marriage_authority1+"&marriage_dt_of_autority="+marriage_dt_of_autority+"&marital_status1="+marital_status1+"&marriage_dte="+marriage_dte;	
		   $.post('marriage_withoutcensus_3008mns_Action?' + key + "=" + value, formdata, function(data){		      
		          if(data=="update"){
		        	  alert("Data approved successfully");
			          window.location.reload(); 
		          }	        
...
function married_save_fn_withcensus(){
	debugger;
...
// bisag v2 03072023(Observation)
 ...
 if(marital_event=='4'){
  ...
  $.post('save_approve_family_marriage_action?' + key + "=" + value, {separated_to_dt:separated_to_dt,separated_from_dt:separated_from_dt,curr_marital_status:curr_marital_status,maiden_name:maiden_name,marriage_date_of_birth:marriage_date_of_birth,
