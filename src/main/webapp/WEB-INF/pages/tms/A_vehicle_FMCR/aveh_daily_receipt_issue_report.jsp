...
<form:form id="dailyReceiptIssueReport" name="dailyReceiptIssueReport" action="#" method='POST' commandName="#">
  <div class="animated fadeIn">
	   	<div class="container" align="center">
	   		<div class="card">
	   			<div class="card-header"><h5>A VEHICLE DAILY RECEIPT / ISSUE REPORT</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by Depot)</span></h6></div>
	   		      <div class="card-header"><strong>Receipt / Issue</strong></div> 
	   		                 ...
	   		                 <div class="row form-group">		   		             
										<div class="col col-md-12">
												<div class="form-check-inline form-check" style="display: inline-block; width: 700px;">
								                     ...
								                     <label for="inline-radio2" class="form-check-label ">
								                              <input type="radio" id="inline-radios" name="inline-radios" value="4" class="form-check-input" onclick="ClearField();">War Trophy 
								                     </label>
								                </div>
										 </div> 
	   		                 </div>
	 ...
	 <div class="col-md-6">
		<div class="row form-group" style="padding-top: 10px;">
			...
			<div class="col-12 col-md-8">
				...
				<input type="text" id="drr_dir_ser_no" name="drr_dir_ser_no" placeholder="" class="form-control autocomplete" autocomplete="off" style="width: 70%" maxlength="50">				</div>
		</div>
	</div>
	<div class="col-md-6">
	 ...
	 <div class="col-md-6">
	  ...
	  <div class="col-md-6">
            <div class="row form-group">
                ...
                <div class="col-md-8">
                  	<input type="text" id="date_report" name="date_report" placeholder="" class="form-control" readonly="readonly">
                </div>
            </div> 
       </div>
  </div>
...
<div class="card-body card-block">
            	...
            	<div class="col-md-6">
            		<div class="row form-group">
			                			...
			                			<textarea id="unit_sus_name" name="unit_sus_name" placeholder="" class="form-control autocomplete" style="font-size: 11px;" autocomplete="off" readonly="readonly" maxlength="100"></textarea>
			                  				<!-- <input type="text" id="unit_sus_name" name="unit_sus_name" placeholder="" class="form-control autocomplete" autocomplete="off" readonly="readonly"> -->
			                			</div>
			          </div>            			
	         	</div>
		</div>
		...
		<div class="col-md-12">
            ...
            <div class="col-md-6">
            		<div class="row form-group">
               			...
               			<div class="col-12 col-md-8">
                 				<input type="text" id="chassis_no" name="chassis_no" placeholder="" class="form-control" readonly="readonly">
               			</div>
             			</div>		           
	          		</div>
		</div>
		...
		<div class="col-md-12">
	          <div class="col-md-6">
	                <div class="row form-group">
               					...
               					<div class="col-12 col-md-8">
                 						<input type="text" id="engine_no" name="engine_no" placeholder="" class="form-control autocomplete" autocomplete="off" readonly="readonly">
               					</div>
             				</div>	          
	          	</div>
		...
		<div class="col-md-12">
	          <div class="col-md-6">
	                 <div class="row form-group">
                			...
                			<div class="col-12 col-md-8">
                  				<input type="text" id="mct_no" name="mct_no" placeholder="" class="form-control" readonly="readonly">
                			</div>
              			</div> 			              				          
	          	</div>
            ...
            <div class="col-md-6">
            	<div class="row form-group">
            				...
            				<div class="col-12 col-md-8">
            					<textarea id="std_nomenclature" name="std_nomenclature" placeholder="" class="form-control autocomplete" style="font-size: 11px;" readonly="readonly"></textarea>
            				</div>
          				</div>	
		...
		<div class="col-md-12">
	          <div class="col-md-6">
	               <div class="row form-group" >
									<div class="col col-md-4">
	                  					<label class=" form-control-label"><strong style="color: red;">* </strong>Classification </label>
	                				</div>
	                				<div class="col-12 col-md-8">
...
<div class="form-control card-footer" align="right">
    <input type="hidden" id="count" name="count">
    <a class="btn btn-success" id=addVehAReceiptDetails >Save</a>
</div>
            	<div class="card-body card-block" style="overflow: auto; display: none;" id="aveh">
			              	...
			              	<table class="table no-margin table-striped  table-hover  table-bordered report_print" id="add_reports">
				                <thead>
				                  <tr>
				                    ...
				                    <th style="display:none;">MCT No</th>
				...
				<div  class="form-control card-footer" align="center" >
					   <a href="aveh_daily_receipt_issue_report" type="reset" class="btn btn-success btn-sm">  Clear </a>
					   <input type="hidden" id="count" value="0" name="count">
				    	<input type="reset" class="btn btn-primary btn-sm" value="Reload" id="clear" onclick="reloadPage();">					   
					 </div>			    
	   		</div>
	   	</div>
   </div>
		      ...
		      select: function( event, ui ) {
		    	  var target_unit_name = ui.item.value;
					...
					$.post("getTargetSUSFromUNITNAME?"+key+"="+value, {
						target_unit_name:ui.item.value
					}).done(function(j) {
						if(j == ""){
			    	 		alert("Please Enter Approved Unit Name.");
				        	document.getElementById("sus_no").value="";
...
$.fn.BaDetailsList = function(ba_no,a) {
   $.post("getBaDetailsList?"+key+"="+value, {ba_no : ba_no}).done(function(j) {
	...
	if(a == 4){
		$.post("getACensuscase6KmList?"+key+"="+value, {ba_no : ba_no}).done(function(k) {
			for (var l = 0; l < k.length; l++) {
				$("#kms_run").val(k[l]);
			}
		}).fail(function(xhr, textStatus, errorThrown) {
...
$(function() {
	$("input[type='radio']").click(function() {
		...
		if (a == 1) {
			...
			$("#cl option[value='1']").attr("disabled",false);
...
$(document).ready(function() {
	...
	document.getElementById("date_report").value = date;
	$('#cl').attr("disabled", true);
	
	var max_fields  = 100; //maximum input boxes allowed
	var x = 0; //initlal text box count
	
	$("#addVehAReceiptDetails").click(function(){
		...
		var data = validate();
    		...
    		if(a != "" && parseInt(drr_len) > parseInt(9) && sus_no != "" && ba_no != "" && authority != "" && data == true){	
			$.ajax({
		        type: 'POST',
		        url: "addVehADailyReceiveIssueReport?"+key+"="+value,
		        data: {drr_dir_ser_no:drr_dir_ser_no, sus_no:sus_no, unit_name:unit_name, a:a, issue_against_rio:issue_against_rio, other_agency:other_agency, unit_sus_no:unit_sus_no,unit_sus_name:unit_sus_name, ba_no:ba_no, kms_run:kms_run, cl:cl, remarks:remarks, authority:authority,issue_type:issue_type},
		        success: function(response) {
		        	if(response == "Failure dtl"){
		        		alert("Data Already Exists.");
		        	}else if(response == "Success")
		        	{
		        		document.getElementById('aveh').style.display='block';
		        		...
		        		if(a == 1){
		        			...
		        			var aa = "Issued To Unit";
		        			var bb = unit_sus_no;
		        			$('#cl').prop('selectedIndex',1);
		        		}else if(a == 3){
		        			var aa = "Received from Unit";
		        			var bb = unit_sus_no;
