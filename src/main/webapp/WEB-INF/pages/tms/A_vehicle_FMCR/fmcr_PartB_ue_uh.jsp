	...
	<div class="animated fadeIn" id="printableArea">
		<div class="row">
	    	<div class="col-md-12" align="center">
	    		<div class="card">
	    			<div class="card-header"> <strong style="text-decoration: underline;"> RESTRICTED</strong> </div>
	    			<div class="card-header">  
	       				...
	       				<tbody style="overflow: hidden;">
		   					<tr>
		   						...
		   						<td align="center">
		   							<h5>FOUR MONTHLY CENSUS RETURN : PART B</h5>
		   						</td>
		   						<td align="right">
			...
			<div class="row">
				<div class="col-md-12" align="center">
	    			<div  class="watermarked" data-watermark="" id="divwatermark" >
						<span id="ip"></span>
						<table id="getpartBReportMcr" class="table no-margin table-striped  table-hover  table-bordered report_print">
							<thead>
								<tr>
							        <th rowspan="2" style="text-align: center;width:5%;">Ser No</th>
							        <th rowspan="2" style="text-align: center;width:10%;">MCT</th>
								...
								<tr>
							        ...
							        <th style=" text-align: center;width:5%;">TRG</th>
							        <th style=" text-align: center;width:5%;">WWR</th>
							       <!--  KAJAL DATA 1 -->
							      <th style=" text-align: center;width:5%;">ON LOAN</th>
							        <th style=" text-align: center;width:5%;">SECTOR</th>
							    </tr>
							</thead>
						<tbody>
							<c:if test="${list.size() == 0}" >
								...
								<c:forEach items="${getdetails_ue_uhMvcr}" var="list"  varStatus="num" >
									<tr>
									    <td style="text-align: center;;width:5%;">${num.index+1}</td> 
									   <td style="text-align: center;width:10%;">${list[0]}</td>
									   <td style="text-align: left;width:40%;">${list[1]}</td>
									   <td style="text-align: center;width:5%;">${list[2]}</td>
										<td style="text-align: center;width:5%;">${list[3]}</td>										
										<td style="text-align: center;width:5%;">${list[4]}</td>	
										<td style="text-align: center;width:5%;">${list[5]}</td>
										<td style="text-align: center;width:5%;">${list[9]}</td>	
										<td style="text-align: center;width:5%;">${list[10]}</td>
										<td style="text-align: center;width:5%;">${list[6]}</td>	
									
										<td style="text-align: center;width:5%;">${list[7]}</td>
										<td style="text-align: center;width:5%;">${list[8]}</td>	
									</tr>
									
						</c:forEach>						
								<tr>
									<td colspan="3" style="width:55%;text-align: center;"><B>TOTAL</B></td>
									<td align="center" style="width: 5%;"><B>${totalUE}</B></td>
									<td align="center" style="width: 5%;"><B>${totalOPUH}</B></td>
									<td align="center" style="width: 5%;"><B>${totalTRGUH}</B></td>
									<td align="center" style="width: 5%;"><B>${totalWWRUH}</B></td>
									<td align="center" style="width: 5%;"><B>${totalloan}</B></td>
									<td align="center" style="width: 5%;"><B>${totalsector}</B></td>
