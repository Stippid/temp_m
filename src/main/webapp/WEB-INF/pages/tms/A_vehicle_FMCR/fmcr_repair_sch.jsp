				...
				<div class="card">
					...
					<div class="card-body">
						...
						<tbody style="overflow: hidden;">
								...
								<tr style="font-size: 14px;">
									<td style="width: 25%;padding-left: 5%;"><label style="margin-right: 15px;" for="text-input" class=" form-control-label">Status </label></td>
		...
		<div class="row animated fadeIn" >
			<div class="col-md-12" align="center">
					<div  class="watermarked" data-watermark="" id="divwatermark" >
						<span id="ip"></span>
					<table id="getpartAReportMcr" class="table no-margin table-striped  table-hover  table-bordered report_print">
						<thead  style="text-align: center;">
							<tr>
								...
								<th colspan="3">OH-1</th>
								<th colspan="2">MR-2</th>
								<th colspan="3">OH-2</th>
						...
						<tbody>
							<c:if test="${list.size() == 0}" >
								...
								<c:forEach items="${RepairReport}" var="list"  varStatus="num" >
									<tr>
