...
<div class="animated fadeIn">
		...
		<div class="container" align="center">
			<div class="card">
				 	<div class="card-header"><h5>FOUR MONTHLY CENSUS RETURN</h5> <h6 class="enter_by"><span style="font-size:12px;color:red;">(To be entered by Unit)</span></h6></div> 
				<div class="card-body">
					<div class="col-md-12">
                         <div class="col-md-6">
...
<c:url value="getMCRReportList" var="searchUrl" />
...
<c:url value="getMCRReport" var="getMCRReportUrl" />
