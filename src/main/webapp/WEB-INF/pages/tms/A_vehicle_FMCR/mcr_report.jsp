...
<div class="animated fadeIn">
	<div class="">
		<div class="container" align="center">
			<div class="card">
				<div class="card-header"
					...
					<h5>Four Monthly Census Return</h5>
				</div>
				<div class="card-body">
					<div class="col-md-12">
						<div class="col-md-6">
							...
							<div class="row form-group">
								...
								<div class="col-12 col-md-6">
									<textarea id="unit_name" name="unit_name"
										...
										autocomplete="off" value="${unit_name}" disabled="disabled"></textarea>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="container-fluid" style="padding: 0; text-align: center;">
			<div id="reportshow1" style="width: 80%; display: inline-block;">
				<table id="SearchMCRReport"
					class="table no-margin table-striped  table-hover  table-bordered report_print">
					<thead>
						<tr class="card-header" style="background-color: #f0f3f5;">
							<th colspan="4" style="color: #4e5154;"><br>
								...
								<div class="col-md-12">
									...
									<div class="row form-group">
										...
										<option value="14">Report Issues</option>
											...
											<select id="report_obsn" name="report_obsn"
												...
												<c:forEach var="item" items="${GetHelpTopic}"
													varStatus="num">
									...
									<%-- 							</c:if> --%>
								</div> Document Upload :<span style="color: red;">(*.zip or
									*.rar Only)</span>
								<form method="POST" enctype="multipart/form-data"
									id="fileUploadForm">
									<input type="hidden" id="sus" name="sus" value="${sus_no}" /> <input
										type="file" id="uploadMvcr" name="uploadMvcr"
										title="MVCR Upload .ZIP only" /> <br> <br> <input
										type="submit" class="btn btn-primary btn-sm" value="Upload"
										id="btnSubmit"> &emsp; <a hreF="#"
										data-target='#rejectModal' data-toggle='modal'
										onclick="getDownloadImageMCR()" class="btn btn-primary btn-sm">Download</a>
								</form></th>
								
							<th colspan="3">
								<form method="POST" enctype="multipart/form-data"
									id="exportExcelData" name="exportExcelData"
									action="exportTMSExcelAction?${_csrf.parameterName}=${_csrf.token}">
									<label style="color: #000000;">Download data in Excel:</label>
									<a href="#" title="Download Uploaded Documents"
										onclick="getExcel();"> <i
										class="action_icons action_download"></i></a> <br> <label
										style="color: #000000;">Upload Excel:</label> <input
										type="file" id="file_browser" name="file_browser"
										accept="application/vnd.ms-excel, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
										class="form-control-sm form-control" /> <input type="hidden"
										id="count" name="count"> <input type="hidden"
										id="countrow" name="countrow"> 
										<input type="hidden"  id="sus_no3" name="sus_no3" value="${sus_no}">
										<input type="hidden"  id="numberOfColumns" name="numberOfColumns">
										<input type="hidden"
										id="table_name" name="table_name" value="tb_tms_census_retrn">
							...
							<th colspan="4">
								...
								<form method="POST" enctype="multipart/form-data"
									style="display: none;" id="exportExcelData"
									...
									<a href="#" title="Download Uploaded Documents"
										...
										class="form-control-sm form-control" /> <input type="hidden"
										id="count" name="count"> <input type="hidden"
										id="countrow" name="countrow"> <input type="hidden"
										id="table_name" name="table_name" value="tb_tms_census_retrn">
									<input type="submit" class="btn btn-success btn-sm"
										value="Submit" onclick="return validate()">
									<div class="card-body card-block">
							...
							<th colspan="2" style="color: #4e5154;">Total : <label
								id="totalVeh">${TOTAL}</label> <%-- 									<form method="POST" enctype="multipart/form-data" id="fileUploadForm"> --%>

							</th>
							<th colspan="2" style="color: #4e5154;">Updated : <label
								id="totalUp">${UPDATE}</label></th>
							<th colspan="2" style="color: #4e5154;">Not Updated : <label
								id="totalNUp">${NotUpdated}</label></th>
						</tr>
						</thead>
						<thead>
						<tr>
							<th style="text-align: center;">Ser No</th>
							<th style="text-align: center;">Veh BA No</th>
							<th style="text-align: center;">Description</th>
							<th style="text-align: center;">Cl</th>
							<th style="text-align: center;">Total Km Run</th>
							<th style="text-align: center;">Engine Type</th>
							<th style="text-align: center;">Aux Type</th>
							<th style="text-align: center;">Main Gun Type</th>
							<th style="text-align: center;">Section Gun Type</th>
							<th style="text-align: center;">Main Radio Set</th>
				...
				<div align="center">
					<a href="mcr" class="btn btn-success btn-sm">Back</a>
				</div>
			</div>
		</div>
...
<c:url value="Viewmcr" var="viewmcrurl" />
<form:form action="${viewmcrurl}" method="post" id="editForm"
