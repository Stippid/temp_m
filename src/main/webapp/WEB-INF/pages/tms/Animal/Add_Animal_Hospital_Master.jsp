...
<form:form name="Add_Hospital" id="Add_Hospital" action="Add_Hospital_Act?${_csrf.parameterName}=${_csrf.token}" method='POST' commandName="Add_Hospital_Cmd" enctype="multipart/form-data">
	<div class="container" align="center">
		<div class="card">
		    <div class="card-header">
				<strong><h3>ANIMAL HOSPITAL MASTER</h3></strong>
				<strong><label for="text-input" id="lbladd" name="lbladd" class=" form-control-label"></label> HOSPITAL </strong>
			</div>
					...
					<div class="col-md-6">
						<div class="row form-group">
							<div class="col col-md-4">
								<label class=" form-control-label"><strong style="color: red;">*</strong> Enter Hospital</label>
							</div>
							<div class="col-12 col-md-8">
								<input id="type_hospital" name="type_hospital" class="form-control" autocomplete="off" maxlength="50" value="${type_hospital1}" oninput="this.value = this.value.toUpperCase()"> 
			...
			<div class="form-control card-footer" align="center">
				...
				<a href="Animal_Hospital_Master" type="reset" class="btn btn-success btn-sm"> Clear </a> 
	      ...
	      <div  class="watermarked" data-watermark="" id="divwatermark" style="display: block;">
			...
			<thead style="background-color: #9c27b0; color: white; text-align: center;">
				<tr>
					...
					<th width="70%" >Name of Hospital</th>
			...
			<tbody >
				...
				<c:forEach var="item" items="${list}" varStatus="num" >
						<tr>
							...
							<td width="70%">${item.type_hospital}</td>
...
<Script>
	$(document).ready(function() {
	 ...
	 function editData(id,hospital) {
		document.getElementById('lbladd').innerHTML = "UPDATE";
		$("#id").val(id);
		$("#type_hospital").val(hospital);
                ...
                $.post("deleteHospital?"+key+"="+value, {
                    ...
                    if (anml_type == undefined){
                		alert("Please Select Animal Type");
              			 ...
              			 $("#type_hospital1").val($("#type_hospital").val()); 
 ...
 function Validate() { 
		if ($("input#type_hospital").val() == "") {
			alert("Please Enter Hospital");
			$("input#type_hospital").focus();
			return false;
		}
	} 
    ...
    <c:url value="search_hospital_master1" var="searchUrl" />
		<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="anml_type3">
			<input type="hidden" name="type_hospital1" id="type_hospital1" value="0"/>
...
$(document).ready(function() {
	...
	$("#type_hospital").val('${type_hospital1}');
