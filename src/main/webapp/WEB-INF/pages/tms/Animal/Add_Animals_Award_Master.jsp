...
<form:form name="Add_Award" id="Add_Award" action="Add_Award_Act?${_csrf.parameterName}=${_csrf.token}" method='POST' commandName="Add_Award_Cmd" enctype="multipart/form-data">
	<div class="container" align="center">
		<div class="card">
		    <div class="card-header">
				<strong><h3>AWARD MASTER</h3></strong>
				<strong><label for="text-input" id="lbladd" name="lbladd" class=" form-control-label"></label> AWARD </strong>
			</div>
					...
					<div class="col-md-6">
						<div class="row form-group">
							<div class="col col-md-4">
								<label class=" form-control-label"><strong style="color: red;">*</strong> Type of Award</label>
							</div>
							<div class="col-12 col-md-8">
								<input id="award_type" name="award_type" class="form-control" autocomplete="off" maxlength="50" value="${award_type1}" oninput="this.value = this.value.toUpperCase()"> 
			...
			<div class="form-control card-footer" align="center">
				...
				<a href="Animal_Award_Master" type="reset" class="btn btn-success btn-sm"> Clear </a> 
			...
			<tbody >
				...
				<c:forEach var="item" items="${list}" varStatus="num" >
						<tr>
							...
							<td width="70%">${item.award_type}</td>
...
<Script>
                ...
                $.post("deleteAward?"+key+"="+value, {
                    ...
                    if (anml_type == undefined){
                		alert("Please Select Animal Type");
              			 ...
              			 $("#award_type1").val($("#award_type").val()); 
 ...
 function Validate() { 
		if ($("input#award_type").val() == "") {
			alert("Please Enter type of award");
			$("input#award_type").focus();
			return false;
		}
	} 
    ...
    <c:url value="search_award_master1" var="searchUrl" />
		<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="anml_type3">
			<input type="hidden" name="award_type1" id="award_type1" value="0"/>
