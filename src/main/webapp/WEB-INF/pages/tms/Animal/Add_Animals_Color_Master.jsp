...
<form:form name="Add_Animals_Color_Master" id="Add_Animals_Color_Master" action="Add_Color_Act?${_csrf.parameterName}=${_csrf.token}" method='POST' commandName="editanimal_masterCmd" enctype="multipart/form-data">
	<div class="container" align="center">
		<div class="card">
			<div class="card-header">
				<strong><h3>COLOR MASTER</h3></strong>
				<strong><label for="text-input" id="lbladd" name="lbladd" class=" form-control-label"></label> COLOR </strong>
			</div>
					...
					<div class="col-md-6">
						<div class="row form-group">
							<div class="col col-md-4">
								<label class=" form-control-label"><strong style="color: red;">*</strong> Type of Color</label>
							</div>
							<div class="col-12 col-md-8">
								<input id="type_color" name="type_color" class="form-control" autocomplete="off" maxlength="30" value="${type_color1}" oninput="this.value = this.value.toUpperCase()"> 
			...
			<div class="form-control card-footer" align="center">
				...
				<a href="Animal_Colour_Master" type="reset" class="btn btn-success btn-sm"> Clear </a> 
...
<div class="container" id="getAnimalColorSearch2" style=" display: none; "  >
		 <div id="divShow" style="display: block;">
</div>

<div class="watermarked" data-watermark="" id="divwatermark" style="display: block;">
	<span id="ip"></span>
		<table id="getAnimalColorSearch" class="table no-margin table-striped  table-hover  table-bordered report_print">
			<thead style="background-color: #9c27b0; color: white; text-align: center;">
				<tr>
					<th width="10%">Ser No</th>
					<th width="70%">Type of Color</th>
			...
			<tbody >
				...
				<c:forEach var="item" items="${list}" varStatus="num" >
						<tr>
							...
							<td width="70%">${item.type_color}</td>
...
<Script>
	...
	function editData(id,color) {
		document.getElementById('lbladd').innerHTML = "UPDATE";
		$("#id").val(id);
		$("#type_color").val(color);
	...
	function deleteData(id) {
                ...
                $.post("deleteColor?"+key+"="+value, { id : id  }, function(data) {
                    ...
                    if (anml_type == undefined){
                		alert("Please Select Animal Type");
              			 ...
              			 $("#type_color1").val($("#type_color").val());
...
function Validate() {
		if ($("input#type_color").val() == "") {
			alert("Please Enter Type of Color");
			$("input#type_color").focus();
			return false;
		}
	}
   ...
   <c:url value="search_color_master1" var="searchUrl" />
		<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="anml_type3">
			<input type="hidden" name="type_color1" id="type_color1" value="0"/>
...
$(document).ready(function() {
	...
	$("#type_color").val('${type_color1}');
	$("div#divwatermark").val('').addClass('watermarked');								
	watermarkreport(); 

	 if('${anml_type3}' == "Army Dog")
		{
			$("#getAnimalColorSearch2").show();
