...
<script src="js/cue/printAllPages.js" type="text/javascript"></script>
	...
	<form:form name="Add_Animals_Source_Master" id="Add_Animals_Source_Master" action="Add_Source_Act?${_csrf.parameterName}=${_csrf.token}" method='POST' commandName="editanimal_masterCmd" enctype="multipart/form-data">
		<div class="container" align="center">
			<div class="card">
				<div class="card-header">
					<strong><h3>SOURCE MASTER</h3></strong>
					<strong><label for="text-input" id="lbladd" name="lbladd" class=" form-control-label"></label> SOURCE </strong>
				</div>
						...
						<div class="col-md-6">
							<div class="row form-group">
								<div class="col col-md-4">
									<label class=" form-control-label"><strong style="color: red;">*</strong> Type of Source</label>
								</div>
								<div class="col-12 col-md-8">
									<input id="source" name="source" class="form-control" autocomplete="off" maxlength="50" value="${source1}" oninput="this.value = this.value.toUpperCase()">
				...
				<div class="form-control card-footer" align="center">
					...
					<a href="Animal_Source_Master" type="reset" class="btn btn-success btn-sm"> Clear </a> 
	...
	<div class="container" id="getAnimalSourceSearch2" style=" display: none; "  >
		 <div id="divShow" style="display: block;">
		 </div>
	
	<div class="watermarked" data-watermark="" id="divwatermark" style="display: block;">
		<span id="ip"></span>
			<table id="getAnimalSourceSearch" class="table no-margin table-striped  table-hover  table-bordered report_print">
				<thead style="background-color: #9c27b0; color: white; text-align: center;">
					<tr>
						<th width="10%">Ser No</th>
						<th width="70%">Type of Source</th>
	...
	<Script>
		...
		function Validate() {
			if ($("input#source").val() == "") {
				alert("Please Enter Type of Source");
				$("input#source").focus();
				return false;
			}
		}
	   ...
	   <c:url value="search_source_master1" var="searchUrl" />
		<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="anml_type3">
			<input type="hidden" name="source1" id="source1" value="0"/>
