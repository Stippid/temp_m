...
<form:form name="Add_Employment" id="Add_Employment" action="Add_Employment_Act?${_csrf.parameterName}=${_csrf.token}" method='POST' commandName="Add_Employment_Cmd" enctype="multipart/form-data">
	<div class="container" align="center">
		<div class="card">
		    <div class="card-header">
				<strong><h3>EMPLOYMENT MASTER</h3></strong>
				<strong><label for="text-input" id="lbladd" name="lbladd" class=" form-control-label"></label> EMP TYPE </strong>
			</div>
					...
					<div class="col-md-6">
						<div class="row form-group">
							<div class="col col-md-4">
								<label class=" form-control-label"><strong style="color: red;">*</strong>Type Of Employment </label>
							</div>
							<div class="col-12 col-md-8">
								<input id=emp_type name="emp_type" class="form-control" autocomplete="off" maxlength="50" value="${emp_type1}" oninput="this.value = this.value.toUpperCase()"> 
			...
			<div class="form-control card-footer" align="center">
				...
				<a href="Animal_Employment_Master" type="reset" class="btn btn-success btn-sm"> Clear </a> 
	      ...
	      <div  class="watermarked" data-watermark="" id="divwatermark" style="display: block;">
			...
			<thead style="background-color: #9c27b0; color: white; text-align: center;">
				<tr>
					...
					<th width="25%" >Type of Animal</th>
					<th width="45%" >Type of Employment</th>
			...
			<tbody >
				...
				<c:forEach var="item" items="${list}" varStatus="num" >
						<tr>
							...
							<th width="25%" >${item.anml_type}</th> 
							<td width="45%">${item.emp_type}</td>
...
<Script>
	...
	function deleteData(id) {
                $.post("deleteEmployment?"+key+"="+value, {
                    id : id
            }, function(data) {
                    //        alert(data);
 ...
 function Validate() { 
		if ($("input#emp_type").val() == "") {
			alert("Please Enter Employment");
			$("input#emp_type").focus();
			return false;
		}
    ...
    <c:url value="search_employment_master1" var="searchUrl" />
		<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="anml_type3">
			<input type="hidden" name="emp_type1" id="emp_type1" value="0"/>
