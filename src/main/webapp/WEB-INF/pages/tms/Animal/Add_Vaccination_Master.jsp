...
<form:form name="Add_Vaccine" id="Add_Vaccine" action="Add_Vaccine_Act?${_csrf.parameterName}=${_csrf.token}" method='POST' commandName="Add_Vaccine_Cmd" enctype="multipart/form-data">
	<div class="container" align="center">
		<div class="card">
		    <div class="card-header">
				<strong><h3>VACCINE MASTER</h3></strong>
				<strong><label for="text-input" id="lbladd" name="lbladd" class=" form-control-label"></label> VACCINE </strong>
			</div>
			...
			<div class="card-body card-block">
				...
				<div class="col-md-12">
					<div class="col-md-6">
						<div class="row form-group">
							<div class="col col-md-4">
								<label class=" form-control-label"><strong style="color: red;">*</strong> Vaccine</label>
							</div>
							<div class="col-12 col-md-8">
								<input id=vaccine_name name="vaccine_name" class="form-control" autocomplete="off" maxlength="50" value="${vaccine_name1}" oninput="this.value = this.value.toUpperCase()"> 
					...
					<div class="col-md-6">
						<div class="row form-group">
							<div class="col col-md-4">
								<label class=" form-control-label"><strong style="color: red;">*</strong> Frequency</label>
							</div>
							<div class="col-12 col-md-8">
								<input id=frequency name="frequency" class="form-control" autocomplete="off" maxlength="100" value="${frequency1}" oninput="this.value = this.value.replace(/[^0-9]/g, '');"> 
							</div>
						</div>
					</div>
				</div>
			...
			<div class="form-control card-footer" align="center">
				...
				<a href="Animal_Vaccine_Master" type="reset" class="btn btn-success btn-sm"> Clear </a> 
	      ...
	      <div  class="watermarked" data-watermark="" id="divwatermark" style="display: block;">
			...
			<thead style="background-color: #9c27b0; color: white; text-align: center;">
				<tr>
					...
					<th width="15%" >Type of Animal</th>
					<th width="40%" >Type of Vaccine</th>
			...
			<tbody >
				...
				<c:forEach var="item" items="${list}" varStatus="num" >
						<tr>
							...
							<th width="15%" >${item.anml_type}</th> 
							<td width="40%">${item.vaccine_name}</td>
							<td width="15%">${item.frequency}</td>
...
<Script>
	$(document).ready(function() {
	 ...
	 function editData(id,vaccine_name,frequency) {
                ...
                $.post("deleteVaccine?"+key+"="+value, {
                    ...
                    if (anml_type == undefined){
                		alert("Please Select Animal Type");
              			 ...
              			 $("#vaccine_name1").val($("#vaccine_name").val());
              			 $("#frequency1").val($("#frequency").val());
 ...
 function Validate() { 
		if ($("input#vaccine_name").val() == "") {
			alert("Please Enter Vaccine");
			$("input#vaccine_name").focus();
			return false;
		}
    ...
    <c:url value="search_vaccine_master1" var="searchUrl" />
		<form:form action="${searchUrl}" method="post" id="searchForm" name="searchForm" modelAttribute="anml_type3">
			<input type="hidden" name="vaccine_name1" id="vaccine_name1" value="0"/>
			<input type="hidden" name="anml_type3" id="anml_type3" value="0"/>
			<input type="hidden" name="frequency1" id="frequency1" value="0"/>
		</form:form> 
...
$(document).ready(function() {
	...
	$("#vaccine_name").val('${vaccine_name1}');
