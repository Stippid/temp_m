...
<form:form name="#" id="#" action="ConvertRequestGstosplVehDTLAction?${_csrf.parameterName}=${_csrf.token}" method='POST' commandName="ConvertRequestGstosplVehInsertDTLCMD" enctype="multipart/form-data">
		...
		<div class="">
			<div class="container" align="center">
				<div class="card">
					...
					<div id="lblh">
						<div class="card-header">
							<strong><h3>MONTHLY STRENGTH RETURN ANIMALS MONTH OF <label for="text-input" id="lbladd" name="lbladd" class=" form-control-label"></label> </h3></strong>
						</div>
					</div>
					...
					<div class="form-control card-footer" align="center">
						...
						<a href="Animal_Equines" type="reset" class="btn btn-success btn-sm"> Clear </a> 
						<input type="button" class="btn btn-primary btn-sm" value="Print" id="printId" onclick="printDiv();" disabled>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container" id="divPrint">
		...
		<div class="watermarked" data-watermark="" id="divwatermark" style="display: block;">
			<span id="ip"></span>
			<table id="getSearchReportanimalequinestbl" class="table no-margin table-striped  table-hover  table-bordered report_print" style="display: none;">
				<thead style="background-color: #9c27b0; color: white; text-align: center;">
					<tr>
						<th width="10%">Ser No</th>
						<th width="40%">Type of Animal</th>
						<th width="10%">UE</th>
						<th width="10%">UH</th>
						<th width="10%">Sur</th>
						<th width="10%">Defi</th>
...
<script>
	function printDiv() {
		...
		var printVal = [ document.getElementById('sus_no').value,
						document.getElementById('from_date').value,
						document.getElementById('unit_file_def').value,
						document.getElementById('fmn').value,
						document.getElementById('re_date').value ];
...
<Script>
	$(document).ready(function() {
				...
				if ('${sus_no1}' != "") {
					$("#getSearchReportanimalequinestbl").show();
					$("#sus_no").val('${sus_no1}');
...
<c:url value="equ_ue_uh" var="searchUrl" />
