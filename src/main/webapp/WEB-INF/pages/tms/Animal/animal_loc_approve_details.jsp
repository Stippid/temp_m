						...
						<div class="col-md-5">
							<div class="row form-group">
								...
								<div class="col-12 col-md-8">
									<label id="remount_no">${remount_no}</label>
								</div>
	...
	<div class="col-md-12" style="overflow: auto;">
				<div class="col-md-12" id="divPrint" style="display:">
					<div id="divShow" style="display: block;"></div>
					<div class="watermarked" data-watermark="" id="divwatermark" style="display: block;">
						<span id="ip"></span>
						<table id="SearchAnimalReaportequ" class="table no-margin table-striped  table-hover  table-bordered report_print">
							<thead style="background-color: #9c27b0; color: white; text-align: center;">
								<tr>
									<th width="5%">Ser No</th>
									<th width="8%">Remount No</th>
									<th width="15%">Unit Name</th>
									<th width="8%">Microchip No</th>
									<th width="5%">Sex</th>
									<th width="5%">Age</th>
									<th width="20%">Type of Equines</th>
									<th width="13%">Medal Details</th>
									<th width="5%">TOS</th>
									<th width="5%">TORS</th>
									<th width="5%">SOS</th>
									<th id= "thact1" width="6%">Action</th>
								</tr>
							</thead>
							<tbody >
...
<div class="">
	...
	<script type="text/javascript">
		jQuery(document).ready(
				function() {
					$("#anml_type").val('${anml_type9}');
					$("#remount_no").text('${remount_no9}');
					$("div#divwatermark").val('').addClass('watermarked');								
					watermarkreport(); 
					$('#printDiv').show();
					var remount_no ='${remount_no9}';
						$("#remount_no").text(remount_no);
					var a = $("#microchip_no").text('${microchip_no9}');
						getmicro(remount_no);
	...
	<script>
		function printDiv() {
			$('td#tdact').hide();
			$('th#thact1').hide();
			var printLbl = [ "REMOUNT NO  :", "MICROCHIP NO :" ];
			var remount_no = '${remount_no9}';
			var microchip_no = $("#microchip_no").text();
			var printVal = [ remount_no, microchip_no ];
			printDivOptimize('divPrint','Location of Animal Details ', printLbl,printVal, "");
		}
	</script>
	
	<c:url value="Show_Animal_loc_equDetails" var="editurlequ" />
	<form:form action="${editurlequ}" method="post" id="editForm1" name="editForm1" modelAttribute="editId" target="result">
		<input type="hidden" name="editId" id="editId" value="0" />
		<input type="hidden" name=anml_type14 id="anml_type14" value="0" />
	</form:form>
