...
<form:form name="IutAction" id="IutAction" action="IutAction?${_csrf.parameterName}=${_csrf.token}" method="post" class="form-horizontal" commandName="IutActionCMD" enctype="multipart/form-data">
<div class="animated fadeIn">
	<div>
		<div class="container" align="center">
			<div class="card">
			<div class="card-header"><h5>ORDER IUT A & B VEH<br></h5></div>			
					<div class="card-body card-block">
                        ...
                        <div class="col-md-12">
	                       <div class="col-md-4">
									...
									<select id="type_veh"  class="form-control-sm form-control" name= "type_veh" onchange="getMCTMainList(this.value)" style="width: 100%">
											<option value="0">--Select--</option>
											<option value="A">A Vehicles</option>
											<option value="B">B Vehicles</option>
				...
				<input type="hidden" id="u_file_hid" name="u_file_hid" value="${IutActionCMD.upload_voucher}" class="form-control autocomplete" autocomplete="off">
...
function checkFileExtImage(file) {
    ...
    case 'PDF':
            ...
            break;
    default:
            alert('Only *.pdf  file extensions allowed');
            file.value = "";
    }
}
</script>