...
<div class="animated fadeIn">
	<div class="col-md-12" align="center">
		...
		<div class="card">
			<div class="card-header"><h5>IUT TRACK STATUS A & B VEH<br></h5></div>
			<div class="card-body">
		...
		<a href="track_iut_status" class="btn btn-success btn-sm" >Clear</a>  
	<i class="fa fa-search"></i><input type="button" onclick="Search1();" class="btn btn-primary btn-sm" id="btn-reload" value="Search" /> 
				...
				<table id="alltable" class="table no-margin table-striped  table-hover  table-bordered report_print">
					<thead style="background-color: #9c27b0; color: white;text-align: center;">
						<tr>
							...
							<th width="10%" >Upload Voucher/Download</th>
					...
					<c:forEach var="item" items="${list}" varStatus="num" >
								<tr>
									...
									<td width="10%" style="text-align: center;" >${item[5]}<input type="hidden" id="target_sus_no${num.index+1}" name="target_sus_no${num.index+1}" value="${item[10]}"/></td>
								    <td>${item[6]}<input type="hidden" id="ba_no${num.index+1}" name="ba_no${num.index+1}" value="${item[6]}"/></td> 
...
<c:url value="UploadFile_Voucher" var="UploadFile_Voucher" />
...
<c:url value="getSearch_track_status_a_b" var="searchUrl" />
