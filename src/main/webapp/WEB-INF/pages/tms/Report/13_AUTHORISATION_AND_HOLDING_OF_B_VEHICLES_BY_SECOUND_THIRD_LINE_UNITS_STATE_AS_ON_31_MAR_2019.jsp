...
<form:form action="search_conver_restruc_reorga_redes_actionlist" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>AUTHORISATION AND HOLDING OF B VEHICLES BY SECOUND THIRD LINE UNITS</h5></div>
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>AUTHORISATION AND HOLDING OF B VEHICLES BY SECOUND THIRD LINE UNITS<br>
						...
						<span id="ip"></span>
							...
							<thead style="background-color: #9c27b0; color: white;" align="center">
									<tr>
										...
										<th colspan="2" style=" text-align: center; width: 8%;"> SECOND LINE UNIT</th><!--  style="font-size: 13px" align="center" colspan="2" -->
										<th colspan="2" style=" text-align: center; width: 8%;"> THIRD LINE UNIT </th>
																
									</tr>
									<tr>
									<th colspan="1" style=" text-align: center; width: 4%;">TYPE OF VEHICLE  </th>
							...
							<tbody style="font-size: 12px" align="left">
								...
								<tr>										
									<td style=" text-align: left; width: 2%;">${item[0]}</td>									
...
<c:url value="AUTHORISATION_AND_HOLDING_OF_B_VEHICLES_BY_SECOUND_THIRD_LINE_UNITS_STATE_AS_ON_31_MAR_2019" var="searchUrltms13" />
