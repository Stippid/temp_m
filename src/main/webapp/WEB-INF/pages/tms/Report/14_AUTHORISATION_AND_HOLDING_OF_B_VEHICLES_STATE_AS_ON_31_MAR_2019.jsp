...
<script src="js/miso/miso_js/jquery-2.2.3.min.js"></script>
	...
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>AUTHORISATION AND HOLDING OF B VEHICLES : COMD WISE</h5></div>
				...
				<div class="card-footer" align="center">
	            	...
	            	<i class="fa fa-search"></i><input type="button" class="btn btn-primary btn-sm" value="Search" onclick="return Search();" > 
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>AUTHORISATION AND HOLDING OF B VEHICLES : COMD WISE<br>
	...
	<div class="animated fadeIn" id="btnhide" style="display: none;">
			<div class="col-md-12" align="center">
				<div class="col-md-12" align="center">
					<input type="button" class="btn btn-primary btn-sm" value="Print" onclick="printDiv('printableArea1')">
				</div>
			</div>
	</div> 	

<c:url value="AUTHORISATION_AND_HOLDING_OF_B_VEHICLES_STATE_AS_ON_31_MAR_2019report" var="searchUrltms13" />
