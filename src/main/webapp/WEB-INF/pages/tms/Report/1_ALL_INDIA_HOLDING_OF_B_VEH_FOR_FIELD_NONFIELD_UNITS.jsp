...
<script src="js/cue/print_OLAPReport.js"></script>
	...
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>1_ALL INDIA HOLDING OF B VEHICLE FOR FIELD NONFIELD UNITS</h5></div>
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>ALL INDIA HOLDING OF B VEHICLE FOR FIELD NONFIELD UNITS<br>
		    		...
		    		<div  class="watermarked" data-watermark="" id="divwatermark" >
						<span id="ip"></span>
							...
							<thead style="background-color: #9c27b0; color: white;" align="center">
									...
									<tr>
										<th style="font-size: 13px" align="center">PURPOSE OF VEHICLE</th>
										<th style="font-size: 13px" align="center">MCT HEADING</th>	
										<th style="font-size: 13px" align="center">FIELD</th>	
										<th style="font-size: 13px" align="center">NON FIELD</th>
										<th style="font-size: 13px" align="center">DEPOT</th>
...
<c:url value="1_ALL_INDIA_HOLDING_OF_B_VEH_FOR_FIELD_NONFIELD_UNITS_RP" var="searchUrl3" />
