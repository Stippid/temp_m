...
<script src="js/cue/print_OLAPReport.js"></script>
	...
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>2_ALL INDIA HOLDING OF B VEH COMMAND AND DEPOTS</h5></div>
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>2_ALL INDIA HOLDING OF B VEH COMMAND AND DEPOTS<br>
		    		...
		    		<div  class="watermarked" data-watermark="" id="divwatermark" >
						...
						<table id="SearchReport2" class="table no-margin table-striped  table-hover  table-bordered report_print">
							<thead style="background-color: #9c27b0; color: white;" align="center">
									...
									<tr>
										<th style="font-size: 13px" align="center">TYPE OF VEHICLE</th>
										<th style="font-size: 13px" align="center">CATEGORY OF VEHICLE</th>	
										...
										<th style="font-size: 13px" align="center">ARTRAC</th>
										...
										<th style="font-size: 13px" align="center">OTHERS</th>
										<th style="font-size: 13px" align="center">DEPOTS</th>
...
<c:url value="2_ALL_INDIA_HOLDING_OF_B_VEH_COMMAND_AND_DEPOTS_RP" var="searchUrl3" />
