...
<script src="js/cue/print_OLAPReport.js"></script>
	...
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>3_FIT/OFF ROAD GS  'B'  VEHICLES BY COMMANDS (SELECTED MCT)</h5></div>
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>3_FIT/OFF ROAD GS  'B'  VEHICLES BY COMMANDS (SELECTED MCT)<br>
		    		...
		    		<div  class="watermarked" data-watermark="" id="divwatermark" >
						...
						<table id="SearchReport2" class="table no-margin table-striped  table-hover  table-bordered report_print">
							<thead style="background-color: #9c27b0; color: white;" align="center">
								...
								<tr>
										<th style="font-size: 13px" align="center">NOMENCLATURE OF VEHICLE</th>
										<th style="font-size: 13px" align="center" colspan="2">SOUTHERN</th>	
										<th style="font-size: 13px" align="center"colspan="2">EASTERN</th>	
										<th style="font-size: 13px" align="center"colspan="2">WESTERN</th>
										<th style="font-size: 13px" align="center"colspan="2">CENTRAL</th>
										<th style="font-size: 13px" align="center"colspan="2">NORTHERN</th>
										<th style="font-size: 13px" align="center"colspan="2">SOUTH WESTERN</th>
										<th style="font-size: 13px" align="center"colspan="2">TRAINING/ARTRAC</th>
										<th style="font-size: 13px" align="center"colspan="2">ANC</th>
										<th style="font-size: 13px" align="center"colspan="2">UN COMMAND</th>
										<th style="font-size: 13px" align="center"colspan="2">TOTAL</th>
										</tr>
									<tr>
										<th colspan="1">
										<th style="font-size: 13px" align="center">FIT(CL 1_3)</th>	
										<th style="font-size: 13px" align="center">REPAIRA BLE(CL 4)</th>	
										<th style="font-size: 13px" align="center">FIT(CL 1_3)</th>	
										<th style="font-size: 13px" align="center">REPAIRA BLE(CL 4)</th>
										<th style="font-size: 13px" align="center">FIT(CL 1_3)</th>	
										<th style="font-size: 13px" align="center">REPAIRA BLE(CL 4)</th>
...
<c:url value="3_FIT_OFF_ROAD_GS_B_VEHICLES_BY_COMMAND_RP" var="searchUrl3" />
	<form:form action="${searchUrl3}" method="post" id="search3" name="search3" modelAttribute="type_of_report1">
