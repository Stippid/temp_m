...
<script src="js/cue/print_OLAPReport.js"></script>
	...
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>ALL INDIA HOLDING OF B VEHICLES BY CLASSIFICATION WITH ARMY UNITS DEPOT 2</h5></div>
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>ALL INDIA HOLDING OF B VEHICLES BY CLASSIFICATION WITH ARMY UNITS DEPOT 2<br>
		    		...
		    		<div  class="watermarked" data-watermark="" id="divwatermark" >
						...
						<table id="SearchReport2" class="table no-margin table-striped  table-hover  table-bordered report_print">
							<thead style="background-color: #9c27b0; color: white;" align="center">
									...
									<tr>
										<th style="font-size: 13px" align="center" rowspan="2"> PURPOSE OF VEHICLE 	</th>
										<th style="font-size: 13px" align="center" rowspan="2" > TYPE OF VEHICLE	</th>
										<th style="font-size: 13px" align="center" colspan="3"> UNIT	</th>
										<th style="font-size: 13px" align="center" rowspan="2"> TOTAL</th>
										<th style="font-size: 13px" align="center" colspan="3"> DEPOT	</th>
										<th style="font-size: 13px" align="center" rowspan="2"> TOTAL </th>
										<th style="font-size: 13px" align="center" rowspan="2"> GRAND TOTAL </th>
										
									<tr>
										
										<th style="font-size: 13px" align="center"> FIT(CL-1,2,3) </th>
										<th style="font-size: 13px" align="center"> REPAIRABLE(CL-4) </th>
										<th style="font-size: 13px" align="center"> UNREPAIRABLE(CL-5,6,7) </th>
										<th style="font-size: 13px" align="center"> FIT(CL-1,2,3) </th>
										<th style="font-size: 13px" align="center"> REPAIRABLE(CL-4) </th>
										<th style="font-size: 13px" align="center"> UNREPAIRABLE(CL-5,6,7) </th>
...
<c:url value="ALL_INDIA_HOLDING_OF_B_VEHICLES_BY_CLASSIFICATION_WITH_ARMY_UNITS_DEPOT_2" var="searchUrl4" />
