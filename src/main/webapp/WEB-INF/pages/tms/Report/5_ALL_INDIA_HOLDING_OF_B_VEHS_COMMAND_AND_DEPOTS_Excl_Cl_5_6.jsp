...
<script src="js/cue/print_OLAPReport.js"></script>
	...
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>ALL INDIA HOLDING OF B VEHS COMMAND AND DEPOTS Excl Cl 5.6 VEHS</h5></div>
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>ALL INDIA HOLDING OF B VEHS COMMAND AND DEPOTS Excl Cl 5.6 VEHS<br>
		    		...
		    		<div  class="watermarked" data-watermark="" id="divwatermark" >
						...
						<table id="SearchReport2" class="table no-margin table-striped  table-hover  table-bordered report_print">
							<thead style="background-color: #9c27b0; color: white;" align="center">
									...
									<tr>
										<th style="font-size: 13px" align="center"> PURPOSE </th>
										<th style="font-size: 13px" align="center"> MCT HEADING </th>	
										<th style="font-size: 13px" align="center"> CC </th>
										<th style="font-size: 13px" align="center"> MISC</th>
...
<c:url value="ALL_INDIA_HOLDING_OF_B_VEHS_COMMAND_AND_DEPOTS_Excl_Cl_5_6" var="searchUrl4" />
