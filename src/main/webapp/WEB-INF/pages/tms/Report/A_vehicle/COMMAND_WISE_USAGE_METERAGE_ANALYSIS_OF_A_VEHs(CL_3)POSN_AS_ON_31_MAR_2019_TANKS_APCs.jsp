...
<script src="js/cue/print_OLAPReport.js"></script>
	...
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>COMMAND WISE USAGE METERAGE ANALYSIS OF A VEHs(CL_III)</h5></div>
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>COMMAND WISE USAGE METERAGE ANALYSIS OF A VEHs(CL_III)<br>
		    		...
		    		<div  class="watermarked" data-watermark="" id="divwatermark" >
						...
						<table id="SearchReport2" class="table no-margin table-striped  table-hover  table-bordered report_print">
							<thead style="background-color: #9c27b0; color: white;" align="center">
								<tr>
										<th style=" text-align: center; width: 5%;" >TYPE OF VEH</th>	
										<th style=" text-align: center; width: 7%;" >COMMAND</th>	
										<th style=" text-align: center; width: 3%;" >UPTO 1000 KM</th>
										<th style=" text-align: center; width: 3%;" >1001-2000 KM</th>
										<th style=" text-align: center; width: 3%;" >2000-2500 KM</th>
										<th style=" text-align: center; width: 3%;" >2500-3000 KM</th>
										<th style=" text-align: center; width: 3%;" >3500-4500 KM</th>
										<th style=" text-align: center; width: 3%;" >4500-5000 KM</th>
										<th style=" text-align: center; width: 3%;" >ABOVE 5001 KM</th>
										<th style=" text-align: center; width: 3%;" >TOTAL</th>
										<th style=" text-align: center; width: 3%;" >CL-4</th>
										<th style=" text-align: center; width: 3%;" >GRAND TOTAL</th>
							...
							<tbody style="font-size: 12px" align="center">
								...
								<tr>										
									<td style=" text-align: left; width: 5%;">${item[0]}</td>									
									<td style=" text-align: left; width: 7%;">${item[1]}</td>
									<td style=" text-align: center; width: 3%;">${item[2]}</td>	
...
<c:url value="COMMAND_WISE_USAGE_METERAGE_ANALYSIS_OF_A_VEHs_CL_3POSN_TANKS_APCsUrl" var="searchUrl3" />
...
$(document).ready(function() {
	...
	document.getElementById('from_d').innerHTML = from_d;
	document.getElementById('to_d').innerHTML = to_d; 	
