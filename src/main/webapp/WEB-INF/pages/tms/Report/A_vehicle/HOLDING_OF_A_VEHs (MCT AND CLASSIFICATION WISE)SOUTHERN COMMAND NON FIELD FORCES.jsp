						...
						<table id="SearchReport2" class="table no-margin table-striped  table-hover  table-bordered report_print">
							<thead style="background-color: #9c27b0; color: white;" align="center">
								<tr>
										...
										<th style=" text-align: center; width: 5%;" rowspan="2">UNIT/DEPOT</th>
	...
	<div class="header"><h4 style="margin-top:20px;text-align:center;text-decoration: underline;"><b>RESTRICTED</b></h4><br></div>
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			<h4 style="text-decoration: underline;"><b>DTE GENERAL INFO SYS</b></h4>
				   			<h5>All INDIA AUTHORISATION OF B VEHICLES<br>
				   			FROM:<strong><span id="from_d"></span></strong>&nbsp; &nbsp; TO:<strong><span id="to_d"></span></strong></h5>
				   		</td>
				   		<td align="right">
				   			<img src="js/miso/images/dgis-logo.png" style="max-width: 155px; height: 50px;"> 
				...
				<div id="in" style="display: none;">
		    		<div  class="watermarked" data-watermark="" id="divwatermark" >
						...
						<table id="SearchReport2" class="table no-margin table-striped  table-hover  table-bordered report_print">
							<thead style="background-color: #9c27b0; color: white;" align="center">
									<tr>
										<th style="font-size: 13px" align="center"> GNL SPL </th>
										<th style="font-size: 13px" align="center"> VEHICLE DESC TYPE </th>
										<th style="font-size: 13px" align="center"> RESERVE (%) </th>
										<th style="font-size: 13px" align="center"> CC </th>
										<th style="font-size: 13px" align="center"> SC </th>
										<th style="font-size: 13px" align="center"> WC </th>
										<th style="font-size: 13px" align="center"> EC </th>
										<th style="font-size: 13px" align="center"> NC </th>
										<th style="font-size: 13px" align="center"> ATC </th>
										<th style="font-size: 13px" align="center"> ANC </th>
										<th style="font-size: 13px" align="center"> SWC </th>
										<th style="font-size: 13px" align="center"> MOD </th>
										<th style="font-size: 13px" align="center"> SFC </th>
										<th style="font-size: 13px" align="center"> UN </th>
										<th style="font-size: 13px" align="center"> TOTAL </th>
										<th style="font-size: 13px" align="center"> RESERVE QTY </th>
										<th style="font-size: 13px" align="center"> GRAND TOTAL </th>		
									</tr>
							</thead>
							<tbody style="font-size: 12px" align="center">
								<c:forEach var="item" items="${list}" varStatus="num" >
...
<c:url value="HOLDING_OF_A_VEHs_SOUTHERN_COMMAND_NON_FIELD_FORCES" var="searchUrl3" />
