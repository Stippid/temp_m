...
<script src="js/miso/miso_js/jquery-2.2.3.min.js"></script>
	...
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>HOLDING STATE OF A VEHs MCT CLASSIFICATION WISE POSN : DEPOT WISE HOLDING</h5></div>
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>HOLDING STATE OF A VEHs MCT CLASSIFICATION WISE<br>
						...
						<table id="SearchReport2" class="table no-margin table-striped  table-hover  table-bordered report_print">
							<thead style="background-color: #9c27b0; color: white;" align="center">
								<tr>
										...
										<th style=" text-align: center; width: 5%;" rowspan="2">DEPOT</th>
										<th style=" text-align: center; width: 2%;" rowspan="2">COUNTRY OF ORIGIN</th>
										<th style=" text-align: center; width: 3%;" colspan="7">CLASSIFICATION</th>
...
<c:url value="HOLDING_STATE_OF_A_VEHs_MCT_CLASSIFICATION_WISE_POSN_AS_ON_DEPOT_WISE_HOLDING" var="searchUrl3" />
