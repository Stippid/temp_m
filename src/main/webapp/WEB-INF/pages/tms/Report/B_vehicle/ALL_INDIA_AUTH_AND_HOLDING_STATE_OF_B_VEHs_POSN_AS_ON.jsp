...
<script src="js/miso/miso_js/jquery-2.2.3.min.js"></script>
	...
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>ALL INDIA AUTH AND HOLDING STATE OF B VEHICLE POSN</h5></div>
								...
								<div class="col-md-6">
									<div class="row form-group">
	                					...
	                					<div class="col-12 col-md-8">
	                						<input type="month" id="from_date" name="" class="form-control" max='${date}' placeholder="mm-yy" class="form-control" >
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>ALL INDIA AUTH AND HOLDING STATE OF B VEHICLES POSN<br>
						...
						<span id="ip"></span>
							...
							<thead style="background-color: #9c27b0; color: white;" align="center">
									<tr>
										...
										<th style="font-size: 13px" align="center">BRIGADE	</th>
										<th style="font-size: 13px" align="center">PARENT ARM DESC</th>
										<th style="font-size: 13px" align="center">SUS NAME</th>
										<th style="font-size: 13px" align="center">MCT</th>
										<th style="font-size: 13px" align="center">STD NOMENCLATURE</th>
										<th style="font-size: 13px" align="center">UE</th>
										<th style="font-size: 13px" align="center">UH</th>
										</tr>
...
<c:url value="ALL_INDIA_AUTH_AND_HOLDING_STATE_OF_B_VEHs_POSN_AS_ON" var="searchUrlreport22" />
	<form:form action="${searchUrlreport22}" method="post" id="search3" name="search3" modelAttribute="type_of_report1">
