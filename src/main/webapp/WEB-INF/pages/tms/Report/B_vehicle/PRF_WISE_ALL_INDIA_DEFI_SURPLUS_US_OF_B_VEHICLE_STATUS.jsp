...
<form:form action="search_conver_restruc_reorga_redes_actionlist" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>PRF WISE ALL INDIA DEFI/SURPLUS OF B VEHICLE</h5></div>
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>PRF WISE ALL INDIA DEFI/SURPLUS US OF B VEHICLE<br>
						...
						<span id="ip"></span>
							...
							<thead style="background-color: #9c27b0; color: white;" align="center">
									...
									<tr>
										...
										<th style=" text-align: center;width: 5%;">NOMENCLATURE</th>	
										<th style=" text-align: center;width: 3%;">UE</th>
										<th style=" text-align: center;width: 3%;">RESERVES</th>
										<th style=" text-align: center;width: 3%;">UE WITH RESERVES</th>
										<th style=" text-align: center;width: 3%;">UH UPTO CLASS IV(EXCL QFD)</th>
										<th style=" text-align: center;width: 3%;">SURPLUS/DEFI WITH OUT RESERVES</th>
										<th style=" text-align: center;width: 3%;">SURPLUS/DEFI WITH RESERVES</th>
										<th style=" text-align: center;width: 3%;">% SURPLUS/DEFI</th>
										</tr>
							...
							<tbody style="font-size: 12px" align="center">
								...
								<tr>										
									...
									<td  style=" text-align: left;width: 5%;">${item[1]}</td>
...
<c:url value="PRF_WISE_ALL_INDIA_DEFI_SURPLUS_US_OF_B_VEHICLE_STATUSCURL" var="searchUrlreportB1" />
	<form:form action="${searchUrlreportB1}" method="post" id="search3" name="search3" modelAttribute="type_of_report1">
