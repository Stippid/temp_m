...
<script src="js/cue/print_OLAPReport.js"></script>
	...
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>RECONCILIATION STATEMENT OF B VEHICLES FOR THE PERIOD 31-MAR-2019</h5></div>
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>RECONCILIATION STATEMENT OF B VEHICLES FOR THE PERIOD 31-MAR-2019<br>
		    		...
		    		<div  class="watermarked" data-watermark="" id="divwatermark" >
						<span id="ip"></span>
							...
							<thead style="background-color: #9c27b0; color: white;" align="center">
									<tr>
										<th style=" text-align: center; " rowspan="2">PRF</th>	
										<th style=" text-align: center; " rowspan="2">MCT</th>	
										<th style=" text-align: center; " colspan="4">STOCK HELD AS ON 31 MAR 2018</th>
										<th style=" text-align: center; " colspan="2">ADD	</th>
										<th style=" text-align: center; " colspan="1">LESS</th>
										<th style=" text-align: center; " colspan="1">NET</th>
										<th style=" text-align: center; " colspan="4">STOCK HELD AS ON 31 MAR 2019</th>
									</tr>
										
									<tr>
										<th style=" text-align: center;">REPORTED</th>	
										<th style=" text-align: center; ">CL 5 TO 7</th>	
										<th style=" text-align: center; ">QFD</th>	
...
<c:url value="RECONCILIATION_STATEMENT_OF_B_VEHICLES_FOR_THE_PERIODCURL" var="searchUrlreportB4" />
	<form:form action="${searchUrlreportB4}" method="post" id="search3" name="search3" modelAttribute="type_of_report1">
