 ...
 <form:form action="search_conver_restruc_reorga_redes_actionlist" method="post" enctype="multipart/form-data" class="form-horizontal"> 
	<div class="animated fadeIn" >
	    	<div class="container" align="center">
	    		<div class="card">
	    		<div class="card-header"><h5>TABLE SHOWING ANTICIPATED DISCARD FOR NEXT 4.5 YEARS FOR THE PERIOD STARTING FROM 01 APR 2019</h5></div>
				...
				<table style="width:100%;">
					<tr>
				   		...
				   		<td align="center">
				   			...
				   			<h5>TABLE SHOWING ANTICIPATED DISCARD FOR NEXT 4.5 YEARS FOR THE PERIOD STARTING FROM 01 APR 2019<br>
						...
						<table id="SearchReport2" class="table no-margin table-striped  table-hover  table-bordered report_print">
							<thead style="background-color: #9c27b0; color: white;" align="center">
									<tr>
										...
										<th style=" text-align: center; width: 3%;">MCT NO</th>
										<th style=" text-align: center; width: 3%;">NOMENCLATURE</th>
										<th style=" text-align: center; width: 3%;">2017-2018</th>	
										<th style=" text-align: center; width: 3%;">2018-2019</th>	
										<th style=" text-align: center; width: 3%;">2019-2020</th>	
										<th style=" text-align: center; width: 3%;">2020-2021</th>	
										<th style=" text-align: center; width: 3%;">2021-2011</th>			
							...
							<tbody style="font-size: 12px" align="center">
								...
								<tr>										
									...
									<td style=" text-align: left; width: 3%;">${item[5]}</td>	
...
<c:url value="TABLE_SHOWING_ANTICIPATED_DISCARD_FOR_NEXT_4_5_YEARSCURL" var="searchUrlreportB3" />
	<form:form action="${searchUrlreportB3}" method="post" id="search3" name="search3" modelAttribute="type_of_report1">
