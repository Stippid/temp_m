...
<form:form name="banum_rejected" id="banum_rejected" action="rejected_BA_noUrl" method="POST" commandName="Tms_Banum_Req_ChildCmd">  
   ...
   <div class="zoom-icon" onclick="openModal(this)">+</div>
					...
					<div class="card-footer" align="center">
						<input type="button" class="btn btn-primary btn-sm" value="Reject"     onclick="if (confirm('Are You Sure You Want to Reject ?')){addRemarkModel('Rejected','')}else{return false;}">  
...
$(document).ready(function() {
	...
	function Rejected() {
		...
		if($("#rej_remarks4").val()==""||$("#rej_remarks4").val()==null||$("#rej_remarks4").val()==0)
			{
		...
		document.getElementById("banum_rejected").submit();
		}	
	}
	function validate() {
		var r = $('input:radio[name=ba_no_type]:checked').val();
