...
<form:form name="banum_update" id="banum_update" action="update_BA_noUrl" method="POST" commandName="Tms_Banum_Req_ChildCmd">  
   ...
   <div class="zoom-icon" onclick="openModal(this)">+</div>
					...
					<div class="card-footer" align="center">
						<input type="submit" class="btn btn-primary btn-sm" value="Update" onclick="return Pending();" > 
					</div>
				</div>
			</div>
		</div>
