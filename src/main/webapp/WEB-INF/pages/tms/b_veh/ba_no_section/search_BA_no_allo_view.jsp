...
<div class="animated fadeIn">
		<div class="">
			<div class="container" align="center">
				<div class="card">
					<h5><b>ALLOCATION OF BA NUMBER : VIEW </b></h5>
					...
					<div class="card-body card-block">
								...
								<div class="row form-group">
									...
									<div class="col-12 col-md-6">
										<div class="form-check-inline form-check">
											<input type="hidden" id="id" name="id" placeholder="" class="form-control"  value="${Tms_Banum_Req_PrntCmd.parent_req_id}">
						...
						<div class="col-md-12">
							<div class="col-md-6">
								<div class="row form-group">
									<div class="col col-md-6">
										<label class=" form-control-label">Requesting Agency Dept </label>
									</div>
									<div class="col-12 col-md-6">
								...
								<div class="row form-group">
									<div class="col col-md-6">
										<label class=" form-control-label">Date of Req </label>
									</div>
									<div class="col-12 col-md-6">
							...
							<div class="col-md-6">
								...
								<div class="row form-group">
									...
									<input type="hidden" id="wheel_track_hide"  value="${Tms_Banum_Req_ChildCmd.wheel_track}">
										<select id="wheel_track" name="wheel_track" class="form-control" onchange="typeofveh(this);" disabled="disabled">
						...
						<div class="col-md-12">
							...
							<div class="col-md-6">
								<div class="row form-group">
									...
									<div class="col-12 col-md-6">
										<input type="date" id="date_of_auth_letter" name="date_of_auth_letter" class="form-control" readonly="readonly">
									</div>
								</div>
							</div>
						</div>
							...
							<div class="col-md-6">
								<div class="row form-group">
									<div class="col col-md-4">
										<label for="text-input" class=" form-control-label">Vehicle Category </label>
									</div>
			              	...
			              	<table class="table no-margin table-striped  table-hover  table-bordered" id="addQuantity">
				                <thead>
				                  <tr>
				                  	...
				                  	<c:if test="${roleAccess=='MISO'}">
				                  		<th width="15%"><strong style="color: red;">*</strong> BA No</th>
				                  	</c:if>
				                ...
				                <tbody>
				                 	 <c:forEach items="${Tms_Banum_Req_engin_chasisCmd}" var = "i" varStatus="c">
				                 	 	<tr>
				                 	 		<td width="5%" id="${c.count}">${c.count} </td>
				                 	 		<c:if test="${roleAccess=='MISO'}">
				                 	 			<td width="15%" ><input id="ba_no${c.count}" name="ba_no${c.count}" maxlength="20" value="${i.ba_no}" class="form-control" readonly="readonly"></td>
				                 	 		</c:if>
   ...
   <div class="zoom-icon" onclick="openModal(this)">+</div>
				                 	 	    ...
				                 	 	    <td><i class="action_icons action_delete" value="${i.id}" onclick="Delete_En(${i.id},${i.parent_req_id})" title="Delete"></i></td>
				                 	 	</tr>
					...
					<div class="card-footer" align="center">
					   ...
					   <a href="search_ba_alloUrl" class="btn btn-success btn-sm" >Back</a> 				
...
/*   NITIN V4 16/11/2022  */
function Delete_En(id,p_id){	
	var qty = $('#quantity').val();
    $.post("Delete_En_Details?"+key+"="+value, {
        id : id,p_id : p_id,qty : qty
}, function(data) {
