...
<form:form name="serachrioActionForm" id="serachrioActionForm" action="serachrioAction" method="POST" commandName="tms_rio_masterCmd">
	<div class="animated fadeIn">
		<div class="container">
			<div class="">
				<div class="card">
					<div class="card-header" align="center"><h5>SEARCH RELEASE ISSUE ORDER</h5></div>
...
<i class="fa fa-download"></i><input type="button" id="exportId" class="btn btn-sm btn_report" style="background-color: #e37c22;color: white;" value="Export" onclick="fnExcelReport();">						
					...
					<table id="rioreport" class="table no-margin table-striped  table-hover  table-bordered report_print" style="width: 100%;">
						<thead>
							<tr>
								...
								<th style="text-align: center;width: 10%;">RIO No</th>
								<th style="text-align: center;width: 10%;">RO NO</th>
								<th style="text-align: center;width: 10%;">Unit Name</th>
								<th style="text-align: center;width: 10%;">Comd Name</th>
								<th style="text-align: center;width: 10%;">Nomenclature</th>
								<th style="text-align: center;width: 10%;">MCT</th>
								<th style="text-align: center;width: 10%;">Qty</th>
								<th style="text-align: center;width: 10%;">Qty Status</th>
								<th style="text-align: center;width: 10%;">Depot Name</th>
								<th style="text-align: center;width: 10%;">Type of Issue</th>
								<th style="text-align: center;width: 10%;">Date of Submission</th>
								<th style="text-align: center;width: 10%;">Date of Validity</th>
								<th style="text-align: center;width: 10%;">In Lieu Nomenclature</th>
								<th style="text-align: center;width: 10%;">UE</th>
								<th style="text-align: center;width: 10%;">UH</th>
								<th style="text-align: center;width: 10%;">PRF UE</th>
								<th style="text-align: center;width: 10%;">PRF UH</th>
								<th style="text-align: center;width: 10%;">Type Of Vehicle</th>
	...
	<c:url value="getRIOData" var="searchUrl" />
