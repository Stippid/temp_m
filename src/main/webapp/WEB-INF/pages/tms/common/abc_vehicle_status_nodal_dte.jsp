...
<div class="animated fadeIn" id="printableArea">
	<div class="">
    	<div class="col-md-12" align="center">
    		<div class="card">
    			<div class="card-header" align="center"><h5>A, B & C Vehicle Status:Nodal Dte</h5></div>
    				<div class="card-body">
    					<div class="col-md-12">
	    			...
	    			<div class="form-control card-footer" align="center" id="buttonDiv">
	    				<a href="abc_vehicle_status_nodal_dte" class="btn btn-success btn-sm" style="border-radius: 5px;">Clear</a>  
...
<c:url value="abc_vehicle_status_details_nodal_dte" var="searchUrl" />
...
$(document).ready(function() {
    ...
    if('${type_of_force1}' != ""){
		$("#type_of_force").val('${type_of_force1}');
	}
    if ('${kms1}' == '') {
		$("#kms").val('0');
	} else {
