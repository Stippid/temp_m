...
<div class="animated fadeIn" id="printableArea">
	<div class="">
    	<div class="col-md-12" align="center">
    		<div class="card">
    			<div class="card-header" align="center"><h5>Vehicle Status:Nodal Dte</h5></div>
    				<div class="card-body">
    					...
    					<div class="col-md-12">
								<div class="row form-group">
	                				...
	                				<div class="col-12 col-md-5">
	                 					<select id="line_dte_sus" name="line_dte_sus" class="form-control-sm form-control" onchange="getMCTMainNameList()" >
	                 						${selectLine_dte}
							...
							<div class="col-md-12">
								<div class="row form-group">
							        ...
							        <div class="col-12 col-md-5">
										<select id="type_veh"  class="form-control-sm form-control" onchange="getMCTMainNameList()" style="width: 100%"><!-- onchange="getPRFList()" -->
	    			...
	    			<div class="form-control card-footer" align="center" id="buttonDiv">
	    				<a href="vehicle_status_nodal_dte" class="btn btn-success btn-sm" style="border-radius: 5px;">Clear</a>  
								...
								<div align="right"><h6>Total Count : ${list_B.size()}</h6></div>
					   			<div  class="watermarked" data-watermark="" id="divwatermark">
									...
									<table id="getVehicleStatusTbl" class="table no-margin table-striped  table-hover  table-bordered report_print" style="margin-bottom: 0rem;">
										<thead>
							        		<tr>
										        ...
										        <th rowspan="2" style="text-align: center;width:7%;">Line Dte</th>
										        <th rowspan="2" style="text-align: center;width:12%;">Nomenclature</th>
										        <th rowspan="2"  style="text-align: center;width:8%;">UE</th>
												<th colspan="8"  style="text-align: center;width:64%;">UH (On Road / Off Road)</th>	
										...
										<tbody>
											...
											<c:forEach var="item" items="${list_B}" varStatus="num" >
												<tr>
												     ...
												     <td style="width:7%;font-size: 10px;"><b>${item[37]}</b></td>
									...
									<table class="table no-margin table-striped  table-hover  table-bordered report_print" style="margin-bottom: 0rem;">
										<tbody>
											<tr>
												<td colspan="8" style="width:67%;text-align: center;"><B>Total</B></td>
									...
									<table id="getVehicleStatusTbl" class="table no-margin table-striped  table-hover  table-bordered report_print" style="margin-bottom: 0rem;">
										<thead>
							        		<tr>
										        ...
										        <th rowspan="2" style="text-align: center;width:12%;">Nomenclature</th>
										        <th rowspan="2"  style="text-align: center;width:8%;">UE</th>
												<th colspan="5"  style="text-align: center;width:40%;">UH (On Road / Off Road)</th>	
												<th rowspan="2" style="width:8%;">Total UH</th>
												<th rowspan="2" style="text-align: center;width:5%;">DEFI</th>
												<th rowspan="2" style="text-align: center;width:5%;">SURPLUS</th>
											</tr>
											<tr>
												...
												<th style="text-align: center;">TRG</th>
										...
										<tbody>
											...
											<c:forEach var="item" items="${list_A}" varStatus="num" >
												<tr>
													 ...
													 <td style="width:8%;text-align: center;">${item[11]}&nbsp; / &nbsp;${item[12]}</td> <!-- Loan -->
													 <td style="width:8%;text-align: center;">${item[13]}&nbsp; / &nbsp;${item[14]}</td> <!-- Sector Store -->
													 <td style="width:8%;text-align: center;">${item[27]}&nbsp; / &nbsp;${item[28]}</td>  <!-- OP -->
													 <td style="width:8%;text-align: center;">${item[29]}&nbsp; / &nbsp;${item[30]}</td> <!-- TRG -->
													 <td style="width:8%;text-align: center;">${item[31]}&nbsp; / &nbsp;${item[32]}</td> <!-- WWR -->
									...
									<table class="table no-margin table-striped  table-hover  table-bordered report_print" style="margin-bottom: 0rem;">
										<tbody>
											<tr>
												...
												<td align='left' style="text-align:center;width:8%;"><B>${loan}</B></td>
												<td align='left' style="text-align:center;width:8%;"><B>${sector}</B></td>
												<td align='left' style="text-align:center;width:8%;"><B>${op}</B></td>
												<td align='left' style="text-align:center;width:8%;"><B>${trg}</B></td>
												<td align='left' style="text-align:center;width:8%;"><B>${wwr}</B></td>
												<td align='left' style="width:8%;text-align:center;"><B>${totalUH}</B></td>
												<td align='left' style="text-align:center;width:5%;"><B></B></td>
												<td align='left' style="text-align:center;width:5%;"><B></B></td>
											</tr>
									...
									<table id="getVehicleStatusTbl" class="table no-margin table-striped  table-hover  table-bordered report_print" style="margin-bottom: 0rem;">
										<thead>
							        		<tr>
										        ...
										        <th rowspan="2" style="text-align: center;width:12%;">Nomenclature</th>
										        <th rowspan="2"  style="text-align: center;width:8%;">UE</th>
												<th colspan="4"  style="text-align: center;width:32%;">UH (On Road / Off Road)</th>	
												<th rowspan="2" style="width:8%;">Total UH</th>
												<th rowspan="2" style="text-align: center;width:5%;">DEFI</th>
												<th rowspan="2" style="text-align: center;width:5%;">SURPLUS</th>
											</tr>
											<tr>
												<th style="text-align: center;">Vs UE</th>
												<th style="text-align: center;">ACSFP</th>
												<th style="text-align: center;">OPWKS</th>
										...
										<tbody>
											...
											<c:forEach var="item" items="${list_C}" varStatus="num" >
												<tr>
													 ...
													 <td style="width:8%;text-align: center;">${item[7]}&nbsp; / &nbsp;${item[8]}</td> <!-- Again UE -->
													 <td style="width:8%;text-align: center;">${item[15]}&nbsp; / &nbsp;${item[16]}</td>  <!-- ACSFP -->
													 <td style="width:8%;text-align: center;">${item[33]}&nbsp; / &nbsp;${item[34]}</td> <!-- OPWORK -->
													 <td style="width:8%;text-align: center;">${item[35]}&nbsp; / &nbsp;${item[36]}</td> <!-- OTHER -->
									...
									<table class="table no-margin table-striped  table-hover  table-bordered report_print" style="margin-bottom: 0rem;">
										<tbody>
											<tr>
												...
												<td align='left' style="text-align:center;width:8%;"><B>${againUE}</B></td>
												<td align='left' style="text-align:center;width:8%;"><B>${acsfp}</B></td>
												<td align='left' style="text-align:center;width:8%;"><B>${opwks}</B></td>
												<td align='left' style="text-align:center;width:8%;"><B>${other}</B></td>
												<td align='left' style="width:8%;text-align:center;"><B>${totalUH}</B></td>
												<td align='left' style="text-align:center;width:5%;"><B></B></td>
												<td align='left' style="text-align:center;width:5%;"><B></B></td>
											</tr>
...
<c:url value="vehicle_status_details_nodal_dte" var="searchUrl" />
...
/* function getPRFList(val){
	var val = $("#type_veh").val();
	var line_dte_sus = $("#line_dte_sus").val();
	var options = '<option value="XNR">'+ "--- Select All Veh Type ---" + '</option>';
	if(val !=""){
	    $.post("getTptSummaryInPRFList_nodal_dte?"+key+"="+value,{type:val,line_dte_sus:line_dte_sus}).done(function(j) {
	    	var prfcd='${prf_code}';
    		prfcd = prfcd +",";
    		var prfcd1=[];
...
//////////////////////////////////////////////////////
function getMCTMainNameList(){
	var type_veh = $("#type_veh").val();
	var line_dte_sus = $("#line_dte_sus").val();
	if(type_veh!="" && line_dte_sus !="0"){
		$.post("getMCtMain_from_prf_codenodal_dte?"+key+"="+value,{type_veh:type_veh,line_dte_sus:line_dte_sus}).done(function(data) {	
		    if(data == ""){
				$("#srctable").empty();
				$("#tartable").empty();
