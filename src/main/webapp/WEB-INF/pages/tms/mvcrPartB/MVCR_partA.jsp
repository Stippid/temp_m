...
<div class="animated fadeIn" id="printableArea">
	   				...
	   				<table class="col-md-12">
		   				<tbody style="overflow: hidden;">
		   					<tr>
		   						...
		   						<td align="center">
		   							<h5>MONTHLY VEHICLE CASUALTY RETURN - PART A </h5>
		   						</td>
		   						<td align="right">
		...
		<div  class="col-md-12">
   			...
   			<div  class="watermarked" data-watermark="" id="divwatermark" >
				<span id="ip"></span>
   				<table id="getpartAReportMvcr" class="table no-margin table-striped  table-hover  table-bordered report_print" style="margin-bottom: 0rem;">
					<thead>
						<tr>
							<th style="width: 3%">Ser No</th>
							<th style="width: 6%">BA No</th>
							<th style="width: 6%">MCT</th>
							<th style="width: 39%">Nomenclature</th>
							<th style="width: 10%">Chassis No</th>
							<th style="width: 10%">Engine No</th>
							<th style="width: 3%">Cl</th>
							<th style="width: 7%">KM Run</th>
					...
					<c:if test="${list.size() == 0}" >
						...
						<c:forEach items="${partAMvcrList}" var="list" varStatus="num">
							<tr>
								<td style='width: 3%' align="center">${num.index+1}</td>
								<td style='width: 6%'> ${list[0]} </td>
								<td style='width: 6%'> ${list[1]} </td>
								<td style='width: 39%'> ${list[2]} </td>
								<td style='width: 10%'> ${list[4]} </td>
								<td style='width: 10%'> ${list[5]} </td>
								<td style='width: 3%'> ${list[6]} </td>
								<td style='width: 7%'> ${list[7]} </td>
								<td style='width: 16%'> ${list[8]} </td>
							</tr>
						</c:forEach> 
					</tbody>
				</table>
