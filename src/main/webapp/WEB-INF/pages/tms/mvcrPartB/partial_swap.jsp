...
<form:form name="partial_swap" id="partial_swap" action="partial_swapAction" method="post" class="form-horizontal" commandName="partial_swapCMD">
<div class="animated fadeIn">
	<div>
		<div class="container" align="center">
			<div class="card">
			<div class="card-header"><h5>PARTIAL SWAP<br></h5><h6><span style="font-size: 10px;font-size:12px;color:red">(To be entered by MISO)</span></h6></div>			
				...
				<div class="card-footer" align="center" id="btnhide" style="display: block;">
					<a href="partial_swap" class="btn btn-success btn-sm" >Clear</a>   
			      ...
			      select: function( event, ui ) {
			    	 var source_sus_no = ui.item.value;
  			      	...
  			      	var list = document.getElementById("lsbox");
		  	   			 	...
		  	   			 	$.post("getPartialBANoList?"+key+"="+value, {source_sus_no : source_sus_no}).done(function(j) {				
			  	   			 	var options;
