	...
	<div class="row" >
		<div class="col-md-12" align="center">
    		<div  class="watermarked" data-watermark="" id="divwatermark" >
				<span id="ip"></span>
				<table id="getprfwiseReportMvcr" class="table no-margin table-striped  table-hover  table-bordered report_print" style="margin-bottom: 0rem;">
					<thead>
			 			<tr>
							<th style="width: 3%;">Ser No</th>
					        <th style="width: 4%;">PRF</th>
					        <th style="width: 25%;">PRF Nomenclature</th>
					        <th style="width: 4%;">MCT</th>
							<th style="width: 48%;">Nomenclature</th>	
							<th style="width: 8%;"  align="center">UE</th>
							<th style="width: 8%;"  align="center">UH</th>
						</tr> 
					</thead>
					<tbody>
						...
						<c:forEach items="${partBMvcrPRFwise_UE_UHList}" var="list" varStatus="num" >
							<tr>
								<td style="width: 3%;" align="center"> ${num.index+1}</td>
								<td style="width: 4%;">${list[4]} </td>
								<td style="width: 25%;">${list[5]}</td>
								<td style="width: 4%;">${list[1]}</td>
								<td  style="width: 48%;">${list[0]}</td>
								<td style="width: 8%;"  align="center">${list[2]}</td>
								<td align='center' style="width: 8%;"> <a hreF='#' data-target='#rejectModal' data-toggle='modal' onclick='Reject(${list[1]},"-1")' >${list[3]}</a></td>
							</tr>
						</c:forEach>
						<c:if test="${list.size() > 0}" >
						<tr>
							<td  style="width: 84%;" colspan="5" align="center"><B>Total</B></td>
							<td align="center" style="width: 8%;" ><B>${sumUE}</B></td>
							<td align='center' style="width: 8%;"><B>${totalUH}</B></td>
						</tr>
						</c:if>
					</tbody>
				</table>
