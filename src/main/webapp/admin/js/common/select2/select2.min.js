    ...
    u.define("select2/dropdown/search", ["jquery"], function(r) {
        ...
        return e.prototype.render = function(e) {
            var t = e.call(this)
              ...
              , e = r('<span class="select2-search select2-search--dropdown"><input class="select2-search__field" style="font-family: FontAwesome,Arial;" placeholder=" Search" type="search" tabindex="-1" autocorrect="off" autocapitalize="none" spellcheck="false" role="searchbox" aria-autocomplete="list" /></span>');
